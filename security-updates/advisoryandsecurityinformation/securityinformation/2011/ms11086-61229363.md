...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8c7c21c5-677d-4a5d-8f2b-8ca7691b6b00&amp;displaylang=ja">ADAM (Active Directory Application Mode)</a><br />
(KB2616310)</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=989cca2d-cce1-4f52-b50e-43152693f240&amp;displaylang=ja">ADAM (Active Directory Application Mode)</a><br />
(KB2616310)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=08b27ce7-c32e-41e4-ad04-481c5eab17a7&amp;displaylang=ja">Active Directory</a><br />
(KB2601626)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=f116824e-ea48-422d-b284-c9ffa7604bf5&amp;displaylang=ja">ADAM (Active Directory Application Mode)</a><br />
(KB2616310)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=de5a74f2-2cc8-4677-b495-3a40fe3d6b9e&amp;displaylang=ja">Active Directory</a><br />
(KB2601626)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=1af1b734-62c7-4e08-91c8-90b6d026da84&amp;displaylang=ja">ADAM (Active Directory Application Mode)</a><br />
(KB2616310)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6168bc67-3d59-450f-bd8a-02d61dabe16b&amp;displaylang=ja">Active Directory</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2bd602cf-ae0d-4790-a5d0-6133fd7d01a0&amp;displaylang=ja">Active Directory Lightweight Directory Service (AD LDS)</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=783521ad-5c50-4194-a582-4e5a1c9999e7&amp;displaylang=ja">Active Directory Lightweight Directory Service (AD LDS)</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b5688923-3914-4f6c-8bc9-036fb4870cc6&amp;displaylang=ja">Active Directory および Active Directory Lightweight Directory Service (AD LDS)</a>*<br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=51f47181-08f6-4de1-80e5-253355675965&amp;displaylang=ja">Active Directory および Active Directory Lightweight Directory Service (AD LDS)</a>*<br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b06f9f55-e3b2-4705-83d0-1b9f5de9d378&amp;displaylang=ja">Active Directory Lightweight Directory Service (AD LDS)</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=790f1d99-96a5-438d-b433-895b692912ce&amp;displaylang=ja">Active Directory Lightweight Directory Service (AD LDS)</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=cc1e99af-fc67-400b-a82c-171f8c4d1ac9&amp;displaylang=ja">Active Directory および Active Directory Lightweight Directory Service (AD LDS)</a>*<br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-2014](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2014) を参照してください。
...
-   LDAPS を使用することに加え、***IPse***c ベースの接続を "Always check CRL" モードで使用します。
    ...
    IPsec で CRL のチェックを有効にする方法の詳細については、TechNet の記事 [Certificate revocation list (CRL) verification - an application choice](http://social.technet.microsoft.com/wiki/contents/articles/964.aspx) (英語情報) を参照してください。
...
Active Directory ドメイン サービス (AD DS) はディレクトリ データを格納し、ユーザーのログオン プロセス、認証、およびディレクトリ検索などのユーザーとドメイン間の通信を管理します。Active Directory ドメイン コントローラーは、AD DS を実行するサーバーです。AD DS の詳細については、TechNet の記事 [Active Directory ドメイン サービス](http://technet.microsoft.com/ja-jp/library/cc770946(ws.10).aspx)を参照してください。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2616310">マイクロソフト サポート技術情報 2616310</a> を参照してください。</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;">Windows Server 2003 上の Active Directory については、<a href="http://support.microsoft.com/kb/2601626">マイクロソフト サポート技術情報 2601626</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 上の Active Directory Application Mode (ADAM) については、<a href="http://support.microsoft.com/kb/2616310">マイクロソフト サポート技術情報 2616310</a> を参照してください。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">レジストリ キーの確認</td>
...
<tr class="even">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2601626">マイクロソフト サポート技術情報 2601626</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">レジストリ キーの確認</td>
