        ...
        <div>
            ...
            <dl class="dl-horizontal">
                ...
                <dd>
                        ...
                        <a href="https://go.microsoft.com/fwlink/?LinkID=532713">この資料</a>を参照してください。
                ...
                <dd>
                        ...
                        2 要素認証をサポートするようにこのアプリケーションをセットアップするには、<a href="https://go.microsoft.com/fwlink/?LinkID=532713">この資料</a>
                       を参照してください。
...
-   **Visual Studio ツールの更新版をダウンロードする**
    -   [Microsoft ASP.NET Web Frameworks とツール](https://go.microsoft.com/fwlink/?linkid=733085&clcid=0x409)
    -   [Microsoft ASP.NET と Web ツール](https://go.microsoft.com/fwlink/?linkid=733086&clcid=0x409)
-   **コンピューターを守る**  
