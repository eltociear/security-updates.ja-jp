...
マイクロソフトは、パートナーがお客様にさらに幅広い保護を提供するために使用できる情報を提供すべく、[Microsoft Active Protections Program](https://go.microsoft.com/fwlink/?linkid=215201) (MAPP) (英語情報) で積極的にパートナーと連携しています。MAPP パートナーにより公開される保護策に関する情報は、[MAPP Partners with Updated Protections](https://technet.microsoft.com/security/advisorymapp) (英語情報) を参照してください。

マイクロソフトは引き続き、[Microsoft セーフティとセキュリティ センター](https://www.microsoft.com/ja-jp/security/pc-security/protect-pc.aspx)のガイダンスに従い、ファイアウォールを有効にし、すべてのソフトウェアの更新プログラムを適用し、マルウェア対策ソフトウェアをインストールすることを推奨しています。
...
| CVE 参照情報                    | [CVE-2014-1761](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1761) |
...
-   Enhanced Mitigation Experience Toolkit を使用する
    ...
    注: グループ ポリシーに関する詳細情報は、「[Group Policy collection](https://go.microsoft.com/fwlink/?linkid=215719)」をご参照ください。
