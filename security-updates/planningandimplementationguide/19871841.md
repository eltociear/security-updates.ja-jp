...
- Windows サーバーのバックアップと復元の詳細については、Microsoft.com で Windows Server 2003 の「データのバックアップと復元」 を参照してください。
  ...
  <https://msdn.microsoft.com/library/bb447543.aspx>
  
- 監視と管理の詳細については、Microsoft.com で「管理と運用」 を参照してください。
  
  <https://technet.microsoft.com/solutionaccelerators/dd285678.aspx>
  
- IAS の最適化の詳細については、以下の URL を参照してください (英語)。
  
  <https://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/intwork/inbc_ias_elfq.mspx>
  
- ワイヤレス ネットワーク コンポーネントのトラブルシューティングの詳細については、以下の URL を参照してください。
  
  <https://support.microsoft.com/default.aspx?scid=kb;ja;313242>
  
  <https://technet.microsoft.com/library/bb457017.aspx>
  
- IAS のトラブルシューティングの詳細については、以下の URL を参照してください (英語)。
  
  <https://technet.microsoft.com/en-us/library/bb742388.aspx>
  
- VXUtil や VXIPConfig などの IP 構成および診断ツールの詳細については、以下の URL を参照してください (英語)。
  
  <https://www.cam.com/windowsce.html>
