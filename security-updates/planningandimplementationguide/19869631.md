...
TOCTitle: 設計ガイドの概要
Title: 設計ガイドの概要
ms:assetid: 'e6114a19-d2e2-4f4f-9354-9a973b9e3221'
ms:contentKeyID: 19869631
ms:mtpsurl: 'https://technet.microsoft.com/ja-jp/library/Cc527052(v=TechNet.10)'
---
...
設計ガイドは IT 設計者を対象とし、以下の内容が記載されています。

-   ワイヤレス セキュリティを実装するビジネス上および技術上の理由

-   ワイヤレス セキュリティの方針

-   ソリューションおよびソリューション コンポーネントに影響する設計上の決定の詳細
