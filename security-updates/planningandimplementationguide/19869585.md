...
ms:contentKeyID: 19869585
ms:mtpsurl: 'https://technet.microsoft.com/ja-jp/library/Cc527057(v=TechNet.10)'
---
...
テスト ガイドには、マイクロソフトがこのソリューションの検証に使用した全体的なテスト方針、および、固有ラボでのソリューションの検証に使用できる主なテスト事例が記載されています。 このソリューションの検証に使用したテスト事例一式が含まれています。

テスト ガイドは次の章で構成されています。

-   第 13 章 : ソリューションをテストする
