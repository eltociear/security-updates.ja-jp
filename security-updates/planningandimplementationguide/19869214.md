...
2.  **成功した軽減戦略** : セキュリティ リスクの軽減に成功した戦略と不成功に終わった戦略の両方の経験を取り込みます。標準的なセキュリティ リスクの分類を使うことで、関係するリスクをグループ化する有意義な方法が利用できます。この結果、チームは、過去に成功したセキュリティ リスク管理戦略の詳細を容易に発見できるのです。
  
3.  **成功した危機管理戦略** : 危機管理計画が、ある資産について特定タイプの脆弱性を保護することで成功した場合には、別の資産の保護にも役立つ場合があります。
...
2.  複雑さと使いやすさを考慮して、セキュリティ リスクの分類と、包括的な対策の必要性の間でバランスを取ります。場合によっては、プロジェクトのタイプごとに異なるリスク分類を行うことで、使いやすさが大幅に改善することがあります。
  
3.  セキュリティ リスクの分類、定義、テスト、有効性基準の監視、および測定基準を説明するためのセキュリティ知識ベースを維持して、新しいセキュリティ対策の作業経験とユーザーを取り込みます。
