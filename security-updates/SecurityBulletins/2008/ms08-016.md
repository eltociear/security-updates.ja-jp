...
[](https://www.microsoft.com/japan/security/bulletins/ms08-016e.mspx)
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS08-016.mspx](https://technet.microsoft.com/security/bulletin/ms08-016)
...
(KB947361)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=72735aa1-e22c-40ed-8c79-38fba89979aa&amp;displaylang=ja"><img src="../../images/Dn610209.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
(KB947866)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9cf8aafa-71a5-4017-b53c-4e80ef6e1188&amp;displaylang=ja"><img src="../../images/Dn610209.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
...
(KB947355)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9f25922c-d3c2-4ef1-b164-8a21a77d29aa&amp;displaylang=ja"><img src="../../images/Dn610209.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-025">MS07-025</a></td>
</tr>
...
(KB949357)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/japan/mac/downloads.mspx"><img src="../../images/Dn610209.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
...
<th style="border:1px solid black;" >Microsoft Office のセルの解析のメモリ破損の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0113">CVE-2008-0113</a></th>
<th style="border:1px solid black;" >Microsoft Office のメモリの破損の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0118">CVE-2008-0118</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-0113](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0113) をご覧ください。
...
-   **未知の、または信頼されないソースからのファイルを開く時、Microsoft Office Isolated Conversion Environment (MOICE) を使用する**
    ...
    MOICE をインストールするためには Word/Excel/PowerPoint 2007 ファイル形式用 Microsoft Office 互換機能パックがインストールされている必要があります。この互換機能パックは[マイクロソフト ダウンロード センター](https://www.microsoft.com/downloads/search.aspx?displaylang=ja)から無償でダウンロードできます。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-0118](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0118) をご覧ください。
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/japan/mac/downloads.mspx) から Microsoft Office 2004 for Mac 11.4.1 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
-   [Zero Day Initiative](https://www.zerodayinitiative.com/) に協力し、「Microsoft Office のセルの解析の脆弱性」([CVE-2008-0113](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0113)) を報告してくださった Arnaud Dovi 氏
-   「Microsoft Office のメモリの破損の脆弱性」 ([CVE-2008-0118](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0118)) を報告してくださった匿名の発見者
