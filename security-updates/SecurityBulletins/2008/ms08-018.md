...
[](https://www.microsoft.com/japan/security/bulletins/ms08-018e.mspx)
...
**既知の問題:** サポート技術情報 [950183](https://support.microsoft.com/kb/950183) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。またこれらの問題に対して推奨される解決策についても説明しています。既知の問題および推奨される解決策はこのソフトウェアの特定のリリースのみが該当します。サポート技術情報 950183 に、関連するサポート技術情報へのリンクを記載しています。

**US マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS08-018.mspx](https://technet.microsoft.com/security/bulletin/ms08-018)
...
(KB949043)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fbe46241-b9da-40c6-803d-42eb6234be77&amp;displaylang=ja"><img src="../../images/Dn610211.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
(KB949005)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=07a90718-6597-426d-9dca-a336d60c01b8&amp;displaylang=ja"><img src="../../images/Dn610211.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
...
(KB948962)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=aaba07d6-e972-4e85-bccd-406aa2c4a4f4&amp;displaylang=ja"><img src="../../images/Dn610211.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<th style="border:1px solid black;" >Project のメモリの検証の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1088">CVE-2008-1088</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-1088](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1088) をご覧ください。
...
-   「Project のメモリの検証の脆弱性」- CVE-2008-1088 を報告してくださった、韓国の [National Cyber Security Center](https://www.ncsc.go.kr/kn-cert/)
