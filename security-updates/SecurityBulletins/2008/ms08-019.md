...
[](https://www.microsoft.com/japan/security/bulletins/ms08-019e.mspx)
...
**既知の問題:** サポート技術情報 [949032](https://support.microsoft.com/kb/949032) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。またこれらの問題に対して推奨される解決策についても説明しています。既知の問題および推奨される解決策はこのソフトウェアの特定のリリースのみが該当します。サポート技術情報 949032 に、関連するサポート技術情報へのリンクを記載しています。

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS08-019.mspx](https://technet.microsoft.com/security/bulletin/ms08-019)
...
(KB947896)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0056a936-def5-40fa-bcfc-0ab0dd5c3964&amp;displaylang=ja"><img src="../../images/Dn610212.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-030">MS07-030</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Visio 2003 Service Pack 2<br />
(KB947650)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=18af0ce6-99a0-4471-8d26-9700a8a8e631&amp;displaylang=ja"><img src="../../images/Dn610212.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-030">MS07-030</a></td>
</tr>
...
(KB947590)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0510a1bb-b464-452c-900f-7f4e58ed9c7e&amp;displaylang=ja"><img src="../../images/Dn610212.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
...
<th style="border:1px solid black;" >Visio のオブジェクト ヘッダーの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1089">CVE-2008-1089</a></th>
<th style="border:1px solid black;" >Visio のメモリの検証の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1090">CVE-2008-1090</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-1089](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1089) をご覧ください。
...
-   **ファイルを開くおよび表示するために、Microsoft Visio Viewer 2003** **または** **Microsoft Visio 2007 Viewer** **を使用する**
    ...
    Microsoft Visio Viewer 2003 または Microsoft Visio 2007 Viewer は、この問題の影響を受けません。[Microsoft Visio Viewer 2003](https://www.microsoft.com/download/details.aspx?displaylang=ja&familyid=3fb3bd5c-fed1-46cf-bd53-da23635ab2df) または [Microsoft Visio 2007 Viewer](https://www.microsoft.com/download/details.aspx?displaylang=ja&familyid=d88e4542-b174-4198-ae31-6884e9edd524) は、マイクロソフト ダウンロード センターからダウンロードすることができます。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-1090](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1090) をご覧ください。
...
**注** MBSA 2.0.1、Microsoft Update および Windows Server Update Servicesによりサポートされていないレガシ製品をご使用のお客様は、[Microsoft Baseline Security Analyzer (MBSA)](https://technet.microsoft.com/ja-jp/security/cc184924.aspx) をご覧のうえ、レガシ製品のサポート セクションのレガシ ツールで包括的にセキュリティ更新プログラムを検出する方法をご参照ください。
...
SMS 2.0 および SMS 2003 について、Security Update Inventory Tool (SUIT) が含まれている SMS SUS Feature Pack は、セキュリティ更新プログラムを検出するために SMS により使用されます。SMS SUIT は検出のために MBSA 1.2.1 エンジンを使用します。SUIT に関する詳細は、次のサポート技術情報 [894154](https://support.microsoft.com/kb/894154/) をご覧ください。SUIT の制限に関する詳細情報は、[306460](https://support.microsoft.com/kb/306460/) をご覧ください。また SMS SUS Feature Pack も Microsoft Office アプリケーションに必要な更新プログラムを検出するための Microsoft Office Inventory Tool が含まれています。
...
-   Microsoft Office System 2007 のサポートされているバージョンについては、[Create a network installation point for the 2007 Office system](https://technet2.microsoft.com/office/f/?en-us/library/72c9ae03-1342-4524-8242-1524fbd068a51033.mspx) (英語情報) をご覧ください。
...
-   「Visio のオブジェクト ヘッダーの脆弱性」 - [CVE-2008-1089](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1089) を報告して下さった匿名の発見者
-   「Visio のメモリの検証の脆弱性」 - [CVE-2008-1090](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1090) を報告して下さった匿名の発見者
