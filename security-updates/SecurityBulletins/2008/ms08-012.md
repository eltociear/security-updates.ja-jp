---
TOCTitle: 'MS08-012'
Title: 'マイクロソフト セキュリティ情報 MS08-012 - 緊急'
ms:assetid: 'ms08-012'
ms:contentKeyID: 61229031
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms08-012(v=Security.10)'
---
...
公開日: 2008年2月13日 | 最終更新日: 2008年9月11日

**バージョン:** 1.1

[](https://www.microsoft.com/japan/security/bulletins/ms08-012e.mspx)

### 概説

#### 概要

この深刻度が「緊急」のセキュリティ更新プログラムは、ユーザーが特別な細工がされた Publisher ファイルを表示した場合、リモートでコードが実行される可能性がある非公開で報告された Microsoft Office Publisher に存在する 2 件の脆弱性を解決します。攻撃者によりこれらの脆弱性が悪用された場合、影響を受けるコンピュータが完全に制御される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。コンピュータでユーザー権限が低い設定のアカウントを持つユーザーは、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。

これは、サポートされているリリースの Microsoft Office Publisher 2000、サポートされているリリースの Microsoft Office Publisher 2002 およびサポートされているエディションの Microsoft Office Publisher 2003 Service Pack 2 の「緊急」のセキュリティ更新プログラムです。Microsoft Publisher 2003 Service Pack 3, Microsoft Office Publisher 2007, および Microsoft Office Publisher 2007 Service Pack 1 はこの脆弱性による影響を受けません。
...
**US マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS08-012.mspx](https://technet.microsoft.com/security/bulletin/ms08-012)
...
![](../../images/Dn610205.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機用または NEC PC-9800 シリーズ用の更新プログラムをダウンロードしてください。
...
<td style="border:1px solid black;">Microsoft office Publisher 2000<br />
(KB946255)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d8b085fb-858f-4c7e-96de-edff8f49d62a&amp;displaylang=ja"><img src="../../images/Dn610205.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;">Microsoft office Publisher 2002<br />
(KB946216)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1135c63a-6ce7-4051-81ba-bfbba8d857fb&amp;displaylang=ja"><img src="../../images/Dn610205.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
...
<td style="border:1px solid black;">Microsoft office Publisher 2003<br />
(KB946254)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7078b952-09f6-4c47-8c05-40667e1f1c3b&amp;displaylang=ja"><img src="../../images/Dn610205.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-054">MS06-054</a></td>
</tr>
...
Microsoft Office 2003 Service Pack 3 はこのセキュリティ情報で説明している脆弱性の影響を受けません。しかしこの場合でも、更新されたファイルはMicrosoft Office Service Pack 3で提供されたファイルよりも新しいため （新しいバージョン番号）、この更新プログラムが提供されます。マイクロソフトはこの更新プログラムを徹底的にテストしています。しかし、すべての更新プログラムについて言えることですが、ご使用のコンピュータの環境と構成に応じたテストすることをお勧めします。
  
**Microsoft Office 2003 Service Pack 3 に対する更新プログラムの提供は、マイクロソフトの更新プログラムのメカニズムに沿わないものですか?**  
いいえ。更新プログラムのメカニズムは正しく機能しており、更新パッケージよりも古いバージョンのファイルをコンピュータで検出し、更新プログラムを提供します。
  
**より新しいバージョンのファイルと置き換える Microsoft Office Service Pack 3 に対する更新プログラムには何が含まれていますか?**  
更新ファイルには Microsoft Office 2003 Service Pack 3 で安定性の変更をサポートする変更と企業環境の変化をサポートする追加の変更が含まれています。マイクロソフトはこの更新プログラムを徹底的にテストしています。しかし、すべての更新プログラムについて言えることですが、ご使用のコンピュータの環境と構成に応じたテストすることをお勧めします。
...
<th style="border:1px solid black;" >Publisher の無効なメモリ参照の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0102">CVE-2008-0102</a></th>
<th style="border:1px solid black;" >Publisher のメモリの破損の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0104">CVE-2008-0104</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
<span></span>
Publisher ファイルをメモリに読み込む時、Microsoft Office Publisher が読み込んだデータを検証する方法に、リモートでコードが実行される脆弱性が存在します。攻撃者は特別な細工がされた Publisher (.pub) ファイルを作成することにより、この脆弱性を悪用する可能性があります。ユーザーが .pub ページを表示すると、この脆弱性により、リモートでコードが実行される可能性があります。攻撃者によりこの脆弱性が悪用された場合、影響を受けるコンピュータが完全に制御される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-0102](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0102) をご覧ください。
  
#### 「Publisher の無効なメモリ参照の脆弱性」の問題を緩和する要素 - CVE-2008-0102:
...
-   Web ベースの攻撃のシナリオで、攻撃者はこの脆弱性の悪用を意図した Web ページを含む Web サイトをホストする可能性があります。さらに、ユーザーが提供するコンテンツを受け入れるまたはホストする Web サイト、または侵害された Web サイトおよび広告サーバーがこの脆弱性を悪用する可能性のある特別な細工がされたコンテンツを含む可能性があります。通常、ユーザーに攻撃者の Web サイトに接続させる電子メール メッセージまたはインスタント メッセンジャーのメッセージ内のリンクをクリックさせることにより、ユーザーを攻撃者の Web サイトに訪問させることが攻撃者にとっての必要条件となります。  
-   この脆弱性は、電子メールを介して、自動的に悪用されることはありません。ユーザーが電子メール メッセージで送信された添付ファイルを開かない限り、攻撃は行われません。
  
#### 「Publisher の無効なメモリ参照の脆弱性」の回避策 - CVE-2008-0102:
...
#### 「Publisher の無効なメモリ参照の脆弱性」のよく寄せられる質問 - CVE-2008-0102:
...
**何が原因で起こりますか?**  
Publisher が Publisher ファイルをメモリに読み込む時、正しくアプリケーション データを検証しないため、この脆弱性が起こります。
...
ユーザーが Microsoft Office Publisher の影響を受けるエディションで、特別に細工された Publisher ファイルを開いた場合、この脆弱性が悪用される可能性があります。  
...
Microsoft Publisher が使用されているコンピュータが主にこの脆弱性による危険にさらされます。管理者がユーザーにサーバーにログオンしプログラムを実行することを許可した場合、サーバーが危険にさらされる可能性が高くなります。しかし、セキュリティ上の最善策として、これを許可しないことが強く推奨されています。
  
**この更新プログラムはどのように問題を修正しますか?**  
この更新プログラムはディスクからメモリにアプリケーションのデータをダウンロードする際にメモリの値を正しく検証することによりこの脆弱性を排除します。
...
<span></span>
Microsoft Office Publisher が Publisher ファイルをメモリに読み込む際にアプリケーション データを検証する方法に、リモートでコードが実行される脆弱性が存在します。攻撃者は特別な細工がされた Publisher (.pub) ファイルを作成することにより、この脆弱性を悪用する可能性があります。ユーザーが .pub ファイルを表示すると、この脆弱性により、リモートでコードが実行される可能性があります。攻撃者によりこの脆弱性が悪用された場合、影響を受けるコンピュータが完全に制御される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-0104](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0104) をご覧ください。
  
#### 「Publisher のメモリの破損の脆弱性」の問題を緩和する要素 - CVE-2008-0104:
...
#### 「Publisher のメモリの破損の脆弱性」の回避策 - CVE-2008-0104:
  
回避策は、設定または構成の変更を示しており、基本的な脆弱性を正すものではありませんが、更新プログラムを適用する前に既知の攻撃方法を阻止するのに役立ちます。マイクロソフトは次の回避策をテストし、詳細の欄で回避策が機能性を削減するかどうか説明しています。
  
-   信頼できない、または信頼できるソースから予期せず受け取った Microsoft Office ファイルを開いたり、保存したりしない。ユーザーが特別な細工がされたファイルを開いた場合、この脆弱性が悪用される可能性があります。
  
#### 「Publisher のメモリの破損の脆弱性」のよく寄せられる質問 - CVE-2008-0104:
  
**どのようなことが起こる可能性がありますか?**  
これはリモートでコードが実行される脆弱性です。攻撃者によりこの脆弱性が悪用された場合、影響を受けるコンピュータが完全に制御される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
**何が原因で起こりますか?**  
Publisher が特別な細工がされた Publisher ファイルを開く際に、メモリのインデックス値を正しく検証しません。
...
| ソフトウェア                            | MBSA 2.0.1 |  
|-----------------------------------------|------------|  
| Microsoft Publisher 2000 Service Pack 3 | 不可       |  
| Microsoft Publisher 2002 Service Pack 3 | 可         |  
| Microsoft Publisher 2003 Service Pack 2 | 可         |
...
|-----------------------------------------|---------|---------------------|--------------------|-----------|  
| Microsoft Publisher 2000 Service Pack 3 | 可      | 可                  | 不可               | 可        |  
| Microsoft Publisher 2002 Service Pack 3 | 可      | 可                  | 可                 | 可        |  
| Microsoft Publisher 2003 Service Pack 2 | 可      | 可                  | 可                 | 可        |
...
<td style="border:1px solid black;">
office2000-kb946255-fullfile-jpn.exe /q:a
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
office2000-kb946255-fullfile-jpn.exe /r:n
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
|------------|------------|------------|-------|-----------|
| mspub.exe  | 9.0.8931.0 | 2008/1/3   | 9:29  | 3,567,616 |
| prtf9.dll  | 9.0.0.8929 | 2005/12/13 | 13:46 | 110,592   |
| ptxt9.dll  | 9.0.0.8929 | 2005/12/13 | 13:38 | 471,040   |
...
<td style="border:1px solid black;">
officeXP-KB946216-fullfile-jpn.exe /q:a
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
officeXP-KB946216-fullfile-jpn.exe /r:n
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| ファイル名        | バージョン  | 日付       | 時間  | サイズ    |
|-------------------|-------------|------------|-------|-----------|
| MSPUB.EXE         | 10.0.6840.0 | 2007/12/19 | 13:46 | 4,105,216 |
| MSPUB.EXE\_1033   | 10.0.6840.0 | 2007/12/19 | 13:47 | 4,105,216 |
| MSPUB.EXE\_1049   | 10.0.6840.0 | 2007/12/19 | 13:48 | 4,105,216 |
| PRTF9.DLL         | 10.0.6784.0 | 2007/12/19 | 13:42 | 137,920   |
| PRTF9.DLL\_1033   | 10.0.6784.0 | 2007/12/19 | 13:47 | 137,920   |
| PTXT9.DLL         | 10.0.6840.0 | 2007/12/19 | 13:44 | 599,040   |
| PTXT9.DLL\_1033   | 10.0.6840.0 | 2007/12/19 | 13:47 | 599,040   |
| PUBCONV.DLL       | 10.0.6840.0 | 2007/12/19 | 13:46 | 603,144   |
| PUBCONV.DLL\_1033 | 10.0.6840.0 | 2007/12/19 | 13:48 | 603,144   |
| PUBCONV.DLL\_1049 | 10.0.6840.0 | 2007/12/19 | 13:48 | 603,144   |
...
<td style="border:1px solid black;">
office2003-kb946254-fullfile-jpn.exe /q:a
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
office2003-kb946254-fullfile-jpn.exe /r:n
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| ファイル名  | バージョン  | 日付       | 時間  | サイズ    |
|-------------|-------------|------------|-------|-----------|
| MSPUB.EXE   | 11.0.8200.0 | 2007/12/14 | 18:39 | 6,747,136 |
| PRTF9.DLL   | 11.0.8200.0 | 2007/12/14 | 18:39 | 133,632   |
| PTXT9.DLL   | 11.0.8200.0 | 2007/12/14 | 18:39 | 612,352   |
| PUBCONV.DLL | 11.0.8200.0 | 2007/12/14 | 18:39 | 562,184   |
...
-   「Publisher の無効なメモリ参照の脆弱性」 - [CVE-2008-0102](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0102) の 問題を報告をしてくださった Piotr Bania 氏
-   「Publisher の無効なメモリ参照の脆弱性」 - [CVE-2008-0102](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0102) の 問題を報告をしてくださった [Fortinet Security Research](https://www.fortinet.com/) の Bing Liu 氏
-   「Publisher のメモリの破損の脆弱性」 - [CVE-2008-0104](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0104) の 問題を報告をしてくださった [Fortinet Security Research](https://www.fortinet.com/) の Bing Liu 氏
...
-   2008/02/14: このセキュリティ情報ページを更新し、このセキュリティ更新プログラムのインストールに関する既知の問題はないことを記載しました。
-   2008/09/11: このセキュリティ情報ページを更新し、「このセキュリティ更新プログラムに関するよく寄せられる質問 (FAQ)」に Microsoft Office の影響を受けないバージョンにこの更新プログラムが提供される理由を説明する項目を追加しました。
