---
TOCTitle: 'MS08-068'
Title: 'マイクロソフト セキュリティ情報 MS08-068 - 緊急'
ms:assetid: 'ms08-068'
ms:contentKeyID: 61229087
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms08-068(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS08-068 - 緊急
===============================================

SMB の脆弱性により、リモートでコードが実行される (957097)
---------------------------------------------------------

公開日: 2008年11月12日 | 最終更新日: 2008年12月11日

**バージョン:** 1.1

[](https://www.microsoft.com/japan/security/bulletins/ms08-068e.mspx)
...
**既知の問題:** マイクロソフト サポート技術情報 [957097](https://support.microsoft.com/kb/957097) には、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明されています。

**US マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS08-068.mspx](https://technet.microsoft.com/security/bulletin/ms08-068)
...
![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機用または NEC PC-9800 シリーズ用の更新プログラムをダウンロードしてください。
...
|----------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|---------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                | [![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=44c971e6-96fc-4bba-8f4a-f9d46bda2b6c&displaylang=ja) | [![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=44c971e6-96fc-4bba-8f4a-f9d46bda2b6c&displaylang=ja-nec) | リモートでコードが実行される | 重要           | [MS06-030](https://technet.microsoft.com/security/bulletin/ms06-030) |
| Windows XP Service Pack 2                                                                                            | [![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6f8ae0aa-fd68-4156-9016-bba00149793c&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 重要           | [MS05-011](https://technet.microsoft.com/security/bulletin/ms05-011) |
| Windows XP Service Pack 3                                                                                            | [![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6f8ae0aa-fd68-4156-9016-bba00149793c&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 重要           | なし                                                                |
| Windows XP Professional x64 Edition および Windows XP Professional x64 Edition Service Pack 2                        | [![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=9501b33b-d639-43e7-ad5a-9e76ed66effd&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 重要           | なし                                                                |
| Windows Server 2003 Service Pack 1 および Windows Server 2003 Service Pack 2                                         | [![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=57a0606d-ea7a-4e5b-8b8b-7b77a444ef75&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 重要           | なし                                                                |
| Windows Server 2003 x64 Edition および Windows Server 2003 x64 Edition Service Pack 2                                | [![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=915e001f-9aa0-4fb0-9c2a-0f0c72b4f056&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 重要           | なし                                                                |
| Windows Server 2003 with SP1 for Itanium-based Systems および Windows Server 2003 with SP2 for Itanium-based Systems | [![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6abf7ba9-825f-4ee2-a2fe-6b1cd9fab622&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 重要           | なし                                                                |
| Windows Vista および Windows Vista Service Pack 1                                                                    | [![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5612815f-8685-45d2-af4a-164c298a0869&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 警告           | なし                                                                |
| Windows Vista x64 Edition および Windows Vista x64 Edition Service Pack 1                                            | [![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=727ce9b6-827f-4350-b4ff-c08e8ac541a6&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 警告           | なし                                                                |
| Windows Server 2008 for 32-bit Systems\*                                                                             | [![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b305e894-61ec-46b4-91ee-4c9ac59bc47e&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 警告           | なし                                                                |
| Windows Server 2008 for x64-based Systems\*                                                                          | [![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e8d26dfd-b347-4f10-b5b6-27dfff5e4f47&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 警告           | なし                                                                |
| Windows Server 2008 for Itanium-based Systems                                                                        | [![](../../images/Dn627072.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=d565467d-e10f-4ddc-a278-3f81a3798686&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 警告           | なし                                                                |
...
NTLM は異なる名前規則をローカル エンティティとしてではなく、リモート エンティティとして処理するため、この更新プログラムをインストールした後、SQL や IIS のようなアプリケーションがローカル NTLM 認証リクエストを行うと異常終了する可能性があります。NTLM is an authentication protocol based on a challenge/response mechanism used to determine the authenticity of the supplied credentials.NTLM とは、チャレンジ/レスポンス メカニズムに基づく認証プロトコルで、提供された資格情報の信頼性を確認するために使用されます。クライアントがローカル 'lsass' メモリ内の NTLM チャレンジに対する正しい応答 (サーバーにより送信される) を計算し、キャッシュする時に、ローカル認証のエラーが起こる可能性があります。NTLM のサーバー コードが受信された応答がローカル 'lsass' キャッシュに存在することを見つけると、認証リクエストを拒否し、それを再生攻撃として処理します。これがローカル認証のエラーの原因となります。これらのコンピューターが正常に認証を行うには、反映の保護を無効にする必要があります。認証の問題および名前付け規則についての追加情報は、サポート技術情報 [896861](https://support.microsoft.com/kb/896861)、[887993](https://support.microsoft.com/kb/887993) および [926642](https://support.microsoft.com/kb/926642) をご覧ください。反映の保護を無効にするための詳細なステップなど、このインストール問題についての追加情報は、サポート技術情報 [957097](https://support.microsoft.com/kb/957097) をご覧ください。
...
<th style="border:1px solid black;" >SMB の資格情報の反映の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4037">CVE-2008-4037</a></th>
...
「SMB の資格情報の反映の脆弱性」 - CVE-2008-4037  
------------------------------------------------
  
 
ユーザーが攻撃者の SMB サーバーに接続する際、Microsoft Server Message Block (SMB) プロトコルが NTLM 資格情報を処理する方法にリモートでコードが実行される脆弱性が存在します。この脆弱性で、攻撃者によりユーザーの資格情報が再生され、ログオンしたユーザーのコンテキストでコードが実行される可能性があります。ユーザーが管理者ユーザー権限でログオンしている場合、攻撃者はこの脆弱性を悪用して、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムをインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。コンピューターのアカウントのユーザー権限を低く設定している場合、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性の影響が少なくなると考えられます。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-4037](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4037) をご覧ください。
  
#### 「SMB の資格情報の反映の脆弱性」の問題を緩和する要素 - CVE-2008-4037:
...
-   すべてのサポートされているエディションの Windows Vista および Windows Server 2008 は、既定でファイル共有が無効にされているため、これらのプラットフォームに対する脆弱性の影響が緩和されます。この既定の構成は、従来のプラットフォームから変更されたもので、Windows Vista および Windows Server 2008 に対する攻撃を回避します。そのため、これらのプラットフォームの脆弱性の深刻度は「警告」に識別されています。
...
-   **SMB 署名を有効にする**
    ...
    SMB 署名を有効にすると、攻撃者がログオンしたユーザーのコンテキストでコードを実行するのを防ぐことができます。マイクロソフトは、グループ ポリシーを使用して SMB 署名を設定することを推奨します。グループ ポリシーを使用して Microsoft Windows 2000、Windows XP および Windows Server 2003 の SMB 署名を有効または無効にするための詳細な手順については、サポート技術情報 [887429](https://support.microsoft.com/kb/887429) をご覧ください。サポート技術情報 [887429](https://support.microsoft.com/kb/887429) の Windows XP および Windows Server 2003 向けの手順は、Windows Vista および Windows Server 2008 にも適用されます。
  
    **回避策の影響:**
  
    SMB のパケット署名を使用すると、ファイル サービスのトランザクション機能が低下する場合があります。このようなポリシー設定がされているコンピューターは、クライアント側のパケット署名を有効にしていないコンピューターと通信できません。SMB 署名および影響の可能性に関する詳細は、[Microsoft ネットワーク サーバー : 常に通信にデジタル署名を行う](https://technet2.microsoft.com/windowsserver/ja/library/c9dfa127-8e28-46de-81d0-6d0742c284201041.mspx?mfr=true)をご覧ください。
  
#### 「SMB の資格情報の反映の脆弱性」のよく寄せられる質問 - CVE-2008-4037:
...
**何が原因で起こりますか?**    
SMB プロトコルには NTLM 認証のリフレクション保護が正しくオプトインされていないため、ユーザーに対してユーザーの資格情報が反映されず、使用されないことを確認する手段がないためにこの脆弱性が起こります。
...
攻撃者はログオンしたユーザーの権限を取得し、ログオンしたユーザーが持つ特権で可能な操作を行う可能性があります。ユーザーが管理者ユーザー権限でログオンしている場合、攻撃者はこの脆弱性を悪用して、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムをインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。コンピューターのアカウントのユーザー権限を低く設定している場合、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性の影響が少なくなると考えられます。
  
**攻撃者はこの脆弱性をどのように悪用する可能性がありますか?**    
この脆弱性は、影響を受けるバージョンの SMB を使用しているユーザーが悪質なサーバーにアクセスした場合に悪用されます。攻撃者は特別に細工したサーバー共有または Web サイトをホストする必要があります。攻撃者は、特別に細工されたサーバー共有またはWeb サイトにユーザーを強制的に訪問させることはできないと考えられます。その代わり、通常、ユーザーに電子メール メッセージまたはインスタント メッセンジャーのメッセージ内の攻撃者のサーバー共有またはWeb サイトへのリンクをクリックさせ、ユーザーを誘導することが攻撃者にとっての必要条件となります。
  
**主にどのようなコンピューターがこの脆弱性による危険にさらされますか?**    
現在サポートされているすべての Windows システムが危険にさらされる可能性があります。
  
**この更新プログラムはどのように問題を修正しますか?**    
このセキュリティ更新プログラムは資格情報の再生を防ぐために、 SMB 認証の応答に対する認証方法を変更することにより、この脆弱性を解決します。
  
**このセキュリティ情報のリリース時に、この脆弱性は一般に公開されていましたか?**    
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2008-4037](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4037) にアサインされています。
  
**このセキュリティ情報の公開時に、マイクロソフトはこの脆弱性が悪用されたという報告を受けていましたか?**    
いいえ。マイクロソフトは、このセキュリティ情報が最初にリリースされた段階で、公開された検証用コード例の存在を確認していましたが、この脆弱性が悪用され、お客様が攻撃されたことを示す情報は受けていませんでした。
...
Windows2000-KB957097-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows 2000 Service Pack 4:  
Windows2000-KB957097-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows 2000 Service Pack 4:  
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB957097$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows 2000 Service Pack 4:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB957097\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
|--------------|---------------|-----------|-------|---------|
| mrxsmb.sys   | 5.0.2195.7174 | 2008/8/28 | 1:29  | 416,016 |
| msv1\_0.dll  | 5.0.2195.6926 | 2005/4/8  | 8:21  | 125,200 |
| netlogon.dll | 5.0.2195.7011 | 2005/6/3  | 4:15  | 366,864 |
| rdbss.sys    | 5.0.2195.7174 | 2008/8/28 | 1:28  | 170,800 |
...
Windowsxp-KB957097-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB957097-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows XP Service Pack 2 および Windows XP Service Pack 3:  
Windowsxp-KB957097-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows XP Professional x64 Edition および Windows XP Professional x64 Edition Service Pack 2:  
WindowsServer2003.WindowsXP-KB957097-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows XP Service Pack 2 および Windows XP Service Pack 3:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB957097\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows XP Professional x64 Edition および Windows XP Professional x64 Edition Service Pack 2:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB957097\\Filelist
</td>
</tr>
</table>
...
|------------|---------------|------------|-------|---------|------------|
| mrxsmb.sys | 5.1.2600.3467 | 2008/10/24 | 20:10 | 453,632 | SP2GDR     |
| mrxsmb.sys | 5.1.2600.3467 | 2008/10/24 | 20:25 | 455,936 | SP2QFE     |
| mrxsmb.sys | 5.1.2600.5700 | 2008/10/24 | 20:21 | 455,296 | SP3GDR     |
| mrxsmb.sys | 5.1.2600.5700 | 2008/10/24 | 20:41 | 455,936 | SP3QFE     |

Windows XP Professional x64 Edition および Windows XP Professional x64 Edition Service Pack 2:

| ファイル名 | バージョン    | 日付     | 時間  | サイズ  | CPU | フォルダー |
|------------|---------------|----------|-------|---------|-----|------------|
| mrxsmb.sys | 5.2.3790.3206 | 2008/9/8 | 11:18 | 786,944 | x64 | SP1GDR     |
| mrxsmb.sys | 5.2.3790.3206 | 2008/9/8 | 11:19 | 786,944 | x64 | SP1QFE     |
| mrxsmb.sys | 5.2.3790.4369 | 2008/9/8 | 11:26 | 786,944 | x64 | SP2GDR     |
| mrxsmb.sys | 5.2.3790.4369 | 2008/9/8 | 11:23 | 786,944 | x64 | SP2QFE     |
...
WindowsServer2003-KB957097-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB957097-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB957097-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB957097-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB957097\\Filelist
</td>
</tr>
</table>
...
| ファイル名 | バージョン    | 日付     | 時間  | サイズ  | フォルダー |
|------------|---------------|----------|-------|---------|------------|
| mrxsmb.sys | 5.2.3790.3206 | 2008/9/5 | 21:43 | 437,248 | SP1GDR     |
| mrxsmb.sys | 5.2.3790.3206 | 2008/9/5 | 21:59 | 438,272 | SP1QFE     |
| mrxsmb.sys | 5.2.3790.4369 | 2008/9/6 | 0:29  | 438,784 | SP2GDR     |
| mrxsmb.sys | 5.2.3790.4369 | 2008/9/5 | 22:42 | 438,784 | SP2QFE     |

サポートされているすべての Itanium-based エディションの Windows Server 2003:

| ファイル名 | バージョン    | 日付     | 時間  | サイズ    | CPU  | フォルダー |
|------------|---------------|----------|-------|-----------|------|------------|
| mrxsmb.sys | 5.2.3790.3206 | 2008/9/8 | 11:21 | 1,170,944 | IA64 | SP1GDR     |
| mrxsmb.sys | 5.2.3790.3206 | 2008/9/8 | 11:21 | 1,171,968 | IA64 | SP1QFE     |
| mrxsmb.sys | 5.2.3790.4369 | 2008/9/8 | 11:23 | 1,171,968 | IA64 | SP2GDR     |
| mrxsmb.sys | 5.2.3790.4369 | 2008/9/8 | 11:21 | 1,172,480 | IA64 | SP2QFE     |
...
| ファイル名   | バージョン     | 日付      | 時間  | サイズ  | フォルダー                                                                                     |
|--------------|----------------|-----------|-------|---------|------------------------------------------------------------------------------------------------|
| mrxsmb10.sys | 6.0.6000.16738 | 2008/8/26 | 10:11 | 211,456 | x86\_microsoft-windows-smb10-minirdr\_31bf3856ad364e35\_6.0.6000.16738\_none\_86a5e1554e593846 |
| mrxsmb10.sys | 6.0.6000.20904 | 2008/8/27 | 9:48  | 211,968 | x86\_microsoft-windows-smb10-minirdr\_31bf3856ad364e35\_6.0.6000.20904\_none\_874beea267621c08 |
| mrxsmb10.sys | 6.0.6001.18130 | 2008/8/27 | 10:05 | 212,480 | x86\_microsoft-windows-smb10-minirdr\_31bf3856ad364e35\_6.0.6001.18130\_none\_88841dab4b86fe7f |
| mrxsmb10.sys | 6.0.6001.22252 | 2008/8/27 | 9:52  | 212,480 | x86\_microsoft-windows-smb10-minirdr\_31bf3856ad364e35\_6.0.6001.22252\_none\_88fa1b3264b308d9 |

サポートされているすべての x64 エディションの Windows Vista:

| ファイル名   | バージョン     | 日付      | 時間  | サイズ  | CPU | フォルダー                                                                                       |
|--------------|----------------|-----------|-------|---------|-----|--------------------------------------------------------------------------------------------------|
| mrxsmb10.sys | 6.0.6000.16738 | 2008/8/26 | 10:37 | 271,872 | x64 | amd64\_microsoft-windows-smb10-minirdr\_31bf3856ad364e35\_6.0.6000.16738\_none\_e2c47cd906b6a97c |
| mrxsmb10.sys | 6.0.6000.20904 | 2008/8/27 | 10:08 | 271,872 | x64 | amd64\_microsoft-windows-smb10-minirdr\_31bf3856ad364e35\_6.0.6000.20904\_none\_e36a8a261fbf8d3e |
| mrxsmb10.sys | 6.0.6001.18130 | 2008/8/27 | 10:26 | 272,896 | x64 | amd64\_microsoft-windows-smb10-minirdr\_31bf3856ad364e35\_6.0.6001.18130\_none\_e4a2b92f03e46fb5 |
| mrxsmb10.sys | 6.0.6001.22252 | 2008/8/27 | 10:25 | 272,896 | x64 | amd64\_microsoft-windows-smb10-minirdr\_31bf3856ad364e35\_6.0.6001.22252\_none\_e518b6b61d107a0f |
...
| ファイル名   | バージョン     | 日付      | 時間  | サイズ  | CPU  | フォルダー                                                                                      |
|--------------|----------------|-----------|-------|---------|------|-------------------------------------------------------------------------------------------------|
| mrxsmb10.sys | 6.0.6001.18130 | 2008/8/27 | 10:05 | 655,872 | IA64 | ia64\_microsoft-windows-smb10-minirdr\_31bf3856ad364e35\_6.0.6001.18130\_none\_8885c1a14b85077b |
| mrxsmb10.sys | 6.0.6001.22252 | 2008/8/27 | 10:01 | 656,384 | IA64 | ia64\_microsoft-windows-smb10-minirdr\_31bf3856ad364e35\_6.0.6001.22252\_none\_88fbbf2864b111d5 |
...
-   2008/11/13: このセキュリティ情報ページを更新し、「SMB の資格情報の反映の脆弱性」の回避策 - CVE-2008-4037 の記載の誤りを修正しました。また、「SMB の資格情報の反映の脆弱性」のよく寄せられる質問 - CVE-2008-4037 のセクションを変更し、公開された検証用コードの報告について説明を追加しました。マイクロソフトは、この脆弱性が一般で悪用され、お客様が攻撃を受けたという報告を直接受けていません。
-   2008/12/11: このセキュリティ情報ページを更新し、「概説」の欄の「既知の問題」にサポート技術情報 957097 へのリンクを追加しました。また、「このセキュリティ更新プログラムに関するよく寄せられる質問 (FAQ)」の欄に既知の問題についての質問および回答も追加しました。
