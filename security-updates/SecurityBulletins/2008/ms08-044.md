...
[](https://www.microsoft.com/japan/security/bulletins/ms08-044e.mspx)
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS08-044.mspx](https://technet.microsoft.com/security/bulletin/ms08-044)
...
<td style="border:1px solid black;">
[![](../../images/Dn627048.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3ab323ec-9f92-453c-b7c7-9a95a9efcaea&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[MS06-039](https://technet.microsoft.com/security/bulletin/ms06-039)
</td>
</tr>
...
<td style="border:1px solid black;">
[![](../../images/Dn627048.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=bf566ce6-23da-45e5-9c2b-c47331d30e79&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627048.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e0df2f6e-1102-461d-829f-5f3e2d7eb4b3&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627048.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=199b08c7-6d79-4930-8f0c-31034629c485&displaylang=en)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627048.dl_arrow(ja-JP,Security.10).jpg)](https://download.microsoft.com/download/c/e/2/ce2f06c0-05fc-4dca-9c5a-4e12297282b9/kb955428_ja-jp.cab)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
はい。Microsoft Office 2003 のサービス モデルの一部として、Microsoft Office 2003 Service Pack 2 のユーザーがこの更新プログラムをインストールした場合、そのユーザーのコンピューターは Microsoft Office 2003 Service Pack 3 で最初に公開されたセキュリティ機能にアップグレードされます。 2008 年 1 月 1 日後に公開された Microsoft Office 2003 Service Pack 2 用のすべての更新プログラムは、これらのセキュリティ機能を含みます。(これらのセキュリティ機能は [Microsoft Office 2003 Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=e25b7049-3e13-433b-b9d2-5e3c1132f206&displaylang=ja) で導入されました。) マイクロソフトはこの更新プログラムのテストを徹底的に行っています。しかし、すべての更新プログラムについて言えることですが、ご使用のシステムの環境と構成に応じたテストの実施をお勧めします。この問題に関する詳細情報は、マイクロソフト サポート技術情報 [951646](https://support.microsoft.com/kb/951646) をご覧ください。
...
<th style="border:1px solid black;" >Microsoft の不正な形式の EPS フィルターの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3019">CVE-2008-3019</a></th>
<th style="border:1px solid black;" >Microsoft の不正な形式の PICT フィルターの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3018">CVE-2008-3018</a></th>
<th style="border:1px solid black;" >Microsoft PICT フィルター解析の脆弱性 <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3021">CVE-2008-3021</a></th>
<th style="border:1px solid black;" >Microsoft の不正な形式の BMP フィルターの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3020">CVE-2008-3020</a></th>
<th style="border:1px solid black;" >Microsoft Office WPG イメージ ファイルのヒープ破損の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3460">CVE-2008-3460</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-3019](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3019) をご覧ください。
...
-   Office 2000 用の [Office ファイルを開くときに確認するツール](https://www.microsoft.com/download/details.aspx?familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f&displaylang=ja)をインストールおよび使用しているお客様には、文書を開く前に、\[開く\]、\[保存\] または \[キャンセル\] の確認が行われます。Office ファイルを開くときに確認するツールの機能は Office XP および Office 2003 に組み込まれています。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-3018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3018) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-3021](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3021) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-3020](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3020) をご覧ください。
...
-   **すべてのサポートされている ｘ64-based エディションの およびWindows Server 2008**  
            コマンド プロンプトから管理者として次のコマンドを実行します。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-3460](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3460) をご覧ください。
...
-   「Microsoft の不正な形式の PICT フィルターの脆弱性」 - [CVE-2008-3018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3018) を報告してくださった [NGS Software](https://www.ngssoftware.com/) の Shaun Colley 氏
-   「Microsoft PICT フィルター解析の脆弱性」 - [CVE-2008-3021](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3021) を報告してくださった [Zero Day Initiative (ZDI)](https://www.zerodayinitiative.com/) に協力している Damian Put 氏
-   「Microsoft PICT フィルターの解析の脆弱性」 - [CVE-2008-3020](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3020) を報告してくださった [iDefense VCP](https://labs.idefense.com/)
-   「Microsoft Office WPG イメージ ファイルのヒープ破損の脆弱性」 - [CVE-2008-3460](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3460) を報告してくださった [iDefense VCP](https://labs.idefense.com/) に協力している Damian Put 氏
