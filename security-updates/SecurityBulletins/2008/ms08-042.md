...
[](https://www.microsoft.com/japan/security/bulletins/ms08-042e.mspx)
...
このセキュリティ更新プログラムは、最初にマイクロソフト セキュリティ アドバイザリ [953635](https://technet.microsoft.com/security/advisory/953635) で説明された脆弱性も解決します。

**推奨する対応策:** マイクロソフトはお客様にできる限り早期にこの更新プログラムを適用することを推奨します。

**既知の問題:** なし

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS08-042.mspx](https://technet.microsoft.com/security/bulletin/ms08-042)
...
|-------------------------------------------|-----------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|---------------------------------------------------------------------|
| Microsoft Office XP Service Pack 3        | Microsoft Word 2002 Service Pack 3 (KB954463) | [![](../../images/Dn627046.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c7146dfc-e1be-4d13-877b-1d9bcacc4a64&displaylang=ja) | リモートでコードが実行される | 重要           | [MS08-026](https://technet.microsoft.com/security/bulletin/ms08-026) |
| Microsoft Office 2003 Service Pack 2      | Microsoft Word 2003 Service Pack 2 (KB954464) | [![](../../images/Dn627046.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=13a37b76-9fec-426f-8176-3c95f934efe0&displaylang=ja) | リモートでコードが実行される | 重要           | [MS08-026](https://technet.microsoft.com/security/bulletin/ms08-026) |
| Microsoft Office 2003 Service Pack 3      | Microsoft Word 2003 Service Pack 3 (KB954464) | [![](../../images/Dn627046.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=13a37b76-9fec-426f-8176-3c95f934efe0&displaylang=ja) | リモートでコードが実行される | 重要           | [MS08-026](https://technet.microsoft.com/security/bulletin/ms08-026) |
...
<th style="border:1px solid black;" >Word のレコードの解析の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244">CVE-2008-2244</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-2244](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244) をご覧ください。
...
-   [Microsoft Office Word Viewer 2003](https://www.microsoft.com/download/details.aspx?displaylang=ja&familyid=95e24c87-8732-48d5-8689-ab826e7b8fdf) または [Microsoft Office Word Viewer 2003 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=ja&familyid=c6e56e97-17d7-4c48-9b2e-474cb3cdcc45) を使用して、Microsoft Word ファイルを開く  
...
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2008-2244](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244) にアサインされています。この脆弱性は、最初にマイクロソフト セキュリティ アドバイザリ [953635](https://technet.microsoft.com/security/advisory/953635) で説明されました。
...
はい。このセキュリティ更新プログラムは、現在悪用されているこの脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2008-2244](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244) に割り当てられています。
...
System Configuration Manager 2007 は更新プログラムの検出に WSUS 3.0 を使用します。Configuration Manager 2007 Software Update Management に関する詳細情報は、[System Center Configuration Manager 2007](https://technet.microsoft.com/en-us/library/bb735860.aspx) (英語情報) をご覧ください。
...
-   「Word のレコードの解析の脆弱性」 - [CVE-2008-2244](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244) の 問題を報告してくださった [ISC/SANS](https://isc.sans.org/)
