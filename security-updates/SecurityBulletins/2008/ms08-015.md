...
[](https://www.microsoft.com/japan/security/bulletins/ms08-015e.mspx)
...
**既知の問題:** サポート技術情報 [949031](https://support.microsoft.com/kb/949031) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。またこれらの問題に推奨される解決策についても説明しています。既知の問題および推奨される解決策はこのソフトウェアの特定のリリースのみが該当します。サポート技術情報 949031 に、関連するサポート技術情報へのリンクを記載しています。

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS08-015.mspx](https://technet.microsoft.com/security/bulletin/ms08-015)
...
(KB946986)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=714a49cd-5bca-4719-96a1-e1077f279533&amp;displaylang=ja"><img src="../../images/Dn610208.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
(KB946985)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=59853687-d885-4059-9460-ee403855dbd8&amp;displaylang=ja"><img src="../../images/Dn610208.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-003">MS07-003</a></td>
</tr>
...
(KB945432)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fccc7c4c-8496-4682-bd46-6590503c1bf2&amp;displaylang=ja"><img src="../../images/Dn610208.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-003">MS07-003</a></td>
</tr>
...
(KB946983)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4e2baf00-88eb-4eb6-961a-54245b363c21&amp;displaylang=ja"><img src="../../images/Dn610208.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<th style="border:1px solid black;" >Outlook の URI の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0110">CVE-2008-0110</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-0110](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0110) をご覧ください。
...
-   「Outlook の URI の脆弱性」 - [CVE-2008-0110](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0110) の 問題を報告をしてくださった [IDefense Labs](https://labs.idefense.com/) の Greg MacManus 氏
