---
TOCTitle: 'MS08-066'
Title: 'マイクロソフト セキュリティ情報 MS08-066 - 緊急'
ms:assetid: 'ms08-066'
ms:contentKeyID: 61229085
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms08-066(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS08-066 - 緊急
===============================================

Microsoft Ancillary Function ドライバーの脆弱性により、特権が昇格される (956803)
--------------------------------------------------------------------------------

公開日: 2008年10月15日 | 最終更新日: 2009年1月14日

**バージョン:** 1.1

[](https://www.microsoft.com/japan/security/bulletins/ms08-066e.mspx)

### 概説

#### 要点

このセキュリティ更新プログラムは、非公開で報告された Microsoft Ancillary Function ドライバーの脆弱性を解決します。攻撃者がローカルでこの脆弱性を悪用した場合、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。

これは、Windows XP および Windows 2003 Server のすべてのサポートされているエディション用の深刻度「重要」のセキュリティ更新プログラムです。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

このセキュリティ更新プログラムは、AFD のコンポーネントを介してユーザー モードから Windows カーネルへ渡された入力を正しく検証することで、脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。

**推奨する対応策:** マイクロソフトはお客様にできる限り早期にこの更新プログラムを適用することを推奨します。

**既知の問題:** サポート技術情報 [956803](https://support.microsoft.com/kb/956803) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。また、これらの問題の推奨される解決策についても説明しています。

**US マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS08-066.mspx](https://technet.microsoft.com/security/bulletin/ms08-066)
...
![](../../images/Dn627070.dl_arrow(ja-JP,Security.10).jpg) このマークをクリックして、PC/AT 互換機用の更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx) および [更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx) をご覧ください。

| オペレーティング システム/ソフトウェア                                                                               | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響 | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報 |
|----------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|----------------------------------------------------------|
| Windows XP Service Pack 2 および Windows XP Service Pack 3                                                           | [![](../../images/Dn627070.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b16d9dac-c430-4dd8-a1e5-9a614801f1d9&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows XP Professional x64 Edition および Windows XP Professional x64 Edition Service Pack 2                        | [![](../../images/Dn627070.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5b607efc-c6fb-4079-8478-e4f3262386d3&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Server 2003 Service Pack 1 および Windows Server 2003 Service Pack 2                                         | [![](../../images/Dn627070.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ee88ff2d-1b12-4f4c-a081-9f27a6fba074&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Server 2003 x64 Edition および Windows Server 2003 x64 Edition Service Pack 2                                | [![](../../images/Dn627070.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ab4d94d3-458c-4946-ab7f-03a279629d25&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Server 2003 with SP1 for Itanium-based Systems および Windows Server 2003 with SP2 for Itanium-based Systems | [![](../../images/Dn627070.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=63234f85-6e5d-4ef6-b7cf-d1d2c78a5517&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
...
マイクロソフトは、このセキュリティ更新プログラムについての検出の変更をお知らせするために、このセキュリティ情報を更新しました。この検出の修正により、このセキュリティ更新プログラムが以前提供されなかった影響を受けるコンピューターにこのセキュリティ更新プログラムが提供されます。コンピューターが正常に更新されたお客様は、この更新プログラムを再インストールする必要はありません。

**このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題には、どのようなものがありますか?**  
サポート技術情報 [956803](https://support.microsoft.com/kb/956803) で、この累積的なセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。また、これらの問題の推奨される解決策についても説明しています。
...
<th style="border:1px solid black;" >AFD のカーネルの上書きの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3464">CVE-2008-3464</a></th>
...
AFD のカーネルの上書きの脆弱性 - CVE-2008-3464  
----------------------------------------------
  
 
Windows がユーザー モードからカーネルに渡された入力を正しく検証しないため、Ancillary Function ドライバー (afd.sys) に特権の昇格の脆弱性が存在します。この脆弱性では、攻撃者が昇格された特権でコードを実行する可能性があります。攻撃者がローカルでこの脆弱性を悪用した場合、任意のコードを実行し、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムをインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-3464](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3464) をご覧ください。
  
#### 「AFD のカーネルの上書きの脆弱性」の問題を緩和する要素 - CVE-2008-3464:
...
#### 「AFD のカーネルの上書きの脆弱性」の回避策 - CVE-2008-3464:
  
回避策は、設定または構成の変更を示しており、基本的な脆弱性を正すものではありませんが、更新プログラムを適用する前に既知の攻撃方法を阻止するのに役立ちます。マイクロソフトは、以下の回避策を検証し、この回避策が機能性を低下させるかどうかについて、説明の部分で述べています。
  
-   マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「AFD のカーネルの上書きの脆弱性」のよく寄せられる質問 - CVE-2008-3464:
...
**何が原因で起こりますか?**    
AFD のコンポーネントがユーザー モードからカーネルにデータを渡す際に、ユーザーの提供した入力を正しく検証しないことが原因で起こります。
  
**AFD コンポーネントとは何ですか?**    
AFD コンポーネントは ancillary function ドライバーを提供し、Windows ソケット アプリケーションをサポートするもので、afd.sys ファイルに含まれています。afd.sys ドライバーはカーネル モードで実行され、Winsock TCP/IP の通信プロトコルを管理します。Winsock の Kernel のインターフェイスは TDI のトランスポートへのアクセスを提供します。AFD コンポーネントに関する詳細は、次の [マイクロソフトの Web サイト](https://msdn.microsoft.com/en-us/library/aa940505.aspx) (英語情報) をご覧ください。
  
**TDI コンポーネントとは何ですか?**    
Transport Driver Interface (TDI) はカーネル モードのネットワーク インターフェイスを定義し、すべてのトランスポート プロトコルのスタックの上端に位置します。各スタックの最上位レベルのプロトコル ドライバーは、上位レベルのカーネル モードのネットワーク クライアント向けの TDI インターフェイスをサポートします。TDI コンポーネントに関する詳細は、[マイクロソフトの Web サイト](https://www.microsoft.com/resources/documentation/windowsserv/2003/standard/proddocs/en-us/sag_tcpip_und_icmp.asp?frame=true) (英語情報) をご覧ください。
...
この脆弱性を悪用する場合、まずコンピューターにログオンすることが攻撃者にとっての必要条件となります。次に、この脆弱性の悪用を意図して特別に細工されたアプリケーションを実行し、影響を受けるコンピューターが完全に制御される可能性があります。
  
**主にどのようなコンピューターがこの脆弱性による危険にさらされますか?**    
主に、ワークステーションおよびターミナル サーバーが、この脆弱性による危険にさらされます。管理者がユーザーにサーバーにログオンしプログラムを実行することを許可している場合、サーバーが危険にさらされる可能性が高くなります。セキュリティ上の最善策として、これを許可しないことを強く推奨しています。
  
**この更新プログラムはどのように問題を修正しますか?**    
このセキュリティ更新プログラムは、AFD のコンポーネントを介してユーザー モードから Windows カーネルへ渡された入力を正しく検証して脆弱性を解決します。
...
System Center Configuration Manager 2007 は更新プログラムの検出に WSUS 3.0 を使用します。Configuration Manager 2007 Software Update Management に関する詳細情報は、[System Center Configuration Manager 2007](https://technet.microsoft.com/en-us/sms/bb676799.aspx) (英語情報) をご覧ください。
...
Windowsxp-KB956803-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB956803-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows XP Service Pack 2 および Windows XP Service Pack 3:  
Windowsxp-KB956803-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての ｘ64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB956803-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] または %Windir%\\$NTUninstallKB956803$\\Spuninst フォルダの Spuninst.exe ユーティリティを使用します。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows XP Service Pack 2 および Windows XP Service Pack 3:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB956803\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB956803\\Filelist
</td>
</tr>
</table>
...
|------------|---------------|-----------|-------|---------|----------|
| afd.sys    | 5.1.2600.3427 | 2008/8/14 | 18:51 | 138,368 | SP2GDR   |
| afd.sys    | 5.1.2600.3427 | 2008/8/14 | 18:48 | 138,368 | SP2QFE   |
| afd.sys    | 5.1.2600.5657 | 2008/8/14 | 19:04 | 138,496 | SP3GDR   |
| afd.sys    | 5.1.2600.5657 | 2008/8/14 | 19:34 | 138,496 | SP3QFE   |

サポートされているすべての x64 エディションの Windows XP:

| ファイル名 | バージョン    | 日付      | 時間  | サイズ  | CPU | フォルダ |
|------------|---------------|-----------|-------|---------|-----|----------|
| afd.sys    | 5.2.3790.3192 | 2008/8/14 | 21:32 | 299,008 | x64 | SP1GDR   |
| afd.sys    | 5.2.3790.3192 | 2008/8/14 | 21:32 | 299,520 | x64 | SP1QFE   |
| afd.sys    | 5.2.3790.4355 | 2008/8/14 | 21:41 | 291,840 | x64 | SP2GDR   |
| afd.sys    | 5.2.3790.4355 | 2008/8/14 | 21:37 | 292,352 | x64 | SP2QFE   |
...
WindowsServer2003-KB956803-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB956803-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB956803-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB956803-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB956803\\Filelist
</td>
</tr>
</table>
...
| ファイル名 | バージョン    | 日付      | 時間  | サイズ  | フォルダ |
|------------|---------------|-----------|-------|---------|----------|
| afd.sys    | 5.2.3790.3192 | 2008/8/14 | 18:51 | 150,528 | SP1GDR   |
| afd.sys    | 5.2.3790.3192 | 2008/8/14 | 19:17 | 153,088 | SP1QFE   |
| afd.sys    | 5.2.3790.4355 | 2008/8/14 | 19:48 | 150,528 | SP2GDR   |
| afd.sys    | 5.2.3790.4355 | 2008/8/14 | 20:08 | 150,528 | SP2QFE   |

サポートされているすべての Itanium-based エディションの Windows Server 2003:

| ファイル名 | バージョン    | 日付      | 時間  | サイズ  | CPU  | フォルダ |
|------------|---------------|-----------|-------|---------|------|----------|
| afd.sys    | 5.2.3790.3192 | 2008/8/14 | 21:34 | 582,656 | IA64 | SP1GDR   |
| afd.sys    | 5.2.3790.3192 | 2008/8/14 | 21:34 | 584,192 | IA64 | SP1QFE   |
| afd.sys    | 5.2.3790.4355 | 2008/8/14 | 21:38 | 583,680 | IA64 | SP2GDR   |
| afd.sys    | 5.2.3790.4355 | 2008/8/14 | 21:35 | 584,192 | IA64 | SP2QFE   |
...
-   AFD のカーネルの上書きの脆弱性 [CVE-2008-3464](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3464) を報告してくださった [SkyRecon](https://www.skyrecon.com/) の Fabien Le Mentec 氏
...
-   2009/01/14: このセキュリティ情報ページを更新し、「このセキュリティ更新プログラムに関するよく寄せられる質問 (FAQ)」にこのセキュリティ更新プログラムについての検出の変更を説明する質問および回答を追加しました。検出の修正により、以前このセキュリティ更新プログラムが提供されなかった影響を受けるコンピューターにセキュリティ更新プログラムが提供されるようになりました。コンピューターが正常に更新されたお客様は、この更新プログラムを再インストールする必要はありません。
