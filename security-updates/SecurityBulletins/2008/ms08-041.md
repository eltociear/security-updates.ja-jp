...
[](https://www.microsoft.com/japan/security/bulletins/ms08-041e.mspx)
...
このセキュリティ更新プログラムは、最初にマイクロソフト セキュリティ アドバイザリ [955179](https://technet.microsoft.com/security/advisory/955179)で説明された脆弱性も解決します。

**推奨する対応策:** マイクロソフトは、お客様に直ちにこの更新プログラムを適用することを推奨します。

**既知の問題:** なし

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS08-041.mspx](https://technet.microsoft.com/security/bulletin/ms08-041)
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7c22bb32-7ce3-4ff2-8366-ba2eb5135833&amp;displaylang=ja"><img src="../../images/Dn627045.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
(KB955441)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=54e4031d-298f-480c-88d5-0ad3b2b62ba9&amp;displaylang=ja"><img src="../../images/Dn627045.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms03-038">MS03-038</a></td>
</tr>
...
(KB955440)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=34b655f8-1922-4246-94ca-ed381c3e3b13&amp;displaylang=ja"><img src="../../images/Dn627045.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms03-038">MS03-038</a></td>
</tr>
...
(KB955439)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fd698517-a504-427d-9e5f-fde8f102142c&amp;displaylang=ja"><img src="../../images/Dn627045.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
...
<th style="border:1px solid black;" >Snapshot Viewer の任意のファイルのダウンロードの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2463">CVE-2008-2463</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-2463](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2463) をご覧ください。
...
はい。この脆弱性は「Microsoft Office Snapshot Viewer の ActiveX コントロールの競合状態」として一般に公開され、Common Vulnerability and Exposure の番号 [CVE-2008-2463](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2463) が割り当てられています。
