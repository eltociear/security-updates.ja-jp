...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/download/details.aspx?familyid=eca13ad8-62ae-41a8-b308-41e2d1773820)から Microsoft Office 2004 for Mac11.5.3 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/download/details.aspx?familyid=ab31a564-43d2-45bd-98bf-19e9ca477b62)から Microsoft Office 2008 for Mac 12.1.5 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
-   「ファイル形式の解析の脆弱性」 - [CVE-2008-4265](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4265) の 問題を報告してくださった [VeriSign iDefense Labs](https://labs.idefense.com/) の Joshua J. Drake 氏
-   「Excel のファイル形式の解析の脆弱性」 - [CVE-2008-4264](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4264) の 問題を報告してくださった [signedness.org](https://www.signedness.org/) の Claes M Nyberg 氏
-   「Excel のグローバル配列メモリ破損の脆弱性」 - [CVE-2008-4266](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4266) の 問題を報告してくださった [Secunia](https://secunia.com/) の Dyon Balding 氏
