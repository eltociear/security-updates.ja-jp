...
[](https://www.microsoft.com/japan/security/bulletins/ms08-051e.mspx)
...
**既知の問題:** サポート技術情報 [949785](https://support.microsoft.com/kb/949785) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題および推奨される解決策を説明しています。既知の問題および推奨される解決策はこのソフトウェアの特定のリリースのみに該当します。サポート技術情報 949785 に、関連のリンクを記載しています。

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS08-051.mspx](https://technet.microsoft.com/security/bulletin/ms08-051)
...
<td style="border:1px solid black;">
[![](../../images/Dn627055.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e7c044d8-778a-4985-b25b-4f7f6e4abadd&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[MS06-058](https://technet.microsoft.com/security/bulletin/ms06-058)
</td>
</tr>
...
<td style="border:1px solid black;">
[![](../../images/Dn627055.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f8921074-7985-4d42-ac2b-d2f3b1d466ba&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627055.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=7a7c21f0-5e0e-4dee-9710-1ce3d565913f&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627055.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=55fd618a-e9c5-4f1e-b9a5-b2e47ec98ef1&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627055.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=911c8872-dec8-4b8e-9708-93dcabd3e036&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627055.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=84ce5d58-0010-4945-bce9-67a41f898f2f&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627055.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ebd3af0c-3f62-4d18-bf45-881655683bd5&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
-   この更新プログラムの再インストールを希望しない場合、サポート技術情報 [938810](https://support.microsoft.com/kb/938810)で説明しているように、回避策として PowerPoint のファイルの種類をブロックし、手動でレジストリ キーを設定する必要があります。

**なぜこのセキュリティ情報は 2008 年 8 月 14 日に更新されたのですか?**  
マイクロソフトは関連するサポート技術情報 [949785](https://support.microsoft.com/kb/949785) に記載されているファイル情報およびこのセキュリティ情報の「セキュリティ更新プログラムの展開」セクションのファイル情報を更新したことをお知らせするために、このセキュリティ情報を更新しました。
...
はい。Microsoft Office 2003 のサービス モデルの一部として、Microsoft Office 2003 Service Pack 2 のユーザーがこの更新プログラムをインストールした場合、ユーザーのコンピューターは Microsoft Office 2003 Service Pack 3 で最初にリリースされたセキュリティ機能にアップグレードされます。マイクロソフトはこの更新プログラムのテストを徹底的に行っています。しかし、すべての更新プログラムについて言えることですが、ご使用のシステムの環境と構成に応じたテストの実施をお勧めします。この問題に関する詳細情報は、マイクロソフト サポート技術情報 [951646](https://support.microsoft.com/kb/951646) をご覧ください。
...
<th style="border:1px solid black;" >メモリの割り当ての脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0120">CVE-2008-0120</a></th>
<th style="border:1px solid black;" >メモリの計算方法の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0121">CVE-2008-0121</a></th>
<th style="border:1px solid black;" >解析のオーバーフローの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1455">CVE-2008-1455</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-0120](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0120) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-0121](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0121) をご覧ください。
...
-   Microsoft Office System 2007 のサポートされているバージョンについては、[Office システム用のネットワーク インストールポイントの作成](https://technet2.microsoft.com/office/f/?en-us/library/72c9ae03-1342-4524-8242-1524fbd068a51033.mspx) (英語情報) をご覧ください。
...
影響を受けるソフトウェアに関する特定のセキュリティ更新プログラムについての情報は、該当のリンクをご覧くソフトウェアの更新プログラムを更新された管理的なイメージから中央管理する予定の場合、詳細情報は [Updating Office XP Clients from a Patched Administrative Image](https://office.microsoft.com/en-us/orkxp/ha011525721033.aspx) (英語情報) をご覧ください。
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/japan/mac/downloads.mspx)から Microsoft Office 2004 for Mac 11.5.1 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
-   [iDefense Labs](https://labs.idefense.com/) と協力して、「メモリの割り当ての脆弱性」 - [CVE-2008-0120](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0120) および 「メモリの計算方法の脆弱性」 - [CVE-2008-0121](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0121) を報告してくださった、[Reversemode.com](https://reversemode.com/) の Ruben Santamarta 氏
-   「解析のオーバーフローの脆弱性」 - [CVE-2008-1455](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1455) を報告してくださった、[Venustech](https://www.venustech.com.cn/) の ADLab
