...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-4033](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4033) をご覧ください。
...
**注意:** サポートされているバージョンおよびエディションの完全な一覧は、[サポート ライフサイクル - 製品名一覧](https://support.microsoft.com/gp/lifeselectindex/)をご覧ください。サービスパックの完全な一覧は、[ライフサイクル サポート対象サービスパック](https://support.microsoft.com/gp/lifesupsps)をご覧ください。サポート ライフサイクル ポリシーに関する詳細については、[マイクロソフト サポート ライフサイクル](https://support.microsoft.com/lifecycle/)をご覧ください。
...
のセキュリティ情報で使用されている用語 （修正プログラムなど） に関しては、サポート技術情報 [824684](https://support.microsoft.com/kb/824684) をご覧ください。
...
**注:** Fwusa.exe インストーラに関する詳細情報は、サポート技術情報 [934307](https://support.microsoft.com/kb/934307) をご覧ください。
...
-   [Windows Server 2008、 Windows Vista、Windows Server 2003 および Windows XP 用の Windows Installer 4.5 Redistributable (日本語 NEC)](https://www.microsoft.com/download/details.aspx?displaylang=ja-nec&familyid=5a58b56f-60b6-4412-95b9-54d056d6f9f4)
...
-   [Windows Server 2003、Windows XP および Windows 2000 用の Windows Installer 3.1 Redistributable (日本語 NEC)](https://www.microsoft.com/download/details.aspx?displaylang=ja-nec&familyid=889482fc-5f56-4a38-b838-de776fd4138c)
-   [Windows 2000 および Windows NT 4.0 用の Windows インストーラ 2.0](https://www.microsoft.com/download/details.aspx?displaylang=en&familyid=f8ca7781-41dc-4a53-a574-82eb9cd85bbb) (英語情報)
...
-   「MSXML DTD のクロス ドメイン スクリプティングの脆弱性」 [CVE-2008-4029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4029) を報告してくださった Gregory Fleischer 氏
-   「MSXML のヘッダー リクエストの脆弱性」 [CVE-2008-4033](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4033) を報告してくださった [Minded Security](https://www.mindedsecurity.com/) の Stefano Di Paola 氏
-   その他の HTTP のみの多層防御の問題を報告してくださった [SecTheory](https://www.sectheory.com/) の Robert Hansen 氏
