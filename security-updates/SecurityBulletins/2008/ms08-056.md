...
[](https://www.microsoft.com/japan/security/bulletins/ms08-056e.mspx)
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS08-056.mspx](https://technet.microsoft.com/security/bulletin/ms08-056)
...
|-----------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|----------------------------------------------------------|
| Microsoft Office XP Service Pack 3 (KB956464) | [![](../../images/Dn627060.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b1aee2d5-bfa0-40e3-91b6-98bf65524e8c&displaylang=ja) | 情報の漏えい           | 警告           | なし                                                     |
...
<th style="border:1px solid black;" >Content-Disposition ヘッダーの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4020">CVE-2008-4020</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-4020](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4020) をご覧ください。
...
**何が原因で起こりますか?**    
サポート技術情報 [260519](https://support.microsoft.com/kb/260519) で説明しているように、ヘッダー "content-disposition: attachment" が指定されると、プロトコルはコンテンツを (直接) レンダリングせずに、ファイルのダウンロードのダイアログを表示させる必要があります。しかし、CDO プロトコル (cdo://) はこのヘッダーを適切に処理せず、常にコンテンツをレンダリングすることが原因で起こります。
...
<td style="border:1px solid black;">
サポート技術情報 [957699](https://support.microsoft.com/kb/957699) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
-   「Content-Disposition ヘッダーの脆弱性」 - [CVE-2008-4020](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4020) の 問題を報告してくださった [ネットエージェント株式会社](https://www.netagent.co.jp/)
