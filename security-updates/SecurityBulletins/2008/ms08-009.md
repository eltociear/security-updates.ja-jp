---
TOCTitle: 'MS08-009'
Title: 'マイクロソフト セキュリティ情報 MS08-009 - 緊急'
ms:assetid: 'ms08-009'
ms:contentKeyID: 61229028
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms08-009(v=Security.10)'
---
...
[](https://www.microsoft.com/japan/security/bulletins/ms08-009e.mspx)
...
これは、Microsoft Office 2000 のすべてのサポートされているエディション用には 「緊急」 の、Microsoft Office XP、 Microsoft Office 2003、および Microsoft Office Word Viewer 2003 用には 「重要」 のセキュリティ更新プログラムです。 詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS08-009.mspx](https://technet.microsoft.com/security/bulletin/ms08-009)
...
![](../../images/Dn610202.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機および NEC PC-9800 シリーズ用の更新プログラムをダウンロードしてください。
...
<td style="border:1px solid black;">Microsoft Word 2000 Service Pack 3<br />
(KB943990)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a513069b-8244-48e9-b136-01ddd3862802&amp;displaylang=ja"><img src="../../images/Dn610202.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-060">MS07-060</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office XP Service Pack 3</td>
<td style="border:1px solid black;">Microsoft Word 2002 Service Pack 3<br />
(KB943957)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=78c338aa-e410-4422-9e36-562f70d742e9&amp;displaylang=ja"><img src="../../images/Dn610202.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
...
<td style="border:1px solid black;">Microsoft Word 2003 Service Pack 2<br />
(KB943983)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=85cb1aa5-211f-4652-827b-2e79b8ffc2fc&amp;displaylang=ja"><img src="../../images/Dn610202.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-024">MS07-024</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Word Viewer 2003<br />
(KB943992)</td>
<td style="border:1px solid black;">-</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fd4ddecd-abd6-4783-b300-32b9d4bad22a&amp;displaylang=ja"><img src="../../images/Dn610202.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-024">MS07-024</a></td>
</tr>
...
**この更新プログラムが Word 2000 には「緊急」と評価されているのに、その他のすべての影響を受けるバージョンの Word には「重要」と評価されているのはなぜですか?**  
Office XP (Word 2002) 以降のバージョンには、ドキュメントを開く際に、\[開く\]、\[保存\] または \[キャンセル\] の確認を行う機能が組み込まれています。この脆弱性を悪用するのに１回以上のユーザー操作が必要となるため、この脆弱性の問題を緩和する要素によって深刻度が「重要」に軽減されます。
  
**Microsoft Office 2003 Service Pack 3 を使用しています。 なぜ、この場合でもこの更新プログラムが提供されるのですか?**  
Microsoft Office 2003 Service Pack 3 はこのセキュリティ情報で説明している脆弱性の影響を受ません。しかしこの場合でも、更新されたファイルは Microsoft Office 2003 Service Pack 3 で提供されたファイルよりも新しいので（新しいバージョン番号）、この更新プログラムが提供されます。マイクロソフトはこの更新を十分に徹底的にテストしています。しかし、すべての更新について言えることですが、ご使用のコンピュータの環境と構成に応じたテストすることをお勧めします。
  
**Microsoft Office 2003 Service Pack 3 に更新プログラムを提供するのは、マイクロソフトの更新のメカニズムに問題があるということですか?**  
いいえ、更新プログラムのパッケージは最新のバージョンを含んでいるので、Update のメカニズムが適切に機能していれば、更新を提供します。
  
**Microsoft Office Service Pack 3 の更新プログラムには更新ファイルよりも高いバージョンとなるものは何が含まれますか？**  
更新ファイルには Microsoft Office 2003 Service Pack 3で安定性の変更をサポートする変更と企業環境の変化をサポートする追加の変更が含まれています。マイクロソフトはこの更新を十分にテストしています。しかし、すべての更新について言えることですが、ご使用のコンピュータの環境と構成に応じたテストすることをお勧めします。
...
<th style="border:1px solid black;" >Word のメモリ破損の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0109"><strong>CVE-2008-0109</strong></a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
<span></span>
Word が特別な細工がされた Word ファイルを処理する方法に、リモートでコードが実行される脆弱性が存在します。この脆弱性は、不正な形式の値を含む特別な細工がされた Word ファイルをユーザーが開いた場合にリモートでコードが実行される可能性があります。攻撃者によりこの脆弱性が悪用された場合、影響を受けるコンピュータが完全に制御される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-0109](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0109) をご覧ください。
  
#### 「Word のメモリ破損の脆弱性」の問題を緩和する要素 - CVE-2008-0109:
...
#### 「Word のメモリ破損の脆弱性」の回避策 - CVE-2008-0109:
...
-   **Office のファイルのブロックのポリシーを使用して未知または信頼されないソースおよび場所からのOffice 2003 およびそれ以前の文書を開くことを阻止する**
...
#### 「Word のメモリ破損の脆弱性」のよく寄せられる質問 - CVE-2008-0109:
...
**何が原因で起こりますか?**  
特別な細工がされた Word ファイルを解析する際にメモリの計算エラーが発生し、この脆弱性が起こります。これにより、攻撃者が任意のコードを実行し、システム メモリが破損される可能性があります。
...
この更新プログラムは Word 文書を開く際に必要なメモリの割り当てを計算する方法を変更することにより、脆弱性をを排除します。
...
セキュリティ更新プログラムは [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747)、[Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) および [Office Update](https://go.microsoft.com/fwlink/?linkid=21135) から利用可能です。セキュリティ更新プログラムは[Microsoft Download Center](https://go.microsoft.com/fwlink/?linkid=21129) からダウンロードすることができます。「security\_patch」のキーワード探索によって容易に見つけることができます。
...
| Microsoft Office Word Viewer 2003  | 可         |  
...
|------------------------------------|---------|---------------------|--------------------|-----------|  
| Microsoft Word 2000 Service Pack 3 | 可      | 可                  | 不可               | 可        |  
| Microsoft Word 2002 Service Pack 3 | 可      | 可                  | 可                 | 可        |  
| Microsoft Word 2003 Service Pack 2 | 可      | 可                  | 可                 | 可        |  
| Microsoft Office Word Viewer 2003  | 可      | 可                  | 可                 | 可        |
...
<td style="border:1px solid black;">
office2000-kb943990-fullfile-jpn.exe /q:a
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
office2000-kb943990-fullfile-jpn.exe /r:n
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
|-------------|------------|------------|-------|-----------|
| winword.exe | 9.0.0.8966 | 2007/10/19 | 23:09 | 8,835,124 |
...
**注:** 組織内で Office 用更新プログラムを適用するための完全なリソースについて、管理された環境での管理者は [Microsoft Office Desktop Applications TechCenter](https://www.microsoft.com/japan/technet/prodtechnol/office/ork/default.mspx) をご覧ください。[Windows Installer Documentation](https://go.microsoft.com/fwlink/?linkid=21685) (英語情報) もまた、Windows インストーラによりサポートされるセットアップ スイッチに関する詳細情報を提供しています。
...
<td style="border:1px solid black;">
officexp-KB943957-FullFile-JPN.exe /q:a
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
officexp-KB943957-FullFile-JPN.exe /r:n
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| ファイル名  | バージョン  | 日付       | 時間  | サイズ     |
|-------------|-------------|------------|-------|------------|
| WINWORD.EXE | 10.0.6838.0 | 2007/12/12 | 17:55 | 10,744,840 |
...
office2003-KB943983-FullFile-JPN.exe /q:a
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Word Viewer 2003 のすべてのサポートされているエディション:  
office2003-KB943992-FullFile-JPN.exe /q:a
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Word 2003 のすべてのサポートされているエディション:  
office2003-KB943983-FullFile-JPN.exe /r:n
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Word Viewer 2003 のすべてのサポートされているエディション:  
office2003-KB943992-FullFile-JPN.exe /r:n
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
完全なファイル マニフェストについては、このセクション内のサブセクション「ファイル情報」、または、マイクロソフト サポート技術情報 [940602](https://support.microsoft.com/kb/940602) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
Wordl 2003 のすべてのサポートされているエディション:

| ファイル名  | バージョン  | 日付       | 時間  | サイズ     |
|-------------|-------------|------------|-------|------------|
| WINWORD.EXE | 11.0.8202.0 | 2007/11/19 | 19:35 | 12,311,048 |

Word 2003 Viewer のすべてのサポートされているエディション:

| ファイル名   | バージョン  | 日付       | 時間  | サイズ    |
|--------------|-------------|------------|-------|-----------|
| WORDVIEW.EXE | 11.0.8202.0 | 2007/11/19 | 19:35 | 8,812,040 |
...
-   「Word のメモリ破損の脆弱性」 - [CVE-2008-0109](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0109) の 問題を報告してくださった Rubén Santamarta 氏
