...
<td style="border:1px solid black;">
[**Windows Netlogon のメモリ破損によりリモートでコードが実行される脆弱性 - CVE-2016-3228**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3228)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=4e25a416-fd68-49c2-b263-8d0e7af05eb0)  
(3162343)
