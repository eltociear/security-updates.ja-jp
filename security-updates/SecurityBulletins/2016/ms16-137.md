...
<td style="border:1px solid black;">
[**仮想保護モードの情報漏えいの脆弱性 CVE-2016-7220**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7220)

</td>
<td style="border:1px solid black;">
[**ローカル セキュリティ機関サブシステム サービスのサービス拒否の脆弱性 CVE-2016-7237**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7237)

</td>
<td style="border:1px solid black;">
[**Windows NTLM の特権の昇格の脆弱性 CVE-2016-7238**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7238)
...
<td style="border:1px solid black;">
[MS15-121](https://go.microsoft.com/fwlink/?linkid=690884) の [3081320](https://support.microsoft.com/kb/3081320)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 for 32-bit Systems Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3198510)  
(3198510)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 for x64-based Systems Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3198510)  
(3198510)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 for Itanium-based Systems Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3198510)  
(3198510)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 for 32-bit Systems Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3198510) (Server Core インストール)  
(3198510)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 for x64-based Systems Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3198510) (Server Core インストール)  
(3198510)
...
<tr class="even">
<td style="border:1px solid black;">仮想保護モードの情報漏えいの脆弱性</td>
...
<tr class="even">
<td style="border:1px solid black;">Windows NTLM の特権の昇格の脆弱性</td>
