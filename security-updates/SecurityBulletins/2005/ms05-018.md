...
-   「Windows カーネルの脆弱性」(CAN-2005-0061) を報告してくださった Sanjeev Radhakrishnan 氏、Amit Joshi 氏、Ananta Iyengar 氏および [GreenBorder Technologies](https://www.greenborder.com/)
...
-   US マイクロソフトセキュリティ情報（MS05-018）  
    [https://www.microsoft.com/technet/security/bulletin/ms05-018.mspx](https://technet.microsoft.com/security/bulletin/ms05-018)
-   サポート技術情報 （KB） 文書番号 ：890859  
    [\[MS05-018\] Windows Kernel の脆弱性により、特権の昇格およびサービス拒否が起こる](https://support.microsoft.com/kb/890859)
