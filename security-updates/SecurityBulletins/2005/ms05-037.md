...
-   US マイクロソフトセキュリティ情報（MS05-037）  
    [https://www.microsoft.com/technet/security/bulletin/MS05-037.mspx](https://technet.microsoft.com/security/bulletin/ms05-037)
-   サポート技術情報 （KB） 文書番号 ：903235  
    [\[MS05-037\] JView プロファイラの脆弱性によりリモートでコードが実行される](https://support.microsoft.com/kb/903235)
