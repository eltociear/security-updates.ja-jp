...
[](http://www.microsoft.com/japan/security/bulletins/ms05-046e.mspx)
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=261a7d4d-90fc-4529-9c4a-b630196c6a83&amp;displaylang=ja"><img src="../../images/Dn610036.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=261a7d4d-90fc-4529-9c4a-b630196c6a83&amp;displaylang=ja-nec"><img src="../../images/Dn610036.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4c1c2c16-99e7-4701-a3f8-65b803b8b881&amp;displaylang=ja"><img src="../../images/Dn610036.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8ab86ba3-54cd-44d7-8016-de6e3ed51021&amp;displaylang=ja"><img src="../../images/Dn610036.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><img src="../../images/Dn610036.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
...
![](../../images/Dn610036.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](http://update.microsoft.com/microsoftupdate/) からインストールすることもできます。  
...
|---------------------------------------------------------------------------------------------------------------------------|------------------------------|--------------|---------------------------|---------------------------|---------------------|  
| NetWare 用クライアントサービスの脆弱性 - [CAN-2005-1985](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1985) | リモートでコードが実行される | 重要         | 重要                      | 重要                      | 重要                |
...
IPX および SPX に関する詳細情報は、次の[マイクロソフトの Web サイト](http://msdn2.microsoft.com/en-us/library/ms817906.aspx)（英語情報） をご覧ください。
...
-   **TCP** **ポート** **139** **および** **445** **をファイアウォールでブロックする**
    ...
    これらのポートは、影響を受けるコンポーネントとの接続を開始するために使用されます。送信および受信のエンタープライズのファイアウォールでこれらのポートをブロックすると、ファイアウォールの背後のコンピュータを、この脆弱性を悪用した攻撃から保護する手助けとなります。そのほかのポートを悪用する可能性のある攻撃を防ぐため、すべてのインターネットからの受信者側が送信を要求していない受信通信をブロックすることを推奨します。ポートに関する詳細情報は、次の[Web サイト](http://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/cnet/cnfc_por_gdqc.mspx?mfr=true) をご覧ください。
  
-   **ネットワークベースでのこの脆弱性の悪用を防ぐ手助けのために、**[**インターネット接続ファイアウォール**](http://www.microsoft.com/japan/athome/security/protect/)**などの個人用ファイアウォールを使用します。これは、Windows XP** **および** **Windows Server 2003** **に含まれているものです。**
...
NetWare 用クライアント サービス (CSNW) は、クライアントが NetWare のファイル、印刷およびディレクトリ サービスを行なえるようにするものです。 マイクロソフトおよび Novell がこの目的でクライアント サービスを提供しています。 それぞれ、NetWare 用 Microsoft クライアント サービスおよび Microsoft® Windows® XP 用 Novell クライアントです。 この脆弱性は、NetWare 用 Microsoft クライアント サービスに影響を及ぼします。 NetWare のアクセスに関する詳細情報は、次の [Web サイト](http://msdn2.microsoft.com/en-us/library/ms817906.aspx) をご覧ください。 このサービスは、Windows 2000 Server の NetWare のゲートウェイ サービスとも呼ばれています。
...
この更新プログラムで、再起動を必要としない場合があります。必要なファイルが使用中である場合、この更新プログラムは再起動を必要とします。この動作が起きた場合、再起動するメッセージが表示されます。再起動が必要になる可能性を低減する手助けとするために、このセキュリティ更新プログラムをインストールする前に、すべての影響を受けるサービスを停止し、影響を受けるファイルを使用している可能性のあるすべてのアプリケーションを閉じてください。再起動が必要となる理由に関する詳細情報は、サポート技術情報 [887012](http://support.microsoft.com/kb/887012) をご覧ください。
...
-   US マイクロソフトセキュリティ情報（MS05-046）  
    [http://www.microsoft.com/technet/security/bulletin/MS05-046.mspx](http://technet.microsoft.com/security/bulletin/ms05-046)
-   サポート技術情報 （KB） 文書番号 ：899589  
    [\[MS05-046\] NetWare 用クライアント サービスの脆弱性により、リモートでコードが実行される](http://support.microsoft.com/kb/899589)
