...
[](https://www.microsoft.com/japan/security/bulletins/ms05-044e.mspx)
...
|                                                         | PC/AT                                                                                                                                                                                             | MU                                                                            |
|---------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows XP Service Pack 1                     | [![](../../images/Dn610034.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=351c63a3-ab62-418d-8678-3af791d73a29&displaylang=ja) | ![](../../images/Dn610034.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003                           | [![](../../images/Dn610034.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=4940cf64-e1fd-4e88-8980-3106be03bf12&displaylang=ja) | ![](../../images/Dn610034.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems | [![](../../images/Dn610034.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b715147b-de2d-4f14-9548-aff18641d0f3&displaylang=ja) | ![](../../images/Dn610034.mu_s(ja-JP,Security.10).gif) |

**影響を受けるコンポーネント** **:**

|                                                                               | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|-------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4 上の Internet Explorer 6 Service Pack 1 | [![](../../images/Dn610034.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=fcea60e5-9ea8-4216-ba4d-c85054892dbb&displaylang=ja) | [![](../../images/Dn610034.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=fcea60e5-9ea8-4216-ba4d-c85054892dbb&displaylang=ja-nec) | ![](../../images/Dn610034.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610034.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://windowsupdate.microsoft.com/) からインストールすることもできます。    
...
|-------------------------------------------------------------------------------------------------------------|--------------|---------------------------|---------------------|-----------------------------------------------------------------------------------------|
| FTP クライアントの脆弱性 - [CAN-2005-2126](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2126) | 改ざん       | 警告                      | 警告                | 警告                                                                                    |
...
MBSA に関する詳細は、[MBSA Web サイト](https://technet.microsoft.com/ja-jp/security/cc184924.aspx) をご覧下さい。MBSA 1.2.1 は、この脆弱性について Windows 2000 Service Pack 4 での検出をサポートしません。

MBSA 1.2.1 が現在検出しないプログラムに関する詳細情報は、サポート技術情報 [306460](https://support.microsoft.com/kb/306460) をご覧ください。
...
この更新プログラムは再起動を必要としない場合もあります。必要なファイルが使用中である場合、この更新プログラムは再起動を必要とします。この動作が起きた場合、再起動するメッセージが表示されます。再起動が必要となる理由に関する詳細情報は、マイクロソフト サポート技術情報 [887012](https://support.microsoft.com/kb/887012) をご覧ください。
...
Arpidfix.exe は、サポート技術情報 [904630](https://support.microsoft.com/kb/904630) で説明されている問題を解決するため、セキュリティ更新プログラムのインストーラにより使用されます。このファイルは、影響を受けるコンピュータにインストールされません。
...
-   US マイクロソフトセキュリティ情報（MS05-044）    
    [https://www.microsoft.com/technet/security/bulletin/ms05-044.mspx](https://technet.microsoft.com/security/bulletin/ms05-044)
-   サポート技術情報 （KB） 文書番号 ：905495  
    [\[MS05-044\] Windows FTP クライアントの脆弱性により、ファイルの転送場所が改ざんされる](https://support.microsoft.com/kb/905495)
