---
TOCTitle: 'MS05-036'
Title: 'マイクロソフト セキュリティ情報 MS05-036 - 緊急'
ms:assetid: 'ms05-036'
ms:contentKeyID: 61228729
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms05-036(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS05-036 - 緊急
===============================================

マイクロソフト カラー管理モジュールの脆弱性によりリモートでコードが実行される (901214)
--------------------------------------------------------------------------------------

公開日: 2005年7月13日 | 最終更新日: 2005年7月21日

[](https://www.microsoft.com/japan/security/bulletins/ms05-036e.mspx)
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fa8d18ec-ebf4-4c49-afa0-f6a215b3624f&amp;displaylang=ja"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fa8d18ec-ebf4-4c49-afa0-f6a215b3624f&amp;displaylang=ja-nec"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><img src="../../images/Dn610026.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c5bcf2db-adce-42bd-abee-1380f258158b&amp;displaylang=ja"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">-</td>
<td style="border:1px solid black;"><img src="../../images/Dn610026.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows XP Professional x64 Edition</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c54bb4ba-fb9b-4615-9bbe-ef6d3885467d&amp;displaylang=ja"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">-</td>
<td style="border:1px solid black;"><img src="../../images/Dn610026.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=44275ecb-2e79-4ce8-8269-e81219ce8f6c&amp;displaylang=ja"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">-</td>
<td style="border:1px solid black;"><img src="../../images/Dn610026.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=97a903bc-90e1-4fde-9487-1816c4a647bb&amp;displaylang=ja"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">-</td>
<td style="border:1px solid black;"><img src="../../images/Dn610026.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows Server 2003 x64 Edition</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=52167b42-8790-4965-9f26-dc5edc2e84f8&amp;displaylang=ja"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">-</td>
<td style="border:1px solid black;"><img src="../../images/Dn610026.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="odd">
...
![](../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機用または NEC PC-9800 シリーズ用の更新プログラムをダウンロードしてください。  
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。
  
![](../../images/Dn610026.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。  
...
ICC プロファイル フォーマットの タグ認証を処理する方法により、マイクロソフト カラー管理モジュールにリモートからコードが実行される脆弱性が存在します。
  
ユーザーが管理者特権でログオンしている場合、攻撃者がこの脆弱性を悪用し、影響を受けるコンピュータを完全に制御する可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。コンピュータでのユーザー権限が低い設定のアカウントを持つユーザーは、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。
...
|-----------------------------------------------------------------------------------------------------------------|------------------------------|-----------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|  
| カラー管理モジュールの脆弱性 - [CAN-2005-1219](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1219) | リモートでコードが実行される | 重要                  | 緊急         | 緊急                      | 緊急                      | 緊急                | 緊急                               |
...
はい。MBSA 1.2.1 によって、MBSA がサポートするプログラムのみを対象にこの更新プログラムが必要かどうか確認されます。MBSA に関する詳細は、[MBSA Web サイト](https://technet.microsoft.com/ja-jp/security/cc184924.aspx) をご覧ください。
  
**Microsoft Baseline Security Analyzer (MBSA) 2.0** **を使用して、この更新プログラムが必要であるかどうかを確認することはできますか?**
  
はい。MBSA 2.0 は、この更新プログラムが必要かどうかを確認します。MBSA 2.0 は Microsoft Update がサポートする製品用のセキュリティ更新プログラムを検出することができます。MBSA に関する詳細は、[MBSA Web サイト](https://technet.microsoft.com/ja-jp/security/cc184924.aspx) をご覧下さい。
...
#### 「カラー管理モジュールの脆弱性」 - CAN-2005-1219:
  
ICC プロファイルのフォーマットのタグの検証を処理する方法のため、リモートでコードが実行される脆弱性がマイクロソフトのカラー管理モジュールに存在します。 攻撃者は、リモートでコードが実行される可能性のある悪質なイメージ ファイルを作成することにより、ユーザーが悪質な Web サイトを訪問した場合、または悪質な電子メール メッセージを表示した場合、この脆弱性を悪用する可能性があります。攻撃者によりこの脆弱性が悪用された場合、影響を受けるコンピュータが完全に制御される可能性があります。
  
#### 「カラー管理モジュールの脆弱性」 の問題を緩和する要素 - CAN-2005-1219:
  
-   Web ベースの攻撃シナリオでは、この脆弱性の悪用を意図した Web ページが含まれる Web サイトを、攻撃者がホストしていることが攻撃者側の必要条件となります。攻撃者は、悪質な Web サイトにユーザーを強制的に訪問させることはできません。その代わり、通常、ユーザーに攻撃者の Web サイトへのリンクをクリックさせ、その Web サイトにユーザーを誘導することが攻撃者にとっての必要条件となります。  
...
#### 「カラー管理モジュールの脆弱性」 の回避策 - CAN-2005-1219:
  
この脆弱性の回避策は確認されていません。
  
#### 「カラー管理モジュールの脆弱性」 のよく寄せられる質問 - CAN-2005-1219:
...
Microsoft カラー管理 モジュールに未チェックのバッファが存在するためにこの脆弱性が起こります。
  
**マイクロソフトカラー管理モジュールとは何ですか?**
  
マイクロソフト カラー 管理 モジュールにより、オペレーティング システムが、異なるデバイスとアプリケーションで、一貫したカラー マッピングを行うことが出来ます。 さらに、このモジュールは一つのカラー スペースから別のものへと変換するために使用されます (例: RGB から CMYK) 。 カラー管理に関する詳細情報は、次の[Web サイト](https://www.microsoft.com/whdc/device/display/color/icmwp.mspx) (英語情報) をご覧ください。
  
**International Color Consortium (ICC)** **とは何ですか?**
  
The International Color Consortium はベンダー間の互換性を確保するために、ベンダーが色彩管理行うことにより標準化を提供する目的の団体です。カラー管理に関する詳細情報は、次の[Web サイト](https://www.color.org) (英語情報)をご覧ください。
...
攻撃者は、特別な細工をした悪質なイメージを作成して、ユーザーにこのイメージを表示させること、ローカル ファイルを表示させること、悪質なイメージを含む電子メールのメッセージをプレビューまたは、悪質なイメージを含む電子メールの添付を開かせようとするなどによって、脆弱性を悪用しようとします。次にこれらの行為は影響を受けるコンピュータにコードを実行させる可能性があります。
...
いいえ。Windows 98、Windows 98 Second Edition、および Windows Millennium Edition には影響を受けるコンポーネントが含まれますが、重大な攻撃ベクタで悪用できないため、この脆弱性の深刻度は「緊急」ではありません。 さらに、現在知られている攻撃のベクタがこの脆弱性を悪用するには、ユーザーの操作が必要になります。深刻度評価システムに関する詳細情報は、次の [Web サイト](https://technet.microsoft.com/security/bulletin/rating) をご覧ください。
  
**この更新プログラムは何を修正しますか?**
  
この更新プログラムは、割り当てられたバッファにデータを送る前に、マイクロソフト カラー管理モジュールが ICC のプロファイルの情報を検証する方法を修正することにより、この脆弱性に対応します。
...
**WindowsServer2003-KB901214-x86- JPN /quiet**
...
**WindowsServer2003-KB901214-x86-JPN /norestart**
...
システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。 Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB901214$\\Spuninst フォルダにあります。このユーティリティは次のセットアップ スイッチをサポートします。
...
|------------|---------------|-----------|-------|---------|----------|
| icm32.dll  | 5.2.3790.359  | 2005/6/29 | 14:11 | 239,616 | rtmgdr   |
| mscms.dll  | 5.2.3790.359  | 2005/6/29 | 14:11 | 70,656  | rtmgdr   |
| icm32.dll  | 5.2.3790.359  | 2005/6/29 | 14:09 | 239,616 | rtmqfe   |
| mscms.dll  | 5.2.3790.359  | 2005/6/29 | 14:09 | 70,656  | rtmqfe   |
| icm32.dll  | 5.2.3790.2476 | 2005/6/29 | 14:24 | 255,488 | sp1gdr   |
| mscms.dll  | 5.2.3790.2476 | 2005/6/29 | 14:24 | 75,264  | sp1gdr   |
| icm32.dll  | 5.2.3790.2476 | 2005/6/29 | 14:27 | 255,488 | sp1qfe   |
| mscms.dll  | 5.2.3790.2476 | 2005/6/29 | 14:27 | 75,264  | sp1qfe   |
...
|------------|---------------|-----------|-------|---------|------|-------------|
| icm32.dll  | 5.2.3790.359  | 2005/6/28 | 22:47 | 737,280 | IA64 | rtmgdr      |
| mscms.dll  | 5.2.3790.359  | 2005/6/28 | 22:47 | 212,992 | IA64 | rtmgdr      |
| wicm32.dll | 5.2.3790.359  | 2005/6/28 | 22:47 | 239,616 | x86  | rtmgdr\\wow |
| wmscms.dll | 5.2.3790.359  | 2005/6/28 | 22:47 | 70,656  | x86  | rtmgdr\\wow |
| icm32.dll  | 5.2.3790.359  | 2005/6/28 | 22:47 | 737,280 | IA64 | rtmqfe      |
| mscms.dll  | 5.2.3790.359  | 2005/6/28 | 22:47 | 212,992 | IA64 | rtmqfe      |
| wicm32.dll | 5.2.3790.359  | 2005/6/28 | 22:47 | 239,616 | x86  | rtmqfe\\wow |
| wmscms.dll | 5.2.3790.359  | 2005/6/28 | 22:47 | 70,656  | x86  | rtmqfe\\wow |
| icm32.dll  | 5.2.3790.2476 | 2005/6/28 | 22:47 | 737,280 | IA64 | sp1gdr      |
| mscms.dll  | 5.2.3790.2476 | 2005/6/28 | 22:47 | 228,864 | IA64 | sp1gdr      |
| wicm32.dll | 5.2.3790.2476 | 2005/6/28 | 22:47 | 255,488 | x86  | sp1gdr\\wow |
| wmscms.dll | 5.2.3790.2476 | 2005/6/28 | 22:47 | 75,264  | x86  | sp1gdr\\wow |
| icm32.dll  | 5.2.3790.2476 | 2005/6/28 | 22:47 | 737,280 | IA64 | sp1qfe      |
| mscms.dll  | 5.2.3790.2476 | 2005/6/28 | 22:47 | 228,864 | IA64 | sp1qfe      |
| wicm32.dll | 5.2.3790.2476 | 2005/6/28 | 22:47 | 255,488 | x86  | sp1qfe\\wow |
| wmscms.dll | 5.2.3790.2476 | 2005/6/28 | 22:47 | 75,264  | x86  | sp1qfe\\wow |
...
| ファイル名 | バージョン    | 日付      | 時間  | サイズ  | CPU | フォルダ    |
|------------|---------------|-----------|-------|---------|-----|-------------|
| icm32.dll  | 5.2.3790.2476 | 2005/6/28 | 22:47 | 292,352 | x64 | sp1gdr      |
| mscms.dll  | 5.2.3790.2476 | 2005/6/28 | 22:47 | 154,112 | x64 | sp1gdr      |
| wicm32.dll | 5.2.3790.2476 | 2005/6/28 | 22:47 | 255,488 | x86 | sp1gdr\\wow |
| wmscms.dll | 5.2.3790.2476 | 2005/6/28 | 22:47 | 75,264  | x86 | sp1gdr\\wow |
| icm32.dll  | 5.2.3790.2476 | 2005/6/28 | 22:47 | 292,352 | x64 | sp1qfe      |
| mscms.dll  | 5.2.3790.2476 | 2005/6/28 | 22:47 | 154,112 | x64 | sp1qfe      |
| wicm32.dll | 5.2.3790.2476 | 2005/6/28 | 22:47 | 255,488 | x86 | sp1qfe\\wow |
| wmscms.dll | 5.2.3790.2476 | 2005/6/28 | 22:47 | 75,264  | x86 | sp1qfe\\wow |
...
-   **レジストリキーの確認**
    ...
    **注:** このレジストリ キーには、インストールされるファイルの完全な一覧が含まれない場合があります。また、管理者または OEM メーカーによって901214 のセキュリティ更新プログラムを Windows インストール ソース ファイルに統合またはスリップストリーム化されている場合、このレジストリ キーが適切に作成されない場合があります。
...
**WindowsXP-KB901214-x86-JPN.exe /quiet**

**注:** /quiet スイッチを使用すると、すべてのメッセージが表示されなくなります。 これは、エラー メッセージを表示しなくなることも含みます。 管理者は /quiet スイッチを使用する場合、インストールが正常に完了したことを確認するためのサポートされている方法の 1 つを使用してください。 また、管理者はこのスイッチを使用する場合、エラー メッセージについて KB901214.log ファイルを確認してください。

コンピュータを強制的に再起動せずにセキュリティ更新プログラムをインストールするためには、Windows XP のコマンド プロンプトで次のコマンドを使用してください。

**WindowsXP-KB901214-x86-JPN.exe /norestart**
...
| ファイル名 | バージョン    | 日付      | 時間  | サイズ  | フォルダ |
|------------|---------------|-----------|-------|---------|----------|
| icm32.dll  | 5.1.2600.1710 | 2005/6/29 | 10:55 | 237,056 | sp1qfe   |
| mscms.dll  | 5.1.2600.1710 | 2005/6/29 | 10:55 | 68,608  | sp1qfe   |
| icm32.dll  | 5.1.2600.2709 | 2005/6/29 | 10:49 | 254,976 | sp2gdr   |
| mscms.dll  | 5.1.2600.2709 | 2005/6/29 | 10:49 | 74,240  | sp2gdr   |
| icm32.dll  | 5.1.2600.2709 | 2005/6/29 | 10:53 | 254,976 | sp2qfe   |
| mscms.dll  | 5.1.2600.2709 | 2005/6/29 | 10:53 | 73,728  | sp2qfe   |
...
Windows 2000 に関して、このセキュリティ更新プログラムを適用するには、Service Pack 4 (SP4) がインストールされている必要があります。Small Business Server 2000 にこのセキュリティ更新プログラムを適用するには、Windows 2000 Server Service Pack 4 (SP4) に Small Business Server 2000 Service Pack 1a (SP1a) または Small Business Server 2000 がインストールされている必要があります。詳細情報は、サポート技術情報 [322389](https://support.microsoft.com/kb/322389) をご覧ください。
...
|------------|----------------|-----------|------|---------|
| icm32.dll  | 5.0.0.3        | 2005/6/29 | 0:31 | 246,032 |
| mscms.dll  | 5.00.2195.7054 | 2005/6/29 | 0:31 | 69,904  |
...
-   **レジストリキーの確認**
    ...
    **注:** このレジストリ キーには、インストールされるファイルの完全な一覧が含まれない場合があります。また、管理者または OEM メーカーによって 901214 のセキュリティ更新プログラムを Windows インストール ソース ファイルに統合またはスリップストリーム化されている場合、このレジストリ キーが適切に作成されない場合があります。
...
-   カラー管理モジュールの脆弱性 (CAN-2005-1219) を報告してくださった[Information & Communication Security Technology Center (ICST)](https://www.icst.org.tw/) のShih-hao Weng 氏
...
-   US マイクロソフトセキュリティ情報（MS05-036）  
    [https://www.microsoft.com/technet/security/bulletin/MS05-036.mspx](https://technet.microsoft.com/security/bulletin/ms05-036)
-   サポート技術情報 （KB） 文書番号 ：901214  
    [\[MS05-036\] マイクロソフト カラー管理モジュールの脆弱性によりリモートでコードが実行される](https://support.microsoft.com/kb/901214)

**更新履歴** **:**

-   2005/07/13: このセキュリティ情報ページを公開しました。
-   2005/07/21: 「再起動の必要性」の情報を更新しました。
