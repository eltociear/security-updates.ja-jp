...
[](https://www.microsoft.com/japan/security/bulletins/ms05-039e.mspx)
...
|                                                                                                                                 | PC/AT                                                                                                                                                                                                | PC-9800                                                                                                                                                                                               | MU                                                                            |
|---------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                           | [![](../../images/Dn610029.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e39a3d96-1c37-47d2-82ef-0ac89905c88f&displaylang=ja)    | [![](../../images/Dn610029.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e39a3d96-1c37-47d2-82ef-0ac89905c88f&displaylang=ja-nec) | ![](../../images/Dn610029.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                  | [![](../../images/Dn610029.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=9a3bfbdd-62ea-4db2-88d2-415e095e207f&displaylang=ja)    | -                                                                                                                                                                                                     | ![](../../images/Dn610029.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                   | [![](../../images/Dn610029.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=89d90e25-4773-4782-ad06-9b7517bab3c8&displaylang=ja)    | -                                                                                                                                                                                                     | ![](../../images/Dn610029.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                               | [![](../../images/Dn610029.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6275d7b7-dab1-47c8-8745-533eb471072c&displaylang=ja)    | -                                                                                                                                                                                                     | ![](../../images/Dn610029.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems | [![](../../images/Dn610029.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=be18d39d-3e4c-4c6f-b841-2ccd8d4c3f50&displaylang=ja)    | -                                                                                                                                                                                                     | ![](../../images/Dn610029.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                       | [![](../../images/Dn610029.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=d976316d-3b17-4ad4-9198-513ffdac98e4%20&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610029.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610029.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。  
...
|-----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|--------------|------------|---------------------|
| プラグ アンド プレイの脆弱性 - [CAN-2005-1983](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1983) | リモートでコードが実行され、ローカルの特権の昇格が行なわれる | 緊急         | 重要       | 重要                |
...
プラグ アンド プレイにリモートでコードが実行される脆弱性およびローカルでの [特権の昇格](https://www.microsoft.com/japan/security/glossary.mspx) が存在し、これにより、攻撃者がこの脆弱性を悪用し、影響を受けるコンピュータを完全に制御する可能性があります。
...
**注:** Internetwork Packet Exchange (IPX) および Sequenced Packet Exchange (SPX) のようなほかのプロトコルはこの問題に対して脆弱性を持つ可能性があります。 IPX や SPX のような脆弱性の影響を受けるプロトコルを使用している場合、これらのプロトコルについて適切なポートをブロックしてください。 IPX および SPX に関する情報は [Microsoft Web site](https://msdn2.microsoft.com/en-us/library/ms817906.aspx) をご覧ください。.
...
-   **TCP** **ポート** **139** **および** **445** **をファイアウォールでブロックする**
    ...
    これらのポートは、影響を受けるプロトコルとの接続を開始するために使用されます。送信および受信のファイアウォールでこれらのポートをブロックすると、ファイアウォールの背後のコンピュータを、この脆弱性を悪用した攻撃から保護する手助けとなります。そのほかのポートを悪用する可能性のある攻撃を防ぐため、すべてのインターネットからの受信者側が送信を要求していない受信通信をブロックすることを推奨します。ポートに関する詳細情報は、次の [Web サイト](https://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/cnet/cnfc_por_gdqc.mspx?mfr=true) (英語情報) をご覧ください。

-   **ネットワークベースでのこの脆弱性の悪用を防ぐ手助けのために、Windows XP Service Pack 1** **に含まれている**[**インターネット接続ファイアウォール**](https://www.microsoft.com/japan/athome/security/protect/windowsxp/firewall.aspx)**などの個人用ファイアウォールを使用します。**
...
[プラグ アンド プレイ](https://www.microsoft.com/technet/prodtechnol/windows2000pro/evaluate/featfunc/plugplay.mspx) (PnP) (英語情報) は、オペレーティング システムがコンピュータに新規のハードウェアをインストールした場合、それを検知することができます。 例えば、新しいマウスをコンピュータにインストールした場合、PnP により Windows がそれを検知して、必要なドライバをダウンロードし、Windows が新しいマウスの使用を開始します。
...
はい。Windows 2000 で匿名のユーザーおよび Windows XP Service Pack 1 で認証されたユーザーによって悪用される可能性があります。ファイアウォールによる最善策および標準の既定の構成により、インターネット経由での攻撃からコンピュータを保護することができます。マイクロソフトはどのようにコンピュータを保護するかについての情報を提供しています。ホーム ユーザーの方は、[Protect Your PC Web サイト](https://www.microsoft.com/japan/athome/security/protect/default.aspx) をご覧ください。IT プロフェッショナルは、[セキュリティ ガイダンス センター](https://www.microsoft.com/japan/security/guidance/default.mspx) をご覧ください。 Windows XP Service Pack 2 および Windows Server 2003 では、攻撃の対象となる特定のコンピュータが攻撃者によってログオンされて攻撃が行なわれる場合があります。 この脆弱性が悪用されても、攻撃者によりリモートからプログラムがダウンロードされる、または実行されることはありません。
...
Arpidfix.exe は、サポート技術情報 [904630](https://support.microsoft.com/kb/904630) にある問題に対処するために、セキュリティ更新プログラムのインストーラにより使用されます。 このファイルは影響を受けるコンピュータにインストールされていません。
...
-   「プラグ アンド プレイの脆弱性」 (CAN-2005-1983) を報告してくださった [ISS X-Force](https://www.iss.net/) の Neel Mehta 氏
-   影響を受けるコンポーネントに関連する問題について協力してくださった、[Herve Schauer Consultants](https://www.hsc.fr/) の Jean-Baptiste Marchand 氏
...
-   US マイクロソフトセキュリティ情報（MS05-039）  
    [https://www.microsoft.com/technet/security/bulletin/ms05-039.mspx](https://technet.microsoft.com/security/bulletin/ms05-039)
-   サポート技術情報 （KB） 文書番号 ：899588  
    [\[MS05-039\] プラグ アンド プレイの脆弱性により、リモートでコードが実行され、特権の昇格が行われる](https://support.microsoft.com/kb/899588)
