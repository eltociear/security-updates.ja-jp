...
[](https://www.microsoft.com/japan/security/bulletins/ms05-040e.mspx)
...
|                                                                                                                                                                                            | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                                                                                      | [![](../../images/Dn610030.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c7417ea1-7afc-4a55-95dc-e814975b8ae6&displaylang=ja) | [![](../../images/Dn610030.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c7417ea1-7afc-4a55-95dc-e814975b8ae6&displaylang=ja-nec) | ![](../../images/Dn610030.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                                                                             | [![](../../images/Dn610030.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b049004b-af28-41d7-8ae6-7a3db15211f1&displaylang=ja) |                                                                                                                                                                                                       | ![](../../images/Dn610030.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                                                                              | [![](../../images/Dn610030.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=705545d0-b53b-4e17-8b62-a4c652697c61&displaylang=ja) |                                                                                                                                                                                                       | ![](../../images/Dn610030.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                                                                                          | [![](../../images/Dn610030.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=0097fe14-1d6b-4423-a437-dea1ed665a07&displaylang=ja) |                                                                                                                                                                                                       | ![](../../images/Dn610030.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems                                                            | [![](../../images/Dn610030.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=bc16beae-0bad-490c-a80f-4bf81c360ca0&displaylang=ja) |                                                                                                                                                                                                       | ![](../../images/Dn610030.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                                                                                  | [![](../../images/Dn610030.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=0cef9cc2-a7bd-42e0-81b1-edc303da8a40&displaylang=ja) |                                                                                                                                                                                                       | ![](../../images/Dn610030.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610030.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。  
...
|------------------------------------------------------------------------------------------------------------------|------------------------------|-----------------------|--------------|------------|---------------------|
| テレフォニー サービスの脆弱性 - [CAN-2005-0058](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-0058) | リモートでコードが実行される | 緊急でない            | 重要         | 重要       | 重要                |
...
-   **ファイアウォールで以下のポートをブロックする**
    ...
    これらのポートは、RPC との接続を開始するために使用されます。RPC は Windows 2000 Server および Windows Server 2003 のテレフォニー サービスとリモートで通信するために使用できます。これらをファイアウォールでブロックすると、この脆弱性の悪用の試行からファイアウォールの背後のコンピュータを保護する手助けとなります。また、リモート コンピュータでそのほかの特別に構成されている RPC ポートがブロックされていることを確認して下さい。そのほかのポートを悪用する可能性のある攻撃を防ぐため、すべてのインターネットからの受信者側が送信を要求していない受信通信をブロックすることを推奨します。RPC が使用するポートに関する詳細は、次の [Web サイト](https://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/cnet/cnfc_por_gdqc.mspx?mfr=true) （英語情報） をご覧ください

-   **ネットワークベースでのこの脆弱性の悪用を防ぐ手助けを行うために、**[**インターネット接続ファイアウォール**](https://www.microsoft.com/japan/athome/security/protect/windowsxp/firewall.aspx)**などの個人用ファイアウォールを使用します。これは** **Windows Server 2003** **に含まれているものです。**
...
-   **ネットワークベースでこの脆弱性が悪用されることを防ぐ手助けを行うために、影響を受けるコンピュータ上の** **IPsec** **を使用して影響を受けるポートをブロックします。**
    ...
    Internet Protocol Security (IPsec) を使用し、ネットワーク通信を保護します。IPsec およびフィルタの適用方法に関する詳細は、サポート技術情報 [313190](https://support.microsoft.com/kb/313190) および [813878](https://support.microsoft.com/kb/813878) をご覧ください。

#### 「テレフォニー サービスの脆弱性」のよく寄せられる質問 - CAN-2005-0058:

**どのようなことが起こる可能性がありますか?**

オペレーティング システムのバージョンおよび構成により、この脆弱性で、リモートでコードが実行される、または [ローカルで特権の昇格](https://www.microsoft.com/japan/security/glossary.mspx)が行われる可能性があります。詳細情報は、よく寄せられる質問の「主にどのようなコンピュータがこの脆弱性による危険にさらされますか?」をご覧ください。
...
コールを行う、受け取ることに加え、プログラムは TAPI を使用して発信者番号、コール ルーティング、ボイス メール、ビデオ カンファレンスなどの高度なテレフォニー機能を提供することができます。通信プログラムは発信者を識別し、発信者情報のリコール、表示を行い、また顧客情報に基づきコールの優先順位の決定またはルートを行うこともできます。TAPI に関する詳細情報は、次の [Web サイト](https://msdn2.microsoft.com/en-us/library/aa922068.aspx) (英語情報) をご覧ください。
...
テレフォニー サーバーとして構成されている Windows 2000 Server が主に匿名の攻撃者によるこの脆弱性の悪用の危険にさらされます。しかし、Windows 2000 Server コンピュータをテレフォニー サーバーとして構成するためには、管理者はいくつかのステップを行う必要があります。これらのステップについては、次の [Web サイト](https://support.microsoft.com/kb/259375/en) (英語情報) をご覧ください｡

テレフォニー サーバーとして構成されている Windows Server 2003 は匿名の攻撃者によるこの脆弱性の悪用の危険にさらされます。しかし、Windows Server 2003 コンピュータをテレフォニー サーバーとして構成するためには、管理者はいくつかのステップを行う必要があります。これらのステップについては、次の [Web サイト](https://msdn2.microsoft.com/en-us/library/aa922068.aspx) (英語情報) をご覧ください。
...
いいえ。Windows 98、Windows 98 Second Edition、および Windows Millennium Edition には、影響を受けるコンポーネントが含まれていますが、その脆弱性の深刻度は、「緊急」ではありません。 深刻度評価システムに関する詳細情報は、次の [Web サイト](https://technet.microsoft.com/security/bulletin/rating)をご覧下さい。
...
このセキュリティ情報で使用されている用語 （修正プログラムなど） に関しては、サポート技術情報 [824684](https://support.microsoft.com/kb/824684) をご覧ください。Arpidfix.exe は、サポート技術情報 [904630](https://support.microsoft.com/kb/904630) で説明されている問題を解決するため、セキュリティ更新プログラムのインストーラにより使用されます。 このファイルは影響を受けるコンピュータにインストールされません。
...
-   US マイクロソフトセキュリティ情報（MS05-040）  
    [https://www.microsoft.com/technet/security/bulletin/ms05-040.mspx](https://technet.microsoft.com/security/bulletin/ms05-040)
-   サポート技術情報 （KB） 文書番号 ：893756  
    [\[MS05-040\] テレフォニー サービスの脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/893756)
