...
[](https://www.microsoft.com/japan/security/bulletins/ms05-043e.mspx)
...
**警告** **:** [908506](https://support.microsoft.com/kb/908506) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。 また、このサポート技術情報には、これらの問題に対する推奨される解決策に関する説明も記載されています。 詳細情報は、サポート技術情報 [908506](https://support.microsoft.com/kb/908506) をご覧ください。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3dd3b530-7f43-4c18-8298-6e8797431a5d&amp;displaylang=ja"><img src="../../images/Dn610033.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3dd3b530-7f43-4c18-8298-6e8797431a5d&amp;displaylang=ja-nec"><img src="../../images/Dn610033.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ef402946-1c3b-47e9-9d51-77d890df8725&amp;displaylang=ja"><img src="../../images/Dn610033.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=25469675-df28-4889-8d13-25efcd498388&amp;displaylang=ja"><img src="../../images/Dn610033.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><img src="../../images/Dn610033.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f0aec064-34a3-4ee4-9f15-be1e3dd02bc7&amp;displaylang=ja"><img src="../../images/Dn610033.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><img src="../../images/Dn610033.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
...
![](../../images/Dn610033.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。  
...
|----------------------------------------------------------------------------------------------------------|------------------------------|--------------|---------------------------|---------------------------|---------------------|  
| 印刷スプーラ の脆弱性 - [CAN-2005-1984](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1984) | リモートでコードが実行される | 緊急         | 緊急                      | 警告                      | 警告                |
...
マイクロソフト サポート技術情報 [908506](https://support.microsoft.com/kb/908506): Windows 2000 Service Pack 4 を実行しているコンピュータにセキュリティ更新プログラム 896423 をインストールした後に、ネットワーク プリンタに印刷することができません。
...
-   US マイクロソフトセキュリティ情報（MS05-043）  
    [https://www.microsoft.com/technet/security/bulletin/ms05-043.mspx](https://technet.microsoft.com/security/bulletin/ms05-043)
-   サポート技術情報 （KB） 文書番号 ：896423  
    [\[MS05-043\] 印刷スプーラの脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/896423)
