...
| Microsoft Windows Server 2003 x64 Edition                                                                                       | [![](../../images/Dn610041.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=1ff26142-6e1e-4e17-9dcd-994b339a69cf&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610041.mu_s(ja-JP,Security.10).gif) |
...
-   **ネットワーク** **DTC** **アクセスを無効にする**
    ...
    5.  **［セキュリティの構成］** のダイアログ ボックスで、**［ネットワーク** **DTC** **アクセス］** のチェック ボックスのチェックをはずします。
        ...
        **注:** また、この設定はグループ ポリシーを使用した複数のコンピュータの設定に適用可能です。グループ ポリシーに関する詳細は、次の [Web サイト](https://www.microsoft.com/japan/windowsserver2003/technologies/management/grouppolicy/default.mspx)をご覧下さい。
...
Arpidfix.exe は、 サポート技術情報 [904630](https://support.microsoft.com/kb/904630) にある問題に対処するために、セキュリティ更新プログラムのインストーラにより使用されます。 このファイルは影響を受けるコンピュータにインストールされません。
...
最新のサービス パックの入手方法に関する詳細情報は、サポート技術情報 [260910](https://support.microsoft.com/kb/260910) をご覧下さい。
...
-   「MSDTCの脆弱性」 (CAN-2005-2119) を報告してくださった [eEye Digital Security](https://www.eeye.com/)
-   「COM+ の脆弱性」 (CAN-2005-1978) を報告してくださった [Argeniss](https://www.argeniss.com/) の Cesar Cerrudo 氏
-   「TIP の脆弱性」 (CAN-2005-1979) および 「分散型 TIP の脆弱性」 (CAN-2005-1980) を報告してくださった [iDefense](https://www.idefense.com/)
...
<https://www.microsoft.com/japan/windowsserversystem/sus/default.mspx>
...
-   US マイクロソフトセキュリティ情報（MS05-051）  
    [https://www.microsoft.com/technet/security/bulletin/MS05-051.mspx](https://technet.microsoft.com/security/bulletin/ms05-051)
-   サポート技術情報 （KB） 文書番号 ：902400  
    [\[MS05-051\] MSDTC および COM+ の脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/902400)
