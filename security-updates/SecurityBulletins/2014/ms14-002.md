...
[Windows XP Service Pack 3](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=6cae1016-419a-47ab-9765-b4c1d7c0865c)  
(2914368)
</td>
<td style="border:1px solid black;">
特権の昇格
...
<td style="border:1px solid black;">
[MS10-099](https://go.microsoft.com/fwlink/?linkid=206365) の 2440591
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=c1094864-2576-4770-9d2d-3dae33ddecb6)  
(2914368)
</td>
<td style="border:1px solid black;">
特権の昇格
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=6d50f851-4be3-413f-b02d-b5b6a3f49fb4)  
(2914368)
</td>
<td style="border:1px solid black;">
特権の昇格
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=69966ceb-a9c9-4aa7-b685-78562c96640f)  
(2914368)
</td>
<td style="border:1px solid black;">
特権の昇格
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 with SP2 for Itanium-based Systems](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=0b1c1309-8b6f-4342-92aa-6cb5cb2abe6a)  
(2914368)
</td>
<td style="border:1px solid black;">
特権の昇格
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2013-5065](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5065) を参照してください。
...
NDPROXY とは何ですか?  
NDPROXY はシステムが提供するドライバーで、WAN ミニポート ドライバー、コール マネージャー、およびミニポート コール マネージャーを Telephony Application Programming Interfaces (TAPI) サービスにインターフェイスで連結します。詳細については、「[NDPROXY Overview](https://msdn.microsoft.com/library/ff568322(vs.85).aspx)」 (英語) を参照してください。
...
はい。この脆弱性は一般で公開されていました。この脆弱性には Common Vulnerability and Exposure の [CVE-2013-5065](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5065) が割り当てられています。[マイクロソフト セキュリティ アドバイザリ 2914486](https://technet.microsoft.com/ja-jp/security/advisory/2914486) で、この脆弱性を最初に説明しました。
