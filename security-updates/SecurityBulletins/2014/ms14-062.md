...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=1464260a-c3a9-436c-b345-e1b64325ab4f)  
(2993254)
...
<td style="border:1px solid black;">
[MS09-040](https://go.microsoft.com/fwlink/?linkid=155979) の 971032

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=fd8c0b32-dd8b-461a-a110-43a076435f77)  
(2993254)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 with SP2 for Itanium-based Systems](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=b0b35a54-9178-4724-89e2-94cace12abc8)  
(2993254)
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2014-4971](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4971) をご覧ください。
...
-   グループ ポリシーを使用
    ...
    **注:** Windows Server 2003 セキュリティ ガイドも参考にすることができます。このガイドには、サービスを無効にする方法の説明が含まれています。
    ...
    -   [Step-by-Step Guide to Understanding the Group Policy Feature Set (英語情報)](https://technet.microsoft.com/ja-jp/library/bb742376.aspx)
    -   [Windows 2000 Group Policy (英語情報)](https://technet.microsoft.com/ja-jp/library/bb742376.aspx)
    -   [Group Policy in Windows Server 2003 (英語情報)](https://www.microsoft.com/windowsserver2003/technologies/management/grouppolicy/default.mspx)
         
...
はい。この脆弱性は一般で公開されていました。これは Common Vulnerability and Exposure の [CVE-2014-4971](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4971) にアサインされています。
