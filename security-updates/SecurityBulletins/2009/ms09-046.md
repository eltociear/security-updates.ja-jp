...
[](https://www.microsoft.com/japan/security/bulletins/ms09-046e.mspx)[![](../../images/Dn627129.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
**既知の問題:** サポート技術情報 [956844](https://support.microsoft.com/kb/956844/en-us) (英語情報) には、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。また、これらの問題に対する推奨される解決策についても説明しています。なお、既知の問題および推奨される解決策がこのソフトウェアの特定のリリースにのみ該当する場合は、サポート技術情報に関連のリンクを掲載します。

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS09-046.mspx](https://technet.microsoft.com/security/bulletin/ms09-046)
...
|------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                      | [![](../../images/Dn627129.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6dd4b0f8-6b54-49a6-a6df-9420f9fd3333&displaylang=ja) | [![](../../images/Dn627129.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6dd4b0f8-6b54-49a6-a6df-9420f9fd3333&displaylang=ja-nec) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows XP Service Pack 2 および Windows XP Service Pack 3 | [![](../../images/Dn627129.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8523d5be-88a2-4124-9b02-660f612e2a12&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows XP Professional x64 Edition Service Pack 2         | [![](../../images/Dn627129.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=dbc33f6b-61bf-409a-89b5-60002192e0e0&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Server 2003 Service Pack 2                         | [![](../../images/Dn627129.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=7478f73f-dd20-4cfa-a650-4c84f37ada2f&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 警告           | なし                                                     |
| Windows Server 2003 x64 Edition Service Pack 2             | [![](../../images/Dn627129.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=88bf502d-1a7c-447a-ac4c-401e1698669b&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 警告           | なし                                                     |
| Windows Server 2003 with SP2 for Itanium-based Systems     | [![](../../images/Dn627129.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8d881ff8-f51f-4476-8cb6-2bebd5b2047f&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 警告           | なし                                                     |
...
この脆弱性はセキュリティ情報 [MS09-037](https://technet.microsoft.com/security/bulletin/ms09-037) で説明した Microsoft Active Template Library (ATL) に存在する脆弱性とは関連はありません。DHTML 編集コンポーネントの ActiveX コントロールの脆弱性は影響を受けるバージョンの ATL に起因していません。
...
<th style="border:1px solid black;" >DHTML 編集コンポーネントの ActiveX コントロールの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2519">CVE-2009-2519</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2009-2519](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2519) をご覧ください。
...
- **DHTML の ActiveX コントロールの COM オブジェクトが Internet Explorer で実行されないようにする**
  ...
  **警告：** レジストリ エディターを正しく使用しないと、深刻な問題が生じ、オペレーティング システムの再インストールが必要になる場合があります。マイクロソフトは、レジストリ エディターを正しく使用しない場合に起こる問題の解決について、保証はできません。レジストリ エディターは、お客様各自の責任において使用してください。
  ...
  ```
  [HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Internet Explorer\ActiveX Compatibility\{ 2D360201-FFF5-11D1-8D03-00A0C959BC0A}]"Compatibility Flags"=dword:00000400
  ```
...
DHTML 編集コンポーネントの ActiveX コントロールは、HTML エディターを提供します。開発者は、これをソフトウェアの動的な Web サイトの HTML 編集をサポートするために使用することができます。DHTML 編集コンポーネントの ActiveX コントロールに関する詳細情報は、MSDN コラム [Introduction to MSHTML Editing](https://msdn.microsoft.com/library/aa753630(vs.85).aspx) (英語情報) の「The DHTML Editing Component」(英語情報) をご覧ください。
...
-   DHTML 編集コンポーネントの ActiveX コントロールの脆弱性 - [CVE-2009-2519](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2519) の 問題を報告してくださった [Google Inc.](https://www.google.com/) の Tavis Ormandy 氏
