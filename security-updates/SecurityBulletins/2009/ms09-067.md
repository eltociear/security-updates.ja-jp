...
[](https://www.microsoft.com/japan/security/bulletins/ms09-067e.mspx)[![](../../images/Dn627150.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
**既知の問題:** マイクロソフト サポート技術情報 [972652](https://support.microsoft.com/kb/972652) には、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明されています。また、これらの問題に対する推奨される解決策についても説明しています。なお、既知の問題および推奨される解決策がこのソフトウェアの特定のリリースにのみ該当する場合は、サポート技術情報に関連のリンクを掲載します。

**USマイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS09-067.mspx](https://technet.microsoft.com/security/bulletin/ms09-067)
...
<td style="border:1px solid black;">
[![](../../images/Dn627150.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5672c8fc-8509-4962-ad86-ebc0f2575043&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627150.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6a6a0f5d-17dc-4a34-b9a0-0774aa287ba5&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627150.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=322b24ca-aff6-4ca0-acf1-440cae0f9693&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627150.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8f115b1c-1e28-4ecf-937c-99c4b60c7c8e&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627150.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b84fe57d-ddda-451e-9ead-69e10aee7928&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627150.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=4dd4bc05-1217-497e-8f65-4347f2544ed6&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627150.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=19151e22-5642-456c-bd39-298574369cdb&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627150.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=fb36df5e-ebef-46bf-9edd-67f2c76dbdb3&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627150.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c4c92d2e-e87d-446f-8d3e-8f4be10c70aa&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
\* Microsoft Office Excel 2007 Service Pack 1 および Microsoft Office Excel 2007 Service Pack 2 について、KB973593 に加え、お客様は [Word/Excel/PowerPoint 2007 ファイル形式用 Microsoft Office 互換機能パック Service Pack 1 および Word/Excel/PowerPoint 2007 ファイル形式用 Microsoft Office 互換機能パック Service Pack 2 用のセキュリティ更新プログラム (KB973704)](https://www.microsoft.com/download/details.aspx?familyid=c4c92d2e-e87d-446f-8d3e-8f4be10c70aa&displaylang=ja) をインストールして、このセキュリティ情報で説明している脆弱性から防御する必要があります。
...
サポート技術情報 [972652](https://support.microsoft.com/kb/972652) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。
...
次の深刻度の評価は脆弱性による影響が最大であった場合を前提としています。このセキュリティ情報のリリース後 30 日以内に、深刻度の評価およびセキュリティ上の影響に関連する脆弱性が悪用される可能性に関する情報は、[11 月のセキュリティ情報](https://technet.microsoft.com/security/bulletin/ms09-nov)の「Exploitability Index (悪用可能性指標)」のセクションをご覧ください。詳細については、[Microsoft Exploitability Index (悪用可能性指標)](https://technet.microsoft.com/security/cc998259.aspx)をご覧ください。
...
<th style="border:1px solid black;" >
Excel のキャッシュ メモリ破損の脆弱性 - [CVE-2009-3127](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3127)
</th>
<th style="border:1px solid black;" >
Excel の SxView メモリ破損の脆弱性 - [CVE-2009-3128](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3128)
</th>
<th style="border:1px solid black;" >
Excel の Featheader レコード メモリ破損の脆弱性 - [CVE-2009-3129](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3129)
</th>
<th style="border:1px solid black;" >
Excel のドキュメント解析のヒープ オーバーフローの脆弱性 - [CVE-2009-3130](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3130)
</th>
<th style="border:1px solid black;" >
Excel の式解析のメモリ破損の脆弱性 - [CVE-2009-3131](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3131)
</th>
<th style="border:1px solid black;" >
Excel のインデックス解析の脆弱性 - [CVE-2009-3132](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3132)
</th>
<th style="border:1px solid black;" >
Excel のドキュメント解析のメモリ破損の脆弱性 - [CVE-2009-3133](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3133)
</th>
<th style="border:1px solid black;" >
Excel のフィールドのサニタイズの脆弱性 - [CVE-2009-3134](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3134)
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2009-3127](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3127) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2009-3128](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3128) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2009-3129](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3129) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2009-3130](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3130) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2009-3131](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3131) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2009-3132](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3132) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2009-3133](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3133) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2009-3134](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3134) をご覧ください。
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/japan/mac/downloads.mspx)から Microsoft Office 2004 for Mac 11.5.6 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/japan/mac/downloads.mspx)から Microsoft Office 2008 for Mac 12.2.3 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/japan/mac/downloads.mspx)から Open XML File Format Converter for Mac 1.1.3 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
-   Excel のキャッシュ メモリ破損の脆弱性 - [CVE-2009-3127](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2009-3127) を報告してくださった [Fortinet の FortiGuard Labs](https://www.fortiguardcenter.com/) の Bing Liu 氏
-   Excel のキャッシュ メモリ破損の脆弱性 - [CVE-2009-3127](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3127) を報告してくださった [TippingPoint](https://www.tippingpoint.com/) および [Zero Day Initiative](https://www.zerodayinitiative.com/)
-   Excel の SxView メモリ破損の脆弱性 - [CVE-2009-3128](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2009-3128) を報告してくださった [Fortinet の FortiGuard Labs](https://www.fortiguardcenter.com/) の Bing Liu 氏
-   Excel の Featheader レコード メモリ破損の脆弱性 - [CVE-2009-3129](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3129) を報告してくださった [VeriSign iDefense Labs](https://labs.idefense.com/) の Sean Larsson 氏
-   Excel の Featheader レコード メモリ破損の脆弱性 - [CVE-2009-3129](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3129) 報告してくださった [TippingPoint](https://www.tippingpoint.com/) および [Zero Day Initiative](https://www.zerodayinitiative.com/) に協力している匿名のリサーチャー
-   Excel のドキュメント解析のヒープ オーバーフローの脆弱性 - [CVE-2009-3130](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3130) を報告してくださった、[VUPEN Security](https://www.vupen.com/) の Nicolas Joly 氏
-   Excel の式解析のメモリ破損の脆弱性 - [CVE-2009-3131](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3131) を報告してくださった、[VUPEN Security](https://www.vupen.com/) の Nicolas Joly 氏
-   Excel のインデックス解析の脆弱性 - [CVE-2009-3132](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3132) を報告してくださった、[VUPEN Security](https://www.vupen.com/) の Nicolas Joly 氏
-   Excel のドキュメント解析のメモリ破損の脆弱性 - [CVE-2009-3133](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3133) を報告してくださった、[VUPEN Security](https://www.vupen.com/) の Nicolas Joly 氏
-   Excel のフィールドのサニタイズの脆弱性 - [CVE-2009-3134](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2009-3134) を報告してくださった [Fortinet の FortiGuard Labs](https://www.fortiguardcenter.com/) の Bing Liu 氏
