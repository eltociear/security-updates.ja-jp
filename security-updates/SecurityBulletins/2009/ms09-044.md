...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS09-044.mspx](https://technet.microsoft.com/security/bulletin/ms09-044)
...
<td style="border:1px solid black;">
[![](../../images/Dn627127.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=027e757d-08d5-4932-b8c4-52ee1be1c864&displaylang=ja)  
...
-   「リモート デスクトップ接続のヒープ オーバーフローの脆弱性」 - [CVE-2009-1133](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1133) の問題を Zero Day Initiative と協力して報告してくださった Team509 の Wushi 氏
-   リモート デスクトップ接続の ActiveX コントロールのヒープ オーバーフローの脆弱性 ([CVE-2009-1929](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1929) を報告してくださった [Palo Alto Networks](https://www.paloaltonetworks.com/) の Yamata Li 氏
