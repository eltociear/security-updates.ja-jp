...
| Windows Server 2003 with SP2 for Itanium-based Systems                                                              | [![](../../images/Dn627112.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=7df0fce2-543c-4e82-85e6-012bfc8bf130&displaylang=ja)     | -                                                                                                                                                                                                         | リモートでコードが実行される | 緊急           | なし                                                                |
...
-   Embedded OpenType フォントのヒープ オーバーフローの脆弱性 - [CVE-2009-0231](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0231) を報告してくださった [VeriSign iDefense Labs](https://labs.idefense.com/)
-   Embedded OpenType フォントのヒープ オーバーフローの脆弱性 - [CVE-2010-0231](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0231) を報告してくださった [Google Inc.](https://www.google.com/) の Tavis Ormandy 氏
-   Embedded OpenType フォントの整数オーバーフローの脆弱性 - [CVE-2009-0232](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0232) を報告してくださった Thomas Garnier 氏
