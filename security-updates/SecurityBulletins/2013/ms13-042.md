...
<td style="border:1px solid black;">
[Microsoft Publisher 2003 Service Pack 3](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=9b186d45-ace4-44ff-9510-f478b918ec5d)  
(2810047)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
...
<td style="border:1px solid black;">
[MS11-091](https://go.microsoft.com/fwlink/?linkid=235287) の 2553084
</td>
</tr>
...
<td style="border:1px solid black;">
[Microsoft Publisher 2007 Service Pack 3](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=8f8af5d3-76b2-4ff8-a35b-e04d3458159f)  
(2597971)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
...
<td style="border:1px solid black;">
[MS11-091](https://go.microsoft.com/fwlink/?linkid=235287) の 2596705
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Publisher 2010 Service Pack 1 (32 ビット版)](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=2524228d-5e6f-4520-b18b-668309e71a9d)  
(2553147)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
...
<td style="border:1px solid black;">
[Microsoft Publisher 2010 Service Pack 1 (64 ビット版)](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=bc3bedf6-9ee1-4de5-a6e4-cb92cbb16acc)  
(2553147)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
...
| 脆弱性のタイトル                                      | CVE 番号                                                                         |  
|-------------------------------------------------------|----------------------------------------------------------------------------------|  
| Publisher の負の値割り当ての脆弱性                    | [CVE-2013-1316](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1316) |  
| Publisher の整数オーバーフローの脆弱性                | [CVE-2013-1317](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1317) |  
| Publisher のインターフェイス ポインターの破損の脆弱性 | [CVE-2013-1318](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1318) |  
| Publisher の戻り値処理の脆弱性                        | [CVE-2013-1319](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1319) |  
| Publisher のバッファー オーバーフローの脆弱性         | [CVE-2013-1320](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1320) |  
| Publisher の戻り値検証の脆弱性                        | [CVE-2013-1321](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1321) |  
| Publisher の無効な範囲チェックの脆弱性                | [CVE-2013-1322](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1322) |  
| Publisher の誤った NULL 値処理の脆弱性                | [CVE-2013-1323](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1323) |  
| Publisher の符号付き整数の脆弱性                      | [CVE-2013-1327](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1327) |  
| Publisher のポインター処理の脆弱性                    | [CVE-2013-1328](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1328) |  
| Publisher のバッファー アンダーフローの脆弱性         | [CVE-2013-1329](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1329) |
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2810047/ja">サポート技術情報 2810047</a> を参照してください。</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2597971/ja">サポート技術情報 2597971</a> を参照してください。</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">ファイル に関する情報</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2553147/ja">サポート技術情報 2553147</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">レジストリ キーの確認</td>
<td style="border:1px solid black;">対象外</td>
