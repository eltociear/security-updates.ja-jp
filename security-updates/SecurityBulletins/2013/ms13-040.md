...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=e18cab6d-f588-43df-8855-3617fa616bd3)  
(2804577)
</td>
<td style="border:1px solid black;">
なりすまし
...
<td style="border:1px solid black;">
[MS10-041](https://go.microsoft.com/fwlink/?linkid=185042) の 979909
</td>
</tr>
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 4](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=ea9610d3-7d1a-4ebc-931a-ad69d6b30199)<sup>[1]</sup>
(2804576)
</td>
<td style="border:1px solid black;">
なりすまし
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=4556068b-25b3-4049-bab7-ed0f44ac24a0)  
(2804580)
</td>
<td style="border:1px solid black;">
なりすまし
...
<td style="border:1px solid black;">
[MS10-041](https://go.microsoft.com/fwlink/?linkid=185042) の 979910
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 4.5](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=5f7e0dc6-e4a3-492d-88ff-5614bc63c13f)  
(2804582)
</td>
<td style="border:1px solid black;">
なりすまし
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5.1](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=386e6d49-7514-4d21-b760-13bbe09e4856)  
(2804579)
</td>
<td style="border:1px solid black;">
なりすまし
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=02b0f58d-d251-40cd-b4c8-75bb0e3eaedd)  
(2804584)
</td>
<td style="border:1px solid black;">
なりすまし
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 4.5](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=e8b9c923-59ae-45d9-ba0e-ee2d239e0300)  
(2804583)
</td>
<td style="border:1px solid black;">
なりすまし
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2013-1336](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1336) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2013-1337](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1337) を参照してください。

#### 問題を緩和する要素

緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。

-   既定では、WCF 認証モードは [userNamePasswordValidationMode](https://msdn.microsoft.com/ja-jp/library/system.servicemodel.security.usernamepasswordservicecredential.usernamepasswordvalidationmode.aspx) プロパティで "Windows" に設定されます。これは脆弱性の影響を受けません。

#### 回避策

回避策は、根本的な脆弱性を正すものではありませんが、更新プログラムを適用するまでの間、既知の攻撃方法の阻止に役立つ設定または構成の変更を示します。マイクロソフトは次の回避策をテストし、回避策が機能性を低下させるかどうかの情報を提供しています。

-   [netHttpsBinding](https://msdn.microsoft.com/ja-jp/library/system.servicemodel.nethttpsbinding) ではなく [netHttpBinding](https://msdn.microsoft.com/library/system.servicemodel.nethttpbinding) を [TransportWithMessageCredential](https://msdn.microsoft.com/ja-jp/library/ms789011) と使用します。
...
何が原因で起こりますか?   
この脆弱性は、.NET Framework が [netHttpsBinding](https://msdn.microsoft.com/ja-jp/library/system.servicemodel.nethttpsbinding) または [basicHttpsBinding](https://msdn.microsoft.com/ja-jp/library/system.servicemodel.basichttpsbinding) クラスに固有な [userNamePasswordValidationMode](https://msdn.microsoft.com/library/ja-jp/system.servicemodel.security.usernamepasswordservicecredential.usernamepasswordvalidationmode) パラメーターを使用して、カスタム WCF エンドポイント認証をセットアップするときに認証のためのポリシー要件を正しく作成しないために起こります。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2836440/ja">サポート技術情報 2836440</a> を参照してください。</td>
</tr>
<tr class="even">
...
| ファイルに関する情報 | [サポート技術情報 2836440](https://support.microsoft.com/kb/2836440/ja) を参照してください。                                                                       |
