---
TOCTitle: 'MS13-008'
Title: 'マイクロソフト セキュリティ情報 MS13-008 - 緊急'
ms:assetid: 'ms13-008'
ms:contentKeyID: 61229468
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms13-008(v=Security.10)'
---
...
このセキュリティ更新プログラムは 1 件の Internet Explorer に存在する一般で公開された脆弱性を解決します。この脆弱性により、ユーザーが Internet Explorer を使用して特別に細工された Web ページを表示すると、リモートでコードが実行される可能性があります。この脆弱性が悪用された場合、攻撃者が現在のユーザーと同じユーザー権限を取得する可能性があります。コンピューターでのユーザー権限が低い設定のアカウントを持つユーザーは、管理者特権で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。

このセキュリティ更新プログラムは、Windows クライアント上の Internet Explorer 6、Internet Explorer 7 および Internet Explorer 8 について深刻度を「緊急」と評価し、Windows サーバー上の Internet Explorer 6、Internet Explorer 7 および Internet Explorer 8 について深刻度を「警告」と評価しています。Internet Explorer 9 および Internet Explorer 10 は影響を受けません。詳細情報については、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションを参照してください。
...
このセキュリティ更新プログラムは、[マイクロソフト セキュリティ アドバイザリ 2794220](https://technet.microsoft.com/ja-jp/security/advisory/2794220) で最初に説明した脆弱性も解決します。
...
この更新プログラム MS13-008 は、Internet Explorer 用の累積的なセキュリティ更新プログラムですか?   
いいえ。このセキュリティ更新プログラム MS13-008 は、このセキュリティ情報で説明されている脆弱性のみを解決します。

Internet Explorer の最新の累積的なセキュリティ 更新プログラム MS12-077 をインストールする必要がありますか?   
はい。どのような場合でも、MS13-008 はこのセキュリティ情報で説明している脆弱性からお客様を防御します。ただし、Internet Explorer 用の最新の累積的なセキュリティ更新プログラムをインストールしていない場合、MS13-008 更新プログラムをインストールした後で互換性の問題が発生する可能性があります。

互換性の問題を回避するために、お客様は、Internet Explorer 用の最新の累積的なセキュリティ更新プログラム [MS12-077](https://go.microsoft.com/fwlink/?linkid=268393) がインストールされていることを確認する必要があります。

マイクロソフト セキュリティアドバイザリ 2794220 で説明した Internet Exploer 用の自動化された Microsoft Fix it ソリューションを適用した場合、この更新プログラムの適用前に、回避策を元に戻す必要がありますか?  
[マイクロソフト セキュリティ アドバイザリ 2794220](https://technet.microsoft.com/ja-jp/security/advisory/2794220) で Microsoft Fix it ソリューション「MSHTML Shim 回避策」を実装したお客様は、この更新プログラムを適用する前に Microsoft Fix it ソリューションを元に戻す必要はありません。
...
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの情報については、[マイクロソフト サポート技術情報 2799329](https://support.microsoft.com/kb/2799329/ja) を参照してください。
...
<th style="border:1px solid black;" >
Internet Explorer の解放後使用の脆弱性 - CVE-2012-4792
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-4792](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4792) を参照してください。

#### 「Internet Explorer の解放後使用の脆弱性」の問題を緩和する要素 - CVE-2012-4792
...
#### 「Internet Explorer の解放後使用の脆弱性」の回避策 - CVE-2012-4792

回避策は、根本的な脆弱性を正すものではありませんが、更新プログラムを適用するまでの間、既知の攻撃方法の阻止に役立つ設定または構成の変更を示します。マイクロソフトは次の回避策をテストし、回避策が機能性を低下させるかどうかの情報を提供しています。

-   この問題の悪用を阻止する Microsoft Fix it ソリューション「MSHTML Shim 回避策」を適用してください。

    自動化された Microsoft Fix it ソリューションを使用してこの回避策を有効または無効にする方法については、[サポート技術情報 2799329](https://support.microsoft.com/kb/2799329/ja) を参照してください。
...
#### 「Internet Explorer の解放後使用の脆弱性」のよく寄せられる質問 - CVE-2012-4792
...
はい。この脆弱性は一般で公開されていました。この脆弱性には Common Vulnerability and Exposure の [CVE-2012-4792](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4792) が割り当てられています。[マイクロソフト セキュリティ アドバイザリ 2794220](https://technet.microsoft.com/ja-jp/security/advisory/2794220) で、この脆弱性を最初に説明しました。

このセキュリティ情報の公開時に、マイクロソフトはこの脆弱性が悪用されたという報告を受けていましたか?   
はい。マイクロソフトは Internet Explorer 8 の脆弱性を悪用しようとする標的型攻撃を確認しました。
...
WindowsXP-KB2799329-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 用の Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB2799329-x64-JPN.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows XP 用の Internet Explorer 7:<br />
IE7-WindowsXP-KB2799329-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 用の Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB2799329-x64-JPN.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows XP 用の Internet Explorer 8:<br />
IE8-WindowsXP-KB2799329-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 用の Internet Explorer 8:<br />
IE8-WindowsServer2003.WindowsXP-KB2799329-x64-JPN.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows XP 用の Internet Explorer 6:<br />
WindowsXP-KB2799329-x86-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 用の Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB2799329-x64-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows XP 用の Internet Explorer 7:<br />
IE7-WindowsXP-KB2799329-x86-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 用の Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB2799329-x64-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows XP 用の Internet Explorer 8:<br />
IE8-WindowsXP-KB2799329-x86-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 用の Internet Explorer 8:<br />
IE8-WindowsServer2003.WindowsXP-KB2799329-x64-JPN.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">すべてのサポートされているエディションの Windows XP 用の Internet Explorer 6:<br />
[コントロール パネル] の [プログラムの追加と削除]または %Windir%\$NTUninstallKB2799329$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされているエディションの Windows XP 用の Internet Explorer 7:<br />
[コントロール パネル] の[プログラムの追加と削除] または %Windir%\ie7updates\KB2799329-IE7\spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされているエディションの Windows XP 用の Internet Explorer 8:<br />
[コントロール パネル] の[プログラムの追加と削除] または %Windir%\ie8updates\KB2799329-IE8\spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2799329/ja">サポート技術情報 2799329</a> を参照してください。</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2799329-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2799329-ia64-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003 用の Internet Explorer 7:<br />
IE7-WindowsServer2003-KB2799329-x86-JPN.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003-KB2799329-ia64-JPN.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003 用の Internet Explorer 8:<br />
IE8-WindowsServer2003-KB2799329-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003 用の Internet Explorer 6:<br />
WindowsServer2003-KB2799329-x86-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003 用の Internet Explorer 6:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003 用の Internet Explorer 6:<br />
WindowsServer2003-KB2799329-ia64-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003 用の Internet Explorer 7:<br />
IE7-WindowsServer2003-KB2799329-x86-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003 用の Internet Explorer 7:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003 用の Internet Explorer 7:<br />
IE7-WindowsServer2003-KB2799329-ia64-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003 用の Internet Explorer 8:<br />
IE8-WindowsServer2003-KB2799329-x86-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003 用の Internet Explorer 8:<br />
...
-   Internet Explorer の解放後使用の脆弱性 (CVE-2012-4792) についてマイクロソフトに協力してくださった [Exodus Intelligence](https://www.exodusintel.com)
...
-   V1.0 (2013/01/15):このセキュリティ情報ページを公開しました。
