...
[Windows 8 for 32-bit Systems](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=a6a65ec6-cfdd-458c-835b-f8c7a803f1df)  
(2829254)
</td>
<td style="border:1px solid black;">
サービス拒否
...
<td style="border:1px solid black;">
[Windows 8 for 64-bit Systems](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=db3fa389-b1f1-4431-aafa-0354416a521a)  
(2829254)
</td>
<td style="border:1px solid black;">
サービス拒否
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=53b182bc-700a-4c55-81fd-2d4eb910badf)  
(2829254)
</td>
<td style="border:1px solid black;">
サービス拒否
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=53b182bc-700a-4c55-81fd-2d4eb910badf) (Server Core インストール)  
(2829254)
</td>
<td style="border:1px solid black;">
サービス拒否
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2013-1305](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1305) を参照してください。
...
-   エンタープライズの境界ファイアウォールで TCP ポート 80 および 443 をブロックする  
    ...
    回避策の解除方法:エンタープライズの境界領域のファイアウォールで TCP ポート 80 および 443 のブロックを解除します。ポートの詳細については、TechNet の記事 [TCP and UDP Port Assignments (英語情報)](https://go.microsoft.com/fwlink/?linkid=21312) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2829254/ja">サポート技術情報 2829254</a> を参照してください。</td>
</tr>
<tr class="odd">
...
| ファイルに関する情報 | [サポート技術情報 2829254](https://support.microsoft.com/kb/2829254/ja) を参照してください。                                                                       |
