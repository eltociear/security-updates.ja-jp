...
<td style="border:1px solid black;">
[MS13-009](https://go.microsoft.com/fwlink/?linkid=275670) の 2792100
</td>
</tr>
...
<td style="border:1px solid black;">
[MS13-009](https://go.microsoft.com/fwlink/?linkid=275670) の 2792100 および [MS13-010](https://go.microsoft.com/fwlink/?linkid=275837) の 2797052
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| 脆弱性のタイトル                                              | CVE 番号                                                                         |
|---------------------------------------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer OnResize の解放後使用の脆弱性               | [CVE-2013-0087](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0087) |
| Internet Explorer saveHistory の解放後使用の脆弱性            | [CVE-2013-0088](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0088) |
| Internet Explorer CMarkupBehaviorContext の解放後使用の脆弱性 | [CVE-2013-0089](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0089) |
| Internet Explorer CCaret の解放後使用の脆弱性                 | [CVE-2013-0090](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0090) |
| Internet Explorer CElement の解放後使用の脆弱性               | [CVE-2013-0091](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0091) |
| Internet Explorer GetMarkupPtr の解放後使用の脆弱性           | [CVE-2013-0092](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0092) |
| Internet Explorer onBeforeCopy の解放後使用の脆弱性           | [CVE-2013-0093](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0093) |
| Internet Explorer removeChild の解放後使用の脆弱性            | [CVE-2013-0094](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0094) |
| Internet Explorer CTreeNode の解放後使用の脆弱性              | [CVE-2013-1288](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1288) |
...
| CVE 番号                                                                         | 一般に公開 |
|----------------------------------------------------------------------------------|------------|
| [CVE-2013-0087](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0087) | なし       |
| [CVE-2013-0088](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0088) | なし       |
| [CVE-2013-0089](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0089) | なし       |
| [CVE-2013-0090](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0090) | なし       |
| [CVE-2013-0091](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0091) | なし       |
| [CVE-2013-0092](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0092) | なし       |
| [CVE-2013-0093](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0093) | なし       |
| [CVE-2013-0094](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0094) | なし       |
| [CVE-2013-1288](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1288) | あり       |
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2809289/ja">サポート技術情報 2809289</a> を参照してください。</td>
</tr>
<tr class="even">
...
| ファイルに関する情報 | [サポート技術情報 2809289](https://support.microsoft.com/kb/2809289/ja) を参照してください。                                                                                                                                                                                                                                    |
...
-   Internet Explorer CCaret の解放後使用の脆弱性 (CVE-2013-0090) を報告してくださった [Harmony Security](https://www.harmonysecurity.com/) の Stephen Fewer 氏  
...
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して Internet Explorer onBeforeCopy の解放後使用の脆弱性 (CVE-2013-0093) を報告してくださった [Aniway.Aniway@gmail.com](mailto:aniway.aniway@gmail.com) 氏  
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して Internet Explorer removeChild の解放後使用の脆弱性 (CVE-2013-0094) を報告してくださった Simon Zuckerbraun 氏  
