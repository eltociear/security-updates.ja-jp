---
TOCTitle: 'MS13-015'
Title: 'マイクロソフト セキュリティ情報 MS13-015 - 重要'
ms:assetid: 'ms13-015'
ms:contentKeyID: 61229475
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms13-015(v=Security.10)'
---

 

マイクロソフト セキュリティ情報 MS13-015 - 重要
===============================================
...
このセキュリティ更新プログラムは、非公開で報告された 1 件の .NET Framework の脆弱性を解決します。この脆弱性により、ユーザーが特別に細工された Web ページを XAML ブラウザー アプリケーション (XBAP) を使用して表示した場合、特権の昇格が起こる可能性があります。この脆弱性は、コード アクセス セキュリティ (CAS) の制限を回避する目的で Windows .NET アプリケーションで悪用される可能性もあります。この脆弱性が悪用された場合、攻撃者が現在のユーザーと同じユーザー権限を取得する可能性があります。コンピューターでのユーザー権限が低い設定のアカウントを持つユーザーは、管理者特権で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。
...
このセキュリティ更新プログラムは、ユーザーから提供されたコールバックを実行する際に .NET Framework が特権を昇格させる方法を修正して、脆弱性を解決します。これらの脆弱性の詳細については、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」を参照してください。
...
<td style="border:1px solid black;">
[](https://go.microsoft.com/fwlink/?linkid=251095)[MS12-038](https://go.microsoft.com/fwlink/?linkid=251095)</a> の KB2686828 は KB2789643 に置き換えられます。  
[](https://go.microsoft.com/fwlink/?linkid=251095)[MS12-038](https://go.microsoft.com/fwlink/?linkid=251095)</a> の KB2686827 は KB2789642 に置き換えられます。
</td>
</tr>
...
<td style="border:1px solid black;">
[](https://go.microsoft.com/fwlink/?linkid=251095)[MS12-038](https://go.microsoft.com/fwlink/?linkid=251095)</a> の KB2686833 は KB2789646 に置き換えられます。  
[](https://go.microsoft.com/fwlink/?linkid=251095)[MS12-038](https://go.microsoft.com/fwlink/?linkid=251095)</a> の KB2686827 は KB2789642 に置き換えられます。  
KB2789648 に置き換えられる更新プログラムはありません。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-038](https://go.microsoft.com/fwlink/?linkid=251095) の KB2686830 は KB2789644 に置き換えられます。  
[MS12-038](https://go.microsoft.com/fwlink/?linkid=251095) の KB2686827 は KB2789642 に置き換えられます。
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-038](https://go.microsoft.com/fwlink/?linkid=251095) の KB2686831 は KB2789645 に置き換えられます。  
[MS12-038](https://go.microsoft.com/fwlink/?linkid=251095) の KB2686827 は KB2789642 に置き換えられます。  
KB2789648 に置き換えられる更新プログラムはありません。
</td>
</tr>
...
(KB2789645)  
[Microsoft .NET Framework 4](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=182f4d35-f18b-4485-be22-43becbd3cc05)<sup>[1]</sup> (Server Core インストール)  
(KB2789642)  
...
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの情報については、[マイクロソフト サポート技術情報 2800277](https://support.microsoft.com/kb/2800277/ja) を参照してください。
...
<th style="border:1px solid black;" >
WinForms のコールバックの昇格の脆弱性 - CVE-2013-0073
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
特定のWindows フォーム オブジェクトの作成時に .NET Framework がコールバック機能の特権を昇格させる方法に、特権の昇格の脆弱性が存在します。攻撃者がこの脆弱性の悪用に成功した場合、影響を受けるシステムを完全に制御する可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除などを行ったり、完全なユーザー権限を持つ新たなアカウントを作成したりする可能性があります。コンピューターでのユーザー権限が低い設定のアカウントを持つユーザーは、管理者特権で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。

特定の WinForms オブジェクトの作成時に .NET Framework がコールバック機能の特権を適切に昇格させないことが原因でこの脆弱性が起こります。

Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2013-0073](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0073) を参照してください。

#### 「WinForms のコールバックの昇格の脆弱性」の問題を緩和する要素 - CVE-2013-0073
...
#### 「WinForms のコールバックの昇格の脆弱性」の回避策 - CVE-2013-0073
...
#### 「WinForms のコールバックの昇格の脆弱性」のよく寄せられる質問 - CVE-2013-0073
...
この更新プログラムは、ユーザーから提供されたコールバックを実行する際に .NET Framework が特権を昇格させる方法を修正して、脆弱性を解決します。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2800277/ja">サポート技術情報 2800277</a> を参照してください。</td>
</tr>
<tr class="odd">
...
| /norestart | いずれかの修正プログラムで再起動が必要な場合でも、メッセージを表示せず、再起動も行いません。 |
| /uninstall | セキュリティ更新プログラムをアンインストールします。                                         |

注 Windows Installer ベースのソフトウェアの更新プログラムのコマンド ライン スイッチに関する詳細情報は、[コマンド ラインオプション](https://msdn.microsoft.com/ja-jp/library/aa367988)を参照してください。
...
Microsoft .NET Framework 2.0 Service Pack 2 向けセキュリティ更新プログラムは、次のセットアップ スイッチをサポートします。
...
注 wusa.exe インストーラのコマンド ライン スイッチに関する詳細情報は、[Windows ソフトウェア更新プログラム パッケージのコマンド ライン スイッチ](https://support.microsoft.com/kb/262841/ja)をご覧ください。
...
注 Windows Installer ベースのソフトウェアの更新プログラムのコマンド ライン スイッチに関する詳細情報は、[コマンド ライン オプション](https://msdn.microsoft.com/ja-jp/library/aa367988)を参照してください。
...
-   WinForms のコールバックの昇格の脆弱性 (CVE-2013-0073) を報告してくださった [Context Information Security](https://www.contextis.com/) の James Forshaw 氏
