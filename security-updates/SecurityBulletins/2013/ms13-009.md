...
既知の問題: [マイクロソフト サポート技術情報 2792100](https://support.microsoft.com/kb/2792100/ja) で、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。
...
<td style="border:1px solid black;">
[MS12-077](https://go.microsoft.com/fwlink/?linkid=268393) の KB2761465 および [MS13-008](https://go.microsoft.com/fwlink/?linkid=275222) の KB2799329
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-077](https://go.microsoft.com/fwlink/?linkid=268393) の KB2761465
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<sup>[1]</sup> この更新プログラムは、[Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) を通じてのみ入手可能です。
...
はい。この Internet Explorer 用の累積的なセキュリティ更新プログラムは、[MS13-008](https://go.microsoft.com/fwlink/?linkid=275222) で説明されている脆弱性を解決します。この更新プログラムで以前のどの更新プログラムが置き換えられるかの詳細については、「影響を受けるソフトウェアおよび影響を受けないソフトウェア」セクションの「置き換えられる更新プログラム」を参照してください。

Windows 7 用の Internet Explorer 10 Release Preview は、このセキュリティ情報で説明されている脆弱性の影響を受けますか?   
はい。KB2792100 の更新プログラムは、Windows 7 for 32-bit Systems Service Pack 1 および Windows 7 for x64-based Systems Service Pack 1 用の Internet Explorer 10 Release Preview で利用できます。Windows 7 for 32-bit Systems Service Pack 1 および Windows 7 for x64-based Systems Service Pack 1 用の Internet Explorer 10 Release Preview をご使用のお客様は、システムにこれらの更新プログラムを適用することをお勧めします。この更新プログラムは [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) で利用可能です。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2013-0015](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0015) を参照してください。
...
| 脆弱性のタイトル                                      | CVE 番号                                                                         |
|-------------------------------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer SetCapture の解放後使用の脆弱性     | [CVE-2013-0018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0018) |
| Internet Explorer COmWindowProxy の解放後使用の脆弱性 | [CVE-2013-0019](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0019) |
| Internet Explorer CMarkup の解放後使用の脆弱性        | [CVE-2013-0020](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0020) |
| Internet Explorer vtable の解放後使用の脆弱性         | [CVE-2013-0021](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0021) |
| Internet Explorer LsGetTrailInfo の解放後使用の脆弱性 | [CVE-2013-0022](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0022) |
| Internet Explorer CDispNode の解放後使用の脆弱性      | [CVE-2013-0023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0023) |
| Internet Explorer pasteHTML の解放後使用の脆弱性      | [CVE-2013-0024](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0024) |
| Internet Explorer SLayoutRun の解放後使用の脆弱性     | [CVE-2013-0025](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0025) |
| Internet Explorer InsertElement の解放後使用の脆弱性  | [CVE-2013-0026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0026) |
| Internet Explorer CPasteCommand の解放後使用の脆弱性  | [CVE-2013-0027](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0027) |
| Internet Explorer CObjectElement の解放後使用の脆弱性 | [CVE-2013-0028](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0028) |
| Internet Explorer CHTML の解放後使用の脆弱性          | [CVE-2013-0029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0029) |
...
-   既定で、すべてのサポートされているバージョンの Microsoft Outlook、Microsoft Outlook Express および Windows メールは、HTML 形式の電子メール メッセージを制限付きサイト ゾーンで開きます。制限付きサイト ゾーンはスクリプトおよび ActiveX コントロールを無効にし、これらの脆弱性を悪用して悪意のあるコードを実行しようとする攻撃のリスクを軽減するのに役立ちます。しかし、ユーザーが電子メール メッセージのリンクをクリックすると、Web ベースの攻撃のシナリオで悪用された脆弱性の影響を受ける可能性があります。
-   既定で、Windows Server 2003、Windows Server 2008、Windows Server 2008 R2、および Windows Server 2012 上の Internet Explorer は、「[セキュリティ強化の構成](https://technet.microsoft.com/ja-jp/library/dd883248)」と呼ばれる制限されたモードで実行されます。このモードにより、これらの脆弱性の影響が緩和されます。Internet Explorer のセキュリティ強化の構成に関する詳細情報については、この脆弱性に関する「よく寄せられる質問」を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2792100/ja">サポート技術情報 2792100</a> を参照してください。</td>
</tr>
<tr class="even">
...
| 適用                                |                                                                                                                                                                                                                                                                                                                                |  
|                                     | この更新プログラムは、[Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) を通じてのみ入手可能です。                                                                                                                                                                                                                |  
| 再起動の必要性                      |                                                                                                                                                                                                                                                                                                                                |  
...
| ファイルに関する情報                | [サポート技術情報 2792100](https://support.microsoft.com/kb/2792100/ja) を参照してください。                                                                                                                                                                                                                                    |
...
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して、Internet Explorer SetCapture の解放後使用の脆弱性 (CVE-2013-0018) を報告してくださった [Omair](https://krash.in/) 氏  
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して、 Internet Explorer COmWindowProxy の解放後使用の脆弱性 (CVE-2013-0019) を報告してくださった SkyLined 氏  
-   Exodus Intelligence と協力して、Internet Explorer CMarkup の解放後使用の脆弱性 (CVE-2013-0020) を報告してくださった Arthur Gerkis 氏  
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して、Internet Explorer CMarkup の解放後使用の脆弱性 (CVE-2013-0020) を報告してくださった [Harmony Security](https://www.harmonysecurity.com/) の Stephen Fewer 氏  
-   Internet Explorer vtable の解放後使用の脆弱性 (CVE-2013-0021) を報告してくださった Tencent PC Manager  
-   Internet Explorer LsGetTrailInfo の解放後使用の脆弱性 (CVE-2013-0022) を報告してくださった [Omair](https://krash.in/) 氏  
-   [HP](https://www.hpenterprisesecurity.com/products)の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して、Internet Explorer CDispNode の解放後使用の脆弱性 (CVE-2013-0023) を報告してくださった Arthur Gerkis 氏  
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して、Internet Explorer pasteHTML の解放後使用の脆弱性 (CVE-2013-0024) を報告してくださった匿名のリサーチャー様  
-   Internet Explorer SLayoutRun の解放後使用の脆弱性 (CVE-2013-0025) を報告してくださった [Security-Assessment.com](https://www.security-assessment.com) の Scott Bell 氏  
...
-   Internet Explorer CObjectElement の解放後使用の脆弱性 (CVE-2013-0028) を報告してくださった [Security-Assessment.com](https://www.security-assessment.com) の Scott Bell 氏  
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して Internet Explorer CObjectElement の解放後使用の脆弱性 (CVE-2013-0028) を報告してくださった Yenteasy Security Research の Jose A Vazquez 氏  
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して、Internet Explorer CHTML の解放後使用の脆弱性 (CVE-2013-0029) を報告してくださった [Harmony Security](https://www.harmonysecurity.com/) の Stephen Fewer 氏  
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して、Internet Explorer CHTML の解放後使用の脆弱性 (CVE-2013-0029) を報告してくださった [Aniway.Aniway@gmail.com](mailto:aniway.aniway@gmail.com) 氏  
-   このセキュリティ情報に含まれている追加の多層防御の変更についてマイクロソフトと協力してくださった [NCC Group](https://www.nccgroup.com/) の Ollie Whitehouse 氏
