...
既知の問題: [マイクロソフト サポート技術情報 2769327](https://support.microsoft.com/kb/2769327/ja) で、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。
...
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの情報については、[マイクロソフト サポート技術情報 2769327](https://support.microsoft.com/kb/2769327/ja) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2013-0005](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0005) を参照してください。
...
-   ファイアーウォールで OData Web アプリケーションをブロックする
    ...
    OData ポートは通常、TCP ポート 80 とポート 443 でサポートされますが、他の非標準ポートでサポートされる場合もあります。組織の環境を検証し、組織のファイアウォールで、OData サービスをホストするすべてのポートで受信接続と発信接続をブロックすると、この脆弱性を悪用した攻撃からコンピューターを保護できます。そのほかのポートを悪用する可能性のある攻撃を防ぐため、インターネットからの受信者側が送信を要求していないすべての受信通信をブロックすることを推奨します。ポートの詳細については、TechNet の記事 [TCP and UDP Port Assignments](https://go.microsoft.com/fwlink/?linkid=21312) (英語情報) を参照してください。
...
-   IIS に接続するクライアントに対して認証が要求されるように設定
    ...
    IIS 7 については、「[IIS 7 で認証を構成する](https://technet.microsoft.com/ja-jp/library/cc733010(v=ws.10).aspx)」を参照してください。

    IIS 6.0 については、「[IIS 6.0 の統合 Windows 認証](https://technet.microsoft.com/ja-jp/library/cc738016(v=ws.10).aspx)」を参照してください。
...
OData とは何ですか?   
Open Data (OData) プロトコルは、データのクエリと更新のための Web プロトコルで、データのロックを解除し、今日のアプリケーションに存在するサイロからデータを解放する方法を提供します。OData は、[HTTP](https://www.w3.org/protocols/)、[Atom Publishing Protocol](https://www.ietf.org/rfc/rfc4287.txt) (AtomPub)、[JSON](https://json.org/) などの Web テクノロジを基盤として適用することでこれを実現し、さまざまなアプリケーション、サービス、保存場所の情報にアクセスできるようにします。このプロトコルは、AtomPub クライアントおよびサーバーをさまざまな製品に実装した過去数年間の経験から生まれました。OData は、リレーショナル データベース、ファイル システム、コンテンツ管理システム、従来の Web サイトなどのさまざまなソースの情報の公開およびアクセスのために使用されます。OData の仕様の詳細については、[Open Data プロトコル Web サイト](https://www.odata.org/)を参照してください。

Management OData IIS 拡張機能 Web サービスとは何ですか?    
Management OData IIS 拡張機能とは、IIS の下で実行されている OData Webサービスを使用して Windows PowerShell コマンドレットを簡単に公開するためのフレームワークです。詳細については、[Creating a Management OData IIS Extension Web Service](https://msdn.microsoft.com/ja-jp/library/windows/desktop/hh880865(v=vs.85).aspx) (英語情報) を参照してください。

WCF とは何ですか?    
Windows Communication Foundation (WCF) は、サービス指向のアプリケーションを作成するためのマイクロソフトの統一プログラミング モデルです。これにより、開発者は、セキュリティで保護された安全なトランザクション化されたソリューションを作成し、複数のプラットフォームを統合して、既存の投資を活用することができます。WCF の詳細については、[Windows Communication Foundation](https://msdn.microsoft.com/ja-jp/library/dd456779.aspx) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2736416/ja">サポート技術情報 2736416</a> を参照してください。<br />
<a href="https://support.microsoft.com/kb/2736428/ja">サポート技術情報 2736428</a> を参照してください。</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2736418/ja">サポート技術情報 2736418</a> を参照してください。<br />
<a href="https://support.microsoft.com/kb/2736422/ja">サポート技術情報 2736422</a> を参照してください。<br />
<a href="https://support.microsoft.com/kb/2736428/ja">サポート技術情報 2736428</a> を参照してください。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">レジストリ キーの確認</td>
...
<tr class="even">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2736693/ja">サポート技術情報 2736693</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">レジストリ キーの確認</td>
...
<tr class="even">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2736693/ja">サポート技術情報 2736693</a> を参照してください。<br />
<a href="https://support.microsoft.com/kb/2753596/ja">サポート技術情報 2753596</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">レジストリ キーの確認</td>
<td style="border:1px solid black;">Microsoft .NET Framework 3.5<br />
