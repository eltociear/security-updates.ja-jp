---
TOCTitle: 'MS07-067'
Title: 'マイクロソフト セキュリティ情報 MS07-067 - 緊急'
ms:assetid: 'ms07-067'
ms:contentKeyID: 61229017
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms07-067(v=Security.10)'
---
...
公開日: 2007年12月12日 | 最終更新日: 2007年12月12日

**バージョン:** 1.1

[](https://www.microsoft.com/japan/security/bulletins/ms07-067e.mspx)

### 概説

#### 要点

この深刻度が「重要」の更新プログラムは、一般に公開された 1 件の脆弱性を解決します。Macrovision ドライバがパラメータの構成を正しく処理しないために、特権の昇格の脆弱性が存在します。ローカルの攻撃者はこの脆弱性を悪用し、コンピュータを制御する可能性があります。 攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります。

これは、Windows XP および Windows Server 2003 のすべてのサポートされているエディション用の深刻度「重要」のセキュリティ更新プログラムです。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

この脆弱性に関する詳細情報は、次の「脆弱性の情報」のセクションの下の特定の脆弱性のエントリに関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。

このセキュリティ更新プログラムは、最初にマイクロソフト セキュリティ アドバイザリ [944653](https://technet.microsoft.com/security/advisory/944653)で説明された脆弱性も解決します。詳細情報は次の「脆弱性の情報」のセクションの特定の脆弱性についての「よく寄せられる質問」をご覧ください。

**推奨する対応策:** マイクロソフトはお客様にできる限り早期にこの更新プログラムを適用することを推奨します。

**既知の問題:** なし

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS07-067.mspx](https://technet.microsoft.com/security/bulletin/ms07-067)
...
![](../../images/Dn610191.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機用の更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム/ソフトウェア                                                        | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響 | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報 |
|-----------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|----------------------------------------------------------|
| Windows XP Service Pack 2                                                                     | [![](../../images/Dn610191.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c7d368d0-f7bf-4946-a4a6-3e88315e5317&displaylang=ja) | ローカルの特権の昇格   | 重要           | なし                                                     |
| Windows XP Professional x64 Edition および Windows XP Professional x64 Edition Service Pack 2 | [![](../../images/Dn610191.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5f4fa8e9-fcf2-4daf-93c0-8bb267da69aa&displaylang=ja) | ローカルの特権の昇格   | 重要           | なし                                                     |
| Windows Server 2003 Service Pack 1 および Windows Server 2003 Service Pack 2                  | [![](../../images/Dn610191.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=0f84f5e2-1dd8-4882-b796-444ab70b6b02&displaylang=ja) | ローカルの特権の昇格   | 重要           | なし                                                     |
| Windows Server 2003 x64 Edition および Windows Server 2003 x64 Edition Service Pack 2         | [![](../../images/Dn610191.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=1f416b71-783f-4cbc-9b85-9a9be7daa0d7&displaylang=ja) | ローカルの特権の昇格   | 重要           | なし                                                     |
...
<span></span>
**Macrovision から提供されたセキュリティ更新プログラムをインストールしました。マイクロソフトの更新プログラムをインストールする必要がありますか?**  
いずれかのセキュリティ更新プログラムが正常にインストールされたコンピュータについては何の操作も必要ありません。secdrv.sys ドライバのバージョン 4.3.86.0 は、すべての影響を受けるバージョンの Windows 向けに Macrovision および Microsoft から提供されており、同じ脆弱性を解決します。Macrovision および Microsoft の secdrv.sys ドライバ向けの更新プログラムは、作成時期が異なるだけです。
...
<th style="border:1px solid black;" >Macrovision ドライバの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5587">CVE-2007-5587</a></th>
...
Macrovision ドライバの脆弱性 - CVE-2007-5587  
--------------------------------------------
  
<span></span>
Macrovision ドライバがパラメータの構成を正しく処理しないために、ローカルで特権の昇格の脆弱性が存在します。 攻撃者がこの脆弱性を悪用した場合、ローカル システムのコンテキストで任意のコードが実行される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2007-5587](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5587) をご覧ください。
  
#### 「Macrovision ドライバの脆弱性」の問題を緩和する要素 - CVE-2007-5587:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   攻撃者がこの脆弱性を悪用するには、ユーザーに実行ファイルを実行させるか、有効なログイン資格情報を入手する必要があります。これは、ローカルで特権が昇格される脆弱性です。この脆弱性の悪用をリモートで実行することはできません。  
-   Microsoft Windows 2000 Service Pack 4 は影響を受けません。  
-   Windows Vista は影響を受けません。
  
#### 「Macrovision ドライバの脆弱性」の回避策 - CVE-2007-5587:
  
回避策は、設定または構成の変更を示しており、基本的な脆弱性を正すものではありませんが、更新プログラムを適用する前に既知の攻撃方法を阻止するのに役立ちます。マイクロソフトは、以下の回避策を検証し、この回避策が機能性を低下させるかどうかについて、説明の部分で述べています。
  
-   **secdrv.sys ドライバを無効にする**
  
    システムのレジストリ キーの secdrv.sys ドライバを無効にすると、この脆弱性の悪用から影響を受けるコンピュータを保護する手助けとなります。
    ...
    **対話型**
    ...
    2.  \[HKEY\_LOCAL\_MACHINE\] を展開します。  
    3.  \[SYSTEM\]、\[CurrentControlSet\] を順に拡張し、次に \[Services\] を展開します。  
    4.  \[Secdrv\] をクリックします。  
    5.  \[ファイル\] メニューをクリックして、\[プロパティ\] を選択します。  
    6.  編集前にレジストリのバックアップを取るには、\[ファイル\] メニューから \[エクスポート\] をクリックします。\[レジストリ ファイルのエクスポート\] ダイアログボックスで、\[レジストリ ファイルのエクスポート\] ダイアログボックスで、\[レジストリ ファイルのエクスポート\] ダイアログボックスで、“Secdrv\_configuration\_backup.reg” と入力して、\[保存\] をクリックします。  
    7.  値の名前 \[スタート\] をダブルクリックし、\[値のデータ\] を 4 に変更します。  
    8.  \[OK\] をクリックします。  
    9.  \[スタート\]、\[すべてのプログラム\]、\[アクセサリ\] を順にクリックし、\[コマンド プロンプト\] をクリックします。  
    ...
    **管理された配置スクリプト**
    ...
    2.  次を .REG の拡張子で (例: Disable\_Secdrv.reg) でファイルに保存します:
  
        `Windows Registry Editor Version 5.00[HKEY_LOCAL_MACHINE\System\CurrentControlSet\Services\Secdrv]"Start"=dword:00000004`
  
    3.  対象のコンピュータで、ステップ 2 で作成したレジストリ スクリプトを以下のコマンドで実行してください。
  
        `Regedit /s Disable_Secdrv.reg`
  
    4.  \[スタート\]、\[すべてのプログラム\]、\[アクセサリ\] を順にクリックし、\[コマンド プロンプト\] をクリックします。  
    5.  コマンド プロンプトで、次のコマンドを実行します。
  
        `Sc stop secdrv`
  
    **回避策の影響** **:** このドライバを必要とするプログラムが実行されなくなります。
  
#### 「Macrovision ドライバの脆弱性」のよく寄せられる質問 - CVE-2007-5587:
  
**どのようなことが起こる可能性がありますか?**  
これは、ローカルで特権が昇格される脆弱性です。攻撃者がこの脆弱性を悪用した場合、ローカル コンピュータのコンテキストで任意のコードが実行される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります。
  
**何が原因で起こりますか?**  
Macrovision ドライバが構成のパラメータを正しく処理しないことが原因で起こります。
  
**secdrv.sys とは何ですか?**  
この secdrv.sys ドライバは Macrovision SafeDisc を使用するゲームで使われています。このドライバは、SafeDisc で保護されているゲームの信頼性を検証し、ゲームなど不正なコピーが Windows 上で実行されるのを禁止します。secdrv.sys は、Microsoft Windows XP、Windows Server 2003 および Windows Vista に含まれており、Windows 上のゲームの互換性を強化しています。このドライバがない場合、SafeDisc で保護されたゲームは Windows 上で実行できません。SafeDisc は、Windows でゲームが実行される認証の際に呼び出されるまで有効になりません。
  
**この脆弱性により、攻撃者は何を行う可能性がありますか?**  
ローカルの攻撃者によりこの脆弱性が悪用された場合、影響を受けるコンピュータを完全に制御される可能性があります。
  
**攻撃者はこの脆弱性をどのように悪用する可能性がありますか?**  
攻撃者は、コンピュータにログオンするために有効な資格情報を入手し、特別に細工したアプリケーションを実行して脆弱性を悪用し、影響を受けるコンピュータを完全に制御する可能性があります。
  
**Macrovision が提供している更新プログラムは同じ脆弱性を解決しますか?**  
secdrv.sys ドライバのバージョン 4.3.86.0 は、すべての影響を受けるバージョンの Windows 向けに Macrovision および Microsoft から提供されています。Macrovision および Microsoft の secdrv.sys ドライバ向けの更新プログラムは、作成時期が異なるだけです。
...
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2007-5587](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5587) にアサインされています。この脆弱性は、最初にマイクロソフト セキュリティ アドバイザリ [944653](https://technet.microsoft.com/security/advisory/944653) で説明されました。
...
Windowsxp-KB944653-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB944653-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB944653-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての ｘ64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB944653-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB944653$\\Spuninst フォルダにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP3\\KB944653\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB944653\\Filelist
</td>
</tr>
</table>
...
|------------|------------|------------|-------|--------|-----|----------|
| secdrv.sys | 4.3.86.0   | 2007/11/14 | 12:36 | 23,040 | x64 | SP2GDR   |
| secdrv.sys | 4.3.86.0   | 2007/11/14 | 12:29 | 23,040 | x64 | SP2QFE   |
...
WindowsServer2003-KB944653-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB944653-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB944653\\Filelist
</td>
</tr>
</table>
...
| ファイル名 | バージョン | 日付       | 時間  | サイズ | フォルダ |
|------------|------------|------------|-------|--------|----------|
| secdrv.sys | 4.3.86.0   | 2007/11/13 | 18:32 | 20,480 | SP2GDR   |
| secdrv.sys | 4.3.86.0   | 2007/11/13 | 18:32 | 20,480 | SP2QFE   |
...
-   2007/12/12: 脆弱性の影響を明確にするため、このセキュリティ情報更新しました。
