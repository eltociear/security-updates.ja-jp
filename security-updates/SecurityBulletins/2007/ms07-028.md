...
[](https://www.microsoft.com/japan/security/bulletins/ms07-028e.mspx)
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ca930018-4a66-4da6-a6c5-206df13af316&amp;displaylang=ja"><img src="../../images/Dn610152.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
![](../../images/Dn610152.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。  
...
|------------------------------------------------------------------------------------------------------------------|------------------------------|---------|-------------------------------|  
| CAPICOM.Certificates の脆弱性 - [CVE-2007-0940](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-xxxx-xxxx) | リモートでコードが実行される | 緊急    | 緊急                          |
...
-   「CAPICOM.Certificates の脆弱性」 - [CVE-2007-0940](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0940) を報告してくださった [VigilantMinds Inc.](https://www.vigilantminds.com/) の Chris Ries 氏
...
-   US マイクロソフトセキュリティ情報（MS07-028）  
    [https://www.microsoft.com/technet/security/bulletin/ms07-028.mspx](https://technet.microsoft.com/security/bulletin/ms07-028)
-   サポート技術情報 （KB） 文書番号 ：931906  
    [\[MS07-028\] CAPICOM の脆弱性により、リモートでコードが実行される (931906)](https://support.microsoft.com/kb/931906)
