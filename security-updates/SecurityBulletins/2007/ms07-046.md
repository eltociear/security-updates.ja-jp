...
[](https://www.microsoft.com/japan/security/bulletins/ms07-046e.mspx)
...
**US** **マイクロソフトセキュリティ情報:**[https://www.microsoft.com/technet/security/bulletin/MS07-046.mspx](https://technet.microsoft.com/security/bulletin/ms07-046)
...
|------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|---------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                            | [![](../../images/Dn610170.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8fc8340b-c2b3-4559-835c-caa00cf086b9&displaylang=ja) | [![](../../images/Dn610170.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8fc8340b-c2b3-4559-835c-caa00cf086b9&amp;displaylang=ja-nec) | リモートでコードが実行される | 緊急           | [MS06-001](https://technet.microsoft.com/security/bulletin/ms06-001) |
| Microsoft Windows XP Service Pack 2                              | [![](../../images/Dn610170.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=dc29475d-c0bb-4d35-8dd6-4ca1cac32315&displaylang=ja) | -                                                                                                                                                                                                         | リモートでコードが実行される | 緊急           | [MS06-001](https://technet.microsoft.com/security/bulletin/ms06-001) |
| Microsoft Windows XP Professional x64 Edition                    | [![](../../images/Dn610170.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3c81730a-981a-4649-b2d9-45144230d512&displaylang=ja) | -                                                                                                                                                                                                         | リモートでコードが実行される | 緊急           | [MS06-001](https://technet.microsoft.com/security/bulletin/ms06-001) |
| Microsoft Windows Server 2003 Service Pack 1                     | [![](../../images/Dn610170.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5374583d-de68-4d65-bca8-598d6b98b8b3&displaylang=ja) | -                                                                                                                                                                                                         | リモートでコードが実行される | 緊急           | [MS06-001](https://technet.microsoft.com/security/bulletin/ms06-001) |
| Microsoft Windows Server 2003 x64 Edition                        | [![](../../images/Dn610170.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c3359f27-e03e-4a4f-b896-3bda39f69f7e&displaylang=ja) | -                                                                                                                                                                                                         | リモートでコードが実行される | 緊急           | [MS06-001](https://technet.microsoft.com/security/bulletin/ms06-001) |
| Microsoft Windows Server 2003 with SP1 for Itanium-based Systems | [![](../../images/Dn610170.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=92822479-2060-4357-a340-ed096f180b2b&displaylang=ja) | -                                                                                                                                                                                                         | リモートでコードが実行される | 緊急           | [MS06-001](https://technet.microsoft.com/security/bulletin/ms06-001) |
...
<th style="border:1px solid black;" >GDI でリモートでコードが実行される脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3034">CVE-2007-3034</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2007-3034](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3034) をご覧ください。
...
-   **レジストリを変更してメタファイルのプロセスを無効にする**
    ...
    [MS07-017](https://technet.microsoft.com/security/bulletin/ms07-017) を適用のお客様または Windows Vista をご使用のお客様はレジストリを変更してメタファイルのプロセスを無効にすることができます。この設定により、影響を受けるコンピュータを脆弱性の悪用から守る手助けとなります。
...
**注:** サポートされているバージョンおよび影響を受けるエディションの一覧は、[サポート ライフサイクル - 製品名一覧](https://support.microsoft.com/gp/lifeselectindex/)をご覧ください。サービスパックの完全な一覧は、[ライフサイクル サポート対象サービスパック](https://support.microsoft.com/gp/lifesupsps)をご覧ください。サポート ライフサイクル ポリシーに関する詳細については、[マイクロソフト サポート ライフサイクル](https://support.microsoft.com/lifecycle/)をご覧ください。
...
-   「GDI でリモートでコードが実行される脆弱性」 - [CVE-2007-3034](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3034) の 問題を報告をしてくださった [eEye](https://www.eeye.com/html/index.html)
