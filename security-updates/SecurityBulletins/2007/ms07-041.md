...
[](https://www.microsoft.com/japan/security/bulletins/ms07-041e.mspx)
...
**既知の問題:** マイクロソフト サポート技術情報 [939373](https://support.microsoft.com/kb/939373) には、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明されています。

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS07-041.mspx](https://technet.microsoft.com/security/bulletin/ms07-041)
...
|----------------------------------------|---------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Windows XP Professional Service Pack 2 | Microsoft Internet Information Services (IIS) 5.1 | [![](../../images/Dn610165.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=fccbfe90-f838-47df-8310-352e2fb47132&displaylang=ja) | リモートでコードが実行される | 重要           | なし                                                     |
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2005-4360](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2005-4360) をご覧ください。
...
-   「IIS メモリのリクエストの脆弱性」 - [CVE-2005-4360](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2005-4360) についてマイクロソフトに協力および追加情報を提供してくださった、[Watchfire](https://https://www.watchfire.com/) の Jonathan Afek 氏 および Adi Sharabani 氏
-   「IIS メモリのリクエストの脆弱性」 - [CVE-2005-4360](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2005-4360) についてマイクロソフトに協力および追加情報を提供してくださった、[NGS Software](https://www.ngssoftware.com/) の Peter Winter-Smith 氏
