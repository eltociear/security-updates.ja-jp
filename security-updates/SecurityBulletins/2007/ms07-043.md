...
[](https://www.microsoft.com/japan/security/bulletins/ms07-043e.mspx)
...
**既知の問題:** [921503](https://support.microsoft.com/kb/921503) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。また、このサポート技術情報には、これらの問題に対する推奨される解決策に関する説明も記載されています

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS07-043.mspx](https://technet.microsoft.com/security/bulletin/ms07-043)
...
|----------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Windows 2000 Service Pack 4                                                                                          | [![](../../images/Dn610167.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5c35b6e8-732a-4451-b5d4-23ed63e6e792&displaylang=ja)           | [![](../../images/Dn610167.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5c35b6e8-732a-4451-b5d4-23ed63e6e792&amp;displaylang=ja-nec) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows XP Service Pack 2                                                                                            | [![](../../images/Dn610167.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6e8de050-8589-4831-ae19-075c93509485&displaylang=ja)           | -                                                                                                                                                                                                         | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows XP Professional x64 Edition および Windows XP Professional x64 Edition Service Pack 2                        | [![](../../images/Dn610167.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b85bb583-dc61-4d37-b458-208f5bb07ece&displaylang=ja)           | -                                                                                                                                                                                                         | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Server 2003 Service Pack 1 および Windows Server 2003 Service Pack 2                                         | [![](../../images/Dn610167.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=15d4d4fa-9bab-4da5-978e-f89c78c8086a&displaylang=ja)           | -                                                                                                                                                                                                         | リモートでコードが実行される | 警告           | なし                                                     |
| Windows Server 2003 x64 Edition および Windows Server 2003 x64 Edition Service Pack 2                                | [![](../../images/Dn610167.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6608d722-3ef8-4085-b771-7b17bb0ba06e&displaylang=ja)           | -                                                                                                                                                                                                         | リモートでコードが実行される | 警告           | なし                                                     |
| Windows Server 2003 with SP1 for Itanium-based Systems および Windows Server 2003 with SP2 for Itanium-based Systems | [![](../../images/Dn610167.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=fc04451a-0696-4a21-b2b6-f02d4e2c33bf&displaylang=ja)           | -                                                                                                                                                                                                         | リモートでコードが実行される | 警告           | なし                                                     |
| Microsoft Office 2004 for Mac                                                                                        | [![](../../images/Dn610167.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/japan/mac/downloads.mspx)                                                                      | -                                                                                                                                                                                                         | リモートでコードが実行される | 緊急           | なし                                                     |
| Microsoft Visual Basic 6.0 Service Pack 6                                                                            | [![](../../images/Dn610167.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e1646fb0-29d5-4a6e-a8d2-304c4d7735b7&displaylang=ja)(KB924053) | -                                                                                                                                                                                                         | リモートでコードが実行される | 緊急           | なし                                                     |
...
[921503](https://support.microsoft.com/kb/921503) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。また、このサポート技術情報には、これらの問題に対する推奨される解決策に関する説明も記載されています。

**このセキュリティ情報で説明されているソフトウェアの旧エディションを使用しています。どうすればよいですか?**  
このセキュリティ情報に記載されている影響を受けるソフトウェアのテストを行い、影響を受けるバージョンを確認しました。そのほかのエディションについてはサポート ライフサイクルが終了しています。ご使用中の製品およびエディションのサポート ライフサイクルを確認するためには、[マイクロソフト サポート ライフサイクルの Web サイト](https://support.microsoft.com/gp/lifecycle) をご覧ください。
...
<th style="border:1px solid black;" >OLE オートメーションのメモリの破損の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2224">CVE-2007-2224</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2007-2224](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2224) をご覧ください。
...
Visual Basic 6.0 はこのセキュリティ更新プログラムによる影響を受ける唯一の開発プラットフォームです。このセキュリティ情報ではVisual Basic 6.0 Service Pack 6 用の更新プログラムの[ダウンロード先](https://www.microsoft.com/download/details.aspx?familyid=e1646fb0-29d5-4a6e-a8d2-304c4d7735b7&displaylang=ja)を提供しています。開発者は共有されたコンポーネントを使用するための推奨される最善策に従ってください。共有されたコンポーネントの使用についての最善策に関する詳細情報は、分離アプリケーションについてのサポート技術情報 [835322](https://support.microsoft.com/kb/835322/ja) をご覧ください。
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/japan/mac/downloads.mspx)から Microsoft Office 2004 for Mac 11.3.7 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
この更新プログラムのダウンロードまたは使用における技術的な質問または問題については、[Microsoft for Mac Support (英語情報)](https://www.microsoft.com/mac/support.aspx) で、利用可能なサポート オプションをご覧ください。
...
-   「OLE オートメーションのメモリ破損の脆弱性」- [CVE-2007-2224](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2224) を報告してくださった [VeriSign iDefense VCP](https://labs.idefense.com/) に協力している匿名のリサーチャー
-   「OLE オートメーションのメモリ破損の脆弱性」- [CVE-2007-2224](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2224) を報告してくださった [Zero Day Initiative](https://www.zerodayinitiative.com/) に協力している匿名のリサーチャー
