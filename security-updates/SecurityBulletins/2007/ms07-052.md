...
[](https://www.microsoft.com/japan/security/bulletins/ms07-052e.mspx)
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS07-052.mspx](https://technet.microsoft.com/security/bulletin/ms07-052)

#### 影響を受けるソフトウェアおよび影響を受けないソフトウェア

ここに記載されているソフトウェアをテストし、影響を受けるバージョンまたはエディションを確認しました。そのほかのバージョンまたはエディションはサポート ライフサイクルが終了したか、または影響を受けません。ご使用中の製品およびバージョンのサポートライフ サイクルを確認するためには、[マイクロソフト サポート ライフサイクルの Web サイト](https://go.microsoft.com/fwlink/?linkid=21742) をご覧ください。記載されている Visual Studio のエディションのみがこの脆弱性の影響を受けます。そのほかのエディションは Crystal Reports を含まず、また影響を受けないため、更新プログラムを適用する必要はありません。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2608c83b-e1b2-4449-9a0e-1e566aac3d76&amp;displaylang=ja"><img src="../../images/Dn610176.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d612ad41-5a0d-4e13-99ea-d6a5589786d6&amp;displaylang=ja"><img src="../../images/Dn610176.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0b10b04b-932c-4bff-9cbc-b3eeb15064b1&amp;displaylang=ja"><img src="../../images/Dn610176.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=21073cc2-919c-40df-8ebb-aa3db06050d2&amp;displaylang=ja"><img src="../../images/Dn610176.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=967d43c8-efba-4221-beb0-981e7deef33a&amp;displaylang=ja"><img src="../../images/Dn610176.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<th style="border:1px solid black;" >Crystal Reports の RPT 処理の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-6133">CVE-2006-6133</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2006-6133](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-6133) をご覧ください。
...
Crystal Reports は、[Business Objects](https://www.businessobjects.com/) から提供されているソフトウェアです。マイクロソフトは、特定のエディションの Visual Studio .NET 2002、Visual Studio .NET 2003 および Visual Studio 2005 でカスタム バージョンの Crystal Reports を再配布しています。
