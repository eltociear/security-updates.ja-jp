...
-   .NET PE ローダーの脆弱性 - [CVE-2007-0041](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0041) の 問題を報告してくださった [OWASP](https://www.owasp.org/) 社の Dinis Cruz 氏
-   ASP .NET Null Byte Termination の脆弱性 - [CVE-2007-0042](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0042) の 問題を報告してくださった [Security Assessment](https://www.smsiinc.com/) のPaul Craig 氏
-   .NET JIT コンパイラの脆弱性 - [CVE-2007-0043](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0043) を最初に報告してくださった [Sumatra](https://www.sumatra.nl/) の Jeroen Frijters氏
-   .NET リクエスト フィルタリングのバイパスの脆弱性 - [CVE-2006-7192](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-7192) を最初に報告してくださった [UK CPNI](https://www.cpni.gov.uk/) と協力している [ProCheckUp](https://www.procheckup.com/)
-   .NET リクエスト フィルタリングのバイパスの脆弱性 - [CVE-2006-7192](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-7192) についてマイクロソフトに協力および追加情報を提供してくださった、[Portcullis Computer Security Ltd](https://www.portcullis-security.com/) の Ferruh T. Mavituna 氏
-   .NET リクエスト フィルタリングのバイパスの脆弱性 - [CVE-2006-7192](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-7192) についてマイクロソフトに協力および追加情報を提供してくださった、[TrueSec](https://www.truesec.com/) の Johannes Gumbel 氏
