...
[](https://www.microsoft.com/japan/security/bulletins/ms07-037e.mspx)
...
**US** **マイクロソフトセキュリティ情報:**[https://www.microsoft.com/technet/security/bulletin/MS07-037.mspx](https://technet.microsoft.com/security/bulletin/ms07-037)
...
(KB936646)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=25d272e7-f2dd-4342-92be-7ebc2e770b44&amp;displaylang=ja"><img src="../../images/Dn610161.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<span></span>
ディスクからメモリにアプリケーションのデータを書き込む際に、Publisher が適切にメモリのリソースをクリアにしない方法に、リモートでコードが実行される脆弱性が存在します。攻撃者は特別な細工がされた Publisher (.pub) ページを作成することにより、この脆弱性を悪用する可能性があります。ユーザーが .pub ページを表示すると、この脆弱性により、リモートでコードが実行される可能性があります。攻撃者によりこの脆弱性が悪用された場合、影響を受けるコンピュータが完全に制御される可能性があります。Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2007-1754](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1754) をご覧ください。
...
-   Microsoft Office 2003 のサポートされているバージョンについては、[製品の更新プログラムを管理者インストールポイントから適用する](https://office.microsoft.com/en-us/ork2003/ha011401931033.aspx) (英語情報) をご覧ください。Microsoft Office 2003 のサポートされていないバージョンの管理者用インストール ポイントの場合は、サポート技術情報 [902349](https://support.microsoft.com/kb/902349) をご覧ください
    ...
    **注:** ソフトウェアの更新プログラムを更新された管理的なイメージから中央管理する予定の場合、詳細情報を [Office 2003 製品の更新プログラムの配信](https://office.microsoft.com/en-us/ork2003/ha011402381033.aspx?pid=ch011480761033) (英語情報) をご覧ください。
  
-   the 2007 Microsoft Office system のサポートされているバージョンについては、[2007 Office system のネットワーク インストール ポイントを作成する](https://technet2.microsoft.com/office/f/?ja-jp/library/72c9ae03-1342-4524-8242-1524fbd068a51041.mspx)をご覧ください。  
...
-   「Publisher の無効なメモリの参照の脆弱性」 - [CVE-2007-1754](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1754) についてマイクロソフトに報告してくださった [eEye](https://eeye.com/)
