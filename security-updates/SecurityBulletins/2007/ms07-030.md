...
[](https://www.microsoft.com/japan/security/bulletins/ms07-030e.mspx)
...
**既知の問題:** サポート技術情報 [927051](https://support.microsoft.com/kb/927051/ja) で、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明されています。

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS07-030.mspx](https://technet.microsoft.com/security/bulletin/ms07-030)
...
(KB931280)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fc1d0483-27e8-4541-b81d-4a47973bea30&amp;displaylang=ja"><img src="../../images/Dn610154.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
(KB931281)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c47f432e-8538-42fd-92c9-7e0f1d643e8e&amp;displaylang=ja"><img src="../../images/Dn610154.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、 [CVE-2007-0934](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0934) をご覧ください。
...
-   **ファイルの表示および閲覧するために、Visio Viewer 2003** **または** **Microsoft Visio Viewer 2007** **を使用する**
    ...
    Visio Viewer 2003 または Microsoft Visio Viewer 2007 は、この問題の影響を受けません。マイクロソフト ダウンロード センターから [Microsoft Visio Viewer 2003](https://www.microsoft.com/download/details.aspx?displaylang=ja&familyid=3fb3bd5c-fed1-46cf-bd53-da23635ab2df) または [Microsoft Visio Viewer 2007](https://www.microsoft.com/download/details.aspx?displaylang=ja&familyid=d88e4542-b174-4198-ae31-6884e9edd524) をダウンロードすることができます。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、 [CVE-2007-0936](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0936) をご覧ください。
...
**注:** ソフトウェアの更新プログラムを更新された管理者イメージから中央管理する予定の場合、詳細情報は [Updating Office 2000 Clients from a Patched Administrative Image](https://office.microsoft.com/en-us/ork2000/ha011525661033.aspx?pid=ch102053491033) (英語情報) をご覧ください。
  
-   Microsoft Office 2003 のサポートされているバージョンについては、[管理者インストール ポイントの作成](https://www.microsoft.com/japan/office/ork/2003/two/ch3/depb01.htm)をご覧ください。Microsoft Office 2003 のサポートされていないバージョンの管理者インストール ポイントの場合は、サポート技術情報 [902349](https://support.microsoft.com/kb/902349) をご覧ください。
  
**注:** ソフトウェアの更新プログラムを更新された管理者イメージから中央管理する予定の場合、詳細情報は [Distributing Office 2003 Product Updates](https://office.microsoft.com/en-us/ork2003/ha011402381033.aspx?pid=ch011480761033) (英語情報) をご覧ください。Microsoft Office 2007 のサポートされているバージョンについては、[Create a network installation point for the 2007 Office system](https://technet2.microsoft.com/office/f/?en-us/library/72c9ae03-1342-4524-8242-1524fbd068a51033.mspx) (英語情報) をご覧ください。
  
**注:** Windows Server Update Services を使用してセキュリティ更新プログラムを中央で管理する場合。Windows Server Update Services を使用して、Microsoft Office 2007 用のセキュリティ更新プログラムを適用する方法の詳細は、次のマイクロソフトの Web サイトをご覧ください。[Windows Server Update Services 製品概要](https://www.microsoft.com/japan/windowsserversystem/updateservices/evaluation/overview.mspx)
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。**注:** この更新プログラムを削除する場合、CD ドライブにMicrosoft Office 2003 の CD を挿入するようメッセージが表示される場合があります。さらに、\[コントロール パネル\] の \[アプリケーションの追加と削除\] から更新プログラムを削除するオプションがない場合もあります。この問題について、いくつかの考えられる原因があります。削除に関する詳細情報は、サポート技術情報 [903771](https://support.microsoft.com/kb/903771) をご覧ください。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
**注:** この更新プログラムを削除する場合、Microsoft Office 2003 の CD を挿入するようメッセージが表示される場合があります。さらに、\[コントロール パネル\] の \[アプリケーションの追加と削除\] から更新プログラムを削除するオプションがない場合もあります。削除に関する詳細情報は、サポート技術情報 [903771](https://support.microsoft.com/kb/903771) をご覧ください。
...
-   「Visio ドキュメント パッケージの脆弱性」 - [CVE-2007-0936](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0936) を報告してくださった [VigilantMinds Inc.](https://www.vigilantminds.com/) の Chris Ries 氏
