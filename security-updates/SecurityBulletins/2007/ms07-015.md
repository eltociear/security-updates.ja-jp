---
TOCTitle: 'MS07-015'
Title: 'マイクロソフト セキュリティ情報 MS07-015 - 緊急'
ms:assetid: 'ms07-015'
ms:contentKeyID: 61228965
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms07-015(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS07-015 - 緊急
===============================================

Microsoft Office の脆弱性により、リモートでコードが実行される (932554)
----------------------------------------------------------------------

公開日: 2007年2月14日 | 最終更新日: 2008年4月24日

[](https://www.microsoft.com/japan/security/bulletins/ms07-015e.mspx)
...
(KB929062) クライアント用更新プログラムおよび管理者用更新プログラム</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=20e089e7-7dd3-44a4-abfe-6d8c27721683&amp;displaylang=ja"><img src="../../images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><img src="../../images/Dn610139.ot_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Microsoft Office XP Service Pack 3 :</strong>
<ul>
<li>Microsoft Access 2002</li>
<li>Microsoft Excel 2002</li>
<li>Microsoft FrontPage 2002</li>
<li>Microsoft Outlook 2002</li>
<li>Microsoft PowerPoint 2002</li>
<li>Microsoft Publisher 2002</li>
<li>Microsoft Word 2002</li>
</ul>
(KB929063) クライアント用更新プログラムおよび管理者用更新プログラム</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c54b1fda-1237-48f7-ad19-f0830ee0e8ff&amp;displaylang=ja"><img src="../../images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><img src="../../images/Dn610139.ot_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="odd">
...
<li>Microsoft Word Viewer 2003</li>
</ul>
(KB929064) クライアント用更新プログラムおよび管理者用更新プログラム</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bb0973e7-275d-4491-9ba1-91eaea84eefd&amp;displaylang=ja"><img src="../../images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><img src="../../images/Dn610139.ot_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Microsoft Project 2000 Service Release 1</strong>
(KB929062)クライアント用更新プログラムおよび管理者用更新プログラム<br />
上述の Office 2000 Service Pack 3 (KB929062) とは別の更新プログラムです</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3df54b5c-cb82-4a99-9b90-edab38ad6310&amp;displaylang=ja"><img src="../../images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><img src="../../images/Dn610139.ot_s(ja-JP,Security.10).gif" /><br />
</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Microsoft Project 2002 Service Pack 1</strong>
(KB929063) クライアント用更新プログラムおよび管理者用更新プログラム<br />
上述の Office XP Service Pack 3 (KB929063) とは別の更新プログラムです</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=419191dc-01b8-4e2a-ba5b-71bf3066c169&amp;displaylang=ja"><img src="../../images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><img src="../../images/Dn610139.ot_s(ja-JP,Security.10).gif" /><br />
</td>
</tr>
<tr class="even">
...
(KB929063) クライアント用更新プログラムおよび管理者用更新プログラム<br />
上述の Office XP Service Pack 3 (KB929063) とは別の更新プログラムです</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f50a5111-0926-4221-96df-18294230ed1e&amp;displaylang=ja"><img src="../../images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><img src="../../images/Dn610139.ot_s(ja-JP,Security.10).gif" /><br />
</td>
</tr>
</tbody>
...
![](../../images/Dn610139.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機用または NEC PC-9800 シリーズ用の更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

![](../../images/Dn610139.ot_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは Office Update からインストールすることもできす。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/japan/mac/downloads.mspx"><img src="../../images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
</tr>
</tbody>
</table>
...
<span></span>
この更新プログラムは、新たに確認され一般に公開された脆弱性、および非公開で報告された 2 つの脆弱性を解決します。各脆弱性はこのセキュリティ情報の「脆弱性の詳細」欄に説明されています。
...
| 脆弱性識別番号                                                                                                                            | 脆弱性の影響                 | Microsoft Office 2000 | Microsoft Office XP | Microsoft Office 2003 | Microsoft Office 2004 for Mac |  
|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|-----------------------|---------------------|-----------------------|-------------------------------|  
| PowerPoint の不正な形式のレコード メモリの破損の脆弱性 - [CVE-2006-3877](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3877) | リモートでコードが実行される | 緊急                  | 重要                | 重要                  | 重要                          |  
| Excel の不正な形式のレコードの脆弱性 - [CVE-2007-0671](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0671)                   | リモートでコードが実行される | 緊急                  | 重要                | 重要                  | 重要                          |  
...
| セキュリティ情報番号                                                | Microsoft Office 2000 | Microsoft Office XP | Microsoft Office 2003 | Microsoft Office 2004 for Mac |  
|---------------------------------------------------------------------|-----------------------|---------------------|-----------------------|-------------------------------|  
| [MS06-062](https://technet.microsoft.com/security/bulletin/ms06-062) | 置き換わる            | 置き換わる          | 置き換わる            | 置き換わる                    |
  
**この更新プログラムは MS06-058 とどのような関連がありますか?**
  
MS06-058 で最初に説明されている脆弱性 CVE-2006-3877 の更なる調査により、更新プログラム MS06-058 は影響を受けるコンピュータからの脆弱性の排除に効果的ではないことが確認されました。今回のセキュリティ情報は CVE-2006-3877 を適切に解決するために公開されました。お客様はこのセキュリティ情報で提供されている更新プログラムを直ちに適用してください。
  
**この更新プログラムはなぜ MS06-058 ではなく MS06-062 に置き換わるものなのですか?**
  
CVE-2006-3877 の更なる調査で、PowerPoint.exe に存在する脆弱性の修正は効果的でないことが確認されました。この更新プログラムでは CVE-2006-3877 を効果的に解決する mso.dll のバージョンがインストールされます。
  
このセキュリティ情報は mso.dll の更新であるため、MS06-062 の以前の mso.dll の更新に置き換わります。
...
**注:** 管理者用インストール ポイントを使用して Office 2000、Office XP または Office 2003 を導入している場合、管理者用インストール ポイントを元のベースラインから更新していると、SMS を使用して更新プログラムを適用できない可能性があります。
  
-   更新された管理者用インストール ポイントから Office 2000 の元のベースライン ソースまたは Service Pack 3 （SP3） にクライアント コンピュータ用のソースを変更する方法に関する詳細情報は、マイクロソフト サポート技術情報 [932889](https://support.microsoft.com/kb/932889) をご覧ください。  
-   更新された管理者用インストール ポイントから Office XP の元のベースライン ソースまたは Service Pack 3 （SP3） にクライアント コンピュータ用のソースを変更する方法に関する詳細情報は、マイクロソフト サポート技術情報 [922665](https://support.microsoft.com/kb/922665) をご覧ください。  
-   更新された管理者用インストール ポイントから Office 2003 の元のベースライン ソースまたは Service Pack 2 （SP2） にクライアント コンピュータ用のソースを変更する方法に関する詳細情報は、マイクロソフト サポート技術情報 [902349](https://support.microsoft.com/kb/902349) をご覧ください。
...
リモートでコードが実行される脆弱性が PowerPoint に存在します。この脆弱性は特別に細工されたファイルが開かれた場合、悪用される可能性があります。このようなファイルは、電子メールの添付ファイルに含まれているか、または悪意のある Web サイトにホストされている可能性があります。攻撃者が特別な細工をした PowerPoint ファイルを作成することにより、この脆弱性が悪用され、リモートでコードが実行される可能性があります。
...
#### 「PowerPoint の不正な形式のレコード メモリの破損の脆弱性」の問題を緩和する要素 - CVE-2006-3877:
  
-   この脆弱性が悪用された場合、攻撃者によりローカル ユーザーと同じ権限が取得される可能性があります。コンピュータでユーザー権限が低い設定のアカウントを持つユーザーは、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。  
-   Web ベースの攻撃のシナリオでは、この脆弱性の悪用を意図した PowerPoint のファイルが含まれる Web サイトをホストしていることが攻撃者にとっての必要条件となります。また、改竄 (侵害) された Web サイトやユーザーが提供したファイルを受け入れ、掲載しているような Web サイトでは、この脆弱性を悪用する可能性のある特別な細工がされたファイルを含む可能性があります。しかしながら、攻撃者は、ユーザーを不正な Web サイトに強制的に誘導する方法はありません。その代わり、通常、ユーザーに自分のサイトに接続するリンクをクリックさせ、その Web サイトにユーザーを誘導することが攻撃者にとっての必要条件となります。  
...
-   Microsoft PowerPoint Viewer 2003 は、この脆弱性による影響を受けません。
  
#### 「PowerPoint の不正な形式のレコード メモリの破損の脆弱性」の回避策 - CVE-2006-3877:
  
マイクロソフトは次の回避策のテストを行いました。この回避策は根本的な脆弱性を修正しませんが、既知の攻撃方法を阻止する手助けとなります。回避策が機能の低下の原因となる場合、下記に示します。
  
-   **信頼できない、または信頼できるソースから予期せず受け取った** **Microsoft** **PowerPointファイルを開いたり、保存したりしない**
  
    ユーザーが特別な細工がされたファイルを開く際に、この脆弱性が悪用される可能性があります。
  
#### 「PowerPoint の不正な形式のレコード メモリの破損の脆弱性」のよく寄せられる質問 - CVE-2006-3877:
  
**どのようなことが起こる可能性がありますか?**
  
リモートでコードが実行される脆弱性が PowerPoint に存在します。この脆弱性は不正な形式のレコードが含まれるファイルが PowerPoint で開かれた場合、悪用される可能性があります。このようなファイルは、電子メールの添付ファイルに含まれているか、または悪意のある Web サイトにホストされている可能性があります。攻撃者が特別な細工をした PowerPoint ファイルを作成することにより、この脆弱性が悪用され、リモートでコードが実行される可能性があります。
  
ユーザーが管理者ユーザー権限でログオンしている場合、影響を受けるコンピュータが攻撃者に完全に制御される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。コンピュータでユーザー権限が低い設定のアカウントを持つユーザーは、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。
  
**何が原因で起こりますか?**
  
プレースホルダのデータを解析した際に、意図した場所以外のメモリ アクセスが行れる特別な細工のされた PowerPoint ファイルが PowerPoint で開かれた場合、この脆弱性が起こります。
...
電子メールでの攻撃シナリオでは、攻撃者は特別な細工がされた PowerPoint のファイルをユーザーに送信し、ユーザーにそのファイルを開くよう誘導することにより、この脆弱性を悪用する可能性があります。
...
この更新プログラムは、PowerPoint が割り当てられたバッファにファイルを渡す前に、ファイルの解析およびレコードの検証を行う方法を変更することにより、この脆弱性を排除します。
  
**このセキュリティ情報の公開時に、この脆弱性は一般に知られていましたか？**
  
いいえ。マイクロソフトは信頼のおける情報元からこの脆弱性に関する情報を受けました。マイクロソフトは、このセキュリティ情報が最初に公開された際に、MS06-058 でお伝えした情報以外にこの脆弱性が一般に知られていたという情報は受けていませんでした。このセキュリティ情報は、内部調査で新たに確認された問題とともに、非公開で報告された脆弱性を解決します。
...
リモートでコードが実行される脆弱性が Excel に存在します。この脆弱性は特別に細工されたファイルが Excel で開かれた場合、悪用される可能性があります。このようなファイルは、電子メールの添付ファイルに含まれているか、または悪意のある Web サイトにホストされている可能性があります。攻撃者が特別な細工をした Excel ファイルを作成することにより、この脆弱性が悪用されてリモートでコードが実行される可能性があります。
  
ユーザーが管理者ユーザー権限でログオンしている場合、影響を受けるコンピュータが攻撃者に完全に制御される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。コンピュータでユーザー権限が低い設定のアカウントを持つユーザーは、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。
  
#### 「Excel の不正な形式のレコードの脆弱性」の問題を緩和する要素 - CVE-2007-0671:
  
-   この脆弱性が悪用された場合、攻撃者によりローカル ユーザーと同じ権限が取得される可能性があります。コンピュータでユーザー権限が低い設定のアカウントを持つユーザーは、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。  
-   Web ベースの攻撃のシナリオでは、この脆弱性の悪用を意図した Excel ファイルが含まれる Web サイトをホストしていることが攻撃者にとっての必要条件となります。また、改竄 (侵害) された Web サイトやユーザーが提供したファイルを受け入れ、掲載しているような Web サイトでは、この脆弱性を悪用する可能性のある特別な細工がされたファイルを含む可能性があります。しかしながら、攻撃者は、ユーザーを不正な Web サイトに強制的に誘導する方法はありません。その代わり、通常、ユーザーに自分のサイトに接続するリンクをクリックさせ、その Web サイトにユーザーを誘導することが攻撃者にとっての必要条件となります。  
-   この脆弱性は、電子メールを介して、自動的に悪用されることはありません。ユーザーが電子メール メッセージで送信された添付ファイルを開かない限り、攻撃は行われません。  
-   Office 2000 用の [Office ファイルを開くときに確認するツール](https://www.microsoft.com/download/details.aspx?displaylang=ja&familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f) をインストールおよび使用しているお客様には、文書を開く前に \[開く\]、\[保存\] または \[キャンセル\] の確認が行われます。Office ファイルを開くときに確認するツールの機能は Office XP および Office 2003 には組み込まれています。  
-   2007 Microsoft Office System は、この脆弱性による影響を受けません。
  
#### 「Excel の不正な形式のレコードの脆弱性」の回避策 - CVE-2007-0671:
  
マイクロソフトは次の回避策のテストを行いました。この回避策は根本的な脆弱性を修正しませんが、既知の攻撃方法を阻止する手助けとなります。回避策が機能の低下の原因となる場合、下記に示します。
  
-   **信頼できない、または信頼できるソースから予期せず受け取ったExcelファイルを開いたり、保存したりしない**
  
    ユーザーが特別な細工がされたファイルを開く際に、この脆弱性が悪用される可能性があります。
  
#### 「Excel の不正な形式のレコードの脆弱性」のよく寄せられる質問 - CVE-2007-0671:
  
**どのようなことが起こる可能性がありますか?**
  
リモートでコードが実行される脆弱性が Excel に存在します。この脆弱性は不正な形式のレコードが含まれるファイルが Excel で開かれた場合、悪用される可能性があります。このようなファイルは、電子メールの添付ファイルに含まれているか、または悪意のある Web サイトにホストされている可能性があります。攻撃者が特別な細工をした Excel ファイルを作成することにより、この脆弱性が悪用され、リモートでコードが実行される可能性があります。
  
ユーザーが管理者ユーザー権限でログオンしている場合、影響を受けるコンピュータが攻撃者に完全に制御される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。コンピュータでユーザー権限が低い設定のアカウントを持つユーザーは、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。
  
**何が原因で起こりますか?**
  
プレースホルダのデータを解析した際に、意図した場所以外のメモリ アクセスが行われる特別な細工のされた Excel ファイルが Excel で開かれた場合、この脆弱性が起こります。
...
電子メールでの攻撃シナリオでは、攻撃者は特別な細工がされた Excel のファイルをユーザーに送信し、ユーザーにそのファイルを開くよう誘導することにより、この脆弱性を悪用する可能性があります。
...
この更新プログラムは、割り当てられたバッファに渡される前に Excel がファイルを解析しレコードを検証する方法を変更することにより、この脆弱性を排除します。
  
**このセキュリティ情報の公開時に、この脆弱性は一般に知られていましたか？**
  
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の CVE-2007-0671 にアサインされています。
...
1.  [Office 2000 用のセキュリティ更新プログラム](https://download.microsoft.com/download/1/3/0/130dc99d-e1bf-4087-936d-ca39adc6cbc8/office2000-kb929062-fullfile-jpn.exe)または [Project 2000 Service Pack 1 用のセキュリティ更新プログラム](https://download.microsoft.com/download/b/9/5/b95cb38c-f65e-4198-8283-bee4c030c550/project2000-kb929062-fullfile-jpn.exe)をダウンロードしてください。  
...
|------------|------------|----------|------|-----------|  
| Mso9.dll   | 9.0.0.8960 | 2007/2/7 | 5:02 | 5,595,185 |
...
| Pj9od9.dll   | 9.0.2002.523  | 2006/6/17 | 9:36  | 782,389   |  
| Pjbknd09.dll | 9.0.2002.523  | 2006/6/17 | 9:36  | 3,391,543 |  
| Winproj.exe  | 9.0.2007.104  | 2007/1/4  | 20:39 | 6,164,534 |
...
| 製品名                 | 機能                                                         |  
|------------------------|--------------------------------------------------------------|  
| Microsoft Project 2000 | PROJECTFiles,ASSISTANTFiles,ProductFiles,PROJECTNonBootFiles |
...
1.  [Office XP 用のセキュリティ更新プログラム](https://download.microsoft.com/download/e/f/1/ef1f70a9-751d-46f9-85b4-632db8124f61/officexp-kb929063-fullfile-jpn.exe)および [Project 2002 Service Pack 1 (SP1) 用のセキュリティ更新プログラム](https://download.microsoft.com/download/c/2/0/c2004c89-b05e-4d85-a046-dda910d5f664/project2002-kb929063-fullfile-jpn.exe)および [Visio 2002 Service Pack 2 (SP2) 用のこのセキュリティ更新プログラム](https://download.microsoft.com/download/9/c/3/9c358d05-1588-45ed-8018-04a4a49eb80f/visio2002-kb929063-fullfile-jpn.exe)をダウンロードしてください。  
2.  \[このプログラムをディスクに保存する\] をクリックし、次に \[OK\] をクリックします。  
3.  \[保存\] をクリックします。  
4.  Windows エクスプローラを使用して、保存されたファイルを含むフォルダを検索し、次に保存されたファイルをダブルクリックします。  
5.  更新プログラムのインストールの確認メッセージが表示されたら、\[はい\] をクリックします。  
...
| ファイル名 | バージョン  | 日付       | 時間  | サイズ    |  
|------------|-------------|------------|-------|-----------|  
| Mso.dll    | 10.0.6825.0 | 2006/12/14 | 21:59 | 9,816,840 |
...
| Microsoft Project 2002                  | ProductFiles                   |
...
1.  [Office 2003 用のセキュリティ更新プログラムをダウンロードします。](https://download.microsoft.com/download/6/b/5/6b5b56c2-f2b1-4a02-9016-40ca3bd83fa5/office2003-kb929064-fullfile-jpn.exe)  
2.  \[このプログラムをディスクに保存する\] をクリックし、次に \[OK\] をクリックします。  
3.  \[保存\] をクリックします。  
4.  Windows エクスプローラを使用して、保存されたファイルを含むフォルダを検索し、次に保存されたファイルをダブルクリックします。  
5.  更新プログラムのインストールの確認メッセージが表示されたら、\[はい\] をクリックします。  
...
| ファイル名 | バージョン  | 日付       | 時間  | サイズ     |  
|------------|-------------|------------|-------|------------|  
| Ietag.dll  | 11.0.6550.0 | 2005/3/17  | 13:36 | 161,984    |  
| Mso.dll    | 11.0.8122.0 | 2006/12/27 | 15:18 | 12,257,032 |
...
バージョン番号が 11.3.4 であれば、この更新プログラムは正常にインストールされています。
...
-   PowerPoint の不正な形式のレコード メモリの破損の脆弱性 - [CVE-2006-3877](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3877) を報告してくださった [VigilantMinds Inc.](https://www.vigilantminds.com/) の Chris Ries 氏
...
-   Microsoft Baseline Security Analyzer (MBSA) : [https://www.microsoft.com/japan/technet/security/tools/Tools/mbsahome.mspx](https://technet.microsoft.com/ja-jp/security/cc184924.aspx)  
    MBSA ツールのセキュリティ更新プログラムの検出に関する制限は [306460](https://support.microsoft.com/kb/306460) をご覧ください。  
...
-   セキュリティ関連、およびセキュリティ更新プログラムに関するご質問や、ご不明な点などありましたら、マイクロソフト セキュリティ情報センターまでご連絡ください。  
    [マイクロソフト セキュリティ情報センター](https://www.microsoft.com/japan/security/sicinfo.mspx) マイクロソフトでは、お問い合わせの内容が弊社製品の不具合が原因である場合、無償でサポートをご提供いたします。  
-   その他、製品に関するご質問は、マイクロソフト プロダクト サポートまでご連絡ください。マイクロソフトでは、お問い合わせの内容が弊社製品の不具合が原因である場合、無償またはインシデントの未消費にてサポートをご提供いたします。  
    [マイクロソフト プロダクト サポートへの連絡方法はこちらをご覧ください。](https://support.microsoft.com/select/?target=assistance)
  
**詳細情報** **:**
  
-   US マイクロソフトセキュリティ情報 (MS07-015）  
    [https://www.microsoft.com/technet/security/bulletin/MS07-015.mspx](https://technet.microsoft.com/security/bulletin/ms07-015)  
-   サポート技術情報 （KB） 文書番号 ：932554  
    [\[MS07-015\] Microsoft Office の脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/932554)
...
-   2007/02/22: セキュリティ更新プログラムに関する情報を更新し、Office 2003 の必要条件欄に Project 2003 Service Pack 2、Visio 2003 Service Pack 2、OneNote 2003 Service Pack 2 に関する情報を追加しました。  
-   2008/04/24: このセキュリティ情報ページを更新し、「影響を受けるソフトウェア」の一覧の Microsoft Office XP Service Pack 3 のセクションから Microsoft Visio 2002 を削除しました。Microsoft Visio 2002 Service Pack 2 は、「影響を受けるソフトウェア」の別の欄に記載されています。
