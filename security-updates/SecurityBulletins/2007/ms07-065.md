...
[](https://www.microsoft.com/japan/security/bulletins/ms07-065e.mspx)
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS07-065.mspx](https://technet.microsoft.com/security/bulletin/ms07-065)
...
|----------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|---------------------------------------------------------------------|
| Windows 2000 Service Pack 4            | [![](../../images/Dn610189.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=bda9d0b4-f7cb-4d9d-b030-043d7437734b&displaylang=ja) | [![](../../images/Dn610189.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=bda9d0b4-f7cb-4d9d-b030-043d7437734b&amp;displaylang=ja-nec) | リモートでコードが実行される | 重要           | [MS05-017](https://technet.microsoft.com/security/bulletin/ms05-017) |
| Windows XP Service Pack 2              | [![](../../images/Dn610189.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=09d4e6ae-5d19-4f11-bb7e-60cee8263bc8&displaylang=ja) |                                                                                                                                                                                                           | 特権の昇格                   | 警告           | なし                                                                |
...
<th style="border:1px solid black;" >メッセージ キュー サービスのリモートでコードが実行される脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3039">CVE-2007-3039</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2007-3039](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3039) をご覧ください。
...
-   **メッセージ キュー サービスを無効にする**  
    ...
    -   グループ ポリシーを使用 :
        ...
        **注:** [Windows Server 2003 セキュリティ ガイド](https://www.microsoft.com/japan/technet/security/prodtech/windowsserver2003/w2003hg/sgch00.mspx) も参考にすることができます。このガイドには、サービスを無効にする方法に関する説明が記載されています。グループ ポリシーの詳細については、次のマイクロソフトの Web サイトを参照してください。
  
        -   [Step-by-Step Guide to Understanding the Group Policy Feature Set](https://www.microsoft.com/windows2000/techinfo/planning/management/groupsteps.asp) (英語情報）  
        -   [Windows Server に関する情報](https://www.microsoft.com/japan/windows2000/remove404.mspx)  
        -   [Group Policy in Windows Server 2003](https://technet2.microsoft.com/windowsserver/en/technologies/featured/gp/default.mspx) (英語情報）
...
-   メッセージ キュー サービスのリモートでコードが実行される脆弱性」の回避策 - [CVE-2007-3039](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3039) を報告してくださった [Zero Day Initiative](https://www.zerodayinitiative.com/)
-   「MSMQ のリモートでコードが実行される脆弱性」- [CVE-2007-3039](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3039) を報告してくださった [Venustech](https://www.venustech.com.cn/) の ADLABS 氏
