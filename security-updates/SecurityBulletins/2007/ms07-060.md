...
[](https://www.microsoft.com/japan/security/bulletins/ms07-060e.mspx)
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS07-060.mspx](https://technet.microsoft.com/security/bulletin/ms07-060)
...
|--------------------------------------|------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|---------------------------------------------------------------------|
| Microsoft Office 2000 Service Pack 3 | Microsoft Word 2000 Service Pack 3 | [![](../../images/Dn610184.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8b3072fb-5933-47f7-a498-13a93e268e57&displaylang=ja) (KB942669) | リモートでコードが実行される | 緊急           | [MS07-024](https://technet.microsoft.com/security/bulletin/ms07-024) |
| Microsoft Office XP Service Pack 3   | Microsoft Word 2002 Service Pack 3 | [![](../../images/Dn610184.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=d6b787bb-03ff-4f67-8b69-6011fb18ba75&displaylang=ja) (KB942670) | リモートでコードが実行される | 重要           | [MS07-024](https://technet.microsoft.com/security/bulletin/ms07-024) |
| Microsoft Office 2004 for Mac        | -                                  | [![](../../images/Dn610184.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/japan/mac/downloads.mspx)                                                                       | リモートでコードが実行される | 重要           | [MS07-024](https://technet.microsoft.com/security/bulletin/ms07-024) |
...
<th style="border:1px solid black;" >Word のメモリ破損の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3899"><strong>CVE-2007-3899</strong></a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2007-3899](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3899) をご覧ください。
...
-   [Microsoft Office 2004 for Mac 11.3.7 用の更新プログラム](https://www.microsoft.com/japan/mac/download/office2004/office04_1137.mspx)がコンピュータにインストールされている必要があります。
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/japan/mac/download/office2004/office04_1138.mspx)から Microsoft Office 2004 for Mac 11.3.8 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
-   「Word のメモリ破損の脆弱性」 - [CVE-2007-3899](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3899) の 問題を報告をしてくださった Information & Communication Security Technology Center の Liu Kun-Hao 氏
