---
TOCTitle: 'MS07-055'
Title: 'マイクロソフト セキュリティ情報 MS07-055 - 緊急'
ms:assetid: 'ms07-055'
ms:contentKeyID: 61229005
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms07-055(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS07-055 - 緊急
===============================================
...
[](https://www.microsoft.com/japan/security/bulletins/ms07-055e.mspx)

### 概説

#### 要点

この深刻度「緊急」の更新プログラムは非公開で報告された脆弱性を解決します。Kodak Image Viewer (以前は Wang Image viewer) が特別に細工された画像ファイルを処理する方法にリモートでコードが実行される脆弱性が存在します。この脆弱性で、攻撃者により影響を受けるコンピュータでリモートでコードが実行される可能性があります。コンピュータでユーザー権限が低い設定のアカウントを持つユーザーは、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。

この脆弱性は Windows 2000 を実行しているコンピュータのみに存在します。しかし、Windows 2000 からアップグレードされている場合、サポートされている 32-bit エディションの Windows XP および Windows Server 2003 を実行しているコンピュータもこの脆弱性の影響を受ける可能性があります。これは、Windows 2000 Service Pack 4、32-bit エディションの Windows XP Service Pack 2 およびサポートされている 32-bit エディションの Windows Server 2003 用の「緊急」のセキュリティ更新プログラムです。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

このセキュリティ更新プログラムは、Kodak Image viewer が特別に作成されたファイルの種類を処理する方法を改善すると共に、サポートが終了したファイルの種類を廃止することによりこの脆弱性を解決します。この脆弱性に関する詳細情報は、次の「脆弱性の情報」のセクションの下の特定の脆弱性のエントリに関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。

**推奨する対応策:** マイクロソフトは、お客様に直ちにこの更新プログラムを適用することを推奨します。

**既知の問題:** なし

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS07-055.mspx](https://technet.microsoft.com/security/bulletin/ms07-055)
...
![](../../images/Dn610179.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機用または NEC PC-9800 シリーズ用の更新プログラムをダウンロードしてください。
...
|------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Windows 2000 Service Pack 4                                                  | [![](../../images/Dn610179.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=29763117-c2dc-4746-b31e-0b27350118e6&displaylang=ja) | [![](../../images/Dn610179.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=29763117-c2dc-4746-b31e-0b27350118e6&amp;displaylang=ja-nec) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows XP Service Pack 2                                                    | [![](../../images/Dn610179.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=be52f740-e9c9-4228-95c0-00995213bbd0&displaylang=ja) |                                                                                                                                                                                                           | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Server 2003 Service Pack 1 および Windows Server 2003 Service Pack 2 | [![](../../images/Dn610179.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=9a5c9e5d-4908-48bf-9346-745b4c6f6d4e&displaylang=ja) |                                                                                                                                                                                                           | リモートでコードが実行される | 緊急           | なし                                                     |

**注:** Windows XP および Windows Server 2003 のサポートされているエディションは Windows 2000 からアップグレードされていない限り影響を受けません。
...
<span></span>
**Windows XP** **または** **Windows Server 2003** **を実行していますが、Kodak Image Viewer** **をインストールしていません。この場合、影響を受けますか?**  
いいえ。Windows XP および Windows Server 2003 を新規にインストールしている場合 Kodak Image Viewer は OS に含まれないため、この脆弱性の影響を受けません。Windows XP および Windows Server 2003 を実行しているコンピュータは Windows 2000 からアップグレードされた場合のみ影響を受けます。
...
<th style="border:1px solid black;" >Kodak Image Viewer のリモートでコードが実行される脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2217">CVE-2007-2217</a></th>
...
Kodak Image Viewer のリモートでコードが実行される脆弱性 - CVE-2007-2217  
-----------------------------------------------------------------------
  
<span></span>
Windows の Kodak Image Viewer が特別に細工された画像ファイルを処理する方法に、リモートでコードが実行される脆弱性が存在します。攻撃者は、ユーザーが Web サイトを訪問した場合、または特別な細工がされた電子メール メッセージを表示、または電子メールの添付を開いた場合にリモートでコードが実行される可能性のある特別な細工のされた画像を作成することにより、この脆弱性を悪用する可能性があります。攻撃者によりこの脆弱性が悪用された場合、影響を受けるコンピュータが完全に制御される可能性があります
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2007-2217](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2217) をご覧ください。
  
#### 「Kodak Image Viewer のリモートでコードが実行される脆弱性」の問題を緩和する要素 - CVE-2007-2217:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   Windows XP および Windows Server 2003 を実行しているコンピュータは Windows 2000 からアップグレードされた場合のみ影響を受けます。  
...
#### 「Kodak Image Viewer のリモートでコードが実行される脆弱性」の回避策 - CVE-2007-2217:
...
-   **oieng400.dll** **のアクセス制御リストを変更する**
  
    oieng400.dll のアクセス制御リスト (ACL) をさらに制限するために変更するためには、次のステップに従ってください。
  
    1.  管理者特権を持つユーザーとしてログオンします。  
    2.  \[スタート\] ボタンをクリックし、\[ファイル名を指定して実行\] をクリックします。次に「cmd」と入力して \[OK\] をクリックします。  
    3.  この変更を元に戻す時のため、現在のファイル (継承された設定を含む) の ACL のメモをとってください。ACL を表示するには、次を入力します:
    ...
    **回避策の影響:** Kodak Image Viewer が開きません。
  
    **回避策の解除方法:** この回避策のステップ 3 にある ACL を復元します。
  
#### 「Kodak Image Viewer のリモートでコードが実行される脆弱性」のよく寄せられる質問 - CVE-2007-2217:
...
この脆弱性が悪用されるには、特別に細工がされた画像ファイルをユーザーが表示するか、または開くことが攻撃者にとっての必要条件となります。イメージ ファイルの表示または閲覧に影響を受ける Kodak Image Viewer のライブラリのアプリケーションを使用しているすべてのコンピュータが影響を受ける可能性があります。
  
**この更新プログラムはどのように問題を修正しますか?**  
この更新プログラムは Kodak Image viewer が特別に細工されたファイルの種類を処理する方法を変更することにより、この脆弱性を排除します。
...
Windows2000-KB923810-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows 2000 Service Pack 4:  
Windows2000-KB923810-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows 2000 Service Pack 4:  
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。または、%Windir%\\$NTUninstallKB923810$\\Spuninst フォルダにある Spuninst.exe ユーティリティを使用してください。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB923810\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
|--------------|---------------|-----------|-------|---------|
| jpeg2x32.dll | 5.0.2195.7134 | 2007/8/17 | 12:19 | 39,184  |
| kodakimg.exe | 5.0.2195.7136 | 2007/8/17 | 12:15 | 524,560 |
| kodakprv.exe | 5.0.2195.7136 | 2007/8/17 | 12:15 | 73,488  |
| oieng400.dll | 5.0.2195.7144 | 2007/8/17 | 12:19 | 448,272 |
| sp3res.dll   | 5.0.2195.7136 | 2007/5/28 | 13:26 | 503,296 |
| tifflt.dll   | 5.0.3900.7134 | 2007/8/17 | 12:19 | 33,552  |
...
Windowsxp-kb923810-x86-jpn /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows XP Service Pack 2:  
Windowsxp-kb923810-x86-jpn /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP3\\KB923810\\Filelist
</td>
</tr>
</table>
...
|--------------|---------------|-----------|-------|---------|----------|
| jpeg2x32.dll | 5.0.2195.7136 | 2007/9/8  | 2:58  | 38,941  | SP2QFE   |
| kodakimg.exe | 5.0.2195.7138 | 2007/9/7  | 19:04 | 509,469 | SP2QFE   |
| kodakprv.exe | 5.0.2195.7138 | 2007/9/7  | 19:04 | 70,173  | SP2QFE   |
| oieng400.dll | 5.0.2195.7146 | 2007/9/8  | 2:58  | 447,517 | SP2QFE   |
| spru0411.dll | 5.1.2600.3158 | 2007/6/19 | 10:01 | 656,896 | SP2QFE   |
| tifflt.dll   | 5.0.3900.7136 | 2007/9/8  | 2:58  | 33,307  | SP2QFE   |
...
この更新プログラムは、オペレーティング システムを Windows 2000 からアップグレードした場合のみインストールされます。Windows 2000 がインストールされたことのないコンピュータの場合は、この脆弱性の影響を受けません。
...
WindowsServer2003-KB923810-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 1 および Windows Server 2003 Service Pack 2:  
WindowsServer2003-KB923810-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされており影響を受けるすべての 32-bit バージョンの Windows Server 2003 Service Pack 1 および Windows Server 2003 Service Pack 2:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB923810\\Filelist
</td>
</tr>
</table>
...
| ファイル名    | バージョン    | 日付      | 時間  | サイズ  | フォルダ |
|---------------|---------------|-----------|-------|---------|----------|
| jpeg2x32.dll  | 5.0.2195.7138 | 2007/9/11 | 2:31  | 38,941  | SP1QFE   |
| kodakimg.exe  | 5.0.2195.7140 | 2007/9/10 | 16:51 | 509,469 | SP1QFE   |
| kodakprv.exe  | 5.0.2195.7140 | 2007/9/10 | 16:51 | 70,173  | SP1QFE   |
| oieng400.dll  | 5.0.2195.7148 | 2007/9/11 | 2:31  | 447,517 | SP1QFE   |
| tifflt.dll    | 5.0.3900.7138 | 2007/9/11 | 2:31  | 33,307  | SP1QFE   |
| ws03a2409.dll | 5.2.3790.2957 | 2007/9/10 | 23:15 | 49,152  | SP1QFE   |
| jpeg2x32.dll  | 5.0.2195.7139 | 2007/9/11 | 2:38  | 38,941  | SP2QFE   |
| kodakimg.exe  | 5.0.2195.7141 | 2007/9/10 | 19:18 | 509,469 | SP2QFE   |
| kodakprv.exe  | 5.0.2195.7141 | 2007/9/10 | 19:18 | 70,173  | SP2QFE   |
| oieng400.dll  | 5.0.2195.7149 | 2007/9/11 | 2:38  | 447,517 | SP2QFE   |
| tifflt.dll    | 5.0.3900.7139 | 2007/9/11 | 2:38  | 33,307  | SP2QFE   |
| w03a3409.dll  | 5.2.3790.4107 | 2007/9/10 | 23:21 | 25,600  | SP2QFE   |
...
-   「Kodak Image Viewer のリモートでコードが実行される脆弱性」 - [CVE-2007-2217](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2217) の 問題を報告してくださったCu Fang 氏
-   「Kodak Image Viewer のリモートでコードが実行される脆弱性」 - [CVE-2007-2217](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2217) についてマイクロソフトに協力してくださった [Global360](https://www.global360.com/products/g360_imaging/default.asp) の Rita Schappler 氏
...
-   2007/10/18: セキュリティ情報を更新し、影響を受けないソフトウェアに Windows XP Professional x64 Edition を追加しました。
