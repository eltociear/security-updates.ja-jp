---
TOCTitle: 'MS11-020'
Title: 'マイクロソフト セキュリティ情報 MS11-020 - 緊急'
ms:assetid: 'ms11-020'
ms:contentKeyID: 61229297
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-020(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS11-020 - 緊急
===============================================
...
[](https://www.microsoft.com/japan/security/bulletins/ms11-020e.mspx)[![](../../images/Dn636510.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)

### 概説

#### 要点

このセキュリティ更新プログラムは非公開で報告された Microsoft Windows に存在する 1 件の脆弱性を解決します。この脆弱性で、攻撃者が特別に細工された SMB パケットを作成し、そのパケットを影響を受けるコンピューターに送信した場合、リモートでコードが実行される可能性があります。ファイアウォールによる最善策および標準のファイアウォールの既定の構成を使用することにより、組織のネットワーク境界の外部からのこの脆弱性を悪用しようとする攻撃を防ぎ、ネットワークを保護することができます。
...
このセキュリティ更新プログラムは SMB が不正な形式の SMB リクエストのフィールドで検証する方法を修正することにより、この脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS11-020.mspx](https://technet.microsoft.com/security/bulletin/ms11-020)
...
![](../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ccb08a8a-f4d9-4320-8ffb-3fd4fe217987&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7ee202da-a711-42ee-bea3-7202a70e4ea0&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=64c550d4-c927-4382-91e1-473ed6790819&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ef62db94-4f72-4245-ac9f-6391035e2516&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=79aeb3cd-7c73-467b-b91e-02c6ea01e911&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d6eddff4-a242-4dec-9d84-72891db2b754&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2878c587-6544-40b4-9288-fc3b3ce1128d&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a>,<br />
<a href="https://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=31c48ba9-7774-4633-862d-5c27c3703584&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a>,<br />
<a href="https://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=de843115-cf98-4511-aa93-f620e4572555&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a>,<br />
<a href="https://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b89b8e28-cd98-4bcc-8729-5e51d52d1e92&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a>,<br />
<a href="https://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d3ef905b-3584-4842-9ec2-cf3856305d49&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7ddc943b-6868-4e8f-a869-89b47133c287&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c4352802-9c5a-4c07-8303-3a4b78d3f954&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0005377b-443f-44ca-a890-620b2dcea6f1&amp;displaylang=ja"><img src="../../images/Dn636510.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
</tr>
...
<th style="border:1px solid black;" >SMB のトランザクション解析の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0661">CVE-2011-0661</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
マイクロソフトのサーバー メッセージ ブロック (SMB) プロトコルのソフトウェアが特別に細工された SMB パケットを処理する方法に、リモートで認証を必要としないコードが実行される脆弱性が存在します。この脆弱性が悪用されるには、認証は必要条件とはならないと考えられ、攻撃者は特別に細工された SMB パケットを Server サービスを実行しているコンピューターに送信して、この脆弱性を悪用する可能性があります。攻撃者はこの脆弱性を悪用し、コンピューターを完全に制御する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0661](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0661) をご覧ください。
  
#### 「SMB のトランザクション解析の脆弱性」の問題を緩和する要素 - CVE-2011-0661:
...
#### 「SMB のトランザクション解析の脆弱性」の回避策 - CVE-2011-0661:
...
#### 「SMB のトランザクション解析の脆弱性」のよく寄せられる質問 - CVE-2011-0661:
...
**何が原因で起こりますか?**  
この脆弱性は、Microsoft Server Message Block (SMB) プロトコルのソフトウェアが、いくつかの事前認証のシナリオなど、SMB パケットを適切に処理しない場合に起こります。
  
**Microsoft Server Message Block (SMB) プロトコルとは何ですか?**  
Microsoft Server Message Block (SMB) プロトコルとは、Microsoft Windows で使用されるマイクロソフトのネットワーク ファイル共有プロトコルです。詳細情報は、[Microsoft SMB Protocol and CIFS Protocol Overview](https://msdn.microsoft.com/library/aa365233(vs.85).aspx) (英語情報) をご覧ください。
...
攻撃者がこの脆弱性を悪用した場合、影響を受けるシステムを完全に制御する可能性があります。
  
**攻撃者はこの脆弱性をどのように悪用する可能性がありますか?**  
攻撃者は、特別に細工した SMB パケットを作成し、影響を受けるコンピューターにそのパケットを送信することにより、この脆弱性を悪用する可能性があります。
  
**主にどのようなコンピューターがこの脆弱性による危険にさらされますか?**  
SMB Server サービスが含まれているすべてのシステムがこの脆弱性による影響を受けます。ドメイン コントローラーは、既定ですべてのドメイン ユーザーにネットワーク共有を開いているため、この脆弱性が悪用される危険性がさらに高くなります。
  
**この更新プログラムはどのように問題を修正しますか?**  
この更新プログラムは SMB が不正な形式の SMB リクエストのフィールドで検証する方法を修正することにより、この脆弱性を解決します。
...
Windowsxp-KB2508429-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2508429-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB2508429-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB2508429-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB2508429$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポート技術情報 [2508429](https://support.microsoft.com/kb/2508429) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB2508429\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB2508429\\Filelist
</td>
</tr>
</table>
...
WindowsServer2003-KB2508429-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2508429-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2508429-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB2508429-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2508429\\Filelist
</td>
</tr>
</table>
...
Windows6.0-KB2508429-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2508429-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Vista:  
Windows6.0-KB2508429-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows Vista:  
Windows6.0-KB2508429-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2508429-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2508429-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2508429-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2508429-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows 7:  
Windows6.1-KB2508429-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows 7:  
Windows6.1-KB2508429-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2508429-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2508429-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   2011/04/28: このセキュリティ情報を更新し、「影響を受けるソフトウェア」の表で、Windows Vista および Windows Server 2008 のすべてのサポートされたエディションについての「この更新プログラムによって置き換えられるセキュリティ情報」の欄を修正しました。
