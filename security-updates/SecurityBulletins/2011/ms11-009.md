---
TOCTitle: 'MS11-009'
Title: 'マイクロソフト セキュリティ情報 MS11-009 - 重要'
ms:assetid: 'ms11-009'
ms:contentKeyID: 61229286
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-009(v=Security.10)'
---
...
|-------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|-----------------------------------------------------------|
| Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1                                         | [JScript 5.8](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=54a64215-e407-4b7b-8536-28817ef23bac)      | 情報漏えい             | 重要           | なし                                                      |
| Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1                                         | [VBScript 5.8](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=54a64215-e407-4b7b-8536-28817ef23bac)     | 情報漏えい             | 重要           | [MS10-022](https://go.microsoft.com/fwlink/?linkid=184779) |
| Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1                                   | [JScript 5.8](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=b854d76e-6891-426d-8c09-0ed8243a3b8d)      | 情報漏えい             | 重要           | なし                                                      |
| Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1                                   | [VBScript 5.8](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=b854d76e-6891-426d-8c09-0ed8243a3b8d)     | 情報漏えい             | 重要           | [MS10-022](https://go.microsoft.com/fwlink/?linkid=184779) |
| Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1         | [JScript 5.8](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=f482bd40-f0b9-4534-a768-45879f1e7285)\*\*  | 情報漏えい             | 警告           | なし                                                      |
| Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1         | [VBScript 5.8](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=f482bd40-f0b9-4534-a768-45879f1e7285)\*\* | 情報漏えい             | 警告           | [MS10-022](https://go.microsoft.com/fwlink/?linkid=184779) |
| Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1 | [JScript 5.8](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=f05a3de0-381c-4d17-83ee-ca4f6da1bdb0)      | 情報漏えい             | 警告           | なし                                                      |
| Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1 | [VBScript 5.8](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=f05a3de0-381c-4d17-83ee-ca4f6da1bdb0)     | 情報漏えい             | 警告           | [MS10-022](https://go.microsoft.com/fwlink/?linkid=184779) |
...
<span></span>
次の深刻度の評価は、脆弱性の影響が最も深刻な場合を想定しています。深刻度の評価およびセキュリティ上の影響に関連して、このセキュリティ情報の公開から 30 日以内にこの脆弱性が悪用される可能性に関する情報については、[2 月のセキュリティ情報の概要](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-feb)の Exploitability Index (悪用可能性指標) を参照してください。詳細については、[Microsoft Exploitability Index](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) (悪用可能性指標) を参照してください。
...
<th style="border:1px solid black;" >スクリプト エンジンの情報漏えいの脆弱性 - CVE-2011-0031</th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1 上の JScript 5.8 および VBScript 5.8</td>
<td style="border:1px solid black;">重要 <br />
情報漏えい</td>
<td style="border:1px solid black;">重要</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1 上の JScript 5.8 および VBScript 5.8 **</td>
<td style="border:1px solid black;">重要 <br />
情報漏えい</td>
<td style="border:1px solid black;">重要</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1** 上の JScript 5.8 および VBScript 5.8</td>
<td style="border:1px solid black;">警告 <br />
情報漏えい</td>
<td style="border:1px solid black;">警告</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1 上の JScript 5.8 および VBScript 5.8</td>
<td style="border:1px solid black;">警告 <br />
情報漏えい</td>
<td style="border:1px solid black;">警告</td>
</tr>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-0031](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0031) を参照してください。
...
-   既定で、Windows Server 2008 および Windows Server 2008 R2 上の[](https://technet.microsoft.com/ja-jp/library/dd883248(ws.10).aspx)Internet Explorer は、「セキュリティ強化の構成」と呼ばれる制限されたモードで実行されます。このモードは、この脆弱性の影響を緩和します。Internet Explorer のセキュリティ強化の構成に関する詳細については、このセキュリティ更新プログラムに関する「よく寄せられる質問」を参照してください。
...
セキュリティ更新プログラムは、[Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) および [Windows Update](https://update.microsoft.com) から入手できます。セキュリティ更新プログラムは、[Microsoft ダウンロード センター](https://go.microsoft.com/fwlink/?linkid=21129)からもダウンロードできます。「セキュリティ更新プログラム」のキーワード探索で容易に見つけられます。
...
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows 7 上の JScript 5.8 および VBScript 5.8<br />
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2475792/ja">サポート技術情報 2475792</a> を参照してください。</td>
</tr>
<tr class="odd">
...
-   スクリプト エンジンの情報漏えいの脆弱性 - CVE-2011-0031 を報告してくださった [Palo Alto Networks](https://www.paloaltonetworks.com/) の Yamata Li 氏
