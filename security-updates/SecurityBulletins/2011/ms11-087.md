...
このセキュリティ更新プログラムは、最初に[マイクロソフト セキュリティ アドバイザリ 2639658](https://technet.microsoft.com/ja-jp/security/advisory/2639658/ja) で説明した脆弱性も解決します。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|---------------------------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=b01bb041-005c-48c4-a606-66aa264ba0fa&displaylang=ja)                                                                                               | リモートでコードが実行される | 緊急           | [MS11-077](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-077) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0a872cd2-5f4d-400c-a1c4-a2d194746fb6&displaylang=ja)                                                                      | リモートでコードが実行される | 緊急           | [MS11-077](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-077) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e84e6964-1580-41ef-9d3e-4d0c3ad4cb69&displaylang=ja)                                                                                      | リモートでコードが実行される | 緊急           | [MS11-077](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-077) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9d9f3667-3fd6-4948-83db-282783599f41&displaylang=ja)                                                                          | リモートでコードが実行される | 緊急           | [MS11-077](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-077) |
| [Windows Server 2003 with SP2 for Itanium-based Systems](https://www.microsoft.com/download/details.aspx?familyid=1ecf72cd-6732-4cf3-aa22-8caf15ea633e&displaylang=ja)                                                                  | リモートでコードが実行される | 緊急           | [MS11-077](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-077) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7f69ec9d-43ad-4106-90ef-c191e7ec43af&displaylang=ja)                                                                                            | リモートでコードが実行される | 緊急           | [MS11-077](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-077) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ae1f1f86-6f13-4e1e-9f93-4f70b6c9927e&displaylang=ja)                                                                                | リモートでコードが実行される | 緊急           | [MS11-077](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-077) |
| [Windows Server 2008 for 32-bit Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c4ba344d-dd0d-4cfb-81d9-d364d7f37e25&displaylang=ja)\*\*\*\*                                                           | リモートでコードが実行される | 緊急           | [MS11-077](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-077) |
| [Windows Server 2008 for x64-based Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=058963f6-9654-41d0-86d2-f25a0c2ad416&displaylang=ja)\*\*\*\*                                                        | リモートでコードが実行される | 緊急           | [MS11-077](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-077) |
| [Windows Server 2008 for Itanium-based Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=42cd1c33-11a7-4a29-ae85-f7272a626f91&displaylang=ja)                                                            | リモートでコードが実行される | 緊急           | [MS11-077](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-077) |
| [Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0526727a-f2fb-4846-9b04-f1899f52f1f6&displaylang=ja)                                         | リモートでコードが実行される | 緊急           | [MS11-084](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-084) |
| [Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=cfd42c42-1595-419a-bf04-b23b64663629&displaylang=ja)                                   | リモートでコードが実行される | 緊急           | [MS11-084](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-084) |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=d64a31ca-cccd-488a-98fd-c059b9e9e1ea&displaylang=ja)\*\*\*\* | リモートでコードが実行される | 緊急           | [MS11-084](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-084) |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=b46f6da7-6d24-4262-8e55-3b657db39813&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS11-084](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-084) |
...
ただし、今回のセキュリティ更新プログラムを適用した後に、「T2EMBED.DLL へのアクセスを拒否」するの回避策で無効にされた機能を元に戻すため、適用されたシステムから回避策を取り消す必要があります。自動化された Microsoft Fix it ソリューションを使用してこの回避策を無効にする方法については、[サポート技術情報 2639417](https://support.microsoft.com/kb/2639417/ja) を参照してください。

ファイル情報の詳細はどこにありますか?  
ファイル情報の詳細の場所については、「セキュリティ更新プログラムの展開」の参照表をご覧ください。

Windows Developer Preview はこの問題の影響を受けますか?  
はい。Windows Developer Preview リリース向けの更新プログラム KB2639417 が利用可能です。Windows Developer Preview をご使用のお客様は、システムにこの更新プログラムを適用することをお勧めします。この更新プログラムは、[Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) で利用可能です。
...
-   T2EMBED.DLL へのアクセスを拒否する
    ...
    注 この回避策を適用する前に、ユーザーは最新のマイクロソフトのセキュリティ更新プログラムを適用する必要があります。ご使用のソフトウェアが最新のものかどうか定かでない場合は、[Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) にアクセスし、コンピューターをスキャンして利用可能な更新プログラムがあるかどうかを調べ、提示される優先度の高い更新プログラムをインストールしてください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2639417/ja">サポート技術情報 2639417</a> を参照してください。</td>
</tr>
<tr class="even">
