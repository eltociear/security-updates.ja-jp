...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|---------------------------------------------------------------------|
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c2d4aa38-9241-465d-8d65-aba73e936d0f)                                                                                | サービス拒否                 | 重要           | [MS09-008](https://technet.microsoft.com/security/bulletin/ms09-008) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2db4098a-f4f9-4211-b55d-5d0df1409c43)                                                                    | サービス拒否                 | 重要           | [MS09-008](https://technet.microsoft.com/security/bulletin/ms09-008) |
| [Windows Server 2003 with SP2 for Itanium-based Systems](https://www.microsoft.com/download/details.aspx?familyid=1934acfa-5637-4ae9-9e9a-fc7e58930b7a)                                                            | サービス拒否                 | 重要           | [MS09-008](https://technet.microsoft.com/security/bulletin/ms09-008) |
| [Windows Server 2008 for 32-bit Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ac2d5122-6f9b-46f5-9840-77aa7ff84308)\*                                                           | リモートでコードが実行される | 緊急           | なし                                                                |
| [Windows Server 2008 for x64-based Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5f605f6f-3854-403d-878b-637626aef78f)\*                                                        | リモートでコードが実行される | 緊急           | なし                                                                |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=6a86e2cf-4e7d-4012-88c3-6957a3842dd3)\* | リモートでコードが実行される | 緊急           | なし                                                                |
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1966](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1966) を参照してください。
...
Naming Authority Pointer (NAPTR) DNS リソース レコード (RR) により、DNS を使用して、ドメイン名構文になっていない URI など、さまざまなリソース名のサービスを検索できるようになります。NAPTR の詳細については、[RFC-2915](https://www.ietf.org/rfc/rfc2915.txt) を参照してください。
  
DNS リソース レコードとは何ですか?   
DNS リソース レコード (RR) は、ドメイン内の特定リソースを識別します。詳細については、TechNet の記事 [How DNS Works](https://technet.microsoft.com/ja-jp/library/dd197446(ws.10).aspx) (英語情報) を参照してください。
  
URI とは何ですか?   
Uniform Resource Identifier (URI) とは、インターネットからのリソースおよびネットワーク上のリソースの操作または識別を行うために使用される文字列です。URL は Web サイトなどのリソースを参照する URI の典型的な例です。URI に関する詳細情報は [RFC-2396](https://www.ietf.org/rfc/rfc2915.txt) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1970](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1970) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2562485">マイクロソフト サポート技術情報 2562485</a> を参照してください。</td>
</tr>
<tr class="even">
