...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS11-054.mspx](https://technet.microsoft.com/security/bulletin/ms11-054)
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=d7a47370-f415-46ea-9a82-a943f743c8b6&displaylang=ja)                                                                                               | 特権の昇格             | 重要           | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=db89d88f-d0d4-4ed6-8589-bf27557c0304&displaylang=ja)                                                                      | 特権の昇格             | 重要           | [MS11-041](https://technet.microsoft.com/security/bulletin/ms11-041) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7a26a437-a705-4d48-8389-50f159a39891&displaylang=ja)                                                                                      | 特権の昇格             | 重要           | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=95393f89-0b05-4243-95ed-17bcdad24bfb&displaylang=ja)                                                                          | 特権の昇格             | 重要           | [MS11-041](https://technet.microsoft.com/security/bulletin/ms11-041) |
| [Windows Server 2003 with SP2 for Itanium-based Systems](https://www.microsoft.com/download/details.aspx?familyid=3b094bdb-4150-44f2-a638-afd5f41b00a3&displaylang=ja)                                                                  | 特権の昇格             | 重要           | [MS11-041](https://technet.microsoft.com/security/bulletin/ms11-041) |
| [Windows Vista Service Pack 1 および Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c1fe1e53-34d5-497e-8ba2-50caa8dc1158&displaylang=ja)                                                        | 特権の昇格             | 重要           | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7bc0a285-cc32-4c6b-abee-d92130d459b7&displaylang=ja)                                | 特権の昇格             | 重要           | [MS11-041](https://technet.microsoft.com/security/bulletin/ms11-041) |
| [Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b88d0471-4427-4835-9446-db71116481f0&displaylang=ja)\*                   | 特権の昇格             | 重要           | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d3df6184-3e3c-4949-a1ee-293ec68f8149&displaylang=ja)\*             | 特権の昇格             | 重要           | [MS11-041](https://technet.microsoft.com/security/bulletin/ms11-041) |
| [Windows Server 2008 for Itanium-based Systems および Windows Server 2008 for Itanium-based Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9e021d69-7f0c-457f-af86-07e760d8f421&displaylang=ja)       | 特権の昇格             | 重要           | [MS11-041](https://technet.microsoft.com/security/bulletin/ms11-041) |
| [Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=41db1b2f-f862-43bb-89bc-4b97737e5cb9&displaylang=ja)                                         | 特権の昇格             | 重要           | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=211abdc6-40c7-4bfc-8c2d-be72981f311e&displaylang=ja)                                   | 特権の昇格             | 重要           | [MS11-041](https://technet.microsoft.com/security/bulletin/ms11-041) |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=4f54e498-3825-407d-a036-1900a65d34f1&displaylang=ja)\*       | 特権の昇格             | 重要           | [MS11-041](https://technet.microsoft.com/security/bulletin/ms11-041) |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=e7ae39e8-1154-4a13-8598-29d4a6358762&displaylang=ja) | 特権の昇格             | 重要           | [MS11-041](https://technet.microsoft.com/security/bulletin/ms11-041) |

**\*Server Core インストールは影響を受けます。**サポートされているエディションの Windows Server 2008 または Windows Server 2008 R2 では、Server Core インストール オプションを使用してインストールされているかどうかに関わらず、この更新プログラムの深刻度は同じです。 このインストール オプションの詳細については、[Server Core](https://wwwppe/japan/windowsserver2008/technologies/server-core.mspx) および [Windows Server 2008 R2 の Server Core](https://wwwppe/japan/windowsserver2008/r2/technologies/server-core.mspx) を参照してください。 Windows Server 2008 および Windows Server 2008 R2 の特定のエディションでは、Server Core インストール オプションが使用できないことに注意してください。詳細については、[Server Core インストールオプションの比較](https://wwwppe/japan/windowsserver2008/r2/editions/core-installation.mspx) を参照してください。
...
<th style="border:1px solid black;" >Win32k の解放後使用の脆弱性 – CVE-2011-1874</th>
<th style="border:1px solid black;" >Win32k の解放後使用の脆弱性 – CVE-2011-1875</th>
<th style="border:1px solid black;" >Win32k の解放後使用の脆弱性 – CVE-2011-1876</th>
<th style="border:1px solid black;" >Win32k の解放後使用の脆弱性 – CVE-2011-1877</th>
<th style="border:1px solid black;" >Win32k の解放後使用の脆弱性 – CVE-2011-1878</th>
<th style="border:1px solid black;" >Win32k の解放後使用の脆弱性 – CVE-2011-1879</th>
<th style="border:1px solid black;" >Win32k の NULL ポインター逆参照の脆弱性 - CVE-2011-1880</th>
<th style="border:1px solid black;" >Win32k の NULL ポインター逆参照の脆弱性 - CVE-2011-1881</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<tr class="header">
<th style="border:1px solid black;" >影響を受けるソフトウェア</th>
<th style="border:1px solid black;" >Win32k の解放後使用の脆弱性 – CVE-2011-1882</th>
<th style="border:1px solid black;" >Win32k の解放後使用の脆弱性 – CVE-2011-1883</th>
<th style="border:1px solid black;" >Win32k の解放後使用の脆弱性 – CVE-2011-1884</th>
<th style="border:1px solid black;" >Win32k の NULL ポインター逆参照の脆弱性 - CVE-2011-1885</th>
<th style="border:1px solid black;" >Win32k の不適切なパラメーター検証による情報漏えいの脆弱性 - CVE-2011-1886</th>
<th style="border:1px solid black;" >Win32k の NULL ポインター逆参照の脆弱性 - CVE-2011-1887</th>
<th style="border:1px solid black;" >Win32k の NULL ポインター逆参照の脆弱性 - CVE-2011-1888</th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1874](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1874) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1875](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1875) を参照してください。
...
#### 「Win32k の解放後使用の脆弱性」の回避策 – CVE-2011-1875
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1876](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1876) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1877](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1877) を参照してください。
  
#### 「Win32k の解放後使用の脆弱性」の問題を緩和する要素 – CVE-2011-1877
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1878](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1878) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1879](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1879) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1880](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1880) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1881](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1881) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1882](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1882) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1883](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1883) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1884](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1884) を参照してください。
  
#### 「Win32k の解放後使用の脆弱性」の問題を緩和する要素 – CVE-2011-1884
  
緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーが、この脆弱性を悪用することはないと思われます。
  
#### 「Win32k の解放後使用の脆弱性」の回避策 – CVE-2011-1884
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Win32k の解放後使用の脆弱性」のよく寄せられる質問 – CVE-2011-1884
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1885](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1885) を参照してください。
  
#### 「Win32k の NULL ポインター逆参照の脆弱性」の問題を緩和する要素 - CVE-2011-1885
  
緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーが、この脆弱性を悪用することはないと思われます。
  
#### 「Win32k の NULL ポインター逆参照の脆弱性」の回避策 - CVE-2011-1885
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Win32k の NULL ポインター逆参照の脆弱性」のよく寄せられる質問 - CVE-2011-1885
...
Win32k の不適切なパラメーターによる情報漏えいの脆弱性 - CVE-2011-1886  
---------------------------------------------------------------------
  
 
Windows カーネルモード ドライバーが関数パラメーターを検証する方法が原因で、情報漏えいの脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、SAM ファイルにアクセスするなど、カーネル メモリの任意の場所にあるデータにアクセスできるようになります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1886](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1886) を参照してください。
  
#### 「Win32k の不適切なパラメーターによる情報漏えいの脆弱性」の問題を緩和する要素 - CVE-2011-1886
  
緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーが、この脆弱性を悪用することはないと思われます。
  
#### 「Win32k の不適切なパラメーターによる情報漏えいの脆弱性」の回避策 - CVE-2011-1886
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Win32k の不適切なパラメーターによる情報漏えいの脆弱性」のよく寄せられる質問 - CVE-2011-1886
...
**SAM ファイルとは何ですか?**    
セキュリティ アカウント マネージャー (SAM) データベース ファイルは、Windows におけるユーザー パスワードの格納場所です。パスワードはデータベースにハッシュ化された形式で格納されています。ハッシュ化とは、データの断片から固有の "指紋" を生成する暗号化プロセスです。ハッシュ関数は一方向関数なので、攻撃者が他のユーザーのパスワードのハッシュ値を取得しても、それを "逆ハッシュ化" してパスワードそのものを得ることはできません。
  
それに対し、攻撃者が SAM データベースにアクセスできるようになると、オフラインでパスワード解読攻撃を仕掛けられるようになります。攻撃者は SAM データベースを他のコンピューターにコピーすると、可能なパスワードを 1 つ残らず徹底的に生成してハッシュ化し、生成された値をデータベースに格納されているハッシュ値と比較します。たとえば、"XYZ" のハッシュ値と同じ値がデータベースに存在したと場合、攻撃者はそのユーザーのパスワートが "XYZ" だとわかります。SAM データベースのコピーが得られれば、このような攻撃を行うためのツールが入手可能です。
  
**攻撃者は、この脆弱性を悪用して何を行う可能性がありますか?**    
攻撃者はこの脆弱性を悪用して、SAM ファイルにアクセスするなど、カーネルモード メモリの任意の場所にあるデータにアクセスできるようになります。
  
**攻撃者はこの脆弱性をどのように悪用する可能性がありますか?**    
攻撃者は渡された特定の関数パラメーターをカーネルモード ドライバーが検証する方法を悪用し、カーネルモード メモリの任意の場所にあるデータにアクセスできます。
  
**主にどのコンピューターがこの脆弱性による危険にさらされますか?**    
主に、ワークステーションおよびターミナル サーバーが、この脆弱性による危険にさらされます。管理者がユーザーにサーバーへのログオンおよびプログラムの実行を許可している場合、サーバーが影響を受ける可能性が高くなります。しかし、最善策では、これを許可しないことを強く推奨しています。
  
**この更新プログラムはどのように問題を修正しますか?**    
この更新プログラムは、カーネルモード ドライバーが関数パラメーターを検証する方法を修正することにより、この脆弱性を解決します。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1887](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1887) を参照してください。
  
#### 「Win32k の NULL ポインター逆参照の脆弱性」の問題を緩和する要素 - CVE-2011-1887
  
緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーが、この脆弱性を悪用することはないと思われます。
  
#### 「Win32k の NULL ポインター逆参照の脆弱性」の回避策 - CVE-2011-1887
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Win32k の NULL ポインター逆参照の脆弱性」のよく寄せられる質問 - CVE-2011-1887
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1888](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1888) を参照してください。
  
#### 「Win32k の NULL ポインター逆参照の脆弱性」の問題を緩和する要素 - CVE-2011-1888
  
緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーが、この脆弱性を悪用することはないと思われます。
  
#### 「Win32k の NULL ポインター逆参照の脆弱性」の回避策 - CVE-2011-1888
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Win32k の NULL ポインター逆参照の脆弱性」のよく寄せられる質問 - CVE-2011-1888
...
WindowsXP-KB2555917-x86-JPN /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2555917-x64-JPN /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
WindowsXP-KB2555917-x86-JPN /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2555917-x64-JPN /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2555917$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>ファイルに関する情報</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2555917">サポート技術情報 2555917</a> を参照してください。</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2555917-x86-JPN /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2555917-ia64-JPN /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32-bit エディションの Windows Server 2003:<br />
WindowsServer2003-KB2555917-x86-JPN /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003:<br />
WindowsServer2003-KB2555917-ia64-JPN /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ログ ファイル</td>
<td style="border:1px solid black;">KB2555917.log</td>
...
-   Win32k の解放後使用の脆弱性 (CVE-2011-1874) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1875) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1876) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1877) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1878) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1879) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の NULL ポインター逆参照の脆弱性 (CVE-2011-1880) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の NULL ポインター逆参照の脆弱性 (CVE-2011-1881) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1882) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1883) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1884) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の NULL ポインター逆参照の脆弱性 (CVE-2011-1885) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の不適切なパラメーター検証による情報漏えいの脆弱性 (CVE-2011-1886) を報告してくださった[北京大学ソフトウェアおよびマイクロエレクトロニクス学院](https://www.ss.pku.edu.cn/en/)の Liang Yin 氏、Sihan Qing 教授、Weiping Wen 教授、および Husheng Zhou 氏  
-   Win32k の NULL ポインター逆参照の脆弱性 (CVE-2011-1887) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の NULL ポインター逆参照の脆弱性 (CVE-2011-1888) を報告してくださった [Norman](https://www.norman.com) の Tarjei Mandt 氏
