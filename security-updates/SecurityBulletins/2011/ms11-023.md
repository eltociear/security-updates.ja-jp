...
[](https://www.microsoft.com/japan/security/bulletins/ms11-023e.mspx)[![](../../images/Dn636513.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
既知の問題: [サポート技術情報 2489293](https://support.microsoft.com/kb/2489293) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。なお、既知の問題および推奨される解決策がソフトウェアの特定のリリースにのみ該当する場合は、サポート技術情報に関連のリンクを掲載します。

US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS11-023.mspx](https://technet.microsoft.com/security/bulletin/ms11-023)
...
<td style="border:1px solid black;">
[![](../../images/Dn636513.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6c87c2a9-3705-4680-8a9b-63b6ec83674d&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636513.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8b68cf68-1606-4649-b860-a64702c6cf33&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636513.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=dbba0cd4-ab72-4e2b-9524-fd6be27f0b02&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636513.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f756d836-6ab2-4adb-9dee-6cb523d7c1f5&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636513.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=84dfe3f4-a2a1-47b9-8da1-29ae67230918&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636513.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=0c323a12-6385-4666-ad39-a9516a8eda14&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
はい。この更新プログラムにより解決される「Office コンポーネントの安全でないライブラリのロードの脆弱性」 (CVE-2011-0107) は、マイクロソフト セキュリティ アドバイザリ [2269637](https://technet.microsoft.com/security/advisory/2269637) で説明しているアプリケーションが外部ライブラリをロードする方法に影響する脆弱性の一種に関連するものです。このセキュリティ更新プログラムはこの種の脆弱性の特定の問題を解決します。

この更新プログラムには、機能性に対してセキュリティ関連の変更が含まれますか?     
はい。Microsoft Office 2003 Service Pack 3 (KB2509503) および Microsoft Office 2007 Service Pack 2 (KB2509488) 用のこの更新プログラムは、Microsoft Word、Microsoft Excel および Microsoft PowerPoint 用の更新プログラムとともに、Office ファイル検証機能のサポートを提供します。Office ファイル検証機能に関する詳細情報は、[マイクロソフト セキュリティ アドバイザリ 2501584](https://technet.microsoft.com/security/advisory/2501584) をご覧ください。

この更新プログラムは MS11-029 と、どのような関連がありますか?     
このセキュリティ情報で提供している Microsoft Office XP 用のセキュリティ更新プログラム パッケージ (KB2509461) は、セキュリティ情報 [MS11-029](https://technet.microsoft.com/security/bulletin/ms11-029) で説明している脆弱性も解決します。Microsoft Office XP をインストールしているユーザーはいずれかのセキュリティ更新プログラム パッケージをインストールしてください。
...
このセキュリティ情報で提供している Microsoft Office 2004 for Mac (KB2505924)、Microsoft Office 2008 for Mac (KB2505927) および Open XML File Format Converter for Mac (KB2505935) 用のセキュリティ更新プログラム パッケージはセキュリティ情報 [MS11-022](https://technet.microsoft.com/security/bulletin/ms11-022) および [MS11-021](https://technet.microsoft.com/security/bulletin/ms11-021) で説明している脆弱性も解決します。Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac または Open XML File Format Converter for Mac をご利用の場合、これらのセキュリティ更新プログラムのインストールが必要なのは 1 回だけです。
...
<th style="border:1px solid black;" >
Office コンポーネントの安全でないライブラリのロードの脆弱性 - [CVE-2011-0107](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107)
</th>
<th style="border:1px solid black;" >
Microsoft Office グラフィック オブジェクトの逆参照の脆弱性 - [CVE-2011-0977](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0977)
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0107](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107) をご覧ください。
...
はい。この脆弱性は一般で公開されていました。これは Common Vulnerability and Exposure の [CVE-2011-0107](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107) にアサインされています。

このセキュリティ情報の公開時に、マイクロソフトはこの脆弱性が悪用されたという報告を受けていましたか?    
いいえ。マイクロソフトは、このセキュリティ情報が最初に公開された際に、この脆弱性が一般で悪用され、お客様が攻撃されていたことを示す情報を受けていませんでした。

このセキュリティ更新プログラムを適用することは、一般に公開された、この脆弱性が悪用される可能性のある検証用コードからお客様を保護する手助けとなりますか？     
はい。このセキュリティ更新プログラムは、公開された検証用コードを使用して悪用される可能性がある脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2011-0107](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107) に割り当てられています。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0977](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0977) をご覧ください。
...
-   Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から Microsoft Excel の Office 2003 以前のドキュメントを開くことをブロックする
    ...
    回避策の影響: Microsoft Office 2003 および Microsoft Office 2007 について、ファイル ブロックのポリシーは構成していますが、特別な「除外されるディレクトリ」を構成していないユーザー、またはサポート技術情報 [922848](https://support.microsoft.com/kb/922848) で説明しているように、ファイルを信頼できる場所へ移動させていないユーザーは、Office 2003 ファイルまたはそれ以前のバージョンを開けなくなります。
...
<td style="border:1px solid black;">
サポート技術情報 [2509461](https://support.microsoft.com/kb/2509461) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
<td style="border:1px solid black;">
サポート技術情報 [2509503](https://support.microsoft.com/kb/2509503) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
<td style="border:1px solid black;">
サポート技術情報 [2509488](https://support.microsoft.com/kb/2509488) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
[Microsoft ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=84dfe3f4-a2a1-47b9-8da1-29ae67230918&displaylang=ja)から Microsoft Office 2008 for Mac 12.2.9 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[Microsoft ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=0c323a12-6385-4666-ad39-a9516a8eda14&displaylang=ja)から Mac 1.1.9 用の Open XML File Format Converter の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
-   Office コンポーネントの安全でないライブラリのロードの脆弱性 - [CVE-2011-0107](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2011-0107) を報告してくださった [Fortinet の FortiGuard Labs](https://www.fortiguard.com/) の Haifei Li氏
-   Microsoft Office のグラフィック オブジェクトの逆参照の脆弱性 - [CVE-2011-0977](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0977) を報告してくださった [TippingPoint](https://www.tippingpoint.com/) の [Zero Day Initiative](https://www.zerodayinitiative.com/) に協力している匿名のリサーチャー
