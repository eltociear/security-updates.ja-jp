...
既知の問題: [マイクロソフト サポート技術情報 2640241](https://support.microsoft.com/kb/2640241/ja) で、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。
...
<td style="border:1px solid black;">
[Microsoft Excel 2003 Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=5859014f-afc5-4958-82ea-6ba45a5ad4b3&displaylang=ja)  
(KB2596954)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
...
<td style="border:1px solid black;">
[Microsoft Office 2004 for Mac](https://www.microsoft.com/download/details.aspx?familyid=ef3b559c-0bd2-45dd-8049-6946f6431a2a&displaylang=ja)  
(KB2644358)
</td>
<td style="border:1px solid black;">
対象外
...
Office ファイル検証機能が Microsoft Excel 2003 で有効にされている場合、CVE-2011-3403 で説明しているこの脆弱性の悪用を目的として特別に細工されたファイルが自動的には開かなくなり、その代わりに、既定で、ファイルを開くかどうかの選択がユーザーに提供されます。ユーザーがファイルを開くには、これらの脆弱性が悪用されてしまう前に、この警告に対してクリックで答えていく必要があります。Microsoft Excel 2003 の Office ファイル検証機能の詳細については、[マイクロソフト セキュリティ アドバイザリ 2501584](https://technet.microsoft.com/ja-jp/security//advisory/2501584) を参照してください。

Excel 2003 でファイル検証に失敗したファイルが開かれることを無効にした場合、どのような利点がありますか?  
Office ファイル検証機能を設定して、Excel 2003 で疑わしいファイルが開かないようにすることで、[サポート技術情報 2501584](https://support.microsoft.com/kb/2501584/ja) でご利用いただける Microsoft Fix it ソリューション「Excel 2003 および 2007 の文書を開く操作を無効にする」により、CVE-2011-3403 で説明している脆弱性を悪用する攻撃手法が阻止されます。

[サポート技術情報 2501584](https://support.microsoft.com/kb/2501584/ja) で、自動化された Fix it ソリューション「Excel 2003 および 2007 の文書を開く操作を無効にする」の適用方法を確認するか、または、このセキュリティ情報の「脆弱性の情報」の CVE-2011-1986 および CVE-2011-1987 の回避策のセクションで、手動によるソリューションの適用方法を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-3403](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3403) を参照してください。
...
回避策の影響: Microsoft Office 2003 について、ファイル ブロックのポリシーを構成しており、特別な「除外されるディレクトリ」を構成していないか、またはファイルを信頼できる場所へ移動させていないユーザーは、Office 2003 またはそれ以前のバージョンのファイルを開けなくなります。Microsoft Office ソフトウェアのファイル ブロックの設定による影響については、[サポート技術情報 922850](https://support.microsoft.com/kb/922850/ja) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2596954/ja">サポート技術情報 2596954</a> を参照してください。</td>
</tr>
<tr class="even">
...
[マイクロソフト ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=ef3b559c-0bd2-45dd-8049-6946f6431a2a&displaylang=ja)から Microsoft Office 2004 for Mac 11.6.6 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) に協力して、レコードのメモリ破損の脆弱性 (CVE-2011-3403) を報告してくださった匿名のリサーチャー
