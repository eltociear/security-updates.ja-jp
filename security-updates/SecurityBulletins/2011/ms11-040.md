...
[](https://www.microsoft.com/japan/security/bulletins/ms11-040e.mspx)[![](../../images/Dn636530.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS11-040.mspx](https://technet.microsoft.com/security/bulletin/ms11-040)
...
|-----------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Microsoft Forefront Threat Management Gateway 2010 クライアント | [![](../../images/Dn636530.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=d1c85acd-a6df-4634-9cd4-c562ad92097e&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
...
<th style="border:1px solid black;" >TMG ファイアウォール クライアントのメモリ破損の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1889">CVE-2011-1889</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-1889](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1889) をご覧ください。
...
Forefront TMG クライアントに関する詳細情報は、[Firewall Client Basics: Introduction to the ISA Server Firewall Client and Forefront TMG Client](https://technet.microsoft.com/en-us/library/ee291341.aspx) (英語情報) をご覧ください。
...
<td style="border:1px solid black;">
サポート技術情報 [2520426](https://support.microsoft.com/kb/2520426) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
