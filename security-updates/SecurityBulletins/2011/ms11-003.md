---
TOCTitle: 'MS11-003'
Title: 'マイクロソフト セキュリティ情報 MS11-003 - 緊急'
ms:assetid: 'ms11-003'
ms:contentKeyID: 61229280
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-003(v=Security.10)'
---
...
[](https://www.microsoft.com/japan/security/bulletins/ms11-003e.mspx)[![](../../images/Dn636493.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)

### 概説

#### 要点

このセキュリティ更新プログラムは Internet Explorer に存在する 2 件の非公開で報告された脆弱性と 2 件の公開された脆弱性を解決します。この脆弱性により、ユーザーが Internet Explorer を利用して、特別に細工された Web ページを閲覧する、または特別に細工したライブラリ ファイルをロードする正当な HTML ファイルを表示した場合に、リモートでコードが実行される可能性があります。これらの脆弱性が悪用された場合、攻撃者はローカル ユーザーと同じ権限を取得する可能性があります。システムでアカウントのユーザー権限を低く設定している場合、管理者ユーザー権限で実行しているユーザーよりも、この脆弱性の影響が少なくなると考えられます。

このセキュリティ更新プログラムは、Windows クライアント上の Internet Explorer 6、Internet Explorer 7 および Internet Explorer 8 について深刻度を「緊急」と評価し、Windows サーバー上の Internet Explorer 6、Internet Explorer 7 および Internet Explorer 8 について深刻度を「警告」と評価しています。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

このセキュリティ更新プログラムは、Internet Explorer がメモリのオブジェクトおよびカスケード スタイル シート処理する方法、および外部ライブラリをロードする方法を変更して、これらの脆弱性を解決します。この脆弱性に関する詳細情報は、次の「脆弱性の情報」のセクションの下の特定の脆弱性のエントリに関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。

この累積的なセキュリティ更新プログラムは、最初に[マイクロソフト セキュリティ アドバイザリ 2488013](https://technet.microsoft.com/security/advisory/2488013) で説明した脆弱性についても解決します。
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS11-003.mspx](https://technet.microsoft.com/security/bulletin/ms11-003)
...
![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ae343de6-ec61-4891-b136-cfc4234d97d9&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=d431100d-a627-4ea0-b75b-2d4157e38df2&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5e0f4bf2-f727-483a-af3a-9a2abf0c36bb&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=0592b520-88d1-45bc-8b15-d3f0c8fa2181&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b2298b32-238a-4970-bc1f-2ede51a6c361&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=85bf88b7-2dd9-4204-8492-b2c1d8d2264e&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=a795de21-13f4-4035-a4d5-4257ddc92fe7&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=45e504d4-c17d-4b73-b08e-d9c0cb3f4918&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=29adcfb5-540f-4980-b2ca-9a22aa7bba13&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c41a0094-204b-4d05-ab39-a32915201af1&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b176777e-4897-4cf1-9fc0-dd608930bb4c&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=20ad0136-c6df-4c7b-811f-d6b3dd9e2c56&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ee61f0dd-9797-4e11-8281-a05b201d0c0b&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=558bc86a-a49d-4d6c-b5e4-f12956f6b61b&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8c2abba5-0597-4565-9b87-a37e574690e0&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c72fbb97-2313-45f6-842d-99db373822dd&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=69dfa24b-7c56-4521-850c-1485b062154a&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=74238e08-fae2-4f17-ac72-681226a53a40&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ebef4869-9812-46ce-9c01-2fb8c866ec90&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=77971c3c-55ec-4a9c-bcb8-8fb8c61431e3&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=d3580784-aada-4118-b7f2-3a23aec2ed04&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ef1ae382-8835-4f60-83bd-e84a3400d55c&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5607df02-93fa-45fe-a928-e5f6329851f3&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=07aa7ffc-47c7-4611-b32c-ecb3fbcad32f&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=2b8ffafe-78bb-4fa7-aea2-01208b6a3dfe&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=38b67efb-dd4b-4e8c-8460-0f40f0367441&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636493.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=0e41cbe5-5e5e-4ece-a71a-71f4b6319f0d&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
Internet Explorer 9 のベータ版は、このセキュリティ情報で説明している脆弱性の影響を受けます。このベータ リリースを実行しているお客様は、この更新プログラムをダウンロードし、ご使用のシステムに適用することを推奨します。セキュリティ更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) および [Windows Update](https://update.microsoft.com/microsoftupdate/v6/default.aspx&ln=ja) から利用可能です。このセキュリティ更新プログラムは [マイクロソフト ダウンロード センター](https://www.microsoft.com/downloads/ja-jp/results.aspx&displaylang=en&freetext=security%20update)からもダウンロード可能です。

**なぜこの更新プログラムはいくつかの報告されたセキュリティ上の脆弱性を解決するのですか?**  
これらの問題を解決するために必要な変更が関連するファイルに存在するため、この更新プログラムはいくつかの脆弱性を解決します。ユーザーは、ほぼ同一のファイルを含むいくつもの更新プログラムをインストールする代わりに、この更新プログラムのみをインストールすることができます。

**マイクロソフト セキュリティ アドバイザリ 2488013 で提供された回避策を適用済みの場合、この更新プログラムを適用前に元に戻す必要がありますか?**  
マイクロソフトは、このセキュリティ更新プログラムをインストールする前に、「Internet Explorer のカスケード スタイル シート (CSS) の再帰的なロードを防ぐ」の回避策を、適用済みのシステムから元に戻すことを推奨します。自動化された “Microsoft Fix it” ソリューションを使用して、この回避策を無効にするには、サポート技術情報 [2482017](https://support.microsoft.com/kb/2482017) をご覧ください。

**この更新プログラムは、マイクロソフト セキュリティ アドバイザリ 2269637 と関連していますか?**  
はい。この更新プログラムにより解決される脆弱性 [CVE-2011-0038](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038) は、マイクロソフト セキュリティ アドバイザリ [2269637](https://technet.microsoft.com/security/advisory/2269637) で説明している、アプリケーションが外部ライブラリをロードする方法に影響する脆弱性に関連するものです。このセキュリティ更新プログラムはこの種の脆弱性の特定の問題を解決します。
...
<span></span>
次の深刻度の評価は脆弱性による影響が最大であった場合を前提としています。このセキュリティ情報のリリース後 30 日以内に、深刻度の評価およびセキュリティ上の影響に関連する脆弱性が悪用される可能性に関する情報は、[2 月のセキュリティ情報](https://technet.microsoft.com/security/bulletin/ms11-feb)の「Exploitability Index (悪用可能性指標)」のセクションをご覧ください。詳細については、[Microsoft Exploitability Index (悪用可能性指標)](https://technet.microsoft.com/security/cc998259.aspx)をご覧ください。
...
<th style="border:1px solid black;" >
CSS メモリ破損の脆弱性 - [CVE-2010-3971](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971)
</th>
<th style="border:1px solid black;" >
初期化されていないメモリ破損の脆弱性 - [CVE-2011-0035](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0035)
</th>
<th style="border:1px solid black;" >
初期化されていないメモリ破損の脆弱性 - [CVE-2011-0036](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0036)
</th>
<th style="border:1px solid black;" >
Internet Explorer の安全でないライブラリのロードの脆弱性 - [CVE-2011-0038](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038)
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
#### 「CSS メモリ破損の脆弱性」の回避策 - CVE-2010-3971:
...
-   **Internet Explorer のカスケード スタイル シート (CSS) の再帰的なロードを防ぐ**

    この回避策は、Internet Explorer におけるカスケード スタイル シート (CSS) の攻撃の経路をブロックすることで、この脆弱性の悪用防止に役立てます。

    この回避策は、“Microsoft Fix it” ソリューションのみで利用可能です。自動化された “Microsoft Fix it” ソリューションを使用してこの回避策を有効または無効にするには、サポート技術情報 [2482017](https://support.microsoft.com/kb/2482017) をご覧ください。

    **注:** Internet Explorer をご使用のお客様で [MS10-090](https://technet.microsoft.com/security/bulletin/ms10-090) の更新プログラムをまだ適用していない場合は、この回避策を有効にする前に MS10-090 の更新プログラムも適用する必要があります。

    **回避策の影響** **:** カスケード スタイル シート (CSS) の再帰的なロードを防ぐことで、副次的な影響があります。ユーザーには、CSS ファイルのロードを防ぐために必要な確認が増加するため、わずかな動作問題が起きる可能性があります。

    **注:** この回避策が有効にされているシステムでは、マイクロソフトはセキュリティ更新プログラムを適用する前に、この回避策を無効にすることを推奨します。

#### 「CSS メモリ破損の脆弱性」のよく寄せられる質問 - CVE-2010-3971:
...
**何が原因で起こりますか?**  
Internet Explorer が特別に細工された、それ自身を再帰的に呼び出すカスケード スタイル シートを解析する際に、メモリを正しく処理しないことが原因で起こります。
...
この更新プログラムは、Intenet Explorer がカスケード スタイル シートを処理する方法を変更することにより、この脆弱性を解決します。

**このセキュリティ情報のリリース時に、この脆弱性は一般に公開されていましたか?**  
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2010-3971](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971) にアサインされています。この脆弱性は、マイクロソフト セキュリティ アドバイザリ [2488013](https://technet.microsoft.com/security/advisory/2488013) で説明しました。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0035](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0035) をご覧ください。

#### 「初期化されていないメモリ破損の脆弱性」の問題を緩和する要素 - CVE-2011-0035:
...
#### 「初期化されていないメモリ破損の脆弱性」の回避策 - CVE-2011-0035:
...
#### 「初期化されていないメモリ破損の脆弱性」のよく寄せられる質問 - CVE-2011-0035:

**どのようなことが起こる可能性がありますか?**  
これはリモートでコードが実行される脆弱性です。攻撃者がこの脆弱性を悪用した場合、ログオンしたユーザーと同じユーザー権限を取得する可能性があります。システムで、アカウントのユーザー権限を低く設定している場合、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性の影響が少なくなると考えられます。

**何が原因で起こりますか?**  
Internet Explorer が、特別に細工した Web コンテンツを解析する際に、メモリのオブジェクトを正しく処理しないことが原因で起こります。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0036](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0036) をご覧ください。

#### 「初期化されていないメモリ破損の脆弱性」の問題を緩和する要素 - CVE-2011-0036:
...
#### 「初期化されていないメモリ破損の脆弱性」の回避策 - CVE-2011-0036:
...
#### 「初期化されていないメモリ破損の脆弱性」のよく寄せられる質問 - CVE-2011-0036:
...
<span></span>
Internet Explorer が DLL ファイルの読み込みを処理する方法に、リモートでコードが実行される脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、ログオンしたユーザーと同じユーザー権限を取得する可能性があります。ユーザーが管理者ユーザー権限でログオンしている場合、攻撃者はこの脆弱性を悪用して、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。

Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0038](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038) をご覧ください。

#### 「Internet Explorer の安全でないライブラリのロードの脆弱性」の問題を緩和する要素 - CVE-2011-0038:

「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。

-   このファイル共有のプロトコルであるサーバー メッセージ ブロック (SMB) は、多くの場合境界ファイアウォールで無効にされます。これにより、この脆弱性に対する潜在的な攻撃経路を制限します。
-   攻撃者がこの脆弱性を悪用した場合、ローカルのユーザーと同じユーザー権限を取得する可能性があります。システムで、アカウントのユーザー権限を低く設定している場合、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性の影響が少なくなると考えられます。

#### 「Internet Explorer の安全でないライブラリのロードの脆弱性」の回避策 - CVE-2011-0038:
...
-   **WebClient サービスを無効にする**
    ...
    **回避策の解除方法** **:** Web Client サービスを再度有効にするためには、次のステップを実行してください。
...
#### 「Internet Explorer の安全でないライブラリのロードの脆弱性」のよく寄せられる質問 - CVE-2011-0038:
...
**攻撃者はこの脆弱性をどのように悪用する可能性がありますか?**  
攻撃者は、特別に細工されたダイナミック リンク ライブラリ (DLL) ファイルと同じディレクトリにある正当な Hypertext Markup Language (HTML) ファイルをユーザーに開かせることにより、この脆弱性を悪用する可能性があります。次に、HTML ファイルを開いている間に Internet Explorer が DLL ファイルをロードし、それに含まれている任意のコードを実行しようとする可能性があります。既定で、Internet Explorer はデスクトップのみが現在のディレクトリであると見なします。この攻撃が実行される場合、ユーザーが HTML ファイルおよび特別に細工した DLL をユーザーのデスクトップに置くことが、攻撃者にとっての必要条件になります。攻撃者は、UNC または WebDAV の場所を介してこの問題を悪用するために、ユーザーを誘導して環境変数 PATH を変更させます。
...
Web ベースの攻撃シナリオでは、攻撃者はユーザーを誘導して正当な HTML ファイルおよび特別に細工した DLL をダウンロードおよびデスクトップに保存させ、正当な HTML ファイルを開かせようとする可能性があります。その後、HTML ファイルを開いている間に Internet Explorer が DLL ファイルをロードし、それに含まれている任意のコードを実行する可能性があります。この脆弱性は、Web ページを閲覧するだけでは悪用されることはなく、ユーザー対話が必要になります。
ネットワークの攻撃シナリオでは、攻撃者は正当な HTML ファイルおよび特別に細工した DLL を、UNC または WebDAV の場所のようなネットワーク共有に置く可能性があります。その後、攻撃者はユーザーを誘導し、UNC または WebDAV の場所などのネットワーク共有を含むよう環境変数 PATH を変更させ、ユーザーに HTML ファイルを開かせようとします。その後、HTML ファイルを開いている間に Internet Explorer が 検索パスで確認した DLL ファイルをロードし、それに含まれている任意のコードを実行しようとする可能性があります。
...
**この更新プログラムはどのように問題を修正しますか?**  
この更新プログラムは、Internet Explorer が外部のライブラリをロードする方法を修正して、この脆弱性を解決します。

**この脆弱性は、マイクロソフト セキュリティ アドバイザリ 2269637 と関連していますか?**  
はい。この脆弱性はマイクロソフト セキュリティ アドバイザリ [2269637](https://technet.microsoft.com/security/advisory/2269637) で説明されているアプリケーションが外部ライブラリをロードする方法に影響する脆弱性の種類に関連します。このセキュリティ更新プログラムはこの種の脆弱性の特定の問題を解決します。

**このセキュリティ情報のリリース時に、この脆弱性は一般に公開されていましたか?**  
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2011-0038](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038) にアサインされています。
...
Windowsxp-KB2482017-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2482017-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
IE7-WindowsXP-KB2482017-x86-jpn /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
IE7-WindowsServer2003.WindowsXP-KB2482017-x64-jpn /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
IE8-WindowsXP-KB2482017-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
IE8-WindowsServer2003.WindowsXP-KB2482017-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows XP Service Pack 2 および Windows XP Service Pack 3 用の Internet Explorer 6:  
Windowsxp-KB2482017-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP 用の Internet Explorer 6:  
WindowsServer2003.WindowsXP-KB2482017-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows XP Service Pack 2 および Windows XP Service Pack 3 用の Internet Explorer 7:  
IE7-WindowsXP-KB2482017-x86- JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP 用の Internet Explorer 7:  
IE7-WindowsServer2003.WindowsXP-KB2482017-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows XP Service Pack 2 および Windows XP Service Pack 3 用の Internet Explorer 8:  
IE8-WindowsXP-KB2482017-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP 用の Internet Explorer 8:  
IE8-WindowsServer2003.WindowsXP-KB2482017-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
すべてのサポートされているエディションの Windows XP 用の Internet Explorer 6:  
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB2482017$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
すべてのサポートされているエディションの Windows XP 用の Internet Explorer 7:  
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは%Windir%\\ie7updates\\KB2482017-IE7\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
すべてのサポートされているエディションの Windows XP 用の Internet Explorer 8:  
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは%Windir%\\ie8updates\\KB2482017-IE8\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポート技術情報 [2482017](https://support.microsoft.com/kb/2482017) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB2482017\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB2482017\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP0\\KB2482017-IE7\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP0\\KB2482017-IE7\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP0\\KB2482017-IE8\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP0\\KB2482017-IE8\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
WindowsServer2003-KB2482017-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2482017-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
IE7-WindowsServer2003-KB2482017-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
IE7-WindowsServer2003-KB2482017-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
IE8-WindowsServer2003-KB2482017-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
IE8-WindowsServer2003-KB2482017-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Server 2003 の 32-bit エディション用の Internet Explorer 6:  
WindowsServer2003-KB2482017-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Server 2003 の Itanium-based エディション用の Internet Explorer 6:  
WindowsServer2003-KB2482017-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Server 2003 の 32-bit エディション用の Internet Explorer 7:  
IE7-WindowsServer2003-KB2482017-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Server 2003 の Itanium-based エディション用の Internet Explorer 7:  
IE7-WindowsServer2003-KB2482017-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Server 2003 の 32-bit エディション用の Internet Explorer 8:  
IE8-WindowsServer2003-KB2482017-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Server 2003 の Itanium-based エディション用の Internet Explorer 8:  
IE8-WindowsServer2003-KB2482017-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Server 2003 の 32-bit エディション、x64-based エディションおよび Itanium-based エディション用の Internet Explorer 6:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2482017\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Server 2003 の 32-bit エディション、x64-based エディションおよび Itanium-based エディション用の Internet Explorer 7:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP0\\KB2482017-IE7\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Server 2003 の 32-bit エディション、x64-based エディションおよび Itanium-based エディション用の Internet Explorer 8:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP0\\KB2482017-IE8\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
Windows6.0-KB2482017-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2482017-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
IE8-Windows6.0-KB2482017-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
IE8-Windows6.0-KB2482017-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Vista 32-bit エディション用の Internet Explorer 7:  
Windows6.0-KB2482017-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Vista x64 エディション用の Internet Explorer 7:  
Windows6.0-KB2482017-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Vista 32-bit エディション用の Internet Explorer 8:  
IE8-Windows6.0-KB2482017-x86. /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Vista x64 エディション用の Internet Explorer 8:  
IE8-Windows6.0-KB2482017-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2482017-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべてのWindows Server 2008 Itanium-based エディション用の Internet Explorer 7:  
Windows6.0-KB2482017-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2482017-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2482017-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows 7 32-bit エディション用の Internet Explorer 8:  
Windows6.1-KB2482017-x86. /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows 7 x64 エディション用の Internet Explorer 8:  
Windows6.1-KB2482017-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2482017-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Windows Server 2008 R2 Itanium-based エディション用の Internet Explorer 8:  
Windows6.1-KB2482017-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   「初期化されていないメモリ破損の脆弱性」 - [CVE-2011-0035](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0035) を報告してくださった [Trend Micro](https://www.trendmicro.com/) の Yuki Chen 氏
-   「初期化されていないメモリ破損の脆弱性」 - [CVE-2011-0036](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0036) を報告してくださった [Google Inc.](https://www.google.com/) の Skylined 氏
-   「Internet Explorer の安全でないライブラリのロードの脆弱性」 - [CVE-2011-0038](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2011-0038) を報告してくださった [Fortinet の FortiGuard Labs](https://www.fortiguard.com/) の Haifei Li 氏
