...
管理者およびエンタープライズのインストール、またはこのセキュリティ更新プログラムを手動でインストールしたいエンドユーザーは、更新プログラムの管理ソフトウェアまたは [Microsoft Update サービス](https://update.microsoft.com/microsoftupdate) で更新プログラムを確認して、この更新プログラムをできる限り早期に適用することを推奨します。サポート技術情報[2489279](https://support.microsoft.com/kb/2489279) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。なお、既知の問題および推奨される解決策がソフトウェアの特定のリリースにのみ該当する場合は、サポート技術情報に関連のリンクを掲載します。

既知の問題: マイクロソフト サポート技術情報 [2489279](https://support.microsoft.com/kb/2489279) には、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明されています。
...
<td style="border:1px solid black;">
[![](../../images/Dn636511.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=db2c5cfe-588c-4646-b86a-3fb8248f7af4&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636511.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=916a076d-d754-4092-b23d-c8826db7e397&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636511.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5ae34fe0-03bd-48a9-a7ac-de8f7b1aff90&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636511.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=a427f0e2-b74d-4ef3-bec4-0a101d09bfa3&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636511.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=13dca35d-2209-4c5c-9150-d6db2bb3b496&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636511.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f756d836-6ab2-4adb-9dee-6cb523d7c1f5&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636511.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=84dfe3f4-a2a1-47b9-8da1-29ae67230918&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636511.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ef1e612f-d8e3-4628-9fe4-ad136f0debd3&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636511.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=0c323a12-6385-4666-ad39-a9516a8eda14&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636511.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=2d75786a-2368-4ef2-970b-fa2e57d63ca9&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636511.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=946cc611-4d75-4728-b9d3-1c8b557b02c2&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
はい。Microsoft Excel 2003 Service Pack 3 (KB2502786) および Microsoft Excel 2007 Service Pack 2 (KB2464583) 用のこの更新プログラムは、セキュリティ情報 [MS11-023](https://technet.microsoft.com/security/bulletin/ms11-023) で提供されている更新プログラムと共に、Office ファイル検証機能のサポートを提供します。Office ファイル検証機能に関する詳細情報は、[マイクロソフト セキュリティ アドバイザリ 2501584](https://technet.microsoft.com/security/advisory/2501584) をご覧ください。

このセキュリティ更新プログラムは、MS10-087 および MS10-088 と、どのような関連がありますか?       
このセキュリティ情報で提供している Microsoft Office 2004 for Mac (KB2505924) の更新プログラムは、[MS10-087](https://technet.microsoft.com/security/bulletin/ms10-087) および [MS10-088](https://technet.microsoft.com/security/bulletin/ms10-088) で説明している脆弱性も解決します。
...
このセキュリティ情報で提供している Microsoft Office 2004 for Mac (KB2505924)、Microsoft Office 2008 for Mac (KB2505927) および Open XML File Format Converter for Mac (KB2505935) 用のこのセキュリティ更新プログラム パッケージは、[MS11-022](https://technet.microsoft.com/security/bulletin/ms11-022) および [MS11-023](https://technet.microsoft.com/security/bulletin/ms11-023) のセキュリティ情報で説明している脆弱性も解決します。このセキュリティ情報で提供している Microsoft Office for Mac 2011 (KB2525412) のセキュリティ更新プログラム パッケージは、[MS11-022](https://technet.microsoft.com/security/bulletin/ms11-022) で説明している脆弱性も解決します。 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac、Open XML File Format Converter for Mac または Microsoft Office for Mac 2011 をご利用のユーザーの場合、これらのセキュリティ更新プログラム パッケージのインストールが必要なのは 1 回だけです。
...
<th style="border:1px solid black;" >
Excel の整数オーバーランの脆弱性 - [CVE-2011-0097](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0097)
</th>
<th style="border:1px solid black;" >
Excel のヒープ オーバーフローの脆弱性 - [CVE-2011-0098](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0098)
</th>
<th style="border:1px solid black;" >
Excel のレコード解析の WriteAV の脆弱性 - [CVE-2011-0101](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0101%20)
</th>
<th style="border:1px solid black;" >
Excel のメモリ破損の脆弱性 - [CVE-2011-0103](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0103)
</th>
<th style="border:1px solid black;" >
Excel のバッファー上書きの脆弱性- [CVE-2011-0104](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2011-0104)
</th>
</tr>
<tr>
<th colspan="6">
...
<th style="border:1px solid black;" >
Excel のデータ初期化の脆弱性- [CVE-2011-0105](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2011-0105)
</th>
<th style="border:1px solid black;" >
Excel の配列インデックスの脆弱性- [CVE-2011-0978](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2011-0978)
</th>
<th style="border:1px solid black;" >
Excel の連結リスト破損の脆弱性- [CVE-2011-0979](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2011-0979)
</th>
<th style="border:1px solid black;" >
Excel のダングリング ポインターの脆弱性- [CVE-2011-0980](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2011-0980)
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0097](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0097) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0098](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0098) をご覧ください。
...
-   Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から Microsoft Excel の Office 2003 以前のドキュメントを開くことをブロックする
    ...
    回避策の影響:Microsoft Office 2003 および Microsoft Office 2007 について、ファイル ブロックのポリシーを構成しており、サポート技術情報 [922848](https://support.microsoft.com/kb/922848) で説明しているように、ファイル ブロックのポリシーを構成している、および特別な「除外されるディレクトリ」を構成していない、またはファイルを信頼できる場所へ移動させていないユーザーは、Office 2003 ファイルまたはそれ以前のバージョンを開けなくなります。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0101](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0101) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0103](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0103) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0104](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0104) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0105](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0105) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0978](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0978) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0979](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0979) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0980](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0980) をご覧ください。
...
<td style="border:1px solid black;">
サポート技術情報 [2466169](https://support.microsoft.com/kb/2466169) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
<td style="border:1px solid black;">
サポート技術情報 [2502786](https://support.microsoft.com/kb/2502786) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
<td style="border:1px solid black;">
Excel 2007:  
サポート技術情報 [2464583](https://support.microsoft.com/kb/2464583) をご覧ください。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Microsoft Excel Viewer:  
サポート技術情報 [2466158](https://support.microsoft.com/kb/2466158) をご覧ください。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Word/Excel/PowerPoint 2007 ファイル形式用 Microsoft Office 互換機能パック  
サポート技術情報 [2466156](https://support.microsoft.com/kb/2466156) をご覧ください。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポート技術情報 [2466146](https://support.microsoft.com/kb/2466146) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
[Microsoft ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=f756d836-6ab2-4adb-9dee-6cb523d7c1f5&displaylang=ja)から Microsoft Office 2004 for Mac 11.6.3 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[Microsoft ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=ad1b1984-b2b2-49b3-a1dd-385b77d9248a&displaylang=ja)から Microsoft Office 2008 for Mac 12.2.9 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[Microsoft ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=8bd6ca3b-8004-4e8d-a09d-220dcbbce799&displaylang=ja) から Microsoft Office 2011 14.1 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[Microsoft ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=b846d255-a7d4-4a2c-a084-d434c29fe676&displaylang=ja)から Mac 1.1.9 用の Open XML File Format Converter の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
-   Excel の整数オーバーランの脆弱性 - [CVE-2011-0097](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2011-0097) を報告してくださった [Secunia Research](https://secunia.com/) の Alin Rad Pop 氏
-   Excel のヒープ オーバーフローの脆弱性 - [CVE-2011-0098](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2011-0098) を報告してくださった [Secunia Research](https://secunia.com/) の Alin Rad Pop 氏
-   Excel のレコード解析の WriteAV の脆弱性 - [CVE-2011-0101](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2011-0101) を報告してくださった [Telus Security Labs](https://www.telussecuritylabs.com/) の Muhammad Junaid Bohio 氏
-   Excel のレコード解析の WriteAV の脆弱性 - [CVE-2011-0101](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0101) を報告してくださった [TippingPoint の Zero Day Initiative](https://www.zerodayinitiative.com/) に協力している Aniway 氏
-   Excel のメモリ破損の脆弱性 [CVE-2011-0103](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0103) を報告してくださった匿名のリサーチャー
-   Excel のバッファー上書きの脆弱性 [CVE-2011-0104](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0104) を報告してくださった [Check Point Vulnerability Discovery Team](https://www.checkpoint.com/)(VDT) の Rodrigo Rubira Branco 氏
-   Excel のデータ初期化の脆弱性 - [CVE-2011-0105](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0105) を報告してくださった [TippingPoint の Zero Day Initiative](https://www.zerodayinitiative.com/) に協力している Aniway 氏
-   Excel の配列インデックスの脆弱性 - [CVE-2011-0978](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0978) を報告してくださった [TippingPoint の Zero Day Initiative](https://www.zerodayinitiative.com/) に協力している Aniway 氏
-   Excel の連結リスト破損の脆弱性 - [CVE-2011-0979](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0979) を報告してくださった [TippingPoint の Zero Day Initiative](https://www.zerodayinitiative.com/) に協力している匿名のリサーチャー
-   Excel のダングリング ポインターの脆弱性 - [CVE-2011-0980](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0980) を報告してくださった [TippingPoint の Zero Day Initiative](https://www.zerodayinitiative.com/) に協力している匿名のリサーチャー
