...
[](https://www.microsoft.com/japan/security/bulletins/ms11-036e.mspx)[![](../../images/Dn636526.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
既知の問題: マイクロソフト サポート技術情報 [2545814](https://support.microsoft.com/kb/2545814) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。なお、既知の問題および推奨される解決策がソフトウェアの特定のリリースにのみ該当する場合は、サポート技術情報に関連のリンクを掲載します。

US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS11-036.mspx](https://technet.microsoft.com/security/bulletin/ms11-036)
...
<td style="border:1px solid black;">
[![](../../images/Dn636526.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=2e8a30ac-bcfe-4535-8ceb-723c25b43d5f&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636526.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=fc1cfcac-64cc-484a-97f2-3dcfe84cfdcd&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636526.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=9a181739-709a-4c0d-a97f-f9891c45c04c&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636526.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5be09069-1cac-4b1e-ac94-4fb7024fb4ac&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
マイクロソフトはこのセキュリティ情報を更新し、このセキュリティ情報が最初に公開された際に提供されていなかった Microsoft Office for Mac 用セキュリティ更新プログラムが、セキュリティ情報 [MS11-045](https://technet.microsoft.com/security/bulletin/ms11-045) で利用可能となったことをお知らせしました。
...
次の深刻度の評価は脆弱性による影響が最大であった場合を前提としています。このセキュリティ情報のリリース後 30 日以内に、深刻度の評価およびセキュリティ上の影響に関連する脆弱性が悪用される可能性に関する情報は、[5 月のセキュリティ情報](https://technet.microsoft.com/security/bulletin/ms11-may)の「Exploitability Index (悪用可能性指標)」のセクションをご覧ください。詳細については、[Microsoft Exploitability Index (悪用可能性指標)](https://technet.microsoft.com/security/cc998259.aspx)をご覧ください。
...
<th style="border:1px solid black;" >
プレゼンテーションのメモリ破損の RCE の脆弱性 - [CVE-2011-1269](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1269)
</th>
<th style="border:1px solid black;" >
プレゼンテーションのバッファー オーバーランの RCE の脆弱性 - [CVE-2011-1270](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1270)
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-1269](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1269) をご覧ください。
...
-   Office ファイル検証機能を設定して、PowerPoint 2003 および PowerPoint 2007 でファイル検証に失敗したファイルが開かれるのを無効にする
    ...
    次のレジストリ スクリプトは、レジストリ エントリ (.reg) ファイルに保存し、ファイル検証に失敗したファイルの編集を無効にするために使用できます。レジストリ スクリプトの使用方法に関する詳細は、サポート技術情報[310516](https://support.microsoft.com/kb/310516) をご覧ください。
...
-   Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から Office 2003 以前のドキュメントが開かれるのをブロックする
    ...
    次のレジストリ スクリプトは、レジストリ エントリ (.reg) ファイルに保存し、ファイル ブロックのポリシーを設定するために使用できます。レジストリ スクリプトの使用方法に関する詳細は、サポート技術情報[310516](https://support.microsoft.com/kb/310516) をご覧ください。各自の Office ソフトウェアに適切なレジトリ スクリプトを使用する。
    ...
    または、Microsoft Office 2007 では、グループ ポリシーを使用してファイル制限機能を適用できます。詳細情報は、TechNet の記事 [2007 Office system でファイル形式のブロック設定を構成する](https://technet.microsoft.com/ja-jp/library/cc179186(office.12).aspx)をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-1270](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1270) をご覧ください。
...
-   Office のファイル検証機能を設定して、PowerPoint 2003 で、ファイル検証に失敗したファイルが開かれるのを無効にする
    ...
    注: この回避策を適用する前に、各自の Microsoft Office のバージョン向けの Office ファイル検証機能を有効にする必要があります。Microsoft Office 2003 で Office ファイル検証機能を有効にする方法に関する情報は、TechNet の記事 [Office File Validation for Office 2003 and Office 2007](https://technet.microsoft.com/library/gg985445(en-us,office.12).aspx) (英語情報) をご覧ください。
...
-   Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から Office 2003 以前のドキュメントを開くことをブロックする
    ...
    レジストリ スクリプトの使用方法に関する詳細は、サポート技術情報[310516](https://support.microsoft.com/kb/310516) をご覧ください。
    ...
    回避策の影響: Microsoft Office 2003 について、ファイル ブロックのポリシーを構成している、および特別な「除外されるディレクトリ」を構成していない、またはファイルを信頼できる場所へ移していないユーザーは、Office 2003 ファイルまたはそれ以前のバージョンを開くことができなくなります。Microsoft Office ソフトウェアのファイル ブロックの設定の影響に関する詳細情報は、サポート技術情報[922850](https://support.microsoft.com/kb/922850)をご覧ください。
...
注: マイクロソフトは 2011 年 4 月 12 日付で SMS 2.0 のサポートを終了しました。また SMS 2003 についても、マイクロソフトは 2011 年 4 月 12 日付で Security Update Inventory Tool (SUIT) のサポートを終了しました。マイクロソフトはお客様に [System Center Configuration Manager 2007](https://technet.microsoft.com/ja-jp/library/bb735860.aspx) にアップグレードすることを推奨します。
...
<td style="border:1px solid black;">
サポート技術情報 [2535802](https://support.microsoft.com/kb/2535802) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
<td style="border:1px solid black;">
サポート技術情報 [2535812](https://support.microsoft.com/kb/2535812) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
<td style="border:1px solid black;">
PowerPoint 2007 については、サポート技術情報 [2535818](https://support.microsoft.com/kb/2535818) をご覧ください。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Word/Excel/PowerPoint 2007 ファイル形式用 Microsoft Office 互換機能パック Service Pack については、サポート技術情報 [2540162](https://support.microsoft.com/kb/2540162) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
-   プレゼンテーションのメモリ破損の RCE の脆弱性 [CVE-2011-1269](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1269) についてマイクロソフトと協力してくださった [CERT/CC](https://www.cert.org/) の Will Dormann 氏
-   プレゼンテーションのバッファー オーバーランの RCE の脆弱性 - [CVE-2011-1270](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1270) についてマイクロソフトと協力してくださった [CERT/CC](https://www.cert.org/) の Will Dormann 氏
