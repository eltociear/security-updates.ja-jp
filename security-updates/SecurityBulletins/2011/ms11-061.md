...
**既知の問題:** [サポート技術情報 2546250](https://support.microsoft.com/kb/2546250) で、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明しています。 また、これらの問題に対する推奨される解決策についても説明しています。

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS11-061.mspx](https://technet.microsoft.com/security/bulletin/ms11-061)
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|--------------------------------------------------------|
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=777f3bbe-094c-411d-879d-34a5a20ae7f3&displaylang=ja)\*\* | 特権の昇格             | 重要           | なし                                                   |
...
はい。マイクロソフトは、Web 登録 ASP ページを編集したお客様が[マイクロソフト サポート技術情報 2546250](https://support.microsoft.com/kb/2546250) を確認して、システムに適用される可能性がある既知の問題についての重要な情報に目を通すことを推奨します。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1263](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1263) を参照してください。
...
リモート デスクトップ Web アクセス (RD Web アクセス) はリモート デスクトップ サービスの役割における役割サービスであり、ユーザーが Web ブラウザーを使用して、RemoteApp プログラム、仮想デスクトップ、セッションベースのデスクトップを使用できるようになります。 また、RD Web アクセスによって、ユーザーは適切なアクセス権があるサーバーまたはクライアント コンピューターのリモート デスクトップに Web ブラウザーから接続できます。 詳細については、TechNet の記事「[Remote Desktop Web Access](https://technet.microsoft.com/ja-jp/library/ff608245(ws.10).aspx)」(英語情報)) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2546250">マイクロソフト サポート技術情報 2546250</a> を参照してください。</td>
</tr>
<tr class="odd">
