---
TOCTitle: 'MS11-006'
Title: 'マイクロソフト セキュリティ情報 MS11-006 - 緊急'
ms:assetid: 'ms11-006'
ms:contentKeyID: 61229283
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-006(v=Security.10)'
---
...
公開日: 2011年2月9日 | 最終更新日: 2011年2月15日

**バージョン:** 1.0

[](https://www.microsoft.com/japan/security/bulletins/ms11-006e.mspx)[![](../../images/Dn636496.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
このセキュリティ更新プログラムの深刻度は、すべてのサポートされているエディションの Windows XP、Windows Server 2003、Windows Vista および Windows Server 2008 について「緊急」と評価しました。サポートされているエディションの Windows 7 および Windows Server 2008 R2 はこの脆弱性の影響を受けません。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

このセキュリティ更新プログラムは、Windows シェルのグラフィック プロセッサーがサムネイル画像を解析する方法を修正することにより、この脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。

このセキュリティ更新プログラムは、最初に [マイクロソフト セキュリティ アドバイザリ 2490606](https://technet.microsoft.com/security/advisory/2490606) で説明した脆弱性についても解決します。
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS11-006.mspx](https://technet.microsoft.com/security/bulletin/ms11-006)
...
![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx) および [更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム                                                                                         | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響       | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報            |
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|---------------------------------------------------------------------|
| Windows XP Service Pack 3                                                                                         | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=bbea7ead-6c5c-4da8-aa03-a40325fd2de3&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows XP Professional x64 Edition Service Pack 2                                                                | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=bcb7217e-624a-4d61-86a1-f2440a1afd57&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Server 2003 Service Pack 2                                                                                | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=2aa94528-5063-427b-97f7-2a0a55cbb6bf&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Server 2003 x64 Edition Service Pack 2                                                                    | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6e740922-6ce4-46ec-a35e-e94201a9e398&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Server 2003 with SP2 for Itanium-based Systems                                                            | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=a4f9ec46-35b2-44c9-abf6-647f7a474b99&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Vista Service Pack 1 および Windows Vista Service Pack 2                                                  | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=0c18ecca-afb9-4738-bc7b-76a0e815dfb8&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2                          | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=62dc454f-4b1e-4ac0-8ffe-6c73112f8d4d&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2\*\*           | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=253c47a0-69ac-437a-ad3e-778c37fa37cb&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2\*\*     | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ec7101aa-96c2-4931-a3e4-0c55cbc74d9c&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Server 2008 for Itanium-based Systems および Windows Server 2008 for Itanium-based Systems Service Pack 2 | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e62493cb-8d25-4975-bbe6-a368e039872b&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
...
はい。このセキュリティ更新プログラムをインストールする前に、「Windows XP および Windows Server 2003 システム上の shimgvw.dll のアクセス制御リスト (ACL) を変更する」の回避策を、以前に適用したシステムから元に戻す必要があります。自動化された “Microsoft Fix it” ソリューションを使用して、この回避策を無効にするには、サポート技術情報 [2483185](https://support.microsoft.com/kb/2483185) をご覧ください。
...
<th style="border:1px solid black;" >Windows シェルのグラフィック処理のオーバーランの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970">CVE-2010-3970</a></th>
...
Windows シェルのグラフィック処理のオーバーランの脆弱性 - CVE-2010-3970  
----------------------------------------------------------------------
  
<span></span>
Windows シェルのグラフィック プロセッサーが特別な細工がされたサムネイル画像を処理する方法にリモートでコードが実行される脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、ログオン ユーザーのセキュリティ コンテキストで任意のコードが実行される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。システムで、アカウントのユーザー権限を低く設定している場合、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性の影響が少なくなると考えられます。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3970](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970) をご覧ください。
  
#### 「Windows シェルのグラフィック処理のオーバーランの脆弱性」の問題を緩和する要素 - CVE-2010-3970:
...
#### 「Windows シェルのグラフィック処理のオーバーランの脆弱性」の回避策 - CVE-2010-3970:
  
回避策は、設定または構成の変更を示しており、基本的な脆弱性を正すものではありませんが、更新プログラムを適用する前に既知の攻撃方法を阻止するのに役立ちます。マイクロソフトは、以下の回避策を検証し、この回避策が機能性を低下させるかどうかについて、説明の部分で述べています。
  
-   **Windows XP および Windows Server 2003 上の shimgvw.dll のアクセス制御リスト (ACL) を変更する**
  
    **注意:** 自動化された “Microsoft Fix it” ソリューションを使用してこの回避策を有効または無効にするには、サポート技術情報 [2483185](https://support.microsoft.com/kb/2483185) をご覧ください。
    ...
    **回避策の影響** **:** 通常 Windows シェルのグラフィック プロセッサーにより処理されるメディア ファイルが適切に表示されなくなります。MS11-006 のセキュリティ更新プログラムをインストールする前に、この回避策を、以前に適用したシステムから元に戻す必要があることに注意してください。
...
-   **Windows Vista および Windows Server 2008 システム上の Windows エクスプローラーで縮小版の表示を無効にする**
    ...
    3.  \[表示\] タブを選択し、\[常にアイコンを表示し、縮小版は表示しない\] のオプションが選択されていることを確認します。\[OK\] をクリックし、変更を保存します。  
    4.  Windows エクスプローラーのすべての開いているインスタンスを閉じて、この変更を有効にします。
  
    **回避策の影響** **:** Windows エクスプローラーがサムネイル画像を表示しなくなります。
  
    **回避策の解除方法:**
  
    Windows Vista および Windows Server 2008 の縮小版の表示を有効にするには、次のステップを行います。
  
    1.  \[コントロール パネル\] を開き、\[デスクトップのカスタマイズ\] を選択します。  
    2.  メニューから \[フォルダー オプション\] を選択します。  
    3.  \[表示\] タブを選択し、\[常にアイコンを表示し、縮小版は表示しない\] のオプションが選択されていないことを確認します。\[OK\] をクリックし、変更を保存します。  
    4.  Windows エクスプローラーのすべての開いているインスタンスを閉じて、この変更を有効にします。
  
#### 「Windows シェルのグラフィック処理のオーバーランの脆弱性」のよく寄せられる質問 - CVE-2010-3970:
...
**何が原因で起こりますか?**  
この脆弱性は、Windows シェルのグラフィック プロセッサーが特別な細工がされたサムネイル画像を不適切に解析した場合に発生し、これによりスタックのバッファー オーバーランが発生します。
...
この脆弱性が悪用されるには、ユーザーが特別な細工がされたサムネイル画像を表示することが攻撃者にとっての必要条件となります。  
ネットワークの攻撃のシナリオでは、攻撃者は特別な細工がされたサムネイル画像または特別な細工がされたサムネイル画像を含むファイルを、UNC や WebDAV などのネットワーク共有に置き、ユーザーに Windows エクスプローラーでその場所を参照させる可能性があります。ユーザーがその共有に移動する際に、影響を受けるコントロール パスが Windows シェルのグラフィック プロセッサーによりトリガーされます。次に、特別な細工がされたサムネイル画像によりこの脆弱性が悪用され、ログオン ユーザーのセキュリティ コンテキストでコードが実行される可能性があります。攻撃者は、ネットワーク共有、UNC、または WebDAV にユーザーを強制的に訪問させることはできないと考えられます。その代わり、通常、ユーザーに電子メール メッセージまたはインスタント メッセンジャーのメッセージ内のリンクをクリックさせ、その共有、UNC、または WebDAV の場所にユーザーを誘導することが攻撃者にとっての必要条件となります。
  
**Uniform Naming Convention (UNC) とは何ですか?**  
Uniform Naming Convention (UNC) は、ネットワーク上の共有名やファイルなどのリソースを特定するための方法です。一般的な UNC の名前は、\\\\server\\share\\subdirectory\\filename のように 2 つの \\ で始まり、サーバー名が続きます。
...
この更新プログラムは、Windows シェルのグラフィック プロセッサーがサムネイル画像を解析する方法を修正することにより、この脆弱性を解決します。
  
**このセキュリティ情報のリリース時に、この脆弱性は一般に公開されていましたか?**  
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2010-3970](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970) にアサインされています。この脆弱性は、マイクロソフト セキュリティ アドバイザリ [2490606](https://technet.microsoft.com/security/advisory/2490606) で説明しました。
  
**このセキュリティ情報の公開時に、マイクロソフトはこの脆弱性が悪用されたという報告を受けていましたか?**  
いいえ。マイクロソフトは、このセキュリティ情報が最初にリリースされた時に、公開された検証用コードの存在を確認していましたが、この脆弱性が悪用され、お客様が攻撃されたという直接の報告は受けていませんでした。
  
**このセキュリティ更新プログラムを適用すると、この脆弱性を悪用しようとする既に公開されている検証用コードからお客様を保護する手助けとなりますか?**  
はい。このセキュリティ更新プログラムは公開された検証用コードにより悪用される可能性のある脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2010-3970](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970) に割り当てられています。
...
Windowsxp-KB2483185-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2483185-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB2483185-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB2483185-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB2483185$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB2483185\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB2483185\\Filelist
</td>
</tr>
</table>
...
|-------------|---------------|------------|-------|-----------|------------|
| Shell32.dll | 6.0.2900.6072 | 2011/01/21 | 23:44 | 8,368,128 | SP3GDR     |
| Shimgvw.dll | 6.0.2900.6072 | 2011/01/21 | 23:44 | 436,736   | SP3GDR     |
| Shell32.dll | 6.0.2900.6072 | 2011/01/21 | 23:42 | 8,369,152 | SP3QFE     |
| Shimgvw.dll | 6.0.2900.6072 | 2011/01/21 | 23:42 | 437,248   | SP3QFE     |

サポートされているすべての x64 エディションの Windows XP:

| ファイル名   | バージョン    | 日付       | 時間  | サイズ     | CPU | フォルダー  |
|--------------|---------------|------------|-------|------------|-----|-------------|
| Shell32.dll  | 6.0.3790.4822 | 2011/01/22 | 03:43 | 10,416,128 | x64 | SP2GDR      |
| Shimgvw.dll  | 6.0.3790.4822 | 2011/01/22 | 03:43 | 631,808    | x64 | SP2GDR      |
| Wshell32.dll | 6.0.3790.4822 | 2011/01/22 | 03:43 | 8,267,776  | x86 | SP2GDR\\WOW |
| Wshimgvw.dll | 6.0.3790.4822 | 2011/01/22 | 03:43 | 486,400    | x86 | SP2GDR\\WOW |
| Shell32.dll  | 6.0.3790.4822 | 2011/01/22 | 03:41 | 10,416,640 | x64 | SP2QFE      |
| Shimgvw.dll  | 6.0.3790.4822 | 2011/01/22 | 03:41 | 631,808    | x64 | SP2QFE      |
| Wshell32.dll | 6.0.3790.4822 | 2011/01/22 | 03:41 | 8,268,288  | x86 | SP2QFE\\WOW |
| Wshimgvw.dll | 6.0.3790.4822 | 2011/01/22 | 03:41 | 486,400    | x86 | SP2QFE\\WOW |
...
WindowsServer2003-KB2483185-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2483185-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2483185-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB2483185-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2483185\\Filelist
</td>
</tr>
</table>
...
| ファイル名  | バージョン    | 日付       | 時間  | サイズ    | フォルダー |
|-------------|---------------|------------|-------|-----------|------------|
| Shell32.dll | 6.0.3790.4822 | 2011/01/22 | 07:00 | 8,267,776 | SP2GDR     |
| Shimgvw.dll | 6.0.3790.4822 | 2011/01/22 | 07:00 | 486,400   | SP2GDR     |
| Shell32.dll | 6.0.3790.4822 | 2011/01/22 | 07:01 | 8,268,288 | SP2QFE     |
| Shimgvw.dll | 6.0.3790.4822 | 2011/01/22 | 07:01 | 486,400   | SP2QFE     |

サポートされているすべての Itanium-based エディションの Windows Server 2003:

| ファイル名   | バージョン    | 日付       | 時間  | サイズ     | CPU   | フォルダー  |
|--------------|---------------|------------|-------|------------|-------|-------------|
| Shell32.dll  | 6.0.3790.4822 | 2011/01/22 | 03:46 | 13,153,792 | IA-64 | SP2GDR      |
| Shimgvw.dll  | 6.0.3790.4822 | 2011/01/22 | 03:46 | 1,034,752  | IA-64 | SP2GDR      |
| Wshell32.dll | 6.0.3790.4822 | 2011/01/22 | 03:46 | 8,267,776  | x86   | SP2GDR\\WOW |
| Wshimgvw.dll | 6.0.3790.4822 | 2011/01/22 | 03:46 | 486,400    | x86   | SP2GDR\\WOW |
| Shell32.dll  | 6.0.3790.4822 | 2011/01/22 | 03:43 | 13,155,328 | IA-64 | SP2QFE      |
| Shimgvw.dll  | 6.0.3790.4822 | 2011/01/22 | 03:43 | 1,034,752  | IA-64 | SP2QFE      |
| Wshell32.dll | 6.0.3790.4822 | 2011/01/22 | 03:43 | 8,268,288  | x86   | SP2QFE\\WOW |
| Wshimgvw.dll | 6.0.3790.4822 | 2011/01/22 | 03:43 | 486,400    | x86   | SP2QFE\\WOW |
...
Windows6.0-KB2483185-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2483185-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Vista:  
Windows6.0-KB2483185-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows Vista:  
Windows6.0-KB2483185-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポート技術情報 [2483185](https://support.microsoft.com/kb/2483185) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
Windows6.0-KB2483185-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2483185-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   「Windows シェルのグラフィック処理のオーバーランの脆弱性」[CVE-2010-3970](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970) を報告してくださった [VeriSign iDefense Labs](https://labs.idefense.com/) に協力している Kobi Pariente 氏および Yaniv Miron 氏
