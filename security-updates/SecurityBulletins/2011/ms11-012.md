---
TOCTitle: 'MS11-012'
Title: 'マイクロソフト セキュリティ情報 MS11-012 - 重要'
ms:assetid: 'ms11-012'
ms:contentKeyID: 61229289
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-012(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS11-012 - 重要
===============================================
...
[](https://www.microsoft.com/japan/security/bulletins/ms11-012e.mspx)[![](../../images/Dn636502.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)

### 概説

#### 要点

このセキュリティ更新プログラムは、非公開で報告された 5 件の Microsoft Windows に存在する脆弱性を解決します。これらの脆弱性により、攻撃者がローカルでログオンし、特別に細工したアプリケーションを実行した場合、特権の昇格が起こる可能性があります。攻撃者が有効なログオン資格情報を所持し、ローカルでログオンできた場合、これらの脆弱性を悪用する可能性があります。リモートで、または匿名ユーザーが、これらの脆弱性を悪用することはないと思われます。

このセキュリティ更新プログラムは、すべてのサポートされているバージョンの Microsoft Windows について、深刻度を「重要」に評価しています。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

このセキュリティ更新プログラムは Windows カーネル モード ドライバーがユーザー モードから渡された入力を検証する方法を修正することにより、この脆弱性を解決します。この脆弱性に関する詳細情報は、次の「脆弱性の情報」のセクションの下の特定の脆弱性のエントリに関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。
...
US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS11-012.mspx](https://technet.microsoft.com/security/bulletin/ms11-012)
...
![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム                                                                                               | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響 | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報            |
|-------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|---------------------------------------------------------------------|
| Windows XP Service Pack 3                                                                                               | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=56f4f43e-c313-49dc-a278-e3e8a83a907e&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
| Windows XP Professional x64 Edition Service Pack 2                                                                      | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e80db313-b470-4d71-bc34-70bfbfb6579f&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
| Windows Server 2003 Service Pack 2                                                                                      | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=54fe2669-8a63-4d96-8b82-5b10f45b293e&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
| Windows Server 2003 x64 Edition Service Pack 2                                                                          | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=4632e1ce-6ae8-431c-9104-9a8840e5ac63&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
| Windows Server 2003 with SP2 for Itanium-based Systems                                                                  | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=a09c3e6e-c55c-492a-b7ad-3e3d35711643&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
| Windows Vista Service Pack 1 および Windows Vista Service Pack 2                                                        | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6fb7ebcc-2052-457b-b5bc-1bbcb17696b9&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
| Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2                                | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=88d68757-1ab0-4585-9578-52a474b10882&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
| Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2 \*                  | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=80494972-db45-475f-97cd-dac46b9486a1&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2 \*            | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5597d449-17e3-440f-8b0e-56a902a96569&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
| Windows Server 2008 for Itanium-based Systems および Windows Server 2008 for Itanium-based Systems Service Pack 2       | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=d10eda21-b3c3-4d8e-8596-bc45e4165f93&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
| Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1                                         | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=078fe6c0-1b2c-4896-a345-25cc1b1105e2&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
| Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1                                   | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b42642b3-fb78-4700-bfe8-bfa997b90c16&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
| Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1\*       | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=d2c53f44-12eb-4293-9fa5-2a14075b636e&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
| Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1 | [![](../../images/Dn636502.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8c6bf720-f544-4f58-9b1c-2399957ec43d&displaylang=ja) | 特権の昇格             | 重要           | [MS10-098](https://technet.microsoft.com/security/bulletin/ms10-098) |
...
<span></span>
なぜこのセキュリティ情報は、2011 年 3 月 22 日に更新されたのですか?  
...
<th style="border:1px solid black;" >Win32k の不適切なユーザー入力の検証の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0086">CVE-2011-0086</a></th>
<th style="border:1px solid black;" >Win32k の不十分なユーザー入力の検証の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0087">CVE-2011-0087</a></th>
<th style="border:1px solid black;" >Win32k のウィンドウ クラスのポインターの混同の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0088">CVE-2011-0088</a></th>
<th style="border:1px solid black;" >Win32k のウィンドウ クラスの不適切なポインター検証の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0089">CVE-2011-0089</a></th>
<th style="border:1px solid black;" >Win32k のメモリ破損の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0090">CVE-2011-0090</a></th>
...
<span></span>
Windows カーネル モード ドライバーがユーザー モードから提供されたデータを検証する方法に、特権の昇格の脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、カーネル モードで任意のコードが実行され、影響を受けるコンピューターが完全に制御される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を備えた新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0086](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0086) をご覧ください。
  
#### 「Win32k の不適切なユーザー入力の検証の脆弱性」の問題を緩和する要素 - CVE-2011-0086:
...
#### 「Win32k の不適切なユーザー入力の検証の脆弱性」の回避策 - CVE-2011-0086:
  
-   マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Win32k の不適切なユーザー入力の検証の脆弱性」のよく寄せられる質問 - CVE-2011-0086:
  
どのようなことが起こる可能性がありますか?  
これは、特権の昇格の脆弱性です。攻撃者がこの脆弱性が悪用した場合、カーネル モードで任意のコードを実行し、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を備えた新たなアカウントを作成する可能性があります。
  
何が原因で起こりますか?  
Windows カーネルモード ドライバーがユーザー モードから渡された入力を適切に検証しない場合に、この脆弱性が起こります。
...
この更新プログラムは Windows カーネル モード ドライバーがユーザー モードから渡された入力を検証する方法を修正して、この脆弱性を解決します。
...
<span></span>
Windows カーネル モード ドライバーがユーザー モードから提供されたデータを検証する方法に、特権の昇格の脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、カーネル モードで任意のコードを実行し、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を備えた新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0087](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0087) をご覧ください。
  
#### 「Win32k の不十分なユーザー入力の検証の脆弱性」の問題を緩和する要素 - CVE-2011-0087:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーにより、この脆弱性が悪用されることはないと思われます。
  
#### 「Win32k の不十分なユーザー入力の検証の脆弱性」の回避策 - CVE-2011-0087:
  
-   マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Win32k の不十分なユーザー入力の検証の脆弱性」のよく寄せられる質問 - CVE-2011-0087:
  
どのようなことが起こる可能性がありますか?  
これは、特権の昇格の脆弱性です。攻撃者がこの脆弱性を悪用した場合、カーネル モードで任意のコードを実行し、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を備えた新たなアカウントを作成する可能性があります。
...
この脆弱性により、攻撃者は何を行う可能性がありますか?  
攻撃者がこの脆弱性を悪用した場合、カーネル モードで任意のコードを実行し、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を備えた新たなアカウントを作成する可能性があります。
...
<span></span>
Windows カーネル モード ドライバーが、ユーザー モードからカーネル モードに提供したデータを検証する方法に、特権の昇格の脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、カーネル モードで任意のコードを実行し、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を備えた新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0088](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0088) をご覧ください。
  
#### 「Win32k のウィンドウ クラスのポインターの混同の脆弱性」の問題を緩和する要素 - CVE-2011-0088:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーにより、この脆弱性が悪用されることはないと思われます。
  
#### 「Win32k のウィンドウ クラスのポインターの混同の脆弱性」の回避策 - CVE-2011-0088:
  
-   マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Win32k のウィンドウ クラスのポインターの混同の脆弱性」のよく寄せられる質問 - CVE-2011-0088:
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0089](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0089) をご覧ください。
  
#### 「Win32k のウィンドウ クラスの不適切なポインター検証の脆弱性」の問題を緩和する要素 - CVE-2011-0089:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーにより、この脆弱性が悪用されることはないと思われます。
  
#### 「Win32k のウィンドウ クラスの不適切なポインター検証の脆弱性」の回避策 - CVE-2011-0089:
  
-   マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Win32k のウィンドウ クラスの不適切なポインター検証の脆弱性」のよく寄せられる質問 - CVE-2011-0089:
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0090](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0090) をご覧ください。
  
#### 「Win32k のメモリ破損の脆弱性」の問題を緩和する要素 - CVE-2011-0090
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーにより、この脆弱性が悪用されることはないと思われます。
  
#### 「Win32k のメモリ破損の脆弱性」の回避策 - CVE-2011-0090:
  
-   マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Win32k のメモリ破損の脆弱性」のよく寄せられる質問 - CVE-2011-0090:
...
Windowsxp-KB2479628-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2479628-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB2479628-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB2479628-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB2479628$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB2479628\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB2479628\\Filelist
</td>
</tr>
</table>
...
|------------|---------------|------------|-------|-----------|------------|
| Win32k.sys | 5.1.2600.6064 | 2010/12/31 | 23:03 | 1,854,592 | SP3GDR     |
| Win32k.sys | 5.1.2600.6064 | 2010/12/31 | 23:02 | 1,863,680 | SP3QFE     |

サポートされているすべての x64 エディションの Windows XP:

| ファイル名 | バージョン    | 日付       | 時間  | サイズ    | CPU | フォルダー |
|------------|---------------|------------|-------|-----------|-----|------------|
| Win32k.sys | 5.2.3790.4813 | 2011/01/01 | 15:22 | 4,563,456 | x64 | SP2GDR     |
| Win32k.sys | 5.2.3790.4813 | 2011/01/01 | 15:19 | 4,581,888 | x64 | SP2QFE     |
...
WindowsServer2003-KB2479628-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2479628-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2479628-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB2479628-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2479628\\Filelist
</td>
</tr>
</table>
...
| ファイル名 | バージョン    | 日付       | 時間  | サイズ    | フォルダー |
|------------|---------------|------------|-------|-----------|------------|
| Win32k.sys | 5.2.3790.4813 | 2011/01/01 | 02:40 | 1,857,024 | SP2GDR     |
| Win32k.sys | 5.2.3790.4813 | 2011/01/01 | 02:42 | 1,867,776 | SP2QFE     |

サポートされているすべての Itanium-based エディションの Windows Server 2003:

| ファイル名 | バージョン    | 日付       | 時間  | サイズ    | CPU   | フォルダー |
|------------|---------------|------------|-------|-----------|-------|------------|
| Win32k.sys | 5.2.3790.4813 | 2010/12/31 | 23:21 | 5,587,456 | IA-64 | SP2GDR     |
| Win32k.sys | 5.2.3790.4813 | 2010/12/31 | 23:18 | 5,606,400 | IA-64 | SP2QFE     |
...
Windows6.0-KB2479628-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2479628-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Vista:  
Windows6.0-KB2479628-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows Vista:  
Windows6.0-KB2479628-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポート技術情報 [2479628](https://support.microsoft.com/kb/2479628) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
Windows6.0-KB2479628-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2479628-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2479628-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2479628-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows 7:  
Windows6.1-KB2479628-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows 7:  
Windows6.1-KB2479628-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2479628-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2479628-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   「Win32k の不適切なユーザー入力の検証の脆弱性」- [CVE-2011-0086](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0086) を報告してくださった [Norman](https://www.norman.com/) の Tarjei Mandt 氏
-   「Win32k のメモリ破損の脆弱性」- [CVE-2011-0087](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0087) を報告してくださった [Norman](https://www.norman.com/) の Tarjei Mandt 氏
-   「Win32k のウィンドウ クラスのポインターの混同の脆弱性」- [CVE-2011-0088](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0088) を報告してくださった [Norman](https://www.norman.com/) の Tarjei Mandt 氏
-   「Win32k のWriteAV の脆弱性」- [CVE-2011-0089](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0089) を報告してくださった [Norman](https://www.norman.com/) の Tarjei Mandt 氏
-   「Win32k のメモリ破損の脆弱性」- [CVE-2011-0090](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0090) を報告してくださった [Norman](https://www.norman.com/) の Tarjei Mandt 氏
