---
TOCTitle: 'MS11-086'
Title: 'マイクロソフト セキュリティ情報 MS11-086 - 重要'
ms:assetid: 'ms11-086'
ms:contentKeyID: 61229363
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-086(v=Security.10)'
---


マイクロソフト セキュリティ情報 MS11-086 - 重要
===============================================
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8c7c21c5-677d-4a5d-8f2b-8ca7691b6b00&amp;displaylang=ja">ADAM (Active Directory Application Mode)</a><br />
(KB2616310)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=989cca2d-cce1-4f52-b50e-43152693f240&amp;displaylang=ja">ADAM (Active Directory Application Mode)</a><br />
(KB2616310)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=08b27ce7-c32e-41e4-ad04-481c5eab17a7&amp;displaylang=ja">Active Directory</a><br />
(KB2601626)<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=f116824e-ea48-422d-b284-c9ffa7604bf5&amp;displaylang=ja">ADAM (Active Directory Application Mode)</a><br />
(KB2616310)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=de5a74f2-2cc8-4677-b495-3a40fe3d6b9e&amp;displaylang=ja">Active Directory</a><br />
(KB2601626)<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=1af1b734-62c7-4e08-91c8-90b6d026da84&amp;displaylang=ja">ADAM (Active Directory Application Mode)</a><br />
(KB2616310)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6168bc67-3d59-450f-bd8a-02d61dabe16b&amp;displaylang=ja">Active Directory</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2bd602cf-ae0d-4790-a5d0-6133fd7d01a0&amp;displaylang=ja">Active Directory Lightweight Directory Service (AD LDS)</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=783521ad-5c50-4194-a582-4e5a1c9999e7&amp;displaylang=ja">Active Directory Lightweight Directory Service (AD LDS)</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b5688923-3914-4f6c-8bc9-036fb4870cc6&amp;displaylang=ja">Active Directory および Active Directory Lightweight Directory Service (AD LDS)</a>*<br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=51f47181-08f6-4de1-80e5-253355675965&amp;displaylang=ja">Active Directory および Active Directory Lightweight Directory Service (AD LDS)</a>*<br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b06f9f55-e3b2-4705-83d0-1b9f5de9d378&amp;displaylang=ja">Active Directory Lightweight Directory Service (AD LDS)</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=790f1d99-96a5-438d-b433-895b692912ce&amp;displaylang=ja">Active Directory Lightweight Directory Service (AD LDS)</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cc1e99af-fc67-400b-a82c-171f8c4d1ac9&amp;displaylang=ja">Active Directory および Active Directory Lightweight Directory Service (AD LDS)</a>*<br />
(KB2601626)</td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ja-jp/security/bulletin/ms10-068">MS10-068</a></td>
...
| Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1<sup>[1]</sup> |
...
<span></span>
SSL 経由の LDAP (LDAPS) を使用するように構成されている場合、Active Directory に特権の昇格の脆弱性が存在します。攻撃者は、Active Directory ドメインへの認証に以前に失効された証明書を使用してネットワーク リソースへのアクセスを取得するか、失効された証明書が関連付けられている特定の承認されたユーザーの特権でコードを実行することにより、この脆弱性を悪用する可能性があります。

Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-2014](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2014) を参照してください。

#### 「LDAPS 認証バイパスの脆弱性」の問題を緩和する要素 - CVE-2011-2014
...
#### 「LDAPS 認証バイパスの脆弱性」の回避策 - CVE-2011-2014

回避策は、根本的な脆弱性を正すものではありませんが、更新プログラムを適用するまでの間、既知の攻撃方法の阻止に役立つ設定または構成の変更を示します。マイクロソフトは次の回避策をテストし、回避策が機能性を低下させるかどうかの情報を提供しています。

-   失効した証明書のドメインからユーザーアカウントを削除します。
-   LDAPS を使用することに加え、***IPse***c ベースの接続を "Always check CRL" モードで使用します。

    IPsec で CRL のチェックを有効にする方法の詳細については、TechNet の記事 [Certificate revocation list (CRL) verification - an application choice](https://social.technet.microsoft.com/wiki/contents/articles/964.aspx) (英語情報) を参照してください。

    注

    1.  IPsec を使用し、証明書認証と CRL チェックを使って LDAPS への接続を暗号化し、保護します。
    2.  IPsec を使用し、証明書認証と CRL をチェックを使って暗号化なしで LDAPS への接続を保護します。この場合、LDAPS が暗号化を担います。Windows Vista、Windows Server 2008、Windows 7、および Windows Server 2008 R2 の影響を受けるエディションでは、AuthIP (ユーザー認証が可能な IPsec 拡張) を採用して、攻撃者がコンピューターの証明書を使った IPsec 証明書認証を実行できないようにし、失効したユーザー証明書を使って LDAPS 認証を実行できないようにすることができます。
    3.  LDAPS の NULL カプセル化を使用して 2 回の暗号化を回避し、IPsec レベルの証明書認証と SSL で実行されている認証を無関係にします。つまり、各層で個別の証明書を使用すると、失効した証明書を介した LDAPS へのアクセスが引き続き可能です。

#### 「LDAPS 認証バイパスの脆弱性」のよく寄せられる質問 - CVE-2011-2014

この脆弱性により、どのようなことが起こる可能性がありますか?  
これは、特権の昇格の脆弱性です。攻撃者はこの脆弱性を悪用し、特定の承認されたユーザーの特権でネットワーク リソースへのアクセスを取得したり、コードを実行する可能性があります。

何が原因で起こりますか?  
この脆弱性は、Active Directory が LDAPS を使用するように構成されている場合に、ドメイン アカウントに関連付けられている CRL に対する SSL 証明書の失効状況の検証に失敗したときに起こります。これにより、証明書が証明機関 (CA) によって失効された後でも有効として受け入れられます。

証明機関 (CA) とは何ですか?  
証明機関とは、証明書を発行する組織のことです。証明機関は、人物またはその他の証明機関に属す公開キーの信頼性を確立し、検証します。また、証明書を要求する人物または組織の身元を確認します。

Active Directory サービス とは 何ですか?  
...
Active Directory Lightweight Directory Services (ADLDS) は独立した Active Directory のモードで、アプリケーション専用のディレクトリ サービスを提供します。AD LDS は Windows Vista、Windows Server 2008、Windows 7、および Windows Server 2008 R2 で利用できます。AD LDS は Active Directory Application Mode (ADAM) に代わるものであり、Windows XP および Windows Server 2003 で利用できます。AD LDS の詳細については、TechNet の記事 [Active Directory ライトウェイト ディレクトリ サービス](https://technet.microsoft.com/ja-jp/library/cc731868(ws.10).aspx)を参照してください。

Active Directory Application Mode (ADAM) とは何ですか?  
Active Directory Application Mode (ADAM) は、Windows XP および Windows Server 2003 においてシステム サービスとしてではなくユーザー サービスとして実行される Lightweight Directory Access Protocol (LDAP) ディレクトリ サービスです。ADAM の詳細については、TechNet の記事 [ADAM とは](https://technet.microsoft.com/ja-jp/library/cc780837(ws.10).aspx)を参照してください。
...
証明書失効リスト (CRL) とは何ですか?  
CRL とは、CA により発行されたデジタル署名されたリストで、その CA が発行したのち失効させた証明書のリストを含みます。失効となった個々の証明書について、証明書のシリアル番号、証明書が失効となった日付、失効の理由がリストに含まれています。アプリケーションは CRL チェックを行い、提示された証明書の失効状況を確認することができます。証明書の失効のチェックに関する詳細については、TechNet の記事 [Certificate Revocation and Status Checking](https://technet.microsoft.com/ja-jp/library/ee619730(ws.10).aspx) を参照してください。

SSL経由の LDAP (LDAPS) とは何ですか?  
SSL 経由の LDAP (LDAPS) は、クライアント コンピューターとサーバー コンピューター間を Secure Sockets Layer (SSL)/Transport Layer Security (TLS) テクノロジによって転送されるトラフィックを暗号化します。

Active Directory ドメイン サービスとは何ですか?  
Active Directory ドメイン サービス (AD DS) はディレクトリ データを格納し、ユーザーのログオン プロセス、認証、およびディレクトリ検索などのユーザーとドメイン間の通信を管理します。Active Directory ドメイン コントローラーは、AD DS を実行するサーバーです。AD DS の詳細については、TechNet の記事 [Active Directory ドメイン サービス](https://technet.microsoft.com/ja-jp/library/cc770946(ws.10).aspx)を参照してください。

この脆弱性により、攻撃者は何を行う可能性がありますか?  
攻撃者はこの脆弱性を悪用し、特定の承認されたユーザーの特権でネットワーク リソースへのアクセスを取得したり、コードを実行する可能性があります。そのユーザーに管理者特権がある場合、攻撃者が完全なユーザー権限を持って、プログラムのインストール、データの表示、変更または削除、あるいはアカウントの新規作成を行う可能性があります。

攻撃者はこの 脆弱性をどのように悪用する可能性がありますか?  
この脆弱性を悪用するには、攻撃者は、まず、ドメインの有効なアカウントに関連付けられている失効した証明書を獲得します。次に、攻撃者は、Active Directory ドメインへの認証にこの以前に失効された証明書を使用してネットワーク リソースへのアクセスを取得するか、失効された証明書が関連付けられている特定の承認されたユーザーの特権でコードを実行することにより、この脆弱性を悪用する可能性があります。

主にどのコンピューターがこの脆弱性による危険にさらされますか?  
影響を受けるオペレーティング システムを実行し、Active Directory サービスがインストールされている、すべてのコンピューターがこの脆弱性による影響を受けます。

この更新プログラムはどのように問題を修正しますか?  
このセキュリティ更新プログラムは、Active Directory が CRL に対して証明書を検証する方法を変更することにより、この脆弱性を解決します。
...
<td style="border:1px solid black;">Windows XP Service Pack 3 上の Active Directory Application Mode (ADAM)<br />
WindowsXP-KB2616310-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 上の Active Directory Application Mode (ADAM)<br />
...
<td style="border:1px solid black;">[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2616310$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2616310">マイクロソフト サポート技術情報 2616310</a> を参照してください。</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">ユーザーの操作なしでインストールする</td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 上の Active Directory<br />
WindowsServer2003-KB2601626-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 上の Active Directory Application Mode (ADAM)<br />
WindowsServer2003-KB2616310-x86-jpn.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 上の Active Directory<br />
WindowsServer2003.WindowsXP-KB2601626-x64-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 上の Active Directory Application Mode (ADAM)<br />
WindowsServer2003.WindowsXP-KB2616310-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 with SP2 for Itanium-based Systems 上の Active Directory<br />
WindowsServer2003-KB2601626-ia64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 上の Active Directory<br />
WindowsServer2003-KB2601626-x86-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 上の Active Directory Application Mode (ADAM)<br />
WindowsServer2003-KB2616310-x86-jpn.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 上の Active Directory<br />
WindowsServer2003.WindowsXP-KB2601626-x64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 上の Active Directory Application Mode (ADAM)<br />
WindowsServer2003.WindowsXP-KB2616310-x64-jpn.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 with SP2 for Itanium-based Systems 上の Active Directory<br />
WindowsServer2003-KB2601626-ia64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ログ ファイル</td>
...
<tr class="even">
<td style="border:1px solid black;">削除に関する情報:</td>
<td style="border:1px solid black;">Active Directory については、[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2601626$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Active Directory Application Mode (ADAM) については、[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2616310$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;">Windows Server 2003 上の Active Directory については、<a href="https://support.microsoft.com/kb/2601626">マイクロソフト サポート技術情報 2601626</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 上の Active Directory Application Mode (ADAM) については、<a href="https://support.microsoft.com/kb/2616310">マイクロソフト サポート技術情報 2616310</a> を参照してください。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">レジストリ キーの確認</td>
<td style="border:1px solid black;">Windows Server 2003 上の Active Directory<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB2601626\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 上の Active Directory Application Mode (ADAM)<br />
...
<tr class="odd">
<td style="border:1px solid black;">ユーザーの操作なしでインストールする</td>
<td style="border:1px solid black;">AD LDS がインストールされているすべてのサポートされている 32-bit エディションの Windows Vista<br />
...
<tr class="even">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2601626">マイクロソフト サポート技術情報 2601626</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">レジストリ キーの確認</td>
...
<tr class="odd">
<td style="border:1px solid black;">ユーザーの操作なしでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32-bit エディションの Windows Server 2008 上の Active Directory および Active Directory Lightweight Directory Service (AD LDS)<br />
Windows6.0-KB2601626-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2008 上の Active Directory および Active Directory Lightweight Directory Service (AD LDS)<br />
Windows6.0-KB2601626-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">再起動しないでインストールする</td>
...
<tr class="odd">
<td style="border:1px solid black;">ユーザーの操作なしでインストールする</td>
<td style="border:1px solid black;">AD LDS がインストールされているすべてのサポートされている 32-bit エディションの Windows 7<br />
Windows6.1-KB2601626-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">AD LDS がインストールされているすべてのサポートされている x64-based エディションの Windows 7<br />
