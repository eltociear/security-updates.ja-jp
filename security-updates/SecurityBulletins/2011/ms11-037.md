---
TOCTitle: 'MS11-037'
Title: 'マイクロソフト セキュリティ情報 MS11-037 - 重要'
ms:assetid: 'ms11-037'
ms:contentKeyID: 61229314
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-037(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS11-037 - 重要
===============================================

MHTML の脆弱性により、情報漏えいが起こる (2544893)
--------------------------------------------------

公開日: 2011年6月15日 | 最終更新日: 2011年11月18日
...
このセキュリティ更新プログラムは Microsoft Windows の MHTML プロトコル ハンドラーに存在する一般に公開された脆弱性を解決します。この脆弱性により、ユーザーが攻撃者の Web サイトから特別に細工された URL を開くと、情報漏えいが起こる可能性があります。この脆弱性が悪用されるには、通常、電子メール メッセージまたはインスタント メッセンジャーのメッセージ内のリンクをユーザーにたどらせ、その Web サイトを訪問させることが攻撃者にとっての必要条件となります。

このセキュリティ更新プログラムは、すべてのサポートされているエディションの Windows XP、Windows Vista、および Windows 7 について深刻度を「重要」と評価し、Windows Server 2003、Windows Server 2008、および Windows Server 2008 R2 のすべてのサポートされているエディションについて深刻度を「注意」と評価しています。詳細情報については、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションを参照してください。

このセキュリティ更新プログラムは MHTML パーサーがリクエストを処理する方法を修正することにより、この脆弱性を解決します。この脆弱性に関する詳細については、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」を参照してください。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=ce5bc2d7-9438-4bf0-be5e-be9dd00c3286&displaylang=ja)                                                                                               | 情報漏えい             | 重要           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7b211b02-a005-46a3-ad1d-d4baaeec8289&displaylang=ja)                                                                      | 情報漏えい             | 重要           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6427ea5d-05d0-4367-805c-9cb305802b3c&displaylang=ja)                                                                                      | 情報漏えい             | 注意           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e7f65891-32c0-4817-b3b2-d8be73145df9&displaylang=ja)                                                                          | 情報漏えい             | 注意           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
| [Windows Server 2003 with SP2 for Itanium-based Systems](https://www.microsoft.com/download/details.aspx?familyid=ca8b1d09-9f80-417b-99b1-8f86e86e1f11&displaylang=ja)                                                                  | 情報漏えい             | 注意           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
| [Windows Vista Service Pack 1 および Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ebea38a7-1fbe-4141-a529-52d7a7326d6a&displaylang=ja)                                                        | 情報漏えい             | 重要           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
| [Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=54833350-a385-4a31-995a-9ddc38798c21&displaylang=ja)                                | 情報漏えい             | 重要           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
| [Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6a3bbd67-94db-40b2-8786-cb39a493ec92&displaylang=ja)\*\*                 | 情報漏えい             | 注意           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
| [Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4cb870f3-9878-4075-b8fd-2ee90c8e3bc8&displaylang=ja)\*\*           | 情報漏えい             | 注意           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
| [Windows Server 2008 for Itanium-based Systems および Windows Server 2008 for Itanium-based Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e1243011-00e6-49f2-a676-c04cb805d36a&displaylang=ja)       | 情報漏えい             | 注意           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
| [Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=c3647646-658a-423b-b0cb-bba7613b67e7&displaylang=ja)                                         | 情報漏えい             | 重要           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
| [Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=7996511d-4b8e-49c3-a0fa-4da907a6c947&displaylang=ja)                                   | 情報漏えい             | 重要           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=40354f73-4f4d-4a4a-abac-f8a3d4c3ae5f&displaylang=ja)\*\*     | 情報漏えい             | 注意           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=22853823-8f63-4258-8991-1ad50e58a0d9&displaylang=ja) | 情報漏えい             | 注意           | [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026) |
...
なぜこのセキュリティ情報は 2011 年 11 月 9 日に更新されたのですか?  
マイクロソフトはこのセキュリティ情報を再リリースし、すべてのサポートされているエディションの Windows XP および Windows Server 2003 用のセキュリティ更新プログラム KB2544893 を再提供しました。新しく提供したこの更新プログラムにより、この更新プログラムによって他のすべての影響を受けるオペレーティング システムに提供されている累積的な保護と同じ保護が Windows XP または Windows Server 2003 を実行しているシステムに提供されます。Windows XP および Windows Server 2003 のサポートされているエディションを実行しているシステムには、この更新プログラムの新しいバージョンが自動的に提供されます。2011 年 6 月 14 日に最初に提供された更新プログラムを既に正常にインストールされているお客様を含め、これらのオペレーティング システムを使用しているお客様は、再提供された更新プログラムをインストールする必要があります。
...
<th style="border:1px solid black;" >MHTML の MIME 形式のリクエストの脆弱性 - CVE-2011-1894</th>
...
MHTML の MIME 形式のリクエストの脆弱性 - CVE-2011-1894  
------------------------------------------------------
  
 
MHTML が HTML 文書内に埋め込まれているコンテンツの MIME 形式のリクエストを解釈する方法に情報漏えいの脆弱性が存在します。サーバー側のクロスサイト スクリプティング (XSS) の脆弱性と同じように、特定の状況でこの脆弱性により攻撃者は標的となるユーザーの Internet Explorer のインスタンスのコンテンツで実行されている Web リクエストへの応答にクライアント側のスクリプトを挿入する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1894](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1894) を参照してください。
  
#### 「MHTML の MIME 形式のリクエストの脆弱性」の問題を緩和する要素 - CVE-2011-1894
...
-   Web ベースの攻撃では、この脆弱性の悪用に使用する Web ページが含まれる Web サイトを攻撃者がホストしているケースなどが挙げられます。さらに、侵害された Web サイトおよびユーザー提供のコンテンツまたは広告を受け入れる、またはホストする Web サイトにこの脆弱性の悪用を意図する特別に細工されたコンテンツが含まれる可能性があります。ただし、いずれの場合も、攻撃者が強制的にユーザーをこのような Web サイトにアクセスさせることはできません。その代わりに攻撃者は、ユーザーをこのような Web サイトにアクセスさせるように誘導する必要があります。そのためによく用いられる方法として、電子メール メッセージやインスタント メッセージのリンクをクリックするように仕向け、クリックすると攻撃者の Web サイトに誘導されるという方法があります。
  
#### 「MHTML の MIME 形式のリクエストの脆弱性」の回避策 - CVE-2011-1894
...
-   MHTML プロトコル ハンドラーを無効にする
    ...
    MHTML プロトコル ハンドラーを手動で無効にするために、次のステップを行ってください。
  
    1.  レジストリ エディターを開きます。  
    2.  以下のレジストリ キーの場所へ移動します。  
        HKEY\_CLASSES\_ROOT\\PROTOCOLS\\Handler\\mhtml  
    3.  mhtml レジストリ キーを右クリックし、\[エクスポート\] を選択してバックアップし、レジストリ ファイル (例: "mhtml pluggable protocol registry backup.reg") として保存します。  
    4.  mhtml キーを右クリックし、\[削除\] を選択してレジストリから削除します。
  
    管理された適用スクリプトを使用する
  
    管理された適用スクリプトを使用して MHTML プロトコル ハンドラーを無効にするには、次のステップに従います。
  
    1.  次のコマンド ライン エントリを使用して、mhtml レジストリ キーをバックアップします。  
        regedit /e mhtml\_pluggable\_protocol\_registry\_backup.reg HKEY\_CLASSES\_ROOT\\PROTOCOLS\\Handler\\mhtml  
    2.  以下の内容を .reg 拡張子のファイル (例: disable\_mhtml\_pluggable\_protocol.reg) に保存して、管理された展開スクリプトを作成します。  
        Windows Registry Editor Version 5.00  
        \[-HKEY\_CLASSES\_ROOT\\PROTOCOLS\\Handler\\mhtml\]  
    3.  次のコマンド ライン エントリを使用して、対象のシステム上で管理された展開スクリプトを実行します。  
    ...
    回避策の解除方法: この回避策を解除するには、上記のステップで作成したバックアップ レジストリ ファイルをダブルクリックします。
  
#### 「MHTML の MIME 形式のリクエストの脆弱性」のよく寄せられる質問 - CVE-2011-1894
  
この脆弱性により、どのようなことが起こる可能性がありますか?   
これは情報漏えいの脆弱性です。
  
何が原因で起こりますか?   
MHTML が HTML 文書内に埋め込まれたコンテンツの MIME 形式のリクエストを解釈した場合にこの脆弱性が起こり、攻撃者は間違ったセキュリティ コンテキストでスクリプトを実行できる可能性があります。(例: いくつかのスクリプトが正しくない Internet Explorer のセキュリティ ゾーンで実行される可能性があります。)
  
MHTML とは何ですか?   
MHTML (MIME Encapsulation of Aggregate HTML) は、HTML のコンテンツをまとめるために使用される MIME の構造を定義するインターネットの標準です。Windows の MHTML プロトコル ハンドラーは、プラグ可能なプロトコル (MHTML:) を提供します。このプロトコルは MHTML エンコードされた文書をアプリケーションでレンダリングすることを許可します。詳細については、MSDN の記事 [About Asynchronous Pluggable Protocols](https://msdn.microsoft.com/en-us/library/aa767916(v=vs.85).aspx) (英語情報) を参照してください。
  
クロスサイト スクリプティング (XSS) とは何ですか?   
クロスサイト スクリプティング (XSS) とは攻撃者により Web ページのリクエストへの応答にスクリプトが挿入されるセキュリティの脆弱性の種類です。このスクリプトは要求元のアプリケーション (多くの場合 Web ブラウザー) によって実行されます。スクリプトは影響を受ける Web サイトで、コンテンツのなりすまし、情報の漏えい、または標的となるユーザーに代わって任意の操作を行う可能性があります。
  
この脆弱性により、攻撃者は何を行う可能性がありますか?   
攻撃者によってこの脆弱性が悪用された場合、ユーザーの Internet Explorer インスタンスにクライアント側スクリプトが挿入される可能性があります。スクリプトは影響を受ける Web サイトでコンテンツのなりすまし、情報の漏えい、または標的となるユーザーに代わって任意の操作を行う可能性があります。
  
攻撃者はこの脆弱性をどのように悪用する可能性がありますか?   
攻撃者によってこの脆弱性が悪用された場合、HTML &lt;EMBED&gt; タグを使用してページ内に悪意のあるスクリプトを埋め込んだ Web サイトが作成される可能性があります。次に、攻撃者はこのサイトにユーザーを訪問させるように仕向けることがあります。これにより、攻撃者は間違ったセキュリティ コンテキストでクライアント側のスクリプトを実行する可能性があります。このスクリプトは Web サイトでコンテンツのなりすまし、情報の漏えい、またはユーザーに可能な任意の操作を行う可能性があります。
...
はい。この脆弱性は一般で公開されていました。これは Common Vulnerability and Exposure の [CVE-2011-1894](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1894) にアサインされています。
...
WindowsXP-KB2544893-v2-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2544893-v2-x64-JPN.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
WindowsXP-KB2544893-v2-x86-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2544893-v2-x64-JPN.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2544893-v2$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2544893">サポート技術情報 2544893</a> を参照してください。</td>
</tr>
<tr class="even">
...
<br />
注:  最初のリリースの更新プログラムのファイルがインストールされているシステムでは、次のレジストリ キーも存在します。<br />
...
WindowsServer2003-KB2544893-v2-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2544893-v2-ia64-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32-bit エディションの Windows Server 2003:<br />
WindowsServer2003-KB2544893-v2-x86-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003:<br />
WindowsServer2003-KB2544893-v2-ia64-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ログ ファイル</td>
<td style="border:1px solid black;">KB2544893-v2.log</td>
...
-   このセキュリティ情報に対する変更について協力してくださった [Google Security Team](https://www.google.com/) の Billy Rios 氏および Eduardo Vela Nava 氏
...
-   V2.0 (2011/11/09):このセキュリティ情報を再リリースし、すべてのサポートされているエディションの Windows XP および Windows 2003 用の更新プログラムを再提供しました。2011 年 6 月 15 日に最初に提供された更新プログラムを既に正常にインストールされているお客様を含め、これらのオペレーティング システムを使用しているお客様は、再提供された更新プログラムをインストールする必要があります。詳細については、更新プログラムに関する FAQ を参照してください。  
-   V2.1 (2011/11/18):このセキュリティ情報ページを更新し、Windows XP および Windows Server 2003 について、インストールの確認のレジストリ キー、更新プログラムのログ ファイル名および削除に関する情報を修正しました。今回の更新は情報のみの変更です。
