---
TOCTitle: 'MS11-011'
Title: 'マイクロソフト セキュリティ情報 MS11-011 - 重要'
ms:assetid: 'ms11-011'
ms:contentKeyID: 61229288
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-011(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS11-011 - 重要
===============================================

Windows カーネルの脆弱性により、特権が昇格される (2393802)
----------------------------------------------------------

公開日: 2011年2月9日 | 最終更新日: 2011年3月22日

**バージョン:** 1.0

[](https://www.microsoft.com/japan/security/bulletins/ms11-011e.mspx)[![](../../images/Dn636501.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)

### 概説

#### 要点

このセキュリティ更新プログラムは Microsoft Windows に存在する 1 件の一般に公開された脆弱性および 1 件の非公開で報告された脆弱性を解決します。これらの脆弱性により、攻撃者がローカルでログオンし、特別に細工されたアプリケーションを実行した場合、特権の昇格が起こる可能性があります。これらの脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーにより、これらの脆弱性が悪用されることはないと思われます。

このセキュリティ更新プログラムは、すべてのサポートされているバージョンの Microsoft Windows について、深刻度を「重要」と評価しています。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

このセキュリティ更新プログラムは Windows カーネルがメモリを割り当てる前にユーザーが提供したデータを適切に検証するようにしてこれらの脆弱性を解決します。この脆弱性に関する詳細情報は、次の「脆弱性の情報」のセクションの下の特定の脆弱性のエントリに関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。
...
既知の問題: サポート技術情報 [2393802](https://support.microsoft.com/kb/2393802) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。

US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS11-011.mspx](https://technet.microsoft.com/security/bulletin/ms11-011)
...
![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム/ソフトウェア                                                                            | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響 | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報            |
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|---------------------------------------------------------------------|
| Windows XP Service Pack 3                                                                                         | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=a511d33a-9ae0-46ee-a225-9d97390de7d1&displaylang=ja) | 特権の昇格             | 重要           | [MS10-047](https://technet.microsoft.com/security/bulletin/ms10-047) |
| Windows XP Professional x64 Edition Service Pack 2                                                                | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e7273a85-ce96-464b-8c4f-2710701213e3&displaylang=ja) | 特権の昇格             | 重要           | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
| Windows Server 2003 Service Pack 2                                                                                | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6bf2eeec-8225-477f-a606-263d3ee434d6&displaylang=ja) | 特権の昇格             | 重要           | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
| Windows Server 2003 x64 Edition Service Pack 2                                                                    | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ec544894-ee98-4a2b-ac4d-33b0c3754213&displaylang=ja) | 特権の昇格             | 重要           | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
| Windows Server 2003 with SP2 for Itanium-based Systems                                                            | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=fcd48499-1bb4-4304-b9cc-27d9d92e11cd&displaylang=ja) | 特権の昇格             | 重要           | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
| Windows Vista Service Pack 1 および Windows Vista Service Pack 2                                                  | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=66978514-bb7f-42cc-9360-2fd1c686f4e6&displaylang=ja) | 特権の昇格             | 重要           | [MS10-047](https://technet.microsoft.com/security/bulletin/ms10-047) |
| Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2                          | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8fdb8c37-1b22-457b-bdc0-21f6a5061dd3&displaylang=ja) | 特権の昇格             | 重要           | [MS10-047](https://technet.microsoft.com/security/bulletin/ms10-047) |
| Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2\*             | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=4b37418a-e044-415e-b566-4507f157934a&displaylang=ja) | 特権の昇格             | 重要           | [MS10-047](https://technet.microsoft.com/security/bulletin/ms10-047) |
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2\*       | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=163d3aca-3703-452e-b1cb-73932e2bcf8c&displaylang=ja) | 特権の昇格             | 重要           | [MS10-047](https://technet.microsoft.com/security/bulletin/ms10-047) |
| Windows Server 2008 for Itanium-based Systems および Windows Server 2008 for Itanium-based Systems Service Pack 2 | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=55b07bc0-dff5-4cd7-87c9-c08e5a49197d&displaylang=ja) | 特権の昇格             | 重要           | [MS10-047](https://technet.microsoft.com/security/bulletin/ms10-047) |
| Windows 7 for 32-bit Systems                                                                                      | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e1224c90-b0bc-4e4b-999a-efae327213b4&displaylang=ja) | 特権の昇格             | 重要           | [MS10-047](https://technet.microsoft.com/security/bulletin/ms10-047) |
| Windows 7 for x64-based Systems                                                                                   | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ddcf352e-742c-485e-9ed5-19cdba673562&displaylang=ja) | 特権の昇格             | 重要           | [MS10-047](https://technet.microsoft.com/security/bulletin/ms10-047) |
| Windows Server 2008 R2 for x64-based Systems\*                                                                    | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=70f5056a-72ad-46ff-a43f-ee151639b9a7&displaylang=ja) | 特権の昇格             | 重要           | [MS10-047](https://technet.microsoft.com/security/bulletin/ms10-047) |
| Windows Server 2008 R2 for Itanium-based Systems                                                                  | [![](../../images/Dn636501.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=1646b3a5-714f-4ea5-b109-566fa9b933b6&displaylang=ja) | 特権の昇格             | 重要           | [MS10-047](https://technet.microsoft.com/security/bulletin/ms10-047) |
...
<th style="border:1px solid black;" >ドライバーの Windows カーネルとの不適切な対話の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398">CVE-2010-4398</a></th>
<th style="border:1px solid black;" >Windows カーネルの整数の切り捨ての脆弱性- <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0045">CVE-2011-0045</a></th>
...
<span></span>
ドライバーが Windows カーネルと適切に対話しないため、特権の昇格の脆弱性が存在します。攻撃者によりこの脆弱性が悪用された場合、カーネル モードで任意のコードが実行され、影響を受けるコンピューターが完全に制御される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-4398](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398) をご覧ください。
  
#### 「ドライバーの Windows カーネルとの不適切な対話の脆弱性」の問題を緩和する要素 - CVE-2010-4398:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。
  
#### 「ドライバーの Windows カーネルとの不適切な対話の脆弱性」の回避策 - CVE-2010-4398:
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「ドライバーの Windows カーネルとの不適切な対話の脆弱性」のよく寄せられる質問 - CVE-2010-4398:
  
どのようなことが起こる可能性がありますか?  
これは、特権の昇格の脆弱性です。攻撃者によりこの脆弱性が悪用された場合、カーネル モードで任意のコードが実行され、影響を受けるコンピューターが完全に制御される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります。
  
何が原因で起こりますか?  
ドライバーが Windows カーネルと適切に対話しないため、この脆弱性が起こります。
  
Windows カーネルとは何ですか?  
Windows カーネルとは、オペレーティング システムの中心となる部分です。デバイスやメモリの管理、処理時の処理時間の割り当て、およびエラー処理の管理など、システム レベルのサービスを提供します。
  
この脆弱性により、攻撃者は何を行う可能性がありますか?  
攻撃者によりこの脆弱性が悪用された場合、カーネル モードで任意のコードが実行され、影響を受けるコンピューターが完全に制御される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります。
...
この更新プログラムは、影響を受けるドライバーの Windows カーネルとの対話を安全にすることにより、この脆弱性を解決します。
  
この更新プログラムには、そのほかのセキュリティ関連の変更が含まれますか?  
この更新プログラムには、セキュリティ関連の機能への変更が含まれています。詳細情報は、MSDN コラム [RtlQueryRegistryValues Routine](https://msdn.microsoft.com/ja-jp/library/ff562046(v=vs.85).aspx) (英語情報) をご覧ください。
  
このセキュリティ情報のリリース時に、この脆弱性は一般に公開されていましたか?  
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2010-4398](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398) にアサインされています。
...
<span></span>
ユーザーが提供したメモリをWindows カーネルが読み取る際にメモリを割り当てる方法が原因で、特権の昇格の脆弱性が存在します。攻撃者によりこの脆弱性が悪用された場合、カーネル モードで任意のコードが実行され、影響を受けるコンピューターが完全に制御される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0045](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0045) をご覧ください。
  
#### 「Windows カーネルの整数の整数の切り捨ての脆弱性」の問題を緩和する要素 - CVE-2011-0045:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。
  
#### 「Windows カーネルの整数の切り捨ての脆弱性」の回避策 - CVE-2011-0045:
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Windows カーネルの整数の切り捨ての脆弱性」のよく寄せられる質問 - CVE-2011-0045:
  
どのようなことが起こる可能性がありますか?  
これは、特権の昇格の脆弱性です。攻撃者によりこの脆弱性が悪用された場合、カーネル モードで任意のコードが実行され、影響を受けるコンピューターが完全に制御される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります。
  
何が原因で起こりますか?  
Windows カーネルがメモリを割り当てる前に、ユーザーが提供したデータを適切に検証しないため、この脆弱性が起こります。
...
この更新プログラムはどのように問題を修正しますか?  
このセキュリティ更新プログラムは Windows カーネルがメモリを割り当てる前にユーザーが提供したデータを適切に検証するようにしてこれらの脆弱性を解決します。
...
Windowsxp-KB2393802-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2393802-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB2393802-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB2393802-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB2393802$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB2393802\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB2393802\\Filelist
</td>
</tr>
</table>
...
|--------------|---------------|------------|-------|-----------|------------|
| Ntdll.dll    | 5.1.2600.6055 | 2010/12/10 | 00:15 | 640,000   | SP3GDR     |
| Ntkrnlmp.exe | 5.1.2600.6055 | 2010/12/10 | 00:13 | 2,148,864 | SP3GDR     |
| Ntkrnlpa.exe | 5.1.2600.6055 | 2010/12/10 | 00:13 | 2,069,376 | SP3GDR     |
| Ntkrpamp.exe | 5.1.2600.6055 | 2010/12/10 | 00:13 | 2,027,008 | SP3GDR     |
| Ntoskrnl.exe | 5.1.2600.6055 | 2010/12/10 | 00:13 | 2,192,768 | SP3GDR     |
| Ntdll.dll    | 5.1.2600.6055 | 2010/12/10 | 00:15 | 640,000   | SP3QFE     |
| Ntkrnlmp.exe | 5.1.2600.6055 | 2010/12/10 | 00:14 | 2,148,864 | SP3QFE     |
| Ntkrnlpa.exe | 5.1.2600.6055 | 2010/12/09 | 20:44 | 2,069,376 | SP3QFE     |
| Ntkrpamp.exe | 5.1.2600.6055 | 2010/12/10 | 00:14 | 2,027,008 | SP3QFE     |
| Ntoskrnl.exe | 5.1.2600.6055 | 2010/12/10 | 00:14 | 2,192,768 | SP3QFE     |

サポートされているすべての x64 エディションの Windows XP:

| ファイル名   | バージョン    | 日付       | 時間  | サイズ    | CPU | フォルダー  |
|--------------|---------------|------------|-------|-----------|-----|-------------|
| Ntdll.dll    | 5.2.3790.4789 | 2010/11/09 | 00:49 | 1,373,696 | x64 | SP2GDR      |
| Ntkrnlmp.exe | 5.2.3790.4789 | 2010/11/09 | 00:49 | 4,594,176 | x64 | SP2GDR      |
| Ntoskrnl.exe | 5.2.3790.4789 | 2010/11/09 | 00:49 | 4,524,544 | x64 | SP2GDR      |
| Wntdll.dll   | 5.2.3790.4789 | 2010/11/09 | 00:49 | 884,736   | x86 | SP2GDR\\WOW |
| Hal.dll      | 5.2.3790.4354 | 2010/11/09 | 00:47 | 280,064   | x64 | SP2QFE      |
| Ntdll.dll    | 5.2.3790.4789 | 2010/11/09 | 00:47 | 1,374,720 | x64 | SP2QFE      |
| Ntkrnlmp.exe | 5.2.3790.4789 | 2010/11/09 | 00:47 | 4,619,264 | x64 | SP2QFE      |
| Ntoskrnl.exe | 5.2.3790.4789 | 2010/11/09 | 00:47 | 4,546,560 | x64 | SP2QFE      |
| Wntdll.dll   | 5.2.3790.4789 | 2010/11/09 | 00:47 | 884,736   | x86 | SP2QFE\\WOW |
...
WindowsServer2003-KB2393802-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2393802-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2393802-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB2393802-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2393802\\Filelist
</td>
</tr>
</table>
...
| ファイル名   | バージョン    | 日付       | 時間  | サイズ    | フォルダー |
|--------------|---------------|------------|-------|-----------|------------|
| Ntdll.dll    | 5.2.3790.4789 | 2010/10/22 | 21:27 | 883,712   | SP2GDR     |
| Ntkrnlmp.exe | 5.2.3790.4789 | 2010/10/22 | 21:26 | 2,492,928 | SP2GDR     |
| Ntkrnlpa.exe | 5.2.3790.4789 | 2010/10/22 | 21:26 | 2,305,024 | SP2GDR     |
| Ntkrpamp.exe | 5.2.3790.4789 | 2010/11/09 | 00:18 | 2,344,448 | SP2GDR     |
| Ntoskrnl.exe | 5.2.3790.4789 | 2010/10/22 | 21:26 | 2,454,016 | SP2GDR     |
| Ntdll.dll    | 5.2.3790.4789 | 2010/10/22 | 21:20 | 883,712   | SP2QFE     |
| Ntkrnlmp.exe | 5.2.3790.4789 | 2010/10/22 | 21:18 | 2,504,192 | SP2QFE     |
| Ntkrnlpa.exe | 5.2.3790.4789 | 2010/10/22 | 21:18 | 2,314,752 | SP2QFE     |
| Ntkrpamp.exe | 5.2.3790.4789 | 2010/10/22 | 21:18 | 2,355,200 | SP2QFE     |
| Ntoskrnl.exe | 5.2.3790.4789 | 2010/10/22 | 21:18 | 2,463,232 | SP2QFE     |

サポートされているすべての Itanium-based エディションの Windows Server 2003:

| ファイル名   | バージョン    | 日付       | 時間  | サイズ    | CPU   | フォルダー  |
|--------------|---------------|------------|-------|-----------|-------|-------------|
| Ntdll.dll    | 5.2.3790.4789 | 2010/11/09 | 00:41 | 1,758,208 | IA-64 | SP2GDR      |
| Ntkrnlmp.exe | 5.2.3790.4789 | 2010/11/09 | 00:41 | 6,560,256 | IA-64 | SP2GDR      |
| Wntdll.dll   | 5.2.3790.4789 | 2010/11/09 | 00:41 | 884,736   | x86   | SP2GDR\\WOW |
| Ntdll.dll    | 5.2.3790.4789 | 2010/11/09 | 00:38 | 1,758,720 | IA-64 | SP2QFE      |
| Ntkrnlmp.exe | 5.2.3790.4789 | 2010/11/09 | 00:38 | 6,588,416 | IA-64 | SP2QFE      |
| Wntdll.dll   | 5.2.3790.4789 | 2010/11/09 | 00:38 | 884,736   | x86   | SP2QFE\\WOW |
...
Windows6.0-KB2393802-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2393802-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Vista:  
Windows6.0-KB2393802-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows Vista:  
Windows6.0-KB2393802-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポート技術情報 [2393802](https://support.microsoft.com/kb/2393802) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
Windows6.0-KB2393802-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2393802-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2393802-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2393802-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows 7:  
Windows6.1-KB2393802-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows 7:  
Windows6.1-KB2393802-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2393802-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2393802-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   「ドライバーの Windows カーネルとの不適切な対話の脆弱性」 - [CVE-2010-4398](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398) を報告してくださった [360safe](https://www.360.cn/) の Zhengwenbin 氏
-   「ドライバーの Windows カーネルとの不適切な対話の脆弱性」 - [CVE-2010-4398](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398) を報告してくださった Guo Bojun 氏
-   「ドライバーの Windows カーネルとの不適切な対話の脆弱性」 - [CVE-2010-4398](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398) を報告してくださった Wei Zhang 氏
-   「Windows カーネルの不適切なデータの検証の脆弱性」 - [CVE-2010-4398](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398) についてマイクロソフトに協力してくださった [PrevX](https://www.prevx.com/) の Marco Giuliani 氏
-   「Windows カーネルの整数の切り捨ての脆弱性」- [CVE-2011-0045](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0045) を報告してくださった [Tipping Point](https://www.tippingpoint.com/) の[ゼロディ イニシアティブ](https://www.zerodayinitiative.com/) に協力している std\_logic
...
-   2011/03/03: このセキュリティ情報ページを更新し、「概説」の「既知の問題」のセクションに、サポート技術情報 2393802 へのリンクを追加しました。
-   2011/03/22: マイクロソフトはこのセキュリティ情報を更新し、「影響を受けないソフトウェア」の一覧に、Windows 7 for 32-bit Systems Service Pack 1、Windows 7 for x64-based Systems Service Pack 1、Windows Server 2008 R2 for x64-based Systems Service Pack 1 および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1 を追加したことをお知らせしました。今回の更新は情報のみの変更です。このセキュリティ情報のセキュリティ更新プログラムのファイルおよび検出ロジックへの変更はありません。
