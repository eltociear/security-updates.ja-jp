...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|--------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=6bc1f0ac-223d-4b0b-86cd-2ba3863955c4&displaylang=ja)                              | 特権の昇格             | 重要           | なし                                                   |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d5ee6787-408d-4870-af70-9338158b161b&displaylang=ja)     | 特権の昇格             | 重要           | なし                                                   |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8de0f2db-aa09-48cd-a13b-e26a973e9cdc&displaylang=ja)                     | 特権の昇格             | 重要           | なし                                                   |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8f208407-4bb3-41fe-b0d6-fc8a5e30e667&displaylang=ja)         | 特権の昇格             | 重要           | なし                                                   |
| [Windows Server 2003 with SP2 for Itanium-based Systems](https://www.microsoft.com/download/details.aspx?familyid=ef140089-d022-4ee8-9cc4-7fb25295a39d&displaylang=ja) | 特権の昇格             | 重要           | なし                                                   |
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1974](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1974) を参照してください。
...
リモート アクセス サービス (RAS) により、ユーザーは、電話回線、インターネット、またはその他のネットワーク接続でリモートのコンピューターに接続し、リモートのネットワークに物理的に接続しているように操作できます。 RAS によって、ユーザーは電子メールの送受信、ドキュメントの FAX 操作、ファイルの取得、オフィスのプリンターでのドキュメントの印刷などの作業をリモートから実行できます。 詳細については、MSDN の記事 [RAS](https://msdn.microsoft.com/en-us/library/ff563285(v=vs.85).aspx)Architecture Overview (NDIS 5.1) (英語情報) を参照してください。
...
**注**: MBSA、Microsoft Update および Windows Server Update Services でサポートされていないレガシ製品をご使用のお客様は、[Microsoft Baseline Security Analyzer](https://technet.microsoft.com/ja-jp/security/cc184924) (MBSA) をご覧のうえ、レガシ製品のサポート セクションのレガシ ツールで包括的にセキュリティ更新プログラムを検出する方法をご参照ください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2566454">サポート技術情報 2566454</a> を参照してください。</td>
</tr>
<tr class="even">
