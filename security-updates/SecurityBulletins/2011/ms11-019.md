- <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=2011-0660">CVE-2011-0660</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0654](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0654) をご覧ください。
...
Microsoft Server Message Block (SMB) プロトコルとは、Microsoft Windows で使用されるマイクロソフトのネットワーク ファイル共有プロトコルです。SMB に関する詳細情報は、MSDN コラム [Microsoft SMB Protocol and CIFS Protocol Overview](https://msdn.microsoft.com/library/aa365233(vs.85).aspx) (英語情報) をご覧ください。
  
**ブラウザー サービスとは何ですか?**  
ブラウザー サービスはコンピューターが属しているドメイン名またはワーキンググループ名の一覧および、ブラウザー サービスを実行しているコンピューターが運用しているネットワーク セグメント上のコンピューターが使用しているプロトコルを保持します。各ネットワーク セグメントでは、ブラウザー サービスを実行しているセグメント上にあるコンピューター グループからマスター ブラウザーが選択されます。コンピューター ブラウザー サービスに関する詳細は、[サポート技術情報 188001](https://support.microsoft.com/kb/188001) をご覧ください。
  
**Common Internet File System (CIFS) ブラウザー プロトコルとは何ですか?**   
CIFS ブラウザー プロトコルは、ネットワーク上で利用可能なサービスの clearinghouse として動作するサーバー、ネットワーク上で利用可能な印刷またはファイル共有のようなサービスを行うサーバー、および特定なサービスの詳細をリクエストするクライアントが送信および受信するメッセージを定義します。CIFS ブラウザー プロトコルのコンテキストでは、閲覧は特定のサービスを提供するサーバーを検索するプロセスです。詳細情報は、MSDN の記事 [\[MS-BRWS\]: Common Internet File System (CIFS) Browser Protocol Specification](https://msdn.microsoft.com/library/cc224428(prot.10).aspx) (英語情報) をご覧ください。
  
**マスター ブラウザーとは何ですか?**   
マスター ブラウザーは、マスター ブラウザーのネットワーク セグメント上の各サーバーから 12 分毎にデータグラムとして送信されるホストまたはサーバーのアナウンスを収集する役目があります。マスター ブラウザーは、各ネットワーク セグメントの可能なブラウザーに、バックアップ ブラウザーになるように指示します。所定のネットワーク セグメント上のバックアップ ブラウザーは、同じセグメントのクライアント コンピューターに一覧を提供します。コンピューター ブラウザー サービスに関する詳細は、[サポート技術情報 188001](https://support.microsoft.com/kb/188001) をご覧ください。
...
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2011-0654](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0654) にアサインされています。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0660](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0660) をご覧ください。
...
**URI とは何ですか?**   
Uniform Resource Identifier (URI) とは、インターネットからのリソースおよびネットワーク上のリソースの操作または識別を行うために使用される文字列です。URL は Web サイトなどのリソースを参照する URI の典型的な例です。URI に関する詳細は、[RFC-2396](https://www.ietf.org/rfc/rfc2396.txt) (英語情報) をご覧ください。
...
<td style="border:1px solid black;">
サポート技術情報 [2511455](https://support.microsoft.com/kb/2511455) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
