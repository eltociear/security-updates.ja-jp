...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1878](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1878) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1884](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1884) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1885](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1885) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1886](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1886) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1887](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1887) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1888](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1888) を参照してください。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2555917">サポート技術情報 2555917</a> を参照してください。</td>
</tr>
<tr class="even">
...
-   Win32k の解放後使用の脆弱性 (CVE-2011-1874) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1875) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1876) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1877) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1878) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1879) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の NULL ポインター逆参照の脆弱性 (CVE-2011-1880) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の NULL ポインター逆参照の脆弱性 (CVE-2011-1881) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1882) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1883) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の解放後使用の脆弱性 (CVE-2011-1884) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の NULL ポインター逆参照の脆弱性 (CVE-2011-1885) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の不適切なパラメーター検証による情報漏えいの脆弱性 (CVE-2011-1886) を報告してくださった[北京大学ソフトウェアおよびマイクロエレクトロニクス学院](http://www.ss.pku.edu.cn/en/)の Liang Yin 氏、Sihan Qing 教授、Weiping Wen 教授、および Husheng Zhou 氏  
-   Win32k の NULL ポインター逆参照の脆弱性 (CVE-2011-1887) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏  
-   Win32k の NULL ポインター逆参照の脆弱性 (CVE-2011-1888) を報告してくださった [Norman](http://www.norman.com) の Tarjei Mandt 氏
