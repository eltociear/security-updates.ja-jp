...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|--------------------------------------------------------|
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e08266d8-fffa-40bf-b8f6-10a65ee27524&displaylang=ja)                                                                                            | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4f2365ed-d50e-44d9-b859-1ec54d3b4d38&displaylang=ja)                                                                                | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2008 for 32-bit Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f82dc413-668c-4ca8-a8c8-db74f05346bc&displaylang=ja)\*\*                                                               | リモートでコードが実行される | 警告           | なし                                                   |
| [Windows Server 2008 for x64-based Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=06ad5637-56a1-4478-aaa0-063e877503c9&displaylang=ja)\*\*                                                            | リモートでコードが実行される | 警告           | なし                                                   |
| [Windows Server 2008 for Itanium-based Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2de5de74-e643-4045-9c22-ff95b0dbcafc&displaylang=ja)                                                            | リモートでコードが実行される | 警告           | なし                                                   |
| [Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=2307fa93-8e45-4841-a5a9-7e89960712f9&displaylang=ja)                                         | リモートでコードが実行される | 注意           | なし                                                   |
| [Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=62603d18-1b21-400c-8eba-202193182960&displaylang=ja)                                   | リモートでコードが実行される | 注意           | なし                                                   |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=c9cf6a22-f9ab-427a-9b16-33c60baaabb5&displaylang=ja)\*\*     | リモートでコードが実行される | 注意           | なし                                                   |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=012777f5-51f2-4944-91af-a9c79b8081a1&displaylang=ja) | リモートでコードが実行される | 注意           | なし                                                   |
...
Windows ミーティング スペースを使用すると、ドキュメント、プログラム、またはデスクトップを、Windows Vista を実行しているコンピューターのユーザーと共有できます。Windows ミーティング スペースでは、ピア ツー ピア テクノロジを使用します。既存のネットワークが見つからない場合は、アドホック ネットワークが自動的にセットアップされます。詳細については、[Windows ミーティング スペース : よく寄せられる質問](https://windows.microsoft.com/ja-jp/windows-vista/windows-meeting-space-frequently-asked-questions)を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2620704">マイクロソフト サポート技術情報 2620704</a> を参照してください。</td>
</tr>
<tr class="odd">
