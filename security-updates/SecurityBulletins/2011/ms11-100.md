...
このセキュリティ更新プログラムは、[マイクロソフト セキュリティ アドバイザリ 2659883](https://technet.microsoft.com/ja-jp/security/advisory/2659883) で最初に説明した脆弱性も解決します。
...
既知の問題 [マイクロソフト サポート技術情報 2638420](https://support.microsoft.com/kb/2638420/ja) で、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。
...
<td style="border:1px solid black;">
[MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) の KB2572067 は、KB2656353 に置き換えられる。  
[MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) のKB2418241 および[セキュリティ アドバイザリ 973811](https://technet.microsoft.com/ja-jp/security/advisory/973811) の KB982167 は、KB2656352 に置き換えられる。  
[MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) の KB2416473 は、KB2657424 に置き換えられる。  
[MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) の KB2416472 は、KB2656351 に置き換えられる。
</td>
</tr>
...
<td style="border:1px solid black;">
[MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) の KB2416451 は、KB2656358 に置き換えられる。  
[MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) のKB2418241 および[セキュリティ アドバイザリ 973811](https://technet.microsoft.com/ja-jp/security/advisory/973811) の KB982167 は、KB2656352 に置き換えられる。  
[MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) の KB2416473 は、KB2657424 に置き換えられる。  
[MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) の KB2416472 は、KB2656351 に置き換えられる。
</td>
...
<td style="border:1px solid black;">
[MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) の KB2572067 は、KB2656353 に置き換えられる。  
[MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) のKB2416470 および[セキュリティ アドバイザリ 973811](https://technet.microsoft.com/ja-jp/security/advisory/973811) の KB982533 は、KB2656362 に置き換えられる。  
[MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) の KB2416473 は、KB2657424 に置き換えられる。  
[MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) の KB2416472 は、KB2656351 に置き換えられる。
</td>
</tr>
...
<td style="border:1px solid black;">
[MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) の KB2416471 は、KB2656355 に置き換えられる。  
[MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) の KB2416472 は、KB2656351 に置き換えられる。
</td>
</tr>
<tr class="alternateRow">
...
はい。このセキュリティ情報で提供している KB2656353 は、[MS12-035](https://go.microsoft.com/fwlink/?linkid=246970) で言及している CVE-2012-0160 および CVE-2012-0161 にも対応しています。
...
|-------------------------------------------------------------|------------------------------------------------------------------------|
| Windows Developer Preview 上の Microsoft .NET Framework 3.5 | [サポート技術情報 2656360](https://support.microsoft.com/kb/2656360/ja) |
| Windows Developer Preview 上の Microsoft .NET Framework 4.5 | [サポート技術情報 2656354](https://support.microsoft.com/kb/2656354/ja) |

セキュリティ更新プログラムは、[Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) および [](https://go.microsoft.com/fwlink/?linkid=21130)[Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)</a> から入手できます。

この更新プログラムはその他のセキュリティ関連の変更を含みますか?  
はい。このセキュリティ情報の「脆弱性の情報」の欄に記載されている変更と共に、この更新プログラムには ASP.NET のフレームワークに対する機能の変更が含まれています。この更新プログラムはリクエストでフォーム キー、ファイルおよび JSON メンバーの最大数を 1000 までに制限します。この変更により、ASP.NET アプリケーションがこのような要素が 1000 以上あるリクエストを拒否するようになります。これらの種類のリクエストを行うクライアントは拒否され、ブラウザーでエラー メッセージ (通常、エラー 500) が表示されるようになります。この制限はアプリケーションごとに構成できます。 [マイクロソフト サポート技術情報 2661403](https://support.microsoft.com/kb/2661403/ja) を参照してください。

また、この更新プログラムはフォーム認証チケットの形式を変更し、旧バージョンのフォーム認証チケットとの互換性を持たないようにします。たとえば、この更新プログラムをインストールした後、更新されたサーバーと更新されていないサーバーの存在する Web ファームの環境で、更新されているサーバーが更新されていないサーバーで互換性を持たないフォーム認証チケットを生成する可能性があります。[マイクロソフト サポート技術情報 2661404](https://support.microsoft.com/kb/2661404/ja) を参照してください。
...
今後、脆弱性の影響を受けないようにするため、旧リリースのソフトウェアを使用しているお客様は、サポート対象のリリースに移行することを強く推奨します。ご使用中のソフトウェア リリースのサポート ライフサイクルを確認するには、[プロダクト サポート ライフサイクル - 製品一覧](https://go.microsoft.com/fwlink/?linkid=169555)を参照してください。これらのソフトウェアのリリースのサービス パックの詳細については、[プロダクト サポート ライフサイクル - 製品一覧](https://go.microsoft.com/fwlink/?linkid=89213)を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-3414](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3414) を参照してください。
...
-   構成ベースの回避策
    ...
    注: 既定での HTTP クエリの文字列の増加および、ヘッダーのサイズの限界値を増加させる要求、サーバーがサービス拒否の影響をより受けやすくなることついては、このアドバイザリで説明されています。詳細については、「I[IS 用の Http.sys レジストリ設定](https://support.microsoft.com/kb/820129/ja)」をご覧ください。
...
はい。この脆弱性は一般で公開されていました。これは Common Vulnerability and Exposure の番号 [CVE-2011-3414](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3414) が割り当てられています。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-3415](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3415) を参照してください。
...
-   web.config でフォーム認証を無効にする
    ...
    2.  認証モードを Windows, Passport または、None に設定します。
        ...
        各モードの詳細については、 <https://msdn.microsoft.com/en-us/library/aa291347(v=vs.71).aspx> を参照してください。
...
フォーム認証は、ユーザーがサイトにログインしたときに作成された認証チケットを使用して、ユーザーがサイトにいる間中、追跡を行います。フォーム認証のチケットは通常クッキーの中に含まれています。しかし、ASP.NET version 2.0 は、クッキーを使用しないフォーム認証をサポートしています。その結果、チケットはクエリの文字列に渡されます。詳細については、MSDN の記事「[Explained:Forms Authentication in ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ff647070.aspx)」(英語情報)をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-3416](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3416) を参照してください。
...
詳細情報は、[マイクロソフト サポート技術情報 2659968](https://support.microsoft.com/kb/2659968/ja) をご参照ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-3417](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3417) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2638420/ja">マイクロソフト サポート技術情報 2638420</a> を参照してください。</td>
</tr>
<tr class="odd">
...
インストーラーの詳細については、[MSDN Web サイト](https://msdn.microsoft.com/en-us/library/aa367988(vs.85).aspx) (英語情報)を参照してください。
...
-   「.NET フォームの認証の安全ではないリダイレクトの脆弱性」(CVE-2011-3415) を報告してくださった [Seeker](https://www.seekersec.com) の Irene Abezgauz 氏
-   「ASP.Net フォームの認証バイパスの脆弱性」(CVE-2011-3416) を報告してくださった [SEC Consult](https://www.sec-consult.com/) の Kestutis Gudinavicius 氏
-   「ASP.Net フォームの認証のチケットをキャッシュする脆弱性」(CVE-2011-3417) を報告してくださった [LBi](https://www.lbi.com/) の Oliver Dewdney 氏
