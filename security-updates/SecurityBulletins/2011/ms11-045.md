...
既知の問題: マイクロソフト サポート技術情報 [2537146](https://support.microsoft.com/kb/2537146) には、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明されています。
...
<th style="border:1px solid black;" >
Excel の不適切なレコードの解析の脆弱性 - [CVE-2011-1273](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1273)
</th>
<th style="border:1px solid black;" >
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-1275](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1275) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-1276](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1276) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-1277](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1277) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1278](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1278) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1279](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1279) を参照してください。
...
-   Office ファイル検証機能を設定して、Excel 2003 でファイル検証に失敗したファイルが開かれるのを無効にする
    ...
    注: この回避策を適用する前に、各自の Microsoft Office バージョン向けの Office ファイル検証機能を有効にする必要があります。 Microsoft Office 2003 で Office ファイル検証機能を有効にする方法の詳細については、TechNet の記事 [Office File Validation for Office 2003 and Office 2007](https://technet.microsoft.com/en-us/library/gg985445(office.12).aspx) (英語情報) を参照してください。
...
-   Microsoft Office 2003 のサポートされているバージョンについては、[Creating an Administrative Installation Point](https://office.microsoft.com/en-us/ork2003/ha0114.1.2931033.aspx) (英語情報) をご覧ください。Microsoft Office 2003 のサポートされていないバージョンの管理者用インストール ポイントの場合は、マイクロソフト サポート技術情報 [902349](https://support.microsoft.com/kb/902349) をご覧ください
...
<td style="border:1px solid black;">
サポート技術情報 [2541003](https://support.microsoft.com/kb/2541003) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
<td style="border:1px solid black;">
サポート技術情報 [2541025](https://support.microsoft.com/kb/2541025) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
<td style="border:1px solid black;">
Excel 2007:  
サポート技術情報 [2541007](https://support.microsoft.com/kb/2541007) をご覧ください。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Microsoft Excel Viewer:  
サポート技術情報 [2541015](https://support.microsoft.com/kb/2541015) をご覧ください。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Word/Excel/PowerPoint 2007 ファイル形式用 Microsoft Office 互換機能パック  
サポート技術情報 [2541012](https://support.microsoft.com/kb/2541012) をご覧ください。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2523021">サポート技術情報 2523021</a> を参照してください。</td>
</tr>
<tr class="even">
...
[マイクロソフト ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=d12d0868-4f28-4c0a-ab61-338878064b70)から Microsoft Office 2004 for Mac 11.6.4 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[Microsoft ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=ad1b1984-b2b2-49b3-a1dd-385b77d9248a&displaylang=ja)から Microsoft Office 2008 for Mac 12.3.0 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[Microsoft ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=8bd6ca3b-8004-4e8d-a09d-220dcbbce799&displaylang=ja) から Microsoft Office 2011 14.1.2 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[Microsoft ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=b846d255-a7d4-4a2c-a084-d434c29fe676&displaylang=ja)から Mac 1.2.0 用の Open XML File Format Converter の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
-   Excel の不十分なレコードの検証の脆弱性 - [CVE-2011-1272](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2011-1272) を報告してくださった [Fortinet の FortiGuard Labs](https://www.fortiguardcenter.com/) の Bing Liu 氏  
-   Excel の不適切なレコードの解析の脆弱性 - [CVE-2011-1273](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1273) を報告してくださった [VeriSign iDefense Labs](https://labs.idefense.com/) に協力している匿名のリサーチャー  
-   Excel の境界外の配列のアクセスの脆弱性 - [CVE-2011-1274](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1274) を報告してくださった [VeriSign iDefense Labs](https://labs.idefense.com/) に強力している Omair 氏  
-   Excel のメモリのヒープの上書きの脆弱性 - [CVE-2011-1275](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1275) を報告してくださった [VeriSign iDefense Labs](https://labs.idefense.com/) に協力している匿名のリサーチャー  
-   Excel のバッファー オーバーランの脆弱性 - [CVE-2011-1276](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1276) を報告してくださった [VeriSign iDefense Labs](https://labs.idefense.com/) に協力している [Agarri](https://www.agarri.fr/) の Nicolas Gregoire 氏  
-   Excel のメモリ破損の脆弱性 - [CVE-2011-1277](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1277) を報告してくださった Omair 氏  
-   Excel の WriteAV の脆弱性 [CVE-2011-1278](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1278) を報告してくださった [CERT/CC](https://www.cert.org/) の Will Dormann 氏  
-   Excel の境界外の WriteAV の脆弱性 [CVE-2011-1279](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1279) を報告してくださった [CERT/CC](https://www.cert.org/) の Will Dormann 氏
