---
TOCTitle: 'MS11-083'
Title: 'マイクロソフト セキュリティ情報 MS11-083 - 緊急'
ms:assetid: 'ms11-083'
ms:contentKeyID: 61229360
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-083(v=Security.10)'
---


マイクロソフト セキュリティ情報 MS11-083 - 緊急
===============================================
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|------------------------------|---------------------------------------------------------------------------|
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=fc3fe87c-2493-431d-a904-dec9310f6042&displaylang=ja)                                                                                                        | 緊急                   | リモートでコードが実行される | [MS11-064](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=042c1a8f-834d-4eed-8a59-9e030ccc6d39&displaylang=ja)                                                                                            | 緊急                   | リモートでコードが実行される | [MS11-064](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows Server 2008 for 32-bit Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=79382bf2-d2cb-42ea-92dc-64f949353521&displaylang=ja)\*                                                                             | 緊急                   | リモートでコードが実行される | [MS11-064](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows Server 2008 for x64-based Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=71ff3a89-d7ad-4dda-9e59-fab54b21bd5d&displaylang=ja)\*                                                                          | 緊急                   | リモートでコードが実行される | [MS11-064](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows Server 2008 for Itanium-based Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b1c0cb05-c284-49b1-ae4f-92813fdf520f&displaylang=ja)                                                                        | 緊急                   | リモートでコードが実行される | [MS11-064](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=4ddb4c2a-bada-49b0-ad78-e07e7e11ced7&displaylang=ja)                                                     | 緊急                   | リモートでコードが実行される | [MS11-064](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=05eef5d7-acf6-46e4-abfc-dc83f0a7cae5&displaylang=ja)                                               | 緊急                   | リモートでコードが実行される | [MS11-064](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=3f9f74a6-e984-4aab-837c-ef7286e7305f&displaylang=ja)\*                   | 緊急                   | リモートでコードが実行される | [MS11-064](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=b20bfcbd-a515-4074-b56e-b82539fe5bad&displaylang&displaylang=ja) | 緊急                   | リモートでコードが実行される | [MS11-064](https://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
...
<th style="border:1px solid black;" >参照カウンターのオーバーフローの脆弱性 - CVE-2011-2013</th>
...
<span></span>
特別に細工された UDP パケットの連続フローの処理が原因で、Windows TCP/IP スタックに、リモートでコードが実行される脆弱性が存在します。攻撃者がこの脆弱性の悪用に成功した場合、カーネル モードで任意のコードを実行する可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除などを行ったり、完全なユーザー権限を持つ新たなアカウントを作成したりする可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-2013](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2013) を参照してください。
  
#### 「参照カウンターのオーバーフローの脆弱性」の問題を緩和する要素 - CVE-2011-2013
  
マイクロソフトは、この脆弱性の問題を緩和する要素を確認していません。
  
#### 「参照カウンターのオーバーフローの脆弱性」の回避策 - CVE-2011-2013
  
回避策は、根本的な脆弱性を正すものではありませんが、更新プログラムを適用するまでの間、既知の攻撃方法の阻止に役立つ設定または構成の変更を示します。マイクロソフトは次の回避策をテストし、回避策が機能性を低下させるかどうかの情報を提供しています。
  
-   未使用の UDP ポートを境界ファイアウォールでブロックする
  
    未使用の (閉じられている) UDP ポートを境界ファイアウォールでブロックするすると、ファイアウォールの背後のシステムを、この脆弱性の悪用の試行から保護する手助けとなります。ポートの詳細については、TechNet の記事 [TCP and UDP Port Assignments](https://go.microsoft.com/fwlink/?linkid=21312) (英語情報) を参照してください。
  
#### 「参照カウンターのオーバーフローの脆弱性」のよく寄せられる質問 - CVE-2011-2013
  
この脆弱性により、どのようなことが起こる可能性がありますか?   
これは、Windows カーネルのコンテキストでリモートが実行される脆弱性です。
  
何が原因で起こりますか?   
この脆弱性は Windows TCP/IP スタックが特別な細工がされたパケットの連続フローを処理する際に起こり、これにより整数オーバーフローが発生します。
...
UDP とは何ですか?    
User Datagram Protocol (UDP) は RFC 768 "User Datagram Protocol (UDP)" で定義された TCP/IP の標準です。UDP は、TCP/IP ホスト間で高速、軽量、信頼性の低いデータの転送を行うために TCP に代わって一部のプログラムで使用されます。UDP はコネクションレス データグラム サービスで、ベストエフォート配信を行います。つまり、UDP はデータグラムの配信を保証しません。また、シーケンスを検証しません。信頼性のある通信を必要としているソース ホストは、TCP や、独自のシーケンス サービスおよび確認サービスを備えたプログラムを使用する必要があります。詳細については、TechNet の記事[ユーザー データグラム プロトコル (UDP)](https://technet.microsoft.com/ja-jp/library/cc785220(ws.10).aspx)を参照してください。
...
攻撃者は、特別に細工した UDP パケットの連続フローを対象システムの閉じられたポートに送信して、この脆弱性を悪用する可能性があります。
  
主にどのコンピューターがこの脆弱性による危険にさらされますか?   
ワークステーションおよびサーバーが、主にこの脆弱性による危険にさらされます。
  
この更新プログラムはどのように問題を修正しますか?   
この更新プログラムは、Windows TCP/IP スタックがメモリ内の UDP パケットを追跡する方法を変更することにより、この脆弱性を解決します。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2588516">サポート技術情報 2588516</a> を参照してください。</td>
</tr>
<tr class="odd">
