...
既知の問題: [マイクロソフト サポート技術情報 2567951](https://support.microsoft.com/kb/2567951) で、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。
...
<td style="border:1px solid black;">
[MS11-039](https://technet.microsoft.com/security/bulletin/ms11-039)
</td>
</tr>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1978](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1978) を参照してください。
...
-   [KB2562394](https://support.microsoft.com/kb/2562394) がインストール済みの場合、ユーザーの操作なしでは悪用されません。MS11-044 を通じて利用可能になるこの更新プログラムは、インターネット ゾーンで ClickOnce アプリケーションがユーザーにプロンプトを表示せずに実行されることがないようにします。[KB2562394](https://support.microsoft.com/kb/2562394) がインストールされていない場合、アプリケーションがインターネットのみ以外のアクセス許可を使用していなければ、ダイアログ ボックスは表示されません。この機能の詳細については、[KB2562394](https://support.microsoft.com/kb/2562394) を参照してください。
...
.NET Framework の System.Net.Sockets 名前空間は、ネットワークへのアクセスを厳しく制御したい開発者に Windows Sockets (Winsock) インターフェイスの管理された実装を提供します。詳細については、MSDN の記事「[System.Net.Sockets 名前空間](https://msdn.microsoft.com/ja-jp/library/sb27wehh.aspx)」を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2567951">マイクロソフト サポート技術情報 2567951</a> を参照してください。</td>
</tr>
<tr class="odd">
