---
TOCTitle: 'MS11-064'
Title: 'マイクロソフト セキュリティ情報 MS11-064 - 重要'
ms:assetid: 'ms11-064'
ms:contentKeyID: 61229341
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-064(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS11-064 - 重要
===============================================
...
このセキュリティ更新プログラムは、非公開で報告された 2 件の Microsoft Windows に存在する脆弱性を解決します。 この脆弱性により、攻撃者が特別に細工された一連のインターネット制御メッセージ プロトコル (ICMP) メッセージを標的となるコンピューターに送信した場合、または特別に細工された URL リクエストを URL ベースのサービスの品質 (QoS) 機能が有効で Web コンテンツをサービスするサーバーに送信した場合、サービス拒否が起こる可能性があります。

このセキュリティ更新プログラムは、すべてのサポートされているエディションの Windows Server 2008 および Windows Server 2008 R2 について「重要」と評価されており、すべてのサポートされているエディションの Windows Vista および Windows 7 について「警告」と評価されています。詳細については、このセクションのサブセクション「影響を受けるソフトウェアおよび影響を受けないソフトウェア」を参照してください。

このセキュリティ更新プログラムは、Windows TCP/IP スタックが ICMP メッセージを処理する方法と URL ベースの QoS が有効の場合にメモリ内の URL を処理する方法を変更することにより、これらの脆弱性を解決します。 これらの脆弱性の詳細については、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」を参照してください。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|---------------------------------------------------------------------|
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=114c2835-921a-4d3e-be91-dfd217fd26a9&displaylang=ja)                                                                                            | サービス拒否           | 警告           | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0fcee476-8d7e-49a7-b6ea-89043304a653&displaylang=ja)                                                                                | サービス拒否           | 警告           | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 for 32-bit Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c01d9132-af5f-4039-8195-95f6761f2d0e&displaylang=ja)\*                                                                 | サービス拒否           | 重要           | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 for x64-based Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=70797adb-d693-4102-9e7c-ba1ea8fb07d0&displaylang=ja)\*                                                              | サービス拒否           | 重要           | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 for Itanium-based Systems Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9babf81a-8b21-42ae-a65c-f414793516ab&displaylang=ja)                                                            | サービス拒否           | 重要           | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=814bbdfa-7cbc-40e5-8ca3-8fed9d13ff00&displaylang=ja)                                         | サービス拒否           | 警告           | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=085ee785-b6ad-4c68-835a-e17bc8f12a53&displaylang=ja)                                   | サービス拒否           | 警告           | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=9fd2b4ba-d98e-4ad6-99f2-c471335042d3&displaylang=ja)\*       | サービス拒否           | 重要           | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=93752c8f-5461-4e6f-9cab-6401b985ef17&displaylang=ja) | サービス拒否           | 重要           | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
...
<th style="border:1px solid black;" >ICMP のサービス拒否の脆弱性 - CVE-2011-1871</th>
<th style="border:1px solid black;" >TCP/IP QOS のサービス拒否の脆弱性 - CVE-2011-1965</th>
...
<span></span>
TCP/IP スタックが特別に細工された一連の ICMP メッセージを適切に処理しないことが原因で、Windows TCP/IP スタックにサービス拒否の脆弱性が存在します。 攻撃者にこの脆弱性が悪用された場合、標的となったコンピューターが応答せず、自動的に再起動する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1871](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1871) を参照してください。
  
#### 「ICMP のサービス拒否の脆弱性」の問題を緩和する要素 - CVE-2011-1871
  
マイクロソフトは、この脆弱性の問題を緩和する要素を確認していません。
  
#### 「ICMP のサービス拒否の脆弱性」の回避策 - CVE-2011-1871
  
回避策は、根本的な脆弱性を正すものではありませんが、更新プログラムを適用するまでの間、既知の攻撃方法の阻止に役立つ設定または構成の変更を示します。 マイクロソフトは次の回避策をテストし、回避策が機能性を低下させるかどうかの情報を提供しています。
  
-   **ファイアウォールで ICMP をブロックする**
  
    ネットワーク境界のファイアウォールまたはルーターですべての ICMP メッセージをブロックすると、ファイアウォールまたはルーターの背後のコンピューターを、この脆弱性を悪用した攻撃から保護することができます。 受信者側が要求していないすべてのインターネットからの受信通信をブロックすることを推奨します。
...
#### 「ICMP のサービス拒否の脆弱性」のよく寄せられる質問 - CVE-2011-1871
  
**この脆弱性により、どのようなことが起こる可能性がありますか?**    
これは、サービス拒否の脆弱性です。
  
**何が原因で起こりますか?**    
この脆弱性は、Windows TCP/IP スタックが特別に細工された一連の ICMP メッセージを適切に処理しないことが原因で起こります。
  
**この脆弱性による影響を受けるコンポーネントは何ですか?**    
Tcpip.sys がこの脆弱性による影響を受けるコンポーネントです。
  
**この脆弱性により、攻撃者は何を行う可能性がありますか?**    
攻撃者にこの脆弱性が悪用された場合、標的となったコンピューターが応答せず、自動的に再起動する可能性があります。
  
**攻撃者はこの脆弱性をどのように悪用する可能性がありますか?**    
リモートの認証を受けていない攻撃者が、特別に細工された一連の ICMP メッセージを標的となるコンピューターに送信するプログラムを作成することによって、この脆弱性を悪用する可能性があります。
  
**主にどのコンピューターがこの脆弱性による危険にさらされますか?**    
サーバーおよびワークステーションがこの脆弱性の影響を受けます。
  
**この更新プログラムはどのように問題を修正しますか?**    
この更新プログラムは、Windows TCP/IP スタックが ICMP メッセージを処理する方法を変更することにより、この脆弱性を解決します。
...
<span></span>
URL ベースのサービスの品質 (QoS) が有効の場合に TCP/IP スタックがメモリ内の URL を適切に処理しないことが原因で、Windows TCP/IP スタックにサービス拒否の脆弱性が存在します。 攻撃者にこの脆弱性が悪用された場合、標的となったコンピューターが応答せず、自動的に再起動する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1965](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1965) を参照してください。
  
#### 「TCP/IP QOS のサービス拒否の脆弱性」の問題を緩和する要素 - CVE-2011-1965
  
緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。 お客様の状況で、次の「緩和する要素」が役立つ場合があります。
  
-   既定では、URL ベースのサービスの品質機能はどの Windows オペレーティング システムでも有効になっていません。 ユーザーが手動でこの機能をインストールしている場合、この脆弱性の影響を受けます。
  
#### 「TCP/IP QOS のサービス拒否の脆弱性」の回避策 - CVE-2011-1965
  
回避策は、根本的な脆弱性を正すものではありませんが、更新プログラムを適用するまでの間、既知の攻撃方法の阻止に役立つ設定または構成の変更を示します。 マイクロソフトは次の回避策をテストし、回避策が機能性を低下させるかどうかの情報を提供しています。
  
-   ポリシーベースの QoS を無効にします。 詳細については、マイクロソフト TechNet の記事 [Policy-based Quality of Service (QoS)](https://technet.microsoft.com/en-us/library/dd919203(ws.10).aspx) (英語情報) を参照してください。
  
#### 「TCP/IP QOS のサービス拒否の脆弱性」のよく寄せられる質問 - CVE-2011-1965
  
**この脆弱性により、どのようなことが起こる可能性がありますか?**    
これは、サービス拒否の脆弱性です。
  
**何が原因で起こりますか?**    
この脆弱性は、TCP/IP スタックがメモリ内の特別に細工された URL を適切に処理しないことによって起こります。 この脆弱性は、標的となるコンピューターが IIS のようなサービスを使用して Web コンテンツをホストしており、かつ URL ベースの QoS が有効になっている場合にのみ引き起こされます。
  
**この脆弱性による影響を受けるコンポーネントは何ですか?**    
Tcpip.sys がこの脆弱性による影響を受けるコンポーネントです。
  
**URL ベースのサービスの品質 (QoS) とは何ですか?**    
ネットワークのサービスの品質 (QoS) は、クリティカル アプリケーションの高品質なパフォーマンスを保証するために業界全体で使われる標準と機構の集まりです。 ネットワーク管理者は QoS 機構を使用して、送信ネットワーク トラフィックについて、優先順位の設定と送信速度の管理を行うことができます。 このような機構を採り入れることによって、求められるサービス水準を提供するためにリソースが効率良く使用されます。
  
Windows Server 2008 R2 を使用すると、Web トラフィックの優先度を URL に基づいて制御できます。 URL ベースの QoS を使用して、重要な Web トラフィックがそれほど重要でないトラフィックより先に処理されるようにすることで、混雑したネットワークのパフォーマンスを向上させることができます。 たとえば、重要な内部 Web サイトに対する Web トラフィックの優先度を外部 Web サイトに対するそれより高くすることで、ネットワーク混雑時のパフォーマンスを最大限に高めることができます。 詳細については、マイクロソフト TechNet の記事「[URL ベースの QoS](https://technet.microsoft.com/ja-jp/library/dd637810(ws.10).aspx)」を参照してください。
  
**URI とは何ですか?**    
Uniform Resource Identifier (URI) とは、インターネットからのリソースおよびネットワーク上のリソースの操作または識別を行うために使用される文字列です。 URL は Web サイトなどのリソースを参照する URI の典型的な例です。 URI の詳細については、[RFC-2396](https://www.ietf.org/rfc/rfc2396.txt) (英語情報) を参照してください。
  
**この脆弱性により、攻撃者は何を行う可能性がありますか?**    
攻撃者にこの脆弱性が悪用された場合、標的となったコンピューターが応答せず、自動的に再起動する可能性があります。
  
**攻撃者はこの脆弱性をどのように悪用する可能性がありますか?**    
リモート攻撃のシナリオでは、認証されていない攻撃者が特別に細工された URL リクエストを、URL ベースの QoS が有効で Web コンテンツ サービスを行うサーバーに送信することによって、この脆弱性を悪用する可能性があります。
  
**主にどのコンピューターがこの脆弱性による危険にさらされますか?**    
URL ベースの QoS が有効で Web コンテンツをホストするサーバーが主に危険にさらされます。 URL ベースの QoS が有効になっていないサーバー、または Web コンテンツ サービスを行っていないサーバーは影響を受けません。 インターネット インフォメーション サービス (IIS) の実行が可能な、Windows 7 コンピューターなどのワークステーションは、IIS と URL ベースの QoS とがどちらも有効の場合に危険にさらされる可能性が高くなります。
  
**Windows 7 コンピューターは IIS を使用するサーバーとして構成されていると危険にさらされる可能性が高くなりますか?**    
はい。 Windows 7 コンピューターには、IIS のようなサーバー ソフトウェアをインストールして構成することができます。 Windows 7 コンピューターはワークステーションと見なされますが、この構成の場合はサーバーとして機能し、したがってこの脆弱性の対する危険性が増します。
  
**この更新プログラムはどのように問題を修正しますか?**    
このセキュリティ更新プログラムは、URL ベースの QoS が有効の場合に TCP/IP スタックがメモリ内の URL を処理する方法を変更することにより、この脆弱性を解決します。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2563894">サポート技術情報 2563894</a> を参照してください。</td>
</tr>
<tr class="odd">
