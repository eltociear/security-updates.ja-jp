...
[](https://www.microsoft.com/japan/security/bulletins/ms11-026e.mspx)[![](../../images/Dn636516.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
このセキュリティ更新プログラムは MHTML パーサーがリクエストを処理する方法を修正することにより、この脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。 このセキュリティ更新プログラムは、最初に[マイクロソフト セキュリティ アドバイザリ 2501696](https://technet.microsoft.com/security/advisory/2501696) で説明した脆弱性についても解決します。
...
US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS11-026.mspx](https://technet.microsoft.com/security/bulletin/ms11-026)
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7f0a4616-8e3e-4925-9d95-ce6e614e45ae&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b01fe9a5-66a4-4683-963b-e78aea214579&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">情報漏えい</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0209a004-f23a-40d9-991f-864046f4605f&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">情報漏えい</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6c287571-54ea-4298-8b7d-b98b2c830cc3&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">情報漏えい</td>
<td style="border:1px solid black;">注意</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3fb450a0-d087-4f36-9301-05ffbf94cc1a&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">情報漏えい</td>
<td style="border:1px solid black;">注意</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c8fce0fb-4c90-479b-8ce9-75e60d52d256&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">情報漏えい</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7da10b64-d0a9-4e42-aa3a-87c657122a8c&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">情報漏えい</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=036f1285-7484-4e3b-8799-2c6c08166596&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">情報漏えい</td>
<td style="border:1px solid black;">注意</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1438cec8-8dab-4510-ad75-dc6959dac0d8&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">情報漏えい</td>
<td style="border:1px solid black;">注意</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f35ecdd1-6b5c-40e7-a00b-ca083bdf5cba&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">情報漏えい</td>
<td style="border:1px solid black;">注意</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=aed201c1-f1fb-4df9-8875-6f57ea0eb15b&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">情報漏えい</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1a32bf04-7eed-4d27-a8e4-054b4a5b76cb&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">情報漏えい</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=665faa7e-2368-4421-9dd5-ea6df2c79498&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">情報漏えい</td>
<td style="border:1px solid black;">注意</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=140ea384-2877-401f-ac3b-f84f6966e970&amp;displaylang=ja"><img src="../../images/Dn636516.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">情報漏えい</td>
<td style="border:1px solid black;">注意</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<th style="border:1px solid black;" >MHTML の MIME 形式のリクエストの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096">CVE-2011-0096</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0096](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096) をご覧ください。
...
-   MHTML プロトコル ハンドラーを無効にする
    ...
    ポリシーを使用し、ドメインに適用することもできます。グループ ポリシーの詳細については、TechNet の記事 [Group Policy collection](https://technet.microsoft.com/library/cc779838.aspx) (英語情報)を参照してください。
...
-   MHTML プロトコルのロックダウンを有効にする
    ...
    注意: 自動化された “Microsoft Fix it” ソリューションを使用してこの回避策を有効または無効にするには、サポート技術情報 [2503658](https://support.microsoft.com/kb/2503658) をご覧ください。MHTML プロトコルをロックダウンするには、以下のテキストをメモ帳などのテキスト エディターに貼り付けてください。次に、.reg ファイル名拡張子を使用してファイルを保存します。
    ...
    この .reg ファイルをダブルクリックすると、個々のコンピューターに適用できます。グループ ポリシーを使用し、ドメインに適用することもできます。グループ ポリシーの詳細については、次のマイクロソフトの Web サイトを参照してください。グループ ポリシーの詳細については、TechNet の記事 [Group Policy collection](https://technet.microsoft.com/library/cc779838.aspx) (英語情報)を参照してください。
...
MHTML とは何ですか?  
MHTML (MIME Encapsulation of Aggregate HTML) は、HTML のコンテンツをまとめるために使用される MIME の構造を定義するインターネットの標準です。Windows の MHTML プロトコル ハンドラーは、MHTML エンコードされた文書をアプリケーションでレンダリングすることを許可する [プラグ可能なプロトコル (MHTML:)](https://msdn.microsoft.com/en-us/library/aa767916(vs.85).aspx) (英語情報) を提供します。
...
マイクロソフト サポート技術情報 [2503658](https://support.microsoft.com/kb/2503658) の Microsoft Fix it ソリューションは MHTML プロトコルのロックダウンを有効にします。このセキュリティ更新プログラムは MHTML に存在する脆弱性を解決しますが、Microsoft Fix it ソリューションにより実行される MHTML プロトコルのロックダウンを無効にはしません。回避策の影響は、このセキュリティ更新プログラムをインストールした後も残ります。MHTML プロトコルをロックダウンしたのままにしておきたくないユーザーは Microsoft Fix it ソリューションを使用してロックダウンを無効にすることができます。Microsoft Fix it ソリューションに関する詳細情報は、前のセクションの回避策「MHTML プロトコルのロックダウンを有効にする」をご覧ください。
...
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-20011-0096](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096) にアサインされています。
...
はい。このセキュリティ更新プログラムは、現在悪用されているこの脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-20011-0096](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096) に割り当てられています。
...
<td style="border:1px solid black;">
サポート技術情報 [2503658](https://support.microsoft.com/kb/2503658) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
-   「MHTML の MIME 形式の Web リクエストの脆弱性」 [CVE-2011-0096](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096) についてマイクロソフトと協力してくださった [Google Security Team](https://www.google.com/)
