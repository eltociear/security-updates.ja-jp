...
[](https://www.microsoft.com/japan/security/bulletins/ms11-051e.mspx)[![](../../images/Dn636541.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
既知の問題: マイクロソフト サポート技術情報 [2518295](https://support.microsoft.com/kb/2518295) には、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明されています。

US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS11-051.mspx](https://technet.microsoft.com/security/bulletin/ms11-051)
...
新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ef90d6c1-ea7f-4c32-9c90-0303e04c7436&amp;displaylang=ja"><img src="../../images/Dn636541.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=62944095-33d6-4131-be32-a79d9ec4d4a9&amp;displaylang=ja"><img src="../../images/Dn636541.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=46ade106-e0cb-4c71-8230-793a15062823&amp;displaylang=ja"><img src="../../images/Dn636541.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6141a1c5-ecaf-4553-9d27-dd6e5c4a13fd&amp;displaylang=ja"><img src="../../images/Dn636541.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1da04414-6210-43ea-8e0a-cf21cf144076&amp;displaylang=ja"><img src="../../images/Dn636541.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
はい。マイクロソフトは Web 登録の ASP ページを編集したお客様が、マイクロソフト サポート技術情報 [2518295](https://support.microsoft.com/kb/2518295) をご覧になり、所有のシステムに適用する既知の問題に関する重要な情報を入手することを推奨します。
...
<th style="border:1px solid black;" >Active Directory の証明書サービスの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1264">CVE-2011-1264</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-1264](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1264) をご覧ください。
...
Microsoft Baseline Security Analyzer (MBSA) を使用して、管理者はローカルおよびリモートで一般的に誤った構成のセキュリティ更新プログラムと不足しているセキュリティ更新プログラムをスキャンできます。MBSA の詳細情報については、[Microsoft Baseline Security Analyzer (MBSA)](https://technet.microsoft.com/security/cc184924.aspx) をご覧ください。以下の表では、このセキュリティ更新プログラム用の MBSA が検出する概要を提供しています。
...
<td style="border:1px solid black;">
サポート技術情報 [2518295](https://support.microsoft.com/kb/2518295/) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
-   「Active Directory 証明書サービスの脆弱性」 - [CVE-2011-1264](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1264) を報告してくださった Ruggero Strabla 氏、[eMaze Networks](https://www.emaze.net/)、[Saipem Security Team](https://www.saipem.com/site/home.html)
