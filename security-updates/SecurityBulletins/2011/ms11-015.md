...
[](https://www.microsoft.com/japan/security/bulletins/ms11-015e.mspx)[![](../../images/Dn636505.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS11-015.mspx](https://technet.microsoft.com/security/bulletin/ms11-015)
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b1be30de-7e88-467d-aee2-68f88e6a7355&amp;displaylang=ja"><img src="../../images/Dn636505.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d8284bfa-ed6c-4647-9fb0-588e53173775&amp;displaylang=ja"><img src="../../images/Dn636505.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5270b5d3-3720-42a2-a8cf-67089c0cc658&amp;displaylang=ja"><img src="../../images/Dn636505.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f9f1dde2-2219-4bf1-a497-edd011577b96&amp;displaylang=ja"><img src="../../images/Dn636505.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e11d00df-d1cf-4a33-a1be-6721cdff5995&amp;displaylang=ja"><img src="../../images/Dn636505.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1be77daa-29b1-4dae-a87f-2cb8f7e6a305&amp;displaylang=ja"><img src="../../images/Dn636505.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=56fb24ce-65c7-4573-b613-e424ccc1a3a6&amp;displaylang=ja"><img src="../../images/Dn636505.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6f45658a-1db8-4ef5-b840-4d0180d4d90e&amp;displaylang=ja"><img src="../../images/Dn636505.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
...
(KB2494132)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1bc240b3-1938-4350-b26f-67b81a79f8a0&amp;displaylang=ja"><img src="../../images/Dn636505.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
(KB2494132)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cd4c5a80-db24-4696-a248-1286c3b9f550&amp;displaylang=ja"><img src="../../images/Dn636505.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
はい。この更新プログラムが解決する脆弱性は、マイクロソフト セキュリティ アドバイザリ [2269637](https://technet.microsoft.com/security/advisory/2269637) で説明している、アプリケーションが外部ライブラリをロードする方法に影響する脆弱性のクラスに関連するものです。このセキュリティ更新プログラムはこの種の脆弱性の特定の問題を解決します。
...
<span></span>
次の深刻度の評価は脆弱性による影響が最大であった場合を前提としています。このセキュリティ情報のリリース後 30 日以内に、深刻度の評価およびセキュリティ上の影響に関連する脆弱性が悪用される可能性に関する情報は、[3 月のセキュリティ情報](https://technet.microsoft.com/security/bulletin/msxx-mmm)の「Exploitability Index (悪用可能性指標)」のセクションをご覧ください。詳細については、[Microsoft Exploitability Index (悪用可能性指標)](https://technet.microsoft.com/security/cc998259.aspx)をご覧ください。
...
<th style="border:1px solid black;" >DirectShow の安全でないライブラリのロードの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0032">CVE-2011-0032</a></th>
<th style="border:1px solid black;" >DVR-MS の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0042">CVE-2011-0042</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0032](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0032) をご覧ください。
...
DirectShow は Microsoft Windows で自動的にインストールされる既定のフィルターのセットを提供します。これらのフィルターは、高度なハードウェアの独立性を提供しながら、多くのデータ形式をサポートします。アプリケーションは対象となるシステムにカスタム フィルターを登録し、インストールすることもできます。フィルターの全一覧および詳細情報については、MSDN コラム [DirectShow Filters](https://msdn.microsoft.com/library/dd375464(v=vs.85).aspx) (英語情報) をご覧ください。
...
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2011-0032](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0032) にアサインされています。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0042](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0042) をご覧ください。
...
<td style="border:1px solid black;">
サポート技術情報 [2479943](https://support.microsoft.com/kb/2479943) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポート技術情報 [2494132](https://support.microsoft.com/kb/2494132) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
-   「DVR-MS の脆弱性」 - [CVE-2011-0042](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0042) の 問題を報告してくださった [Sourcefire VRT](https://www.sourcefire.com/services/sf_vrt.html) の Matthew Watchinski 氏
