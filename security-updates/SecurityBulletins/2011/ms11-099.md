...
既知の問題 [サポート技術情報 2618444](https://support.microsoft.com/kb/2618444/ja) で、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。
...
マイクロソフトはこのセキュリティ情報を更新し、この更新プログラム (MS11-099) によって、 [SSL/TLS の脆弱性により、情報漏えいが起こる](https://technet.microsoft.com/ja-jp/security/bulletin/ms12-006) の更新プログラム (MS12-006) で提供されている防御を Internet Explorer 向けに有効にすることをお知らせしました。詳細については、 [MS12-006](https://technet.microsoft.com/ja-jp/security/bulletin/ms12-006) を参照してください。

このセキュリティ更新プログラムは、MS12-006 および CVE-2011-3389 と、どのような関係がありますか?  
[SSL/TLS の脆弱性により、情報漏えいが起こる](https://technet.microsoft.com/ja-jp/security/bulletin/ms12-006)の更新プログラム (MS12-006) は、WinHTTP に影響を及ぼす SSL および TLS プロトコルの脆弱性 ([CVE-2011-3389](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3389)) を解決して、システム全体の保護を有効にできるようにします。この更新プログラム (MS11-099) は、Internet Explorer の保護を有効にします。詳細については、 [MS12-006](https://technet.microsoft.com/ja-jp/security/bulletin/ms12-006) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1992](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1992) を参照してください。
...
-   XSS フィルターを無効にする
    ...
    1.  次を .REG の拡張子 (例: Disable\_XSS\_Filter.reg) でファイルに保存します。
	
	```
	5.00[HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Internet Explorer\MAIN\FeatureControl\FEATURE_XSSFILTER]"iexplorer.exe"=dword:00000000[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Internet Explorer\MAIN\FeatureControl\FEATURE_XSSFILTER]"iexplorer.exe"=dword:00000000
	```
    ...
    1.  次を .REG の拡張子 (例: Enable\_XSS\_Filter.reg) でファイルに保存します。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-2019](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2019) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-3404](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3404) を参照してください。
...
詳細については、[サポート技術情報 910723](https://support.microsoft.com/kb/910723/ja) を参照してください。「毎月リリースされる検出と展開の手引きの一覧」
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2618444/ja">サポート技術情報 2618444</a> を参照してください。</td>
</tr>
<tr class="even">
...
-   「Internet Explorer の安全でないライブラリのロードの脆弱性」(CVE-2011-2019) を報告してくださった [Citrix Security Team](https://www.citrix.com) の Andy Cooper 氏  
-   「Content-Disposition の情報の漏えいの脆弱性」(CVE-2011-3404) を報告してくださった [Google Inc.](https://www.google.com/) の [Robert Swiecki](https://www.swiecki.net) 氏  
-   「Content-Disposition の情報の漏えいの脆弱性」(CVE-2011-3404) についてマイクロソフトに協力して下さった [Yosuke Hasegawa](https://utf-8.jp/) 氏  
-   このセキュリティ情報に組み込まれている多層防御についてマイクロソフトに協力してくださった [Jan Schejbal](https://janschejbal.wordpress.com/) 氏
