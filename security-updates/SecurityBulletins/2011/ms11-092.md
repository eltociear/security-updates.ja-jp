---
TOCTitle: 'MS11-092'
Title: 'マイクロソフト セキュリティ情報 MS11-092 - 緊急'
ms:assetid: 'ms11-092'
ms:contentKeyID: 61229369
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-092(v=Security.10)'
---
...
公開日: 2011年12月14日 | 最終更新日: 2012年8月2日
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=03bc6446-7cf3-47c4-8ed1-a53a4d53a429">Windows XP Media Center Edition 2005 Service Pack 3</a><br />
(KB2619340)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=d85091b5-69bb-4d0f-839a-a65cd94e2887">Windows XP Service Pack 3</a><br />
(KB2619339)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=7d1d1e9a-603c-4895-a69f-b61186a75ad5">Windows XP Professional x64 Edition Service Pack 2</a><br />
(KB2619339)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=e9130fad-de8c-4be0-aea1-62cbaa310b76">Windows Vista Service Pack 2</a><br />
(KB2619339)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=b7c4bf05-eb2d-48ac-a6df-8afd88e811d8">Windows Vista x64 Edition Service Pack 2</a><br />
(KB2619339)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=b6e44069-dec5-48f6-8fc4-8ab375a10b4e">Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1</a><br />
(KB2619339)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=f7997ab8-27e0-4714-845a-d237f4326587">Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1</a><br />
(KB2619339)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
...
はい。Windows Developer Preview リリース向けの KB2619339 の更新プログラムが利用可能です。Windows Developer Preview をご使用のお客様は、システムにこの更新プログラムを適用することをお勧めします。この更新プログラムは [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) でのみ利用可能です。
...
<th style="border:1px solid black;" >Windows Media Player DVR-MS のメモリ破損の脆弱性 - CVE-2011-3401</th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
<span></span>
Windows Media Player および Windows Media Center が DVR-MS ファイルを処理する方法にリモートでコードが実行される脆弱性が存在します。この脆弱性で、攻撃者がユーザーに特別な細工がされた DVR-MS ファイルを開くよう誘導した場合、任意のコードが実行される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除などを行ったり、完全なユーザー権限を持つ新たなアカウントを作成したりする可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-3401](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3401) を参照してください。
  
#### 「Windows Media Player DVR-MS のメモリ破損の脆弱性」の問題を緩和する要素 - CVE-2011-3401
...
-   この脆弱性は、電子メールを介して、自動的に悪用されることはありません。攻撃が行われるには、電子メール メッセージで添付ファイルとして送信された特別な細工がされた DVR-MS ファイルをユーザーが開くことが攻撃者にとっての必要条件となります。  
...
#### 「Windows Media Player DVR-M のメモリ破損の脆弱性」の回避策 - CVE-2011-3401
  
回避策は、根本的な脆弱性を正すものではありませんが、更新プログラムを適用するまでの間、既知の攻撃方法の阻止に役立つ設定または構成の変更を示します。マイクロソフトは次の回避策をテストし、回避策が機能性を低下させるかどうかの情報を提供しています。
  
-   Administrator グループが所有する ENCDEC.DLL へのアクセスを制限する
  
    Windows XP (32-bit エディション) では、コマンド プロンプトから次のコマンドを実行します。
  
    `cacls %WINDIR%\SYSTEM32\ENCDEC.DLL /E /P everyone:N`
  
    Windows XP (64-bit エディション) では、コマンド プロンプトから次のコマンドを実行します。
  
    `cacls %WINDIR%\SYSWOW64\ENCDEC.DLL E /P everyone:N`
  
    Windows Vista (32-bit エディション) および Windows Server 7 (32-bit エディション) では、コマンド プロンプトから管理者として次のコマンドを実行します。
    ...
    Windows Vista (x64-based エディション) および Windows 7 (x64-based エディション) では、コマンド プロンプトから管理者として次のコマンドを実行します。
    ...
    Windows Vista (32-bit エディション) および Windows 7 (32-bit エディション) では、コマンド プロンプトから管理者として次のコマンドを実行します。
...
-   ENCDEC.DLL の登録を解除する
    ...
    32-bit エディションの Windows では、管理者としてログインし、コマンド プロンプトから次のコマンドを実行します。
  
    `Regsvr32.exe -u %WINDIR%\SYSTEM32\ENCDEC.DLL`
  
    x64-based エディションの Windows では、管理者としてログオン中にコマンド プロンプトから次のコマンドを実行します。
...
-   信頼されないソースからの .dvr-ms ファイルを 開かない
  
    信頼できない、または信頼できるソースから予期せず受け取った .dvr-ms ファイルを開かないでください。ユーザーが特別な細工がされたファイルを開いた場合、この脆弱性が悪用される可能性があります。
  
#### 「Windows Media Player DVR-M のメモリ破損の脆弱性」のよく寄せられる質問 - CVE-2011-3401
...
Microsoft Digital Video Recording (DVR-MS) ファイルとは、ストリーム バッファー エンジン (SBE) により作成されるファイルで、.dvr-ms ファイル拡張子で保存されます。SBE がビデオ コントロールから制御されている時、オーディオおよびビデオの基本ストリームはコピー防止/制御情報についてテストされます。この情報がコンテンツが暗号化される必要があると指定していない場合、暗号化されていないファイルが作成され、その後、SBE を使用する DirectShow ベースのアプリケーションによりアクセスされます。この情報がコンテンツが暗号化される必要があると指定している場合、録音のために使用された同じコンピューター上のみでの再生以外、結果ファイルにアクセスできなくなります。ビデオ制御に基づいていない DirectShow アプリケーションでは直接 SBE を使用して、暗号化されていない dvr-ms ファイルの作成や再生ができます。
...
WindowsXPMediaCenter2005-KB2619340-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
WindowsXP-KB2619339-x86-jpn.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2619339-x64-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">Windows XP Media Center Edition 2005 Service Pack 3:<br />
WindowsXPMediaCenter2005-KB2619340-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
WindowsXP-KB2619339-x86-jpn.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2619339-x64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Windows XP Media Center Edition 2005 Service Pack 3:<br />
[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2619340$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2619339$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Windows XP Media Center Edition 2005 Service Pack 3:<br />
<a href="https://support.microsoft.com/kb/2619340">サポート技術情報 2619340</a> を参照してください。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
<a href="https://support.microsoft.com/kb/2619339">サポート技術情報 2619339</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
...
<tr class="even">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2619339">サポート技術情報 2619339</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">レジストリ キーの確認</td>
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/)に協力して、Windows Media Player DVR-MS のメモリ破損の脆弱性 (CVE-2011-3401) を報告してくださった匿名のリサーチャー
...
-   V1.1 (2012/08/02):このセキュリティ情報ページを更新し、KB2619339 について Windows Vista パッケージでの検出を変更し、Windows Update での再提供の問題を修正したことをお知らせしました。これは検出の変更のみです。システムを正常に更新済みのお客様は、措置を講じる必要はありません。
