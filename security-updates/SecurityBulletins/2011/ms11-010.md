---
TOCTitle: 'MS11-010'
Title: 'マイクロソフト セキュリティ情報 MS11-010 - 重要'
ms:assetid: 'ms11-010'
ms:contentKeyID: 61229287
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-010(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS11-010 - 重要
===============================================
...
[](https://www.microsoft.com/japan/security/bulletins/ms11-010e.mspx)[![](../../images/Dn636500.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)

### 概説

#### 要点

このセキュリティ更新プログラムは Windows XP および Windows Server 2003 の Microsoft Windows のクライアント/サーバー ランタイム サブシステム (CSRSS) に存在する 1 件の非公開で報告された脆弱性を解決します。このセキュリティ更新プログラムは、これらのオペレーティングの、すべてのサポートされているエディションについて、深刻度を「重要」と評価しています。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

攻撃者がユーザーのコンピューターにログオンし、脆弱性を悪用してログオフした後も引き続き走り続ける特別に細工されたアプリケーションを実行します。その後、特別に細工されたアプリケーションで次にログオンするユーザーのログオン資格情報を取得することで特権が昇格される可能性があります。攻撃者が有効なログオン資格情報を所持し、ローカルでログオンできた場合、この脆弱性を悪用する可能性があります。リモートで、または匿名ユーザーが、この脆弱性を悪用することはないと思われます。

このセキュリティ更新プログラムは、ログオフ時にユーザー プロセスが終了する方法を修正することにより、この脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。
...
US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS11-010.mspx](https://technet.microsoft.com/security/bulletin/ms11-010)
...
![](../../images/Dn636500.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cfa10178-9859-4e03-bedc-e3f5297a0251&amp;displaylang=ja"><img src="../../images/Dn636500.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9f0b7b77-5b90-4a4b-97a4-0c1ce6a70126&amp;displaylang=ja"><img src="../../images/Dn636500.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-011">MS10-011</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=aed08b96-24cc-4e23-8fd5-c7e52f8ef41a&amp;displaylang=ja"><img src="../../images/Dn636500.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-011">MS10-011</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ca7879e1-e295-445d-a658-0a31be1928cc&amp;displaylang=ja"><img src="../../images/Dn636500.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-011">MS10-011</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=50855101-a15c-4c81-ad81-a7fe3f1d2026&amp;displaylang=ja"><img src="../../images/Dn636500.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-011">MS10-011</a></td>
</tr>
...
<th style="border:1px solid black;" >CSRSS 特権の昇格 Vulnerability - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0030">CVE-2011-0030</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
CSRSS の特権の昇格の脆弱性 - CVE-2011-0030  
------------------------------------------
  
<span></span>
ユーザーがログオフした際に Windows クライアント/サーバー ランタイム サブシステム (CSRSS) がプロセスを終了させる方法に特権の昇格の脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、コンピューターに次にログオンしたユーザーの操作を監視するよう設計されたコードが実行される可能性があります。これにより、機密情報が漏えいするか、または影響を受けるコンピューター上の、ログオンしたユーザーがアクセスできるデータにアクセスされる可能性があります。 この機密情報には、次に使用するユーザーのログオン資格情報が含まれている可能性があり、これを攻撃者が特権の昇格や、後に別のユーザーとしてコンピューターでコードを実行する目的で悪用する可能性があります。この脆弱性が悪用されても、攻撃者自身が直接コードを実行したり、攻撃者自身の権限を昇格することはないと思われます。影響を受けるコンピューターをさらに侵害するために必要な情報を収集するために、この脆弱性が悪用される可能性があります。管理者特権を持つユーザーが次にそのコンピューターにログオンした場合、攻撃者によりカーネル モードで任意のコードが実行される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なシステム権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0030](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0030) をご覧ください。
  
#### 「CSRSS の特権の昇格の脆弱性」の問題を緩和する要素 - CVE-2011-0030:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   攻撃者が有効なログオン資格情報を所持し、ローカルでログオンできた場合、この脆弱性を悪用する可能性があります。リモートで、または匿名ユーザーが、この脆弱性を悪用することはないと思われます。
  
#### 「CSRSS の特権の昇格の脆弱性」の回避策 - CVE-2011-0030:
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「CSRSS の特権の昇格の脆弱性」のよく寄せられる質問 - CVE-2011-0030:
  
どのようなことが起こる可能性がありますか?  
これは、特権の昇格の脆弱性です。攻撃者がこの脆弱性を悪用した場合、影響を受けるコンピューターを完全に制御する可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なシステム権限を持つ新たなアカウントを作成する可能性があります。この脆弱性が悪用されるには、ローカルでコンピュータにログオンし、プログラムを実行できることが攻撃者にとっての必要条件となります。
  
何が原因で起こりますか?  
ユーザーがコンピューターをログオフした際に Windows クライアント/サーバー ランタイム サブシステム (CSRSS) がユーザー プロセスを適切に終了しない場合にこの脆弱性が起こります。
  
クライアント/サーバー ランタイム サブシステムとは何ですか?  
クライアント/サーバー ランタイム サブシステム (CSRSS) とは、Win32 サブシステムのユーザー モードの部分です。CSRSS は、常に実行されている必要のある不可欠なサブシステムです。CSRSS はコンソールのウィンドウ、スレッドの作成および/または削除の役割を担当します。
  
この脆弱性により、攻撃者は何を行う可能性がありますか?  
攻撃者がこの脆弱性を悪用した場合、コンピューターに次にログオンしたユーザーの操作を監視するよう設計されたコードが実行される可能性があります。これにより、機密情報が漏えいするか、または影響を受けるコンピューター上にあるログオンしたユーザーがアクセスできるデータにアクセスされる可能性があります。この機密情報には、特権を昇格する、または別のユーザーのコンピューター上でコードを実行するために後に攻撃者により悪用される可能性のある資格情報が含まれています。この脆弱性によりこの特権の昇格の脆弱性が悪用された場合、コンピューターに次にログオンしたユーザーの特権レベルでコードが実行される可能性があります。管理者がコンピューターにログオンした場合、攻撃者のコードが昇格された特権で実行される可能性があります。
  
攻撃者はこの脆弱性をどのように悪用する可能性がありますか?  
この脆弱性が悪用されるには、まずコンピューターにログオンすることが攻撃者にとっての必要条件です。攻撃者は次に攻撃者のログオフ後に引き続き実行されるよう設計された特別な細工がされたアプリケーションを起動する可能性があります。 新しいユーザーがそのユーザー自身の資格情報でログオンした場合、攻撃者のプロセスが、その新しくログオンしたユーザーが実行したすべての操作を監視する可能性があります。新しくログオンしたユーザーが管理者である場合、漏えいした情報が、影響を受けるコンピューターをさらに侵害する目的で悪用される可能性があります。
  
主にどのようなコンピューターがこの脆弱性による危険にさらされますか?  
複数のユーザーがローカルでログオンし、信頼されないアプリケーションを実行するアクセス権を持つコンピューターがこの脆弱性による危険に最もさらされます。
  
この更新プログラムはどのように問題を修正しますか?  
この更新プログラムは、ログオフ時にユーザー プロセスが終了する方法を修正することにより、この脆弱性を解決します。
...
Windowsxp-KB2476687-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2476687-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB2476687-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB2476687-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB2476687$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB2476687\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB2476687\\Filelist
</td>
</tr>
</table>
...
|------------|---------------|------------|-------|--------|------------|
| Csrsrv.dll | 5.1.2600.6055 | 2010/12/09 | 23:29 | 33,280 | SP3GDR     |
| Csrsrv.dll | 5.1.2600.6055 | 2010/12/09 | 23:28 | 33,280 | SP3QFE     |

サポートされているすべての x64 エディションの Windows XP:

| ファイル名 | バージョン    | 日付       | 時間  | サイズ | CPU | フォルダー |
|------------|---------------|------------|-------|--------|-----|------------|
| Csrsrv.dll | 5.2.3790.4803 | 2010/12/10 | 13:49 | 86,528 | x64 | SP2GDR     |
| Csrsrv.dll | 5.2.3790.4803 | 2010/12/10 | 13:41 | 86,528 | x64 | SP2QFE     |
...
詳細情報は、サポート技術情報[832475](https://support.microsoft.com/kb/832475)をご覧ください。
...
WindowsServer2003-KB2476687-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2476687-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2476687-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB2476687-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2476687\\Filelist
</td>
</tr>
</table>
...
| ファイル名 | バージョン    | 日付       | 時間  | サイズ | フォルダー |
|------------|---------------|------------|-------|--------|------------|
| Csrsrv.dll | 5.2.3790.4803 | 2010/12/10 | 16:58 | 33,792 | SP2GDR     |
| Csrsrv.dll | 5.2.3790.4803 | 2010/12/10 | 17:02 | 33,792 | SP2QFE     |

サポートされているすべての Itanium-based エディションの Windows Server 2003:

| ファイル名 | バージョン    | 日付       | 時間  | サイズ  | CPU   | フォルダー |
|------------|---------------|------------|-------|---------|-------|------------|
| Csrsrv.dll | 5.2.3790.4803 | 2010/12/10 | 13:48 | 134,656 | IA-64 | SP2GDR     |
| Csrsrv.dll | 5.2.3790.4803 | 2010/12/10 | 13:41 | 134,656 | IA-64 | SP2QFE     |
...
-   CSRSS の特権の昇格の脆弱性 [CVE-2011-0030](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0030) を報告してくださった [Peking University の Department of Information Security](https://www.ss.pku.edu.cn/en/) の Sihan Qing 氏 (教授)、Weiping Wen 氏 (准教授)、Liang Yin 氏および Husheng Zhou 氏 (大学院生)
