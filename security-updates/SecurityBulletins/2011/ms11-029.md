...
[](https://www.microsoft.com/japan/security/bulletins/ms11-029e.mspx)[![](../../images/Dn636519.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS11-029.mspx](https://technet.microsoft.com/security/bulletin/ms11-029)
...
(KB2412687)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=59266a9d-a319-4309-a046-7f15c6da0136&amp;displaylang=ja"><img src="../../images/Dn636519.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
(KB2412687)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3797009a-b9a4-4e83-8614-e1589c8b5090&amp;displaylang=ja"><img src="../../images/Dn636519.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
</tr>
...
(KB2412687)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fd284233-e177-4064-9b02-f83dcb727dbe&amp;displaylang=ja"><img src="../../images/Dn636519.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
</tr>
...
(KB2412687)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d5adaf4e-4cd7-42ea-8202-31b5c856f5e3&amp;displaylang=ja"><img src="../../images/Dn636519.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
</tr>
...
(KB2412687)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=72a513bb-f901-4992-8562-d1afe1afec8a&amp;displaylang=ja"><img src="../../images/Dn636519.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
</tr>
...
(KB2412687)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4ff2e440-79c2-4045-b225-913d1740fdb9&amp;displaylang=ja"><img src="../../images/Dn636519.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
</tr>
...
(KB2412687)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4d826026-e62a-4cec-8682-49fbe7f65cd6&amp;displaylang=ja"><img src="../../images/Dn636519.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
</tr>
...
(KB2412687)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fbada866-7d36-4b85-acde-fd856a998737&amp;displaylang=ja"><img src="../../images/Dn636519.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
</tr>
...
(KB2412687)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8f4ddfcb-374d-4cad-8c61-2b988b46f628&amp;displaylang=ja"><img src="../../images/Dn636519.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
</tr>
...
(KB2412687)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2fd71543-0e18-4907-89b9-355d24d7db69&amp;displaylang=ja"><img src="../../images/Dn636519.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
</tr>
...
<td style="border:1px solid black;">
[![](../../images/Dn636519.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6c87c2a9-3705-4680-8a9b-63b6ec83674d&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
このセキュリティ情報で提供している Microsoft Office XP 用のセキュリティ更新プログラム パッケージ (KB2509461) は、セキュリティ情報 [MS11-023](https://technet.microsoft.com/security/bulletin/ms11-023) で説明している脆弱性も解決します。Microsoft Office XP をインストールしているユーザーはこのセキュリティ更新プログラム パッケージを 1 回のみインストールしてください。

**以前に公開された GDI+ のマイクロソフト セキュリティ情報 MS09-062 の「影響を受けるソフトウェア」および「影響を受けないソフトウェア」の一覧のソフトウェアが、このセキュリティ情報にありません。それはなぜですか?**    
このセキュリティ情報に記載されている影響を受けるソフトウェアのテストを行い、影響を受けるバージョンおよびエディションと影響を受けないバージョンおよびエディションを評価しました。[MS09-062](https://technet.microsoft.com/security/bulletin/ms09-062) のセキュリティ情報に記載しているその他のバージョンやエディションは、サポート ライフサイクルの期限が切れているか、または現在サポートされていない Windows 2000 Service Pack 4 にインストールされている場合の GDI+ にのみ該当します。ご使用中のソフトウェアのバージョンまたはエディションのサポート ライフサイクルを確認するためには、[マイクロソフト サポート ライフサイクルの Web サイト](https://support.microsoft.com/gp/lifecycle)をご覧ください。
...
<th style="border:1px solid black;" >
GDI+ の整数オーバーフローの脆弱性 - [CVE-2011-0041](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0041)
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-0041](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0041) をご覧ください。
...
-   **メタファイルの処理を無効にする**
    ...
    [MS07-017](https://technet.microsoft.com/security/bulletin/ms07-017) のセキュリティ更新プログラムを適用されているお客様、Windows Vista または Windows Server 2008 をご使用のお客様はレジストリを変更してメタファイルの処理を無効にすることができます。この設定により、影響を受けるコンピューターを脆弱性の悪用から守る手助けとなります。
...
画像の種類および形式に関する詳細は、サポート技術情報 [320314](https://support.microsoft.com/kb/320314) をご覧ください。これらのファイル形式に関する詳細については、[MSDN ライブラリの Web サイト (英語情報)](https://msdn.microsoft.com/en-us/library/ms536391.aspx) をご覧ください。
...
<td style="border:1px solid black;">
サポート技術情報 [2412687](https://support.microsoft.com/kb/2412687) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
-   GDI+ の整数オーバーフローの脆弱性 [CVE-2011-0041](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0041) を報告してくださった [VUPEN Threat Protection Program](https://www.vupen.com/english/services/tpp-index.php) の Nicolas Joly 氏および Chaouki Bekrar 氏
