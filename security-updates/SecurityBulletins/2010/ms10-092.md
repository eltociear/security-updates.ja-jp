---
TOCTitle: 'MS10-092'
Title: 'マイクロソフト セキュリティ情報 MS10-092 - 重要'
ms:assetid: 'ms10-092'
ms:contentKeyID: 61229263
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-092(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS10-092 - 重要
===============================================

タスク スケジューラの脆弱性により、特権が昇格される (2305420)
-------------------------------------------------------------

公開日: 2010年12月15日 | 最終更新日: 2011年3月3日

**バージョン:** 1.0

[](https://www.microsoft.com/japan/security/bulletins/ms10-092e.mspx)[![](../../images/Dn636476.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)

### 概説

#### 要点

このセキュリティ更新プログラムは 1 件の Windows タスク スケジューラに存在する一般で公開された脆弱性を解決します。この脆弱性により、攻撃者が影響を受けるコンピューターにログオンし、特別に細工されたアプリケーションを実行した場合、特権の昇格が起こる可能性があります。この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーにより、この脆弱性が悪用されることはないと思われます。
...
このセキュリティ更新プログラムは、タスク スケジューラが意図されたユーザーの特権でタスクが実行されることを検証するために整合性のチェックを行う方法を修正することにより、この脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。
...
既知の問題: サポート技術情報 [2305420](https://support.microsoft.com/kb/2305420) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。 また、これらの問題に対する推奨される解決策についても説明しています。

US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS10-092.mspx](https://technet.microsoft.com/security/bulletin/ms10-092)
...
![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム/ソフトウェア                                                                            | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響 | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報 |
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|----------------------------------------------------------|
| Windows Vista Service Pack 1 および Windows Vista Service Pack 2                                                  | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=48f10251-34d8-4149-b4b2-bf3ec28f5846&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2                          | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=099ccc5f-b92f-4d06-bcb5-92e35c49f613&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2\*             | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=bdc9564a-4091-4cde-963a-239513db6c17&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2\*       | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=dff39bfe-0799-4912-ae22-392562178ae6&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Server 2008 for Itanium-based Systems および Windows Server 2008 for Itanium-based Systems Service Pack 2 | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=cf341a35-32ea-4ff7-aca9-1a4683c100ee&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows 7 for 32-bit Systems                                                                                      | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=cf85cdb6-58c7-4144-82f6-f01a6a4f9c3a&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows 7 for x64-based Systems                                                                                   | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=0597018d-39f5-4ca9-b437-63d9e68f264d&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Server 2008 R2 for x64-based Systems\*                                                                    | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=28c832fb-4937-4652-8799-eab6c76d05fb&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Server 2008 R2 for Itanium-based Systems                                                                  | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3ad64d5c-2d81-4ac8-934e-8917b2fcf961&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
...
<th style="border:1px solid black;" >タスク スケジューラの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338">CVE-2010-3338</a></th>
...
タスク スケジューラの脆弱性 - CVE-2010-3338  
-------------------------------------------
  
<span></span>
Windows タスク スケジューラがスケジュールされたタスクが意図されたセキュリティ コンテキストで実行されているかを不適切に検証するため、特権の昇格の脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、ローカル システムのセキュリティ コンテキストで任意のコードが実行される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3338](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) をご覧ください。
  
#### 「タスク スケジューラの脆弱性」の問題を緩和する要素 - CVE-2010-3338:
...
#### 「タスク スケジューラの脆弱性」の回避策 - CVE-2010-3338:
...
-   タスク スケジューラ サービスをオフにする
    ...
    3.  \[スタート\] キーをダブルクリックし、その値を 2 から 4 に変更し、次に \[OK\] をクリックします。  
    4.  レジストリ エディターを終了して、コンピューターを再起動します。
  
    回避策の影響: ユーザーはコンピューターでスケジュールされたタスクを実行できなくなります。
    ...
    2.  以下のレジストリ キーを検索し、クリックします。  
        HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\services\\Schedule  
    3.  \[スタート\] キーをダブルクリックし、その値を 4 から 2 に変更し、次に \[OK\] をクリックします。  
    4.  レジストリ エディターを終了して、コンピューターを再起動します。
  
#### 「タスク スケジューラの脆弱性」のよく寄せられる質問 - CVE-2010-3338:
...
何が原因で起こりますか?  
Windows タスク スケジューラがスケジュールされたタスクが意図されたセキュリティ コンテキストで実行されているかを適切に検証しないことが原因でこの脆弱性が起こり、これにより、ローカルの攻撃者はタスクをシステムまたは管理者アカウントのコンテキストで実行されるようスケジュールできる可能性があります。
  
Windows タスク スケジューラとは何ですか?  
タスク スケジューラとは、選択されたコンピューター上で所定のタスクの自動化を有効にできる Windows サービスです。タスク スケジューラは、タスクを開始するためにユーザーが選択した基準 (トリガーと呼ばれます) を監視し、その基準を満たした場合、自動化を有効にします。詳細情報は、MSDN ライブラリ: [Task Scheduler](https://msdn.microsoft.com/library/aa383614(vs.85).aspx) (英語情報) をご覧ください。
  
この脆弱性により、攻撃者は何を行う可能性がありますか?  
攻撃者がこの脆弱性を悪用した場合、ローカル システムのセキュリティ コンテキストで任意のコードが実行される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
...
この更新プログラムは、タスク スケジューラが意図されたユーザーの特権でタスクが実行されることを検証するために整合性のチェックを行う方法を修正することにより、この脆弱性を解決します。
  
このセキュリティ情報のリリース時に、この脆弱性は一般に公開されていましたか?  
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2010-3338](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) にアサインされています。
...
はい。このセキュリティ更新プログラムは公開された検証用コードにより悪用される可能性のある脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2010-3338](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) に割り当てられています。
...
Windows6.0-KB2305420-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2305420-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Vista:  
Windows6.0-KB2305420-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows Vista:  
Windows6.0-KB2305420-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポート技術情報 [2305420](https://support.microsoft.com/kb/2305420) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
Windows6.0-KB2305420-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2305420-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2305420-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2305420-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows 7:  
Windows6.1-KB2305420-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows 7:  
Windows6.1-KB2305420-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2305420-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2305420-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   「タスク スケジューラの脆弱性」 - [CVE-2010-3338](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) を報告してくださった [Kaspersky Lab](https://www.kaspersky.com/) の Sergey Golovanov 氏、Alexander Gostev氏 、Maxim Golovkin 氏および Alexey Monastyrsky 氏、[Design and Test Lab](https://www.dnt-lab.com/) の Vitaly Kiktenko 氏および Alexander Saprykin 氏
-   「タスク スケジューラの脆弱性」 - [CVE-2010-3338](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) を報告してくださった [Symantec](https://www.symantec.com/index.jsp) の Liam O Morchu 氏
-   「タスク スケジューラの脆弱性」 - [CVE-2010-3338](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) を報告してくださった [ESET](https://www.eset.com/) の Alexandr Matrosov 氏、Eugene Rodionov 氏、Juraj Malcho 氏および David Harley 氏
...
-   2011/03/03: このセキュリティ情報ページを更新し、「概説」の「既知の問題」のセクションに、サポート技術情報 2305420 へのリンクを追加しました。
