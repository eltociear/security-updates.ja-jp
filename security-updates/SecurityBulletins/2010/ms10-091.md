---
TOCTitle: 'MS10-091'
Title: 'マイクロソフト セキュリティ情報 MS10-091 - 緊急'
ms:assetid: 'ms10-091'
ms:contentKeyID: 61229262
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-091(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS10-091 - 緊急
===============================================
...
[](https://www.microsoft.com/japan/security/bulletins/ms10-091e.mspx)[![](../../images/Dn636475.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
このセキュリティ更新プログラムは、すべてのサポートされているエディションの Windows Vista および Windows Server 2008 および Windows 7 および Windows Server 2008 R2 について、深刻度を「緊急」に評価しています。このセキュリティ更新プログラムは、すべてのサポートされているエディションの Windows XP および Windows Server 2003 について深刻度を「重要」に評価しました。 詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

このセキュリティ更新プログラムは、OpenType フォント (OTF) ドライバーが OpenType フォント (OTF) を解析する際の、配列のインデックスの方法、メモリの解放の際のポインターのリセット、および OpenType フォント (OTF) を呼び出す際の CMAP テーブルの解析方法を修正して、この脆弱性を解決します。この脆弱性に関する詳細情報は、次の「脆弱性の情報」のセクションの下の特定の脆弱性のエントリに関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS10-091.mspx](https://technet.microsoft.com/security/bulletin/ms10-091)
...
![](../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cdef3358-ad3e-40a6-9ba5-3be220a56a65&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=070fef8e-ba09-40f4-abaa-9cebf08983c3&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-078">MS10-078</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9b70334c-490d-446c-988a-a88a75595fd4&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-078">MS10-078</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=08328e82-b012-4ea5-bf89-becb4881084f&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-078">MS10-078</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=15588d6a-f576-4e3d-95e8-d422af8a94de&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-078">MS10-078</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2ddb8a06-c9cc-4d33-b6d1-22dbda2d871f&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9a245f3c-ffb6-4ccd-956c-e7d1231fca30&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-037">MS10-037</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=87149ec2-74a8-4dea-b7e3-873558e0103e&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-037">MS10-037</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=523a47d3-771d-471a-889b-16311c276a00&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-037">MS10-037</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=959146ee-0e70-4e56-9012-72ed59aeb24b&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-037">MS10-037</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ff590db8-4264-42ba-9e07-88d100e1c4f5&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-037">MS10-037</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4ea4e339-9db2-4b99-b567-80ee55ecdf92&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-037">MS10-037</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e52f7869-474a-44c8-a102-e766c576fc01&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-037">MS10-037</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a21d061a-794a-4012-b3cd-c67445c074f5&amp;displaylang=ja"><img src="../../images/Dn636475.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-037">MS10-037</a></td>
</tr>
...
<th style="border:1px solid black;" >OpenType フォントのインデックスの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3956">CVE-2010-3956</a></th>
<th style="border:1px solid black;" >OpenType フォントのダブル フリーの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3957">CVE-2010-3957</a></th>
<th style="border:1px solid black;" >OpenType CMAP テーブルの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3959">CVE-2010-3959</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
<span></span>
OpenType フォント (OTF) ドライバーが特別に細工された OpenType フォントを正しく解析しないために、リモートでコードが実行される脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、カーネル モードで任意のコードを実行する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3956](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3956) をご覧ください。
  
#### 「OpenType フォントのインデックスの脆弱性」の問題を緩和する要素 - CVE-2010-3956:
...
#### 「OpenType フォントのインデックスの脆弱性」の回避策 - CVE-2010-3956:
  
回避策は、設定または構成の変更を示しており、基本的な脆弱性を正すものではありませんが、更新プログラムを適用する前に既知の攻撃方法を阻止するのに役立ちます。マイクロソフトは、以下の回避策を検証し、この回避策が機能性を低下させるかどうかについて、説明の部分で述べています。
  
-   **Windows Explorer プレビュー ウィンドウおよび詳細ウィンドウを無効にする**
  
    Windows Explorer のプレビュー ウィンドウおよび詳細ウィンドウを無効にすると、Windows Explorer で OTF フォントが閲覧できません。 これは、Windows Explorer での悪質なファイルの閲覧を防ぐものですが、この脆弱性の悪用を目的として、ローカルの認証済みユーザーが特別に細工したプログラムを実行することを防ぐものではありません。 これらのウィンドウを Windows Vista、Windows Server 2008、Windows 7 および Windows Server 2008 R2で無効にするには、次のステップに従ってください。
  
    1.  Windows Explorer を開き、\[整理\] をクリックして、\[レイアウト\] をクリックします。  
    2.  \[詳細ウィンドウ\] および \[プレビュー ウィンドウ\] のメニュー オプションのチェックを両方はずします。  
    3.  Windows Explorer のすべての開いているインスタンスを閉じて、この変更を有効にします。
...
#### 「OpenType フォントのインデックスの脆弱性」のよく寄せられる質問 - CVE-2010-3956:
...
**何が原因で起こりますか?**  
この脆弱性は、OpenType フォント (OTF) ドライバーが OpenType フォント (OTF) を解析中に、正しく配列をインデックスしないことが原因で起こります。
  
**OpenType フォント形式とは何ですか?**  
OpenType は、マイクロソフトと Adobe が共同で開発したフォント形式で、Apple の TrueType フォント形式を拡張させたものです。OpenType フォント ファイルは、データを含み、テーブルでは、TrueType あるいは PostScript のアウトライン フォントのいずれか一方で構成されています。ラスタライザーは、TrueType または PostScript のグリフのアウトラインを呼び出すために、フォントに含まれているテーブルのデータの組み合わせを使用します。詳細情報は、[Microsoft Typography OpenType FAQ](https://www.microsoft.com/typography/opentypefaq.mspx) (英語情報) をご覧ください。
...
Windows Vista、Windows Server 2008、Windows 7 および Windows Server 2008 R2 では、攻撃者がネットワーク共有で特別に細工した OpenType フォントをホストする可能性があります。それから、ユーザーが Windows Explorer の共有に移動した際に、影響受けるコントロール パスが詳細およびプレビューウィンドウおよび詳細ウィンドウを介してトリガーされます。その後、この特別に細工された OpenType フォントが脆弱性を悪用し、影響を受けるシステムを完全に制御する可能性があります。  
...
はい。サードパーティの Web ブラウザーが、OpenType フォントのみを呼び出した場合、この脆弱性の影響を受けます。これらのアプリケーションについては、この脆弱性は特別に細工された OpenType フォントが埋め込まれた Web サイトの閲覧のために使用された場合、ログオン ユーザーのコンテキストで、リモートでコードが実行される可能性があります。既定で、Internet Explorer はこの脆弱性の影響を受けません。
...
**この脆弱性は Windows XP または Windows Server 2003 でリモートで悪用される可能性がありますか?**  
いいえ。これらのシステムでは、OpenType は Windows Explorer で自動的にプレビューされません。攻撃者がこれらのシステムで脆弱性を悪用するには、まずローカル システムにログオンする必要があります。次に、攻撃者はこの脆弱性を悪用可能な特別に細工したアプリケーションを実行し、影響を受けるコンピューターを完全に制御する可能性があります。
  
**この更新プログラムはどのように問題を修正しますか?**  
この更新プログラムは OpenType フォント (OTF) ドライバーが OpenType フォントを解析する際に、配列をインデックスする方法を修正することにより、この脆弱性を解決します。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3957](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3957) をご覧ください。
  
#### 「OpenType フォントのダブル フリーの脆弱性」の問題を緩和する要素 - CVE-2010-3957:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   Web ベースの攻撃のシナリオでは、攻撃者がこの脆弱性の悪用を意図した Web ページが含まれている Web サイトをホストする可能性があります。さらに、影響を受ける Web サイトおよびユーザー提供のコンテンツまたは広告を許可する、またはホストする Web サイトにこの脆弱性を意図する特別に細工されたコンテンツが含まれる可能性があります。しかし、すべての場合において、攻撃者はユーザーを強制的にこれらの Web サイトに訪問させる方法はありません。それに代わり、攻撃者はユーザーを攻撃者の Web サイトに訪問させようとします。一般的には、ユーザーに電子メール メッセージまたはインスタント メッセンジャーのメッセージのリンクをクリックさせ、攻撃者の Web サイトへ誘導します。
  
#### 「OpenType フォントのダブル フリーの脆弱性」の回避策 - CVE-2010-3957:
...
#### 「OpenType フォントのダブル フリーの脆弱性」のよく寄せられる質問 - CVE-2010-3957:
  
**どのようなことが起こる可能性がありますか?**  
これはリモートでコードが実行される脆弱性です。攻撃者はこの脆弱性を悪用し、影響を受けるコンピューターをリモートで完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
**何が原因で起こりますか?**  
この脆弱性は、OpenType フォント (OTF) ドライバーがメモリの解放の際に、ポインターを正しくリセットしないことが原因で起こります。これにより、「ダブル フリー」の状態が起こります。
...
**この脆弱性は Windows XP または Windows Server 2003 で、リモートで悪用される可能性がありますか?**  
いいえ。これらのシステムでは、OpenType は Windows Explorer で自動的にプレビューされません。攻撃者がこれらのシステムで脆弱性を悪用するには、まずローカル システムにログオンする必要があります。次に、攻撃者はこの脆弱性を悪用可能な特別に細工したアプリケーションを実行し、影響を受けるコンピューターを完全に制御する可能性があります。
  
**この更新プログラムはどのように問題を修正しますか?**  
この更新プログラムは OpenType フォント (OTF) ドライバーが、メモリを解放する際にポインターをリセットする方法を修正することにより、この脆弱性を解決します。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3959](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3959) をご覧ください。
  
#### 「OpenType CMAP テーブルの脆弱性」の問題を緩和する要素 - CVE-2010-3959:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   Web ベースの攻撃のシナリオでは、攻撃者がこの脆弱性の悪用を意図した Web ページが含まれている Web サイトをホストする可能性があります。さらに、影響を受ける Web サイトおよびユーザー提供のコンテンツまたは広告を許可する、またはホストする Web サイトにこの脆弱性を意図する特別に細工されたコンテンツが含まれる可能性があります。しかし、すべての場合において、攻撃者はユーザーを強制的にこれらの Web サイトに訪問させる方法はありません。それに代わり、攻撃者はユーザーを攻撃者の Web サイトに訪問させようとします。一般的には、ユーザーに電子メール メッセージまたはインスタント メッセンジャーのメッセージのリンクをクリックさせ、攻撃者の Web サイトへ誘導します。
  
#### 「OpenType CMAP テーブルの脆弱性」の回避策 - CVE-2010-3959:
...
#### 「OpenType CMAP テーブルの脆弱性」のよく寄せられる質問 - CVE-2010-3959:
  
**どのようなことが起こる可能性がありますか?**  
これはリモートでコードが実行される脆弱性です。攻撃者はこの脆弱性を悪用し、影響を受けるコンピューターをリモートで完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
**何が原因で起こりますか?**  
この脆弱性は、Windows OpenType フォント (OTF) ドライバーが特別に細工された OpenType フォントを呼び出す際に、CMAP を正しく解析しないことが原因で起こります。
...
**サードパーティの Web ブラウザーは、この脆弱性の影響を受けますか？**  
はい。サードパーティの Web ブラウザーが、OpenType フォントのみを呼び出した場合、この脆弱性の影響を受けます。これらのアプリケーションについては、この脆弱性により、特別に細工された OpenType フォントが埋め込まれた Web サイトをユーザーが閲覧した際に、リモートでサービス拒否が起こる可能性があります。既定で、Internet Explorer はこの脆弱性の影響を受けません。
  
**この更新プログラムはどのように問題を修正しますか?**  
この更新プログラムは OpenType フォント (OTF) ドライバーが OpenType フォントを呼び出す際に、CMAP テーブルを解析する方法を修正することにより、この脆弱性を解決します。
  
**CMAP テーブルとは何ですか?**  
このテーブルは、フォントで使用されるグリフ インデックス値に文字コードのマッピングを定義します。一文字以上のエンコーディング スキームをサポートするために、一つ以上のサブテーブルが含まれる場合があります。このテーブル ヘッダーは、サブテーブルが存在している文字のエンコーディングを示します。各サブテーブルは、7 つと想定されるフォーマットのひとつで、使用されているフォーマットを示すフォーマット コードで始まります。詳細情報は、[Character to Glyph Index Mapping Table](https://www.microsoft.com/typography/otspec/cmap.htm) (英語情報) をご覧ください。
...
Windowsxp-KB2296199-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2296199-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB2296199-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB2296199-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB2296199$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB2296199\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB2296199\\Filelist
</td>
</tr>
</table>
...
|------------|------------|------------|-------|---------|------------|
| Atmfd.dll  | 5.1.2.230  | 2010/10/28 | 22:11 | 290,048 | SP3GDR     |
| Atmfd.dll  | 5.1.2.230  | 2010/10/28 | 22:08 | 290,048 | SP3QFE     |

サポートされているすべての x64 エディションの Windows XP:

| ファイル名 | バージョン | 日付       | 時間  | サイズ  | CPU | フォルダー |
|------------|------------|------------|-------|---------|-----|------------|
| Atmfd.dll  | 5.2.2.230  | 2010/10/28 | 18:49 | 452,096 | x64 | SP2GDR     |
| Atmfd.dll  | 5.2.2.230  | 2010/10/28 | 18:45 | 452,096 | x64 | SP2QFE     |
...
WindowsServer2003-KB2296199-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2296199-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2296199-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB2296199-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2296199\\Filelist
</td>
</tr>
</table>
...
| ファイル名 | バージョン | 日付       | 時間  | サイズ  | フォルダー |
|------------|------------|------------|-------|---------|------------|
| Atmfd.dll  | 5.2.2.230  | 2010/10/28 | 21:58 | 286,208 | SP2GDR     |
| Atmfd.dll  | 5.2.2.230  | 2010/10/28 | 22:05 | 286,208 | SP2QFE     |

サポートされているすべての Itanium-based エディションの Windows Server 2003:

| ファイル名 | バージョン | 日付       | 時間  | サイズ  | CPU   | フォルダー |
|------------|------------|------------|-------|---------|-------|------------|
| Atmfd.dll  | 5.2.2.230  | 2010/10/28 | 18:47 | 827,392 | IA-64 | SP2GDR     |
| Atmfd.dll  | 5.2.2.230  | 2010/10/28 | 18:45 | 827,392 | IA-64 | SP2QFE     |
...
Windows6.0-KB2296199-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2296199-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Vista:  
Windows6.0-KB2296199-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows Vista:  
Windows6.0-KB2296199-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポート技術情報 [2296199](https://support.microsoft.com/kb/2296199) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
Windows6.0-KB2296199-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2296199-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2296199-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2296199-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows 7:  
Windows6.1-KB2296199-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows 7:  
Windows6.1-KB2296199-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2296199-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2296199-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   「OpenType フォントのインデックスの脆弱性」 - [CVE-2010-3956](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3956) を報告してくださった [Opera Security Team](https://www.opera.com/security/) と協力している [Red Hat Security Response Team](https://www.redhat.com/security/team/) のMarc Schoenefeld 氏
-   「OpenType フォントのダブル フリーの脆弱性」 - [CVE-2010-3957](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3957) の 問題を報告してくださった Red Hat Security Response Team の Marc Schoenefeld 氏
-   「OpenType CMAP テーブルの脆弱性」 - [CVE-2010-3959](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3959) の 問題を報告してくださった Paul-Kenji Cahier Furuya 氏
