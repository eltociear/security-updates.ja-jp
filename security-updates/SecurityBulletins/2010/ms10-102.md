...
[](https://www.microsoft.com/japan/security/bulletins/ms10-102e.mspx)[![](../../images/Dn636486.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
既知の問題[2345316](https://support.microsoft.com/kb/2345316) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b8c06bbc-6e84-4cf1-89f0-c0d34cfffaed&amp;displaylang=ja"><img src="../../images/Dn636486.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=39b7abc7-65a4-4dfd-92ba-c638e3de1118&amp;displaylang=ja"><img src="../../images/Dn636486.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">サービス拒否</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
この更新プログラムで提供されている特定のバイナリの存在のために、この更新プログラムをアンインストールするには、再起動を2 回する必要があります。更新プログラムのアンインストール後に、二回再起動されなかったシステムは、ネットワーク接続を失う場合があります。この問題に関する詳細情報は、マイクロソフト サポート技術情報 [2345316](https://support.microsoft.com/kb/2345316) をご覧ください。
...
<span></span>
次の深刻度の評価は脆弱性による影響が最大であった場合を前提としています。本セキュリティ情報のリリース後 30 日以内に予想される情報、深刻度およびセキュリティへの影響に関連する脆弱性の悪用に関する情報は、[12 月のセキュリティ情報のサマリ](https://technet.microsoft.com/security/bulletin/ms10-dec)の Exploitability Index をご覧ください。詳細情報は、[Microsoft Exploitability Index (悪用可能性指標)](https://technet.microsoft.com/security/cc998259.aspx) をご覧ください。
...
<th style="border:1px solid black;" >Hyper-V VMBus Vulnerability - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3960">CVE-2010-3960</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3960](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3960) をご覧ください。
...
VMBus とは何ですか？  
VMBus はパーティション間の論理的な通信経路です VMBus および Hyper-V のアーキテクチャに関する詳細情報は、MSDN の記事 [Hyper-V Architecture](https://msdn.microsoft.com/library/cc768520(bts.10).aspx) (英語情報) をご覧ください
...
この更新プログラムをアンインストールするには、ネットワーク接続を失わないために、二回再起動する必要があります。詳細情報は、サポート技術情報 [2345316](https://support.microsoft.com/kb/2345316) をご覧ください。
...
<td style="border:1px solid black;">
サポート技術情報 [2345316](https://support.microsoft.com/kb/2345316) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
-   Hyper-V VMBus の脆弱性 - [CVE-2010-3960](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3960) を報告してくださった [HP](https://www.hp.com/) および [techit](https://www.techit.de/)
