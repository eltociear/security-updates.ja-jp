---
TOCTitle: 'MS10-088'
Title: 'マイクロソフト セキュリティ情報 MS10-088 - 重要'
ms:assetid: 'ms10-088'
ms:contentKeyID: 61229259
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-088(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS10-088 - 重要
===============================================
...
[](https://www.microsoft.com/japan/security/bulletins/ms10-088e.mspx)[![](../../images/Dn636472.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)

### 概説

#### 要点

このセキュリティ更新プログラムは、ユーザーが特別な細工がされた PowerPoint ファイルを開いた場合、リモートでコードが実行される可能性がある非公開で報告された Microsoft PowerPoint に存在する 2 件の脆弱性を解決します。攻撃者がこれらの脆弱性のいずれかを悪用した場合、影響を受けるコンピューターが完全に制御される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。システムで、アカウントのユーザー権限を低く設定している場合、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性の影響が少なくなると考えられます。

このセキュリティ更新プログラムの深刻度はサポートされているエディションの Microsoft PowerPoint 2002、Microsoft PowerPoint 2003、Microsoft Office 2004 for Mac および Microsoft PowerPoint Viewer 2007 Service Pack 2 について「重要」と評価しています。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

この更新プログラムは Microsoft PowerPoint が特別な細工がされた PowerPoint ファイルを解析する方法を変更することにより、これらの脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。

推奨する対応策: マイクロソフトはお客様にできる限り早期にこの更新プログラムを適用することを推奨します。

既知の問題: マイクロソフト サポート技術情報 [2293386](https://support.microsoft.com/kb/2293386) には、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明されています。また、これらの問題に対する推奨される解決策についても説明しています。なお、既知の問題および推奨される解決策がこのソフトウェアの特定のリリースにのみ該当する場合は、サポート技術情報に関連のリンクを掲載します。

US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS10-088.mspx](https://technet.microsoft.com/security/bulletin/ms10-088)
...
![](../../images/Dn636472.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
...
<td style="border:1px solid black;">
[![](../../images/Dn636472.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3efbf9f6-734a-46ac-8f92-87b6ec819bfa&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636472.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=108286d4-fb68-40d6-a7b1-64b3a4eb87ee&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636472.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=df826b79-7398-45de-943c-6f6f0af1b4e3&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<sup>[1]</sup> Microsoft Office 2004 for Mac 用のセキュリティ更新プログラム (KB2505924) は 2011 年 4 月 13 日付けで、利用可能です。「このセキュリティ更新プログラムに関するよく寄せられる質問 (FAQ)」のセクションでは、この更新プログラムの入手方法を説明しています。
...
マイクロソフトはこのセキュリティ情報を更新し、セキュリティ情報 [MS11-021](https://technet.microsoft.com/security/bulletin/ms11-021)、[MS11-022](https://technet.microsoft.com/security/bulletin/ms11-022) および [MS11-023](https://technet.microsoft.com/security/bulletin/ms11-023) で提供している Microsoft Office 2004 for Mac 用のセキュリティ更新プログラム (KB2505924) が、各セキュリティ情報で説明している脆弱性に加え、このセキュリティ情報で説明している脆弱性も解決することをお知らせしました。KB2505924 の更新プログラム パッケージは 3 つの個別のセキュリティ情報で提供していますが、Microsoft Office 2004 for Mac をインストールしているユーザーは、このセキュリティ更新プログラム パッケージを 1 回のみインストールしてください。詳細およびダウンロード リンクは、セキュリティ情報 [MS11-021](https://technet.microsoft.com/security/bulletin/ms11-021)、[MS11-022](https://technet.microsoft.com/security/bulletin/ms11-022) および [MS11-023](https://technet.microsoft.com/security/bulletin/ms11-023) をご覧ください。

なぜこのセキュリティ情報は 2010 年 11 月 18 日に更新されたのですか?  
マイクロソフトはこのセキュリティ情報を更新し、Microsoft PowerPoint 2002 および Microsoft PowerPoint 2003 をご使用のお客様も、[MS10-087](https://technet.microsoft.com/security/bulletin/ms10-087) - Microsoft Office の脆弱性により、リモートでコードが実行される (2423930) - で提供している Microsoft Office の更新プログラムをインストールして、CVE-2010-2573 で説明している脆弱性の防御が必要であることを説明しました。今回の更新は情報のみの変更です。既に MS10-087 および MS10-088 の更新プログラムを正常に適用されたお客様は、措置を講じる必要はありません。

Microsoft Offce 2004 for Mac の更新プログラムはどこにありますか?  
...
Microsoft PowerPoint 2007 を使用しており、これはこのセキュリティ情報で説明されている脆弱性による影響は受けません。この場合でも、なぜこの更新プログラムが提供されるのですか?  
Microsoft PowerPoint 2007 はこのセキュリティ情報で説明している脆弱性による影響は受けませんが、影響を受ける Microsoft PowerPoint Viewer 2007 は Microsoft PowerPoint 2007 に同梱されており、このため、このセキュリティ更新プログラムが提供されます。

PowerPoint Viewer とは何ですか?  
Microsoft PowerPoint Viewer は Microsoft Office 2010 テクノロジをベースにしており、Microsoft PowerPoint Viewer 2007 を置き替えるものです。Microsoft PowerPoint Viewer により、Microsoft PowerPoint 97 およびそれ以降のバージョンで作成されたフル機能を備えたプレゼンテーションを表示できます。Microsoft PowerPoint Viewer はこのセキュリティ情報で説明している脆弱性の影響を受けません。

「プレゼンテーションを CD にパッケージ化する機能」を使用しています。このセキュリティ情報で説明されている脆弱性から、プレゼンテーションが保護されていることはどのように確認できますか?  
このセキュリティ更新プログラムを、影響を受けるソフトウェアに適用した後、サポートされているエディションの Microsoft PowerPoint 2003 および Microsoft PowerPoint 2007 を実行しているお客様は PowerPoint の [プレゼンテーションを CD にパッケージ化する](https://support.microsoft.com/kb/828504) 機能を使用して作成したプレゼンテーションの更新バージョンを使用できます。これはプレゼンテーションに含まれる PowerPoint Viewer をこのセキュリティ情報で説明している脆弱性に対し保護するのに役立ちます。
プレゼンテーションを CD にパッケージ化する機能を使用して作成された Microsoft PowerPoint 2010 プレゼンテーションは PowerPoint Viewer を含んでいません。
...
<th style="border:1px solid black;" >
PowerPoint の解析のバッファー オーバーフローの脆弱性 - [CVE-2010-2572](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2572)
</th>
<th style="border:1px solid black;" >
...
<sup>[1]</sup> For Microsoft PowerPoint 2002 および Microsoft PowerPoint 2003 の場合、お客様は MS10-087 で提供している Microsoft Office の更新プログラムをインストールして、CVE-2010-2573 で説明している脆弱性を防御することが必要です。

PowerPoint の解析のバッファー オーバーフローの脆弱性 - CVE-2010-2572
--------------------------------------------------------------------

<span></span>
Microsoft PowerPoint が特別な細工がされた PowerPoint 95 ファイルを処理する方法にリモートでコードが実行される脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。

Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-2572](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2572) をご覧ください。

#### 「PowerPoint の解析のバッファー オーバーフローの脆弱性」の問題を緩和する要素 - CVE-2010-2572
...
-   Microsoft PowerPoint 2003 Service Pack 3 では PowerPoint 95 ファイルは既定でブロックされます。
    Microsoft Office 2003 Service Pack 3 をインストールした後、ブロックされるファイルの種類に関する詳細情報は、サポート技術情報 [938810](https://support.microsoft.com/kb/938810) をご覧ください。

#### 「PowerPoint の解析のバッファー オーバーフローの脆弱性」の回避策 - CVE-2010-2572
...
-  Microsoft PowerPoint 2002 のユーザーについて、pp7x32.dll へのアクセスを制限する

  注意: これらのファイルの制限を設定するためには、管理者特権が必要です。

  Windows XP および Windows XP Professional x64 Edition

  Windows XP 上の PowerPoint 2002 について、管理者としてコマンド プロンプトから次のコマンドを実行します。
  ```
  cacls "C:\Program Files\Microsoft Office\Office10\Xlators\PP7X32.DLL" /E /P everyone:N
  ```

  Windows XP Professional x64 Edition 上の PowerPoint 2002 について、管理者としてコマンド プロンプトから次のコマンドを実行します。
  ```
  ...
  32-bit エディションの Windows Vista、Windows Server 2008、Windows 7 および Windows Server 2008 R2 上の PowerPoint 2002 について、昇格されたコマンド プロンプトで次のコマンドを実行します。
  ```
  ...
  64-bit エディションの Windows Vista、Windows Server 2008、Windows 7 および Windows Server 2008 R2 上の PowerPoint 2002 について、昇格されたコマンド プロンプトで次のコマンドを実行します。
  ```
  takeown /f "C:\Program Files\Microsoft Office (x86)\Office10\Xlators\PP7X32.DLL"
  ```
  ```
  icacls "C:\Program Files (x86)\Mi``crosoft Office\Office10\Xlators\PP7X32.DLL /save %TEMP%\PP7X32_ACL.TXT"
  ```
  ```
  icacls "C:\Program Files (x86)\Microsoft Office\Office10\Xlators\PP7X32.DLL" /deny everyone:(F)
  ```

  回避策の影響: PowerPoint 95 形式のファイルが開けなくなります。

  回避策の解除方法:

  Windows XP 上の PowerPoint 2002 について、管理者としてコマンド プロンプトから次のコマンドを実行します。

  1. \[スタート\] をクリックし、次に \[ファイル名を指定して実行\] をクリックします。
  2. \[ファイル名を指定して実行\] のボックスに次を入力します。
  ```
   C:\Program Files\Microsoft Office\Office10\Xlators
  ```
  3. PP7X32.DLL を右クリックし、\[プロパティ\] をクリックします。
  4. \[セキュリティ\] タブをクリックします。
    注: \[セキュリティ\] タブが \[プロパティ\] ダイアログ ボックスに表示されていない場合、サポート技術情報 [307874](https://support.microsoft.com/kb/307874) の「簡易ファイル共有の無効化」のステップに従い、\[セキュリティ\] タブを表示してください。
  5. \[詳細設定\] をクリックします。
  6. \[所有者\] タブをクリックします。
  7. \[所有者の変更\] リストから \[管理者\] を選択します。\[OK\] をクリックし、変更を保存します。
...
-  Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から Office 2003 以前のドキュメントを開くことをブロックする
  ...
  Office 2003
  ```
  Window``s Registry Editor Version 5.00
  ```
...
-  未知の、または信頼されないソースからのファイルを開く時、Microsoft Office Isolated Conversion Environment (MOICE) を使用する
  ...
  注意: 自動化された “Microsoft Fix it” ソリューションを使用してこの回避策を有効または無効にするには、サポート技術情報 [935865](https://support.microsoft.com/kb/935865) をご覧ください。
...
#### 「PowerPoint の解析のバッファー オーバーフローの脆弱性」のよく寄せられる質問 - CVE-2010-2572
...
何が原因で起こりますか?
Microsoft PowerPoint が特別な細工がされた PowerPoint 95 ファイルを開く時の PowerPoint のファイル形式を解析する方法のため、この脆弱性が存在します。
...
この脆弱性が悪用されるには、ユーザーが Microsoft PowerPoint の影響を受けるバージョンで、特別に細工された PowerPoint 95 ファイルを開くことが攻撃者にとっての必要条件となります。
...
なぜこの脆弱性は Microsoft PowerPoint 2003 Service Pack 3 で深刻度「警告」と評価されているのですか?
Microsoft PowerPoint 2003 では PowerPoint 95 ファイルは既定でブロックされます。この問題を緩和する要素により、この脆弱性はより低い深刻度「警告」と評価しています。
...
- Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から Office 2003 以前の文書を開くことをブロックする
 ...
 ```
 ```
  [HKEY_CURRENT_USER\Softw``are\Microsoft\Office\11.0\PowerPoint\Security\FileOpenBlock]
 ```
 ```
  "BinaryFiles"=dword:00000001
 ```
...
Microsoft PowerPoint 2007 は、どのようにこの脆弱性の影響を受けますか?
Microsoft PowerPoint 2007 はこのセキュリティ情報で説明している脆弱性による影響は受けませんが、影響を受ける Microsoft PowerPoint Viewer 2007 が Microsoft PowerPoint 2007 に同梱されており、このため、このセキュリティ更新プログラムが提供されます。
...
<span></span>
組織のサーバー、デスクトップ、モバイル コンピューターに適用する必要があるソフトウェアおよびセキュリティ更新プログラムを管理してください。詳細情報は、[更新プログラム管理](https://technet.microsoft.com/updatemanagement/default.aspx)をご覧ください [Microsoft セキュリティ TechCenter](https://technet.microsoft.com/security/default.aspx) では、製品に関するセキュリティ情報を提供しています。

セキュリティ更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) および[Windows Update](https://update.microsoft.com/microsoftupdate/v6/default.aspx?ln=ja) から利用可能です。セキュリティ更新プログラムは[マイクロソフト ダウンロード センター](https://www.microsoft.com/downloads/search.aspx?displaylang=ja)からダウンロードすることができます。「セキュリティ更新プログラム」 のキーワード探索で容易に見つけられます。

最後に、セキュリティ更新プログラムは [Microsoft Update カタログ](https://catalog.update.microsoft.com/v7/site/install.aspx)からダウンロードできます。Microsoft Update カタログは、セキュリティ更新プログラム、ドライバーおよび Service Pack などが含まれるコンテンツを検索するカタログで、Windows Update および Microsoft Update でご利用になれます。セキュリティ情報番号 (例えば「MS07-036」など) を使用して検索することで、バスケットに適用可能な更新プログラムをすべて追加でき (異なる言語の更新プログラムを含む)、選択しているフォルダーにダウンロードできます。「Microsoft Update カタログ」の関連情報を参照するには、[Microsoft Update カタログ「よく寄せられる質問」](https://catalog.update.microsoft.com/v7/site/faq.aspx)をご覧ください。
...
<td style="border:1px solid black;">
officexp-KB2413272-FullFile-JPN /q:a
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
officexp-KB2413272-FullFile-JPN /r:n
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Office XP のすべてのサポートされているバージョン (KB2413272)

| ファイル名 | バージョン | 日付  | 時間 | サイズ |
|--------------|-------------|------------|-------|-----------|
| Powerpnt.exe | 10.0.6858.0 | 2010/10/04 | 13:42 | 6,096,728 |
| Pp7x32.dll | 10.0.6867.0 | 2010/10/04 | 13:43 | 108,368 |
...
注: これらのスイッチを 1 つのコマンドに組み込むことができます。旧バージョンとの互換性のため、このセキュリティ更新プログラムは、以前のバージョンのセットアップ プログラムが使用しているセットアップ スイッチもサポートしています。サポートされるインストール スイッチに関する詳細は、サポート技術情報 [262841](https://support.microsoft.com/kb/262841) をご覧ください。
...
<td style="border:1px solid black;">
office2003-KB2413304-FullFile-JPN /q:a
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
office2003-KB2413304-FullFile-JPN /r:n
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Office 2003 のすべてのサポートされているバージョン (KB2413304)

| ファイル名 | バージョン | 日付  | 時間 | サイズ |
|--------------|-------------|------------|-------|-----------|
| Powerpnt.exe | 11.0.8324.0 | 2010/04/17 | 00:14 | 6,418,776 |
| Pp7x32.dll | 11.0.8329.0 | 2010/09/30 | 12:50 | 94,544 |
...
#### PowerPoint Viewer 2007 (すべてのエディション)
...
<td style="border:1px solid black;">
powerpoint2007-kb2413381-fullfile-x86-glb /passive
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
powerpoint2007-kb2413381-fullfile-x86-glb /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポート技術情報 [2413381](https://support.microsoft.com/kb/2413381) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
- 「PowerPoint の解析のバッファー オーバーフローの脆弱性 - [CVE-2010-2572](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2572)」を報告してくださった [Secunia Research](https://secunia.com/) の Alin Rad Pop 氏
...
- 2010/11/10: このセキュリティ情報を更新し、影響を受けるバージョンを "Microsoft PowerPoint Viewer" から "Microsoft PowerPoint Viewer 2007 Service Pack 2" に修正しました。今回の更新は情報のみの変更です。自動更新を有効にしているお客様など、すでにコンピューターを更新済みのお客様は特別な措置を講じる必要はありません。この更新プログラムを以前にインストールしていないお客様は、更新後の「影響を受けるソフトウェア」の一覧を基に、この更新プログラムがシステムに必要であるかどうかを確認する必要があります。
- 2010/11/18: マイクロソフトはこのセキュリティ情報を更新し、Microsoft PowerPoint 2002 および Microsoft PowerPoint 2003 について、お客様は MS10-087 で提供している Microsoft Office の更新プログラムをインストールして、CVE-2010-2573 で説明している脆弱性を防御することが必要であると説明しました。今回の更新は情報のみの変更です。既に MS10-087 および MS10-088 の更新プログラムを正常に適用されたお客様は、措置を講じる必要はありません。
