---
TOCTitle: 'MS10-052'
Title: 'マイクロソフト セキュリティ情報 MS10-052 - 緊急'
ms:assetid: 'ms10-052'
ms:contentKeyID: 61229223
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-052(v=Security.10)'
---


マイクロソフト セキュリティ情報 MS10-052 - 緊急
===============================================
...
[](https://www.microsoft.com/japan/security/bulletins/ms10-052e.mspx)[![](../../images/Dn636435.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
このセキュリティ更新プログラムは、すべてのサポートされているエディションの Windows XP および Windows Server 2003 (サポートされている Itanium-based エディションは除く) について「緊急」の深刻度に評価しました。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

このセキュリティ更新プログラムは、Microsoft MPEG Layer-3 のオーディオ コーデックが、特別に細工されたメディア ファイルの MPEG Layer-3 オーディオ ストリームを処理する方法を修正して、この脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。
...
US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS10-052.mspx](https://technet.microsoft.com/security/bulletin/ms10-052)
...
![](../../images/Dn636435.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム                          | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響       | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報 |
|----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Windows XP Service Pack 3                          | [![](../../images/Dn636435.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=08159149-17de-4640-8818-cb7bd4811531&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows XP Professional x64 Edition Service Pack 2 | [![](../../images/Dn636435.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b7f28d7a-6b27-4059-865b-5fd55edb6299&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Server 2003 Service Pack 2                 | [![](../../images/Dn636435.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=9c2110ec-7e6c-4e73-9785-0a8196095ea0&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Server 2003 x64 Edition Service Pack 2     | [![](../../images/Dn636435.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=fdfad4ca-37c4-4ac5-bebc-a5ad61299503&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
...
<th style="border:1px solid black;" >MPEG Layer-3 オーディオ デコーダーのバッファー オーバーフローの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1882">CVE-2010-1882</a></th>
...
MPEG Layer-3 オーディオ デコーダーのバッファー オーバーフローの脆弱性 - CVE-2010-1882  
-------------------------------------------------------------------------------------
  
Microsoft DirectShow MP3 フィルターがサポートされているフォーマット ファイルを処理する方法に、リモートでコードが実行される脆弱性が存在します。この脆弱性は、特別に細工されたオーディオ ファイルをユーザーが開いた場合に、コードが実行される可能性があります。ユーザーが管理者ユーザー権限でログオンしている場合、攻撃者はこの脆弱性を悪用して、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。システムで、アカウントのユーザー権限を低く設定している場合、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性の影響が少なくなると考えられます。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-1882](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1882) をご覧ください。
  
#### 「MPEG Layer-3 オーディオ デコーダーのバッファー オーバーフローの脆弱性」の問題を緩和する要素 - CVE-2010-1882:
...
#### 「MPEG Layer-3 オーディオ デコーダーのバッファー オーバーフローの脆弱性」の回避策 - CVE-2010-1882:
  
回避策は、設定または構成の変更を示しており、基本的な脆弱性を正すものではありませんが、更新プログラムを適用する前に既知の攻撃方法を阻止するのに役立ちます。マイクロソフトは、以下の回避策を検証し、この回避策が機能性を低下させるかどうかについて、説明の部分で述べています。
  
-   l3codecx.ax の登録を解除する
  
    Windows XP および Windows Server 2003 コンピューターで、コマンド プロンプトから次のコマンドを実行します。
    ...
    DirectShow を使用して MPEG Layer-3 コンテンツを再生するアプリケーションで、MPEG Layer-3 解析が無効になります。
...
-   DirectShow で MPEG Layer-3 解析を無効にする
  
    下記に指定されているレジストリ キーを削除すると、DirectShow を使用して MPEG Layer-3 コンテンツを再生しているアプリケーションで MPEG Layer-3 解析が機能しなくなります。
    ...
    4.  \[レジストリ ファイルのエクスポート\] ダイアログ ボックスに MP3\_Parser\_Backup.reg と入力し、\[保存\] をクリックします。
    ...
    3.  \[ファイル\] メニューの \[エクスポート\] をクリックします。  
    4.  \[レジストリ ファイルのエクスポート\] ダイアログ ボックスに MP3\_Parser\_Backup1.reg と入力し、\[保存\] をクリックします。
    ...
    9.  \[レジストリ ファイルのエクスポート\] ダイアログ ボックスに MP3\_Parser\_Backup 2.reg と入力し、\[保存\] をクリックします。
    ...
    1.  次のコマンドが含まれている管理された適用スクリプトを使用して、レジストリ キーのバックアップ コピーを作成します。
        ...
        Regedit.exe /e MP3\_Parser\_Backup.reg HKEY\_CLASSES\_ROOT\\CLSID\\{38BE3000-DBF4-11D0-860E-00A024CFEF6D}
  
        64 ビットの Windows システム
  
        Regedit.exe /e MP3\_Parser\_Backup.reg HKEY\_CLASSES\_ROOT\\Wow6432Node\\CLSID\\{38BE3000-DBF4-11D0-860E-00A024CFEF6D}
  
    2.  次に Disable\_MP3\_Parser.reg のように REG. 拡張子を持つファイルに次を保存します。
    ...
    3.  \[レジストリ ファイルのインポート\] ダイアログ ボックスで MP3\_Parser\_Backup.reg を選択し、\[開く\] をクリックします。
  
    64 bit Windows システム
  
    1.  \[スタート\] メニューをクリックして \[ファイル名を指定して実行\] をクリックします。次に、\[名前\] ボックスに「Regedit」と入力して、\[OK\] をクリックします。  
    2.  \[ファイル\] メニューをクリックして、\[インポート\] を選択します。  
    3.  \[レジストリ ファイルのインポート\] ダイアログ ボックスで MP3\_Parser\_Backup1.reg を選択し、\[開く\] をクリックします。  
    4.  \[レジストリ ファイルのインポート\] ダイアログ ボックスで MP3\_Parser\_Backup2.reg を選択し、\[開く\] をクリックします。
...
#### 「MPEG Layer-3 オーディオ デコーダーのバッファー オーバーフローの脆弱性」のよく寄せられる質問 - CVE-2010-1882:
...
影響を受ける MPEG Layer-3 オーディオ コーデックとは、Microsoft DirectShow 用の MPEG Layer-3 オーディオ コーデック (l3codecx.ax) です。この MPEG Layer-3 オーディオ コーデックは Windows Media の一部として、また Windows オペレーティング システムの一部として提供されています。
...
Windowsxp-KB2115168-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2115168-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB2115168-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB2115168-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB2115168$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB2115168\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB2115168\\Filelist
</td>
</tr>
</table>
...
|-------------|------------|------------|-------|---------|------------|
| L3codecx.ax | 1.6.0.52   | 2010/06/16 | 01:16 | 143,422 | SP3GDR     |
| L3codecx.ax | 1.6.0.52   | 2010/06/16 | 01:11 | 143,422 | SP3QFE     |

サポートされているすべての x64 エディションの Windows XP:

| ファイル名   | バージョン | 日付       | 時間  | サイズ  | CPU | フォルダー  |
|--------------|------------|------------|-------|---------|-----|-------------|
| Wl3codecx.ax | 1.6.0.52   | 2010/06/15 | 09:27 | 143,422 |     | SP2GDR\\WOW |
| Wl3codecx.ax | 1.6.0.52   | 2010/06/14 | 22:41 | 143,422 |     | SP2QFE\\WOW |
...
WindowsServer2003-KB2115168-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2115168-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2115168\\Filelist
</td>
</tr>
</table>
...
| ファイル名  | バージョン | 日付       | 時間  | サイズ  | フォルダー |
|-------------|------------|------------|-------|---------|------------|
| L3codecx.ax | 1.6.0.52   | 2010/06/15 | 14:26 | 143,422 | SP2GDR     |
| L3codecx.ax | 1.6.0.52   | 2010/06/15 | 14:31 | 143,422 | SP2QFE     |
...
-   「MPEG Layer-3 オーディオ デコーダーのバッファー オーバーフローの脆弱性」 - [CVE-2010-1882](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1882) を報告してくださった [TippingPoint](https://www.tippingpoint.com/) の [Zero Day Initiative](https://www.zerodayinitiative.com/) に協力している n.runs AG の Moritz Jodeit 氏
