...
[](https://www.microsoft.com/japan/security/bulletins/ms10-100e.mspx)[![](../../images/Dn636484.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS10-100.mspx](https://technet.microsoft.com/security/bulletin/ms10-100)
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=85265a23-5094-4007-8d33-f402cabd1664&amp;amp;displaylang=ja"><img src="../../images/Dn636484.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=63c7257a-16bf-4108-80b9-9dfe53528348&amp;amp;displaylang=ja"><img src="../../images/Dn636484.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=14e079a8-01a4-47c9-bd47-f5c9a6ca070a&amp;amp;displaylang=ja"><img src="../../images/Dn636484.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6baf92b7-a336-45f2-a1ba-c00c34dfb76f&amp;amp;displaylang=ja"><img src="../../images/Dn636484.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7a4b23d4-f68e-4d5b-8814-d9247145f164&amp;amp;displaylang=ja"><img src="../../images/Dn636484.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f7c7d57a-d031-46a3-9613-eae2b9cb6401&amp;amp;displaylang=ja"><img src="../../images/Dn636484.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e52c36f5-637b-4928-83d0-27514c6cc384&amp;amp;displaylang=ja"><img src="../../images/Dn636484.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b823a7aa-0eb9-42dd-bf56-8907d94b314a&amp;amp;displaylang=ja"><img src="../../images/Dn636484.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=66b2506d-80e0-4e32-86e6-0908ef56ae90&amp;amp;displaylang=ja"><img src="../../images/Dn636484.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<th style="border:1px solid black;" >承認 UI のなりすましの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3961">CVE-2010-3961</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3961](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3961) をご覧ください。
...
承認 UI とはユーザーアカウント コントロール (UAC) の一部です。UAC を完全に有効にすると、対話型な管理者は通常、最小限のユーザー特権で実行しますが、管理者は承認 UI で明示的な許可を与えることにより自分自身で特権を昇格し管理タスクを実行することができます。このような管理タスクには、ソフトウェアやドライバーのインストール、システム全体の設定の変更、その他のユーザー アカウントの変更、管理ツールの実行などがあります。詳細情報は、MSDN コラム: [ユーザー アカウント制御](https://msdn.microsoft.com/ja-jp/library/aa511445.aspx)をご覧ください。
  
SeImpersonatePrivilege とは何ですか?  
SeImpersonatePrivilege または「認証後にクライアントを偽装」するユーザー権限とは、最初に Microsoft Windows 2000 Service Pack 4 で導入されたセキュリティ設定です。 既定で、デバイスのローカル管理者グループおよびデバイスの LocalService アカウントのメンバーにこのユーザー権限が割り当てられます。SeImpersonatePrivilege 設定は、サポート技術情報 [821546](https://support.microsoft.com/kb/821546) で説明されています。
...
<td style="border:1px solid black;">
サポート技術情報 [2442962](https://support.microsoft.com/kb/2442962) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
-   「承認 UI のなりすましの脆弱性」 - [CVE-2010-3961](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3961) の 問題を報告してくださった [Argeniss](https://www.argeniss.com/) の Cesar Cerrudo 氏
