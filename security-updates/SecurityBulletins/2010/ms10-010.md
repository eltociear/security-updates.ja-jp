...
[](https://www.microsoft.com/japan/security/bulletins/ms10-010e.mspx)[![](../../images/Dn627167.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS10-010.mspx](https://technet.microsoft.com/security/bulletin/ms10-010)
...
|-------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|----------------------------------------------------------|
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2\* | [![](../../images/Dn627167.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3463a63c-e88a-4036-ab60-f84d4bf4191a&displaylang=ja) | サービス拒否           | 重要           | なし                                                     |
| Windows Server 2008 R2 for x64-based Systems\*                                                              | [![](../../images/Dn627167.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3214b347-d901-4aac-85ce-676e4602de87&displaylang=ja) | サービス拒否           | 重要           | なし                                                     |
...
<th style="border:1px solid black;" >Hyper-V のインストラクション セットの検証の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0026">CVE-2010-0026</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-0026](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0026) をご覧ください。
...
-   「Hyper-V のインストラクション セットの検証の脆弱性」- [CVE-2010-0026](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0026) の 問題を報告してくださった Jan Bottorff 氏
