---
TOCTitle: 'MS10-067'
Title: 'マイクロソフト セキュリティ情報 MS10-067 - 重要'
ms:assetid: 'ms10-067'
ms:contentKeyID: 61229238
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-067(v=Security.10)'
---


マイクロソフト セキュリティ情報 MS10-067 - 重要
===============================================
...
[](https://www.microsoft.com/japan/security/bulletins/ms10-067e.mspx)[![](../../images/Dn636451.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS10-067.mspx](https://technet.microsoft.com/security/bulletin/ms10-067)
...
![](../../images/Dn636451.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム                              | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響       | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報 |
|--------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Windows XP Service Pack 3                              | [![](../../images/Dn636451.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=fc4369ec-864a-42ae-a850-b006872241fe&displaylang=ja) | リモートでコードが実行される | 重要           | なし                                                     |
| Windows XP Professional x64 Edition Service Pack 2     | [![](../../images/Dn636451.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=7567986a-261d-4def-9fa5-c667994c7844&displaylang=ja) | リモートでコードが実行される | 重要           | なし                                                     |
| Windows Server 2003 Service Pack 2                     | [![](../../images/Dn636451.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3290e7ee-1e4a-464c-abfd-17fc4108601e&displaylang=ja) | リモートでコードが実行される | 重要           | なし                                                     |
| Windows Server 2003 x64 Edition Service Pack 2         | [![](../../images/Dn636451.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b21570cc-4f90-4ed8-b901-a34584d44a63&displaylang=ja) | リモートでコードが実行される | 重要           | なし                                                     |
| Windows Server 2003 with SP2 for Itanium-based Systems | [![](../../images/Dn636451.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c9c4427d-54c8-4f3c-9a94-818196cd5180&displaylang=ja) | リモートでコードが実行される | 重要           | なし                                                     |
...
<th style="border:1px solid black;" >ワードパッドの Word 97 テキスト コンバーターのメモリ破損の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2563">CVE-2010-2563</a></th>
...
ワードパッドの Word 97 テキスト コンバーターのメモリ破損の脆弱性 - CVE-2010-2563  
--------------------------------------------------------------------------------
  
Microsoft ワードパッドが特別に細工された Word 97 文書を解析する際のメモリを処理する方法に、リモートでコードが実行される脆弱性が存在します。この脆弱性は、不正な形式の値を含む特別な細工がされた Word ファイルをユーザーが開いた場合にリモートでコードが実行される可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-2563](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2563) をご覧ください。
  
#### 「ワードパッドの Word 97 テキスト コンバーターのメモリ破損の脆弱性」の問題を緩和する要素 - CVE-2010-2563:
...
#### 「ワードパッドの Word 97 テキスト コンバーターのメモリ破損の脆弱性」の回避策 - CVE-2010-2563:
...
-   コンバーター ファイルへのアクセスを制限することにより、ワードパッド Word 97 テキスト コンバーターを無効にする
    ...
    注: このセキュリティ更新プログラムをインストールする前に、この回避策を解除してください。
...
#### 「ワードパッドの Word 97 テキスト コンバーターのメモリ破損の脆弱性」のよく寄せられる質問 - CVE-2010-2563:
...
何が原因で起こりますか?  
この脆弱性はワードパッドのテキスト コンバーターが Word 97 の文書の特定のフィールドを正しく解析しない場合に起こります。
...
電子メールの攻撃シナリオでは、攻撃者は特別に細工した Word 97 ファイルをユーザーに送信し、そのファイルを開くよう誘導することにより、この脆弱性を悪用する可能性があります。  
Web ベースの攻撃のシナリオでは、この脆弱性の悪用を意図した Word 97 文書が含まれる Web サイトをホストしていることが攻撃者にとっての必要条件となります。さらに、侵害された Web サイトやユーザー提供のコンテンツを受け入れる、またはホストする Web サイトには、特別に細工したコンテンツが含まれており、この脆弱性が悪用される可能性があります。攻撃者は、特別に細工した Web サイトにユーザーを強制的に訪問させることはできないと考えられます。その代わり、通常、ユーザーに攻撃者の Web サイトへのリンクをクリックさせ、その Web サイトにユーザーを誘導することが攻撃者にとっての必要条件となります。このユーザーに、メッセージが表示され、文書の表示を手動で承諾する必要があります。
  
主にどのようなコンピューターがこの脆弱性による危険にさらされますか?  
ワークステーションやターミナル サーバーなど、信頼されないソースからの Word 文書を開くためにワードパッドを使用する、影響を受けるシステムが主にこの脆弱性の危険にさらされます。管理者がユーザーにサーバーへのログオンおよびプログラムの実行を許可している場合、サーバーが影響を受ける可能性が高くなります。しかし、セキュリティ上の最善策として、これを許可しないことを強く推奨しています。Microsoft Word をインストールしているシステムは通常、既定でワードパッドの代わりに Microsoft Office で Word 文書を表示します。
...
Windowsxp-KB2259922-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2259922-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB2259922-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB2259922-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB2259922$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB2259922\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB2259922\\Filelist
</td>
</tr>
</table>
...
|------------|--------------|------------|-------|---------|------------|
| Mswrd8.wpc | 2010.6.31.10 | 2010/06/28 | 15:57 | 277,504 | SP3GDR     |
| Mswrd8.wpc | 2010.6.31.10 | 2010/06/28 | 15:53 | 277,504 | SP3QFE     |

サポートされているすべての x64 エディションの Windows XP:

| ファイル名  | バージョン   | 日付       | 時間  | サイズ  | CPU | フォルダー  |
|-------------|--------------|------------|-------|---------|-----|-------------|
| Mswrd8.wpc  | 2010.6.31.10 | 2010/07/05 | 15:36 | 381,440 | x64 | SP2GDR      |
| Wmswrd8.wpc | 2010.6.31.10 | 2010/07/05 | 15:36 | 277,504 | x86 | SP2GDR\\WOW |
| Mswrd8.wpc  | 2010.6.31.10 | 2010/07/05 | 15:31 | 381,440 | x64 | SP2QFE      |
| Wmswrd8.wpc | 2010.6.31.10 | 2010/07/05 | 15:31 | 277,504 | x86 | SP2QFE\\WOW |
...
WindowsServer2003-KB2259922-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2259922-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2259922-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB2259922-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2259922\\Filelist
</td>
</tr>
</table>
...
| ファイル名 | バージョン   | 日付       | 時間  | サイズ  | フォルダー |
|------------|--------------|------------|-------|---------|------------|
| Mswrd8.wpc | 2010.6.31.10 | 2010/07/05 | 18:06 | 277,504 | SP2GDR     |
| Mswrd8.wpc | 2010.6.31.10 | 2010/07/05 | 18:24 | 277,504 | SP2QFE     |

サポートされているすべての Itanium-based エディションの Windows Server 2003:

| ファイル名   | バージョン   | 日付       | 時間  | サイズ  | CPU  | フォルダー  |
|--------------|--------------|------------|-------|---------|------|-------------|
| Mswrd8.wpc   | 2010.6.31.10 | 2010/07/05 | 15:32 | 731,136 | ia64 | SP2GDR      |
| Mswrd864.wpc | 2010.6.31.10 | 2010/07/05 | 15:32 | 733,184 | ia64 | SP2GDR      |
| Wmswrd8.wpc  | 2010.6.31.10 | 2010/07/05 | 15:32 | 277,504 | x86  | SP2GDR\\WOW |
| Mswrd8.wpc   | 2010.6.31.10 | 2010/07/05 | 15:29 | 731,136 | ia64 | SP2QFE      |
| Mswrd864.wpc | 2010.6.31.10 | 2010/07/05 | 15:29 | 733,184 | ia64 | SP2QFE      |
| Wmswrd8.wpc  | 2010.6.31.10 | 2010/07/05 | 15:29 | 277,504 | x86  | SP2QFE\\WOW |
...
-   「ワードパッドの Word 97 テキスト コンバーターのメモリ破損の脆弱性」 - [CVE-2010-2563](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2563) の 問題を報告してくださった [iDefense Labs](https://labs.idefense.com/) の S0lute 氏
