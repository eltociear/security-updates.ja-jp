---
TOCTitle: 'MS10-069'
Title: 'マイクロソフト セキュリティ情報 MS10-069 - 重要'
ms:assetid: 'ms10-069'
ms:contentKeyID: 61229240
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-069(v=Security.10)'
---


マイクロソフト セキュリティ情報 MS10-069 - 重要
===============================================
...
[](https://www.microsoft.com/japan/security/bulletins/ms10-069e.mspx)[![](../../images/Dn636453.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS10-069.mspx](https://technet.microsoft.com/security/bulletin/ms10-069)
...
![](../../images/Dn636453.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム                              | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響 | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報            |
|--------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|---------------------------------------------------------------------|
| Windows XP Service Pack 3                              | [![](../../images/Dn636453.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=20091358-7127-4ace-bf96-4319461ad305&displaylang=ja) | 特権の昇格             | 重要           | なし                                                                |
| Windows XP Professional x64 Edition Service Pack 2     | [![](../../images/Dn636453.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=107eb958-b60f-40ae-a785-5d5b4d13d8c6&displaylang=ja) | 特権の昇格             | 重要           | [MS07-021](https://technet.microsoft.com/security/bulletin/ms07-021) |
| Windows Server 2003 Service Pack 2                     | [![](../../images/Dn636453.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=fd46ba66-8ca1-4aa2-b91b-9e5861a173f7&displaylang=ja) | 特権の昇格             | 重要           | [MS07-021](https://technet.microsoft.com/security/bulletin/ms07-021) |
| Windows Server 2003 x64 Edition Service Pack 2         | [![](../../images/Dn636453.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ff5976e0-579c-4e6e-a225-c0d3913cdc85&displaylang=ja) | 特権の昇格             | 重要           | [MS07-021](https://technet.microsoft.com/security/bulletin/ms07-021) |
| Windows Server 2003 with SP2 for Itanium-based Systems | [![](../../images/Dn636453.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e450ca08-1d75-4419-ad9f-c5e5efb55cd5&displaylang=ja) | 特権の昇格             | 重要           | [MS07-021](https://technet.microsoft.com/security/bulletin/ms07-021) |
...
中国語、日本語、または韓国語バージョンの Windows を使用していません。この場合でも、このセキュリティ情報は該当しますか?  
影響を受けるオペレーティング システムのすべての言語エディションに、このセキュリティ情報で解決している脆弱性が含まれていますが、コンピューターが中国語、日本語または韓国語のシステム ロケールで構成されていなければ、この脆弱性が悪用されることはありません。
...
<th style="border:1px solid black;" >CSRSS のローカルの特権の昇格の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1891">CVE-2010-1891</a></th>
...
CSRSS のローカルの特権の昇格の脆弱性 - CVE-2010-1891  
----------------------------------------------------
  
CSRSS が特定のユーザー トランザクションにメモリを割り当てる方法が原因で Windows CSRSS に特権の昇格の脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、ローカル システムのセキュリティ コンテキストで任意のコードが実行される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-1891](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1891) をご覧ください。
  
#### 「CSRSS のローカルの特権の昇格の脆弱性」の問題を緩和する要素 - CVE-2010-1891:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   中国語、日本語または韓国語のシステム ロケールで構成されているコンピューターのみがこの脆弱性の影響を受けます。  
-   この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルまたはリモートでログオンできることが攻撃者にとっての必要条件となります。
  
#### 「CSRSS のローカルの特権の昇格の脆弱性」の回避策 - CVE-2010-1891:
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「CSRSS のローカルの特権の昇格の脆弱性」のよく寄せられる質問 - CVE-2010-1891:
...
何が原因で起こりますか?  
Windows CSRSS は、中国語、日本語または韓国語のシステム ロケールで構成されている Windows コンピューター上で特定のユーザー トランザクションを処理する時に、常に十分なメモリを割り当てるとは限らないため、この脆弱性が起こります。
  
Windows クライアント/サーバー ランタイム サブシステム (CSRSS) とは何ですか?  
CSRSS とは、Win32 サブシステムのユーザー モードの一部です。(カーネル モードの部分は Win32.sys です。) CSRSS とは Client/Server Runtime Subsystem の略で、常に実行されていなければならない重要なサブシステムです。CSRSS はコンソールのウィンドウ、スレッドの作成および/または削除の役割を担当します。
...
マルチバイト言語 (中国語、日本語または韓国語) のシステム ロケールで実行されているワークステーションおよびターミナル サーバーが主にこの脆弱性の危険にさらされます。管理者がユーザーにサーバーへのログオンおよびプログラムの実行を許可している場合、サーバーが影響を受ける可能性が高くなります。しかし、セキュリティ上の最善策として、これを許可しないことを強く推奨しています。
...
この更新プログラムは、CSRSS が特定のトランザクションを処理する時にメモリを割り当てる方法を修正することにより、この脆弱性を解決します。
  
このセキュリティ情報のリリース時に、この脆弱性は一般に公開されていましたか?  
いいえ。マイクロソフトは協調的な脆弱性の公開により、この脆弱性に関する情報を受けました。マイクロソフトは、このセキュリティ情報が最初に公開された際に、この脆弱性が一般に知られていたという情報は受けていませんでした。
...
Windowsxp-KB2121546-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2121546-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB2121546-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB2121546-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB2121546$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB2121546\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB2121546\\Filelist
</td>
</tr>
</table>
...
|------------|---------------|------------|-------|---------|------------|
| Winsrv.dll | 5.1.2600.6001 | 2010/06/19 | 02:44 | 330,752 | SP3GDR     |
| Winsrv.dll | 5.1.2600.6001 | 2010/06/19 | 02:43 | 330,752 | SP3QFE     |

サポートされているすべての x64 エディションの Windows XP:

| ファイル名 | バージョン    | 日付       | 時間  | サイズ  | CPU | フォルダー |
|------------|---------------|------------|-------|---------|-----|------------|
| Winsrv.dll | 5.2.3790.4729 | 2010/06/21 | 13:16 | 550,400 | x64 | SP2GDR     |
| Winsrv.dll | 5.2.3790.4729 | 2010/06/21 | 13:04 | 551,424 | x64 | SP2QFE     |
...
WindowsServer2003-KB2121546-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2121546-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2121546-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB2121546-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2121546\\Filelist
</td>
</tr>
</table>
...
| ファイル名 | バージョン    | 日付       | 時間  | サイズ  | フォルダー |
|------------|---------------|------------|-------|---------|------------|
| Winsrv.dll | 5.2.3790.4729 | 2010/06/21 | 14:48 | 338,944 | SP2GDR     |
| Winsrv.dll | 5.2.3790.4729 | 2010/06/21 | 15:11 | 339,456 | SP2QFE     |

サポートされているすべての Itanium-based エディションの Windows Server 2003:

| ファイル名 | バージョン    | 日付       | 時間  | サイズ  | CPU   | フォルダー |
|------------|---------------|------------|-------|---------|-------|------------|
| Winsrv.dll | 5.2.3790.4729 | 2010/06/21 | 12:56 | 856,576 | IA-64 | SP2GDR     |
| Winsrv.dll | 5.2.3790.4729 | 2010/06/21 | 12:52 | 858,112 | IA-64 | SP2QFE     |
...
-   「CSRSS のローカルの特権の昇格の脆弱性」 - [CVE-2010-1891](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1891) の 問題を報告してくださった [日本 IBM](https://www.ibm.com/jp/ja/)
