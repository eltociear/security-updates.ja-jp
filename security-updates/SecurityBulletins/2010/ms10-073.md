---
TOCTitle: 'MS10-073'
Title: 'マイクロソフト セキュリティ情報 MS10-073 - 重要'
ms:assetid: 'ms10-073'
ms:contentKeyID: 61229244
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-073(v=Security.10)'
---


マイクロソフト セキュリティ情報 MS10-073 - 重要
===============================================
...
[](https://www.microsoft.com/japan/security/bulletins/ms10-073e.mspx)[![](../../images/Dn636457.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)

### 概説

#### 要点

このセキュリティ更新プログラムは、一般に公開された数件の Windows カーネル モード ドライバーの脆弱性を解決します。最も深刻な脆弱性では、攻撃者が影響を受けるコンピューターにログオンし、特別な細工がされたアプリケーションを実行した場合、特権が昇格される可能性があります。この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーにより、この脆弱性が悪用されることはないと思われます。
...
このセキュリティ更新プログラムは、Windows カーネル モード ドライバーによるオブジェクトの参照カウントの管理、ディスクからキーボードのレイアウトをロードする際の関数ポインターの表のインデックス化、およびウィンドウのクラス データを検証する方法を変更することにより、これらの脆弱性を解決します。この脆弱性に関する詳細情報は、次の「脆弱性の情報」のセクションの下の特定の脆弱性のエントリに関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。
...
US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS10-073.mspx](https://technet.microsoft.com/security/bulletin/ms10-073)
...
![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム/ソフトウェア                                                                            | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響 | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報            |
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|---------------------------------------------------------------------|
| Windows XP Service Pack 3                                                                                         | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3966d754-d298-4e4a-9ce6-8205accd2215&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| Windows XP Professional x64 Edition Service Pack 2                                                                | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=7fd7c675-0675-4a87-a709-edc47a30f1e2&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| Windows Server 2003 Service Pack 2                                                                                | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8ef4378e-21ff-4290-96ba-e00a60f372d1&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| Windows Server 2003 x64 Edition Service Pack 2                                                                    | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=4a95c74b-cfd8-45b5-8887-777429d21745&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| Windows Server 2003 with SP2 for Itanium-based Systems                                                            | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=21637cd8-c75c-43b4-9948-be7be54af6bf&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| Windows Vista Service Pack 1 および Windows Vista Service Pack 2                                                  | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e9f735ab-d995-4209-b2dc-197f53fdee0f&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2                          | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=738c8f70-b46a-4a59-bea6-078074a9c4db&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2 \*            | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=4dff0ebe-ccba-4675-98ca-9903f1cb6763&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2 \*      | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=da7905a9-9587-4184-8fca-ecc636a3b67e&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| Windows Server 2008 for Itanium-based Systems および Windows Server 2008 for Itanium-based Systems Service Pack 2 | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b9096046-8c7a-450c-b8c5-6e9fb001e6cd&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| Windows 7 for 32-bit Systems                                                                                      | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b5b31499-d242-42bf-ac78-b787ffb4d602&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| Windows 7 for x64-based Systems                                                                                   | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c47e8b74-8cfe-42d9-9362-8786687c88ad&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| Windows Server 2008 R2 for x64-based Systems \*                                                                   | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=98e0c6ac-c30b-4d39-8ed9-1fe69e7644e5&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| Windows Server 2008 R2 for Itanium-based Systems                                                                  | [![](../../images/Dn636457.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=44080c75-036e-4bd0-914a-74ab72189ee3&displaylang=ja) | 特権の昇格             | 重要           | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
...
<th style="border:1px solid black;" >Win32k の参照カウントの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549">CVE-2010-2549</a></th>
<th style="border:1px solid black;" >Win32k のキーボードのレイアウトの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743">CVE-2010-2743</a></th>
<th style="border:1px solid black;" >Win32k のウィンドウ クラスの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744">CVE-2010-2744</a></th>
...
<td style="border:1px solid black;">対象外</td>
<td style="border:1px solid black;">注意
多層防御</td>
<td style="border:1px solid black;">重要
特権の昇格</td>
<td style="border:1px solid black;">重要</td>
...
Windows カーネルモード ドライバーがオブジェクトの参照カウントを管理する方法が原因で、特権の昇格の脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、カーネル モードで任意のコードを実行する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-2549](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549) をご覧ください。
  
#### 「Win32k の参照カウントの脆弱性」の問題を緩和する要素 - CVE-2010-2549:
...
#### 「Win32k の参照カウントの脆弱性」の回避策 - CVE-2010-2549:
  
-   マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Win32k の参照カウントの脆弱性」のよく寄せられる質問 - CVE-2010-2549:
...
何が原因で起こりますか?  
この脆弱性は、Windows カーネルモード ドライバー がオブジェクトの参照カウントを正しく管理しない場合に起こります。
...
参照カウントとは何ですか？  
参照カウントは、オペレーティング システムのプロセスに提供されたオブジェクト ポインター数を記録するオブジェクト マネージャーです。このオブジェクト マネージャーは、オブジェクトにポインターを与える度に、オブジェクトの参照カウントを増やします。そしてカーネルモードのコンポーネントがポインターの使用を終了した際に、オブジェクト マネージャーを呼び出し、オブジェクトの参照カウントを減少させます。
...
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2010-2549](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549) にアサインされています。
...
Windows カーネルモード ドライバーが特定のキーボードのレイアウトをロードする方法が原因で、特権の昇格の脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、カーネル モードで任意のコードを実行する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-2743](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743) をご覧ください。
  
#### 「Win32k のキーボードのレイアウトの脆弱性」の問題を緩和する要素 - CVE-2010-2743:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーにより、この脆弱性が悪用されることはないと思われます。
  
#### 「Win32k のキーボードのレイアウトの脆弱性」の回避策 - CVE-2010-2743:
  
-   マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Win32k のキーボードのレイアウトの脆弱性」のよく寄せられる質問 - CVE-2010-2743:
  
どのようなことが起こる可能性がありますか?  
これは、特権の昇格の脆弱性です。攻撃者はこの脆弱性を悪用し、任意のコードを実行し、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
何が原因で起こりますか?  
この脆弱性は、Windows カーネルモード ドライバーが、ディスクからキーボードのレイアウトをロードする際に、関数ポインターの一覧のインデックスを正しく作成しない場合に起こります。
  
なぜ、この脆弱性の深刻度は、すべてのサポートされている Windows Server 2003、Windows Vista、Windows Server 2008, Windows 7 および Windows Server 2008 R2 について「注意」と評価されているのですか？  
これらの Windows のリリースには、この脆弱性に関連するコードが存在しますが、攻撃者がこのコードに到達する既知の攻撃手法がないため、深刻度を「注意」と評価しています。しかし、この更新プログラムは将来的にこのコードを悪用して特権を昇格する攻撃手法が確認された場合に備え、多層防御の方法によりこのコードに対応します。
...
この更新プログラムはどのように問題を修正しますか?  
この更新プログラムは、Windows カーネルモード ドライバーがディスクからキーボードのレイアウトをロードする際に、関数ポインターの表のインデックスを作成する方法を変更して、この脆弱性を解決します。
  
このセキュリティ情報のリリース時に、この脆弱性は一般に公開されていましたか?  
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2010-2743](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743) にアサインされています。
  
このセキュリティ情報の公開時に、マイクロソフトはこの脆弱性が悪用されたという報告を受けていましたか?  
はい。このセキュリティ情報が公開された際に、この脆弱性はマルウェアによって、限定的な規模で悪用されていました。
  
Win32k のウィンドウ クラスの脆弱性 - CVE-2010-2744  
--------------------------------------------------
  
Windows カーネル モード ドライバーが Windows のクラス データを正しく検証しない場合に、特権の昇格の脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、カーネルモードで任意のコードを実行する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-2744](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744) をご覧ください。
  
#### 「Win32k のウィンドウ クラスの脆弱性」の問題を緩和する要素 - CVE-2010-2744
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーにより、この脆弱性が悪用されることはないと思われます。
  
#### 「Win32k のウィンドウ クラスの脆弱性」の回避策 - CVE-2010-2744:
  
-   マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Win32k のウィンドウ クラスの脆弱性」のよく寄せられる質問 - CVE-2010-2744:
  
どのようなことが起こる可能性がありますか?  
これは、特権の昇格の脆弱性です。攻撃者はこの脆弱性を悪用し、任意のコードを実行し、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
何が原因で起こりますか?  
この脆弱性は、Windows カーネルモード ドライバーがウィンドウ クラスを正しく管理しないことが原因で起こります。
...
ウィンドウ クラスとは何ですか?  
ウィンドウ クラスは属性のセットでシステムがウィンドウを作成するためにテンプレートとして使用します。すべてのウィンドウが、ウィンドウ クラスのメンバーです。すべてのウィンドウ クラスはプロセス固有のものです。ウィンドウ クラスは三種類あります。 システム クラスは、システムで登録されたウィンドウ クラスです。多くのシステム クラスは、使用される全てのプロセスで利用可能ですが、その他の場合はシステムにより内部のみで使用されます。システムはこれらのクラスを登録するために、プロセスはそれらを破棄できません。application global class (アプリケーション グローバル クラス) は、実行可能ファイルまたはプロセスのその他すべてのモジュールに利用可能な DLL により登録されるウィンドウ クラスです。 application global class (アプリケーション ローカル クラス) は、実行可能ファイルまたは .dll が排他的使用のために登録します。いくつでもローカル クラスを登録できますが、通常はひとつだけ登録します。 このウィンドウ クラスはアプリケーションのメイン ウィンドウのウィンドウ処理をサポートします。ウィンドウ クラスに関する詳細情報は、MSDN コラム: [Window Classess](https://msdn.microsoft.com/en-us/library/ms632596(v=vs.85).aspx) (英語情報) をご覧ください。
...
このセキュリティ情報のリリース時に、この脆弱性は一般に公開されていましたか?  
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2010-2744](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744) にアサインされています。
...
Windowsxp-KB981957-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB981957-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB981957-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB981957-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB981957$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB981957\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB981957\\Filelist
</td>
</tr>
</table>
...
|------------|---------------|------------|-------|-----------|------------|
| Win32k.sys | 5.1.2600.6033 | 2010/09/01 | 16:54 | 1,852,416 | SP3GDR     |
| Win32k.sys | 5.1.2600.6033 | 2010/09/01 | 16:54 | 1,861,504 | SP3QFE     |

サポートされているすべての x64 エディションの Windows XP:

| ファイル名 | バージョン    | 日付       | 時間  | サイズ    | CPU | フォルダー |
|------------|---------------|------------|-------|-----------|-----|------------|
| Win32k.sys | 5.2.3790.4769 | 2010/09/02 | 01:17 | 4,562,432 | x64 | SP2GDR     |
| Win32k.sys | 5.2.3790.4769 | 2010/09/02 | 01:10 | 4,579,328 | x64 | SP2QFE     |
...
WindowsServer2003-KB981957-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB981957-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB981957-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB981957-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB981957\\Filelist
</td>
</tr>
</table>
...
| ファイル名 | バージョン    | 日付       | 時間  | サイズ    | フォルダー |
|------------|---------------|------------|-------|-----------|------------|
| Win32k.sys | 5.2.3790.4769 | 2010/09/02 | 04:28 | 1,853,952 | SP2GDR     |
| Win32k.sys | 5.2.3790.4769 | 2010/09/02 | 04:26 | 1,865,216 | SP2QFE     |

サポートされているすべての Itanium-based エディションの Windows Server 2003:

| ファイル名 | バージョン    | 日付       | 時間  | サイズ    | CPU   | フォルダー |
|------------|---------------|------------|-------|-----------|-------|------------|
| Win32k.sys | 5.2.3790.4769 | 2010/09/02 | 01:17 | 5,579,776 | IA-64 | SP2GDR     |
| Win32k.sys | 5.2.3790.4769 | 2010/09/02 | 01:10 | 5,598,208 | IA-64 | SP2QFE     |
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Vista:  
Windows6.0-KB981957-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows Vista:  
Windows6.0-KB981957-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
|------------|----------------|------------|-------|-----------|
| Win32k.sys | 6.0.6001.18523 | 2010/08/31 | 22:39 | 2,037,248 |
| Win32k.sys | 6.0.6001.22754 | 2010/08/31 | 22:38 | 2,037,760 |
| Win32k.sys | 6.0.6002.18305 | 2010/08/31 | 22:27 | 2,038,272 |
| Win32k.sys | 6.0.6002.22478 | 2010/08/31 | 23:33 | 2,046,464 |

サポートされているすべての x64 エディションの Windows Vista:

| ファイル名 | バージョン     | 日付       | 時間  | サイズ    | CPU |
|------------|----------------|------------|-------|-----------|-----|
| Win32k.sys | 6.0.6001.18523 | 2010/08/31 | 22:18 | 2,751,488 | x64 |
| Win32k.sys | 6.0.6001.22754 | 2010/08/31 | 23:02 | 2,752,512 | x64 |
| Win32k.sys | 6.0.6002.18305 | 2010/08/31 | 23:57 | 2,753,024 | x64 |
| Win32k.sys | 6.0.6002.22478 | 2010/08/31 | 23:04 | 2,756,096 | x64 |
...
Windows6.0-KB981957-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB981957-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| ファイル名 | バージョン     | 日付       | 時間  | サイズ    | CPU   |
|------------|----------------|------------|-------|-----------|-------|
| Win32k.sys | 6.0.6001.18523 | 2010/08/31 | 22:45 | 6,632,448 | IA-64 |
| Win32k.sys | 6.0.6001.22754 | 2010/08/31 | 22:43 | 6,629,376 | IA-64 |
| Win32k.sys | 6.0.6002.18305 | 2010/08/31 | 23:23 | 6,633,472 | IA-64 |
| Win32k.sys | 6.0.6002.22478 | 2010/08/31 | 23:22 | 6,643,712 | IA-64 |
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows 7:  
Windows6.1-KB981957-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows 7:  
Windows6.1-KB981957-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| ファイル名 | バージョン     | 日付       | 時間  | サイズ    |
|------------|----------------|------------|-------|-----------|
| Win32k.sys | 6.1.7600.16667 | 2010/09/01 | 11:34 | 2,327,552 |
| Win32k.sys | 6.1.7600.20792 | 2010/09/01 | 15:16 | 2,328,064 |

サポートされているすべての x64 エディションの Windows 7:

| ファイル名 | バージョン     | 日付       | 時間  | サイズ    | CPU |
|------------|----------------|------------|-------|-----------|-----|
| Win32k.sys | 6.1.7600.16667 | 2010/09/01 | 11:58 | 3,123,712 | x64 |
| Win32k.sys | 6.1.7600.20792 | 2010/09/01 | 11:55 | 3,125,248 | x64 |
...
Windows6.1-KB981957-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB981957-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| ファイル名 | バージョン     | 日付       | 時間  | サイズ    | CPU   |
|------------|----------------|------------|-------|-----------|-------|
| Win32k.sys | 6.1.7600.16667 | 2010/09/01 | 11:23 | 7,428,608 | IA-64 |
| Win32k.sys | 6.1.7600.20792 | 2010/09/01 | 11:27 | 7,431,168 | IA-64 |
...
-   「Win32k のキーボードのレイアウトの脆弱性」 - [CVE-2010-2743](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743) を報告してくださった [Kaspersky Lab](https://www.kaspersky.com/) の Sergey Golovanov 氏、Alexander Gostev氏 、Maxim Golovkin 氏および Alexey Monastyrsky 氏、[Design and Test Lab](https://www.dnt-lab.com/) の Vitaly Kiktenko 氏および Alexander Saprykin 氏
-   「Win32k のキーボードのレイアウトの脆弱性」 - [CVE-2010-2743](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743) を報告してくださった [Symantec](https://www.symantec.com/index.jsp) の Eric Chien 氏
-   「Win32k のウィンドウ クラスの脆弱性」 - [CVE-2010-2744](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744) についてマイクロソフトに協力してくださった [Norman](https://www.norman.com/) の Tarjei Mandt 氏
