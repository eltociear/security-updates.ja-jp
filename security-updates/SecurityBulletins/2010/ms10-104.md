...
[](https://www.microsoft.com/japan/security/bulletins/ms10-104e.mspx)[![](../../images/Dn636488.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS10-104.mspx](https://technet.microsoft.com/security/bulletin/ms10-104)
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3c8fb9f9-7920-43ea-b618-e26dc3360c60&amp;displaylang=ja"><img src="../../images/Dn636488.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3db09280-24bd-42e0-9ae3-02c9bf3e8ee3&amp;displaylang=ja"><img src="../../images/Dn636488.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<th style="border:1px solid black;" >不正な形式のリクエストのコードの実行の脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3964">CVE-2010-3964</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3964](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3964) をご覧ください。
...
-   ファイアウォールで Office Document Conversions Launcher Service により使用されるポートをブロックする
    ...
    ファイアーウォールで TCP ポート 8082 のブロックを解除します。ポートに関する詳細情報は、TechNet の記事 [TCP and UDP Port Assignments](https://technet.microsoft.com/library/cc977599.aspx) (英語情報) をご覧ください。
...
<td style="border:1px solid black;">
サポート技術情報 [2455005](https://support.microsoft.com/kb/2455005) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
-   「不正な形式のリクエストのコードの実行の脆弱性」 - [CVE-2010-3964](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3964) の 問題を報告してくださった [Tipping Point](https://www.tippingpoint.com/) の[ゼロディ イニシアティブ](https://www.zerodayinitiative.com/) に協力している Oleksandr Mirosh 氏
