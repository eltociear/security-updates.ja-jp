...
[](https://www.microsoft.com/japan/security/bulletins/ms10-055e.mspx)[![](../../images/Dn636438.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS10-055.mspx](https://technet.microsoft.com/security/bulletin/ms10-055)
...
|------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Windows XP Service Pack 3                                                                | [![](../../images/Dn636438.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5ddb5e34-f97a-47c6-96c8-ba2ed06ccb77&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows XP Professional x64 Edition Service Pack 2                                       | [![](../../images/Dn636438.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5cff5d6e-11a5-40ed-92ac-e12d287919e6&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Vista Service Pack 1 および Windows Vista Service Pack 2                         | [![](../../images/Dn636438.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=60c81415-b61e-44a4-8dd9-cedec99eb70f&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2 | [![](../../images/Dn636438.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=469b732d-ca62-4a48-bb55-99f2ae4ddcf5&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows 7 for 32-bit Systems                                                             | [![](../../images/Dn636438.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=2e782ac9-b5d5-490e-a01a-7d4481eab224&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows 7 for x64-based Systems                                                          | [![](../../images/Dn636438.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=24751193-592f-4c44-a8d6-f4112d4f011b&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
...
Windows 7 Service Pack 1 Beta は、このセキュリティ情報で説明している脆弱性の影響を受けます。このベータ リリースを実行しているお客様は、この更新プログラムをダウンロードし、ご使用のコンピューターに適用することを推奨します。セキュリティ更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) および [Windows Update](https://windowsupdate.microsoft.com/) から利用可能です。
...
<th style="border:1px solid black;" >Cinepak Codec の展開の脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2553">CVE-2010-2553</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-2553](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2553) をご覧ください。
...
-   「Cinepak Codec の展開の脆弱性」 - [CVE-2010-2553](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2553) の 問題を報告してくださった [TippingPoint](https://www.tippingpoint.com/) の [Zero Day Initiative](https://www.zerodayinitiative.com/) に協力している匿名のリサーチャー
