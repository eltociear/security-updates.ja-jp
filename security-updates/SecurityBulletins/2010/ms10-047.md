---
TOCTitle: 'MS10-047'
Title: 'マイクロソフト セキュリティ情報 MS10-047 - 重要'
ms:assetid: 'ms10-047'
ms:contentKeyID: 61229218
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-047(v=Security.10)'
---
...
[](http://www.microsoft.com/japan/security/bulletins/ms10-047e.mspx)[![](../../images/Dn636430.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
US マイクロソフトセキュリティ情報: [http://www.microsoft.com/technet/security/bulletin/MS10-047.mspx](http://technet.microsoft.com/security/bulletin/ms10-047)
...
![](../../images/Dn636430.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](http://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](http://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム/ソフトウェア                                                                            | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響 | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報            |
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|---------------------------------------------------------------------|
| Windows XP Service Pack 3                                                                                         | [![](../../images/Dn636430.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=e3574047-5ce5-4461-94aa-4eb3258d5e71&displaylang=ja) | 特権の昇格             | 重要           | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| Windows Vista Service Pack 1 および Windows Vista Service Pack 2                                                  | [![](../../images/Dn636430.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=4486f97c-4cf8-4236-bfc3-b50e72e2a5c1&displaylang=ja) | 特権の昇格             | 重要           | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2                          | [![](../../images/Dn636430.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=b547898e-f8a9-49dc-b49d-cffec5a001bc&displaylang=ja) | 特権の昇格             | 重要           | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2\*             | [![](../../images/Dn636430.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=611765ab-b3f3-45db-92b2-ee040b9cfd27&displaylang=ja) | 特権の昇格             | 重要           | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2\*       | [![](../../images/Dn636430.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=131f3512-1585-462e-a4f1-3f359aac44bd&displaylang=ja) | 特権の昇格             | 重要           | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| Windows Server 2008 for Itanium-based Systems および Windows Server 2008 for Itanium-based Systems Service Pack 2 | [![](../../images/Dn636430.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=972efd3a-ec1e-49b2-835e-76f4b21b5b79&displaylang=ja) | 特権の昇格             | 重要           | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| Windows 7 for 32-bit Systems                                                                                      | [![](../../images/Dn636430.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=a7d60864-5942-47ed-a6f3-1c07b4833a14&displaylang=ja) | サービス拒否           | 警告           | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| Windows 7 for x64-based Systems                                                                                   | [![](../../images/Dn636430.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=b00ec47c-402e-4207-a4c9-6c1900f254f8&displaylang=ja) | サービス拒否           | 警告           | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| Windows Server 2008 R2 for x64-based Systems\*                                                                    | [![](../../images/Dn636430.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=c1ad1248-07f1-42d4-baa4-8a20837ec7b4&displaylang=ja) | サービス拒否           | 警告           | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| Windows Server 2008 R2 for Itanium-based Systems                                                                  | [![](../../images/Dn636430.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=f23dec0f-a33b-4d8c-a86d-0e9368ae7ff5&displaylang=ja) | サービス拒否           | 警告           | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
...
<th style="border:1px solid black;" >Windows カーネルのデータ初期化の脆弱性 - <a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1888">CVE-2010-1888</a></th>
<th style="border:1px solid black;" >カーネルのダブル フリーの脆弱性 - <a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1889">CVE-2010-1889</a></th>
<th style="border:1px solid black;" >Windows カーネル の不適切な検証の脆弱性 - <a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1890">CVE-2010-1890</a></th>
...
Windows カーネルが特定のスレッド作成を処理する方法が原因で、Windows カーネルに特権の昇格の脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、カーネル モードで任意のコードを実行する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-1888](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1888) をご覧ください。
  
#### 「Windows カーネルのデータ初期化の脆弱性」の問題を緩和する要素 - CVE-2010-1888:
...
#### 「Windows カーネルのデータ初期化の脆弱性」の回避策 - CVE-2010-1888:
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Windows カーネルのデータ初期化の脆弱性」のよく寄せられる質問 - CVE-2010-1888:
...
何が原因で起こりますか?  
この脆弱性は、特定の種類のスレッドを作成する際に、競合状態を引き起こすことが原因で起こります。
...
この更新プログラムは、スレッド作成のメカニズムに追加のランタイムの検証を導入して、この脆弱性を解決します。
...
Windows カーネルが特定のエラーを処理する間にカーネルがオブジェクトを初期化する方法が原因で、特権の昇格の脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、カーネル モードで任意のコードを実行する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-1889](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1889) をご覧ください。
  
#### 「Windows カーネルのダブル フリーの脆弱性」の問題を緩和する要素 - CVE-2010-1889:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーにより、この脆弱性が悪用されることはないと思われます。
  
#### 「Windows カーネルのダブル フリーの脆弱性」の回避策 - CVE-2010-1889:
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Windows カーネルのダブル フリーの脆弱性」のよく寄せられる質問 - CVE-2010-1889:
  
どのようなことが起こる可能性がありますか?  
これは、特権の昇格の脆弱性です。攻撃者はこの脆弱性を悪用し、任意のコードを実行し、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
何が原因で起こりますか?  
Windows カーネルが特定のエラーを処理する際に、オブジェクトを正しく初期化しないことが原因で起こります。
...
この更新プログラムはどのように問題を修正しますか?  
この更新プログラムは、特定のエラーを処理している最中に、Windows カーネルにオブジェクトを正しく初期化させることにより、この脆弱性を解決します。
...
Windows カーネルがカーネル オブジェクトのアクセス制御リストを検証する方法に、サービス拒否の脆弱性が存在します。攻撃者は、特別に細工したアプリケーションを実行して、システムの応答を停止させ、自動的に再起動させることにより、この脆弱性を悪用する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-1890](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1890) をご覧ください。
  
#### 「Windows カーネル の不適切な検証の脆弱性」の問題を緩和する要素 - CVE-2010-1890:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーにより、この脆弱性が悪用されることはないと思われます。
  
#### 「Windows カーネル の不適切な検証の脆弱性」の回避策 - CVE-2010-1890:
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Windows カーネル の不適切な検証の脆弱性」のよく寄せられる質問 - CVE-2010-1890:
  
どのようなことが起こる可能性がありますか?  
これは、サービス拒否の脆弱性です。攻撃者はこの脆弱性を悪用し、影響を受けるコンピューターが応答を停止させ、自動的に再起動させる可能性があります。攻撃者がサービス拒否の脆弱性を悪用しても、コードが実行されたり、攻撃者のユーザー権限が昇格されたりすることはないと考えられます。しかし、影響を受けるシステムがリクエストを許可しなくなる可能性があることに注意してください。
  
何が原因で起こりますか?  
Windows カーネルが、カーネル オブジェクトのアクセス制御リスト変更を正しく検証しないことが原因で起こります。
...
この更新プログラムはどのように問題を修正しますか?  
この更新プログラムは Windows カーネルが、カーネル オブジェクトに適用したアクセス制御リストを検証する方法を修正することにより、この脆弱性を解決します。
...
Windowsxp-KB981852-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB981852-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB981852\\Filelist
</td>
</tr>
</table>
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Vista:  
Windows6.0-KB981852-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows Vista:  
Windows6.0-KB981852-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB981852-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB981852-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows 7:  
Windows6.1-KB981852-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows 7:  
Windows6.1-KB981852-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB981852-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB981852-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   「Windows カーネルのデータ初期化の脆弱性」 - [CVE-2010-1888](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1888) の 問題を報告してくださった [Google Inc.](http://www.google.com/) の Tavis Ormandy 氏
-   「Windows カーネルのダブル フリーの脆弱性」 - [CVE-2010-1889](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1889) の 問題を報告してくださった [Google Inc.](http://www.google.com/) の Tavis Ormandy 氏
-   「Windows カーネル の不適切な検証の脆弱性」 - [CVE-2010-1890](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1890) の 問題を報告してくださった [Google Inc.](http://www.google.com/) の Tavis Ormandy 氏
