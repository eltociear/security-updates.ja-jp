...
[](https://www.microsoft.com/japan/security/bulletins/ms10-095e.mspx)[![](../../images/Dn636479.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
管理者およびエンタープライズのインストール、またはこのセキュリティ更新プログラムを手動でインストールしたいエンド ユーザーは、更新プログラムの管理ソフトウェアまたは [Microsoft Update サービス](https://update.microsoft.com/microsoftupdate) で更新プログラムを確認して、できる限り早期にこの更新プログラムを適用することを推奨します。

このセキュリティ情報の後半の「検出および適用のツールとガイダンス」をご覧ください。

既知の問題: なし

US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS10-095.mspx](https://technet.microsoft.com/security/bulletin/ms10-095)
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=75591d37-2cb8-4cdf-acbb-89cd0d1a9290&amp;amp;displaylang=ja"><img src="../../images/Dn636479.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3a0c4dd0-98b4-4e7a-99ed-22b9d9f76cd1&amp;amp;displaylang=ja"><img src="../../images/Dn636479.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f58a765f-cea9-456d-b0ab-bfc70b109cbf&amp;amp;displaylang=ja"><img src="../../images/Dn636479.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=13a9f838-ac07-43dc-9aee-a77207998e1e&amp;amp;displaylang=ja"><img src="../../images/Dn636479.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
はい。この脆弱性はマイクロソフト セキュリティ アドバイザリ [2269637](https://technet.microsoft.com/security/advisory/2269637) で説明しているアプリケーションが外部ライブラリをロードする方法に影響する脆弱性の一種に関連するものです。このセキュリティ情報はこの種類の脆弱性の特別なインスタンスを解決します。
...
<th style="border:1px solid black;" >BranchCache の安全でないライブラリのロードの脆弱性 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3966">CVE-2010-3966</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3966](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3966) をご覧ください。
...
-   「BranchCache の安全でないライブラリのロードの脆弱性」 - [CVE-2010-3966](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3966) の 問題を報告してくださった [Fortinet FortiGuard Labs](https://www.fortiguard.com/) の Haifei Li 氏
