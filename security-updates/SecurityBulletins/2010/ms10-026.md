...
[](https://www.microsoft.com/japan/security/bulletins/ms10-026e.mspx)[![](../../images/Dn636409.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
**USマイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS10-026.mspx](https://technet.microsoft.com/security/bulletin/ms10-026)
...
|---------------------------------------------------------------------------------------------------------------------|-------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                               | MPEG Layer-3 コーデック | [![](../../images/Dn636409.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f6394fc2-b9d0-46cf-9265-a0d4aeb1448f&displaylang=ja) | [![](../../images/Dn636409.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f6394fc2-b9d0-46cf-9265-a0d4aeb1448f&displaylang=ja-nec) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows XP Service Pack 2 および Windows XP Service Pack 3                                                          | MPEG Layer-3 コーデック | [![](../../images/Dn636409.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b1582a74-4a7b-4540-beb1-7c89c86eae87&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows XP Professional x64 Edition Service Pack 2                                                                  | MPEG Layer-3 コーデック | [![](../../images/Dn636409.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8afca317-a647-44aa-a771-5d85cd5d62ea&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Server 2003 Service Pack 2                                                                                  | MPEG Layer-3 コーデック | [![](../../images/Dn636409.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=9f89746c-181e-4177-a851-ec1826e78b6d&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Server 2003 x64 Edition Service Pack 2                                                                      | MPEG Layer-3 コーデック | [![](../../images/Dn636409.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b97e7ea1-a163-4ce4-8cbc-5f933773c4b2&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Vista、Windows Vista Service Pack 1 および Windows Vista Service Pack 2                                     | MPEG Layer-3 コーデック | [![](../../images/Dn636409.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=0e7140bb-42d3-48b3-9f4b-d55b17770de8&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 重要           | なし                                                     |
| Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2 | MPEG Layer-3 コーデック | [![](../../images/Dn636409.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b885aef4-3a5d-4c3e-bef6-5efef2965752&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 重要           | なし                                                     |
| Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2\*\*             | MPEG Layer-3 コーデック | [![](../../images/Dn636409.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8e9c04c9-898f-4ed2-949d-f4343cc0d9f6&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2\*\*       | MPEG Layer-3 コーデック | [![](../../images/Dn636409.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=d6f2e1ae-48d3-4d2c-b329-32cff00afee5&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 緊急           | なし                                                     |
...
この検出の変更により、このセキュリティ更新プログラムが Windows Server Update Services (WSUS) をご使用のお客様に新しい更新プログラムとして表示される可能性があります。自動的に承認するルールを設定していない場合、この更新プログラムを手動で再承認する必要がある場合があります。この更新プログラムを再承認しないと、更新プログラムが該当しない場合でも、システムに提供され続ける可能性があります。この変更に関する詳細情報は、サポート技術情報 [894199](https://support.microsoft.com/kb/894199/en-us) (英語情報) をご覧ください。
...
<th style="border:1px solid black;" >MPEG Layer-3 オーディオ デコーダーのスタック オーバーフローの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0480">CVE-2010-0480</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-0480](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0480) をご覧ください。
...
Windows Server Update Services (WSUS) を使用することにより、管理者は Windows 2000 オペレーティング システムおよびそれ以降、Office XP およびそれ以降、Windows 2000 およびそれ以降のオペレーティング システムに対する Exchange Server 2003 およびそれ以降のバージョン、SQL Server 2000 およびそれ以降のバージョン用の最新の緊急な更新プログラムおよびセキュリティ更新プログラムを迅速に、かつ確実に適用することができます。Windows Server Update Services でこのセキュリティ更新プログラムを適用する方法に関する情報は、次のマイクロソフトの Web サイト をご覧ください。[Windows Server Update Services 製品概要](https://technet.microsoft.com/ja-jp/wsus/default.aspx)
...
-   MPEG Layer-3 オーディオ デコーダーのスタック オーバーフローの脆弱性 - [CVE-2010-0480](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2010-0480) を報告してくださった [Palo Alto Networks](https://www.paloaltonetworks.com/) の Yamata Li 氏
