...
[](https://www.microsoft.com/japan/security/bulletins/ms10-056e.mspx)[![](../../images/Dn636439.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
**既知の問題:** サポート技術情報 [2269638](https://support.microsoft.com/kb/2269638) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS10-056.mspx](https://technet.microsoft.com/security/bulletin/ms10-056)
...
<td style="border:1px solid black;">
[![](../../images/Dn636439.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=978eb887-25b6-4dde-a2ec-d2d1e7f1a434&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636439.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=4360bcec-0731-4d4a-89eb-7d28a4607f06&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636439.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=0d7210a3-662e-41e7-affc-ae94f9d89388&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636439.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=d2f44d4a-7cd8-4514-b3ff-1770bc47d595&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636439.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6ece112f-0ca7-4b1f-ad20-603950edee66&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636439.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=a7b834a3-5a44-42d4-afe9-6ef207333834&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636439.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=39fe2229-9201-4270-bdc1-20bc8e30a766&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636439.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ed5b9671-651d-41f3-aed3-93ee8a28657f&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636439.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=feb121ad-e5f6-40e2-bf12-045ae5c2a754)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
Microsoft Office Word Viewer は Word Viewer 2003 および Word Viewer のすべての以前のバージョンに置き替わります。Word Viewer を使用すると、Word をインストールしていない場合でも、Word 文書を表示、印刷およびコピーできます。現在サポートされている Office ビューアーの詳細については、[「サポートされるバージョンの Office ビューアー」](https://support.microsoft.com/kb/979860)をご覧ください。
...
<th style="border:1px solid black;" >
Word のレコードの解析の脆弱性 - [CVE-2010-1900](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1900)
</th>
<th style="border:1px solid black;" >
Word の RTF 形式の解析エンジンのメモリ破損の脆弱性 - [CVE-2010-1901](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1901)
</th>
<th style="border:1px solid black;" >
Word の RTF 形式の解析のバッファー オーバーフローの脆弱性 - [CVE-2010-1902](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1902)
</th>
<th style="border:1px solid black;" >
Word HTML リンクオブジェクトのメモリ破損の脆弱性 - [CVE-2010-1903](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1903)
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-1900](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1900) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-1901](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1901) をご覧ください。
...
-   **電子メールをテキスト形式で読みとる**
    ...
    デジタル署名または暗号化されている電子メール メッセージは、設定による影響は受けず、元の形式で読み取ることができる場合があります。Outlook 2002 のこの設定を有効にする方法に関する情報は、サポート技術情報 [307594](https://support.microsoft.com/kb/307594) で説明されています。 Outlook Express 6 のこの設定に関する情報は、サポート技術情報 [291387](https://support.microsoft.com/kb/291387) で説明されています。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-1902](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1902) をご覧ください。
...
-   **Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から RTF 形式の文書を開くことをブロックする**
    ...
    **回避策の影響:** ファイル ブロックのポリシーを構成しており、マイクロソフト サポート技術情報 [922848](https://support.microsoft.com/kb/922848) で説明されている特別な「除外されるディレクトリ」を構成していないユーザーは、Office 2003 ファイルまたは Office 2003 の初期のバージョンまたは 2007 Microsoft Office System を開くことができなくなります。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-1903](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1903) をご覧ください。
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/japan/mac/download/default.mspx)から Microsoft Office 2004 for Mac 11.6.0 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/japan/mac/download/default.mspx)から Microsoft Office 2008 for Mac 12.2.6 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/japan/mac/downloads.mspx)から Open XML File Format Converter for Mac 1.1.6 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
再起動が必要になる可能性を低減する手助けとするために、このセキュリティ更新プログラムをインストールする前に、すべての影響を受けるサービスを停止し、影響を受けるファイルを使用している可能性のあるすべてのアプリケーションを閉じてください。再起動が必要となる理由に関する詳細情報は、マイクロソフト サポート技術情報 [887012](https://support.microsoft.com/kb/887012) をご覧ください。
...
**注:** これらのスイッチを 1 つのコマンドに組み込むことができます。旧バージョンとの互換性のため、このセキュリティ更新プログラムは、セットアップ プログラムの以前のバージョンによって使用されるセットアップ スイッチもサポートしています。サポートされるインストール スイッチに関する詳細は、マイクロソフト サポート技術情報 [912203](https://support.microsoft.com/kb/912203) をご覧ください。
...
-   Word のレコードの解析の脆弱性 - [CVE-2010-1900](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1900) を [TippingPoint](https://www.tippingpoint.com/) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して報告してくださった [team509](https://www.team509.com/) の L.W.Z 氏
-   Word の RTF 形式の解析エンジンのメモリ破損の脆弱性 - [CVE-2010-1901](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1901) を [VeriSign iDefense Labs](https://labs.idefense.com/) と協力して報告してくださった [team509](https://www.team509.com/) の Wushi 氏
-   Word の RTF 形式の解析のバッファー オーバーフローの脆弱性 - [CVE-2010-1902](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1902) を [VeriSign iDefense Labs](https://labs.idefense.com/) と協力して報告してくださった [team509](https://www.team509.com/)
-   Word HTML リンクオブジェクトのメモリ破損の脆弱性 - [CVE-2010-1903](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1903) を報告してくださった、[Check Point](https://www.checkpoint.com/) IPS Research Team の Rodrigo Rubira Branco 氏
-   Word HTML リンクオブジェクトのメモリ破損の脆弱性 - [CVE-2010-1903](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1903) を [TippingPoint](https://www.tippingpoint.com/) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して報告してくださった 匿名のリサーチャー
