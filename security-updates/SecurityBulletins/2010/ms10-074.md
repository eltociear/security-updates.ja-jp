---
TOCTitle: 'MS10-074'
Title: 'マイクロソフト セキュリティ情報 MS10-074 - 警告'
ms:assetid: 'ms10-074'
ms:contentKeyID: 61229245
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-074(v=Security.10)'
---


マイクロソフト セキュリティ情報 MS10-074 - 警告
===============================================
...
[](https://www.microsoft.com/japan/security/bulletins/ms10-074e.mspx)[![](../../images/Dn636458.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)

### 概説

#### 要点

このセキュリティ更新プログラムは Microsoft Foundation Class (MFC) Library に存在する一般に公開された脆弱性を解決します。この脆弱性により、ユーザーが管理者ユーザー権限でログオンし MFC Library で設計されたアプリケーションを開いている場合、リモートでコードが実行されます。攻撃者がこの脆弱性を悪用した場合、現在ログオンしているユーザーと同じユーザー権限を取得する可能性があります。ユーザーが管理者ユーザー権限でログオンしている場合、攻撃者が影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。システム上で、アカウントのユーザー権限を低く設定している場合、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性の影響が少なくなると考えられます。

このセキュリティ更新プログラムは、すべてのサポートされているリリースの Microsoft Windows について、深刻度を「警告」と評価しています。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

このセキュリティ更新プログラムは、ウィンドウ タイトル変更リクエストに対するチェックを追加することにより脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。
...
US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS10-074.mspx](https://technet.microsoft.com/security/bulletin/ms10-074)
...
![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム/ソフトウェア                                                                            | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響       | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報            |
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|---------------------------------------------------------------------|
| Windows XP Service Pack 3                                                                                         | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=22f46b3b-9be6-45ea-a639-9974324ce4bd&displaylang=ja) | リモートでコードが実行される | 警告           | なし                                                                |
| Windows XP Professional x64 Edition Service Pack 2                                                                | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=285627b9-242d-4247-a4c8-55dc89386b62&displaylang=ja) | リモートでコードが実行される | 警告           | なし                                                                |
| Windows Server 2003 Service Pack 2                                                                                | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=d220f04e-9dbb-4b6d-924a-23065b48b8b6&displaylang=ja) | リモートでコードが実行される | 警告           | [MS07-012](https://technet.microsoft.com/security/bulletin/ms07-012) |
| Windows Server 2003 x64 Edition Service Pack 2                                                                    | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=de908137-33e0-4f23-b32b-cc1bdbcb349c&displaylang=ja) | リモートでコードが実行される | 警告           | なし                                                                |
| Windows Server 2003 with SP2 for Itanium-based Systems                                                            | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=873dea9d-44cc-4e16-8a6d-dca678ce3a80&displaylang=ja) | リモートでコードが実行される | 警告           | なし                                                                |
| Windows Vista Service Pack 1 および Windows Vista Service Pack 2                                                  | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=75ca4e2c-b0ae-46f4-a0fc-616510c41a55&displaylang=ja) | リモートでコードが実行される | 警告           | なし                                                                |
| Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2                          | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=0a12ff95-ea5c-4c48-96c5-9494eb8f9f0d&displaylang=ja) | リモートでコードが実行される | 警告           | なし                                                                |
| Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2\*\*           | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=952b3594-d980-45b1-8fa3-49403784afbf&displaylang=ja) | リモートでコードが実行される | 警告           | なし                                                                |
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2\*\*     | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=21128031-d935-4e2d-b001-c502a2d6022c&displaylang=ja) | リモートでコードが実行される | 警告           | なし                                                                |
| Windows Server 2008 for Itanium-based Systems および Windows Server 2008 for Itanium-based Systems Service Pack 2 | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=2eca0c38-73f5-4f83-ab62-97f979716a1d&displaylang=ja) | リモートでコードが実行される | 警告           | なし                                                                |
| Windows 7 for 32-bit Systems                                                                                      | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f09fbc23-cb6b-4525-8e41-8c14e8d03de9&displaylang=ja) | リモートでコードが実行される | 警告           | なし                                                                |
| Windows 7 for x64-based Systems                                                                                   | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=abc24826-b83a-4e01-be68-8e3a73c10494&displaylang=ja) | リモートでコードが実行される | 警告           | なし                                                                |
| Windows Server 2008 R2 for x64-based Systems\*\*                                                                  | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e4d27aa6-9739-4e41-9536-5f0b8d26503c&displaylang=ja) | リモートでコードが実行される | 警告           | なし                                                                |
| Windows Server 2008 R2 for Itanium-based Systems                                                                  | [![](../../images/Dn636458.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c1634278-5598-45e0-81c6-f18fb5ba54cf&displaylang=ja) | リモートでコードが実行される | 警告           | なし                                                                |
...
<th style="border:1px solid black;" >Windows MFC ドキュメント タイトル 更新バッファ オーバーフローの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3227">CVE-2010-3227</a></th>
...
Windows MFC ドキュメント タイトル 更新バッファ オーバーフローの脆弱性 - CVE-2010-3227  
-------------------------------------------------------------------------------------
  
MFC ライブラリを使用して書かれているアプリケーションに管理されたウィンドウ タイトルに脆弱性が存在します。 脆弱性は MFC の中にあり影響を受けるオペレーティング システムに存在しますが、リモートでの攻撃者が MFC アプリケーションのいずれかのウィンドウウィンドウ タイトルに影響を与える場合のみ悪用される可能性があります。 攻撃者がこの脆弱性を悪用した場合、現在のユーザーのセキュリティ コンテキストで任意のコードが実行される可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3227](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3227) をご覧ください。
  
#### 「Windows MFC ドキュメント タイトル 更新バッファ オーバーフローの脆弱性」の問題を緩和する要素 - CVE-2010-3227:
  
マイクロソフトは、この脆弱性の問題を緩和する要素を確認していません。
  
#### 「Windows MFC ドキュメント タイトル 更新バッファ オーバーフローの脆弱性」の回避策 - CVE-2010-3227:
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Windows MFC ドキュメント タイトル 更新バッファ オーバーフローの脆弱性」のよく寄せられる質問 - CVE-2010-3227:
  
どのようなことが起こる可能性がありますか?  
この脆弱性は、ログオンしたユーザーのセキュリティ コンテキストにおいてリモートでコードが実行される脆弱性です。
  
何が原因で起こりますか?  
この脆弱性は、ウィンドウ タイトルの名前を変更するアプリケーションの要求を MFC が管理する方法が原因で起こります。
  
Microsoft Foundation Class (MFC) Library とは何ですか?  
Microsoft Foundation Class (MFC) Library は、Microsoft Windows のプログラミングのためのアプリケーション フレームワークです。 C++ で書かれている MFC は、ウィンドウ、メニューおよびダイアログ ボックスの管理、基本的な入出力、またはデータ オブジェクトを保存などの標準操作を実行する必要なコードの多くを提供します。
  
システム上に該当する攻撃手法が存在しない場合でも、この更新プログラムは提供されますか?  
はい。この更新プログラムは「影響を受けるソフトウェア」の欄に記載されているソフトウェアを実行している全てのシステムに提供されます。現在 MFC を使用したアプリケーションがシステムにインストールされていない場合でも、後ほど新しい攻撃方法が発見された場合や後から MFC を使用したアプリケーションをインストールした場合を考慮し、多層防御のためにこの更新プログラムをインストールすることをお勧めします。
  
攻撃の方法として悪用される可能性のあるマイクロソフトのアプリケーションはありますか?  
マイクロソフトは全てのアプリケーションを調査し、攻撃の方法として悪用されるマイクロソフトのアプリケーションが存在しないことを確認しました。
  
マイクロソフトは、攻撃の方法として悪用される可能性のあるサード パーティー製の MFC アプリケーションを認識していますか?  
はい。マイクロソフトは、攻撃の方法として悪用される可能性のあるサード パーティー製の MFC アプリケーションを 1 つ、認識しています。このサード パーティー製品を使用して脆弱性の悪用を行う場合、の攻撃の方法を使用したこの脆弱性が悪用されるには、ユー ザーに MFC アプリケーションにより特別な細工がされたファイルを開かせ、MFC アプリケーションの中のフォルダーをダブルクリックさせる必要があります。
  
Microsoft Foundation Classes を使用したアプリケーションを開発しています。このアプリケーションは攻撃の方法として悪用される可能性がありますか？  
Microsoft Foundation Class (MFC) Library は、Microsoft Windows のプログラミングのためのアプリケーション フレームワークです。 C++ で書かれている MFC は、ウィンドウ、メニューおよびダイアログ ボックスの管理、基本的な入出力、またはデータ オブジェクトを保存などの標準操作を実行する必要なコードの多くを提供します。
  
次の全ての条件が当てはまる場合、アプリケーションは攻撃の方法として悪用される可能性があります。
  
-   アプリケーションが Microsoft Foundation Class (MFC) Library 使用している。  
-   アプリケーションがリモートのユーザーによってコントロール可能な情報に基づいてウィンドウ タイトルを設定している。
  
注: マイクロソフトは、MFC アプリケーションが Windows 付属の MFC バージョンに動的にリンクすることをお勧めします。アプリケーションが MFC の影響を受けるバージョンに静的にリンクしている場合、マイクロソフトは Windows 付属の MFC バージョンに動的にリンクさせるためにアプリケーションをアップデートすることをお勧めします。
...
この脆弱性が悪用されるためには、標的となるコンピューターは攻撃に 使用される可能性のある MFC アプリケーションがインストールされている必要があります。攻撃に 使用される可能性のある MFC アプリケーションは、リモートのユーザーに MFC アプリケーション内でウィンドウ タイトルに影響を与える方法を提供する必要があります。MFC で開かれているファイルの内容を基にウィンドウ タイトルを変更する場合もあり、またチャット アプリケーションや Web ブラウザー などのネットワーク入力を基にウィンドウ タイトルを変更する場合もあります。攻撃方法により 、攻撃者はユーザーにユーザーのシステムにインストールされた MFC アプリケーションで特別に細工されたファイルを開かせるか、特定のアクションを実行させる必要があります。チャット アプリケーションなどを使用した攻撃では、攻撃者がチャット ルームの名前を変更したり、ユーザーに接触している間に特別に細工されたハンドルを使用する事で、十分な可能性があります。
  
主にどのようなコンピューターがこの脆弱性による危険にさらされますか?  
リモートのユーザーに MFC アプリケーション内でウィンドウ タイトルに影響を与えることを許可する MFC アプリケーションがインストールされたワークステーションおよびターミナル サーバーが主にこの脆弱性の危険にさらされます。管理者がユーザーにサーバーへのログオンおよびプログラムの実行を許可している場合、サーバーが影響を受ける可能性が高くなります。しかし、セキュリティ上の最善策として、これを許可しないことを強く推奨しています。
  
この更新プログラムはどのように問題を修正しますか?  
この更新プログラムは、ウィンドウ タイトル変更リクエストに対するチェックを追加することにより、脆弱性を解決します。
  
このセキュリティ情報のリリース時に、この脆弱性は一般に公開されていましたか?  
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2010-3227](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3227) にアサインされています。
...
Windowsxp-KB2387149-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2387149-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB2387149-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB2387149-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB2387149$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB2387149\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB2387149\\Filelist
</td>
</tr>
</table>
...
|------------|------------|------------|-------|---------|------------|
| Mfc40.dll  | 4.1.0.6151 | 2010/09/18 | 15:53 | 954,368 | SP3GDR     |
| Mfc40u.dll | 4.1.0.6151 | 2010/09/18 | 15:53 | 953,856 | SP3GDR     |
| Mfc42.dll  | 6.2.8073.0 | 2010/09/18 | 15:53 | 974,848 | SP3GDR     |
| Mfc42u.dll | 6.2.8073.0 | 2010/09/18 | 12:23 | 974,848 | SP3GDR     |
| Mfc40.dll  | 4.1.0.6151 | 2010/09/18 | 16:18 | 954,368 | SP3QFE     |
| Mfc40u.dll | 4.1.0.6151 | 2010/09/18 | 16:18 | 953,856 | SP3QFE     |
| Mfc42.dll  | 6.2.8073.0 | 2010/09/18 | 16:18 | 974,848 | SP3QFE     |
| Mfc42u.dll | 6.2.8073.0 | 2010/09/18 | 16:18 | 974,848 | SP3QFE     |

サポートされているすべての x64 エディションの Windows XP:

| ファイル名  | バージョン | 日付       | 時間  | サイズ  | CPU | フォルダー  |
|-------------|------------|------------|-------|---------|-----|-------------|
| Wmfc40.dll  | 4.1.0.6151 | 2010/09/01 | 13:07 | 888,592 | x86 | SP2GDR\\WOW |
| Wmfc40u.dll | 4.1.0.6151 | 2010/09/01 | 13:07 | 888,080 | x86 | SP2GDR\\WOW |
| Wmfc40.dll  | 4.1.0.6151 | 2010/09/01 | 13:04 | 888,592 | x86 | SP2QFE\\WOW |
| Wmfc40u.dll | 4.1.0.6151 | 2010/09/01 | 13:04 | 888,080 | x86 | SP2QFE\\WOW |
...
WindowsServer2003-KB2387149-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2387149-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2387149-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB2387149-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2387149\\Filelist
</td>
</tr>
</table>
...
| ファイル名 | バージョン | 日付       | 時間  | サイズ  | フォルダー |
|------------|------------|------------|-------|---------|------------|
| Mfc40.dll  | 4.1.0.6151 | 2010/09/02 | 04:54 | 888,592 | SP2GDR     |
| Mfc40u.dll | 4.1.0.6151 | 2010/09/02 | 04:54 | 888,080 | SP2GDR     |
| Mfc40.dll  | 4.1.0.6151 | 2010/09/02 | 04:48 | 888,592 | SP2QFE     |
| Mfc40u.dll | 4.1.0.6151 | 2010/09/02 | 04:48 | 888,080 | SP2QFE     |
...
| Wmfc40.dll  | 4.1.0.6151 | 2010/09/01 | 13:07 | 888,592 | x86 | SP2GDR\\WOW |
| Wmfc40u.dll | 4.1.0.6151 | 2010/09/01 | 13:07 | 888,080 | x86 | SP2GDR\\WOW |
| Wmfc40.dll  | 4.1.0.6151 | 2010/09/01 | 13:02 | 888,592 | x86 | SP2QFE\\WOW |
| Wmfc40u.dll | 4.1.0.6151 | 2010/09/01 | 13:02 | 888,080 | x86 | SP2QFE\\WOW |
...
Windows6.0-KB2387149-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2387149-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Vista:  
Windows6.0-KB2387149-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows Vista:  
Windows6.0-KB2387149-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
|------------|------------|------------|-------|---------|
| Mfc40u.dll | 4.1.0.6151 | 2010/09/01 | 00:41 | 954,288 |
| Mfc40u.dll | 4.1.0.6151 | 2010/09/01 | 00:17 | 954,288 |
| Mfc40u.dll | 4.1.0.6151 | 2010/09/01 | 00:46 | 954,288 |
| Mfc40u.dll | 4.1.0.6151 | 2010/09/01 | 01:49 | 954,288 |
| Mfc40.dll  | 4.1.0.6151 | 2010/09/01 | 00:41 | 954,752 |
| Mfc40.dll  | 4.1.0.6151 | 2010/09/01 | 00:17 | 954,752 |
| Mfc40.dll  | 4.1.0.6151 | 2010/09/01 | 00:46 | 954,752 |
| Mfc40.dll  | 4.1.0.6151 | 2010/09/01 | 01:49 | 954,752 |

サポートされているすべての x64 エディションの Windows Vista:

| ファイル名 | バージョン | 日付       | 時間  | サイズ  | CPU |
|------------|------------|------------|-------|---------|-----|
| Mfc40u.dll | 4.1.0.6151 | 2010/09/01 | 00:41 | 954,288 | x86 |
| Mfc40u.dll | 4.1.0.6151 | 2010/09/01 | 00:17 | 954,288 | x86 |
| Mfc40u.dll | 4.1.0.6151 | 2010/09/01 | 00:46 | 954,288 | x86 |
| Mfc40u.dll | 4.1.0.6151 | 2010/09/01 | 01:49 | 954,288 | x86 |
| Mfc40.dll  | 4.1.0.6151 | 2010/09/01 | 00:41 | 954,752 | x86 |
| Mfc40.dll  | 4.1.0.6151 | 2010/09/01 | 00:17 | 954,752 | x86 |
| Mfc40.dll  | 4.1.0.6151 | 2010/09/01 | 00:46 | 954,752 | x86 |
| Mfc40.dll  | 4.1.0.6151 | 2010/09/01 | 01:49 | 954,752 | x86 |
...
Windows6.0-KB2387149-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2387149-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2387149-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2387149-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows 7:  
Windows6.1-KB2387149-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows 7:  
Windows6.1-KB2387149-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| ファイル名 | バージョン | 日付       | 時間  | サイズ  |
|------------|------------|------------|-------|---------|
| Mfc40u.dll | 4.1.0.6151 | 2010/08/31 | 13:32 | 954,288 |
| Mfc40u.dll | 4.1.0.6151 | 2010/08/31 | 13:25 | 954,288 |
| Mfc40.dll  | 4.1.0.6151 | 2010/08/31 | 13:32 | 954,752 |
| Mfc40.dll  | 4.1.0.6151 | 2010/08/31 | 13:25 | 954,752 |

サポートされているすべての x64 エディションの Windows 7:

| ファイル名 | バージョン | 日付       | 時間  | サイズ  | CPU |
|------------|------------|------------|-------|---------|-----|
| Mfc40u.dll | 4.1.0.6151 | 2010/08/31 | 13:32 | 954,288 | x86 |
| Mfc40u.dll | 4.1.0.6151 | 2010/08/31 | 13:25 | 954,288 | x86 |
| Mfc40.dll  | 4.1.0.6151 | 2010/08/31 | 13:32 | 954,752 | x86 |
| Mfc40.dll  | 4.1.0.6151 | 2010/08/31 | 13:25 | 954,752 | x86 |
...
Windows6.1-KB2387149-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2387149-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   「Windows MFC ドキュメント タイトル 更新バッファ オーバーフローの脆弱性」 - [CVE-2010-3277](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2010-3277) を報告してくださった [Secunia](https://secunia.com/) の Carsten H. Eiram 氏
