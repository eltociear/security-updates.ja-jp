...
[](https://www.microsoft.com/japan/security/bulletins/ms10-087e.mspx)[![](../../images/Dn636471.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
**既知の問題:** マイクロソフト サポート技術情報 [2423930](https://support.microsoft.com/kb/2423930) には、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明されています。

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS10-087.mspx](https://technet.microsoft.com/security/bulletin/ms10-087)
...
<td style="border:1px solid black;">
[![](../../images/Dn636471.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f32648e3-2fb5-472c-932f-360e5d3c0931&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636471.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=07a6cf76-2cea-4c54-b66d-50e9eed108ac&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636471.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=be0c5878-60c0-4700-8836-50d369b51d04&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636471.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=0b308508-0e1e-4e90-b2b8-7e32bfc5dbf4&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636471.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=534c6a2a-e7c6-4adf-8b81-e009a2b5fff4&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636471.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ad1b1984-b2b2-49b3-a1dd-385b77d9248a&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636471.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=8bd6ca3b-8004-4e8d-a09d-220dcbbce799&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636471.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b846d255-a7d4-4a2c-a084-d434c29fe676&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
マイクロソフトはこのセキュリティ情報を更新し、セキュリティ情報 [MS11-021](https://technet.microsoft.com/security/bulletin/ms11-021)、[MS11-022](https://technet.microsoft.com/security/bulletin/ms11-022) および [MS11-023](https://technet.microsoft.com/security/bulletin/ms11-023) で提供している Microsoft Office 2004 for Mac 用のセキュリティ更新プログラム (KB2505924) が、各セキュリティ情報で説明している脆弱性に加え、このセキュリティ情報で説明している脆弱性も解決することをお知らせしました。KB2505924 の更新プログラム パッケージは 3 つの個別のセキュリティ情報で提供していますが、Microsoft Office 2004 for Mac をインストールしているユーザーはこのセキュリティ更新プログラム パッケージを 1 回のみインストールしてください。詳細情報およびダウンロード リンクは、セキュリティ情報 [MS11-021](https://technet.microsoft.com/security/bulletin/ms11-021)、[MS11-022](https://technet.microsoft.com/security/bulletin/ms11-022) および [MS11-023](https://technet.microsoft.com/security/bulletin/ms11-023) をご覧ください。

**なぜこのセキュリティ情報は 2010 年 12 月 16 日に更新されたのですか?**  
マイクロソフトは [Microsoft Office 2008 for Mac](https://www.microsoft.com/download/details.aspx?familyid=ad1b1984-b2b2-49b3-a1dd-385b77d9248a&displaylang=ja) 用 (KB2476512) および [Open XML File Format Converter for Mac](https://www.microsoft.com/download/details.aspx?familyid=b846d255-a7d4-4a2c-a084-d434c29fe676&displaylang=ja) 用 (KB2476511) のセキュリティ更新プログラムが利用可能となったことをお知らせするために、このセキュリティ情報を更新しました。マイクロソフトは Microsoft Office 2008 for Mac および Open XML File Format Converter for Mac のユーザーにこれらの更新プログラムを可能な限り早期に適用し、このセキュリティ情報で説明している脆弱性を解決することを推奨します。Microsoft Office 2004 用の更新プログラムは、現時点ではご利用になれません。

**なぜこのセキュリティ情報は 2010 年 11 月 18 日に更新されたのですか?**  
マイクロソフトはこのセキュリティ情報を更新し、[CVE-2010-2573](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573) をこの更新プログラムにより解決される脆弱性に追加しました。Microsoft PowerPoint 2002 および Microsoft PowerPoint 2003 について、CVE-2010-2573 もまた、このセキュリティ情報 (MS10-087) で提供している Microsoft Office 用の更新プログラムにより、解決されます。今回の更新は情報のみの変更です。既に MS10-087 および MS10-088 の更新プログラムを正常に適用されたお客様は、対策を行う必要はありません。

**Microsoft Office 2004 for Mac 用の更新プログラムはどこにありますか?**  
セキュリティ情報 [MS11-021](https://technet.microsoft.com/security/bulletin/ms11-021)、[MS11-022](https://technet.microsoft.com/security/bulletin/ms11-022) および [MS11-023](https://technet.microsoft.com/security/bulletin/ms11-023) で提供している Microsoft Office 2004 for Mac 用のセキュリティ更新プログラム (KB2505924) は、各セキュリティ情報で説明している脆弱性に加え、このセキュリティ情報で説明している脆弱性も解決します。KB2505924 の更新プログラム パッケージは 3 つの個別のセキュリティ情報で提供していますが、Microsoft Office 2004 for Mac をインストールしているユーザーは、このセキュリティ更新プログラム パッケージを 1 回のみインストールしてください。詳細情報およびダウンロード リンクは、セキュリティ情報 [MS11-021](https://technet.microsoft.com/security/bulletin/ms11-021)、[MS11-022](https://technet.microsoft.com/security/bulletin/ms11-022) および [MS11-023](https://technet.microsoft.com/security/bulletin/ms11-023) をご覧ください。

**MS10-088 はこのセキュリティ情報 (MS10-087) にどのような関係があるのですか?**  
[CVE-2010-2573](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573) はこのセキュリティ情報 (MS10-087) と [MS10-088](https://technet.microsoft.com/security/bulletin/ms10-088)「Microsoft PowerPoint の脆弱性により、リモートでコードが実行される (2293386)」の両方で解決されます。Microsoft PowerPoint 2002 および Microsoft PowerPoint 2003 について、この更新プログラム (MS10-087) はこの脆弱性を解決します。MS10-088 は PowerPoint Viewer など、CVE-2010-2573 による影響を受けるすべてその他のソフトウェアに対応します。
...
<span></span>
次の深刻度の評価は脆弱性による影響が最大であった場合を前提としています。このセキュリティ情報のリリース後 30 日以内に、深刻度の評価およびセキュリティ上の影響に関連する脆弱性が悪用される可能性に関する情報は、[11 月のセキュリティ情報](https://technet.microsoft.com/security/bulletin/ms10-nov)の「Exploitability Index (悪用可能性指標)」のセクションをご覧ください。詳細については、[Microsoft Exploitability Index (悪用可能性指標)](https://technet.microsoft.com/security/cc998259.aspx)をご覧ください。
...
<th style="border:1px solid black;" >
PowerPoint の整数アンダーフローのヒープ破損の脆弱性 - [CVE-2010-2573](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573)
</th>
<th style="border:1px solid black;" >
RTF のスタック バッファ オーバーフローの脆弱性 - [CVE-2010-3333](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3333)
</th>
<th style="border:1px solid black;" >
Office アートのレコード描画の脆弱性 - [CVE-2010-3334](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3334)
</th>
<th style="border:1px solid black;" >
描画の例外処理の脆弱性 - [CVE-2010-3335](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3335)
</th>
<th style="border:1px solid black;" >
MSO のラージ SPID の読み取り AV の脆弱性- [CVE-2010-3336](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2010-3336)
</th>
<th style="border:1px solid black;" >
セキュリティで保護されていないライブラリのロードの脆弱性- [CVE-2010-3337](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2010-3337)
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-2573](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573) をご覧ください。
...
-   **Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から Office 2003 以前の文書を開くことをブロックする**
    ...
    **回避策の影響:**Microsoft Office 2003 および Microsoft Office 2007 について、ファイル ブロックのポリシーを構成しており、サポート技術情報 [922848](https://support.microsoft.com/kb/922848) で説明されている特別な「除外されるディレクトリ」を構成していないユーザーは、Microsoft Office 2003 ファイルまたはそれ以前のバージョンを開くことができなくなります。Microsoft Office 2007 について、選択された開く動作により、Office 2003 またはそれ以前のバージョンは開かなくなるか、または保護モードで開かれるようになります。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3333](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3333) をご覧ください。
...
-   **Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から RTF の文書を開くことをブロックする**
    ...
    **回避策の影響:** Microsoft Office 2003 および Microsoft Office 2007 について、サポート技術情報 [922848](https://support.microsoft.com/kb/922848) で説明しているように、ファイル ブロックのポリシーを構成している、および特別な「除外されるディレクトリ」を構成していない、またはファイルを信頼できる場所へ移していないユーザーは、Office 2003 ファイルまたはそれ以前のバージョンを開くことができなくなります。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3334](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3334) をご覧ください。
...
-   **Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から Microsoft Excel の Office 2003 以前のドキュメントを開くことをブロックする**
    ...
    **回避策の影響:** Microsoft Office 2003 および Microsoft Office 2007 について、サポート技術情報 [922848](https://support.microsoft.com/kb/922848) で説明しているように、ファイル ブロックのポリシーを構成している、および特別な「除外されるディレクトリ」を構成していない、またはファイルを信頼できる場所へ移していないユーザーは、Office 2003 ファイルまたはそれ以前のバージョンを開くことができなくなります。
    Microsoft Office 2003 および Microsoft Office 2007 について、ファイル ブロックのポリシーを構成しており、サポート技術情報 [922848](https://support.microsoft.com/kb/922848) で説明されている特別な「除外されるディレクトリ」を構成していないユーザーは、Office 2003 ファイルまたはそれ以前のバージョンを開くことができなくなります。
    Microsoft Office 2010 について、選択された開く動作により、Office 2003 またはそれ以前のバージョンは開かなくなるか、または保護モードで開かれるようになります。
...
-   **未知の、または信頼されないソースからのファイルを開く時、Microsoft Office Isolated Conversion Environment (MOICE) を使用する**
    ...
    MOICE をインストールするためには Word/Excel/PowerPoint 2007 ファイル形式用 Microsoft Office 互換機能パックがインストールされている必要があります。この互換機能パックはマイクロソフト ダウンロード センターから無償でダウンロードできます。 [Word/Excel/PowerPoint 2007 ファイル形式用 Microsoft Office 互換機能パックをダウンロードしてください](https://www.microsoft.com/download/details.aspx?displaylang=ja&=941b3470-3ae9-4aee-8f43-c6bb74cd1466)

    MOICE にはすべての Office プログラムに推奨されているすべての更新プログラムが必要です。Microsoft Update ですべての推奨される更新プログラムをインストールしてください。

    [www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=ja](https://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=ja)
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3335](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3335) をご覧ください。
...
-   **Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から Microsoft PowerPoint の Office 2003 以前のドキュメントを開くことをブロックする**
    ...
    **回避策の影響:** Microsoft Office 2003 および Microsoft Office 2007 について、サポート技術情報 [922848](https://support.microsoft.com/kb/922848) で説明しているように、ファイル ブロックのポリシーを構成している、および特別な「除外されるディレクトリ」を構成していない、またはファイルを信頼できる場所へ移していないユーザーは、Office 2003 ファイルまたはそれ以前のバージョンを開くことができなくなります。Microsoft Office 2010 について、選択された開く動作により、Office 2003 またはそれ以前のバージョンは開かなくなるか、または保護モードで開かれるようになります。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3336](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3336) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3337](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3337) をご覧ください。
...
はい。この脆弱性はマイクロソフト セキュリティ アドバイザリ [2269637](https://technet.microsoft.com/security/advisory/2269637) で説明しているアプリケーションが外部ライブラリをロードする方法に影響する脆弱性の種類に関連します。このセキュリティ情報はこの種類の脆弱性の特別なインスタンスを解決します。
...
-   Microsoft Office 2003 のサポートされているバージョンについては、[Creating an Administrative Installation Point](https://office.microsoft.com/en-us/ork2003/ha011401931033.aspx) (英語情報) をご覧ください。Microsoft Office 2003 のサポートされていないバージョンの管理者用インストール ポイントの場合は、マイクロソフト サポート技術情報 [902349](https://support.microsoft.com/kb/902349) をご覧ください
...
<td style="border:1px solid black;">
サポート技術情報 [2289158](https://support.microsoft.com/kb/2289158) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポート技術情報 [2289161](https://support.microsoft.com/kb/2289161) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
[Microsoft ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=ad1b1984-b2b2-49b3-a1dd-385b77d9248a&displaylang=ja)から Microsoft Office 2008 for Mac 12.2.8 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
この更新プログラムのダウンロードまたは使用における技術的な質問または問題については、[Microsoft for Mac サポート](https://www.microsoft.com/japan/mac/support.aspx)で、利用可能なサポート オプションをご覧ください。
...
[Microsoft ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=8bd6ca3b-8004-4e8d-a09d-220dcbbce799&displaylang=ja) から Microsoft Office 2011 14.0.1 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
この更新プログラムのダウンロードまたは使用における技術的な質問や問題については、[Microsoft for Mac Support](https://www.microsoft.com/mac/support.aspx) (英語情報) で、利用可能なサポート オプションをご覧ください。
...
[Microsoft ダウンロード センター](https://www.microsoft.com/download/details.aspx?familyid=b846d255-a7d4-4a2c-a084-d434c29fe676&displaylang=ja)から Mac 1.1.8 用の Open XML File Format Converter の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
-   「PowerPoint の整数アンダーフローの脆弱性」 - [CVE-2010-2573](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573) を [TippingPoint](https://www.tippingpoint.com/) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して報告してくださった匿名のリサーチャー
-   「RTF のスタック バッファ オーバーフローの脆弱性」 - [CVE-2010-3333](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3333) の問題を VeriSign iDefense Labs と協力して報告してくださった [team509](https://www.team509.com/)
-   「Office アートのレコード描画の脆弱性」 - [CVE-2010-3334](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3334) の問題を報告してくださった [Secunia](https://secunia.com/) の Dyon Balding 氏
-   「Office アートのレコード描画の脆弱性」 - [CVE-2010-3334](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3334) の問題を報告してくださった [CERT Coordination Center](https://www.cert.org/certcc.html) の Will Dorman 氏
-   「描画の例外処理の脆弱性」 - [CVE-2010-3335](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3335) の問題を報告してくださった [TippingPoint の Zero Day Initiative](https://www.zerodayinitiative.com/)
-   「MSO のラージ SPID の読み取り AV の脆弱性」 - [CVE-2010-3336](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3336) の問題を報告してくださった [VUPEN Vulnerability Research Team](https://www.vupen.com/) の Chaouki Bekrar 氏
-   「セキュリティで保護されていないライブラリのロードの脆弱性」 - [CVE-2010-3337](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3337) の問題を報告してくださった [Fortinet の FortiGuard Labs](https://www.fortiguard.com/) の Haifei Li氏
-   「セキュリティで保護されていないライブラリのロードの脆弱性」 - [CVE-2010-3337](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=%20cve-2010-3337) の問題を報告してくださった [ACROS Security](https://www.acrossecurity.com) の Simon Raner 氏
