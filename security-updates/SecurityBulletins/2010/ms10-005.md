---
TOCTitle: 'MS10-005'
Title: 'マイクロソフト セキュリティ情報 MS10-005 - 警告'
ms:assetid: 'ms10-005'
ms:contentKeyID: 61229176
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-005(v=Security.10)'
---
...
[](https://www.microsoft.com/japan/security/bulletins/ms10-005e.mspx)[![](../../images/Dn627162.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
US マイクロソフトセキュリティ情報: [https://www.microsoft.com/technet/security/bulletin/MS10-005.mspx](https://technet.microsoft.com/security/bulletin/ms10-005)
...
![](../../images/Dn627162.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機用または NEC PC-9800 シリーズ用の更新プログラムをダウンロードしてください。
...
|------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                      | [![](../../images/Dn627162.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e5861705-8f49-45cb-8a92-cf052ccf4134&displaylang=ja) | [![](../../images/Dn627162.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e5861705-8f49-45cb-8a92-cf052ccf4134&displaylang=ja-nec) | リモートでコードが実行される | 警告           | なし                                                     |
| Windows XP Service Pack 2 および Windows XP Service Pack 3 | [![](../../images/Dn627162.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b2e70df6-7728-4fc3-8df7-8ddb9ba5202f&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 警告           | なし                                                     |
| Windows XP Professional x64 Edition Service Pack 2         | [![](../../images/Dn627162.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f8c4acc8-c2f4-41f7-9b32-e7bd791e0155&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 警告           | なし                                                     |
| Windows Server 2003 Service Pack 2                         | [![](../../images/Dn627162.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c1efbe73-fc87-4e6a-8b36-81f125a27aec&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 警告           | なし                                                     |
| Windows Server 2003 x64 Edition Service Pack 2             | [![](../../images/Dn627162.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=9143e435-f0d6-464b-9273-4d1f38f8ff3a&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 警告           | なし                                                     |
| Windows Server 2003 with SP2 for Itanium-based Systems     | [![](../../images/Dn627162.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ee603435-26af-4ab9-9f22-92734346dc0a&displaylang=ja) | -                                                                                                                                                                                                     | リモートでコードが実行される | 警告           | なし                                                     |
...
<th style="border:1px solid black;" >MS ペイントの整数のオーバーフローの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0028">CVE-2010-0028</a></th>
...
Microsoft ペイントが JPEG の画像を処理する方法にリモートでコードが実行される脆弱性が存在します。この脆弱性により、ユーザーが Microsoft ペイントで、特別に細工された JPEG の画像ファイルを表示すると、リモートでコードが実行される可能性があります。攻撃者がこの脆弱性を悪用した場合、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-0028](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0028) をご覧ください。
  
#### 「MS ペイントの整数のオーバーフローの脆弱性」の問題を緩和する要素 - CVE-2010-0028:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   既定で、ユーザーが JPEG ファイルをダブルクリックした場合、Windows 画像と FAX ビューアーでこのファイルが表示されます。脆弱性を悪用しようとする場合、攻撃者はユーザーを誘導して、特別に細工したファイルを Microsoft ペイントで開かせる必要があります。  
-   攻撃者は特別に細工したファイルを電子メールの添付で送信する可能性がありますが、この脆弱性が悪用されるには、ユーザーに Microsoft ペイントを使用して添付ファイルを開かせることが攻撃者にとっての必要条件となります。  
...
#### 「MS ペイントの整数のオーバーフローの脆弱性」の回避策 - CVE-2010-0028:
  
回避策は、設定または構成の変更を示しており、基本的な脆弱性を正すものではありませんが、更新プログラムを適用する前に既知の攻撃方法を阻止するのに役立ちます。マイクロソフトは、以下の回避策を検証し、この回避策が機能性を低下させるかどうかについて、説明の部分で述べています。
  
-   Microsoft ペイントを無効にする
  
    32 ビット Windows システムについては、コマンド プロンプトから次のコマンドを実行します。
  
    `cacls %SystemRoot%\system32\mspaint.exe /E /P everyone:N`
  
    64 ビット Windows システムについては、コマンド プロンプトから次のコマンドを実行します。
  
    `cacls %SystemRoot%\SysWOW64\mspaint.exe /E /P everyone:N`
  
    回避策の影響: ユーザーは、Microsoft ペイントを実行できなくなります。
...
-   Windows XP および Windows Server 2003 で、Microsoft ペイントを削除する
  
    1.  \[コントロール パネル\] で、\[プログラムの追加と削除\] をクリックします。  
    2.  \[Windows コンポーネントの追加と削除\] をクリックします。  
    3.  \[Windows コンポーネント ウィザード\] で、\[アクセサリとユーティリティ\] を選択し、\[詳細\] をクリックします。  
    4.  \[アクセサリ\] を選択し、\[詳細\] をクリックします。  
    5.  \[ペイント\] のチェックボックスのチェックを外し、\[OK\] を 2 度クリックします。  
    6.  \[Windows コンポーネント ウィザード\] で \[アクセサリとユーティリティ\] のチェック ボックスがグレーであることを確認し、\[次へ\] をクリックします。  
    7.  ファイルの削除が完了したら、ウィザードを終了するために、\[完了\] をクリックします。
  
    回避策の影響: ユーザーは、Microsoft ペイントを実行できなくなります。
  
    回避策の解除方法: \[プログラムの追加と削除\] の Windows コンポーネント ウィザードを使用して、Microsoft ペイントを再インストールする。
  
#### 「MS ペイントの整数のオーバーフローの脆弱性」のよく寄せられる質問 - CVE-2010-0028:
...
何が原因で起こりますか?  
この脆弱性は、Microsoft ペイントが処理した JPEG の画像を解読する際に、メモリ破損が引き起こされることが原因で起こります。
  
Microsoft ペイントとは何ですか?  
Microsoft ペイントは、シンプルあるいは精巧な図を作成するために使用されるツールです。さらに、Microsoft ペイントはスキャンされる写真の表示および編集のために使用することも可能です。
  
JPEG イメージとは何ですか?  
JPEG とは、プラットフォームに依存しないイメージ形式で、高レベルの圧縮をサポートします。JPEG は、Joint Photographic Experts Group により開発された広範囲にサポートされたインターネット上の標準形式です。
...
攻撃者はユーザーに特別に細工した画像ファイルを開かせる、または表示させ、この脆弱性を悪用する可能性があります。攻撃者は、特別に細工した JPEG の画像ファイルをユーザーに送信し、Microsoft ペイントでそのファイルを表示させる必要があります。
  
主にどのようなコンピューターがこの脆弱性による危険にさらされますか?  
この脆弱性を悪用して悪意のある動作を行うためには、ユーザーがログオンして、JPEG 画像を編集または表示するために Microsoft ペイントを使用する必要があります。このため、この脆弱性の影響を最も受けるのは、ワークステーションまたはターミナル サーバーなど、電子メール メッセージの読み取りが行われる、または Internet Explorer が頻繁に使用されるコンピューターです。
  
この更新プログラムはどのように問題を修正しますか?  
この更新プログラムは Microsoft ペイントが JPEG の画像ファイルを解読する方法を変更することにより、この脆弱性を解決します。
...
Windows2000-KB978706-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows 2000 Service Pack 4:  
Windows2000-KB978706-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows 2000 Service Pack 4:  
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB978706$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows 2000 Service Pack 4:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB978706\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
|-------------|---------------|------------|-------|---------|
| Mspaint.exe | 5.0.2195.7368 | 2009/12/28 | 18:47 | 319,760 |
...
Windowsxp-KB978706-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB978706-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows XP Service Pack 2 および Windows XP Service Pack 3:  
Windowsxp-KB978706-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB978706-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Windows XP Service Pack 2 および Windows XP Service Pack 3:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB978706\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB978706\\Filelist
</td>
</tr>
</table>
...
|-------------|---------------|------------|-------|---------|------------|
| Mspaint.exe | 5.1.2600.3660 | 2009/12/17 | 16:58 | 336,384 | SP2GDR     |
| Mspaint.exe | 5.1.2600.3660 | 2009/12/17 | 16:51 | 336,384 | SP2QFE     |
| Mspaint.exe | 5.1.2600.5918 | 2009/12/17 | 16:40 | 336,384 | SP3GDR     |
| Mspaint.exe | 5.1.2600.5918 | 2009/12/17 | 16:37 | 336,384 | SP3QFE     |

サポートされているすべての x64 エディションの Windows XP:

| ファイル名   | バージョン    | 日付       | 時間  | サイズ  | CPU | フォルダー  |
|--------------|---------------|------------|-------|---------|-----|-------------|
| Mspaint.exe  | 5.2.3790.4638 | 2009/12/17 | 17:01 | 563,712 | x64 | SP2GDR      |
| Wmspaint.exe | 5.2.3790.4638 | 2009/12/17 | 17:01 | 336,896 | x86 | SP2GDR\\WOW |
| Mspaint.exe  | 5.2.3790.4638 | 2009/12/17 | 16:57 | 563,712 | x64 | SP2QFE      |
| Wmspaint.exe | 5.2.3790.4638 | 2009/12/17 | 16:57 | 336,896 | x86 | SP2QFE\\WOW |
...
WindowsServer2003-KB978706-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB978706-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB978706-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB978706-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB978706\\Filelist
</td>
</tr>
</table>
...
| ファイル名  | バージョン    | 日付       | 時間  | サイズ  | フォルダー |
|-------------|---------------|------------|-------|---------|------------|
| Mspaint.exe | 5.2.3790.4638 | 2009/12/17 | 19:31 | 336,896 | SP2GDR     |
| Mspaint.exe | 5.2.3790.4638 | 2009/12/17 | 19:52 | 336,896 | SP2QFE     |

サポートされているすべての Itanium-based エディションの Windows Server 2003:

| ファイル名   | バージョン    | 日付       | 時間  | サイズ    | CPU   | フォルダー  |
|--------------|---------------|------------|-------|-----------|-------|-------------|
| Mspaint.exe  | 5.2.3790.4638 | 2009/12/17 | 16:58 | 1,038,848 | IA-64 | SP2GDR      |
| Wmspaint.exe | 5.2.3790.4638 | 2009/12/17 | 16:58 | 336,896   | x86   | SP2GDR\\WOW |
| Mspaint.exe  | 5.2.3790.4638 | 2009/12/17 | 16:54 | 1,038,848 | IA-64 | SP2QFE      |
| Wmspaint.exe | 5.2.3790.4638 | 2009/12/17 | 16:54 | 336,896   | x86   | SP2QFE\\WOW |
...
-   MS ペイントの整数のオーバー フローの脆弱性 - [CVE-2010-0028](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0028) を [Secunia](https://secunia.com/) と協力して報告してくださった ICST-ERCIS (Engineering Research Center of Info Security, Institute of Computer Science & Technology, Peking University/China) の Tielei Wang 氏
