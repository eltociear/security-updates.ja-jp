---
TOCTitle: 'MS10-080'
Title: 'マイクロソフト セキュリティ情報 MS10-080 - 重要'
ms:assetid: 'ms10-080'
ms:contentKeyID: 61229251
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-080(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS10-080 - 重要
===============================================
...
このセキュリティ更新プログラムは、非公開で報告された 13 件の Microsoft Office に存在する脆弱性を解決します。これらの脆弱性により、ユーザーが特別な細工がされた Excel ファイルまたは特別な細工がされた Lotus 1-2-3 ファイルを開いた場合、リモートでコードが実行される可能性があります。これらの脆弱性が悪用された場合、攻撃者によりローカル ユーザーと同じ権限が取得される可能性があります。システムで、アカウントのユーザー権限を低く設定している場合、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性の影響が少なくなると考えられます。

このセキュリティ更新プログラムは、すべてのサポートされているエディションの Microsoft Excel 2002、Microsoft Excel 2003、Microsoft Excel 2007、Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac、Open XML File Format Converter for Mac、すべてのサポートされているバージョンの Microsoft Excel Viewer および、Microsoft Office 互換機能パックについて、深刻度を「重要」に評価しています。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

この更新プログラムは Microsoft Excel が特別に細工された Excel ファイルおよび特別な細工がされた Lotus 1-2-3 ファイルを解析する方法を変更することにより、これらの脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。

推奨する対応策: マイクロソフトはお客様にできる限り早期にこの更新プログラムを適用することを推奨します。

既知の問題: サポート技術情報 [2293211](https://support.microsoft.com/kb/2293211/) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。
...
![](../../images/Dn636464.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機用の更新プログラムをダウンロードしてください。
...
<td style="border:1px solid black;">
[![](../../images/Dn636464.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ea859881-2cc5-407b-a394-5d00c5d9fd97&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636464.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3d9a00b8-0f80-4d36-b92a-89b61350fb36&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636464.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=dc9b9af5-50b0-4a07-8923-a30fd5548760&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636464.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=464965fa-971a-49dd-bcee-c4d91fac86a9&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636464.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=abd05074-8ffc-41a4-a2f3-1d8047574552&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636464.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5c759c46-ead3-44ea-b7c8-a308b3140d2e&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636464.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=a833a94a-2dc0-4864-9c14-e196dc54c5a7&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636464.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=7391ec2f-12c9-483c-91d8-e3ec5754da1c&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<sup>[1]</sup> Microsoft Excel 2007 Service Pack 2 について、セキュリティ更新プログラム パッケージ 2345035 に加えて、お客様はこのセキュリティ情報で説明している脆弱性から保護するため、Word/Excel/PowerPoint 2007 ファイル形式用 Microsoft Office 互換機能パックの Service Pack 2 (KB2344875) もインストールする必要があります。
...
Microsoft Excel 2002 およびそれ以降のバージョンには、ドキュメントを開く前に、ユーザーに \[開く\]、\[保存\] または \[キャンセル\] の確認メッセージを表示する機能が組み込まれています。 この脆弱性の悪用には、複数のユーザーの操作が攻撃者にとっての必要条件となるため、この脆弱性の問題を緩和する要素によって深刻度が「緊急」から「重要」に軽減されます。
...
MS10-079 は、Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac および Open XML File Format Converter for Mac の脆弱性についても説明しています。MS10-079 はこのセキュリティ情報 (MS10-080) とどのような関連があるのですか?  
このセキュリティ情報 MS10-080 で提供している Microsoft Office 2004 for Mac (KB2422343)、Microsoft Office 2008 for Mac (KB2422352) および Open XML File Format Converter for Mac (KB2422398) 用のセキュリティ更新プログラムは MS10-079 のセキュリティ情報で説明している脆弱性も解決します。Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac または Open XML File Format Converter for Mac をご利用の場合、これらのセキュリティ更新プログラムのインストールが必要なのは 1 回だけです。
...
Office のスタンドアロン プログラムへの影響は、関連の Office スイートのコンポーネントと同じ深刻度です。例えば、Microsoft Excel のスタンドアロンのインストールへの影響は、Office スイートに同梱された Microsoft Excel のインストールと同じ深刻度です。

Microsoft Excel Viewer とは何ですか?  
Excel をインストールしていなくても Excel Viewer で Excel ブックを開く、表示する、印刷することができます。また、Excel Viewer から別のプログラムにデータをコピーすることもできます。しかし、データの編集、ブックの保存、新しいブックの作成はできません。
...
<th style="border:1px solid black;" >
Excel のレコードの解析の整数オーバーフローの脆弱性 - [CVE-2010-3230](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3230)
</th>
<th style="border:1px solid black;" >
Excel レコード解析のメモリ破損の脆弱性 - [CVE-2010-3231](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3231)
</th>
<th style="border:1px solid black;" >
Excel のファイル形式の解析の脆弱性 -[CVE-2010-3232](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3232)
</th>
<th style="border:1px solid black;" >
Lotus 1-2-3 のワークブックの解析の脆弱性 -[CVE-2010-3233](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3233)
</th>
<th style="border:1px solid black;" >
数式のサブシステムのメモリ破損の脆弱性 -[CVE-2010-3234](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3234)
</th>
<th style="border:1px solid black;" >
数式の Biff のレコードの脆弱性 -[CVE-2010-3235](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3235)
</th>
<th style="border:1px solid black;" >
境界外の配列の脆弱性 -[CVE-2010-3236](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3236)
</th>
</tr>
<tr>
...
<th style="border:1px solid black;" >
セルの結合のレコード ポインターの脆弱性 -[CVE-2010-3237](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3237)
</th>
<th style="border:1px solid black;" >
Negative Future Function の脆弱性 -[CVE-2010-3238](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3238)
</th>
<th style="border:1px solid black;" >
その他の境界外のレコードの解析の脆弱性 -[CVE-2010-3239](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3239)
</th>
<th style="border:1px solid black;" >
リアル タイムのデータ配列のレコードの脆弱性 -[CVE-2010-3240](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3240)
</th>
<th style="border:1px solid black;" >
解析における境界外のメモリの書き込みの脆弱性 -[CVE-2010-3241](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3241)
</th>
<th style="border:1px solid black;" >
非実態レコードの種類の解析の脆弱性 -[CVE-2010-3242](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3242)
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
<span></span>
Microsoft Excel が特別に細工された Excel ファイルを処理する方法にリモートでコードが実行される脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。

Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3230](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3230) をご覧ください。

#### 「Excel のレコードの解析の整数オーバーフローの脆弱性」の問題を緩和する要素 - CVE-2010-3230:
...
Microsoft Excel が使用されているコンピュータが主にこの脆弱性による危険にさらされます。管理者がユーザーにサーバーへのログオンおよびプログラムの実行を許可している場合、サーバーが影響を受ける可能性が高くなります。しかし、セキュリティ上の最善策として、これを許可しないことを強く推奨しています。

この更新プログラムはどのように問題を修正しますか?
この更新プログラムは、Microsoft Excel がレコード情報を検証する方法を変更することにより、この脆弱性を解決します。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3231](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3231) をご覧ください。

#### 「Excel レコード解析のメモリ破損の脆弱性」の問題を緩和する要素 - CVE-2010-3231:
...
#### 「Excel レコード解析のメモリ破損の脆弱性」の回避策 - CVE-2010-3231:
...
#### 「Excel レコード解析のメモリ破損の脆弱性」のよく寄せられる質問 - CVE-2010-3231:
...
攻撃者はこの脆弱性をどのように悪用する可能性がありますか?
この脆弱性が悪用されるには、影響を受けるバージョンの Microsoft Excel で、特別に細工された Excel ファイルをユーザーが開くことが攻撃者にとっての必要条件となります。電子メールでの攻撃のシナリオでは、攻撃者は特別に細工された Excel ファイルをユーザーに送信し、ユーザーにそのファイルを開くよう誘導することにより、この脆弱性を悪用する可能性があります。Web ベースの攻撃のシナリオでは、この脆弱性の悪用を意図した Excel ファイルが含まれる Web サイトをホストしていることが攻撃者にとっての必要条件となります。さらに、侵害された Web サイトやユーザー提供のコンテンツを受け入れる、またはホストする Web サイトには、特別に細工したコンテンツが含まれており、この脆弱性が悪用される可能性があります。攻撃者は、特別に細工した Web サイトにユーザーを強制的に訪問させることはできないと考えられます。その代わり、通常ユーザーに攻撃者の Web サイトへのリンクをクリックさせることにより、その Web サイトを訪問させ、その後、ユーザーに特別に細工された Excel ファイルを表示させることが攻撃者にとっての必要条件となります。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3232](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3232) をご覧ください。

#### 「Excel のファイル形式の解析の脆弱性」の問題を緩和する要素 - CVE-2010-3232:
...
#### 「Excel のファイル形式の解析の脆弱性」の回避策 - CVE-2010-3232:
...
- 未知の、または信頼されないソースからのファイルを開く時、Microsoft Office Isolated Conversion Environment (MOICE) を使用する
  ...
  Microsoft Office Isolated Conversion Environment (MOICE) は、Word、Excel および PowerPoint のバイナリ フォーマット ファイルをより保護された方法で開くことで、Office 2003 がインストールされた環境の保護に役立ちます。
  ...
  [Web サイト](https://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=ja)をご覧ください。

  MOICE を有効にする

  注意: 自動化された “Microsoft Fix it” ソリューションを使用してこの回避策を有効または無効にするには、サポート技術情報 [935865](https://technet.microsoft.com/ja-JP/library///support.microsoft.com/kb/935865(v=Security.10)) をご覧ください。手動で MOICE を有効にするには、次の一覧で指定されているようにコマンドを実行します。コマンドを実行することにより、Office アプリケーションが MOICE と関連します。
...
#### 「Excel のファイル形式の解析の脆弱性」のよく寄せられる質問 - CVE-2010-3232:

どのようなことが起こる可能性がありますか?
これはリモートでコードが実行される脆弱性です。攻撃者はこの脆弱性を悪用し、影響を受けるコンピューターをリモートで完全に制御する可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。

何が原因で起こりますか?
Microsoft Excel が特別に細工された Excel ファイルを開く時の Excel のファイル形式を解析する方法のため、この脆弱性が存在します。

この脆弱性により、攻撃者は何を行う可能性がありますか?
攻撃者がこの脆弱性を悪用した場合、ログオン ユーザーとして任意のコードを実行する可能性があります。ユーザーが管理者ユーザー権限でログオンしている場合、攻撃者が影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。システムで、アカウントのユーザー権限を低く設定している場合、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性の影響が少なくなると考えられます。

攻撃者はこの脆弱性をどのように悪用する可能性がありますか?
この脆弱性が悪用されるには、影響を受けるバージョンの Microsoft Excel で、特別に細工された Excel ファイルをユーザーが開くことが必要となります。
...
主にどのようなコンピューターがこの脆弱性による危険にさらされますか?
主に、ワークステーションやターミナル サーバーなど、Microsoft Excel を使用しているシステムが、この脆弱性による危険にさらされます。管理者がユーザーにサーバーへのログオンおよびプログラムの実行を許可している場合、サーバーが影響を受ける可能性が高くなります。しかし、セキュリティ上の最善策として、これを許可しないことを強く推奨しています。

この更新プログラムはどのように問題を修正しますか?
この更新プログラムは Microsoft Excel が特別に細工された Excel ファイルを解析する方法を変更することにより、この脆弱性を解決します。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3233](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3233) をご覧ください。

#### 「Lotus 1-2-3 のワークブックの解析の脆弱性」の問題を緩和する要素 - CVE-2010-3233:
...
#### 「Lotus 1-2-3 のワークブックの解析の脆弱性」の回避策 - CVE-2010-3233:
...
#### 「Lotus 1-2-3 のワークブックの解析の脆弱性」のよく寄せられる質問 - CVE-2010-3233:

どのようなことが起こる可能性がありますか?
これはリモートでコードが実行される脆弱性です。攻撃者はこの脆弱性を悪用し、影響を受けるコンピューターをリモートで完全に制御する可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。

何が原因で起こりますか?
Microsoft Excel が特別な細工がされた Lotus 1-2-3 ファイルを解析する時、攻撃者が任意のコードを実行する可能性のある方法でシステム メモリが破損する可能性があるため、この脆弱性が起こります。

なぜこの脆弱性は Microsoft Excel 2003 Service Pack 3 で深刻度「警告」と評価されているのですか?
既定で、Lotus 1-2-3 ファイルを開くことは Microsoft Excel 2003 Service Pack 3 では禁止されています。この問題を緩和する要素は Microsoft Excel 2003 Service Pack 3 についての CVE-2010-3233 の深刻度の評価を下げます。Microsoft Office 2003 Service Pack 3 をインストールした後、ブロックされるファイルの種類に関する詳細情報は、サポート技術情報 [938810](https://support.microsoft.com/kb/938810) をご覧ください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3234](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3234) をご覧ください。

#### 「数式のサブシステムのメモリ破損の脆弱性」の問題を緩和する要素 - CVE-2010-3234:
...
#### 「数式のサブシステムのメモリ破損の脆弱性」の回避策 - CVE-2010-3234:
...
#### 「数式のサブシステムのメモリ破損の脆弱性」のよく寄せられる質問 - CVE-2010-3234:

どのようなことが起こる可能性がありますか?
これはリモートでコードが実行される脆弱性です。攻撃者はこの脆弱性を悪用し、影響を受けるコンピューターをリモートで完全に制御する可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。

何が原因で起こりますか?
Microsoft Excel が特別な細工がされた Excel ファイルを開く際の数式の情報を検証する時に、攻撃者が任意のコードを実行する可能性のある方法でメモリ処理のエラーがシステム メモリを破損する可能性があるため、この脆弱性が起こります。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3235](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3235) をご覧ください。

#### 「数式の Biff のレコードの脆弱性」の問題を緩和する要素 - CVE-2010-3235:
...
#### 「数式の Biff のレコードの脆弱性」の回避策 - CVE-2010-3235:
...
#### 「数式の Biff のレコードの脆弱性」のよく寄せられる質問 - CVE-2010-3235:
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3236](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3236) をご覧ください。

#### 「境界外の配列の脆弱性」の問題を緩和する要素 - CVE-2010-3236:
...
-   Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から Office 2003 以前のドキュメントを開くことをブロックする
  ...
  -   Office 2003
    ...
    回避策の影響 : ファイル ブロックのポリシーを構成しており、サポート技術情報 [922848](https://support.microsoft.com/kb/922848) で説明している特別な「除外されるディレクトリ」を構成していないユーザーは、Office 2003 ファイルまたは それ以前のバージョンを開くことができなくなります。
...
#### 「境界外の配列の脆弱性」のよく寄せられる質問 - CVE-2010-3236:
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3237](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3237) をご覧ください。

#### 「セルの結合のレコード ポインターの脆弱性」の問題を緩和する要素 - CVE-2010-3237:
...
#### 「セルの結合のレコード ポインターの脆弱性」の回避策 - CVE-2010-3237:
...
#### 「セルの結合のレコード ポインターの脆弱性」のよく寄せられる質問 - CVE-2010-3237:
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3238](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3238) をご覧ください。

#### 「Negative Future Function の脆弱性」の問題を緩和する要素 - CVE-2010-3238:
...
#### 「Negative Future Function の脆弱性」の回避策 - CVE-2010-3238:
...
#### 「Negative Future Function の脆弱性」のよく寄せられる質問 - CVE-2010-3238:
...
この更新プログラムはどのように問題を修正しますか?
この更新プログラムは、Microsoft Excel がバイナリ ファイルの形式の情報を検証する方法を変更することにより、この脆弱性を解決します。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3239](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3239) をご覧ください。

#### 「その他の境界外のレコードの解析の脆弱性」の問題を緩和する要素 - CVE-2010-3239:
...
#### 「その他の境界外のレコードの解析の脆弱性」の回避策 - CVE-2010-3239:
...
#### 「その他の境界外のレコードの解析の脆弱性」のよく寄せられる質問 - CVE-2010-3239:
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3240](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3240) をご覧ください。

#### 「リアル タイムのデータ配列のレコードの脆弱性」の問題を緩和する要素 - CVE-2010-3240:
...
#### 「リアル タイムのデータ配列のレコードの脆弱性」の回避策 - CVE-2010-3240:
...
#### 「リアル タイムのデータ配列のレコードの脆弱性」のよく寄せられる質問 - CVE-2010-3240:
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3241](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3241) をご覧ください。

#### 「解析における境界外のメモリの書き込みの脆弱性 」の問題を緩和する要素 - CVE-2010-3241:
...
#### 「解析における境界外のメモリの書き込みの脆弱性 」の回避策 - CVE-2010-3241:
...
#### 「解析における境界外のメモリの書き込みの脆弱性 」のよく寄せられる質問 - CVE-2010-3241:
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3242](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3242) をご覧ください。

#### 「非実態レコードの種類の解析の脆弱性 」の問題を緩和する要素 - CVE-2010-3242:
...
#### 「非実態レコードの種類の解析の脆弱性 」の回避策 - CVE-2010-3242:
...
#### 「非実態レコードの種類の解析の脆弱性 」のよく寄せられる質問 - CVE-2010-3242:
...
-   Microsoft Office XP のサポートされているバージョンについては、[製品の更新プログラムを管理者インストールポイントから適用する](https://office.microsoft.com/en-us/orkxp/ha011.6.191033.aspx) (英語情報) をご覧ください。更新された管理者用インストール ポイントから Office XP の元のベースライン ソースにクライアント コンピューターのソースを変更する方法に関する詳細情報は、マイクロソフト サポート技術情報 [922665](https://support.microsoft.com/kb/922665) をご覧ください。
...
<td style="border:1px solid black;">
officexp-KB2345017-FullFile-JPN /q:a
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
officexp-KB2345017-FullFile-JPN /r:n
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Excel 2002 のすべてのサポートされているバージョン (KB2264397)

| ファイル名 | バージョン  | 日付       | 時間  | サイズ    |
|------------|-------------|------------|-------|-----------|
| Excel.exe  | 10.0.6866.0 | 2010/09/30 | 10:01 | 9,361,232 |
...
<td style="border:1px solid black;">
office2003-KB2344893-FullFile-JPN /q:a
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
office2003-KB2344893-FullFile-JPN /r:n
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Excel 2003 のすべてのサポートされているバージョン (KB2264403)

| ファイル名 | バージョン  | 日付       | 時間  | サイズ     |
|------------|-------------|------------|-------|------------|
| Excel.exe  | 11.0.8328.0 | 2010/08/22 | 14:57 | 10,354,512 |
...
<td style="border:1px solid black;">
Excel 2007:  
excel2007-kb2345035-fullfile-x86-glb /passive  
Excel Viewer:  
Office-kb2345088-fullfile-x86-glb /passive
  
Word/Excel/PowerPoint 2007 ファイル形式用 Microsoft Office 互換機能パック:  
office2007-kb2344875-fullfile-x86-glb /passive
...
<td style="border:1px solid black;">
Excel 2007:  
excel2007-kb2345035-fullfile-x86-glb /norestart  
Excel Viewer:  
Office-kb2345088-fullfile-x86-glb /norestart
  
Word/Excel/PowerPoint 2007 ファイル形式用 Microsoft Office 互換機能パック:  
office2007-kb2344875-fullfile-x86-glb /norestart
...
Excel 2007 のすべてのサポートされているエディション (kb2345035)

| ファイル名 | バージョン     | 日付       | 時間  | サイズ     |
|------------|----------------|------------|-------|------------|
| Excel.exe  | 12.0.6545.5000 | 2010/08/13 | 13:06 | 18,354,024 |

Excel Viewer のすべてのサポートされているエディション (kb2345088)

| ファイル名 | バージョン     | 日付       | 時間  | サイズ     |
|------------|----------------|------------|-------|------------|
| Xlview.exe | 12.0.6545.5000 | 2010/08/11 | 22:00 | 13,235,576 |

Word、Excel および PowerPoint 2007 ファイル形式用 Microsoft Office 互換機能パックのすべてのサポートされているエディション (kb2344875)

| ファイル名   | バージョン     | 日付       | 時間  | サイズ     |
|--------------|----------------|------------|-------|------------|
| Excelcnv.exe | 12.0.6545.5000 | 2010/08/11 | 21:47 | 15,130,472 |
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/japan/mac/download/default.mspx)から Microsoft Office 2004 for Mac 11.6.1 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/japan/mac/download/default.mspx)から Open XML File Format Converter for Mac 1.1.7 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。

-   ウイルス対策アプリケーション、すべての Microsoft Office アプリケーション、Microsoft Messenger for Mac および Office Notifications などのすべての実行されているアプリケーションを終了します。この理由は、これらのアプリケーションがインストールを干渉する可能性があるためです。
-   デスクトップの \[Open XML File Format Converter for Mac 1.1.7 Update\] ボリュームを開きます。このステップは自動で実行される場合もあります。
...
-   インストールが正常に終了すると、ハード ディスクから更新プログラムのインストーラーを削除することができます。インストールが正常に終了したことを確認するためには、「更新プログラムが正しくインストールされたかどうか確認する方法」のセクションをご覧ください。更新プログラムのインストーラーを削除するためには、まず Open XML File Format Converter for Mac 1.1.7 Update ボリュームを \[ごみ箱\] にドラッグし、次にダウンロードしたファイルを \[ごみ箱\] にドラッグします。
...
-   Excel のレコードの解析の整数オーバーフローの脆弱性 [CVE-2010-3230](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3230) を報告してくださった [Secunia](https://secunia.com/) の Alin Rad Pop 氏
-   Excel レコード解析のメモリ破損の脆弱性 - [CVE-2010-3231](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3231) を報告してくださった [VUPEN Vulnerability Research Team](https://www.vupen.com/) の Chaouki Bekrar 氏
-   Excel のファイル形式の解析の脆弱性 - [CVE-2010-3232](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3232) を報告してくださった Omair 氏
-   Lotus 1-2-3 のワークブックの解析の脆弱性 - [CVE-2010-3233](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3233) を報告してくださった [Secunia](https://secunia.com/) の Carsten H. Eiram 氏
-   数式のサブシステムのメモリ破損の脆弱性 - [CVE-2010-3234](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3234) を報告してくださった [VUPEN Vulnerability Research Team](https://www.vupen.com/) の Chaouki Bekrar 氏
-   数式の Biff のレコードの脆弱性 - [CVE-2010-3235](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3235) を報告してくださった [VUPEN Vulnerability Research Team](https://www.vupen.com/) の Chaouki Bekrar 氏
-   境界外の配列の脆弱性 - [CVE-2010-3236](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3236) を報告してくださった [VUPEN Vulnerability Research Team](https://www.vupen.com/) の Chaouki Bekrar 氏
-   セルの結合のレコード ポインターの脆弱性 - [CVE-2010-3237](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3237) を報告してくださった [VUPEN Vulnerability Research Team](https://www.vupen.com/) の Chaouki Bekrar 氏
-   数式の Biff のレコードの脆弱性 - [CVE-2010-3238](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3238) を報告してくださった [VUPEN Vulnerability Research Team](https://www.vupen.com/) の Chaouki Bekrar 氏
-   その他の境界外のレコードの解析の脆弱性 - [CVE-2010-3239](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3239) を報告してくださった [VUPEN Vulnerability Research Team](https://www.vupen.com/) の Chaouki Bekrar 氏
-   その他の境界外のレコードの解析の脆弱性 - [CVE-2010-3239](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3239) を報告してくださった [Secunia](https://secunia.com/) の Alin Rad Pop 氏
-   リアル タイムのデータ配列のレコードの脆弱性 - [CVE-2010-3240](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3240) を報告してくださった [VUPEN Vulnerability Research Team](https://www.vupen.com/) の Chaouki Bekrar 氏
-   解析における境界外のメモリの書き込みの脆弱性 - [CVE-2010-3241](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3241) を報告してくださった [VUPEN Vulnerability Research Team](https://www.vupen.com/) の Chaouki Bekrar 氏
-   非実態レコードの種類の解析の脆弱性 - [CVE-2010-3242](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3242) を報告してくださった [VUPEN Vulnerability Research Team](https://www.vupen.com/) の Chaouki Bekrar 氏
-   非実態レコードの種類の解析の脆弱性 - [CVE-2010-3242](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3242) を報告してくださった [Secunia](https://secunia.com/) の Carsten H. Eiram 氏
