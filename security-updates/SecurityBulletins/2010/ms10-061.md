---
TOCTitle: 'MS10-061'
Title: 'マイクロソフト セキュリティ情報 MS10-061 - 緊急'
ms:assetid: 'ms10-061'
ms:contentKeyID: 61229232
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-061(v=Security.10)'
---


マイクロソフト セキュリティ情報 MS10-061 - 緊急
===============================================

印刷スプーラー サービスの脆弱性により、リモートでコードが実行される (2347290)
-----------------------------------------------------------------------------

公開日: 2010年9月15日 | 最終更新日: 2010年9月30日

**バージョン:** 1.0

[](https://www.microsoft.com/japan/security/bulletins/ms10-061e.mspx)[![](../../images/Dn636445.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
このセキュリティ更新プログラムは、印刷スプーラー サービスがアクセス許可を検証する方法を修正して、この脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。
...
**既知の問題:** サポート技術情報 [2347290](https://support.microsoft.com/kb/2347290) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。また、この記事では、これらの問題の推奨される解決策に関する説明も記載しています。

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS10-061.mspx](https://technet.microsoft.com/security/bulletin/ms10-061)
...
![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム/ソフトウェア                                                                            | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響       | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報 |
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Windows XP Service Pack 3                                                                                         | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=93faba6b-0a85-4acc-b527-a012bbf56b13&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows XP Professional x64 Edition Service Pack 2                                                                | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=9f7f3737-056d-44bd-b644-51093b5b501b&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Server 2003 Service Pack 2                                                                                | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3d79680b-c071-462f-9cea-551fbd42edf0&displaylang=ja) | 特権の昇格                   | 重要           | なし                                                     |
| Windows Server 2003 x64 Edition Service Pack 2                                                                    | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=073b3305-4a81-4ef8-b6aa-e53b31a936b4&displaylang=ja) | 特権の昇格                   | 重要           | なし                                                     |
| Windows Server 2003 with SP2 for Itanium-based Systems                                                            | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ca35a520-c4da-41bb-abcc-d5bc534ff19a&displaylang=ja) | 特権の昇格                   | 重要           | なし                                                     |
| Windows Vista Service Pack 1 および Windows Vista Service Pack 2                                                  | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=028977fd-0f39-42d4-9fee-0d90a2931cfd&displaylang=ja) | 特権の昇格                   | 重要           | なし                                                     |
| Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2                          | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c68b9337-883d-4e98-ba0a-90b5cad46184&displaylang=ja) | 特権の昇格                   | 重要           | なし                                                     |
| Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2\*             | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e2e788de-8400-4bf6-b96b-a915154aa20a&displaylang=ja) | 特権の昇格                   | 重要           | なし                                                     |
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2\*       | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e08d4f49-5a13-4e1d-b0a7-27b314c2edb5&displaylang=ja) | 特権の昇格                   | 重要           | なし                                                     |
| Windows Server 2008 for Itanium-based Systems および Windows Server 2008 for Itanium-based Systems Service Pack 2 | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=098537d5-bf6e-4e04-ad33-1cde697e062f&displaylang=ja) | 特権の昇格                   | 重要           | なし                                                     |
| Windows 7 for 32-bit Systems                                                                                      | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=34619e9e-1f00-40e4-be6f-5bbf5e3c801b&displaylang=ja) | 特権の昇格                   | 重要           | なし                                                     |
| Windows 7 for x64-based Systems                                                                                   | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=dbb747a5-658d-44cf-bd49-425d1700157f&displaylang=ja) | 特権の昇格                   | 重要           | なし                                                     |
| Windows Server 2008 R2 for x64-based Systems\*                                                                    | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=11e20088-1be2-4166-9c97-234b7e9f1c4f&displaylang=ja) | 特権の昇格                   | 重要           | なし                                                     |
| Windows Server 2008 R2 for Itanium-based Systems                                                                  | [![](../../images/Dn636445.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=d8c635f8-8978-44bf-b457-e07368f08ef4&displaylang=ja) | 特権の昇格                   | 重要           | なし                                                     |
...
**どうしてこの脆弱性は Windows XP のシステムで高い深刻度なのですか?**  
Windows XP では、ゲスト アカウントが既定で有効にされ、匿名のユーザーがプリンター共有にアクセスできます。Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 および Windows Server 2008 R2 では、パスワード ベースの共有が無効にされない限り、攻撃者がこの脆弱性を悪用するには、認証を受ける必要があります。パスワード ベースの共有が無効にされている場合、認証を受けなくても、攻撃者にこれらのシステムが悪用される場合があります。
...
次の深刻度の評価は脆弱性による影響が最大であった場合を前提としています。このセキュリティ情報のリリース後 30 日以内に、深刻度の評価およびセキュリティ上の影響に関連する脆弱性が悪用される可能性に関する情報は、[9 月 のセキュリティ情報](https://technet.microsoft.com/security/bulletin/ms10-sep)の「Exploitability Index (悪用可能性指標)」のセクションをご覧ください。詳細については、[Microsoft Exploitability Index (悪用可能性指標)](https://technet.microsoft.com/security/cc998259.aspx)をご覧ください。
...
<th style="border:1px solid black;" >印刷スプーラー サービスのなりすましの脆弱性 - <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729">CVE-2010-2729</a></th>
...
印刷スプーラー サービスのなりすましの脆弱性 - CVE-2010-2729  
-----------------------------------------------------------
  
Windows 印刷スプーラー サービスにリモートでコードが実行される脆弱性が存在し、リモートの認証されていない攻撃者が影響を受ける Windows XP のシステムで、任意のコードを実行する可能性があります。攻撃者がこの脆弱性を悪用した場合、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または新たなアカウントを作成する可能性があります。これは、その他のすべてのサポートされている Microsoft Windows システムの特権の昇格の脆弱性です。
  
Common Vulnerabilities および Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-2729](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729) をご覧ください。
  
#### 「印刷スプーラー サービスのなりすましの脆弱性」の問題を緩和する要素 - CVE-2010-2729:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   既定で、プリンターは現在サポート中のいずれの Windows のオペレーティング システムでも共有されていません。  
-   システムが影響を受けるのは、プリンターを共有した場合およびリモートの攻撃者がプリンター共有にアクセス可能な場合だけです。  
...
#### 「印刷スプーラー サービスのなりすましの脆弱性」の回避策 - CVE-2010-2729:
...
-   **ファイアウォールで RPC に関連するポートをブロックする**
    ...
    **回避策の解除方法** **:** ファイアウォールでの UDP ポート 135、137、138 および 445、TCP ポート 135、139、445 および 593 のブロックを解除します。ポートに関する詳細情報は、[TCP and UDP Port Assignments](https://technet.microsoft.com/ja-jp/library/cc977599.aspx) (英語情報) をご覧ください。
  
-   **プリンターの共有を無効にする**
  
    プリンター共有を無効にするには、次の動作を実行してください。
  
    Windows XP および Windows 2003 のシステム
  
    1.  \[スタート\] をクリックして、\[プリンターとファックス\] をクリックします。  
    2.  プリンターのアイコンを右クリックし、\[共有\] をクリックします。  
    3.  \[このプリンタを共有しない\] を選択し、\[OK\] をクリックします。  
    4.  システムで共有している各プリンターについて、このプロセスを繰り返します。
  
    それ以降のすべての Windows のオペレーティング システム
  
    1.  \[スタート\] をクリックして、\[デバイスとプリンター\] をクリックします。  
    2.  プリンターのアイコンを右クリックし、\[プリンターのプロパティ\] をクリックします。  
    3.  \[共有\] タブを選択します。  
    4.  \[プリンタを共有する\] オプションが選択されていないことを確認し、\[OK\] をクリックします。  
    5.  システムで共有している各プリンターについて、このプロセスを繰り返します。
  
    **回避策の影響** **:** この機能を無効にすると、リモート ユーザーは影響を受けるプリンターに印刷できなくなります。
    ...
    **回避策の解除方法** **:**
    ...
    1.  \[スタート\] をクリックして、\[プリンターとファックス\] をクリックします。  
    2.  プリンターのアイコンを右クリックし、\[共有\] を選択します。  
    3.  \[このプリンタを共有する\] を選択し、\[OK\] をクリックします。  
    4.  システムで共有している各プリンターについて、このプロセスを繰り返します。
    ...
    2.  プリンターのアイコンを右クリックし、\[プリンターのプロパティ\] をクリックします。  
    3.  \[共有\] タブを選択します。  
    4.  \[このプリンタを共有する\] オプションを選択し、\[OK\] をクリックします。  
    5.  システムで共有している各プリンターについて、このプロセスを繰り返します。
  
#### 「印刷スプーラー サービスのなりすましの脆弱性」のよく寄せられる質問 - CVE-2010-2729:
  
**どのようなことが起こる可能性がありますか?**  
これはリモートでコードが実行される脆弱性です。攻撃者がこの脆弱性を悪用した場合、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または新たなアカウントを作成する可能性があります。
  
**何が原因で起こりますか?**  
この脆弱性は、Windows 印刷スプーラーが、ユーザーの印刷スプーラーへのアクセス許可を十分に制限しない場合に起こります。
  
**印刷スプーラー サービスとは何ですか?**  
印刷スプーラー サービスは実行可能ファイルで、サービスとしてインストールされています。このスプーラーはオペレーティング システムが起動した際にロードされ、オペレーティング システムがシャット ダウンするまで実行し続けます。印刷スプーラー サービスは、プリンター ドライバーの正しい場所の取得、そのドライバーのロード、印刷ジョブに高度な機能をスプールする、さらに印刷ジョブのスケジューリングのようなタスクなど、印刷プロセスを管理します。特定の印刷ジョブのタスクが完了すると、印刷スプーラー サービスは印刷ルーターへジョブを渡します。詳細情報は、TechNet の記事： [How Network Printing Works](https://technet.microsoft.com/library/cc783789(ws.10).aspx) (英語情報) をご覧ください。
  
**この脆弱性により、攻撃者は何を行う可能性がありますか?**  
攻撃者はこの脆弱性を悪用し、システム特権で、ユーザーのコンピューターで任意のコードを実行する可能性があります。攻撃者がこの脆弱性を悪用した場合、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または新たなアカウントを作成する可能性があります。
  
**攻撃者はこの脆弱性をどのように悪用する可能性がありますか?**  
攻撃者がこの脆弱性を悪用した場合、RPC で印刷スプーラーのインターフェイスを公開している影響を受けるシステムに、悪質な印刷リクエストを作成および送信する可能性があります。この標的のシステムは、リモート ユーザーが十分なアクセス許可を取得しているかどうかを正しく検証せず、リモートの攻撃者が Windows のシステム ディレクトリでファイルを作成できるように許可します。特別な場所に配置した場合、これらのファイルが自動的にシステムで実行される可能性があります。
  
**主にどのようなコンピューターがこの脆弱性による危険にさらされますか?**  
主に、プリンターまたは印刷サーバーを共有しているワークステーションおよびターミナル サーバーが影響を受けます。管理者がユーザーにサーバーへのログオンおよびプログラムの実行を許可している場合、サーバーが影響を受ける可能性が高くなります。しかし、セキュリティ上の最善策として、これを許可しないことを強く推奨しています。
  
**この更新プログラムはどのように問題を修正しますか?**  
この更新プログラムは、印刷スプーラー サービスが印刷スプーラーへのアクセス許可を検証する方法を修正して、この脆弱性を解決します。
  
**このセキュリティ情報のリリース時に、この脆弱性は一般に公開されていましたか?**  
はい。この脆弱性は一般に知られていました。これは Common Vulnerability および Exposure の [CVE-2010-2729](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729) にアサインされています。
  
**このセキュリティ情報の公開時に、マイクロソフトはこの脆弱性が悪用されたという報告を受けていましたか?**  
はい。このセキュリティ情報が公開された際に、この脆弱性はマルウェアにより、限定的な規模で悪用されていました。
...
Windowsxp-KB2347290-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2347290-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB2347290-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB2347290-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB2347290$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB2347290\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB2347290\\Filelist
</td>
</tr>
</table>
...
|-------------|---------------|------------|-------|--------|------------|
| Spoolsv.exe | 5.1.2600.6024 | 2010/08/17 | 22:17 | 58,880 | SP3GDR     |
| Spoolsv.exe | 5.1.2600.6024 | 2010/08/17 | 22:19 | 58,880 | SP3QFE     |

サポートされているすべての x64 エディションの Windows XP:

| ファイル名  | バージョン    | 日付       | 時間  | サイズ  | CPU | フォルダー |
|-------------|---------------|------------|-------|---------|-----|------------|
| Spoolsv.exe | 5.2.3790.4759 | 2010/08/18 | 01:33 | 112,128 | x64 | SP2GDR     |
| Spoolsv.exe | 5.2.3790.4759 | 2010/08/18 | 01:28 | 112,128 | x64 | SP2QFE     |
...
WindowsServer2003-KB2347290-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2347290-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2347290-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB2347290-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2347290\\Filelist
</td>
</tr>
</table>
...
| ファイル名  | バージョン    | 日付       | 時間  | サイズ | フォルダー |
|-------------|---------------|------------|-------|--------|------------|
| Spoolsv.exe | 5.2.3790.4759 | 2010/08/18 | 04:26 | 58,880 | SP2GDR     |
| Spoolsv.exe | 5.2.3790.4759 | 2010/08/18 | 04:35 | 58,880 | SP2QFE     |

サポートされているすべての Itanium-based エディションの Windows Server 2003:

| ファイル名  | バージョン    | 日付       | 時間  | サイズ  | CPU   | フォルダー |
|-------------|---------------|------------|-------|---------|-------|------------|
| Spoolsv.exe | 5.2.3790.4759 | 2010/08/18 | 01:29 | 150,016 | IA-64 | SP2GDR     |
| Spoolsv.exe | 5.2.3790.4759 | 2010/08/18 | 01:26 | 150,016 | IA-64 | SP2QFE     |
...
Windows6.0-KB2347290-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2347290-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Vista:  
Windows6.0-KB2347290-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows Vista:  
Windows6.0-KB2347290-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
|-------------|----------------|------------|-------|---------|
| Spoolsv.exe | 6.0.6001.18511 | 2010/08/17 | 22:32 | 126,464 |
| Spoolsv.exe | 6.0.6001.22743 | 2010/08/17 | 22:27 | 128,000 |
| Spoolsv.exe | 6.0.6002.18294 | 2010/08/17 | 23:11 | 128,000 |
| Spoolsv.exe | 6.0.6002.22468 | 2010/08/17 | 23:20 | 128,000 |

サポートされているすべての x64 エディションの Windows Vista:

| ファイル名  | バージョン     | 日付       | 時間  | サイズ  | CPU |
|-------------|----------------|------------|-------|---------|-----|
| Spoolsv.exe | 6.0.6001.18511 | 2010/08/17 | 23:04 | 267,776 | x64 |
| Spoolsv.exe | 6.0.6001.22743 | 2010/08/17 | 23:02 | 270,848 | x64 |
| Spoolsv.exe | 6.0.6002.18294 | 2010/08/17 | 23:54 | 273,920 | x64 |
| Spoolsv.exe | 6.0.6002.22468 | 2010/08/17 | 23:54 | 273,920 | x64 |
...
Windows6.0-KB2347290-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2347290-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| ファイル名  | バージョン     | 日付       | 時間  | サイズ  | CPU   |
|-------------|----------------|------------|-------|---------|-------|
| Spoolsv.exe | 6.0.6001.18511 | 2010/08/17 | 22:46 | 435,200 | IA-64 |
| Spoolsv.exe | 6.0.6001.22743 | 2010/08/17 | 22:47 | 440,320 | IA-64 |
| Spoolsv.exe | 6.0.6002.18294 | 2010/08/17 | 23:25 | 470,528 | IA-64 |
| Spoolsv.exe | 6.0.6002.22468 | 2010/08/17 | 23:26 | 470,528 | IA-64 |
...
Windows6.1-KB2347290-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2347290-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows 7:  
Windows6.1-KB2347290-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows 7:  
Windows6.1-KB2347290-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| ファイル名  | バージョン     | 日付       | 時間  | サイズ  |
|-------------|----------------|------------|-------|---------|
| Spoolsv.exe | 6.1.7600.16661 | 2010/08/21 | 14:32 | 316,928 |
| Spoolsv.exe | 6.1.7600.20785 | 2010/08/20 | 13:25 | 316,928 |
| Spoolsv.exe | 6.1.7600.16661 | 2010/08/21 | 14:32 | 316,928 |
| Spoolsv.exe | 6.1.7600.20785 | 2010/08/20 | 13:25 | 316,928 |
...
| ファイル名  | バージョン     | 日付       | 時間  | サイズ  | CPU |
|-------------|----------------|------------|-------|---------|-----|
| Spoolsv.exe | 6.1.7600.16661 | 2010/08/21 | 15:29 | 558,592 | x64 |
| Spoolsv.exe | 6.1.7600.20785 | 2010/08/20 | 14:38 | 559,104 | x64 |
| Spoolsv.exe | 6.1.7600.16661 | 2010/08/21 | 15:29 | 558,592 | x64 |
| Spoolsv.exe | 6.1.7600.20785 | 2010/08/20 | 14:38 | 559,104 | x64 |
...
Windows6.1-KB2347290-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2347290-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| ファイル名  | バージョン     | 日付       | 時間  | サイズ    | CPU   |
|-------------|----------------|------------|-------|-----------|-------|
| Spoolsv.exe | 6.1.7600.16661 | 2010/08/21 | 14:27 | 1,084,928 | IA-64 |
| Spoolsv.exe | 6.1.7600.20785 | 2010/08/20 | 13:17 | 1,085,440 | IA-64 |
...
-   「印刷スプーラー サービスのなりすましの脆弱性」 - [CVE-2010-2729](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729) の 問題を報告してくださった [Kaspersky Lab](https://www.kaspersky.com/) の Sergey Golovanov 氏、Alexander Gostev 氏、Maxim Golovkin 氏および Alexey Monastyrsky 氏、 [Design and Test Lab](https://www.dnt-lab.com/) の Vitaly Kiktenko 氏および Alexander Saprykin 氏
-   「印刷スプーラー サービスのなりすましの脆弱性」 - [CVE-2010-2729](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729) の 問題を報告してくださった [Symantec](https://www.symantec.com/index.jsp) 社の Liam O Morchu 氏
...
-   2010/09/30: このセキュリティ情報を更新し、「概説」の「既知の問題」に、サポート技術情報 2347290 のリンク先を追加しました。
