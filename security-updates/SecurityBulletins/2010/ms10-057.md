---
TOCTitle: 'MS10-057'
Title: 'マイクロソフト セキュリティ情報 MS10-057 - 重要'
ms:assetid: 'ms10-057'
ms:contentKeyID: 61229228
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-057(v=Security.10)'
---


マイクロソフト セキュリティ情報 MS10-057 - 重要
===============================================
...
[](https://www.microsoft.com/japan/security/bulletins/ms10-057e.mspx)[![](../../images/Dn636440.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
このセキュリティ更新プログラムは、すべてのサポートされているエディションの Microsoft Office Excel 2002、Microsoft Office Excel 2003、Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac および Open XML File Format Converter for Mac について、深刻度を「重要」に評価しています。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

この更新プログラムは Microsoft Office Excel が特別に細工された Excel ファイルを解析する方法を変更することにより、この脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。

**推奨する対応策:** マイクロソフトはお客様にできる限り早期にこの更新プログラムを適用することを推奨します。

**既知の問題:** サポート技術情報 [2269707](https://support.microsoft.com/kb/2269707/) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。

**US** **マイクロソフトセキュリティ情報:** [https://www.microsoft.com/technet/security/bulletin/MS10-057.mspx](https://technet.microsoft.com/security/bulletin/ms10-057)
...
![](../../images/Dn636440.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機用の更新プログラムをダウンロードしてください。
...
<td style="border:1px solid black;">
[![](../../images/Dn636440.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=032e1530-8736-4e1c-a704-967679227619&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636440.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=7cecbce3-bbb7-47d1-bda3-64d7e0f69f62&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636440.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=d2f44d4a-7cd8-4514-b3ff-1770bc47d595&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636440.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6ece112f-0ca7-4b1f-ad20-603950edee66&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn636440.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=a7b834a3-5a44-42d4-afe9-6ef207333834&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
Office のスタンドアロン プログラムへの影響は、関連の Office スイートのコンポーネントと同じ深刻度です。例えば、Microsoft Office Excel のスタンドアロンのインストールへの影響は、Office スイートに同梱された Microsoft Office Excel のインストールと同じ深刻度です。
...
<th style="border:1px solid black;" >
Excel のメモリ破損の脆弱性 - [CVE-2010-2562](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2562)
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
Excel のメモリ破損の脆弱性 - CVE-2010-2562
------------------------------------------
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-2562](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2562) をご覧ください。

#### 「Excel のメモリ破損の脆弱性」の問題を緩和する要素 - CVE-2010-2562:
...
#### 「Excel のメモリ破損の脆弱性」の回避策 - CVE-2010-2562:
...
-   **Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から Office 2003 以前のドキュメントを開くことをブロックする**
    ...
    **注:** レジストリを不正確に変更すると、深刻な問題となり、オペレーティング システムの再インストールが必要になる可能性があります。マイクロソフトは正しくレジストリを変更しないことで起こる問題の解決を、保証することはできません。レジストリは、お客様各自の責任において変更してください。
    ...
    -   2007 Office System
        ...
        **注:** 2007 Microsoft Office で 'FileOpenBlock' を使用するためには、すべての最新の 2007 Microsoft Office 用のセキュリティ更新プログラムを適用する必要があります。
...
-   **未知の、または信頼されないソースからのファイルを開く時、Microsoft Office Isolated Conversion Environment (MOICE) を使用する**
    ...
    **MOICE を有効にする**
    ...
    注意: 自動化された “Microsoft Fix it” ソリューションを使用してこの回避策を有効または無効にするには、サポート技術情報 [935865](https://support.microsoft.com/kb/935865) をご覧ください。手動で MOICE を有効にするには、次の一覧で指定されているようにコマンドを実行します。コマンドを実行することにより、Office アプリケーションが MOICE と関連します。
...
#### 「Excel のメモリ破損の脆弱性」のよく寄せられる質問 - CVE-2010-2562:
...
<td style="border:1px solid black;">
officexp-KB2264397-FullFile-JPN /q:a
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
officexp-KB2264397-FullFile-JPN /r:n
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
|------------|-------------|------------|-------|-----------|
| Excel.exe  | 10.0.6864.0 | 2010/06/28 | 22:51 | 9,361,232 |
...
<td style="border:1px solid black;">
office2003-KB2264403-FullFile-JPN /q:a
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
office2003-KB2264403-FullFile-JPN /r:n
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| ファイル名 | バージョン  | 日付       | 時間  | サイズ     |
|------------|-------------|------------|-------|------------|
| Excel.exe  | 11.0.8326.0 | 2010/06/23 | 17:14 | 10,354,000 |
...
[Microsoft Mactopia Web サイト](https://www.microsoft.com/japan/mac/download/default.mspx)から Open XML File Format Converter for Mac 1.1.6 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
-   「Excel のメモリ破損の脆弱性」 - [CVE-2010-2562](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2562) を報告してくださった [Core Security Technologies](https://www.coresecurity.com/) の Damián Frizza 氏
