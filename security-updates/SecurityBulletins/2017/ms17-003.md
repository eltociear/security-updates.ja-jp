---
TOCTitle: 'MS17-003'
Title: 'マイクロソフト セキュリティ情報 MS17-003 - 緊急'
ms:assetid: 'ms17-003'
ms:contentKeyID: 74296759
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms17-003(v=Security.10)'
---
...
この更新プログラムの詳細については、[マイクロソフト サポート技術情報 3214628](https://support.microsoft.com/ja-jp/kb/3214628) を参照してください。

脆弱性の情報
------------

<span id="sectionToggle1"></span>
このセキュリティ更新プログラムは、Adobe Security Bulletin [APSB17-02](https://helpx.adobe.com/jp/security/products/flash-player/apsb17-02.html) に記載されている以下の脆弱性を解決します。
...
<td style="border:1px solid black;">
[MS16-154](https://go.microsoft.com/fwlink/?linkid=834443) の 3209498
...
-   **グループ ポリシーを使用して、Adobe Flash Player が Internet Explorer で実行されるのを防ぐ**
    ...
    **注:** この回避策では、Microsoft Office 2007 または Microsoft Office 2010 など、その他のアプリケーションから Flash が呼び出されることを防ぐことはできません。
...
*Page generated 2017-01-04 11:34-08:00.*
