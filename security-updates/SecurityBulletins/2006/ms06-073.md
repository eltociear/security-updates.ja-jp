...
[](https://www.microsoft.com/japan/security/bulletins/ms06-073e.mspx)
...
**警告** **:** サポート技術情報 [925674](https://support.microsoft.com/kb/925674) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。また、このサポート技術情報には、これらの問題に対する推奨される解決策に関する説明も記載されています。詳細情報は、サポート技術情報 [925674](https://support.microsoft.com/kb/925674) をご覧ください。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c2682c53-8e9a-4c7d-b782-be78512dcbfa&amp;displaylang=ja"><img src="../../images/Dn610119.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
![](../../images/Dn610119.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。  
...
|---------------------------------------------------------------------------------------------------------------|------------------------------|--------------------|  
| WMI Object Broker の脆弱性 - [CVE-2006-4704](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4704) | リモートでコードが実行される | 緊急               |
...
サポート技術情報 [925674](https://support.microsoft.com/kb/925674) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。また、このサポート技術情報には、これらの問題に対する推奨される解決策に関する説明も記載されています。詳細情報は、サポート技術情報 [925674](https://support.microsoft.com/kb/925674) をご覧ください。
...
はい。このセキュリティ更新プログラムは、現在悪用されているこの脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2006-4704](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4704) に割り当てられています。
...
**注:** これらのスイッチを 1 つのコマンドに組み込むことができます。サポートされるインストール スイッチに関する詳細情報は、[Windows Installer Command Line Options](https://msdn2.microsoft.com/en-us/library/aa367988.aspx) (英語情報) をご覧ください。Windows インストーラに関する詳細情報は、[MSDN Windows インストーラの Web サイト](https://msdn2.microsoft.com/en-us/library/aa367449.aspx) (英語情報) をご覧ください。
...
再起動の必要性を減少させるためには、セキュリティ更新プログラムをインストールする前にすべての Visual Studio 2005 のインスタンスを閉じてください。再起動が必要となる理由に関する詳細情報は、サポート技術情報 [887012](https://support.microsoft.com/kb/887012) をご覧ください。
...
-   「WMI Object Broker の脆弱性」 - [CVE-2006-4704](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4704) を最初に報告してくださった [TippingPoint](https://www.tippingpoint.com/) および [Zero Day Initiative](https://www.zerodayinitiative.com/)
...
-   US マイクロソフトセキュリティ情報（MS06-073）
    [https://www.microsoft.com/technet/security/bulletin/ms06-073.mspx](https://technet.microsoft.com/security/bulletin/ms06-073)
-   サポート技術情報 （KB） 文書番号 ：925674
    [\[MS06-073\] Visual Studio 2005 の脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/925674)
