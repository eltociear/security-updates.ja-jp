...
[](https://www.microsoft.com/japan/security/bulletins/ms06-034e.mspx)
...
**警告:**   [917537](https://support.microsoft.com/kb/917537) で、この累積的なセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。 また、このサポート技術情報には、これらの問題に対する推奨される解決策に関する説明も記載されています。 詳細情報は、サポート技術情報 [917537](https://support.microsoft.com/kb/917537) をご覧ください。
...
|                                                                                                                                            | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                           | MU                                                                            |
|--------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                                      | [![](../../images/Dn610079.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c917d6da-da2d-402c-a870-1de3cbd21ebf&displaylang=ja) | [![](../../images/Dn610079.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c917d6da-da2d-402c-a870-1de3cbd21ebf&displaylang=ja) | ![](../../images/Dn610079.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional Service Pack 1 および Microsoft Windows XP Professional Service Pack 2                                   | [![](../../images/Dn610079.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=55d3ca3a-97fc-4e22-8ecc-9416ebc993c4&displaylang=ja) |                                                                                                                                                                                                   | ![](../../images/Dn610079.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                              | [![](../../images/Dn610079.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=4e19b792-7505-4453-b460-5a16915443db&displaylang=ja) |                                                                                                                                                                                                   | ![](../../images/Dn610079.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                                          | [![](../../images/Dn610079.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c5e274a8-f962-4944-8878-6b88b1592bbf&displaylang=ja) |                                                                                                                                                                                                   | ![](../../images/Dn610079.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with Service Pack 1 for Itanium-based Systems | [![](../../images/Dn610079.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e2dc245e-d0f3-41b9-b090-68a2118001cb&displaylang=ja) |                                                                                                                                                                                                   | ![](../../images/Dn610079.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                                  | [![](../../images/Dn610079.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f29c886d-b896-4fcf-a22b-2c1a53b1a9eb&displaylang=ja) |                                                                                                                                                                                                   | ![](../../images/Dn610079.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610079.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|-------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| 不正な形式の Active Server Pages を使用した Internet Information Services の脆弱性 - [CVE-2006-0026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0026) | リモートでコードが実行される | 警告                                                                                            | 重要                                                                                                                                                                                       | 重要                                                                               |
...
[917537](https://support.microsoft.com/kb/917537) で、この累積的なセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。 また、このサポート技術情報には、これらの問題に対する推奨される解決策に関する説明も記載されています。 詳細情報は、サポート技術情報 [917537](https://support.microsoft.com/kb/917537) をご覧ください。
...
このセキュリティ更新プログラムは、6.0.3790.1830 バージョンの Asp.dll ファイルを持つコンピュータのホットパッチをサポートします。ホットパッチを使用している場合、サーバーを再起動しないで Microsoft Windows Server 2003 Service Pack 1 を実行しているコンピュータにセキュリティ更新プログラムをインストールできます。ホットパッチおよびホットパッチを使用してセキュリティ更新プログラムを適用する方法に関する詳細情報は、サポート技術情報 [897341](https://support.microsoft.com/kb/897341) をご覧ください。
...
-   「不正な形式の Active Server Pages を使用した Internet Information Services の脆弱性」 - [CVE-2006-0026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0026) を報告してくださった、[Security-Assessment.com](https://security-assessment.com/) の Brett Moore 氏
...
-   US マイクロソフトセキュリティ情報（MS06-034）
    [https://www.microsoft.com/technet/security/bulletin/ms06-034.mspx](https://technet.microsoft.com/security/bulletin/ms06-034)
-   サポート技術情報 （KB） 文書番号 ：917537
    [\[MS06-034\] Active Server Pages を使用した Internet Information Services (IIS) の脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/917537)
