...
[](https://www.microsoft.com/japan/security/bulletins/ms06-002e.mspx)
...
|                                                                                                                                                                                            | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                                                                                      | [![](../../images/Dn610047.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=dc6c2fe8-3c81-4661-994b-4146775bf590&displaylang=ja) | [![](../../images/Dn610047.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=dc6c2fe8-3c81-4661-994b-4146775bf590&displaylang=ja-nec) | ![](../../images/Dn610047.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                                                                             | [![](../../images/Dn610047.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6daea2af-3723-4cdf-b5bd-b21ac75b5243&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610047.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                                                                              | [![](../../images/Dn610047.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=1990b2cf-ae88-4849-aeab-3f833969e197&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610047.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                                                                                          | [![](../../images/Dn610047.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5fc12654-486f-45bf-8d34-bdf0998869c5&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610047.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems                                                            | [![](../../images/Dn610047.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e39d2e29-8934-4aa1-844d-11efa57d9cc5&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610047.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                                                                                  | [![](../../images/Dn610047.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=80b05c56-5bce-4262-8142-af0d8a7bc388&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610047.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610047.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://windowsupdate.microsoft.com/) からインストールすることもできます。  
...
|----------------------------------------------------------------------------------------------------------------------------|------------------------------|-----------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Windows の埋め込み Web フォントの脆弱性 - [CVE-2006-0010](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0010) | リモートでコードが実行される | 緊急                  | 緊急         | 緊急                      | 緊急                      | 重要                | 重要                               |
...
はい。Windows 98、Windows 98 Second Edition および Windows Millennium Edition はこの脆弱性による深刻な影響を受けます。これらのプラットフォーム用の「緊急」のセキュリティ更新プログラムはこのセキュリティ情報の一部として提供されるそのほかのセキュリティ更新プログラムと同時に利用可能とならない場合があります。それらのセキュリティ更新プログラムは、セキュリティ情報のリリース後、可能な限り早期にリリースされる予定です。これらのセキュリティ更新プログラムが利用可能になると、 [Windows Update](https://windowsupdate.microsoft.com/) からのみ、ダウンロード可能となります。深刻度評価システムに関する詳細情報は、次の [Web サイト](https://technet.microsoft.com/security/bulletin/rating) をご覧ください。

**注** **:** Windows Update でサポートされていない Microsoft Windows Millennium Edition のローカライズ版用の更新プログラムは、以下のサイトからダウンロードすることができます。

-   スロベニア語 - [更新プログラムをダウンロードする](https://www.microsoft.com/download/details.aspx?familyid=1daf5e13-9d0c-4f0c-b0c5-5257893f3632&displaylang=sl)
-   スロバキア語 - [更新プログラムをダウンロードする](https://www.microsoft.com/download/details.aspx?familyid=1daf5e13-9d0c-4f0c-b0c5-5257893f3632&displaylang=sk)
-   タイ語 - [更新プログラムをダウンロードする](https://www.microsoft.com/download/details.aspx?familyid=1daf5e13-9d0c-4f0c-b0c5-5257893f3632&displaylang=th)
...
-   「Windows の埋め込み Web フォントの脆弱性」 - (CVE-2006-0010) を報告してくださった [eEye Digital Security](https://www.eeye.com/) 社
...
-   US マイクロソフトセキュリティ情報（MS06-002）  
    [https://www.microsoft.com/technet/security/bulletin/ms06-002.mspx](https://technet.microsoft.com/security/bulletin/ms06-002)
-   サポート技術情報 （KB） 文書番号 ：908519  
    [\[MS06-002\] 埋め込み Web フォントの脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/908519)
