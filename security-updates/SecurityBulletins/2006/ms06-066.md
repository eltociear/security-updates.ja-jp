...
[](https://www.microsoft.com/japan/security/bulletins/ms06-066e.mspx)
...
|                                                                                   | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|-----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                             | [![](../../images/Dn610112.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3cf0b0d1-ff07-40ac-a6ac-44dc4a54f91e&displaylang=ja) | [![](../../images/Dn610112.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3cf0b0d1-ff07-40ac-a6ac-44dc4a54f91e&displaylang=ja-nec) | ![](../../images/Dn610112.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 2                                               | [![](../../images/Dn610112.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=2f54258f-1071-467b-80a2-e4dbfc050667&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610112.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1 | [![](../../images/Dn610112.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f23574f7-4033-45ac-8ad8-6cced2ee9285&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610112.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610112.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
上記のソフトウェアのテストを行い、この脆弱性による影響を評価しました。それより前のバージョンに関してはサポートの対象となっていないため、調査はおこなわれていません。そのため、この脆弱性による影響は不明です。ご使用中の製品およびバージョンのサポートライフ サイクルを確認するためには、[マイクロソフト サポート ライフサイクル](https://support.microsoft.com/gp/lifecycle)の Web サイトをご覧下さい。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------------------|----------------------------------------|---------------------------------------------------------------|
| Microsoft NetWare 用のクライアント サービスのメモリの破損の脆弱性 - [CVE-2006-4688](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4688) | リモートでコードが実行される | 重要                       | 重要                                   | 警告                                                          |
| NetWare ドライバのサービス拒否の脆弱性- [CVE-2006-4689](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4689)                             | サービス拒否                 | 警告                       | 警告                                   | 注意                                                          |
...
|---------------------------------------------------------------------|-----------------------------|----------------------------------------|---------------------------------------------------------------|
| [MS05-046](https://technet.microsoft.com/security/bulletin/ms05-046) | 置き換えられない            | 置き換わる                             | 置き換えられない                                              |
...
**注:** CSNW は一般的に Internetwork Packet Exchange (IPX) および Sequenced Packet Exchange (SPX) プロトコルに関連しています。しかし、CSNW はインストールされたプロトコルを使用することにより悪用される可能性があります。TCP/IP は最も一般的に使用されているプロトコルであるため、次の回避策は TCP/IP に基づいています。IPX や SPX などのプロトコルを使用している場合、これらのプロトコルについて適切なポートをブロックしてください。IPX および SPX に関する詳細情報は、次の[マイクロソフトの Web サイト](https://www.microsoft.com/technet/prodtechnol/winxppro/reskit/) （英語情報） をご覧ください。
...
-   **ネットワークベースでのこの脆弱性の悪用に対する保護の手助けを行うために、Windows XP** **に含まれている**[**Windows** **ファイアウォール**](https://www.microsoft.com/japan/athome/security/default.mspx)**などのパーソナル ファイアウォールを使用する**

    既定で、Windows XP および Windows Server 2003 の[Windows ファイアウォール](https://www.microsoft.com/japan/athome/security/default.mspx)の機能は、受信側が送信を要求していない受信トラフィックをブロックすることにより、インターネット接続を保護する手助けとなります。受信者側が要求していないインターネットからのすべての受信通信をブロックすることを推奨します。
...
-   **ネットワークベースでこの脆弱性が悪用されることを防ぐために、影響を受けるコンピュータで** **IPSec** **を使用して、影響を受けるポートをブロックする**
    ...
    Internet Protocol Security (IPSec) を使用し、ネットワーク通信を保護します。IPSec およびフィルタの適用方法に関する詳細は、マイクロソフト サポート技術情報 [313190](https://support.microsoft./kb/313190) および [813878](https://support.microsoft./kb/813878) をご覧ください。
...
**この脆弱性は**[**MS05-046**](https://technet.microsoft.com/security/bulletin/ms05-046)**で修正されている脆弱性とどのように関連しますか?**
...
NetWare 用クライアント サービス (CSNW) に[サービス拒否](https://www.microsoft.com/japan/security/glossary.mspx)の脆弱性が存在し、これにより攻撃者が特別な細工をしたネットワーク メッセージをこのサービスを実行する影響を受けるコンピュータに送る可能性があります。攻撃者はコンピュータの応答を停止させる可能性があります。
...
このセキュリティ更新プログラムはホットパッチをサポートします。ホットパッチを使用している場合、サーバーを再起動しないで Microsoft Windows Server 2003 Service Pack 1 を実行しているコンピュータにセキュリティ更新プログラムをインストールできます。ホットパッチおよびホットパッチとしてこのセキュリティ更新プログラムを適用する方法に関する詳細情報は、サポート技術情報 [897341](https://support.microsoft.com/kb/897341) をご覧ください。
...
-   Microsoft NetWare 用のクライアント サービスのメモリの破損の脆弱性[CVE-2006-4688](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4688) を報告してくださった [NGS Software](https://www.ngssoftware.com/) の Peter Winter-Smith 氏
-   Microsoft NetWare 用のクライアント サービスのメモリの破損の脆弱性 [CVE-2006-4688](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4688) および NetWare ドライバのサービス拒否の脆弱性 - [CVE-2006-4689](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4689) を報告してくださった [McAfee](https://www.mcafee.com/) の Sam Arun Raj 氏
...
-   US マイクロソフトセキュリティ情報（MS06-066）
    [https://www.microsoft.com/technet/security/bulletin/MS06-066.mspx](https://technet.microsoft.com/security/bulletin/ms06-066)
-   サポート技術情報 （KB） 文書番号 ：923980
    [\[MS06-066\] Netware 用クライアント サービスの脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/923980)
