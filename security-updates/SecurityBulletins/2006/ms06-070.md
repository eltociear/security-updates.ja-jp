---
TOCTitle: 'MS06-070'
Title: 'マイクロソフト セキュリティ情報 MS06-070 - 緊急'
ms:assetid: 'ms06-070'
ms:contentKeyID: 61228942
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms06-070(v=Security.10)'
---



マイクロソフト セキュリティ情報 MS06-070 - 緊急
===============================================

Workstation サービスの脆弱性により、リモートでコードが実行される (924270)
-------------------------------------------------------------------------

公開日: 2006年11月15日 | 最終更新日: 2006年11月17日

[](https://www.microsoft.com/japan/security/bulletins/ms06-070e.mspx)
...
|                                       | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4 | [![](../../images/Dn610116.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3ad5c57d-d3f6-46a1-8dee-3e16d0977f80&displaylang=ja) | [![](../../images/Dn610116.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3ad5c57d-d3f6-46a1-8dee-3e16d0977f80&displaylang=ja-nec) | ![](../../images/Dn610116.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 2   | [![](../../images/Dn610116.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f4c8e767-4ed2-4e36-aa43-612f3017efc7&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610116.mu_s(ja-JP,Security.10).gif) |

![](../../images/Dn610116.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機用または NEC PC-9800 シリーズ用の更新プログラムをダウンロードしてください。

更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

![](../../images/Dn610116.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
| 脆弱性識別番号                                                                                                              | 脆弱性の影響                 | Windows 2000 Service Pack 4 | Windows XP Service Pack 2 |
|-----------------------------------------------------------------------------------------------------------------------------|------------------------------|-----------------------------|---------------------------|
| Workstation サービスのメモリ破損の脆弱性 - [CVE-2006-4691](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4691) | リモートでコードが実行される | 緊急                        | 注意                      |
...
| セキュリティ情報番号                                                | Windows 2000 Service Pack 4 | Windows XP Service Pack 2 |
|---------------------------------------------------------------------|-----------------------------|---------------------------|
| [MS03-049](https://technet.microsoft.com/security/bulletin/ms03-049) | 置き換わる                  | 対象外                    |
| [MS06-040](https://technet.microsoft.com/security/bulletin/ms06-040) | 置き換わる                  | 置き換わる                |
...
#### Workstation サービスのメモリ破損の脆弱性 - CVE-2006-4691:

Workstation サービスにリモートでコードが実行される脆弱性が存在し、これにより、攻撃者がこの脆弱性を悪用し、影響を受けるコンピュータを完全に制御する可能性があります。

#### 「Workstation サービスのメモリ破損の脆弱性」の問題を緩和する要素 - CVE-2006-4691:
...
-   Windows Server 2003 では、影響を受けるコンポーネントは攻撃を受けません。
-   Windows XP Service Pack 2 で攻撃が行われるには、管理者特権で実行することが攻撃者にとっての必要条件となります。

#### 「Workstation サービスのメモリ破損の脆弱性」の回避策 - CVE-2006-4691:
...
- **ネットワークベースでのこの脆弱性の悪用に対する保護の手助けを行うために、Windows ファイアウォールなどのパーソナルファイアウォールを使用する**
    ...
    既定で、Windows XP の [Windows ファイアウォール](https://www.microsoft.com/japan/athome/security/default.mspx)機能は、受信側が送信を要求していない受信トラフィックをブロックすることにより、インターネット接続を保護する手助けとなります。受信者側が要求していないインターネットからのすべての受信通信をブロックすることを推奨します。Windows ファイアウォールの機能をネットワーク セットアップ ウィザードを使用して有効にするためには、次のステップに従ってください。

    1.  \[スタート\] をクリックして \[コントロール パネル\] から、\[ネットワーク接続\] をダブルクリックします。

    2.  ファイアウォールを有効にする接続上で右クリックし、\[プロパティ\] を選択します。

    3.  \[詳細設定\] タブをクリックし、\[設定\] ボタンをクリックします。

    4.  Windows ファイアウォール の画面で \[有効 (推奨) \] が選択されていることを確認してください。これにより、Windows ファイアウォールが有効になります。

    5.  Windows ファイアウォールが有効になったら、すべての受信トラフィックを禁止するために、\[例外を許可しない\] を選択します。
...
#### 「Workstation サービスのメモリ破損の脆弱性」のよく寄せられる質問 - CVE-2006-4691:
...
ローカルのファイル システム リクエストおよびリモートのファイルまたは印刷のネットワーク リクエストは Workstation サービスを介してルーティングされます。このサービスは、リソースの場所を判断した後、ローカルのファイル システムまたはネットワークのコンポーネントへリクエストをルーティングします。Workstation サービスが停止した場合、すべてのリクエストはローカルのリクエストであると想定されます。
...
Windows 2000 Service Pack 4 に、特別な細工をしたメッセージを送信できる匿名ユーザーが、この脆弱性を悪用する可能性があります。Windows XP Service Pack 2 で攻撃が行われるには、管理者特権で実行することが攻撃者にとっての必要条件となります。

**どのように攻撃者はこの脆弱性を悪用する可能性がありますか?**

攻撃者は Windows 2000 のコンピュータに有効なドメイン参加リクエストを送信して、有効または解決可能なドメイン コントローラとして動作している悪意のあるサーバーと通信させることにより、この脆弱性の悪用を試みます。

**主にどのようなコンピュータがこの脆弱性による危険にさらされますか?**

Windows 2000 Service Pack 4 および Windows XP Service Pack 2 のコンピュータが、この脆弱性による危険にさらされます。
...
この更新プログラムは Workstation サービスが割り当てられたバッファにメッセージを渡す前に、メッセージの長さを検証する方法を変更することにより、この脆弱性を排除します。
...
**Windows2000-KB924270-x86-JPN /quiet**

**注: /quiet** スイッチを使用すると、すべてのメッセージが表示されなくなります。これは、エラー メッセージを表示しなくなることも含みます。管理者は **/quiet** スイッチを使用する場合、インストールが正常に完了したことを確認するためのサポートされている方法の 1 つを使用してください。また、管理者はこのスイッチを使用する場合、エラー メッセージについて KB924270.log ファイルを確認してください。

コンピュータを強制的に再起動せずにセキュリティ更新プログラムをインストールするためには、Windows 2000 Service Pack 4 のコマンド プロンプトで次のコマンドを使用してください。

**Windows2000-KB924270-x86-JPN /norestart**
...
システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB924270$\\Spuninst フォルダにあります。このユーティリティは次のセットアップ スイッチをサポートします。
...
|--------------|----------------|-----------|-------|---------|
| lsasrv.dll   | 5.00.2195.7108 | 2006/8/17 | 18:42 | 513,808 |
| netapi32.dll | 5.00.2195.7108 | 2006/8/17 | 18:45 | 309,520 |
| sp3res.dll   | 5.00.2195.7087 | 2006/5/3  | 12:27 | 502,272 |
| wkssvc.dll   | 5.00.2195.7108 | 2006/8/17 | 18:45 | 98,064  |
...
- **レジストリキーの確認**
    ...
    **注:** このレジストリ キーには、インストールされるファイルの完全な一覧が含まれない場合があります。また、管理者または OEM メーカーによって 924270 のセキュリティ更新プログラムが Windows インストール ソース ファイルに統合またはスリップストリーム化されている場合、このレジストリ キーが適切に作成されない場合があります。
...
**WindowsXP-KB924270-x86-JPN /quiet**

**注: /quiet** スイッチを使用すると、すべてのメッセージが表示されなくなります。これは、エラー メッセージを表示しなくなることも含みます。管理者は **/quiet** スイッチを使用する場合、インストールが正常に完了したことを確認するためのサポートされている方法の 1 つを使用してください。また、管理者はこのスイッチを使用する場合、エラー メッセージについて KB924270.log ファイルを確認してください。

コンピュータを強制的に再起動せずにセキュリティ更新プログラムをインストールするためには、Windows XP のコマンド プロンプトで次のコマンドを使用してください。

**WindowsXP-KB924270-x86-JPN /norestart**
...
|--------------|---------------|-----------|-------|---------|----------|
| lsasrv.dll   | 5.1.2600.2976 | 2006/8/17 | 21:28 | 706,560 | SP2GDR   |
| netapi32.dll | 5.1.2600.2976 | 2006/8/17 | 21:28 | 332,288 | SP2GDR   |
| wkssvc.dll   | 5.1.2600.2976 | 2006/8/17 | 21:28 | 132,096 | SP2GDR   |
| lsasrv.dll   | 5.1.2600.2976 | 2006/8/17 | 21:41 | 711,168 | SP2QFE   |
| netapi32.dll | 5.1.2600.2976 | 2006/8/17 | 21:41 | 337,408 | SP2QFE   |
| wkssvc.dll   | 5.1.2600.2976 | 2006/8/17 | 21:41 | 132,096 | SP2QFE   |
...
- **レジストリキーの確認**
    ...
    **注:** これらのレジストリ キーには、インストールされるファイルの完全な一覧が含まれない場合があります。また、管理者または OEM メーカーによって 924270 のセキュリティ更新プログラムが Windows インストール ソース ファイルに統合またはスリップストリーム化されている場合、このレジストリ キーが適切に作成されない場合があります。
...
-   「Workstation サービスのメモリ破損の脆弱性」 - [CVE-2006-4691](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4691) を報告してくださった [eEye](https://www.eeye.com/) 社
...
-   US マイクロソフトセキュリティ情報（MS06-070）
    [https://www.microsoft.com/technet/security/bulletin/ms06-070.mspx](https://technet.microsoft.com/security/bulletin/ms06-070)
-   サポート技術情報 （KB） 文書番号 ：924270
    [\[MS06-070\] Workstation サービスの脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/924270)

**更新履歴** **:**

-   2006/11/15: このセキュリティ情報ページを公開しました。
-   2006/11/17: 「Workstation サービスのメモリ破損の脆弱性」のよく寄せられる質問 - CVE-2006-4691 セクションを更新し、どのように攻撃者はこの脆弱性を悪用する可能性があるかを明確に記載しました。
