...
[](https://www.microsoft.com/japan/security/bulletins/ms06-046e.mspx)
...
|                                                                                                                                 | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                           | [![](../../images/Dn610091.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=34ebe5d3-40c9-41dc-aaff-64608d3ac7b1&displaylang=ja) | [![](../../images/Dn610091.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=34ebe5d3-40c9-41dc-aaff-64608d3ac7b1&displaylang=ja-nec) | ![](../../images/Dn610091.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                  | [![](../../images/Dn610091.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=a6e2cb0a-146f-4300-95cb-7078ce9f9844&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610091.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                   | [![](../../images/Dn610091.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=997a633a-8836-4c0f-98f9-1fd378de4b0c&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610091.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                               | [![](../../images/Dn610091.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5132c3bc-f3af-464e-a615-60f72677bd4b&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610091.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems | [![](../../images/Dn610091.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=527cc785-e69e-4ade-aaf7-61f96ac3ca7a&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610091.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                       | [![](../../images/Dn610091.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=fd1253b0-f4db-4808-a381-98ff9870ebb3&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610091.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610091.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|-------------------------------------------------------------------------------------------------------------------------------|------------------------------|-----------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| HTML ヘルプのバッファ オーバーランの脆弱性 - [CVE-2006-3357](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3357) | リモートでコードが実行される | 緊急                        | 緊急                      | 緊急                      | 警告                | 警告                               |
...
|---------------------------------------------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| [MS05-001](https://technet.microsoft.com/security/bulletin/ms05-001) | 置き換わる   | 置き換わる                | 置き換わる                | 置き換わる          | 置き換わる                         |

**このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題にはどのようなものがありますか?**

[922616](https://support.microsoft.com/kb/922616) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。また、このサポート技術情報には、これらの問題に対する推奨される解決策に関する説明も記載されています。詳細情報は、サポート技術情報 [922616](https://support.microsoft.com/kb/922616) をご覧ください。
...
6.  MaxAllowedZoneと入力し、ENTER キーを押します。
...
- **HTML** **ヘルプの** **ActiveX** **コントロールが** **Internet Explorer** **で実行されないように一時的に無効にする**
    ...
    **警告:** レジストリ エディタを不適切に使用すると、深刻な問題が生じ、オペレーティング システムの再インストールが必要となる場合があります。マイクロソフトは、レジストリ エディタの不正な使用による問題の解決を保証することはできません。レジストリ エディタは、お客様各自の責任において使用してください。
    ...
    ActiveX コントロールが Internet Explorer で実行されないようにするためのステップの詳細は、サポート技術情報 [240797](https://support.microsoft.com/kb/240797) をご覧ください。このサポート技術情報に記載されているステップに従い、レジストリに互換性フラグの値を作成し、Internet Explorer で HTML ヘルプの ActiveX コントロールのインスタンスが作成されないようにしてください。
...
Microsoft [HTML ヘルプ](https://msdn2.microsoft.com/en-us/library/ms670169.aspx) (英語情報) は、Windows プラットフォームの標準ヘルプ システムです。HTML ヘルプの ActiveX コントロールは、HTML ファイルにヘルプ ナビゲーションおよびセカンダリ ウィンドウ機能を追加するために使用されるプログラムです。HTML ヘルプの ActiveX コントロールに関する詳細は、[製品の説明](https://msdn2.microsoft.com/en-us/library/ms644670.aspx) （英語情報） をご覧ください。
...
攻撃者によりインターネットでこの脆弱性が悪用される可能性があります。ファイアウォールの最善策および標準の既定のファイアウォールの構成により、インターネット経由での攻撃からコンピュータを保護することができます。マイクロソフトはどのようにコンピュータを保護するかについての情報を提供しています。ホーム ユーザーの方は、[Protect Your PC Web サイト](https://www.microsoft.com/japan/security/protect/) をご覧ください。IT プロフェッショナルの方は、[TechNet セキュリティ センター](https://technet.microsoft.com/ja-jp/security/default.aspx) をご覧ください。
...
はい。このセキュリティ更新プログラムは、この脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2006-3357](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3357) に割り当てられています。
...
-   「HTML ヘルプのバッファ オーバーランの脆弱性」- [CVE-2006-3357](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3357) を報告してくださった [TippingPoint Security Research Team](https://www.tippingpoint.com/)の Cody Pierce 氏
...
-   US マイクロソフトセキュリティ情報（MS06-046）
    [https://www.microsoft.com/technet/security/bulletin/MS06-046.mspx](https://technet.microsoft.com/security/bulletin/ms06-046)
-   サポート技術情報 （KB） 文書番号 ：922616
    [\[MS06-046\] HTML ヘルプの脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/922616)
