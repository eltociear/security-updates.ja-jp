---
TOCTitle: 'MS06-063'
Title: 'マイクロソフト セキュリティ情報 MS06-063 - 重要'
ms:assetid: 'ms06-063'
ms:contentKeyID: 61228935
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms06-063(v=Security.10)'
---



マイクロソフト セキュリティ情報 MS06-063 - 重要
===============================================

Server サービスの脆弱性により、サービス拒否およびリモートでのコードの実行が起こる (923414)
------------------------------------------------------------------------------------------

公開日: 2006年10月11日 | 最終更新日: 2006年10月12日

[](https://www.microsoft.com/japan/security/bulletins/ms06-063e.mspx)
...
|                                                                                                                                 | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                           | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=2998105d-6796-4e60-8c9c-e8241385f2a9&displaylang=ja) | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=2998105d-6796-4e60-8c9c-e8241385f2a9&displaylang=ja-nec) | ![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                  | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=08ab17b9-149c-44d4-96cf-87a8c6b9dc22&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                   | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=433fd0f9-938f-432d-99d4-f41b92235dcf&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                               | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=abad4cc1-4ea6-4051-bc5a-79deb4dbe72b&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=849eedef-332b-4792-b84e-3750d407a86f&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                       | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=31e448f7-298d-417c-a857-1646689e0817&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif) |

![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機用または NEC PC-9800 シリーズ用の更新プログラムをダウンロードしてください。

更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
この更新プログラムは公開された脆弱性と非公開で報告された脆弱性の両方を解決します。これらの脆弱性については、このセキュリティ情報の「脆弱性の詳細」の欄で説明しています。
...
|---------------------------------------------------------------------------------------------------------------------------|------------------------------|-----------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Server サービスの サービス拒否の脆弱性 - [CVE-2006-3942](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3942) | サービス拒否                 | 重要                        | 重要                      | 重要                      | 重要                | 重要                               |
| SMB の名前の変更の脆弱性- [CVE-2006-4696](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4696)                | リモートでコードが実行される | 重要                        | 重要                      | 重要                      | 重要                | 重要                               |
...
**なぜマイクロソフトは 2006 年 10 月 12 日 にこのセキュリティ情報を再リリースしたのですか?**

マイクロソフトは「SMB の名前の変更の脆弱性」- CVE-2006-4696 に関連する影響を明確にするために、このセキュリティ情報を更新しました。

「SMB の名前の変更の脆弱性」により、認証されたリモートでのコードの実行が行われる可能性がありますが、この脆弱性が悪用された場合のほとんどが、その影響は認証されたサービス拒否であると思われます。このセキュリティ更新プログラムには何の変更も行なわれていません。さらに、両方の脆弱性について、ポート 593 をブロックするというガイダンスをこのセキュリティ情報の「問題を緩和する要素」および「回避策」の欄から削除しました。

**この更新プログラムにより何が置き換えられますか?**

これは、以前にリリースされたセキュリティ更新プログラムに置き換わるセキュリティ更新プログラムです。セキュリティ情報の ID 番号および影響を受けるオペレーティング システムのバージョンを次の表に記載します。

| セキュリティ情報番号                                                | Windows 2000 Service Pack 4 | Windows XP Service Pack 1 および Windows XP Service Pack 2 | Windows XP x64 Edition | Windows Server 2003 および Windows Server 2003 Service Pack 1 |
|---------------------------------------------------------------------|-----------------------------|------------------------------------------------------------|------------------------|---------------------------------------------------------------|
| [MS06-035](https://technet.microsoft.com/security/bulletin/ms06-035) | 置き換わる                  | 置き換わる                                                 | 置き換わる             | 置き換わる                                                    |
...
#### Server サービスのサービス拒否の脆弱性 - CVE-2006-3942:

Server サービスが特定のネットワーク メッセージを処理する方法に[サービス拒否](https://www.microsoft.com/japan/security/glossary.mspx)の脆弱性が存在します。Server サービスを実行しているコンピュータに特別な細工がされたネットワーク メッセージを送ることにより、攻撃者はこの脆弱性を悪用する可能性があります。攻撃者はこの脆弱性を悪用し、影響を受けるコンピュータが応答しないようにする可能性があります。

#### 「Server サービスのサービス拒否の脆弱性」の問題を緩和する要素 - CVE-2006-3942
...
#### 「Server サービスのサービス拒否の脆弱性」の回避策 - CVE-2006-3942:

マイクロソフトは次の回避策のテストを行いました。これらの回避策は根本的な脆弱性を修正しませんが、既知の攻撃方法を阻止する手助けとなります。回避策が機能の低下の原因となる場合、下記に示します。

-   **ファイアウォールにより、以下のポートをブロックする**
    -   UDP ポート 135、137、138 および 445、TCP ポート 135、139、および 445
-   **ネットワークベースでのこの脆弱性の悪用に対する保護の手助けを行うために、Windows XP** **および** **Windows Server 2003** **に含まれている**[**インターネット接続ファイアウォール**](https://www.microsoft.com/japan/athome/security/protect/firewall.mspx)**などのパーソナルファイアウォールを使用する**
...
#### 「Server サービスのサービス拒否の脆弱性」のよく寄せられる質問 - CVE-2006-3942:

**どのようなことが起こる可能性がありますか?**

これは、[サービス拒否](https://www.microsoft.com/japan/security/glossary.mspx)の脆弱性です。攻撃者はこの脆弱性を悪用し、影響を受けるコンピュータが応答しないようにし、自動的に再起動させる可能性があります。その間、サーバーはリクエストに応答できない可能性があります。攻撃者により、サービス拒否の脆弱性が悪用されても、コードが実行されたり、特権の昇格が行われることはありません。しかし、影響を受けるコンピュータが要求を受け入れない可能性があります。

**何が原因で起こりますか?**

Server サービスに初期化されていないバッファが含まれるため、この脆弱性が起こります。

**Server** **サービスとは何ですか?**

Server サービスは、リモート プロシージャ コール (RPC) サポート、ネットワークを介したファイルと印刷のサポート、および名前付きパイプ共有を提供します。Server サービスを使用して、ディスク、プリンタなどのローカル リソースをネットワーク上の他のユーザーからもアクセスできるように共有化することが可能になります。また、ユーザーのコンピュータと他のコンピュータで実行されているアプリケーション間の名前付きパイプの通信が可能になります。
...
攻撃者は、特別な細工をしたメッセージを作成し、影響を受けるコンピュータに送信することにより、この脆弱性を悪用する可能性があります。これにより影響を受けるコンピュータの応答を停止させる可能性があります。

**主にどのようなコンピュータがこの脆弱性による危険にさらされますか?**

すべての Windows コンピュータが、この脆弱性による危険にさらされます。
...
この更新プログラムは、バッファが使用される前にそれを初期化することにより、この脆弱性を排除します。

**このセキュリティ情報の公開時に、この脆弱性は一般に知られていましたか？**

はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の CVE-2006-3942 にアサインされています。また、より大きなセキュリティ コミュニティにより、“Mailslot DOS” とも呼ばれています。
...
このセキュリティ更新プログラムは公開された検証用コードにより悪用される可能性のある脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2004-3942](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3942) に割り当てられています。

**この脆弱性は**[**MS06-035**](https://technet.microsoft.com/security/bulletin/ms06-035)**および**[**MS06-040**](https://technet.microsoft.com/security/bulletin/ms06-040)**で修正されている脆弱性とどのように関連しますか?**

これらのすべての脆弱性は Server サービスに存在していました。しかし、この更新プログラムは MS06-035 の一部または MS06-040 の一部として解決されなかった新たな脆弱性を解決します。MS06-035 および MS06-040 は、これらのセキュリティ情報で説明された脆弱性に対する保護の手助けとなりますが、この新たな脆弱性は解決しません。また、この更新プログラムは MS06-040 に置き換わるものではありません。両方の脆弱性からコンピュータを保護するには、この更新プログラムと MS06-040 で提供された更新プログラムをインストールする必要があります。このセキュリティ情報は MS06-035 に置き換わるものです。この更新プログラムをインストールすると、MS06-035 で修正されたすべての脆弱性に対する保護を行います。

#### SMB の名前の変更の脆弱性- CVE-2006-4696:

Server サービスが特定のネットワーク メッセージを処理する方法のため、Server サービスにリモートでコードが実行される脆弱性が存在します。

Server サービスを認証されたユーザーとして実行しているコンピュータに特別な細工がされたネットワーク メッセージを送ることにより、攻撃者はこの脆弱性を悪用する可能性があります。 この脆弱性で、攻撃者により影響を受けるコンピュータが完全に制御される可能性がありますが、この脆弱性の悪用による影響はほとんどの場合、サービス拒否の状態となる可能性が高いです。

#### 「SMB の名前の変更の脆弱性」の問題を緩和する要素 - CVE-2006-4696:

-   ファイアウォールによる最善策および標準のファイアウォールの既定の構成を使用することにより、組織のネットワーク境界の外部から行われる攻撃を防ぎネットワークを保護することができます。インターネットに接続したコンピュータでは、最低限の数のポートしか開かないようにすることが最善策として推奨されます。
-   この脆弱性の悪用により、影響を受けるコンピュータが予期せず再起動し、リモートでコードが実行されるのではなくむしろ、サービス拒否の状態となる可能性があります。
-   この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ネットワーク越しにログオンできることが攻撃者にとっての必要条件となります。匿名ユーザーにより、この脆弱性が悪用されることはないと思われます。

#### 「SMB の名前の変更の脆弱性」の回避策 - CVE-2006-4696:
...
#### 「SMB の名前の変更の脆弱性」のよく寄せられる質問 - CVE-2006-4696:

**どのようなことが起こる可能性がありますか?**

これはリモートでコードが実行される脆弱性です。 攻撃者によりこの脆弱性が悪用された場合、影響を受けるコンピュータが完全に制御される可能性があります。この脆弱性が悪用された場合、その影響のほとんどがコンピュータの再起動からサービス拒否である可能性が高いです。

**何が原因で起こりますか?**

Server サービスがメモリの再割り当てのリクエストを不適切に処理するため、この脆弱性が起こります。

**Server** **サービスとは何ですか?**

Server サービスは、RPC サポート、ネットワークを介したファイルと印刷のサポート、および名前付きパイプ共有を提供します。Server サービスを使用して、ディスク、プリンタなどのローカル リソースをネットワーク上の他のユーザーからもアクセスできるように共有化することが可能になります。また、ユーザーのコンピュータと他のコンピュータで実行されているアプリケーション間の名前付きパイプの通信が可能になり、RPC に使用されます。

**どのように攻撃者はこの脆弱性を悪用する可能性がありますか?**

この脆弱性の影響を受けるコンピュータに、特別な細工をしたファイルを送信できる認証されたユーザーが、この脆弱性を悪用する可能性があります。

**攻撃者はこの脆弱性をどのように悪用する可能性がありますか?**

攻撃者は、特別な細工をしたメッセージを作成し、影響を受けるコンピュータに送信することにより、この脆弱性を悪用する可能性があります。これにより、影響を受けるコンピュータの応答を停止させる可能性があります。

**主にどのようなコンピュータがこの脆弱性による危険にさらされますか?**

すべての Windows コンピュータがこの脆弱性による危険にさらされます。
...
この更新プログラムは、利用可能なメモリの割り当てについてのそのほかのリクエストを受け入れる前に、コンピュータのメモリが適切にゼロになっていることを確認することにより、この脆弱性を排除します。
...
これらのすべての脆弱性は Server サービスに存在していました。しかし、この更新プログラムは MS06-035 の一部または MS06-040 の一部として解決されなかった新たな脆弱性を解決します。MS06-035 および MS06-040 はこれらのセキュリティ情報で説明された脆弱性に対する保護の手助けとなりますが、この新たな脆弱性は解決しません。また、この更新プログラムは MS06-040 に置き換わるものではありません。両方の脆弱性からコンピュータを保護するには、この更新プログラムと MS06-040 で提供された更新プログラムをインストールする必要があります。このセキュリティ情報は MS06-035 に置き換わるものです。この更新プログラムをインストールすると、MS06-035 で解決された脆弱性に対する保護を行います。
...
**WindowsServer2003-KB923414-x86-JPN /quiet**

**注: /quiet** スイッチを使用すると、すべてのメッセージが表示されなくなります。これは、エラー メッセージを表示しなくなることも含みます。管理者は **/quiet** スイッチを使用する場合、インストールが正常に完了したことを確認するためのサポートされている方法の 1 つを使用してください。また、管理者はこのスイッチを使用する場合、エラー メッセージについて KB923414.log ファイルを確認してください。

コンピュータを強制的に再起動せずにセキュリティ更新プログラムをインストールするためには、Windows Server 2003 のコマンド プロンプトで次のコマンドを使用してください。

**WindowsServer2003-KB923414-x86-JPN /norestart**
...
このセキュリティ更新プログラムはホットパッチをサポートします。ホットパッチおよびホットパッチとしてこのセキュリティ更新プログラムを適用する方法に関する詳細情報は、サポート技術情報 [897341](https://support.microsoft.com/kb/897341) をご覧ください。

**削除に関する情報**

この更新プログラムを削除するためには、\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。

システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB923414$\\Spuninst フォルダにあります。このユーティリティは次のセットアップ スイッチをサポートします。
...
|------------|---------------|----------|-------|---------|----------|
| srv.sys    | 5.2.3790.588  | 2006/9/1 | 19:03 | 340,992 | RTMGDR   |
| srv.sys    | 5.2.3790.588  | 2006/9/1 | 19:14 | 342,016 | RTMQFE   |
| srv.hp.sys | 5.2.3790.2783 | 2006/9/1 | 23:32 | 53,248  | SP1GDR   |
| srv.sys    | 5.2.3790.2783 | 2006/9/1 | 23:32 | 413,696 | SP1GDR   |
| srv.sys    | 5.2.3790.2783 | 2006/9/1 | 19:57 | 360,448 | SP1QFE   |
...
|------------|---------------|----------|------|-----------|------|----------|
| srv.sys    | 5.2.3790.588  | 2006/9/1 | 8:53 | 991,232   | IA64 | RTMGDR   |
| srv.sys    | 5.2.3790.588  | 2006/9/1 | 8:55 | 994,816   | IA64 | RTMQFE   |
| srv.sys    | 5.2.3790.2783 | 2006/9/1 | 8:58 | 1,105,408 | IA64 | SP1GDR   |
| srv.sys    | 5.2.3790.2783 | 2006/9/1 | 8:55 | 1,108,480 | IA64 | SP1QFE   |
...
| ファイル名 | バージョン    | 日付     | 時間 | サイズ  | CPU | フォルダ |
|------------|---------------|----------|------|---------|-----|----------|
| srv.sys    | 5.2.3790.2783 | 2006/9/1 | 8:55 | 671,232 | X64 | SP1GDR   |
| srv.sys    | 5.2.3790.2783 | 2006/9/1 | 8:53 | 672,768 | X64 | SP1QFE   |
...
-   **レジストリキーの確認**
    ...
    **注:** このレジストリ キーには、インストールされるファイルの完全な一覧が含まれない場合があります。また、管理者または OEM メーカーによって 923414 のセキュリティ更新プログラムが Windows インストール ソース ファイルに統合またはスリップストリーム化されている場合、このレジストリ キーが適切に作成されない場合があります。
...
**WindowsXP-KB923414-x86-JPN /quiet**

**注: /quiet** スイッチを使用すると、すべてのメッセージが表示されなくなります。これは、エラー メッセージを表示しなくなることも含みます。管理者は **/quiet** スイッチを使用する場合、インストールが正常に完了したことを確認するためのサポートされている方法の 1 つを使用してください。また、管理者はこのスイッチを使用する場合、エラー メッセージについて KB923414.log ファイルを確認してください。

コンピュータを強制的に再起動せずにセキュリティ更新プログラムをインストールするためには、Windows XP のコマンド プロンプトで次のコマンドを使用してください。

**WindowsXP-KB923414-x86-JPN /norestart**
...
| ファイル名 | バージョン    | 日付      | 時間  | サイズ  | フォルダ |
|------------|---------------|-----------|-------|---------|----------|
| srv.sys    | 5.1.2600.1885 | 2006/8/14 | 17:59 | 321,536 | SP1QFE   |
| srv.sys    | 5.1.2600.2974 | 2006/8/14 | 19:34 | 332,928 | SP2GDR   |
| srv.sys    | 5.1.2600.2974 | 2006/8/14 | 21:00 | 332,928 | SP2QFE   |
...
-   **レジストリキーの確認**
    ...
    **注:** これらのレジストリ キーには、インストールされるファイルの完全な一覧が含まれない場合があります。また、管理者または OEM メーカーによって 923414 のセキュリティ更新プログラムが Windows インストール ソース ファイルに統合またはスリップストリーム化されている場合、このレジストリ キーが適切に作成されない場合があります。
...
|------------|----------------|-----------|-------|---------|
| srv.sys    | 5.00.2195.7106 | 2006/8/11 | 19:47 | 239,280 |
...
-   Server サービスサービス拒否の脆弱性 ([CVE-2006-3942](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3942)) を報告してくださった [Core Security Technologies](https://www.coresecurity.com/) の Gerardo Richarte 氏
-   Server サービスのサービス拒否の脆弱性 ([CVE-2006-3942](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3942)) を報告してくださった [NS Focus](https://www.nsfocus.com/)
-   SMB の名前の変更の脆弱性 ([CVE-2006-4696](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4696)) を報告してくださった [Fortinet](https://www.fortinet.com/)
-   SMB の名前の変更の脆弱性 ([CVE-2006-4696](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4696)) を報告してくださった [VMWare](https://www.vmware.com/) の Matthew Amdur 氏
...
-   US マイクロソフトセキュリティ情報（MS06-063）
    [https://www.microsoft.com/technet/security/bulletin/MS06-063.mspx](https://technet.microsoft.com/security/bulletin/ms06-063)
-   サポート技術情報 （KB） 文書番号 ：923414
    [\[MS06-063\] Server サービスの脆弱性により、サービス拒否およびリモートでのコードの実行が起こる](https://support.microsoft.com/kb/923414)

**更新履歴** **:**

-   2006/10/11: このセキュリティ情報ページを公開しました。
-   2006/10/12: このセキュリティ情報ページを更新し、「SMB の名前の変更の脆弱性」- CVE-2006-4696 に関連するセキュリティ上の影響は、認証されたリモートでのコードの実行の脆弱性であることを明確にしました。また、両方の脆弱性について、ポート 593 をブロックするというガイダンスをこのセキュリティ情報の「問題を緩和する要素」および「回避策」の欄から削除しました。
