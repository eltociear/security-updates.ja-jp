...
[](https://www.microsoft.com/japan/security/bulletins/ms06-032e.mspx)
...
**警告:**   サポート技術情報 [917953](https://support.microsoft.com/kb/917953) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。また、このサポート技術情報には、これらの問題に対する推奨される解決策に関する説明も記載されています。詳細情報は、サポート技術情報 [917953](https://support.microsoft.com/kb/917953) をご覧ください。
...
|                                                                                                                                 | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                           | [![](../../images/Dn610077.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=305e208c-d75c-471b-9e57-30d01e320ad1&displaylang=ja) | [![](../../images/Dn610077.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=305e208c-d75c-471b-9e57-30d01e320ad1&displaylang=ja-nec) | ![](../../images/Dn610077.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                  | [![](../../images/Dn610077.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b62abe8e-4735-4934-a66e-5b957986efbf&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610077.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                   | [![](../../images/Dn610077.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=44213900-9082-45dc-b514-31d38717fe89&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610077.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                               | [![](../../images/Dn610077.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ea319c61-b405-41ab-9eee-d5b3488b90e0&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610077.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems | [![](../../images/Dn610077.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=cd8b88b5-f90f-4c0c-a5ad-3641751381c9&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610077.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                       | [![](../../images/Dn610077.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=cd8699bc-6760-4f0e-b8e0-2e7d89092ce8&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610077.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610077.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|-------------------------------------------------------------------------------------------------------------|------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| IP ソース ルートの脆弱性 - [CVE-2006-2379](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2379) | リモートでコードが実行される | 重要         | 重要                      | 警告                      | 重要                | 警告                               |
...
|-------------------------------------------------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| [**MS06-007**](https://technet.microsoft.com/security/bulletin/ms06-007) | 対象外       | 置き換わる                | 置き換わる                | 置き換わる          | 置き換わる                         |
| [**MS05-019**](https://technet.microsoft.com/security/bulletin/ms05-019) | 置き換わる   | 置き換わる                | 置き換わる                | 置き換わる          | 対象外                             |
...
SMS 2.0 に関して、Security Update Inventory Tool が含まれている SMS SUS Feature Pack は、セキュリティ更新プログラムを検出するために SMS により使用されます。 SMS UIT は検出のために MBSA 1.2.1 エンジンを使用します。Security Update Inventory Tool に関する詳細は、次の [マイクロソフトの Web サイト](https://www.microsoft.com/smserver/downloads/2003/featurepacks/suspack/default.mspx)をご覧ください。Security Update Inventory Tool の制限に関する詳細情報は、サポート技術情報 [306460](https://support.microsoft.com/kb/306460) をご覧ください。なお SMS SUS Feature Pack には Microsoft Office アプリケーションに必要な更新プログラムを検出するための Microsoft Office Inventory Tool も含まれています。
...
IP ソース ルーティングを無効にすることに関する追加情報は、MSDN コラム [How to Harden the TCP/IP Stack](https://msdn2.microsoft.com/en-us/library/aa302363.aspx) (英語情報) に記載されている Additional Protections の情報をご覧ください。
...
攻撃者によりインターネットでこの脆弱性が悪用される可能性があります。ファイアウォールの最善策および標準の既定の構成により、インターネット経由での攻撃からコンピュータを保護する手助けをすることができます。マイクロソフトはどのようにコンピュータを保護するかについての情報を提供しています。ホーム ユーザーの方は、[Protect Your PC Web サイト](https://www.microsoft.com/japan/security/protect/) をご覧ください。IT プロフェッショナルは、[TechNet セキュリティ センター](https://technet.microsoft.com/ja-jp/security/default.aspx)をご覧ください。
...
-   US マイクロソフトセキュリティ情報（MS06-032）
    [https://www.microsoft.com/technet/security/bulletin/MS06-032.mspx](https://technet.microsoft.com/security/bulletin/ms06-032)
-   サポート技術情報 （KB） 文書番号 ：917953
    [\[MS06-032\] TCP/IP の脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/917953)
