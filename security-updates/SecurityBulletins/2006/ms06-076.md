...
[](https://www.microsoft.com/japan/security/bulletins/ms06-076e.mspx)
...
**警告** **:** [923694](https://support.microsoft.com/kb/923694) で、この累積的なセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。また、このサポート技術情報には、これらの問題に対する推奨される解決策に関しての説明も記載されています。詳細情報は、サポート技術情報 [923694](https://support.microsoft.com/kb/923694) をご覧ください。
...
|                                                                                                                                                        | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4 上の Outlook Express 5.5 Service Pack 2                                                                          | [![](../../images/Dn610122.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=cb0563fb-a05d-4d9d-b269-b5602b09c16a&displaylang=ja) | [![](../../images/Dn610122.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=cb0563fb-a05d-4d9d-b269-b5602b09c16a&displaylang=ja-nec) | ![](../../images/Dn610122.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows 2000 Service Pack 4 上の Outlook Express 6 Service Pack 1                                                                            | [![](../../images/Dn610122.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=1f0432d4-3f45-472e-8c2d-b7b6a879acb8&displaylang=ja) | [![](../../images/Dn610122.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=1f0432d4-3f45-472e-8c2d-b7b6a879acb8&displaylang=ja-nec) | ![](../../images/Dn610122.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 2 上の Outlook Express 6                                                                                             | [![](../../images/Dn610122.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=560e8778-9733-4719-a565-614fd490c320&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610122.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition 上の Outlook Express 6                                                                                   | [![](../../images/Dn610122.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6be4f4ce-abd6-4a38-84a5-8952e3531217&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610122.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1 上の Outlook Express 6                                               | [![](../../images/Dn610122.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=fe358108-15df-4ed9-b257-01aeb82647df&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610122.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition 上の Outlook Express 6                                                                                       | [![](../../images/Dn610122.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=dde5c141-de6c-4dd9-8399-6e5db0dcc574&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610122.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems 上の Outlook Express 6 | [![](../../images/Dn610122.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=7d3fea7a-ddc0-4a22-a8b3-d5f46707d017&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610122.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610122.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|-------------------------------------------------------------------------------------------------------------------------------|------------------------------|---------------------------------------------------------------------|-------------------------------------------------------------------|--------------------------------------------------|-------------------------------------------------------------------------------|
| Windows アドレス帳の連絡先レコードの脆弱性 - [CVE-2006-2386](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2386) | リモートでコードが実行される | 重要                                                                | 重要                                                              | 重要                                             | 重要                                                                          |
...
[923694](https://support.microsoft.com/kb/923694) で、この累積的なセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。また、このサポート技術情報には、これらの問題に対する推奨される解決策に関しての説明も記載されています。詳細情報は、サポート技術情報 [923694](https://support.microsoft.com/kb/923694) をご覧ください。

-   マイクロソフト サポート技術情報 [923694](https://support.microsoft.com/kb/923694): 累積的なセキュリティ更新プログラム 911567 (MS06-016) をインストールした後に Windows アドレス帳または Outlook Express を開くと、エラー メッセージが表示される
...
|---------------------------------------------------------------------|---------------------------------------------------------------------|-------------------------------------------------------------------|--------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| [MS06-016](https://technet.microsoft.com/security/bulletin/ms06-016) | 置き換わる                                                          | 置き換わる                                                        | 置き換わる                                                               | 置き換わる                                                                                      | 置き換わる                                                                                                                                       |
| [MS06-043](https://technet.microsoft.com/security/bulletin/ms06-043) | 対象外                                                              | 対象外                                                            | 置き換わる                                                               | 対象外                                                                                          | 置き換わる                                                                                                                                       |
...
このセキュリティ更新プログラムは再起動を必要としません。インストーラによって、必要なサービスが停止され、更新プログラムが適用され、サービスが再起動します。しかし、何らかの理由により、必要なサービスが停止されない場合、または必要なファイルが使用中の場合、この更新プログラムを適用すると、再起動が要求されます。この動作が起きた場合、再起動するメッセージが表示されます。再起動が必要となる理由に関する詳細情報は、マイクロソフト サポート技術情報[887012](https://support.microsoft.com/kb/887012) をご覧ください。
...
このセキュリティ更新プログラムを適用するには、Microsoft Windows XP Service Pack 2がインストールされている必要があります。詳細情報は、サポート技術情報 [322389](https://support.microsoft.com/kb/322389) をご覧ください。
...
**注:** すべてのセキュリティ更新プログラムがホットパッチをサポートしているわけではなく、ホットパッチをサポートしているセキュリティ更新プログラムで、セキュリティ更新プログラムのインストール後、サーバーの再起動が必要になる場合があります。 ホットパッチは、セキュリティ更新プログラムにより置き換えられたファイルが一般に配布されたリリース (GDR) のファイルである場合のみサポートされます。 セキュリティ更新プログラムに含まれるファイルのひとつを更新するための修正プログラムを以前にインストールした場合、ホットパッチはサポートされません。 この動作に関する詳細情報は、サポート技術情報[897341](https://support.microsoft.com/kb/897341) および [824994](https://support.microsoft.com/kb/824994) をご覧ください。
...
-   Microsoft Baseline Security Analyzer (MBSA): <https://technet.microsoft.com/ja-jp/security/cc184924.aspx> MBSA ツールのセキュリティ更新プログラムの検出に関する制限は、サポート技術情報 [306460](https://support.microsoft.com/kb/306460) をご覧ください。
...
-   US マイクロソフトセキュリティ情報 (MS06-076)
    [https://www.microsoft.com/technet/security/bulletin/MS06-076.mspx](https://technet.microsoft.com/security/bulletin/ms06-076)
-   サポート技術情報 （KB） 文書番号 ：923694
    [\[MS06-076\] Outlook Express 用の累積的なセキュリティ更新プログラム](https://support.microsoft.com/kb/923694)
