...
[](https://www.microsoft.com/japan/security/bulletins/ms06-040e.mspx)
...
**警告:**  マイクロソフト サポート技術情報 [921883](https://support.microsoft.com/kb/921883) で、この累積的なセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。 また、このサポート技術情報には、これらの問題に対する推奨される解決策に関する説明も記載されています。 詳細情報は、サポート技術情報 [921883](https://support.microsoft.com/kb/921883) をご覧ください。
...
|                                                                                                                                 | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                           | [![](../../images/Dn610085.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3b61153d-359f-4441-a448-24062cb2387c&displaylang=ja) | [![](../../images/Dn610085.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3b61153d-359f-4441-a448-24062cb2387c&displaylang=ja-nec) | ![](../../images/Dn610085.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                  | [![](../../images/Dn610085.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=2996b9b6-03ff-4636-861a-46b3eac7a305&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610085.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                   | [![](../../images/Dn610085.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=314c7c2c-9a02-4e56-98cf-97703fecf0be&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610085.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                               | [![](../../images/Dn610085.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=a0058f39-6dea-4dfc-9dd6-4cb45b305dec&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610085.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems | [![](../../images/Dn610085.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=af970833-2044-4284-937d-3beb2e2f286d&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610085.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                       | [![](../../images/Dn610085.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3b0c1954-fca5-4e95-abb2-6066a9d6bc76&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610085.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610085.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|-----------------------------------------------------------------------------------------------------------------------------------|------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Server サービスのバッファ オーバーランの脆弱性 - [CVE-2006-3439](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3439) | リモートでコードが実行される | 緊急         | 緊急                      | 緊急                      | 緊急                | 緊急                               |
...
マイクロソフトは、マイクロソフト サポート技術情報 [924054](https://support.microsoft.com/kb/924054) に記述されている Microsoft Windows Server 2003 Service Pack 1 および Microsoft Windows XP Professional x64 Edition に影響を及ぼす問題を解決するために、このセキュリティ情報および関連するセキュリティ更新プログラムを更新しました。 大量の連続するメモリを要求するプログラムがインストールされている Microsoft Windows Server 2003 Service Pack 1 および Microsoft Windows XP Professional x64 Edition で、この更新プログラムの以前のバージョンをインストールした後、コンピュータが異常終了する可能性があります。
...
はい。攻撃者によりインターネットでこの脆弱性が悪用される可能性があります。ファイアウォールの最善策および既定の構成により、インターネット経由での攻撃からコンピュータを保護することができます。マイクロソフトはどのようにコンピュータを保護するかについての情報を提供しています。ホームユーザーの方は、[Protect Your PC Web サイト](https://www.microsoft.com/japan/security/protect/) をご覧ください。IT プロフェッショナルは、[TechNet セキュリティ センター](https://technet.microsoft.com/ja-jp/security/default.aspx)をご覧ください。
...
はい。 このセキュリティ更新プログラムは、現在悪用されている脆弱性を解決します。 解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2006-3439](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3439) に割り当てられています。

**この脆弱性は**[**MS06-035**](https://technet.microsoft.com/security/bulletin/ms06-035)**で修正されている脆弱性とどのように関連しますか?**
...
過去に修正プログラムをインストールしてこれらのファイルのいずれかをアップデートしている場合は、インストーラは RTMQFE、SP1QFE または SP2QFE ファイルをコンピュータにコピーします。それ以外の場合は、RTMGDR、SP1GDR または SP2GDR ファイルがコンピュータにコピーされます。セキュリティ更新プログラムにはこれらのファイルのすべてのバリエーションが含まれない場合があります。この動作に関する詳細情報は、サポート技術情報 [824994](https://support.microsoft.com/kb/824994) をご覧ください。
...
-   Server サービスのバッファ オーバーランの脆弱性 - [CVE-2006-3439](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3439) に関して協力くださった [US-CERT](https://www.us-cert.gov/)
-   Server サービスのバッファ オーバーランの脆弱性 - [CVE-2006-3439](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3439) に関して協力くださった [SANS](https://www.sans.org/)
...
-   US マイクロソフトセキュリティ情報（MS06-040）
    [https://www.microsoft.com/technet/security/bulletin/ms06-040.mspx](https://technet.microsoft.com/security/bulletin/ms06-040)
-   サポート技術情報 （KB） 文書番号 ：921883
    [\[MS06-040\] Server サービスの脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/921883)

**更新履歴:**  

-   2006/08/09: このセキュリティ情報ページを公開しました。
-   2006/08/15: 「警告」の欄を更新し、サポート技術情報 921883 のリリースを反映しました。 特定のポートのブロックに関して、「回避策の影響」の欄を更新しました。
-   2006/09/13: このセキュリティ情報ページを更新し、[サポート技術情報 924054](https://support.microsoft.com/kb/924054) に記述されている Microsoft Windows Server 2003 Service Pack 1 および Microsoft Windows XP Professional x64 Edition に影響を及ぼす問題を解決するための改訂版のセキュリティ更新プログラムをリリースしたことをお知らせしました。
