...
[](https://www.microsoft.com/japan/security/bulletins/ms06-030e.mspx)
...
|                                                                                                                                 | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                           | [![](../../images/Dn610075.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6ec86784-6b12-410b-8068-028c58ed5df7&displaylang=ja) | [![](../../images/Dn610075.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6ec86784-6b12-410b-8068-028c58ed5df7&displaylang=ja-nec) | ![](../../images/Dn610075.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                  | [![](../../images/Dn610075.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c17ddc07-204b-4a7f-8c5a-36b7865a030c&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610075.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                   | [![](../../images/Dn610075.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=89fbbdd0-7504-4807-9337-08324aa457e7&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610075.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                               | [![](../../images/Dn610075.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=43d69a41-6acb-4c64-89dc-2b9aef6e98fd&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610075.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems | [![](../../images/Dn610075.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e1d13c18-72d1-40b8-95b3-08aef8db9213&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610075.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                       | [![](../../images/Dn610075.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=b6018a61-b0ec-467e-9025-059d3c9f1c5f&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610075.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610075.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|---------------------------------------------------------------------------------------------------------------------|--------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| SMB ドライバの特権の昇格の脆弱性 - [CVE-2006-2373](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2373) | 特権の昇格   | 重要         | 重要                      | 重要                      | 重要                | 重要                               |
| SMB の無効なハンドルの脆弱性 - [CVE-2006-2374](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2374)     | サービス拒否 | 警告         | 警告                      | 警告                      | 警告                | 警告                               |
...
|---------------------------------------------------------------------|-----------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| [MS05-011](https://technet.microsoft.com/security/bulletin/ms05-011) | 置き換わる                  | 置き換わる                | 置き換わる                | 置き換わる          | 対象外                             |
...
Microsoft Update および MBSA 2.0 が現在検出しないソフトウェアに関する詳細情報は、サポート技術情報 [895660](https://support.microsoft.com/kb/895660) をご覧ください。
...
これは、[特権の昇格](https://www.microsoft.com/japan/security/glossary.mspx)の脆弱性です。攻撃者によりこの脆弱性が悪用された場合、影響を受けるコンピュータが完全に制御される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
...
これは、[サービス拒否](https://www.microsoft.com/japan/security/glossary.mspx) の脆弱性です。攻撃者はこの脆弱性を悪用し、影響を受けるコンピュータが応答しないようにする可能性があります。 その間、影響を受けるコンピュータはリクエストに応答できません。 攻撃者により、サービス拒否の脆弱性が悪用されても、コードが実行されたり、特権の昇格が行われることはありません。しかし、影響を受けるコンピュータが応答を停止する可能性があります。
...
-   「SMB ドライバの特権の昇格の脆弱性」 - CAN-2006-2373 を [iDEFENSE](https://www.idefense.com/) と協力して報告してくださった [Rubén Santamarta](https://www.reversemode.com/) 氏。
-   「SMB の無効なハンドラの脆弱性」 - CAN-2006-2374 を [iDEFENSE](https://www.idefense.com/) と協力して報告してくださった [Rubén Santamarta](https://www.reversemode.com/) 氏。
...
-   US マイクロソフトセキュリティ情報（MS06-030）
    [https://www.microsoft.com/technet/security/bulletin/ms06-030.mspx](https://technet.microsoft.com/security/bulletin/ms06-030)
-   サポート技術情報 （KB） 文書番号 ：914389
    [\[MS06-030\] サーバー メッセージ ブロックの脆弱性により、特権が昇格される](https://support.microsoft.com/kb/914389)
