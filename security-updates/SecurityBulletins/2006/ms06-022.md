...
[](https://www.microsoft.com/japan/security/bulletins/ms06-022e.mspx)
...
|                                                                                                                                                                                                                                  | PC/AT                                                                                                                                                                                             | MU                                                                            |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows XP Service Pack 1                                                                                                                                                                                              | [![](../../images/Dn610067.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f6328f82-457e-44cb-95fb-2db0e8c9ee3c&displaylang=ja) | ![](../../images/Dn610067.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 2                                                                                                                                                                                              | [![](../../images/Dn610067.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=71022ea1-94cb-4fe9-b89e-46876d068b9a&displaylang=ja) | ![](../../images/Dn610067.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                                                                                                                    | [![](../../images/Dn610067.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=a386523e-96ab-43ed-b189-e13af497b685&displaylang=ja) | ![](../../images/Dn610067.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                                                                                                                                | [![](../../images/Dn610067.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=56df0cf2-9214-4b23-9034-c59e8b7126d6&displaylang=ja) | ![](../../images/Dn610067.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems                                                                                                  | [![](../../images/Dn610067.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5e1b95c3-7e75-4468-829c-1dc7b4ece5d0&displaylang=ja) | ![](../../images/Dn610067.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                                                                                                                        | [![](../../images/Dn610067.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=4dc13b7c-01ab-4bb6-9766-0fe0d02e410d&displaylang=ja) | ![](../../images/Dn610067.mu_s(ja-JP,Security.10).gif) |
...
| Microsoft Windows 2000 Service Pack 4 上の Internet Explorer 5.01 Service Pack 4 | [![](../../images/Dn610067.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ae6d8da7-b170-416d-8812-265ffa757301&displaylang=ja) | [![](../../images/Dn610067.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ae6d8da7-b170-416d-8812-265ffa757301&displaylang=ja-nec) | ![](../../images/Dn610067.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows 2000 Service Pack 4 上の Internet Explorer 6 Service Pack 1    | [![](../../images/Dn610067.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f6328f82-457e-44cb-95fb-2db0e8c9ee3c&displaylang=ja) | [![](../../images/Dn610067.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=f6328f82-457e-44cb-95fb-2db0e8c9ee3c&displaylang=ja-nec) | ![](../../images/Dn610067.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610067.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|----------------------------------------------------------------------------------------------------------------------|------------------------------|-----------------------|--------------|------------------------------------------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| ART イメージ レンダリングの脆弱性 - [CVE-2006-2378](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2378) | リモートでコードが実行される | 緊急                  | なし         | 緊急                                                       | 緊急                      | 緊急                      | 緊急                | 緊急                               |
...
この更新プログラムは MS06-021 で対処された脆弱性を根本的に解決するものであり、マイクロソフトは MS06-021 に加えてこの更新プログラムを適用することを推奨しています。マイクロソフト セキュリティ情報 [MS06-021](https://technet.microsoft.com/security/bulletin/ms06-021) に含まれているセキュリティ更新プログラムを適用後、Internet Explorer は ART の画像形式のファイル フォーマットを表示しなくなります。ユーザーが無効に作成されたイメージを表示する時に、Internet Explorer のプロセスが予期せず閉じられることを防ぐ手助けとなるために、この変更が行なわれました。ART 形式は現在 Internet Explorer でサポートされていません。両方の更新プログラムを適用することを推奨します。
...
EST に関する情報は、よく寄せられる質問の「Enterprise Update Scan Tool (EST) とは何ですか?」および次のマイクロソフトの [Web サイト](https://support.microsoft.com/kb/894193)をご覧ください。
...
-   Windows 2000 は AOL の ART 画像を既定でサポートしていません。 Windows 2000 は、[Windows 2000 AOL Image Support Update](https://support.microsoft.com/kb/254518) (英語情報) がインストールされている場合のみ影響を受けます。 この更新プログラムにより更新されるファイルは AOL Image Support の更新プログラムをインストールしていない場合には Windows 2000 のコンピュータに存在しません。
...
-   **マイクロソフトセキュリティ情報 MS06-021 - Internet Explorer 用の累積的なセキュリティ更新プログラム (916281) をインストールします。**
    ...
    マイクロソフト セキュリティ情報 [MS06-021](https://technet.microsoft.com/security/bulletin/ms06-021) - Internet Explorer 用の累積的なセキュリティ更新プログラム (916281) のインストール後、Internet Explorer で ART ファイルが表示されなくなります。
...
ART は画像ファイルで America Online (AOL) のクライアント ソフトウェアで使用されています。 Windows にはライブラリも含まれており、Internet Explorer が ART 画像を表示します。マイクロソフト セキュリティ情報 [MS06-021](https://technet.microsoft.com/security/bulletin/ms06-021) - Internet Explorer 用の累積的なセキュリティ更新プログラム (916281) のインストール後、Internet Explorer で ART ファイルが表示されなくなります。 マイクロソフトは両方の更新プログラムをインストールすることを推奨します。
...
-   **注：** Windows 2000 は AOL の ART 画像を既定でサポートしていません。 Windows 2000 は、[Windows 2000 AOL Image Support Update](https://www.microsoft.comhttps://support.microsoft.com/kb/254518) (英語情報) がインストールされている場合のみ影響を受けます。
...
このセキュリティ更新プログラムは再起動を必要としません。 再起動が必要になる可能性を低減する手助けとするために、このセキュリティ更新プログラムをインストールする前に、すべての影響を受けるスプーラのサービスを停止し、影響を受けるファイルを使用している可能性のあるすべてのアプリケーションを閉じてください。再起動が必要となる理由に関する詳細情報は、サポート技術情報 [887012](https://support.microsoft.com/kb/887012) をご覧ください。
...
-   ART の画像表示の脆弱性 - CVE-2006-2378 を報告してくださった [iDEFENSE](https://www.idefense.com/) 社
...
-   US マイクロソフトセキュリティ情報（MS06-022）
    [https://www.microsoft.com/technet/security/bulletin/MS06-022.mspx](https://technet.microsoft.com/security/bulletin/ms06-022)
-   サポート技術情報 （KB） 文書番号 ：918439
    [\[MS06-022\] ART の画像表示の脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/918439)
