...
[](https://www.microsoft.com/japan/security/bulletins/ms06-015e.mspx)
...
**警告:**   サポート技術情報 [918165](https://support.microsoft.com/kb/918165) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。 また、このサポート技術情報には、これらの問題に対する推奨される解決策に関する説明も記載されています。 詳細情報は、サポート技術情報 [918165](https://support.microsoft.com/kb/918165) をご覧ください。
...
|                                                                                                                                                                                            | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                                                                                      | [![](../../images/Dn610060.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ae28bc65-3a5e-4497-ad05-2cde8e7b5e95&displaylang=ja) | [![](../../images/Dn610060.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ae28bc65-3a5e-4497-ad05-2cde8e7b5e95&displaylang=ja-nec) | ![](../../images/Dn610060.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                                                                             | [![](../../images/Dn610060.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=392c2f1b-aa24-48e5-8d5b-ea56341db936&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610060.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                                                                              | [![](../../images/Dn610060.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=11a5195e-3f32-41f9-ab39-68a099ee945d&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610060.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                                                                                          | [![](../../images/Dn610060.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=099ee535-8b31-4356-b3fb-ef524c20a424&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610060.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems                                                            | [![](../../images/Dn610060.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=e3c7e736-1583-4bd5-b661-a9aaddfa5b86&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610060.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                                                                                  | [![](../../images/Dn610060.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=238ab809-5a7e-4678-b01b-38fd82e9c701&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610060.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610060.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://windowsupdate.microsoft.com/) からインストールすることもできます。
...
|-----------------------------------------------------------------------------------------------------------|------------------------------|-----------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Windows シェルの脆弱性 - [CVE-2006-0012](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0012) | リモートでコードが実行される | 緊急                  | 緊急         | 緊急                      | 緊急                      | 緊急                | 緊急                               |
...
**注:** サポート技術情報 [918165](https://support.microsoft.com/kb/918165) に示されているように、すでに MS06-015 の更新プログラムを適用したお客様で、この問題の影響を受けていない場合は何もする必要はありません。

**更新されたセキュリティ更新プログラムにはどのような変更が含まれていますか?**

更新されたセキュリティ更新プログラムには最初のセキュリティ更新プログラムに含まれていたバイナリに対する変更は含まれていません。 インストール中、更新されたセキュリティ更新プログラムは、サポート技術情報 [918165](https://support.microsoft.com/kb/918165) に示されているように、許可リスト内に次のエントリを配置します。
...
Microsoft Baseline Security Analyzer (MBSA) 1.2.1 については、検出ロジックが更新されたため、更新されたパッケージは最初の更新プログラムをインストールしていないコンピュータのみに提供されます。 MBSA 1.2.1 は特定されたサード パーティの COM コントロールがインストールされているかどうか判断するために使用できません。これらの問題が発生している MBSA 1.2.1 を使用しているお客様は、マイクロソフトはグループ ポリシーまたはスクリプトを使用して上記の COM コントロールを許可リストに手動で追加することを推奨します。この手順は、サポート技術情報 [918165](https://support.microsoft.com/kb/918165) に記載されています。

**このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題にはどのようなものがありますか?**

サポート技術情報 [918165](https://support.microsoft.com/kb/918165) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。 また、このサポート技術情報には、これらの問題に対する推奨される解決策に関する説明も記載されています。 詳細情報は、サポート技術情報 [918165](https://support.microsoft.com/kb/918165) をご覧ください。
...
|-------------------------------------------------------------------------|------------------|------------|---------------------|
| [**MS05-016**](https://technet.microsoft.com/security/bulletin/ms05-016) | 置き換えられない | 置き換わる | 置き換わる          |
| [**MS05-008**](https://technet.microsoft.com/security/bulletin/ms05-008) | 置き換わる       | 置き換わる | 置き換わる          |
...
はい。MBSA 1.2.1 により、この更新プログラムが必要かどうかを確認することができます。MBSA に関する詳細は、[MBSA Web サイト](https://technet.microsoft.com/ja-jp/security/cc184924.aspx)をご覧下さい。
...
-   **グループポリシー設定を使用して、この機能を必要としない該当のすべてのコンピュータ上で、WebClientサービスを無効に設定する**
    ...
    **注:** [Windows Server 2003 セキュリティ ガイド](https://www.microsoft.com/japan/technet/security/prodtech/windowsserver2003/w2003hg/sgch00.mspx)も参考にすることができます。このガイドには、サービスを無効にする方法に関する説明が記載されています。
...
-   **TCPポート139および445をファイアウォールでブロックする**
    ...
    WebDAV は TCP ポート 80 を送信に使用していますが、悪意のあるサービスに接続し、この脆弱性を悪用しようとする目的で TCP ポート 139 および 445 が送信に使用される可能性があります。 ファイアウォールで、受信と送信の両方をブロックすると、ファイアウォールの背後のコンピュータを、この脆弱性を悪用した攻撃から保護する手助けとなります。 そのほかのポートを悪用する可能性のある攻撃を防ぐため、すべてのインターネットからの受信者側が送信を要求していない受信通信をブロックすることを推奨します。 ポートに関する詳細情報は、次の [Web サイト](https://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/cnet/cnfc_por_gdqc.mspx) (英語情報) をご覧ください。
...
はい。Windows 98、Windows 98 Second Edition および Windows Millennium Edition はこの脆弱性による深刻な影響を受けます。 セキュリティ更新プログラムは コンシューマ プラットフォーム用の更新プログラムは、[Windows Update](https://windowsupdate.microsoft.com/) から利用可能です。深刻度評価システムに関する詳細情報は、次の [Web サイト](https://technet.microsoft.com/security/bulletin/rating) をご覧ください。
...
-   「Windows シェルの脆弱性」 （[CVE-2006-0012](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0012)） を報告してくださった [NISCC](https://www.niscc.gov.uk/)
...
-   US マイクロソフトセキュリティ情報（MS06-015）
    [https://www.microsoft.com/technet/security/bulletin/MS06-015.mspx](https://technet.microsoft.com/security/bulletin/ms06-015)
-   サポート技術情報 （KB） 文書番号 ：908531
    [\[MS06-015\] Windows エクスプローラの脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/908531)
