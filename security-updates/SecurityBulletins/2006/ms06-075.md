...
[](https://www.microsoft.com/japan/security/bulletins/ms06-075e.mspx)
...
|                                                         | PC/AT                                                                                                                                                                                             | MU                                                                            |
|---------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows XP Service Pack 2                     | [![](../../images/Dn610121.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=966704b5-1a7e-4110-9694-844706a52db7&displaylang=ja) | ![](../../images/Dn610121.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003                           | [![](../../images/Dn610121.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=5ea314a2-d76a-46f9-853b-15ff03f8ad95&displaylang=ja) | ![](../../images/Dn610121.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems | [![](../../images/Dn610121.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=7bceaa11-f655-4e3c-a588-5c49097e970b&displaylang=ja) | ![](../../images/Dn610121.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610121.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|------------------------------------------------------------------------------------------------------------------------|--------------|---------------------------|---------------------|
| マニフェスト ファイルの破損の脆弱性 - [CVE-2006-5585](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5585) | 特権の昇格   | 重要                      | 重要                |
...
Windows XP Service Pack 1 のサポート ライフサイクルが終了しました。今後の脆弱性の影響を受ける可能性を防ぐため、これらのオペレーティング システムを使用しているお客様は、サポート対象のバージョンに移行することを強く推奨します。 Windows 製品のサポート ライフサイクルに関する詳細情報は、[マイクロソフト サポート ライフサイクル](https://support.microsoft.com/gp/lifecycle)をご覧ください。 これらのオペレーティングシステムのバージョンについて、延長されたセキュリティ更新プログラムのサポート期間に関する詳細情報は、[マイクロソフト製品サポート サービス Web サイト](https://support.microsoft.com/gp/lifesupsps)をご覧ください。
...
Microsoft Windows が特別に細工されたマニフェスト ファイルを起動させる方法に、[特権の昇格](https://www.microsoft.com/japan/security/glossary.mspx)の脆弱性が存在します。この脆弱性により、ログオンしたユーザーがコンピュータを完全に制御できる可能性があります。
...
サポート技術情報 [921337](https://support.microsoft.com/kb/921337) では、関連のコンピュータを再起動させる可能性があるマニフェスト ファイルの問題を取り上げています。この問題を確認する中で、マイクロソフトはこのセキュリティ更新プログラムのリリースで解決された潜在的なセキュリティの脆弱性を特定しました。
...
このセキュリティ更新プログラムを適用するには、Windows XP Service Pack 2 (SP2) がインストールされている必要があります。詳細情報は、マイクロソフト サポート技術情報[322389](https://support.microsoft.com/kb/322389) をご覧ください。
...
-   US マイクロソフトセキュリティ情報（MS06-075）
    [https://www.microsoft.com/technet/security/bulletin/MS06-075.mspx](https://technet.microsoft.com/security/bulletin/ms06-075)
-   サポート技術情報 （KB） 文書番号 ：926255
    [\[MS06-075\] Windows の脆弱性により、特権が昇格される](https://support.microsoft.com/kb/926255)
