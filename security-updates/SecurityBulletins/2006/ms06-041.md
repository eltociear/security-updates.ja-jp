...
[](https://www.microsoft.com/japan/security/bulletins/ms06-041e.mspx)
...
|                                                                                                                                 | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                           | [![](../../images/Dn610086.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=144408a7-3011-458a-bc79-49b1658aa25d&displaylang=ja) | [![](../../images/Dn610086.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=144408a7-3011-458a-bc79-49b1658aa25d&displaylang=ja-nec) | ![](../../images/Dn610086.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                  | [![](../../images/Dn610086.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=c332b95a-2956-406b-9e06-07c5e96b02e3&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610086.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                   | [![](../../images/Dn610086.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=1be5310b-1995-4ef9-a462-04da9833f50b&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610086.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                               | [![](../../images/Dn610086.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6d027e72-1f94-44de-95f9-f52000a991cc&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610086.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems | [![](../../images/Dn610086.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=18477016-0b70-4c86-90c7-3535d365b7c1&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610086.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                       | [![](../../images/Dn610086.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=583b741c-47e2-429d-9d50-44670bb2f452&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610086.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610086.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|------------------------------------------------------------------------------------------------------------------------------------|------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Winsock のホスト名の脆弱性 - [CVE-2006-3440](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3440)                      | リモートでコードが実行される | 緊急         | 緊急                      | 緊急                      | 緊急                | 緊急                               |
| DNS クライアントのバッファ オーバーランの脆弱性 - [CVE-2006-3441](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3441) | リモートでコードが実行される | 緊急         | 緊急                      | 緊急                      | 緊急                | 緊急                               |
...
-   **ネットワークベースでのこの脆弱性の悪用に対する保護の手助けを行うために、**[**インターネット接続ファイアウォール**](https://www.microsoft.com/japan/security/guidance/default.mspx)**などのパーソナルファイアウォールを使用する(インターネット接続ファイアウォールはWindows XPおよびWindows Server 2003に含まれています)**
...
Windows Sockets 2 (Winsock) により、プログラマはネットワーク プロトコルを使用せずにワイヤでアプリケーションのデータを伝送するための高度なインターネット、イントラネットおよびそのほかのネットワーク対応のアプリケーションを作成することができます。Winsock で、プログラマにマルチキャストおよびサービスの品質 (QOS) のような高度な Microsoft Windows のネットワークの性能へのアクセスが提供されます。Winsock に関する詳細情報は、次の [MSDN コラム](https://windowssdk.msdn.microsoft.com/en-us/library/ms740673.aspx) (英語情報) をご覧ください。
...
攻撃者によりインターネットでこの脆弱性が悪用される可能性があります。ファイアウォールの最善策および標準の既定のファイアウォールの構成により、インターネット経由での攻撃からコンピュータを保護することができます。マイクロソフトはどのようにコンピュータを保護するかについての情報を提供しています。ホーム ユーザーの方は、[Protect Your PC Web サイト](https://www.microsoft.com/japan/security/protect/)をご覧ください。IT プロフェッショナルは、[Security Guidance Center](https://www.microsoft.com/japan/security/guidance/default.mspx) をご覧ください。
...
このセキュリティ更新プログラムはホットパッチをサポートします。ホットパッチを使用している場合、サーバーを再起動しないで Microsoft Windows Server 2003 Service Pack 1 を実行しているコンピュータにセキュリティ更新プログラムをインストールできます。ホットパッチおよびホットパッチとしてこのセキュリティ更新プログラムを適用する方法に関する詳細情報は、サポート技術情報 [897341](https://support.microsoft.com/kb/897341) をご覧ください。Windows Update、Microsoft Update および自動更新で利用可能なこのセキュリティ更新プログラムは、ホットパッチを活用し、サーバーの再起動を必要としません。
...
-   「Winsock のホスト名の脆弱性」 - [CVE-2006-3440](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3440) を報告してくださった [NGS Software](https://www.ngssoftware.com/) の Peter Winter Smith 氏
-   「DNS クライアントのバッファ オーバーランの脆弱性」 - [CVE-2006-3441](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3441) を報告してくださった [ISS X-Force](https://www.iss.net/) でリサーチを実施している Mark Dowd 氏
...
-   US マイクロソフトセキュリティ情報（MS06-041）
    [https://www.microsoft.com/technet/security/bulletin/ms06-041.mspx](https://technet.microsoft.com/security/bulletin/ms06-041)
-   サポート技術情報 （KB） 文書番号 ：920683
    [\[MS06-041\] DNS 解決の脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/920683)
