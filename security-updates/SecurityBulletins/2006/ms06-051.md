---
TOCTitle: 'MS06-051'
Title: 'マイクロソフト セキュリティ情報 MS06-051 - 緊急'
ms:assetid: 'ms06-051'
ms:contentKeyID: 61228923
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms06-051(v=Security.10)'
---



マイクロソフト セキュリティ情報 MS06-051 - 緊急
===============================================

Windows カーネルの脆弱性により、リモートでコードが実行される (917422)
---------------------------------------------------------------------

公開日: 2006年8月9日 | 最終更新日: 2006年8月16日

[](https://www.microsoft.com/japan/security/bulletins/ms06-051e.mspx)
...
|                                                                                                                                 | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                           | [![](../../images/Dn610096.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=83e0c6fb-a542-463a-88fd-dc388605a8ae&displaylang=ja) | [![](../../images/Dn610096.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=83e0c6fb-a542-463a-88fd-dc388605a8ae&displaylang=ja-nec) | ![](../../images/Dn610096.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                  | [![](../../images/Dn610096.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=71e96afc-bc4d-4666-998b-49857007e539&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610096.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                   | [![](../../images/Dn610096.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=a6fe5b95-11d1-42cd-995c-c8cef8a27aef&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610096.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                               | [![](../../images/Dn610096.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=7d0f888b-df35-40df-baff-0bae2b921aef&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610096.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems | [![](../../images/Dn610096.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=df365b0b-f97f-4df1-9105-d81b68a110eb&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610096.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                       | [![](../../images/Dn610096.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=3f750ad5-5bfb-4421-a316-ae66f0557eac&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610096.mu_s(ja-JP,Security.10).gif) |

![](../../images/Dn610096.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機用または NEC PC-9800 シリーズ用の更新プログラムをダウンロードしてください。

更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](https://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](https://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

![](../../images/Dn610096.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
この更新プログラムは新たに確認され、公開された脆弱性および非公開で報告された脆弱性を解決します。また、内部の調査で確認されたそのほかの問題も解決します。
...
|------------------------------------------------------------------------------------------------------------------------------|------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| ユーザー プロファイルの特権の昇格の脆弱性 - [CVE-2006-3443](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3443) | 特権の昇格                   | 重要         | 注意                      | 注意                      | 注意                | 注意                               |
| 処理されない例外の脆弱性 [CVE-2006-3648](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3648)                    | リモートでコードが実行される | 緊急         | 緊急                      | 緊急                      | 緊急                | 緊急                               |
...
Windows 2000 がアプリケーションを起動する方法に[特権の昇格](https://www.microsoft.com/japan/security/glossary.mspx)の脆弱性が存在します。この脆弱性により、ログオンしたユーザーがコンピュータを完全に制御できる可能性があります。

#### 「ユーザー プロファイルの特権の昇格の脆弱性」の問題を緩和する要素 - CVE-2006-3443:

-   この脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。リモートで、または匿名ユーザーにより、この脆弱性が悪用されることはないと思われます。
-   Windows XP Service Pack 1、Windows XP Service Pack2、Windows Server 2003 および Windows Server 2003 Service Pack1 で、SafeDllSearchMode は既定で 1 に設定されており、この脆弱性の影響を受けません。この既定の構成が管理者により変更されている場合、または無効にされている場合、この脆弱性の影響を受ける可能性があります。

#### 「ユーザー プロファイルの特権の昇格の脆弱性」の回避策 - CVE-2006-3443:

マイクロソフトは次の回避策のテストを行いました。これらの回避策は根本的な脆弱性を修正しませんが、既知の攻撃方法を阻止する手助けとなります。回避策が機能の低下の原因となる場合、下記に示します。

-   **SafeDllSearchMode を 1 に設定する**

    レジストリ内で SafeDllSearchMode を 1 に設定すると、DLL 検索パスの順序は現在作業中のディレクトリまたはユーザー プロファイル ディレクトリの前のシステム ディレクトリをターゲットとします。ダイナミック リンク ライブラリの検索の順序に関する詳細情報は、次の [MSDN コラム](https://msdn2.microsoft.com/en-us/library/ms682586.aspx) (英語情報) をご覧ください。
    ...
    **注:** マイクロソフトはレジストリの編集を行う前に、そのバックアップを行うことを推奨します。
    ...
    3.  SafeDllSearchMode という名前の DWORD 値を追加し、値を 1 に設定します。この値は既定の DLL 検索の順序をシステム ディレクトリに設定します。 既定で、Windows 2000 にはこのキーは存在しません。

    4.  この変更を有効にするには、コンピュータを再起動する必要があります。

#### 「ユーザー プロファイルの特権の昇格の脆弱性」のよく寄せられる質問 - CVE-2006-3443:
...
Windows 2000 で、Winlogon は無効なパスの使用を禁止しません。特別な細工がされた DLL がユーザー ディレクトリに配置された場合、WinLogon が DLL のコードを実行し、これによりユーザーの特権を昇格する可能性があります。

**Winlogon とは何ですか?**

Winlogon とは Windows でセキュリティ関連のユーザーの対話を管理するプロセスです。 これはログオンおよびログオフ リクエスト、コンピュータのロックまたはアンロック、パスワードの変更およびそのほかのリクエストを処理します。

**DLL とは何ですか?**

DLL は 2 種類の関数を定義します。それはエクスポートされた関数および内部関数です。エクスポートされた関数は、定義されている DLL 内からだけでなく、そのほかのモジュールにより呼び出されることが意図されています。内部関数は通常、定義されている DLL 内からのみ呼び出されることが意図されています。DLL はデータをエクスポートしますが、そのデータは一般的にその関数によってのみ使用されます。しかし、別のモジュールがそのアドレスを読み取るまたは書き込むことを妨げるものはありません。DLL はアプリケーションが更新され、より容易に再使用されるようにアプリケーションをモジュール化する方法を提供します。 また、複数のアプリケーションが同時に同じ関数を使用する場合、DLL はメモリのオーバーヘッドを低減する手助けとなります。これは、各アプリケーションは DLL データのコピーを受け取りますが、アプリケーションは DLL コードを共有するためです。 DLL に関する詳細情報は、[MSDN コラム](https://msdn2.microsoft.com/en-us/library/ms682589.aspx) (英語情報) をご覧ください。

**SafeDllSearchMode レジストリ キーが見当たらない場合、Windows XP および Windows 2003 はこの脆弱性の影響を受けますか?**

Windows XP Service Pack 1、Windows XP Service Pack 2、Windows Server 2003 および Windows Server 2003 Service Pack1 で、SafeDllSearchMode はオペレーティング システム内で既定で 1 に設定されており、このためこの脆弱性の影響は受けません。1 以外の値を持つレジストリ キーを追加すると、既定の構成が変更されます。SafeDllSearchMode の構成に関する詳細情報は、次の [MSDN コラム](https://msdn2.microsoft.com/en-us/library/ms682589.aspx) (英語情報) をご覧ください。
...
この脆弱性が悪用されるには、まず、コンピュータにログオンすることが攻撃者にとっての必要条件となります。攻撃者は次に特別な細工がされた DLL を UserProfile ディレクトリ内に配置し、コンピュータを再起動する可能性があります。攻撃者により再起動が行われ、再度ログオンされた後、DLL はこの脆弱性を悪用する可能性のあるコードを実行し、攻撃者により影響を受けるコンピュータが完全に制御される可能性があります。
...
この更新プログラムは WinLogon が Windows 2000 の無効なパスを使用しないようにして、この脆弱性を排除します。
...
メモリに存在する複数のアプリケーションで管理される、例外処理の方法にリモートでコードが実行される脆弱性が存在します。

#### 「処理されない例外の脆弱性」の問題を緩和する要素 - CVE-2006-3648:

-   この脆弱性が悪用されるには、この脆弱性の悪用を意図した Web ページを含む Web サイトをホストすることが攻撃者にとっての必要条件となります。攻撃者は、特別な細工がされた Web サイトにユーザーを強制的に訪問させることはできません。その代わり、通常、ユーザーに攻撃者の Web サイトへのリンクをクリックさせ、その Web サイトにユーザーを誘導することが攻撃者にとっての必要条件となります。ユーザーがリンクをクリックした後、ユーザーにいくつかの動作を実行するよう誘導するメッセージが表示される可能性があります。ユーザーがこれらの操作を行った場合にのみ、攻撃が実行される可能性があります。
-   この脆弱性が悪用された場合、攻撃者によりローカル ユーザーと同じ権限が取得される可能性があります。コンピュータでユーザー権限が低い設定のアカウントを持つユーザーは、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。
-   制限付きサイト ゾーンは、HTML 形式の電子メール メッセージの読み取りが行われる場合、アクティブ スクリプトおよび ActiveX コントロールが使用されないようにすることにより、この脆弱性を悪用しようとする攻撃を削減する手助けとなります。 しかし、ユーザーが電子メール メッセージ内のリンクをクリックする場合、前述の Web ベースの攻撃のシナリオによるこの問題の影響を依然として受ける可能性があります。
-   既定で、Microsoft Outlook Express 6、Outlook 2002、および Outlook 2003 は、HTML 形式の電子メール メッセージを制限付きサイト ゾーンで開きます。 また、Outlook 98 および Outlook 2000 では、[Outlook 電子メール セキュリティ更新プログラム](https://office.microsoft.com/japan/downloads/2000/out2ksec.aspx)がインストールされている場合、HTML 形式の電子メール メッセージが制限付きサイト ゾーンで開かれます。 Outlook Express 5.5 Service Pack 2 は、[MS04-018](https://technet.microsoft.com/security/bulletin/ms04-018) がインストールされている場合、HTML 形式の電子メール メッセージを制限付きサイト ゾーンで開きます。

#### 「処理されない例外の脆弱性」の回避策 - CVE-2006-3648:

マイクロソフトは次の回避策のテストを行いました。これらの回避策は根本的な脆弱性を修正しませんが、既知の攻撃方法を阻止する手助けとなります。回避策が機能の低下の原因となる場合、下記に示します。

-   **マイ コンピュータ ゾーンのアクティブ スクリプトを無効にする**
    ...
    **注:** マイクロソフトはレジストリの編集を行う前に、そのバックアップを行うことを推奨します。
    ...
    3.  1400 という名前の DWORD 値をクリックします。

    4.  DWORD の編集のダイアログが表示されます。既定の値は 0 です。この値を 3 に変更します。

    5.  Internet Explorer のすべてのインスタンスを閉じてください。次に Internet Explorer が起動すると、変更が有効になります。
...
#### 「処理されない例外の脆弱性」のよく寄せられる質問 - CVE-2006-3648:
...
メモリに存在するアプリケーションで例外処理が適切に行われないため、この脆弱性が起こります。
...
Windows ワークステーションおよびサーバー コンピュータが主に危険にさらされます。サーバーは、十分な管理者アクセス権を所有していないユーザーが、サーバーにログオンし、プログラムを実行する権限を得た場合にこの脆弱性による危険にさらされる可能性が高くなります。しかし、セキュリティ上の最善策として、これを許可しないことが強く推奨されています。
...
この更新プログラムは例外処理を正しく行うことにより、この脆弱性を排除します。
...
**WindowsServer2003-KB917422-x86-JPN /quiet**

**注: /quiet** スイッチを使用すると、すべてのメッセージが表示されなくなります。 これは、エラー メッセージを表示しなくなることも含みます。 管理者は **/quiet** スイッチを使用する場合、インストールが正常に完了したことを確認するためのサポートされている方法の 1 つを使用してください。 また、管理者はこのスイッチを使用する場合、エラー メッセージについて KB917422.log ファイルを確認してください。

コンピュータを強制的に再起動せずにセキュリティ更新プログラムをインストールするためには、Windows Server 2003 のコマンド プロンプトで次のコマンドを使用してください。

**WindowsServer2003-KB917422-x86-JPN /norestart**
...
システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB917422$\\Spuninst フォルダにあります。このユーティリティは次のセットアップ スイッチをサポートします。
...
|--------------|---------------|-----------|-------|-----------|----------|
| kernel32.dll | 5.2.3790.566  | 2006/7/25 | 21:31 | 1,245,696 | RTMGDR   |
| kernel32.dll | 5.2.3790.566  | 2006/7/25 | 21:41 | 1,246,208 | RTMQFE   |
| termsrv.dll  | 5.2.3790.566  | 2006/7/25 | 21:41 | 215,552   | RTMQFE   |
| winsta.dll   | 5.2.3790.566  | 2006/7/25 | 21:41 | 52,224    | RTMQFE   |
| kernel32.dll | 5.2.3790.2756 | 2006/7/25 | 21:36 | 1,295,872 | SP1GDR   |
| kernel32.dll | 5.2.3790.2756 | 2006/7/25 | 21:56 | 1,295,872 | SP1QFE   |
...
|---------------|---------------|-----------|------|-----------|------|-------------|
| kernel32.dll  | 5.2.3790.566  | 2006/7/25 | 6:12 | 2,109,440 | ia64 | RTMGDR      |
| wkernel32.dll | 5.2.3790.566  | 2006/7/25 | 6:12 | 758,784   | x86  | RTMGDR\\wow |
| kernel32.dll  | 5.2.3790.566  | 2006/7/25 | 6:12 | 2,110,464 | ia64 | RTMQFE      |
| termsrv.dll   | 5.2.3790.566  | 2006/7/25 | 6:12 | 614,912   | ia64 | RTMQFE      |
| winsta.dll    | 5.2.3790.566  | 2006/7/25 | 6:12 | 141,824   | ia64 | RTMQFE      |
| wkernel32.dll | 5.2.3790.566  | 2006/7/25 | 6:12 | 760,320   | x86  | RTMQFE\\wow |
| wwinsta.dll   | 5.2.3790.566  | 2006/7/25 | 6:12 | 52,224    | x86  | RTMQFE\\wow |
| kernel32.dll  | 5.2.3790.2756 | 2006/7/25 | 6:14 | 2,224,128 | ia64 | SP1GDR      |
| wkernel32.dll | 5.2.3790.2756 | 2006/7/25 | 6:14 | 832,000   | x86  | SP1GDR\\wow |
| kernel32.dll  | 5.2.3790.2756 | 2006/7/25 | 6:12 | 2,223,104 | ia64 | SP1QFE      |
| wkernel32.dll | 5.2.3790.2756 | 2006/7/25 | 6:12 | 832,512   | x86  | SP1QFE\\wow |
...
| ファイル名    | バージョン    | 日付      | 時間 | サイズ    | CPU | フォルダ    |
|---------------|---------------|-----------|------|-----------|-----|-------------|
| kernel32.dll  | 5.2.3790.2756 | 2006/7/25 | 6:11 | 1,758,208 | x64 | SP1GDR      |
| wkernel32.dll | 5.2.3790.2756 | 2006/7/25 | 6:11 | 832,000   | x86 | SP1GDR\\wow |
| kernel32.dll  | 5.2.3790.2756 | 2006/7/25 | 6:08 | 1,758,720 | x64 | SP1QFE      |
| wkernel32.dll | 5.2.3790.2756 | 2006/7/25 | 6:08 | 832,512   | x86 | SP1QFE\\wow |
...
-   **レジストリキーの確認**
    ...
    **注:** このレジストリ キーには、インストールされるファイルの完全な一覧が含まれない場合があります。また、管理者または OEM メーカーによって 917422 のセキュリティ更新プログラムを Windows インストール ソース ファイルに統合またはスリップストリーム化されている場合、このレジストリ キーが適切に作成されない場合があります。
...
**WindowsXP-KB917422-x86-JPN /quiet**

**注: /quiet** スイッチを使用すると、すべてのメッセージが表示されなくなります。 これは、エラー メッセージを表示しなくなることも含みます。 管理者は **/quiet** スイッチを使用する場合、インストールが正常に完了したことを確認するためのサポートされている方法の 1 つを使用してください。 また、管理者はこのスイッチを使用する場合、エラー メッセージについて KB917422.log ファイルを確認してください。

コンピュータを強制的に再起動せずにセキュリティ更新プログラムをインストールするためには、Windows XP のコマンド プロンプトで次のコマンドを使用してください。

**WindowsXP-KB917422-x86-JPN /norestart**
...
| ファイル名   | バージョン    | 日付     | 時間  | サイズ    | フォルダ |
|--------------|---------------|----------|-------|-----------|----------|
| kernel32.dll | 5.1.2600.1869 | 2006/7/5 | 19:53 | 1,175,040 | SP1QFE   |
| kernel32.dll | 5.1.2600.2945 | 2006/7/5 | 19:55 | 1,230,336 | SP2GDR   |
| kernel32.dll | 5.1.2600.2945 | 2006/7/5 | 19:57 | 1,231,360 | SP2QFE   |
...
-   **レジストリキーの確認**
    ...
    HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP2\\KB917422\\Filelist

    **注:** これらのレジストリ キーには、インストールされるファイルの完全な一覧が含まれない場合があります。また、管理者または OEM メーカーによって 917422 のセキュリティ更新プログラムを Windows インストール ソース ファイルに統合またはスリップストリーム化されている場合、このレジストリ キーが適切に作成されない場合があります。
...
| ファイル名   | バージョン     | 日付      | 時間  | サイズ  | フォルダ |
|--------------|----------------|-----------|-------|---------|----------|
| kernel32.dll | 5.00.2195.7099 | 2006/6/21 | 12:23 | 907,024 |          |
| mpr.dll      | 5.00.2195.6824 | 2006/6/21 | 12:23 | 54,544  |          |
| kernel32.dll | 5.00.2195.7099 | 2006/6/21 | 12:23 | 907,024 | uniproc  |
...
-   「ユーザー プロファイルの特権の昇格の脆弱性」 - [CVE-2006-3443](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3443) を報告してくださった [Canaudit, Inc](https://www.canaudit.com/) の Reed Arvin 氏
-   「処理されない例外の脆弱性」 - [CVE-2006-3684](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3684) を報告してくださった [Leviathan Security Group](https://www.leviathansecurity.com/) の Matt Miller 氏および協力してくださった Ken Johnson 氏
...
-   US マイクロソフトセキュリティ情報（MS06-051）
    [https://www.microsoft.com/technet/security/bulletin/ms06-051.mspx](https://technet.microsoft.com/security/bulletin/ms06-051)
-   サポート技術情報 （KB） 文書番号 ：917422
    [\[MS06-051\] Windows カーネルの脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/917422)

**更新履歴** **:**

-   2006/08/09: このセキュリティ情報ページを公開しました。
-   2006/08/16: 「処理されない例外の脆弱性」のよく寄せられる質問の「どのようなことが起こる可能性がありますか?」を更新しました。
