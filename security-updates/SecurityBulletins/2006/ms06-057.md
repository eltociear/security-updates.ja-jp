...
[](https://www.microsoft.com/japan/security/bulletins/ms06-057e.mspx)
...
|                                                                                                                                 | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                           | [![](../../images/Dn610102.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=756f53a7-28dc-422a-a691-c1bbfcbf3d0c&displaylang=ja) | [![](../../images/Dn610102.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=756f53a7-28dc-422a-a691-c1bbfcbf3d0c&displaylang=ja-nec) | ![](../../images/Dn610102.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                  | [![](../../images/Dn610102.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=235bca55-8d43-4eaf-8970-a55bc3165e3d&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610102.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                   | [![](../../images/Dn610102.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=96271f96-0d8e-4ab1-b131-2b37fca7e6e7&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610102.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                               | [![](../../images/Dn610102.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=48f2314b-b268-468c-919c-593e06af4453&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610102.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems | [![](../../images/Dn610102.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=6507e201-b84e-432a-8797-23b586ad15ae&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610102.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                       | [![](../../images/Dn610102.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=2b39693f-aabc-49c6-9d1a-6791f80f8f22&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610102.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610102.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|-------------------------------------------------------------------------------------------------------------------------------|------------------------------|-----------------------------|------------------------------------------------------------|---------------------|------------------------------------|
| Windows シェルのリモート コード実行の脆弱性- [CVE-2006-3730](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3730) | リモートでコードが実行される | 緊急                        | 緊急                                                       | 警告                | 警告                               |
...
|---------------------------------------------------------------------|-----------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| [MS06-045](https://technet.microsoft.com/security/bulletin/ms06-045) | 置き換わらない              | 置き換わる                | 置き換わらない            | 置き換わらない      | 置き換わらない                     |
...
-   **WebViewFolderIcon ActiveX** **が** **Internet Explorer** **で実行されないようにする**
    ...
    **注:** CLSID {e5df9d10-3b52-11d1-83e8-00a0c90dc849} の互換性フラグは、最初 0x20000 の DWORD 値を持っています。 この回避策を展開する場合、このセキュリティ更新プログラムをインストールした後、キーを削除するよりも、DWORD 値を 0x20000 にリセットする必要があります。 登録された Microsoft ActiveX コントロールの動作を決定するさまざまな値の情報については、以下の [Web サイト](https://msdn2.microsoft.com/en-us/library/aa768187.aspx) (英語情報) をご覧ください。
...
既定で、Windows Server 2003 上の Internet Explorer は、[「セキュリティ強化の構成」](https://www.microsoft.com/japan/windowsserver2003/developers/iesecconfig.mspx)と呼ばれる制限されたモードで実行されます。このモードにより、この脆弱性の影響が緩和されます。
...
はい。このセキュリティ更新プログラムは、この脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2004-4690](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3730) に割り当てられています。
...
-   US マイクロソフトセキュリティ情報（MS06-057）
    [https://www.microsoft.com/technet/security/bulletin/MS06-057.mspx](https://technet.microsoft.com/security/bulletin/ms06-057)
-   サポート技術情報 （KB） 文書番号 ：923191
    [\[MS06-057\] Windows Explorer の脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/923191)
