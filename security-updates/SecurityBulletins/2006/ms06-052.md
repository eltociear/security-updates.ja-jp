...
[](https://www.microsoft.com/japan/security/bulletins/ms06-052e.mspx)
...
|                                                                                | PC/AT                                                                                                                                                                                             | MU                                                                            |
|--------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2 | [![](../../images/Dn610097.dl_arrow(ja-JP,Security.10).jpg)](https://www.microsoft.com/download/details.aspx?familyid=ce264ac4-6ca3-4732-9016-3143ff1bca2f&displaylang=ja) | ![](../../images/Dn610097.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610097.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](https://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|-------------------------------------------------------------------------------------------------------------|------------------------------|---------------------------|---------------------------|
| PGM のコードの実行の脆弱性 [CVE-2006-3442](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3442) | リモートでコードが実行される | 重要                      | 重要                      |
...
PGM は信頼のおける拡張可能なマルチキャスト プロトコルで、受信者によりデータ損失の検出、その再送信のリクエスト、または修復不能なデータのアプリケーションの通知ができます。 受信者はすべてのデータを受け取ったかどうかを確認することができるため、PGM は受信者にとって信頼できるプロトコルです。これにより送信者は受信確認を行う必要がありません。PGM は、複数のソースから複数の受信者へ配信される複製可能なマルチキャストのデータを必要とするアプリケーションに適しています。 PGM は送信元認証のサポートも、複数の送信者からのパケットの優先度に関する保証も行ないません。 PGM に関する詳細情報は、[Web サイト](https://msdn2.microsoft.com/en-us/library/ms740090.aspx) (英語情報) をご覧ください。

**MSMQ** **および** **MSMQ** **サービスとは何ですか?**

Microsoft メッセージ キュー サービス (MSMQ) により、異なる時に実行されているアプリケーションが異機種ネットワークおよび一時的にオフラインとなっている可能性のあるコンピュータとの通信ができるようになります。PGM に関する詳細情報は、[Web サイト](https://msdn2.microsoft.com/en-us/library/ms740090.aspx) (英語情報) をご覧ください。
...
-   **PGM** のコードの実行の脆弱性 - [CVE-2006-3442](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3442) を報告してくださった NuPaper Inc. の David Warden 氏
...
-   US マイクロソフトセキュリティ情報 (MS06-052)
    [https://www.microsoft.com/technet/security/bulletin/MS06-052.mspx](https://technet.microsoft.com/security/bulletin/ms06-052)
-   サポート技術情報 （KB） 文書番号 ：919007
    [\[MS06-052\] Pragmatic General Multicast (PGM) の脆弱性により、リモートでコードが実行される](https://support.microsoft.com/kb/919007)
