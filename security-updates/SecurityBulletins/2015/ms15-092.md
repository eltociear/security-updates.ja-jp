...
<td style="border:1px solid black;">
[Microsoft .NET Framework 4.6](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=d132a3cf-5516-4bc9-8b15-0d3e2a6144b1)  
(3083186)
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 4.6](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=a4296c66-8bb1-4322-84de-664ffabf53be)  
(3083184)
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 4.6](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=d2529b42-806d-4f6b-9e1b-4a420689ba00)  
(3083185)
...
**注:** Windows Server Technical Preview 2 は影響を受けます。このオペレーティング システムを実行しているお客様は、[Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) を介してこの更新プログラムを適用することを推奨します。
...
<td style="border:1px solid black;">
[**RyuJIT 最適化の特権の昇格の脆弱性 - CVE-2015-2479**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-2479)

</td>
<td style="border:1px solid black;">
[**RyuJIT 最適化の特権の昇格の脆弱性 - CVE-2015-2480**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-2480)

</td>
<td style="border:1px solid black;">
[**RyuJIT 最適化の特権の昇格の脆弱性 - CVE-2015-2481**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-2481)
...
-   V1.2 (2015/09/28):影響を受けるソフトウェアの表の注釈に、Windows Server Technical Preview 2 は影響を受ける旨追加しました。このオペレーティング システムを実行しているお客様は、[Windows update](https://go.microsoft.com/fwlink/?linkid=21130) を 介してこの更新プログラムを適用することを推奨します。
