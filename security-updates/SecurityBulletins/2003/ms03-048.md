...
**なぜInternet Explorer 5.01 Service Pack 3用のセキュリティ更新プログラムのファイルのバージョン番号は、**[**MS03-040**](http://technet.microsoft.com/security/bulletin/ms03-040)**で説明されたInternet Explorer 5.01 Service Pack 3用のセキュリティ更新プログラムのファイルのバージョン番号より、低いのですか?**
