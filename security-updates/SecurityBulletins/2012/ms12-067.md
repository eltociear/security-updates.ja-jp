...
このセキュリティ更新プログラムは、SharePoint Server 2010 の影響を受けるエディションに対し、最初に[マイクロソフト セキュリティ アドバイザリ 2737111](https://technet.microsoft.com/ja-jp/security/advisory/2737111) で説明されている脆弱性も解決します。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=17909d1f-c679-4a20-b39d-b99f9cc7dbc1">Advanced Filter Pack</a> <br />
(KB2553402)</td>
...
[マイクロソフト セキュリティ アドバイザリ 2737111](https://technet.microsoft.com/ja-jp/security/advisory/2737111) の回避策を実行して Advanced Filter Pack を無効にしたお客様が、この更新プログラムの適用前に、回避策を解除する必要はありません。ただし、SharePoint 機能の Advanced Filter Pack を再度有効にするために、お客様は更新プログラムを適用した後、回避策を解除することもできます。
...
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの情報については、[サポート技術情報 2742321](https://support.microsoft.com/kb/2742321/ja) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2553402/ja">サポート技術情報 2553402</a> を参照してください。</td>
</tr>
<tr class="even">
