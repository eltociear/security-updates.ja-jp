...
<td style="border:1px solid black;">
[MS12-055](https://go.microsoft.com/fwlink/?linkid=257907) の KB2731847 は KB2761226 に置き換えられる
</td>
</tr>
...
はい。Windows 8 Release Preview および Windows Server 2012 Release Candidate 用の KB2761226 の更新プログラムが利用可能です。Windows 8 Release Preview および Windows Server 2012 RC 版をご使用のお客様は、システムにこの更新プログラムを適用することをお勧めします。この更新プログラムは [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) でのみ利用可能です。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2530](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2530) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2553](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2553) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2897](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2897) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2761226/ja">マイクロソフト サポート技術情報 2761226</a> を参照してください。</td>
</tr>
<tr class="even">
...
| ファイルに関する情報:               | [マイクロソフト サポート技術情報 2761226](https://support.microsoft.com/kb/2761226/ja) を参照してください。                                                                                  |
...
-   Windows カーネル win32k.sys の解放後使用の脆弱性 (CVE-2012-2553) を報告してくださった [Google Inc](https://www.google.com) の Matthew Jurczyk 氏  
-   Chromium Security Rewards Program と協力して TrueType フォントの解析の脆弱性 (CVE-2012-2897) を報告してくださった [Documill](https://www.documill.com) の Eetu Luodemaa 氏と Joni Vähämäki 氏
