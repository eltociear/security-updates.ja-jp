---
TOCTitle: 'MS12-008'
Title: 'マイクロソフト セキュリティ情報 MS12-008 - 緊急'
ms:assetid: 'ms12-008'
ms:contentKeyID: 61229385
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms12-008(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS12-008 - 緊急
===============================================
...
このセキュリティ更新プログラムは、Windows カーネル モード ドライバーがユーザー モードによる GDI の呼び出しを処理する方法およびキーボード レイアウト エラーを処理する方法を変更することで、これらの脆弱性を解決します。これらの脆弱性の詳細については、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」を参照してください。
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=832afe5e-d61e-4554-b889-9174df042b32)                                                                                               | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=ff2c141c-08b4-42c6-9f66-580f8678c01f)                                                                      | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=f0e6e06d-89db-45ad-9660-7959c6f9b546)                                                                                      | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=b81decda-9d82-4ffb-baae-78b190e553ea)                                                                          | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2003 with SP2 for Itanium-based Systems](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=8dcd71c8-82ad-4f86-b386-7f1ea09e157f)                                                                  | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=5852118c-fc39-45e2-8b44-ce1401d310e2)                                                                                            | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=5161d16d-1037-49d5-8d4d-c353288cb41c)                                                                                | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008 for 32-bit Systems Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=45c6c511-a4fa-4c3b-af26-6c113f6f5f5e)\*\*\*\*                                                           | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008 for x64-based Systems Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=046932cf-0671-49e6-8ddf-98abfc97c5f0)\*\*\*\*                                                        | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008 for Itanium-based Systems Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=304bd0c5-f4ee-4f8c-89b4-4cbaaf418679)                                                            | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=3e5ca1bf-9415-412c-9dff-dd1abc57e74d)                                         | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=78cbbe02-a3d3-4cef-9b54-a3e78c1b885a)                                   | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=6b228ad6-d5a4-4b91-8aa8-0874deb22116)\*\*\*\* | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=922b2438-0cfc-49e3-b9a0-52c68b69126a) | 緊急                   | リモートでコードが実行される | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
...
Windows Server 2008 および Windows Server 2008 R2 を Server Core インストール オプションを使用してインストールした場合は、CVE-2011-5046 の攻撃シナリオのうち、ローカルの特権の昇格のみの脆弱性の影響を受けます。Web ベースやファイル共有の攻撃シナリオは該当しません。
...
<th style="border:1px solid black;" >GDI のアクセス違反の脆弱性 - CVE-2011-5046</th>
<th style="border:1px solid black;" >キーボード レイアウトの解放後使用の脆弱性 - CVE-2012-0154</th>
...
ユーザー モードから GDI のカーネル コンポーネントで渡された入力を正しく検証しないため、Windows カーネルにリモートでコードが実行される脆弱性が存在します。この脆弱性により、攻撃者は、カーネルモードでコードを実行し、プログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります。
...
#### 「GDI のアクセス違反の脆弱性」の問題を緩和する要素 - CVE-2011-5046
...
#### 「GDI のアクセス違反の脆弱性」のよく寄せられる質問 - CVE-2011-5046
...
何が原因で起こりますか?   
この脆弱性は、Windows カーネル モード ドライバーが GDI のカーネル コンポーネントを介してユーザー モードから渡される入力を正しく検証しないときに起こります。
  
この脆弱性は、どのコンポーネントに影響を及ぼしますか?   
Win32k.sys がこの脆弱性による影響を受ける Windows コンポーネントです。
  
GDI とは何ですか?   
Microsoft Windows Graphics Device Interface (GDI) により、アプリケーションはグラフィックスおよび書式付きテキストをビデオのディスプレイとプリンターの両方で使用することができます。Windows ベースのアプリケーションはグラフィックス ハードウェアに直接アクセスしません。GDI がアプリケーションの代わりにデバイス ドライバーと対話します。GDI に関する詳細については、MSDN コラム、[Windows GDI](https://msdn.microsoft.com/ja-jp/library/dd145203(vs.85).aspx) (英語情報) を参照してください。
...
ローカル攻撃のシナリオでは、攻撃者は特別に細工したアプリケーションを実行して、影響を受けるシステムを完全に制御することで、この悪用性を実行することも可能です。ただし、このシナリオでこの脆弱性が悪用されるには、有効なログオン資格情報を持ち、ローカルでログオンできることが攻撃者にとっての必定条件となります。
  
主にどのコンピューターがこの脆弱性による危険にさらされますか?   
ワークステーションおよびサーバーが、この脆弱性による危険にさらされます。
  
この更新プログラムはどのように問題を修正しますか?   
このセキュリティ更新プログラムは、Windows カーネル モード ドライバーがユーザー モードによる GDI の呼び出しを処理する方法を修正することで、この脆弱性を解決します。
  
このセキュリティ情報の公開時に、この脆弱性は一般に知られていましたか?   
はい。この脆弱性は一般で公開されていました。これは Common Vulnerability and Exposure の番号 [CVE-2011-5046](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-5046) が割り当てられています。
...
Windows カーネルモード ドライバーが特定のキーボード レイアウトを管理する方法が原因で、特権の昇格の脆弱性が存在します。攻撃者によりこの脆弱性が悪用された場合、カーネルモード内の任意のコードが実行される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0154](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0154) を参照してください。
  
#### 「キーボード レイアウトの解放後使用の脆弱性」の問題を緩和する要素 - CVE-2012-0154
  
緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。
  
#### 「キーボード レイアウトの解放後使用の脆弱性」の回避策 - CVE-2012-0154
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「キーボード レイアウトの解放後使用の脆弱性」のよく寄せられる質問 - CVE-2012-0154
...
何が原因で起こりますか?   
この脆弱性は、Windows カーネル モード ドライバーがキーボード レイアウト エラーを正しく処理しないことが原因で起こります。
...
この更新プログラムはどのように問題を修正しますか?   
この更新プログラムは、Windows カーネルモード ドライバーがキーボード レイアウト エラーを処理する方法を修正することによりこの脆弱性を解決します。
...
WindowsXP-KB2660465-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2660465-x64-jpn.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
WindowsXP-KB2660465-x86-jpn.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2660465-x64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2660465$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2660465/ja">サポート技術情報 2660465</a> を参照してください。</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2660465-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2660465-ia64-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003:<br />
WindowsServer2003-KB2660465-x86-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003:<br />
WindowsServer2003-KB2660465-ia64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ログ ファイル</td>
<td style="border:1px solid black;">KB2660465.log</td>
...
この問題を連絡し、顧客の保護に協力してくださった下記の方に対し、マイクロソフトは深い[謝意](https://technet.microsoft.com/ja-jp/security/bulletin/policy%20)を表します。
  
-   キーボード レイアウトの解放後使用の脆弱性 (CVE-2012-0154) の問題を報告してくださった [Azimuth Security](https://www.azimuthsecurity.com/) の Tarjei Mandt 氏
