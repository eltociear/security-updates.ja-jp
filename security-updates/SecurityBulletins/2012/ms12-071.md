...
<td style="border:1px solid black;">
[MS12-063](https://go.microsoft.com/fwlink/?linkid=255505) の KB2744842 は、KB2761451 に置き換えられる
</td>
</tr>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1538](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1538) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1539](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1539) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-4775](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4775) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2761451/ja">マイクロソフト サポート技術情報 2761451</a> を参照してください。</td>
</tr>
<tr class="odd">
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) に協力して、CFormElement における解放後使用の脆弱性 (CVE-2012-1538) を報告してくださった spa-s3c.blogspot.com の Jose A. Vazquez 氏  
-   CFormElement における解放後使用の脆弱性 (CVE-2012-1538) を報告してくださった [Omair](https://krash.in/) 氏  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) に協力して、CTreePos における解放後使用の脆弱性 (CVE-2012-1539) を報告してくださった spa-s3c.blogspot.com の Jose A. Vazquez 氏  
-   CTreeNode の解放後使用の脆弱性 (CVE-2012-4775) を報告してくださった [Trend Micro](https://www.trendmicro.com/) の Cheng-da Tsai (Orange) 氏、Sung-ting Tsai 氏、および Ming-chieh Pan 氏
