...
<td style="border:1px solid black;">
[MS12-037](https://go.microsoft.com/fwlink/?linkid=249045) の KB2699988 は KB2719177 に置き換えられます。
</td>
</tr>
...
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの詳細については、[サポート技術情報 2719177](https://support.microsoft.com/kb/2719177/ja) を参照してください。
...
はい。KB2719177 更新プログラムは、Windows 8 Consumer Preview および Windows Server 2012 Consumer Preview で使用できます。Windows 8 Consumer Preview および Windows Server 2012 Consumer Preview をご使用のお客様は、システムにこの更新プログラムを適用することをお勧めします。この更新プログラムは [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) でのみ利用可能です。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1522](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1522) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1524](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1524) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2719177/ja">サポート技術情報 2719177</a> を参照してください。</td>
</tr>
<tr class="odd">
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) に協力して、キャッシュされたオブジェクトのリモートでコードが実行される脆弱性 (CVE-2012-1522) を報告してくださった spa-s3c.blogspot.com の Jose A. Vazquez 氏  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) に協力して、属性削除のリモートでコードが実行される脆弱性 (CVE-2012-1524) を報告してくださった Omair 氏
