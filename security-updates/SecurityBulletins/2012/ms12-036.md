---
TOCTitle: 'MS12-036'
Title: 'マイクロソフト セキュリティ情報 MS12-036 - 緊急'
ms:assetid: 'ms12-036'
ms:contentKeyID: 61229413
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms12-036(v=Security.10)'
---

 

マイクロソフト セキュリティ情報 MS12-036 - 緊急
===============================================

リモート デスクトップの脆弱性により、リモートでコードが実行される (2685939)
---------------------------------------------------------------------------

公開日: 2012年6月13日 | 最終更新日: 2013年7月11日
...
<td style="border:1px solid black;">
[MS12-020](https://go.microsoft.com/fwlink/?linkid=232664) の KB2621440 は、KB2685939 に置き換えられる
</td>
</tr>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0173](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0173) を参照してください。
...
-   サポートされるエディションの Windows Vista、Windows 7、Windows Server 2008、Windows Server 2008 R2 が実行されているシステムでネットワーク レベル認証を有効化する
      
    注: 自動化された Microsoft Fix It ソリューションを使用してこの回避策を有効にする方法については、[サポート技術情報 2685939](https://support.microsoft.com/kb/2685939/ja) を参照してください。
...
WindowsXP-KB2685939-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2685939-x64-jpn.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
WindowsXP-KB2685939-x86-jpn.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2685939-x64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2685939$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2685939/ja">マイクロソフト サポート技術情報 2685939</a> を参照してください。</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2685939-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2685939-ia64-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003:<br />
WindowsServer2003-KB2685939-x86-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003:<br />
WindowsServer2003-KB2685939-ia64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ログ ファイル</td>
<td style="border:1px solid black;">KB2685939.log</td>
