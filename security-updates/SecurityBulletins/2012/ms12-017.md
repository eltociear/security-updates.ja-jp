---
TOCTitle: 'MS12-017'
Title: 'マイクロソフト セキュリティ情報 MS12-017 - 重要'
ms:assetid: 'ms12-017'
ms:contentKeyID: 61229394
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms12-017(v=Security.10)'
---
...
公開日: 2012年3月14日 | 最終更新日: 2012年4月23日
...
このセキュリティ更新は、すべてのサポートされているエディションの Microsoft Windows Server 2003、32-bit および x64-based エディションの Windows Server 2008、および x64-based エディションの Windows Server 2008 R2 に対して「重要」と評価されています。詳細については、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションを参照してください。

この更新プログラムでは、DNS サーバーがメモリ内でオブジェクトを処理する方法を変更することにより、この脆弱性を解決します。この脆弱性に関する詳細については、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」を参照してください。
...
既知の問題 [マイクロソフト サポート技術情報 2647170](https://support.microsoft.com/kb/2647170/ja)で、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=b04da098-666f-4760-90da-d2a17e78bf47">Windows Server 2003 Service Pack 2</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=647eaf09-3959-439e-8418-fd25221eb6b9">Windows Server 2003 x64 Edition Service Pack 2</a></td>
<td style="border:1px solid black;">サービス拒否</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a><br />
<a href="https://go.microsoft.com/fwlink/?linkid=238474">MS12-009</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=92f3af60-9a9b-4419-9e95-55f5cb54cf00">Windows Server 2003 with SP2 for Itanium-based Systems</a></td>
<td style="border:1px solid black;">サービス拒否</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a><br />
<a href="https://go.microsoft.com/fwlink/?linkid=238474">MS12-009</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=233c62b7-f2b1-49ce-9a7f-e51435be0d26">Windows Server 2008 for 32-bit Systems Service Pack 2</a>\*</td>
<td style="border:1px solid black;">サービス拒否</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=56eae770-5990-4e1b-8b48-3d0602fcc72b">Windows Server 2008 for x64-based Systems Service Pack 2</a>\*</td>
<td style="border:1px solid black;">サービス拒否</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=19a4f3d1-24d2-41af-a41a-e5cc2c6232e8">Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1</a>\*</td>
<td style="border:1px solid black;">サービス拒否</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
...
この更新プログラムは DNS が「影響を受けるソフトウェア」の表に記載されているオペレーティング システムで有効にされている場合のみインストールできます。既定で DNS はこれらのオペレーティング システムで有効ではないため、DNS が有効にされていないとこの更新プログラムは提供されません。
...
<th style="border:1px solid black;" >DNS のサービス拒否の脆弱性 - CVE-2012-0006</th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
DNS のサービス拒否の脆弱性 - CVE-2012-0006  
------------------------------------------
  
<span></span>
ドメインのリソース レコードをルックアップする際にメモリ内のオブジェクトを DNS サーバーが不適切に処理する方法にサービス拒否の脆弱性が存在します。この脆弱性が攻撃者に悪用された場合、DNS サーバーが標的となるコンピューターで応答を停止し、自動的に再起動する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0006](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0006) を参照してください。
  
#### 「DNS のサービス拒否の脆弱性」の問題を緩和する要素 - CVE-2012-0006
  
マイクロソフトは、この脆弱性の問題を緩和する要素を確認していません。
  
#### 「DNS のサービス拒否の脆弱性」の回避策 - CVE-2012-0006
  
回避策は、根本的な脆弱性を正すものではありませんが、更新プログラムを適用するまでの間、既知の攻撃方法の阻止に役立つ設定または構成の変更を示します。マイクロソフトは次の回避策をテストし、回避策が機能性を低下させるかどうかの情報を提供しています。
  
-   定期的に DNS キャッシュをクリアする
  
    以下の記事に記載されたとおりに、次の dnscmd コマンドを実行します。 [Dnscmd Syntax](https://technet.microsoft.com/en-us/library/cc756116(v=ws.10).aspx): (英語情報)
  
    `dnscmd [ServerName] /clearcache`
  
    このコマンドはスケジュールされたタスクとして、あるいは必要に応じて実行できます。
  
    回避策の影響: 指定した DNS サーバー内のリソース レコードの DNS キャッシュ メモリをクリアします。
  
    回避策の解除方法:
  
    dnscmd コマンドを実行しているすべてのスケジュールされたタスクを削除または無効化します。
  
#### 「DNS のサービス拒否の脆弱性」に関する FAQ - CVE-2012-0006
  
この脆弱性により、どのようなことが起こる可能性がありますか?   
これは、サービス拒否の脆弱性です。
  
何が原因で起こりますか?   
この脆弱性は、リソース レコードをルックアップする際に DNS サーバーがメモリ内のオブジェクトを不適切に処理すると発生します。
...
リモートの認証を受けていない攻撃者が、特別に細工された DNS クエリをターゲット DNS サーバーに送信して、この脆弱性を悪用する可能性があります。
  
主にどのコンピューターがこの脆弱性による危険にさらされますか?   
DNS の役割を実行しているサーバーが主にこの脆弱性による危険にさらされます。この役割を有効にしていないサーバーは、危険にさらされません。
  
この更新プログラムはどのように問題を修正しますか?   
この更新プログラムは、DNS サーバーがメモリ内でオブジェクトを処理する方法を変更することにより、この脆弱性を解決します。
...
WindowsServer2003-KB2647170-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003:<br />
WindowsServer2003.WindowsXP-KB2647170-x64-jpn.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003:<br />
WindowsServer2003-KB2647170-ia64-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003:<br />
WindowsServer2003-KB2647170-x86-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003:<br />
WindowsServer2003.WindowsXP-KB2647170-x64-jpn.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003:<br />
WindowsServer2003-KB2647170-ia64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2647170$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2647170/ja">サポート技術情報 2647170</a> を参照してください。</td>
</tr>
<tr class="even">
...
-   V1.1 (2011/04/23): このセキュリティ情報ページを更新し、「概説」の「既知の問題」のセクションに、サポート技術情報 2647170 へのリンクを追加しました。また、Windows Server 2003 Service Pack 2、Windows Server 2003 x64 Edition Service Pack 2 および Windows Server 2003 with SP2 for Itanium-based Systems についての置き換えられるセキュリティ情報を修正しました。これはセキュリティ情報の変更のみです。このセキュリティ情報のセキュリティ更新プログラムの検出およびファイルへの変更はありません。
