...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=ccc3d8fb-2631-42d0-87ed-5d29d4b1f598">Windows XP Service Pack 3</a> <br />
(KB2723135)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=246927">MS12-036</a> の KB2685939 は、KB2723135 に置き換えられます。</td>
</tr>
</tbody>
</table>
...
マイクロソフトはこのセキュリティ情報を更新し、適切なタイプスタンプ属性なしでマイクロソフトにより生成された特定のデジタル証明書に関する問題に対応するために、Windows XP に適用する KB2723135 更新プログラムを再リリースしました。詳細については、[マイクロソフト セキュリティ アドバイザリ KB 2749655](https://go.microsoft.com/fwlink/?linkid=265301) を参照してください。
  
ファイル情報の詳細はどこにありますか?     
ファイル情報の詳細の場所については、「セキュリティ更新プログラムの展開」の参照表を参照してください。
  
セキュリティ更新プログラムのハッシュはどこにありますか?     
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの詳細については、[サポート技術情報 2723135](https://support.microsoft.com/kb/2723135/ja) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2526](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2526) を参照してください。
...
-   リモート デスクトップ機能が必要でない場合、無効にする
    ...
    手動でおよびグループ ポリシーを使用してリモート アシスタンスを無効にする方法など、リモート アシスタンスに関する詳細については、「[Remote Assistance](https://technet.microsoft.com/ja-jp/library/bb457177.aspx)」(英語情報) を参照してください。
...
リモート デスクトップ プロトコル (RDP) を使用してユーザーはデスクトップ コンピューター上に仮想セッションを作成できます。RDP により、リモート ユーザーは、コンピューター上のすべてのデータとアプリケーションにアクセスできます。詳細については、MSDN の記事「[Remote Desktop Protocol](https://msdn.microsoft.com/ja-jp/library/aa383015.aspx)」(英語情報) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2723135/ja">サポート技術情報 2723135</a> を参照してください。</td>
</tr>
<tr class="even">
