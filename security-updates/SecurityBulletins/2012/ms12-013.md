...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|------------------------------|--------------------------------------------------------|
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=c503c7b1-24f8-40a4-8283-c1e4abf90b57)                                                                                            | 緊急                   | リモートでコードが実行される | なし                                                   |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=ddbd9fcf-10c4-4089-88c0-c2a6c288222b)                                                                                | 緊急                   | リモートでコードが実行される | なし                                                   |
| [Windows Server 2008 for 32-bit Systems Service Pack 2](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=0c1812af-f57d-455d-a81d-5e03db99b2f7)\*                                                                 | 緊急                   | リモートでコードが実行される | なし                                                   |
| [Windows Server 2008 for x64-based Systems Service Pack 2](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=e1b66bb5-ea12-44a5-807a-f21ede0dc76d)\*                                                              | 緊急                   | リモートでコードが実行される | なし                                                   |
| [Windows Server 2008 for Itanium-based Systems Service Pack 2](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=3a96ab34-8f45-48bf-a98b-9e683b50aaa0)                                                            | 緊急                   | リモートでコードが実行される | なし                                                   |
| [Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=403f355c-2273-42ac-8263-d662f5d7740c)                                         | 緊急                   | リモートでコードが実行される | なし                                                   |
| [Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=8bd8e804-ca4d-4326-bc60-345e2975b7aa)                                   | 緊急                   | リモートでコードが実行される | なし                                                   |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=d868c5ef-165a-46a0-b832-e6ca55a910f9)\*       | 緊急                   | リモートでコードが実行される | なし                                                   |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=e5416371-495b-4dc7-a239-f9185f968969) | 緊急                   | リモートでコードが実行される | なし                                                   |
