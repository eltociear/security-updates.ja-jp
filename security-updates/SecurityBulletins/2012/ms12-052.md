...
既知の問題: [マイクロソフト サポート技術情報 2722913](https://support.microsoft.com/kb/2722913/ja) で、このセキュリティ更新プログラムのインストール時に発生する可能性のある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。
...
<td style="border:1px solid black;">
[MS12-037](https://go.microsoft.com/fwlink/?linkid=249045) の KB2699988 は KB2722913 に置き換えられます。
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-044](https://go.microsoft.com/fwlink/?linkid=254377) の KB2719177 は KB2722913 に置き換えられます。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの詳細については、[サポート技術情報 2722913](https://support.microsoft.com/kb/2722913/ja) を参照してください。
...
このセキュリティ情報で説明している「JavaScript の整数オーバーフローにより、リモートでコードが実行される脆弱性」(CVE-2012-2523) は、[MS12-056](https://go.microsoft.com/fwlink/?linkid=256487) でも対応されています。

システムに Internet Explorer 8 をインストールしているお客様は、MS12-056 で説明している [KB2706045](https://go.microsoft.com/fwlink/?linkid=256487) 更新プログラムをインストールして、CVE-2012-2523 で説明している脆弱性から保護してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1526](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1526) を参照してください。
...
-   既定で、Windows Server 2003、Windows Server 2008 および Windows Server 2008 R2 上の Internet Explorer は、「[セキュリティ強化の構成](https://technet.microsoft.com/ja-jp/library/dd883248.aspx)」と呼ばれる制限されたモードで実行されます。このモードは、この脆弱性の影響を緩和します。Internet Explorer のセキュリティ強化の構成に関する詳細情報については、この脆弱性に関する「よく寄せられる質問」を参照してください。

#### 「レイアウトのメモリ破損の脆弱性」の回避策 - CVE-2012-1526
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2521](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2521) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2522](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2522) を参照してください。
...
#### 「仮想関数テーブルの破損により、リモートでコードが実行される脆弱性」の回避策 - CVE-2012-2522
...
#### 「仮想関数テーブルの破損により、リモートでコードが実行される脆弱性」のよく寄せられる質問 - CVE-2012-2522

この脆弱性により、どのようなことが起こる可能性がありますか?   
これは、現在のユーザーのコンテキストでリモートでコードが実行される脆弱性です。

何が原因で起こりますか?   
Internet Explorer が、破損した仮想関数テーブルにアクセスしようとするときに、攻撃者により現在のユーザーのコンテキストで任意のコードが実行される可能性のある方法で、メモリが破損する可能性があります。
...
Internet Explorer がコピー操作中にメモリのオブジェクトのサイズを計算する方法に、リモートでコードが実行される脆弱性が存在します。この脆弱性では、攻撃者が現在のユーザーのコンテキストで任意のコードを実行するような方法で、メモリを破損する可能性があります。

Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-CVE-2012-2523](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2523) を参照してください。

#### 「JavaScript 整数オーバーフローのリモートでコードが実行される脆弱性」の問題を緩和する要素 - CVE-2012-2523
...
-   既定で、すべてのサポートされているバージョンの Microsoft Outlook、Microsoft Outlook Express および Windows メールは、HTML 形式の電子メール メッセージを制限付きサイト ゾーンで開きます。制限付きサイト ゾーンはスクリプトおよび ActiveX コントロールを無効にし、この脆弱性を悪用して悪意のあるコードを実行しようとする攻撃のリスクを排除するのに役立ちます。しかし、ユーザーが電子メール メッセージのリンクをクリックすると、Web ベースの攻撃のシナリオで悪用された脆弱性の影響を受ける可能性があります。
-   既定で、Windows Server 2003、Windows Server 2008 および Windows Server 2008 R2 上の Internet Explorer は、「[セキュリティ強化の構成](https://technet.microsoft.com/ja-jp/library/dd883248.aspx)」と呼ばれる制限されたモードで実行されます。このモードは、この脆弱性の影響を緩和します。Internet Explorer のセキュリティ強化の構成に関する詳細情報については、この脆弱性に関する「よく寄せられる質問」を参照してください。
-   Internet Explorer の 64 ビット版を使用できるように追加構成された 64 ビット版の Microsoft Windows のみが、この脆弱性の影響を受けます。

#### 「JavaScript 整数オーバーフローのリモートでコードが実行される脆弱性」の回避策 - CVE-2012-2523
...
-   32-bit バージョンの Internet Explorer の使用

    Internet Explorer の 32 ビット版へのショートカットを作成するには、次のステップを実行します。

    1.  Windows エクスプローラーで、"C:\\Program Files (x86)\\Internet Explorer\\" に進みます。
    2.  「iexplore.exe」を右クリックし、\[ショートカットの作成\]をクリックします。
    3.  デスクトップ上にショートカットを作成します。クイック起動ツール バーにショートカットをコピーすることもできます。

    作成したショートカットを使用して、Internet Explorer の 32 ビット版を起動します。

    また、次のステップを実行することにより、Internet Explorer の 32 ビット版を既定のブラウザーとして設定することもできます。

    1.  デスクトップに作成したショートカットをクリックして、Internet Explorer の 32 ビット版を開きます。
    2.  Internet Explorer を既定のブラウザーとして設定するかどうかを確認するメッセージが表示されたら、\[はい\]をクリックします。必要なステップは以上です。
        メッセージが表示されない場合は、次のステップに進みます。
    3.  \[ツール\]ボタンをクリックし、\[インターネット オプション\]をクリックします。
    4.  \[プログラム\]タブをクリックし、\[既定に設定\]をクリックします。
    5.  \[OK\]をクリックし、Internet Explorer を終了します。

    以上で、Internet Explorer の 32 ビット版が既定の Web ブラウザーに設定されました。

#### 「JavaScript 整数オーバーフローのリモートでコードが実行される脆弱性」のよく寄せられる質問 - CVE-2012-2523

この脆弱性により、どのようなことが起こる可能性がありますか?   
これは、現在のユーザーのコンテキストでリモートでコードが実行される脆弱性です。

何が原因で起こりますか?   
この脆弱性は、Internet Explorer がコピー操作中にメモリのオブジェクトのサイズを不適切に計算するときに発生します。
...
主にどのコンピューターがこの脆弱性による危険にさらされますか?   
ワークステーションまたはターミナル サーバーなど、Internet Explorer 8 または Internet Explorer 9 を頻繁に使用するコンピューターが、最もこの脆弱性の危険にさらされる可能性があります。

Windows Server 2003、Windows Server 2008 または Windows Server 2008 R2 用の Internet Explorer を実行している場合、この脆弱性の影響は緩和されますか?   
はい。既定で、Windows Server 2003、Windows Server 2008 および Windows Server 2008 R2 上の Internet Explorer は、「[セキュリティ強化の構成](https://technet.microsoft.com/ja-jp/library/dd883248.aspx)」と呼ばれる制限されたモードで実行されます。セキュリティ強化の構成は、Internet Explorer で事前に設定され、ユーザーまたは管理者が特別に細工された Web コンテンツをサーバーにダウンロードし、実行する危険性を低減します。これは、Internet Explorer の信頼済みサイト ゾーンに追加していない Web サイトに対する「緩和する要素」に該当します。

この更新プログラムはどのように問題を修正しますか?   
この更新プログラムは、Internet Explorer がメモリのオブジェクトを処理する方法を変更することにより、Internet Explorer 9 の脆弱性を排除します。

注: この更新プログラムでは、Internet Explorer 8 の脆弱性は解決しません。Internet Explorer 8 の場合、更新プログラムは [MS12-056](https://go.microsoft.com/fwlink/?linkid=256487) で説明されている KB2706045 更新プログラムを通じて利用可能です。

Internet Explorer 8 をコンピューターにインストールしています。CVE-2012-2523 を解決する更新プログラムはどこで入手できますか?   
システムに Internet Explorer 8 をインストールしているお客様は、[MS12-056](https://go.microsoft.com/fwlink/?linkid=256487) で説明している KB2706045 更新プログラムをインストールすることで、CVE-2012-2523 で説明している脆弱性を解決できます。

システムに Internet Explorer 9 をインストールしているお客様は、この更新プログラム (KB2722913) により、Internet Explorer 9 を実行しているシステムに対する CVE-2012-2523 が解決されるため、KB2706045 更新プログラムをインストールする必要はありません。
...
WindowsXP-KB2722913-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 用の Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB2722913-x64-JPN.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows XP 用の Internet Explorer 7:<br />
IE7-WindowsXP-KB2722913-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 用の Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB2722913-x64-JPN.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows XP 用の Internet Explorer 8:<br />
IE8-WindowsXP-KB2722913-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 用の Internet Explorer 8:<br />
IE8-WindowsServer2003.WindowsXP-KB2722913-x64-JPN.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows XP 用の Internet Explorer 6:<br />
WindowsXP-KB2722913-x86-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 用の Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB2722913-x64-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows XP 用の Internet Explorer 7:<br />
IE7-WindowsXP-KB2722913-x86-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 用の Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB2722913-x64-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows XP 用の Internet Explorer 8:<br />
IE8-WindowsXP-KB2722913-x86-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 用の Internet Explorer 8:<br />
IE8-WindowsServer2003.WindowsXP-KB2722913-x64-JPN.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">すべてのサポートされているエディションの Windows XP 用の Internet Explorer 6:[コントロール パネル] の</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされているエディションの Windows XP 用の Internet Explorer 7:<br />
[コントロール パネル] の[プログラムの追加と削除] または %Windir%\ie7updates\KB2722913-IE7\spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされているエディションの Windows XP 用の Internet Explorer 8:<br />
[コントロール パネル] の[プログラムの追加と削除] または %Windir%\ie8updates\KB2722913-IE8\spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2722913/ja">マイクロソフト サポート技術情報 2722913</a> を参照してください。</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2722913-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2722913-ia64-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003 用の Internet Explorer 7:<br />
IE7-WindowsServer2003-KB2722913-x86-JPN.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003-KB2722913-ia64-JPN.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003 用の Internet Explorer 8:<br />
IE8-WindowsServer2003-KB2722913-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003 用の Internet Explorer 6:<br />
WindowsServer2003-KB2722913-x86-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003 用の Internet Explorer 6:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003 用の Internet Explorer 6:<br />
WindowsServer2003-KB2722913-ia64-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003 用の Internet Explorer 7:<br />
IE7-WindowsServer2003-KB2722913-x86-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003 用の Internet Explorer 7:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003 用の Internet Explorer 7:<br />
IE7-WindowsServer2003-KB2722913-ia64-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003 用の Internet Explorer 8:<br />
IE8-WindowsServer2003-KB2722913-x86-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003 用の Internet Explorer 8:<br />
...
<td style="border:1px solid black;">削除に関する情報</td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版、x64-based エディションおよび Itanium-based エディションの Windows Server 2003 用の Internet Explorer 6:<br />
[コントロール パネル] の[プログラムの追加と削除] または %Windir%\$NTUninstallKB2722913$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版、x64-based エディションおよび Itanium-based エディションの Windows Server 2003 用の Internet Explorer 7:<br />
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) に協力して、レイアウトのメモリ破損の脆弱性 (CVE-2012-1526) を報告してくださった GWSlabs  
-   [Beyond Security の SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html) プログラムに協力して、非同期の NULL オブジェクト アクセスにより、リモートでコードが実行される脆弱性 (CVE-2012-2521) を報告してくださった Derek Soeder 氏  
-   仮想関数テーブルの破損により、リモートでコードが実行される脆弱性 (CVE-2012-2522) を報告してくださった [Trend Micro](https://www.trendmicro.com/) の Sung-ting Tsai 氏および Ming-Chieh Pan 氏  
-   JavaScript 整数オーバーフローのリモートでコードが実行される脆弱性 (CVE-2012-2523) を報告してくださった [Google's Chrome Security Team](https://chrome.google.com/) の Cris Neckar 氏
...
-   V1.1 (2012/08/21):このセキュリティ情報ページを更新し、よく寄せられる質問で Windows 8 Release Preview および Windows Server 2012 Release Candidate リリースについての誤った記載を削除しました。Windows 8 Release Preview および Windows Server 2012 Release Candidate リリースはこのセキュリティ情報で説明している脆弱性の影響を受けません。  
-   V1.2 (2013/07/19):このセキュリティ情報ページを更新し、「概要」の「既知の問題」に、サポート技術情報 2722913 へのリンクを追加しました。
