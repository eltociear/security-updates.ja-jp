---
TOCTitle: 'MS12-056'
Title: 'マイクロソフト セキュリティ情報 MS12-056 - 重要'
ms:assetid: 'ms12-056'
ms:contentKeyID: 61229433
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms12-056(v=Security.10)'
---

 

マイクロソフト セキュリティ情報 MS12-056 - 重要
===============================================
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=e1b9a081-0329-4db6-b026-04a332cb0b4d">JScript 5.8 および VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> の KB2510531 は KB2706045 に置き換えられます。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=81f5d8a5-12e5-4227-ae6f-5aea6ffff2a5">JScript 5.8 および VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=294a7eb4-c47f-449f-8931-262bec7d6ecc">JScript 5.8 および VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> の KB2510531 は KB2706045 に置き換えられます。</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=47b2e47f-30f1-48e8-a857-70df319011ef">JScript 5.8 および VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">注意</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> の KB2510531 は KB2706045 に置き換えられます。</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=ece661be-4ddf-42cc-a62b-15ce53b9d74b">JScript 5.8 および VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> の KB2510531 は KB2706045 に置き換えられます。</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=bbb876e6-a6b9-4193-be5e-d84390d30f1e">JScript 5.8 および VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">注意</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> の KB2510531 は KB2706045 に置き換えられます。</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=97004a96-0c83-421d-91a9-d55be32610c9">JScript 5.8 および VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">注意</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> の KB2510531 は KB2706045 に置き換えられます。</td>
...
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの詳細については、[サポート技術情報 2706045](https://support.microsoft.com/kb/2706045/ja) を参照してください。
...
このセキュリティ更新プログラムは ***MS12-***052 とどのような関連がありますか?   
このセキュリティ情報で説明している JavaScript 整数オーバーフローのリモートでコードが実行される脆弱性 (CVE-2012-2523) は、[MS12-052](https://go.microsoft.com/fwlink/?linkid=255327) でも解決されます。

コンピューターに Internet Explorer 8 をインストールしているユーザーの場合、CVE-2012-2523 で説明されている脆弱性から保護するには、このセキュリティ情報で説明している KB2706045 更新プログラムをインストールしてください。

コンピューターに Internet Explorer 9 をインストールしているユーザーの場合、CVE-2012-2523 で説明されている脆弱性から保護するには、[MS12-052](https://go.microsoft.com/fwlink/?linkid=255327) で説明されている KB2722913 更新プログラムをインストールしてください。

コンピューターにインストールされている JScript および VBScript スクリプト エンジンのバージョンをどのように確認できますか?   
Internet Explorer 8、Internet Explorer 9、および Internet Explorer 10 は、JScript 5.8 および VBScript 5.8 スクリプト エンジンを使用しています。KB2706045 更新プログラム パッケージは、Internet Explorer 8 バージョンの JScript および VBScript を更新します。MS12-052 で説明されている KB2722913 更新プログラム パッケージは、Internet Explorer 9 バージョンを更新します。Internet Explorer 10 バージョンは既に最新の状態であるため、この更新プログラムは不要です。
...
3.  ディレクトリに移動します。
4.  jscript.dllを右クリックし、\[プロパティ\]を選択し、次に \[詳細\]タブをクリックします。(同じディレクトリに存在する vbscript.dll についてこのステップを繰り返します)
...
<th style="border:1px solid black;" >JavaScript 整数オーバーフローのリモートでコードが実行される脆弱性 - CVE-2012-2523</th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 上の JScript 5.8 および VBScript 5.8</td>
<td style="border:1px solid black;">重要 <br />
リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 上の JScript 5.8 および VBScript 5.8</td>
<td style="border:1px solid black;">注意 <br />
リモートでコードが実行される</td>
<td style="border:1px solid black;">注意</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Vista x64 Edition Service Pack 2 上の JScript 5.8 および VBScript 5.8</td>
<td style="border:1px solid black;">重要 <br />
リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 for x64-based Systems Service Pack 2 上の JScript 5.8 および VBScript 5.8</td>
<td style="border:1px solid black;">注意 <br />
リモートでコードが実行される</td>
<td style="border:1px solid black;">注意</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows 7 for x64-based Systems 上の JScript 5.8 および VBScript 5.8</td>
<td style="border:1px solid black;">重要 <br />
リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows 7 for x64-based Systems Service Pack 1 上の JScript 5.8 および VBScript 5.8</td>
<td style="border:1px solid black;">重要 <br />
リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008 R2 for x64-based Systems 上の JScript 5.8 および VBScript 5.8</td>
<td style="border:1px solid black;">注意 <br />
リモートでコードが実行される</td>
<td style="border:1px solid black;">注意</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2 for x64-based Systems Service Pack 1 上の JScript 5.8 および VBScript 5.8</td>
<td style="border:1px solid black;">注意 <br />
リモートでコードが実行される</td>
<td style="border:1px solid black;">注意</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008 R2 for Itanium-based Systems 上の JScript 5.8 および VBScript 5.8</td>
<td style="border:1px solid black;">注意 <br />
リモートでコードが実行される</td>
<td style="border:1px solid black;">注意</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2 for Itanium-based Systems Service Pack 1 上の JScript 5.8 および VBScript 5.8</td>
<td style="border:1px solid black;">注意 <br />
リモートでコードが実行される</td>
<td style="border:1px solid black;">注意</td>
</tr>
...
JScript および VBScript エンジンがコピー操作中にメモリ内のオブジェクトを計算する方法に、リモートでコードが実行される脆弱性が存在します。この脆弱性では、攻撃者が現在のユーザーのコンテキストで任意のコードを実行するような方法で、メモリを破損する可能性があります。現在のユーザーが管理者ユーザー権限でログオンしている時に、攻撃者によりこの脆弱性が悪用された場合、影響を受けるコンピューターが完全に制御される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除などを行ったり、完全なユーザー権限を持つ新たなアカウントを作成したりする可能性があります。
...
-   Internet Explorer の 32 ビット版を使用する
...
ワークステーションまたはターミナル サーバーなど、Internet Explorer 8 および Internet Explorer 9 を頻繁に使用するコンピューターが、最もこの脆弱性による危険にさらされます。
...
この更新プログラムは、JScript および VBScript がメモリ内でオブジェクトを処理する方法を変更することにより、この脆弱性を解決します。
...
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 上の JScript 5.8 および VBScript 5.8<br />
IE8-WindowsServer2003.WindowsXP-KB2706045-x64-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 上の JScript 5.8 および VBScript 5.8<br />
IE8-WindowsServer2003.WindowsXP-KB2706045-x64-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ログ ファイル</td>
<td style="border:1px solid black;">JScript 5.8 および VBScript 5.8:KB2706045-IE8.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows XP 上の JScript 5.8 および VBScript 5.8<br />
[コントロール パネル] の [プログラムの追加と削除]または %Windir%\ie8updates\KB2706045-IE8\spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2706045/ja">マイクロソフト サポート技術情報 2706045</a> を参照してください。</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">ユーザーの操作なしでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている x64-based Windows Server 2003 上の JScript 5.8 および VBScript 5.8<br />
IE8-WindowsServer2003.WindowsXP-KB2706045-x64-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
...
<tr class="even">
<td style="border:1px solid black;">削除に関する情報</td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003 上の JScript 5.8 および VBScript 5.8<br />
[コントロール パネル] の [プログラムの追加と削除]または %Windir%\ie8updates\KB2706045-IE8\spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報</td>
...
<tr class="odd">
<td style="border:1px solid black;">ユーザーの操作なしでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Vista 上の JScript 5.8 および VBScript 5.8<br />
...
<tr class="odd">
<td style="border:1px solid black;">ユーザーの操作なしでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2008 上の JScript 5.8 および VBScript 5.8<br />
IE8-Windows6.0-KB2706045-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
...
<tr class="odd">
<td style="border:1px solid black;">ユーザーの操作なしでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows 7 上の JScript 5.8 および VBScript 5.8<br />
...
<tr class="odd">
<td style="border:1px solid black;">ユーザーの操作なしでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2008 R2 上の JScript 5.8 および VBScript 5.8<br />
Windows6.1-KB2706045-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2008 R2 上の JScript 5.8 および VBScript 5.8<br />
