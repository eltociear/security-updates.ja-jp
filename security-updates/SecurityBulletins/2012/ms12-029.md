...
MS12-029 更新プログラムを適用すると、Microsoft Word に対して Office ファイル検証機能が有効になる場合があります。これは、以前に [Microsoft Office ファイル検証アドイン](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=6a4e39a4-4c3f-4cc7-98ec-1cb2d5cb5881) (KB2501584) をインストールしたものの、Office ファイル検証に関する Microsoft Word へのアーキテクチャ更新を適用していなかった場合に発生します。このような場合、MS12-029 が Microsoft Word 用のアーキテクチャ更新を含んでおり、また、Office ファイル検証アドインが既にインストールされているので、Microsoft Word に対して Office ファイル検証が有効になります。
