...
<td style="border:1px solid black;">
[MS10-079](https://go.microsoft.com/fwlink/?linkid=201696) の KB2344911 は KB2598332 に置き換えられます
</td>
</tr>
...
<td style="border:1px solid black;">
[MS10-079](https://go.microsoft.com/fwlink/?linkid=201696) の KB2344993 は KB2596917 に置き換えられます
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS10-079](https://go.microsoft.com/fwlink/?linkid=201696) の KB2345043 は KB2596880 に置き換えられます
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
MS12-029 更新プログラムを適用すると、Microsoft Word に対して Office ファイル検証機能が有効になる場合があります。これは、以前に [Microsoft Office ファイル検証アドイン](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=6a4e39a4-4c3f-4cc7-98ec-1cb2d5cb5881) (KB2501584) をインストールしたものの、Office ファイル検証に関する Microsoft Word へのアーキテクチャ更新を適用していなかった場合に発生します。このような場合、MS12-029 が Microsoft Word 用のアーキテクチャ更新を含んでおり、また、Office ファイル検証アドインが既にインストールされているので、Microsoft Word に対して Office ファイル検証が有効になります。

Office ファイル検証は、Office ファイル検証機能でファイルを検証しないようにする特定のレジストリ キーを設定して無効にすることができます。Office ファイル検証を無効にする方法については、[Office File Validation for Office 2003 and Office 2007](https://technet.microsoft.com/en-us/library/53782285-736e-4d00-b458-6170054287af.aspx) (英語情報) をご覧ください。Microsoft Word 2007 をご使用のお客様は、Office ファイル検証機能を無効にする代わりに、[信頼できる場所を構成する機能](https://technet.microsoft.com/en-us/library/cc178948(office.12).aspx)を使用して、Office ファイル検証チェックから除外するディレクトリを特定できます。
...
このセキュリティ情報で提供している Microsoft Office 2008 for Mac (KB2665346) および Microsoft Office for Mac 2011 (KB2665351) 用のセキュリティ更新プログラム パッケージは、[MS12-030](https://go.microsoft.com/fwlink/?linkid=238499) のセキュリティ情報で説明している脆弱性も解決します。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0183](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0183) を参照してください。
...
-   Microsoft Office 向けファイル ブロックのポリシーを使用して、未知または信頼されないソースおよび場所から RTF の文書を開くことをブロックする
    ...
    回避策の影響:ファイル ブロックのポリシーを構成して、[サポート技術情報 922848](https://support.microsoft.com/kb/922848/ja) で説明されている特別な「除外されるディレクトリ」を構成していない、またはファイルを信頼できる場所に移していないユーザーは、Office 2003 または 2007 Microsoft Office System で .rtf ファイルを開くことができなくなります。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2598332/ja">マイクロソフト サポート技術情報 2598332</a> を参照してください。</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;">Word 2007 については、<a href="https://support.microsoft.com/kb/2596917/ja">サポート技術情報 2596917</a> を参照してください。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Office 互換機能パックについては、<a href="https://support.microsoft.com/kb/2596880/ja">サポート技術情報 2596880</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">レジストリ キーの確認</td>
<td style="border:1px solid black;">対象外</td>
...
-   RTF の不一致の脆弱性 (CVE-2012-0183) を [TippingPoint](https://www.tippingpoint.com/) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して報告してくださった匿名のリサーチャー
