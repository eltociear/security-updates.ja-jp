---
TOCTitle: 'MS12-041'
Title: 'マイクロソフト セキュリティ情報 MS12-041 - 重要'
ms:assetid: 'ms12-041'
ms:contentKeyID: 61229418
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms12-041(v=Security.10)'
---

 

マイクロソフト セキュリティ情報 MS12-041 - 重要
===============================================
...
このセキュリティ更新プログラムは、非公開で報告された 5 件の Microsoft Windows に存在する脆弱性を解決します。これらの脆弱性により、攻撃者がコンピューターにログオンし、特別な細工がされたアプリケーションを実行した場合、特権が昇格される可能性があります。これらの脆弱性のいずれかが悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。
...
このセキュリティ更新プログラムは、Windows カーネル モード ドライバーがユーザー モードから渡された入力を検証し、TrueType フォントの読み込みを処理する方法を修正することにより、また、スレッド作成のメカニズムに追加のランタイム検証を導入することにより、この脆弱性を解決します。これらの脆弱性の詳細については、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」を参照してください。
...
<td style="border:1px solid black;">
[MS12-018](https://go.microsoft.com/fwlink/?linkid=235364) の KB2641653 は、KB2709162 に置き換えられる
</td>
</tr>
...
<th style="border:1px solid black;" >
文字列アトム クラス名の処理の脆弱性 - CVE-2012-1864
</th>
<th style="border:1px solid black;" >
文字列アトム クラス名の処理の脆弱性 - CVE-2012-1865
</th>
<th style="border:1px solid black;" >
クリップボード形式アトム名の処理の脆弱性 - CVE-2012-1866
</th>
</tr>
<tr>
<td style="border:1px solid black;">
...
<th style="border:1px solid black;" >
フォント リソース参照カウントの整数オーバーフローの脆弱性 - CVE-2012-1867
</th>
<th style="border:1px solid black;" >
Win32k.sys 競合状態の脆弱性 - CVE-2012-1868
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
Windows カーネルモード ドライバーがカーネルモード ドライバー オブジェクトを管理する方法が原因で、特権の昇格が起こる脆弱性が存在します。攻撃者によりこの脆弱性が悪用された場合、カーネルモード内の任意のコードが実行される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります

Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1864](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1864) を参照してください。

#### 「文字列アトム クラス名の処理の脆弱性」の問題を緩和する要素 - CVE-2012-1864

緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。

-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。

#### 「文字列アトム クラス名の処理の脆弱性」の回避策 - CVE-2012-1864

マイクロソフトは、この脆弱性の回避策を確認していません。

#### 「文字列アトム クラス名の処理の脆弱性」のよく寄せられる質問 - CVE-2012-1864
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1865](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1865) を参照してください。

#### 「文字列アトム クラス名の処理の脆弱性」の問題を緩和する要素 - CVE-2012-1865

緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。

-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。

#### 「文字列アトム クラス名の処理の脆弱性」の回避策 - CVE-2012-1865

マイクロソフトは、この脆弱性の回避策を確認していません。

#### 「文字列アトム クラス名の処理の脆弱性」のよく寄せられる質問 - CVE-2012-1865
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1866](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1866) を参照してください。

#### 「クリップボード形式アトム名の処理の脆弱性」の問題を緩和する要素 - CVE-2012-1866

緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。

-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。

#### 「クリップボード形式アトム名の処理の脆弱性」の回避策 - CVE-2012-1866

マイクロソフトは、この脆弱性の回避策を確認していません。

#### 「クリップボード形式アトム名の処理の脆弱性」のよく寄せられる質問 - CVE-2012-1866
...
Windows カーネル モード ドライバーがフォントを処理するときにメモリを適切に割り当てないため、この脆弱性が存在します。攻撃者によりこの脆弱性が悪用された場合、カーネルモード内の任意のコードが実行される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります

Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1867](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1867) を参照してください。

#### 「フォント リソース参照カウントの整数オーバーフローの脆弱性」の問題を緩和する要素 - CVE-2012-1867

緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。

-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。

#### 「フォント リソース参照カウントの整数オーバーフローの脆弱性」の回避策 - CVE-2012-1867

マイクロソフトは、この脆弱性の回避策を確認していません。

#### 「フォント リソース参照カウントの整数オーバーフローの脆弱性」のよく寄せられる質問 - CVE-2012-1867

この脆弱性により、どのようなことが起こる可能性がありますか?   
これは、特権の昇格の脆弱性です。

何が原因で起こりますか?   
この脆弱性は、Windows カーネルモード ドライバー が、TrueType フォントの読み込みを適切に処理できない場合に起こります。
...
この更新プログラムはどのように問題を修正しますか?   
この更新プログラムは、Windows カーネル モード ドライバーが TrueType フォントの読み込みを処理する方法を修正することにより、この脆弱性を解決します。
...
Windows カーネルが特定のスレッド作成を処理する方法が原因で、Windows カーネルに特権の昇格の脆弱性が存在します。攻撃者によりこの脆弱性が悪用された場合、カーネルモード内の任意のコードが実行される可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります

Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1868](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1868) を参照してください。

#### 「Win32k.sys 競合状態の脆弱性」の問題を緩和する要素 - CVE-2012-1868

緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。

-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。

#### 「Win32k.sys 競合状態の脆弱性」の回避策 - CVE-2012-1868

マイクロソフトは、この脆弱性の回避策を確認していません。

#### 「Win32k.sys 競合状態の脆弱性」のよく寄せられる質問 - CVE-2012-1868

この脆弱性により、どのようなことが起こる可能性がありますか?   
これは、特権の昇格の脆弱性です。

何が原因で起こりますか?   
この脆弱性は、特定の種類のスレッドが作成される際に、競合状態を引き起こすことが原因で起こります。
...
この更新プログラムはどのように問題を修正しますか?   
この更新プログラムは、スレッド作成のメカニズムに追加のランタイム検証を導入することにより、この脆弱性を解決します。
...
WindowsXP-KB2709162-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2709162-x64-jpn.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
WindowsXP-KB2709162-x86-jpn.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2709162-x64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2709162$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2709162/ja">マイクロソフト サポート技術情報 2709162</a> を参照してください。</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2709162-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2709162-ia64-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003:<br />
WindowsServer2003-KB2709162-x86-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003:<br />
WindowsServer2003-KB2709162-ia64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ログ ファイル</td>
<td style="border:1px solid black;">KB2709162.log</td>
...
-   文字列アトム クラス名の処理の脆弱性 (CVE-2012-1864) の問題を報告してくださった [Azimuth Security](https://www.azimuthsecurity.com/) の Tarjei Mandt 氏  
-   Win32k.sys 競合状態の脆弱性 (CVE-2012-1865) の問題を報告してくださった [Azimuth Security](https://www.azimuthsecurity.com/) の Tarjei Mandt 氏  
-   クリップボード形式アトム名の処理の脆弱性 (CVE-2012-1866) の問題を報告してくださった [Azimuth Security](https://www.azimuthsecurity.com/) の Tarjei Mandt 氏  
-   フォント リソース参照カウントの整数オーバーフローの脆弱性 (CVE-2012-1867) の問題を報告してくださった [Google Inc.](https://www.google.com) の [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org) 氏
