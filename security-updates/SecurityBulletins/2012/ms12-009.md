---
TOCTitle: 'MS12-009'
Title: 'マイクロソフト セキュリティ情報 MS12-009 - 重要'
ms:assetid: 'ms12-009'
ms:contentKeyID: 61229386
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms12-009(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS12-009 - 重要
===============================================
...
このセキュリティ更新プログラムは、非公開で報告された 2 件の Microsoft Windows に存在する脆弱性を解決します。これらの脆弱性により、攻撃者がユーザーのシステムにログオンし、特別な細工が施されたアプリケーションを実行した場合、特権が昇格される可能性があります。これらの脆弱性が悪用されるには、有効なログオン資格情報を所持し、ローカルでログオンできることが攻撃者にとっての必要条件となります。

このセキュリティ更新プログラムは、Windows XP (x86 ベースを除く)、Windows Server 2003、Windows Vista (x86 ベースを除く)、Windows Server 2008 (x86 ベースを除く)、Windows 7 (x86 ベースを除く)、および Windows Server 2008 R2 のすべてのサポートされているエディションについて、深刻度「重要」と評価されています。詳細については、このセクションのサブセクション「影響を受けるソフトウェアおよび影響を受けないソフトウェア」を参照してください。

このセキュリティ更新プログラムは、入力をユーザー モードから Windows カーネルに渡す前に、AFD が入力を検証する方法を修正することにより、この脆弱性を解決します。これらの脆弱性の詳細については、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」を参照してください。

推奨する対応策: 自動更新を有効にしている大多数のお客様には、このセキュリティ更新プログラムが自動的にダウンロードおよびインストールされるため、特別な措置を講じる必要はありません。自動更新を有効にしていない場合、この更新プログラムを手動で確認し、インストールする必要があります。自動更新の具体的な構成オプションの詳細については、[サポート技術情報 294871](https://support.microsoft.com/kb/294871/ja) を参照してください。マイクロソフトは、更新プログラムの管理ソフトウェアまたは [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) サービスで更新プログラムを確認して、この更新プログラムをできる限り早期に適用することを推奨します。
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|-----------------------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=82f5c503-d2ea-4fed-8f9d-f30bee2f60b3)                                                                      | 特権の昇格             | 重要           | [MS11-080](https://go.microsoft.com/fwlink/?linkid=227486) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=5ee4bef7-b355-4aae-8bba-834a16d44744)                                                                                      | 特権の昇格             | 重要           | [MS11-080](https://go.microsoft.com/fwlink/?linkid=227486) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=b53cf810-0ea3-4cb0-91f9-de1406ccfc96)                                                                          | 特権の昇格             | 重要           | [MS11-080](https://go.microsoft.com/fwlink/?linkid=227486) |
| [Windows Server 2003 with SP2 for Itanium-based Systems](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=3b18d22d-e192-498b-a105-b946a5f5bfad)                                                                  | 特権の昇格             | 重要           | [MS11-080](https://go.microsoft.com/fwlink/?linkid=227486) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=73e240a6-2d5e-4ceb-8500-8dacca0e4a43)                                                                                | 特権の昇格             | 重要           | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2008 for x64-based Systems Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=0e06e77d-7e5d-4d57-98b2-0817f68a1ebb)\*                                                              | 特権の昇格             | 重要           | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2008 for Itanium-based Systems Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=56cbeba9-0c39-4418-9042-7244ac9d03db)                                                            | 特権の昇格             | 重要           | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=299d107d-ab9f-42b6-8f94-a2f1d242c127)                                   | 特権の昇格             | 重要           | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=576192d3-f050-4718-a7da-c84fce6bf744)\*       | 特権の昇格             | 重要           | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=d6a9b2c9-7582-4953-8ab1-a55c63fcc8dc) | 特権の昇格             | 重要           | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
...
このセキュリティ情報の影響を受けるのが Windows Server 2003 Service Pack 2 の 32 ビット版のみであるのはなぜですか?    
このセキュリティ更新プログラムは、2 つの脆弱性、CVE-2012-0148 および CVE-2012-0149 を解決します。前者は Windows の 32 ビット版に影響を及ぼしませんが、後者は、32 ビット版を含め Windows Server 2003 のサポートされるバージョンのみに影響を与えます。このため、このセキュリティ情報の影響を受けるソフトウェアに含まれる Windows の 32 ビット版は Windows Server 2003 Service Pack 2 のみです。
...
<th style="border:1px solid black;" >AfdPoll の特権の昇格の脆弱性 - CVE-2012-0148</th>
<th style="border:1px solid black;" >Ancillary Function ドライバーの特権の昇格の脆弱性 - CVE-2012-0149</th>
...
AfdPoll の特権の昇格の脆弱性 - CVE-2012-0148  
--------------------------------------------
  
 
ユーザー モードから Windows カーネルに渡される入力が正しく検証されないため、Ancillary Function ドライバー (afd.sys) に特権の昇格の脆弱性が存在します。この脆弱性では、攻撃者が昇格された特権でコードを実行する可能性があります。攻撃者がローカルでこの脆弱性を悪用した場合、任意のコードを実行し、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0148](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0148) を参照してください。
  
#### 「AfdPoll の特権の昇格の脆弱性」の問題を緩和する要素 - CVE-2012-0148
  
緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。  
-   この脆弱性が Microsoft Windows の 32 ビット版で悪用されることはありません。
  
#### 「AfdPoll の特権の昇格の脆弱性」の回避策 - CVE-2012-0148
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「AfdPoll の特権の昇格の脆弱性」のよく寄せられる質問 - CVE-2012-0148
...
何が原因で起こりますか?   
この脆弱性は、afd.sys ドライバーがユーザー モードからデータを受け取るときに、入力を正しく検証しないことが原因で起こります。
  
Ancillary Function ドライバー (AFD) とは何ですか?   
AFD コンポーネントは Ancillary Function ドライバーを提供し、Windows ソケット アプリケーションをサポートするもので、afd.sys ファイルに含まれています。afd.sys ドライバーはカーネル モードで実行し、Winsock TCP/IP の通信プロトコルを管理します。Winsock の Kernel のインターフェイスは TDI のトランスポートへのアクセスを提供します。
  
Transport Driver Interface (TDI) とは何ですか?   
Transport Driver Interface (TDI) はカーネル モードのネットワーク インターフェイスを定義し、すべてのトランスポート プロトコルのスタックの上端に現れます。各スタックの最上位レベルのプロトコル ドライバーは、上位レベルのカーネル モードのネットワーク クライアント向けの TDI インターフェイスをサポートします。TDI コンポーネントの詳細については、MSDN コラム [Transport Driver Interface](https://msdn.microsoft.com/en-us/library/ff565685.aspx) を参照してください。
...
Ancillary Function ドライバーの特権の昇格の脆弱性 - CVE-2012-0149  
-----------------------------------------------------------------
  
 
ユーザー モードから Windows カーネルに渡される入力が正しく検証されないため、Ancillary Function ドライバー (afd.sys) に特権の昇格の脆弱性が存在します。この脆弱性では、攻撃者が昇格された特権でコードを実行する可能性があります。攻撃者がローカルでこの脆弱性を悪用した場合、任意のコードを実行し、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全な管理者権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0149](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0149) を参照してください。
  
#### 「Ancillary Function ドライバーの特権の昇格の脆弱性」の問題を緩和する要素 - CVE-2012-0149
  
緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。
  
#### 「Ancillary Function ドライバーの特権の昇格の脆弱性」の回避策 - CVE-2012-0149
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Ancillary Function ドライバーの特権の昇格の脆弱性」のよく寄せられる質問 - CVE-2012-0149
...
WindowsServer2003.WindowsXP-KB2645640-x64-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2645640-x64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2645640$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2645640/ja">サポート技術情報 2645640</a> を参照してください。</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2645640-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2645640-ia64-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003:<br />
WindowsServer2003-KB2645640-x86-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003:<br />
WindowsServer2003-KB2645640-ia64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ログ ファイル</td>
<td style="border:1px solid black;">KB2645640.log</td>
...
-   AfdPoll の特権の昇格の脆弱性 (CVE-2012-0148) を報告してくださった [Azimuth Security](https://www.azimuthsecurity.com/) の Tarjei Mandt 氏  
-   Ancillary Function ドライバー の特権の昇格の脆弱性 (CVE-2012-0149) を報告してくださった [Azimuth Security](https://www.azimuthsecurity.com/) の Tarjei Mandt 氏
...
-   セキュリティ関連、およびセキュリティ更新プログラムに関するご質問や、ご不明な点などがありましたら、[マイクロソフト セキュリティ情報センター](https://go.microsoft.com/fwlink/?linkid=21131)までご連絡ください。マイクロソフトでは、お問い合わせの内容が弊社製品の不具合が原因である場合、無償でサポートをご提供いたします。利用可能なサポート オプションの詳細については、[マイクロソフト サポート オンライン](https://support.microsoft.com/?ln=ja%20)を参照してください。  
