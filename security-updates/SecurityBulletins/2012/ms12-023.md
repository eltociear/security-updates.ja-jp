...
<td style="border:1px solid black;">
[MS12-010](https://go.microsoft.com/fwlink/?linkid=236989) の KB2647516 が KB2675157 に置き換えられる
</td>
</tr>
...
はい。Windows Developer Preview リリース向けの KB2675157 の更新プログラムが利用可能です。Windows Developer Preview をご使用のお客様は、システムにこの更新プログラムを適用することをお勧めします。この更新プログラムは [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) でのみ利用可能です。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0168](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0168) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0169](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0169) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0170](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0170) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0171](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0171) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0172](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0172) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2675157/ja">マイクロソフト サポート技術情報 2675157</a> を参照してください。</td>
</tr>
<tr class="even">
...
-   印刷機能のリモートでコードが実行される脆弱性 (CVE-2012-0168) を報告してくださった [AISec](https://www.aisec.cn/) の linx2008 氏  
-   JScript9 のリモートでコードが実行される脆弱性 (CVE-2012-0169) を報告してくださった [TopDesk](https://www.topdesk.com) の Roel Spilker 氏  
-   [VeriSign iDefense Labs](https://labs.idefense.com) と協力して、OnReadyStateChange のリモートでコードが実行される脆弱性 (CVE-2012-0170) を報告してくださった Jose Antonio Vazquez Gonzalez 氏  
-   [TippingPoint](https://www.tippingpoint.com) の [Zero Day Initiative](https://www.zerodayinitiative.com) に協力して、SelectAll のリモートでコードが実行される脆弱性 (CVE-2012-0171) を報告してくださった匿名のリサーチャー  
-   [TippingPoint](https://www.tippingpoint.com) の [Zero Day Initiative](https://www.zerodayinitiative.com) に協力して、VML スタイルのリモートでコードが実行される脆弱性 (CVE-2012-0172) を報告してくださった匿名のリサーチャー  
