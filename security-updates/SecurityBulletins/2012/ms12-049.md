...
<td style="border:1px solid black;">
[MS10-049](https://go.microsoft.com/fwlink/?linkid=197104) の KB980436 は KB2655992 に置き換えられます。
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-006](https://go.microsoft.com/fwlink/?linkid=232510) の KB2585542 は KB2655992 に置き換えられます。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS10-085](https://go.microsoft.com/fwlink/?linkid=201705) の KB2207566 は KB2655992 に置き換えられます。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 for 32-bit Systems Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=97030267-6b19-46ae-84ce-0bb1f91ab951) (Server Core インストール)  
(KB2655992)
</td>
<td style="border:1px solid black;">
情報漏えい
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 for x64-based Systems Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=8a5f6e84-5e5b-42c3-a5b7-65defdb0665f) (Server Core インストール)  
(KB2655992)
</td>
<td style="border:1px solid black;">
情報漏えい
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 for x64-based Systems](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=c9ef728f-abef-4076-bb13-7488af471aa4) (Server Core インストール)  
(KB2655992)
</td>
<td style="border:1px solid black;">
情報漏えい
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 for x64-based Systems Service Pack 1](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=c9ef728f-abef-4076-bb13-7488af471aa4) (Server Core インストール)  
(KB2655992)
</td>
<td style="border:1px solid black;">
情報漏えい
...
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの詳細については、[サポート技術情報 2655992](https://support.microsoft.com/kb/2655992/ja) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1870](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870) を参照してください。
...
はい。この脆弱性は一般で公開されていました。これは Common Vulnerability and Exposure の番号 [CVE-2012-1870](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870) が割り当てられています。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2655992/ja">サポート技術情報 2655992</a> を参照してください。</td>
</tr>
<tr class="even">
