...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1527](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1527) を参照してください。
...
ブリーフケースとは何ですか?   
ブリーフケースは、2 つのフォルダーの内容を同期させる Windows の機能です。ブリーフケースは、USB サム ドライブなどのデバイスとコンピューターの間でフォルダーを同期させる場合に役に立ちます。詳細については、「[ブリーフケースを使用して同期させる](https://windows.microsoft.com/ja-jp/windows7/sync-using-briefcase)」を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1528](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1528) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2727528/ja">マイクロソフト サポート技術情報 2727528</a> を参照してください。</td>
</tr>
<tr class="even">
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/)と協力し、Windows ブリーフケースの整数オーバーフローの脆弱性 (CVE-2012-1527) を報告してくださった Tal Zeltzer 氏  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) と協力し、Windows ブリーフケースの整数アンダーフローの脆弱性 (CVE-2012-1528) を報告してくださった Tal Zeltzer 氏
