...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|--------------------------------------------------------|
| [Windows Server 2008 for 32-bit Systems Service Pack 2](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=3f6f89b3-3bc8-4325-b8d8-9a5a398b99c6&displaylang=ja)\*\*                                                               | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2008 for x64-based Systems Service Pack 2](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=35e6bd04-594f-42ef-97f8-abcf578b4f10&displaylang=ja)\*\*                                                            | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2008 for Itanium-based Systems Service Pack 2](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=d1d51b26-2d01-42a9-9bb1-9fb82c1fb914&displaylang=ja)                                                            | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=8c51e09b-51c3-4860-836e-6bcffde75f04&displaylang=ja)\*\*     | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](https://www.microsoft.com/download/ja-jp/details.aspx?familyid=fba58a1b-9d9f-4a10-b1df-08a0ebfa2358&displaylang=ja) | リモートでコードが実行される | 重要           | なし                                                   |
