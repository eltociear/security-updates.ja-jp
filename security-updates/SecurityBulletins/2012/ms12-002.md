---
TOCTitle: 'MS12-002'
Title: 'マイクロソフト セキュリティ情報 MS12-002 - 重要'
ms:assetid: 'ms12-002'
ms:contentKeyID: 61229379
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms12-002(v=Security.10)'
---
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|--------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=feaeda8c-84ee-47be-8c68-736f0e5b1fc7%20)                           | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=211827f2-fe6a-4e16-a90c-0cc3b60a722d)     | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=b8e46267-7988-4fbe-ae94-68b6fdb2e7d9)                     | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=5975b01e-139b-4b9d-a0d5-a87a279bfea1)         | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2003 with SP2 for Itanium-based Systems](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=26079c35-4b96-42fc-ad47-138be25a6bf0) | リモートでコードが実行される | 重要           | なし                                                   |
...
<th style="border:1px solid black;" >オブジェクト パッケージャーの安全でない実行可能ファイルが実行される脆弱性 - CVE-2012-0009</th>
...
Windows が Windows オブジェクト パッケージャーを登録し、使用する方法に、リモートでコードが実行される脆弱性が存在します。攻撃者がこの脆弱性の悪用に成功した場合、影響を受けるシステムを完全に制御する可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除などを行ったり、完全なユーザー権限を持つ新たなアカウントを作成したりする可能性があります。コンピューターでのユーザー権限が低い設定のアカウントを持つユーザーは、管理者特権で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0009](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0009) を参照してください。
  
#### 「オブジェクト パッケージャーの安全でない実行可能ファイルが実行される脆弱性」の問題を緩和する要素 - CVE-2012-0009
...
#### 「オブジェクト パッケージャーの安全でない実行可能ファイルが実行される脆弱性」の回避策 - CVE-2012-0009
...
-   packager.exe を完全なパスに登録する
    ...
    10. Server  
    11. の順に展開します。  
    12. (既定) のキーをクリックし、次の値に変更します。C:\Windows\System32\Packager.exe 注:
  
#### 「オブジェクト パッケージャーの安全でない実行可能ファイルが実行される脆弱性」のよく寄せられる質問 - CVE-2012-0009
...
何が原因で起こりますか?   
影響を受けるリリースの Microsoft Windows の Windows オブジェクト パッケージャーの不適切な登録と実装が原因で発生します。
  
Windows オブジェクト パッケージャーとは何ですか ?   
Windows オブジェクト パッケージャーは、ファイルに挿入可能なパッケージを作成するために使用できるツールです。オブジェクト パッケージャーの詳細については、[Microsoft Product Documentation](https://www.microsoft.com/resources/documentation/windows/xp/all/proddocs/en-us/packager_what_is_obj_pkg.mspx?mfr=true) (英語情報) を参照してください。
...
ネットワーク攻撃のシナリオでは、攻撃者はパッケージ化されたオブジェクトが組み込まれた正当なファイルと特別に細工された実行可能ファイルをネットワーク共有、UNC、または WebDAV の場所に置き、ユーザーにそのファイルを開かせようとする可能性があります。
  
主にどのコンピューターがこの脆弱性による危険にさらされますか?   
ユーザーが信頼されないネットワークの場所からファイルを開く可能性のあるワークステーションが主に危険にさらされます。管理者がユーザーにサーバーへのログオンおよびプログラムの実行を許可している場合、サーバーもまた危険にさらされる可能性があります。しかし、最善策では、これを許可しないことを強く推奨しています。
  
この更新プログラムはどのように問題を修正しますか?   
この更新プログラムは、Windows オブジェクト パッケージャーに関連付けられたレジストリ キーを修正して、この脆弱性を解決します。
...
WindowsXP-KB2603381-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2603381-x64-JPN.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
WindowsXP-KB2603381-x86-JPN.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2603381-x64-JPN.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2603381$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
...
WindowsServer2003-KB2603381-x86-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2603381-ia64-JPN.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32-bit エディションの Windows Server 2003:<br />
WindowsServer2003-KB2603381-x86-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003:<br />
WindowsServer2003-KB2603381-ia64-JPN.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ログ ファイル</td>
<td style="border:1px solid black;">KB2603381.log</td>
