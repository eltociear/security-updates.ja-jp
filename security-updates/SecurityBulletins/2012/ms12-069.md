...
<td style="border:1px solid black;">
[MS11-013](https://go.microsoft.com/fwlink/?linkid=208523) の KB2425227 は KB2743555 に置き換えられる
</td>
</tr>
...
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの情報については、[サポート技術情報 KB2743555](https://support.microsoft.com/kb/2743555/ja) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2551](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2551) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2743555/ja">サポート技術情報 2743555</a> を参照してください。</td>
</tr>
<tr class="odd">
