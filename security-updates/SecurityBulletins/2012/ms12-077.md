...
<td style="border:1px solid black;">
[MS12-063](https://go.microsoft.com/fwlink/?linkid=255505) の KB2744842 は、KB2761465 に置き換えられる
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-071](https://go.microsoft.com/fwlink/?linkid=268299) の KB2761451 は、KB2761465 に置き換えられる
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-4781](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4781) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-4782](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4782) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-4787](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4787) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2761465/ja">マイクロソフト サポート技術情報 2761465</a> を参照してください。</td>
</tr>
<tr class="even">
...
| ファイルに関する情報:               | [マイクロソフト サポート技術情報 2761465](https://support.microsoft.com/kb/2761465/ja) を参照してください。                                                                                                                                                                                                                     |
...
-   不適切な参照カウントの解放後使用の脆弱性 (CVE-2012-4787) を報告してくださった [Google Inc](https://www.google.com) の Fermin J. Serna 氏
