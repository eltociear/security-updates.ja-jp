...
このセキュリティ更新プログラムは、[マイクロソフト セキュリティ アドバイザリ 2757760](https://technet.microsoft.com/ja-jp/security/advisory/2757760) で最初に説明した脆弱性も解決します。
...
<td style="border:1px solid black;">
[MS12-052](https://go.microsoft.com/fwlink/?linkid=255327) の KB2722913 は KB2744842 に置き換えられます。
</td>
</tr>
...
[マイクロソフト セキュリティ アドバイザリ 2757760](https://technet.microsoft.com/ja-jp/security/advisory/2757760)で Microsoft Fix it ソリューション「Internet Explorer の ExecCommand を介した、メモリ破損を防ぐ」を実装したお客様は、この更新プログラムを適用する前にこの Microsoft Fix it ソリューションを元に戻す必要はありません。

ファイル情報の詳細はどこにありますか?   
ファイル情報の詳細の場所については、「セキュリティ更新プログラムの展開」の参照表を参照してください。

セキュリティ 更新プログラムのハッシュはどこにありますか?   
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの情報については、[サポート技術情報 2744842](https://support.microsoft.com/kb/2744842/ja) を参照してください。

Server Core インストールはこのセキュリティ情報で説明している脆弱性によってどのような影響を受けますか?   
この更新プログラムによって解決される脆弱性は、「影響を受けないソフトウェア」の表に示すように、Server Core インストール オプションを使用してインストールされている Windows Server 2008、Windows Server 2008 R2、または Windows Server 2012 のサポートされるエディションには影響を及ぼしません。このインストール オプションの詳細については、TechNet の記事「[Managing a Server Core Installation: Overview](https://technet.microsoft.com/ja-jp/library/ee441255)」(英語情報)、「[Servicing a Server Core Installation](https://technet.microsoft.com/ja-jp/library/ff698994)」(英語情報)、「[Server Core サーバーとフル サーバーの統合に関するテクニカル プレビュー](https://technet.microsoft.com/ja-jp/library/hh831758)」を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1529](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1529) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2546](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2546) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2548](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2548) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2557](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2557) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-4969](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4969) を参照してください。
...
-   この脆弱性の悪用を阻止する Microsoft Fix it ソリューション、 「Internet Explorer の ExecCommand を介した、メモリ破損を防ぐ」を適用してください。
    ...
    自動化された Microsoft Fix it ソリューションを使用してこの回避策を有効または無効にする方法については、[サポート技術情報 2744842](https://support.microsoft.com/kb/2744842/ja) を参照してください。
...
-   Enhanced Mitigation Experience Toolkit を使用する
    ...
    現時点では、EMET に対するサポートは限定されており、英語のみでご利用可能です。詳細については、[サポート技術情報 2458544](https://support.microsoft.com/kb/2458544/ja) を参照してください。
    ...
    注: グループ ポリシーの詳細については、「[Group Policy collection](https://go.microsoft.com/fwlink/?linkid=215719)」(英語情報) を参照してください。
...
このセキュリティ情報の公開時に、この脆弱性は一般に知られていましたか?   
はい。この脆弱性は一般で公開されていました。この脆弱性には Common Vulnerability and Exposure の [CVE-2012-4969](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4969) が割り当てられています。[マイクロソフト セキュリティ アドバイザリ 2757760](https://technet.microsoft.com/ja-jp/security/advisory/2757760) で、この脆弱性を最初に説明しました。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2744842/ja">サポート技術情報 2744842</a> を参照してください。</td>
</tr>
<tr class="even">
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) に協力して、OnMove の解放後使用の脆弱性 (CVE-2012-1529) を報告してくださった匿名のリサーチャー  
-   イベント リスナーの解放後使用の脆弱性 (CVE-2012-2546) を報告してくださった Rosario Valotta 氏  
-   textBlock の解放後使用の脆弱性 (CVE-2012-2548) を報告してくださった [TippingPoint](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/) の [Zero Day Initiative](https://www.zerodayinitiative.com/) に協力している、[Harmony Security](https://www.harmonysecurity.com/) の Stephen Fewer 氏  
-   [TippingPoint](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/) の [Zero Day Initiative](https://www.zerodayinitiative.com/) に協力して、cloneNode の解放後使用の脆弱性 (CVE-2012-2557) を報告してくださった匿名のリサーチャー  
-   [TippingPoint](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/) の [Zero Day Initiative](https://www.zerodayinitiative.com/) に協力して、execCommand の解放後使用の脆弱性 (CVE-2012-4969) を報告してくださった匿名のリサーチャー  
-   execCommand の解放後使用の脆弱性 (CVE-2012-4969) についてマイクロソフトに協力してくださった [Mitre](https://www.mitre.org/)
