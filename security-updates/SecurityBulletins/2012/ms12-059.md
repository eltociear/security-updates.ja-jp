...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=de95d8b9-51a5-43cd-8ba3-8cbb1320d099">Microsoft Visio 2010 Service Pack 1 (32 ビット版)</a>[1]<br />
(KB2687508)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=225739">MS11-089</a> の KB2553374 は KB2597171 または KB2687508[2] に置き換えられます。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=af690cd8-cb2c-4743-96f0-ffaec77adf10">Microsoft Visio 2010 Service Pack 1 (64 ビット版)</a>[1]<br />
(KB2687508)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=225739">MS11-089</a> の KB2553374 は KB2597171 または KB2687508[2] に置き換えられます。</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=62e87f7b-f48e-43a7-86d7-cbb8f0603ea3">Microsoft Visio Viewer 2010 Service Pack 1 (32 ビット版)</a><br />
(KB2598287)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=248385">MS12-031</a> の KB2597981 は KB2598287 に置き換えられます。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=3889e1b3-69b2-4a8f-a0d9-de8c7dc6f5ec">Microsoft Visio Viewer 2010 Service Pack 1 (64 ビット版)</a><br />
(KB2598287)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=248385">MS12-031</a> の KB2597981 は KB2598287 に置き換えられます。</td>
...
マイクロソフトは、適切なタイムスタンプ属性なしでマイクロソフトによって生成された特定のデジタル証明書に関する問題に対応するために、このセキュリティ情報を再リリースし、影響を受けるすべてのエディションの Microsoft Visio 2010 用の KB2597171 更新プログラムを KB2687508 更新プログラムで置き換えます。詳細については、[マイクロソフト セキュリティ アドバイザリ 2749655](https://technet.microsoft.com/ja-jp/security/advisory/2749655) を参照してください。
...
注: 元の更新プログラムが既にインストールされているときに、再リリースされた更新プログラムを同じシステムにインストールすると、更新プログラムが既にインストールされていることを示すメッセージがインストーラーによって表示されます。メッセージが表示された後に、インストール済み更新プログラムの一覧で元の更新プログラムの KB 番号が再リリースされた更新プログラムの KB 番号に置き換えられます。このインストール動作の詳細については、[マイクロソフト サポート技術情報 2720573](https://support.microsoft.com/kb/2720573/ja) を参照してください。
  
ファイル情報の詳細はどこにありますか?     
ファイル情報の詳細の場所については、「セキュリティ更新プログラムの展開」の参照表を参照してください。
  
セキュリティ 更新プログラムのハッシュはどこにありますか?     
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの詳細については、[サポート技術情報 2733918](https://support.microsoft.com/kb/2733918/ja) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1888](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1888) を参照してください。
...
<td style="border:1px solid black;">Microsoft Visio 2010 については、<a href="https://support.microsoft.com/kb/2687508/ja">サポート技術情報2687508</a> を参照してください。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Visio Viewer 2010 については、<a href="https://support.microsoft.com/kb/2598287/ja">サポート技術情報 2598287</a> を参照してください。</td>
</tr>
<tr class="odd">
...
-   [TippingPoint](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/) の [Zero Day Initiative](https://www.zerodayinitiative.com/)にご協力いただき、Visio DXF ファイル形式のバッファー オーバーフローの脆弱性 (CVE-2012-1888) を報告してくださった Alexander Gavrun 氏
