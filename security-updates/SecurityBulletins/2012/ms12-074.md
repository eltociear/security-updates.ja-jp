...
<td style="border:1px solid black;">
[MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) の KB2572066 は、KB2698035 に置き換えられる  
   
[MS11-100](https://go.microsoft.com/fwlink/?linkid=232432) の KB2656353 は、KB2698023 に置き換えられる
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) の KB2633880 と [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) の KB2572073 は、KB2729450 に置き換えられる  
   
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) の KB2633870 と [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) の KB2572078 は、KB2729449 に置き換えられる
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-034](https://go.microsoft.com/fwlink/?linkid=251038) の KB2656405 は、KB2737019 に置き換えられる
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) の KB2572069 は、KB2698032 に置き換えられる
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) の KB2633874 と [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) の KB2572075 は、KB2729453 に置き換えられる  
   
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) の KB2633870 と [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) の KB2572078 は、KB2729449 に置き換えられる  
   
...
<td style="border:1px solid black;">
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) の KB2633879 および [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075)の KB2572076 は KB2729451 に置き換えられる  
   
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) の KB2633870 と [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) の KB2572078 は、KB2729449 に置き換えられる
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) の KB2633873 と [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) の KB2572077 は、KB2729452 に置き換えられる  
   
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) の KB2633870 と [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) の KB2572078 は、KB2729449 に置き換えられる  
   
KB2729460 に置き換えられる更新プログラムはありません
...
<sup>[2]</sup> Windows 8、Windows Server 2012 およびWindows RT 上で Microsoft .NET Framework 4.5 を実行しているお客様は、この問題の影響は受けません。2012 年 10 月 11 日にリリースされた「Windows 8 Client と Windows Server 2012 の一般公開用の累積的な更新プログラム」(KB2756872) には、追加の多層防御の変更が含まれています。この更新プログラムをまだインストールされていないお客様は、多層防御策としてインストールすることを推奨します。詳細については、[マイクロソフト サポート技術情報 2745030](https://support.microsoft.com/kb/2745030/ja) の「関連情報」を参照してください。ダウンロード先および詳細については、[サポート技術情報 2756872](https://support.microsoft.com/kb/2756872/ja) を参照してください。この更新プログラムには、セキュリティ以外の内容が含まれています。

<sup>[3]</sup> Windows RTセキュリティ更新プログラムは [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) からのみの提供となります。
...
はい。この更新プログラムが解決する .NET Framework の安全でないライブラリのロードの脆弱性 (CVE-2012-2519) は、[マイクロソフト セキュリティ アドバイザリ 2269637](https://technet.microsoft.com/ja-jp/security/advisory/2269637) で説明している、アプリケーションが外部ライブラリをロードする仕組みに影響する脆弱性の一種です。このセキュリティ更新プログラムはこの種の脆弱性の特定の問題を解決します。

.Net Framework 4.5 Release Candidate はこのセキュリティ情報で説明している脆弱性の影響を受けますか？

はい。Windows Vista、Windows Server 2008、Windows 7、Windows Server 2008 R2、Windows 8 Release Preview および Windows Server 2012 Release Candidate 上の Microsoft .NET Framework 4.5 Release Candidate 用に更新プログラムをご利用いただけます。また、Windows 8 Release Preview および Windows Server 2012 Release Candidate 上の Microsoft .NET Framework 3.5 にも更新プログラムをご利用いただけます。これらの構成で実行しているお客様は、この更新プログラムをご使用のコンピューターに適用することを推奨します。なお、これらの更新プログラムは、[Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) からのみの提供となります。

なぜこの更新プログラムはいくつかの報告されたセキュリティ上の脆弱性を解決するのですか?   
これらの問題を解決するために必要な変更が関連するファイルに存在するため、この更新プログラムはいくつかの脆弱性を解決します。

この更新プログラムには、セキュリティ関連以外の機能への変更が含まれていますか?    
はい。このセキュリティ情報の「脆弱性の情報」の欄に記載されている変更と共に、KB2756872 更新プログラムには、[サポート技術情報 2756872](https://support.microsoft.com/kb/2756872/ja) に記載されている機能変更が含まれます。この更新プログラムは 2012 年 10 月 11 日に最初に提供されたことに注意してください。この更新プログラムを既にインストールしているお客様は、その他の対策を行う必要はなく、この更新プログラムが再度提供されることもありません。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1895](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1895) を参照してください。
...
CLR とは何ですか?   
Microsoft .NET Framework は共通言語ランタイム (CLR) というランタイム環境を提供します。CLR はコードの実行を行い、開発プロセスを容易にするサービスを提供します。CLR の詳細については、[Common Language Runtime Overview](https://msdn.microsoft.com/en-us/library/ddk909ch(vs.71).aspx) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1896](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1896) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2519](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2519) を参照してください。
...
エンティティ フレームワークとは、ADO.NET に組み込まれているテクノロジー一式です。データ指向のソフトウェア アプリケーションの開発を支援します。詳細については、MSDN の記事「[エンティティ フレームワークの概要](https://msdn.microsoft.com/ja-jp/library/bb399567.aspx)」を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-4776](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4776) を参照してください。
...
-   WPAD を登録する
    ...
    [サポート技術情報 934864](https://support.microsoft.com/kb/934864/ja) に記載されている手順に従って WPAD を登録します。

    回避策の影響:攻撃者が悪用する機会を得る前に、管理者が WPAD を登録します。

    回避策の解除方法:詳細については、[サポート技術情報 934864](https://support.microsoft.com/kb/934864/ja) を参照してください。
...
-   .NET アプリケーションの既定の Web プロキシ設定に 依存しない
    ...
    WebRequest.DefaultWebProxy プロパティの説明については、「[WebRequest.DefaultWebProxy プロパティ](https://msdn.microsoft.com/ja-jp/library/system.net.webrequest.defaultwebproxy.aspx)」を参照してください。
...
Web プロキシ自動発見 (WPAD) の機能により、Web クライアントがユーザーの介入なしで、自動でプロキシの設定を検出できます。WPAD の機能はホスト名 "wpad" を完全修飾ドメイン名に追加し、ドメイン名を返している WPAD サーバーを検出するまでサブドメインを削除し続けます。詳細については、「[WebProxy.GetDefaultProxy メソッド](https://msdn.microsoft.com/ja-jp/library/system.net.webproxy.getdefaultproxy(v=vs.110).aspx)」を参照してください。
...
この更新プログラムはどのように問題を修正しますか?   
System.Net 内の Microsoft.Jscript を更新して、WPAD 構成ファイル内に記述されている JavaScript の .NET Framework による実行にも制限を加えることで問題を修正しています。また、WPAD の処理方法を Microsoft.Jscript を使った方法から WinHTTP を使用する方法に変更しています。この変更により、めったにないことですが、標準的なプロキシ自動構成を使用しない環境では互換性の問題が生じることがあります。この変更の詳細については、[マイクロソフト サポート技術情報 2745030](https://support.microsoft.com/kb/2745030/ja) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-4777](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4777) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2745030/ja">マイクロソフト サポート技術情報 2745030</a> を参照してください。</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;">適用</td>
<td style="border:1px solid black;">Windows RT の更新プログラムは、<a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> からのみの提供となります。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">詳細情報</td>
<td style="border:1px solid black;">サブセクション「検出および展開ツールとガイダンス」を参照してください。</td>
...
Windows RT の更新プログラムは、[Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) からのみの提供となります。
