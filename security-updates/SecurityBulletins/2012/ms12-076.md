...
<td style="border:1px solid black;">
[MS12-030](https://go.microsoft.com/fwlink/?linkid=238499) の KB2597086 は、KB2687481 に置き換えられる
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-030](https://go.microsoft.com/fwlink/?linkid=238499) の KB2597161 は、KB2687307 に置き換えられる
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-030](https://go.microsoft.com/fwlink/?linkid=238499) の KB2597166 は、KB2597126 に置き換えられる
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-030](https://go.microsoft.com/fwlink/?linkid=238499) の KB2665346 は、KB2764048 に置き換えられる
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-051](https://go.microsoft.com/fwlink/?linkid=255000) の KB2721015 は、KB2764047 に置き換えられる
</td>
</tr>
<tr>
<th colspan="5">
...
<td style="border:1px solid black;">
[MS12-030](https://go.microsoft.com/fwlink/?linkid=238499) の KB2596842 は、KB2687313 に置き換えられる
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-030](https://go.microsoft.com/fwlink/?linkid=238499) の KB2597162 は、KB2687311 に置き換えられる
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1885](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1885) を参照してください。
...
-   未知の、または信頼されないソースからのファイルを開くとき、Microsoft Office Isolated Conversion Environment (MOICE) を使用する
    ...
    また、MOICE をインストールするためには Word/Excel/PowerPoint 2007 ファイル形式用 Microsoft Office 互換機能パックもインストールされている必要があります。この互換機能パックは[マイクロソフト ダウンロード センター](https://www.microsoft.com/ja-jp/download/details.aspx?id=3)から無償でダウンロードできます。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1886](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1886) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1887](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1887) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2543](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2543) を参照してください。
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2687481/ja">サポート技術情報 2687481</a> を参照してください。</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2687307/ja">マイクロソフト サポート技術情報 2687307</a> を参照してください。<br />
<a href="https://support.microsoft.com/kb/2687313/ja">マイクロソフト サポート技術情報 2687313</a> を参照してください。<br />
<a href="https://support.microsoft.com/kb/2687311/ja">マイクロソフト サポート技術情報 2687311</a> を参照してください。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">レジストリ キーの確認</td>
<td style="border:1px solid black;">対象外</td>
...
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2597126/ja">マイクロソフト サポート技術情報 2597126</a> を参照してください。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">レジストリ キーの確認</td>
<td style="border:1px solid black;">対象外</td>
...
[マイクロソフト ダウンロード センター](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=d3d801a2-d57f-4b4c-970a-c296bc716521)から Microsoft Office 2008 for Mac 12.3.5 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
[マイクロソフト ダウンロード センター](https://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=0f4e073f-4fec-440d-a9bf-1e01ee9e92ad)から Microsoft Office for Mac 2011 14.2.5 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
-   [iDefense VCP](https://labs.idefense.com) に協力して Excel SerAuxErrBar のヒープ オーバーフローの脆弱性 (CVE-2012-1885) を報告してくださった Sean Larsson 氏  
-   [iDefense VCP](https://labs.idefense.com) に協力して、Excel のメモリ破損の脆弱性 (CVE-2012-1886) を報告してくださった匿名のリサーチャー  
-   [iDefense VCP](https://labs.idefense.com) に協力して、Excel SST の解放後の無効な長さの使用の脆弱性 (CVE-2012-1887) を報告してくださった匿名のリサーチャー  
-   [HP TippingPoint](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/) の [Zero Day Initiative](https://www.zerodayinitiative.com/) に協力して、FEAT レコードからのスタック オーバーフローの脆弱性 (CVE-2012-2543) を報告してくださった匿名のリサーチャー
