---
TOCTitle: 'MS04-JAN'
Title: 2004 年 1 月のマイクロソフト セキュリティ情報の概要
ms:assetid: 'ms04-jan'
ms:contentKeyID: 61229604
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms04-jan(v=Security.10)'
---



2004 年 1 月のマイクロソフト セキュリティ情報の概要
===================================================
...
このセキュリティ情報の概要は 2004 年 1 月公開のセキュリティ情報の一覧です。
...
この概要では、Microsoft Windows、Microsoft Exchange Server、および Microsoft Internet Security and Acceleration Server で確認されている脆弱性を説明します。深刻度の詳しい情報は以下をご覧ください。

**緊急**

[マイクロソフト セキュリティ情報 MS04-001 - Microsoft Internet Security and Acceleration Server 2000 H.323 フィルターの脆弱性により、リモートでコードが実行される (816458)](https://technet.microsoft.com/ja-jp/security/bulletin/ms04-001)
...
<td style="border:1px solid black;">Microsoft Internet Security and Acceleration Server 2000
<div>
...
<td style="border:1px solid black;">2004/01/14</td>
</tr>
<tr class="even">
...
[マイクロソフト セキュリティ情報 MS04-003 - MDAC 機能のバッファ オーバーランにより、コードが実行される (832483)](https://technet.microsoft.com/ja-jp/security/bulletin/ms04-003)
...
<tr class="odd">
<td style="border:1px solid black;">影響を受けるソフトウェア</td>
<td style="border:1px solid black;">Microsoft Data Access Components 2.5 (Microsoft Windows 2000 に含まれる)
<div>
Microsoft Data Access Components 2.6 (Microsoft SQL Server 2000 に含まれる)  
</div>
<div>
Microsoft Data Access Components 2.7 (Microsoft Windows XP に含まれる)  
</div>
<div>
Microsoft Data Access Components 2.8 (Microsoft Windows Server 2003 に含まれる)  
</div>
<div>
Microsoft Data Access Components 2.8 (Microsoft Windows Server 2003 64-Bit Edition に含まれる)
</div></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">影響</td>
...
<tr class="odd">
<td style="border:1px solid black;">最終更新日</td>
<td style="border:1px solid black;">2004/04/02</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">バージョン番号</td>
...
[マイクロソフト セキュリティ情報 MS04-002 - Exchange Server 2003 の脆弱性により、権限が昇格する (832759)](https://technet.microsoft.com/ja-jp/security/bulletin/ms04-002)
...
-   MS04-001 で説明している問題を報告してくださった [UK National Infrastructure Security Co-ordination Centre (NISCC)](https://www.niscc.gov.uk/)
...
-   V1.0 (2004/01/14):このセキュリティ情報の概要ページを公開しました。
