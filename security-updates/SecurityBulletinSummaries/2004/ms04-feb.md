---
TOCTitle: 'MS04-FEB'
Title: 2004 年 2 月のマイクロソフト セキュリティ情報の概要
ms:assetid: 'ms04-feb'
ms:contentKeyID: 61229603
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms04-feb(v=Security.10)'
---



2004 年 2 月のマイクロソフト セキュリティ情報の概要
===================================================
...
このセキュリティ情報の概要は 2004 年 2 月公開のセキュリティ情報の一覧です。
...
この概要では、Microsoft Windows および Microsoft Macintosh 製品で確認されている脆弱性を説明します。深刻度の詳しい情報は以下をご覧ください。

**緊急**

[マイクロソフト セキュリティ情報 MS04-004 – Internet Explorer 用の累積的なセキュリティ更新プログラム (832894)](https://technet.microsoft.com/ja-jp/security/bulletin/ms04-004)
...
[マイクロソフト セキュリティ情報 MS04-007 - ASN .1 の脆弱性により、コードが実行される (828028)](https://technet.microsoft.com/ja-jp/security/bulletin/ms04-007)
...
<tr class="odd">
<td style="border:1px solid black;">最終更新日</td>
<td style="border:1px solid black;">2004/06/09</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">バージョン番号</td>
...
[マイクロソフト セキュリティ情報 MS04-005 - Virtual PC for Mac の脆弱性により、権限が昇格する (835150)](https://technet.microsoft.com/ja-jp/security/bulletin/ms04-005)
...
<tr class="odd">
<td style="border:1px solid black;">影響を受けるソフトウェア</td>
<td style="border:1px solid black;">Microsoft Virtual PC for Mac version 6.0
<div>
...
[マイクロソフト セキュリティ情報 MS04-006 - Windows インターネット ネーム サービス (WINS) の脆弱性により、コードが実行される (830352)](https://technet.microsoft.com/ja-jp/security/bulletin/ms04-006)
...
<tr class="odd">
<td style="border:1px solid black;">影響を受けるソフトウェア</td>
<td style="border:1px solid black;">Microsoft Windows NT Server 4.0 Service Pack 6a
<div>
Microsoft Windows NT Server 4.0 Terminal Server Edition Service Pack 6  
</div>
<div>
...
-   MS04-005 で説明している問題を報告してくださった [@stake](https://www.atstake.com/) の George Gal 氏  
-   MS04-006 で説明している問題を報告してくださった [Qualys](https://www.qualys.com/)  
-   MS04-007 で説明している問題を報告してくださった [eEye Digital Security](https://www.eeye.com/)
...
-   V1.0 (2004/02/11):このセキュリティ情報の概要ページを公開しました。
