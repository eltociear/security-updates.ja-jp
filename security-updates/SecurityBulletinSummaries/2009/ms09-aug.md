...
| [MS09-037](https://go.microsoft.com/fwlink/?linkid=158695) | Microsoft ATL (Active Template Library) の脆弱性により、リモートでコードが実行される (973908) | [CVE-2009-2494](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2494) | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 安定した悪用コードの可能性     | (なし)                                                                                                                                                                                                                                                                                                          |  
...
| [MS09-043](https://go.microsoft.com/fwlink/?linkid=128110) | Microsoft Office Web コンポーネントの脆弱性により、リモートでコードが実行される (957638)      | [CVE-2009-1534](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1534) | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 安定した悪用コードの可能性     | (なし)                                                                                                                                                                                                                                                                                                          |  
...
-   MS09-036 で説明している問題について最初に報告してくださった [Digitiria](https://www.digitaria.com/) の Alexander Pfandt 氏
-   MS09-037 で説明している問題について最初に報告してくださった [IBM ISS X-Force](https://www.iss.net/) の Ryan Smith 氏および Alex Wheeler 氏
-   MS09-037 で説明している問題について報告してくださった [IBM ISS X-Force](https://www.iss.net/) の Robert Freeman 氏
-   MS09-037 で説明している問題について報告してくださった [IBM ISS X-Force](https://www.iss.net/) の David Dewey 氏
-   MS09-037 で説明している 2 つの問題について報告してくださった [VeriSign iDefense Labs](https://labs.idefense.com/) の Ryan Smith 氏
-   MS09-038 で説明している 2 つの問題について報告してくださった Adobe Systems, Inc. の Vinay Anantharaman 氏
-   MS09-039 で説明している問題について報告してくださった [TippingPoint](https://www.tippingpoint.com/) および [Zero Day Initiative](https://www.zerodayinitiative.com/)
-   MS09-039 で説明している問題について報告してくださった [National University of Defense Technology](https://english.nudt.edu.cn/) の LiGen 氏
-   MS09-040 で説明している問題について報告してくださった [Positive Technologies Research Team](https://en.securitylab.ru/lab/) の Nikita Tarakanov 氏
-   MS09-041 で説明している問題について報告してくださった [TippingPoint DVLabs](https://dvlabs.tippingpoint.com/) の Cody Pierce 氏
-   MS09-043 で説明している 2 つの問題について報告してくださった [Zero Day Initiative](https://www.zerodayinitiative.com/) の Peter Vreugdenhil 氏
-   MS09-043 で説明している問題について報告してくださった [Zero Day Initiative](https://www.zerodayinitiative.com/) の Peter Vreugdenhil 氏および Fortinet’s [FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) の Haifei Li 氏
-   MS09-043 で説明している問題について報告してくださった [VeriSign iDefense Labs](https://labs.idefense.com/) の Sean Larsson 氏
-   MS09-044 で説明している問題について Zero Day Initiative と協力して報告してくださった [Team509](https://www.team509.com/) の Wushi 氏
-   MS09-044 で説明している問題について報告してくださった [Palo Alto Networks](https://www.paloaltonetworks.com/) の Yamata Li 氏

#### サポート

-   セキュリティ関連、およびセキュリティ更新プログラムに関するご質問や、ご不明な点などありましたら、 [マイクロソフト セキュリティ情報センター](https://www.microsoft.com/ja-jp/security/sic.aspx) までご連絡ください。
...
-   V1.1 (2009/08/14): Windows XP Service Pack 2 および Windows XP Service Pack 3 の RDP 更新プログラムのリストを セキュリティ情報と合わせて修正しました。MS09-037、MS09-042、および MS09-044 の再起動の要件を変更しました。
-   V2.0 (2009/08/26): MS09-044 の Windows XP Service Pack 2 用の RDP バージョン 5.2 (KB958469) のダウンロード リンクを修正しました。また、KB958471 および KB958470 のインストールの順番を間違って説明していた補足説明を修正しました。これらの更新プログラムが正常にインストールされた場合、これらの更新プログラムの再インストールの必要はありません。
-   V3.0 (2009/09/09): Windows XP Media Center Edition 2005 およびすべてのサポートされているエディションの Windows Vista 上の HtmlInput Object ActiveX コントロール向けの新しい更新プログラムを提供するためにセキュリティ情報 MS09-037 を再リリースしました。
-   V4.0 (2009/10/28): マイクロソフトは Microsoft Office 2003 Service Pack 3 および Microsoft Office 2003 Web Components Service Pack 3 用の検出の問題を解決する更新プログラムを再度提供するために、セキュリティ情報 MS09-043 を再リリースしました。これは検出の変更のみで、バイナリへの変更はありません。更新プログラムがシステムに正しくインストールされたお客様は、この更新プログラムを再インストールする必要はありません。
