...
[![](../../images/Dn627293.onepoint_summary(ja-JP,Security.10).jpg)](https://technet.microsoft.com/ja-jp/security/dd251169.aspx)[![](../../images/Dn627293.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
マイクロソフトは公開したセキュリティ更新プログラムの概要を説明用スライドと音声でお伝えする日本語の Webcast 情報を 2013 年 3 月 13 日 の午後 (日本時間) に配信予定です。詳細は、「 [今月のワンポイント セキュリティ情報](https://technet.microsoft.com/ja-jp/security/dd251169.aspx) 」をご覧ください。
...
|-----------------------------------------------------------|---------------------------------------------------------------|----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|--------------------------------|----------------------------------------|  
| [MS13-021](https://go.microsoft.com/fwlink/?linkid=279923) | Internet Explorer OnResize の解放後使用の脆弱性               | [CVE-2013-0087](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0087) | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 対象外                         | (なし)                                 |  
| [MS13-021](https://go.microsoft.com/fwlink/?linkid=279923) | Internet Explorer saveHistory の解放後使用の脆弱性            | [CVE-2013-0088](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0088) | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 対象外                         | (なし)                                 |  
| [MS13-021](https://go.microsoft.com/fwlink/?linkid=279923) | Internet Explorer CMarkupBehaviorContext の解放後使用の脆弱性 | [CVE-2013-0089](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0089) | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 対象外                         | (なし)                                 |  
| [MS13-021](https://go.microsoft.com/fwlink/?linkid=279923) | Internet Explorer CCaret の解放後使用の脆弱性                 | [CVE-2013-0090](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0090) | [2](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの作成困難 | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 対象外                         | (なし)                                 |  
| [MS13-021](https://go.microsoft.com/fwlink/?linkid=279923) | Internet Explorer CElement の解放後使用の脆弱性               | [CVE-2013-0091](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0091) | 影響なし                                                                              | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 対象外                         | (なし)                                 |  
| [MS13-021](https://go.microsoft.com/fwlink/?linkid=279923) | Internet Explorer GetMarkupPtr の解放後使用の脆弱性           | [CVE-2013-0092](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0092) | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 対象外                         | (なし)                                 |  
| [MS13-021](https://go.microsoft.com/fwlink/?linkid=279923) | Internet Explorer onBeforeCopy の解放後使用の脆弱性           | [CVE-2013-0093](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0093) | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 対象外                         | (なし)                                 |  
| [MS13-021](https://go.microsoft.com/fwlink/?linkid=279923) | Internet Explorer removeChild の解放後使用の脆弱性            | [CVE-2013-0094](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0094) | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 対象外                         | (なし)                                 |  
| [MS13-021](https://go.microsoft.com/fwlink/?linkid=279923) | Internet Explorer CTreeNode の解放後使用の脆弱性              | [CVE-2013-1288](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1288) | 影響なし                                                                              | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 対象外                         | この脆弱性は一般で公開されていました。 |  
| [MS13-022](https://go.microsoft.com/fwlink/?linkid=275737) | Silverlight 二重逆参照の脆弱性                                | [CVE-2013-0074](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0074) | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 対象外                                                                                | 対象外                         | (なし)                                 |  
| [MS13-023](https://go.microsoft.com/fwlink/?linkid=276801) | Visio Viewer のツリー オブジェクトの種類の混同の脆弱性        | [CVE-2013-0079](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0079) | 影響なし                                                                              | [2](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの作成困難 | 対象外                         | (なし)                                 |  
| [MS13-024](https://go.microsoft.com/fwlink/?linkid=271610) | コールバック関数の脆弱性                                      | [CVE-2013-0080](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0080) | 影響なし                                                                              | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 対象外                         | (なし)                                 |  
| [MS13-024](https://go.microsoft.com/fwlink/?linkid=271610) | SharePoint XSS の脆弱性                                       | [CVE-2013-0083](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0083) | 影響なし                                                                              | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 対象外                         | (なし)                                 |  
| [MS13-024](https://go.microsoft.com/fwlink/?linkid=271610) | SharePoint ディレクトリ トラバーサルの脆弱性                  | [CVE-2013-0084](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0084) | 影響なし                                                                              | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 対象外                         | (なし)                                 |  
| [MS13-024](https://go.microsoft.com/fwlink/?linkid=271610) | バッファー オーバーフローの脆弱性                             | [CVE-2013-0085](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0085) | 影響なし                                                                              | [3](https://technet.microsoft.com/ja-jp/security/cc998259) - 悪用コードの可能性低      | 一時的                         | これは、サービス拒否の脆弱性です。     |  
| [MS13-025](https://go.microsoft.com/fwlink/?linkid=282355) | バッファー サイズの検証の脆弱性                               | [CVE-2013-0086](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0086) | 影響なし                                                                              | [3](https://technet.microsoft.com/ja-jp/security/cc998259) - 悪用コードの可能性低      | 対象外                         | これは情報漏えいの脆弱性です。         |  
| [MS13-026](https://go.microsoft.com/fwlink/?linkid=280673) | 意図していないコンテンツが読み込まれる脆弱性                  | [CVE-2013-0095](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0095) | [3](https://technet.microsoft.com/ja-jp/security/cc998259) - 悪用コードの可能性低      | [3](https://technet.microsoft.com/ja-jp/security/cc998259) - 悪用コードの可能性低      | 対象外                         | これは情報漏えいの脆弱性です。         |  
| [MS13-027](https://go.microsoft.com/fwlink/?linkid=282639) | Windows USB 記述子の脆弱性                                    | [CVE-2013-1285](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1285) | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 永続的                         | (なし)                                 |  
| [MS13-027](https://go.microsoft.com/fwlink/?linkid=282639) | Windows USB 記述子の脆弱性                                    | [CVE-2013-1286](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1286) | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 永続的                         | (なし)                                 |  
| [MS13-027](https://go.microsoft.com/fwlink/?linkid=282639) | Windows USB 記述子の脆弱性                                    | [CVE-2013-1287](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1287) | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | [1](https://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 悪用コードの可能性   | 永続的                         | (なし)                                 |
...
<td style="border:1px solid black;">
[Microsoft OneNote 2010 Service Pack 1 (32 ビット版)](https://www.microsoft.com/downloads/ja-jpdetails.aspx?familyid=da4bfd31-65b9-496b-aa98-4fa8b729dcf3)   
(2760600)  
(重要)
</td>
<td style="border:1px solid black;">
...
-   Internet Explorer OnResize の解放後使用の脆弱性 (CVE-2013-0087) を報告してくださった [TELUS Security Labs](https://telussecuritylabs.com/) の Arseniy Akuney 氏
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して Internet Explorer saveHistory の解放後使用の脆弱性 (CVE-2013-0088) を報告してくださった匿名のリサーチャー
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して Internet Explorer CMarkupBehaviorContext の解放後使用の脆弱性 (CVE-2013-0089) を報告してくださった匿名のリサーチャー
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して Internet Explorer CCaret の解放後使用の脆弱性 (CVE-2013-0090) を報告してくださったHarmony Security の Stephen Fewer 氏
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して Internet Explorer CCaret の解放後使用の脆弱性 (CVE-2013-0090) を報告してくださった SkyLined 氏
...
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して Internet Explorer GetMarkupPtr の解放後使用の脆弱性 (CVE-2013-0092) を報告してくださった [Aniway.Aniway@gmail.com](mailto:aniway.aniway@gmail.com) 氏
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力して Internet Explorer onBeforeCopy の解放後使用の脆弱性 (CVE-2013-0093) を報告してくださったAniway.Aniway@gmail.com 氏
-   [HP](https://www.hpenterprisesecurity.com/products) の [Zero Day Initiative](https://www.zerodayinitiative.com/) と協力してInternet Explorer removeChild の解放後使用の脆弱性 (CVE-2013-0094) を報告してくださった Simon Zuckerbraun 氏
-   Internet Explorer CTreeNode の解放後使用の脆弱性 (CVE-2013-1288) についてマイクロソフトに協力して下さった [Venustech](https://www.venustech.com.cn/) ADLab の Gen Chen 氏
-   Internet Explorer CTreeNode の解放後使用の脆弱性 (CVE-2013-1288) についてマイクロソフトに協力して下さった [Qihoo 360 Security Center](https://www.360.cn/)

MS13-022

-   Silverlight 二重逆参照の脆弱性 (CVE-2013-0074) を報告してくださった [Context Information Security](https://www.contextis.com/) の James Forshaw 氏
