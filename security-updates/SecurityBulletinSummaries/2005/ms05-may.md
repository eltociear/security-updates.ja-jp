---
TOCTitle: 'MS05-MAY'
Title: 2005 年 5 月のセキュリティ情報
ms:assetid: 'ms05-may'
ms:contentKeyID: 61229619
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms05-may(v=Security.10)'
---
...
[**MS05-024** : Windows の重要な更新](https://www.microsoft.com/japan/security/bulletins/ms05-024e.mspx)
...
| セキュリティ情報の番号       | MS05-024                                                                                                                      |
|------------------------------|-------------------------------------------------------------------------------------------------------------------------------|
| **タイトル**                 | [「Web の表示」の脆弱性により、リモートでコードが実行される(894320)](https://technet.microsoft.com/security/bulletin/ms05-024) |
| **概要**                     | 「Web の表示」でファイル属性を取り扱う場合にスクリプト挿入の脆弱性が存在します。                                              |
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=67581d32-743f-44ff-9b53-30277c196923&amp;displaylang=ja">重要</a></td>
</tr>
<tr class="odd">
...
-   2005/05/10 : このセキュリティ情報ページを公開しました｡
