...
<td style="border:1px solid black;"><p>任意</p></td>
<td style="border:1px solid black;"><p>ME</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>Block everything</p></td>
<td style="border:1px solid black;"><p>任意</p></td>
<td style="border:1px solid black;"><p>任意</p></td>
<td style="border:1px solid black;"><p>任意</p></td>
<td style="border:1px solid black;"><p>任意</p></td>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><p>Inbound ICMP for TCP PMTU</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>Inbound IIS Server HTTP:80</p></td>
<td style="border:1px solid black;"><p>TCP</p></td>
<td style="border:1px solid black;"><p>任意</p></td>
<td style="border:1px solid black;"><p>80</p></td>
<td style="border:1px solid black;"><p>任意</p></td>
...
<tr class="odd">
<td style="border:1px solid black;"><p>Inbound IIS Server FTP:21</p></td>
<td style="border:1px solid black;"><p>TCP</p></td>
<td style="border:1px solid black;"><p>任意</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>Inbound Terminal Server</p></td>
<td style="border:1px solid black;"><p>TCP</p></td>
<td style="border:1px solid black;"><p>任意</p></td>
...
<tr class="odd">
<td style="border:1px solid black;"><p>Me to Domain DCs all traffic</p></td>
<td style="border:1px solid black;"><p>任意</p></td>
<td style="border:1px solid black;"><p>任意</p></td>
<td style="border:1px solid black;"><p>任意</p></td>
<td style="border:1px solid black;"><p>ME</p></td>
<td style="border:1px solid black;"><p>ドメイン名</p></td>
<td style="border:1px solid black;"><p>許可</p></td>
<td style="border:1px solid black;"><p>あり</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p>Outbound DNS UDP/TCP</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>Outbound WINS</p></td>
<td style="border:1px solid black;"><p>UDP</p></td>
...
<tr class="odd">
<td style="border:1px solid black;"><p>Outbound DHCP</p></td>
<td style="border:1px solid black;"><p>UDP</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>Outbound HTTP:80</p></td>
<td style="border:1px solid black;"><p>TCP</p></td>
<td style="border:1px solid black;"><p>任意</p></td>
<td style="border:1px solid black;"><p>80</p></td>
<td style="border:1px solid black;"><p>ME</p></td>
...
<tr class="odd">
<td style="border:1px solid black;"><p>Mitigation from inbound src 80 attack</p></td>
<td style="border:1px solid black;"><p>TCP</p></td>
<td style="border:1px solid black;"><p>80</p></td>
