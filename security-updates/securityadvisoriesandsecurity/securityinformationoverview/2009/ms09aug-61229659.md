...
| [MS09-037](http://go.microsoft.com/fwlink/?linkid=158695) | Microsoft ATL (Active Template Library) の脆弱性により、リモートでコードが実行される (973908) | [CVE-2009-2494](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2494) | [1](http://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 安定した悪用コードの可能性     | (なし)                                                                                                                                                                                                                                                                                                          |  
...
| [MS09-043](http://go.microsoft.com/fwlink/?linkid=128110) | Microsoft Office Web コンポーネントの脆弱性により、リモートでコードが実行される (957638)      | [CVE-2009-1534](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1534) | [1](http://technet.microsoft.com/ja-jp/security/cc998259.aspx) - 安定した悪用コードの可能性     | (なし)                                                                                                                                                                                                                                                                                                          |  
...
-   MS09-036 で説明している問題について最初に報告してくださった [Digitiria](http://www.digitaria.com/) の Alexander Pfandt 氏
-   MS09-037 で説明している問題について最初に報告してくださった [IBM ISS X-Force](http://www.iss.net/) の Ryan Smith 氏および Alex Wheeler 氏
-   MS09-037 で説明している問題について報告してくださった [IBM ISS X-Force](http://www.iss.net/) の Robert Freeman 氏
-   MS09-037 で説明している問題について報告してくださった [IBM ISS X-Force](http://www.iss.net/) の David Dewey 氏
-   MS09-037 で説明している 2 つの問題について報告してくださった [VeriSign iDefense Labs](http://labs.idefense.com/) の Ryan Smith 氏
-   MS09-038 で説明している 2 つの問題について報告してくださった Adobe Systems, Inc. の Vinay Anantharaman 氏
-   MS09-039 で説明している問題について報告してくださった [TippingPoint](http://www.tippingpoint.com/) および [Zero Day Initiative](http://www.zerodayinitiative.com/)
-   MS09-039 で説明している問題について報告してくださった [National University of Defense Technology](http://english.nudt.edu.cn/) の LiGen 氏
-   MS09-040 で説明している問題について報告してくださった [Positive Technologies Research Team](http://en.securitylab.ru/lab/) の Nikita Tarakanov 氏
-   MS09-041 で説明している問題について報告してくださった [TippingPoint DVLabs](http://dvlabs.tippingpoint.com/) の Cody Pierce 氏
-   MS09-043 で説明している 2 つの問題について報告してくださった [Zero Day Initiative](http://www.zerodayinitiative.com/) の Peter Vreugdenhil 氏
-   MS09-043 で説明している問題について報告してくださった [Zero Day Initiative](http://www.zerodayinitiative.com/) の Peter Vreugdenhil 氏および Fortinet’s [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com/) の Haifei Li 氏
-   MS09-043 で説明している問題について報告してくださった [VeriSign iDefense Labs](http://labs.idefense.com/) の Sean Larsson 氏
-   MS09-044 で説明している問題について Zero Day Initiative と協力して報告してくださった [Team509](http://www.team509.com/) の Wushi 氏
-   MS09-044 で説明している問題について報告してくださった [Palo Alto Networks](http://www.paloaltonetworks.com/) の Yamata Li 氏

#### サポート

-   セキュリティ関連、およびセキュリティ更新プログラムに関するご質問や、ご不明な点などありましたら、 [マイクロソフト セキュリティ情報センター](http://www.microsoft.com/ja-jp/security/sic.aspx) までご連絡ください。
