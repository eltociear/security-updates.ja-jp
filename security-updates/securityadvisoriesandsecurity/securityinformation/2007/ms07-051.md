...
[](http://www.microsoft.com/japan/security/bulletins/ms07-051e.mspx)
...
**US** **マイクロソフトセキュリティ情報:** [http://www.microsoft.com/technet/security/bulletin/MS07-051.mspx](http://technet.microsoft.com/security/bulletin/ms07-051)
...
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|---------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4 | [![](../../images/Dn610175.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=7cd248ed-d154-4dce-89ef-ceefd2700965&displaylang=ja) | [![](../../images/Dn610175.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=7cd248ed-d154-4dce-89ef-ceefd2700965&amp;displaylang=ja-nec) | リモートでコードが実行される | 緊急           | [MS07-020](http://technet.microsoft.com/security/bulletin/ms07-020) |
...
<th style="border:1px solid black;" >エージェントのリモートでコードが実行される脆弱性 - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040">CVE-2007-3040</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2007-3040](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040) をご覧ください。
...
Microsoft エージェントは対話的なアニメーション文字の使用により、ユーザーをガイドし、コンピュータによる使用および学習をより簡単に行うための Microsoft Windows オペレーティング システムのコンポーネントです。 詳細情報は、こちらの [Microsoft エージェントの Web サイト](http://www.microsoft.com/msagent/) (英語情報) をご覧ください。
...
-   「エージェントのリモートでコードが実行される脆弱性」 - [CVE-2007-3040](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040) の 問題を報告をしてくださった [Assurent Secure Technologies](http://www.assurent.com/) 社の Vulnerability Research チーム
-   「エージェントのリモートでコードが実行される脆弱性」 - [CVE-2007-3040](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040) の 問題を報告をしてくださった [Palo Alto Networks](http://www.paloaltonetworks.com/) 社の Yamata Li 氏
-   エージェントのリモートでコードが実行される脆弱性 - [CVE-2007-3040](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040) を報告してくださった [VeriSign iDEFENSE VCP](http://labs.idefense.com/) に協力している匿名のリサーチャー
