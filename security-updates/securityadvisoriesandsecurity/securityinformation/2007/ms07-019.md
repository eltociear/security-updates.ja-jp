...
[](http://www.microsoft.com/japan/security/bulletins/ms07-019e.mspx)
...
|                                                                                                                   | PC/AT                                                                                                                                                                                             | MU                                                                            |
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows XP Service Pack 2                                                                               | [![](../../images/Dn610143.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=ecf69778-91f9-498e-a8bd-35208aa93051&displaylang=ja) | ![](../../images/Dn610143.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition および Microsoft Windows XP Professional x64 Edition Service Pack 2 | [![](../../images/Dn610143.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=6ceb5b4f-861f-4f37-b4bc-e8a56382b833&displaylang=ja) | ![](../../images/Dn610143.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610143.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](http://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|-------------------------------------------------------------------------------------------------------------|------------------------------|-------------------------------------|
| UPnP メモリの破損の脆弱性 -[CVE-2007-1204](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1204) | リモートでコードが実行される | 緊急                                |
...
-   **ファイアウォールにより、以下のポートをブロックする**
    ...
    この UPnP のフレームワークでは、UDP ポート 1900 および TCP ポート 2869 を使用しています。Simple Service Discovery Protocol (SSDP) は、マルチキャスト検索を使用して UPnP のデバイスを検出します。マルチキャスト検索は動的な送信ポートを使用して UDP ポート 1900 へ送信されます。Windows ファイアウォールは、マルチキャスト検索の実行から 3 秒以内に受信した、検索要求と一致する応答を受け入れます。その後、ファイアウォールは検索の要求と一致していたとしてもマルチキャスト検索の応答をブロックします。ファイアウォールを設定した場合の、UPnP サービスへの影響に関する追加情報は、サポート技術情報 [886257](http://support.microsoft.com/kb/886257)をご覧ください。
...
このセキュリティ更新プログラムを適用するには、Microsoft Windows XP Service Pack 2 または Windows XP Professional, x64 Edition がインストールされている必要があります。Windows XP の最新のサービス パックの入手方法に関する詳細情報は、マイクロソフト サポート技術情報 [322389](http://support.microsoft.com/kb/322389) をご覧ください。Windows XP Professional, x64 Edition 用の Service Pack 2 の入手方法の詳細は、 [ダウンロード センター](http://www.microsoft.com/downloads/details.aspx?displaylang=ja&familyid=893fd6c0-6283-44c3-bb84-b2f0315b2ae6)をご覧ください。
...
-   UPnP メモリの破損 の脆弱性 - [CVE-2007-1204](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1204) を報告してくださった [IDefense Labs](http://labs.idefense.com/) の Greg MacManus 氏
...
-   US マイクロソフトセキュリティ情報（MS07-019）
    [http://www.microsoft.com/technet/security/bulletin/MS07-019.mspx](http://technet.microsoft.com/security/bulletin/ms07-019)
-   サポート技術情報 （KB） 文書番号 ：931261
    [\[MS07-019\] ユニバーサル プラグ アンド プレイの脆弱性により、リモートでコードが実行される](http://support.microsoft.com/kb/931261)
