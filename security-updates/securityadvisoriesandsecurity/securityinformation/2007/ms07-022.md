...
[](http://www.microsoft.com/japan/security/bulletins/ms07-022e.mspx)
...
|                                                                                                                                 | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                           | [![](../../images/Dn610146.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=b3599afb-7673-4ef6-a2b1-d77e39fd782c&displaylang=ja) | [![](../../images/Dn610146.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=b3599afb-7673-4ef6-a2b1-d77e39fd782c&displaylang=ja-nec) | ![](../../images/Dn610146.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 2                                                                                             | [![](../../images/Dn610146.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=eeaee4a7-4858-4b6b-9c6d-a9f1eae19b51&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610146.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003、Microsoft Windows Server 2003 Service Pack 1 および Microsoft Windows Server 2003 Service pack 2 | [![](../../images/Dn610146.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=5e94a29c-7ec0-4459-92eb-d43b524fd6fd&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610146.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610146.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](http://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|---------------------------------------------------------------------------------------------------------------------------|--------------|---------------------------------------|-------------------------------------|-------------------------------|----------------------------------------------|----------------------------------------------|
| カーネルのローカルの特権の昇格の脆弱性 - [CVE-2007-1206](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1206) | 特権の昇格   | 重要                                  | 重要                                | 重要                          | 重要                                         | 重要                                         |
...
詳細情報は、サポート技術情報 [931784](http://support.microsoft.com/kb/931784) をご覧ください。サポート技術情報 [931784](http://support.microsoft.com/kb/931784) で、この改訂版のセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。
...
|---------------------------------------------------------------------|-----------------------------|---------------------------|---------------------|------------------------------------|------------------------------------|
| [MS06-049](http://technet.microsoft.com/security/bulletin/ms06-049) | 置き換わる                  | 対象外                    | 対象外              | 対象外                             | 対象外                             |
...
このセキュリティ更新プログラムを適用するには、Microsoft Windows XP Service Pack 2 がインストールされている必要があります。Windows XP の最新のサービス パックの入手方法に関する詳細情報は、マイクロソフトサポート技術情報 [322389](http://support.microsoft.com/kb/322389) をご覧ください。
...
-   カーネルのローカルの特権の昇格の脆弱性 [CVE-2007-1206](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1206) を報告してくださった [eEye](http://www.eeye.com/)
...
-   US マイクロソフトセキュリティ情報（MS07-022）  
    [http://www.microsoft.com/technet/security/bulletin/ms07-022.mspx](http://technet.microsoft.com/security/bulletin/ms07-022)
-   サポート技術情報 （KB） 文書番号 ：931784  
    [\[MS07-022\] Windows カーネルの脆弱性により、特権が昇格される](http://support.microsoft.com/kb/931784)
