...
この更新プログラムはそのほかのセキュリティ関連以外の機能への変更を含みますか?  はい。このすべての影響を受ける Windows プラットフォーム用の 更新プログラム パッケージ (KB977165) には、サポート技術情報 [977165](http://support.microsoft.com/kb/977165) で説明している Windows カーネルに対する変更が含まれています。
