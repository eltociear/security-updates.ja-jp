...
[](http://www.microsoft.com/japan/security/bulletins/ms10-003e.mspx)[![](../../images/Dn627160.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
既知の問題: マイクロソフト サポート技術情報 [978214](http://support.microsoft.com/kb/978214) には、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明されています。

US マイクロソフトセキュリティ情報: [http://www.microsoft.com/technet/security/bulletin/MS10-003.mspx](http://technet.microsoft.com/security/bulletin/ms10-003)
...
<td style="border:1px solid black;">
[![](../../images/Dn627160.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=47553f45-fa10-40e5-8267-9d42ff560a62&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
<td style="border:1px solid black;">
[![](../../images/Dn627160.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=7c985595-00c5-44b8-81c3-59d9967220f8&displaylang=ja)
</td>
<td style="border:1px solid black;">
リモートでコードが実行される
</td>
...
Microsoft Office 2004 for Mac の累積的なサービス モデルの一部として、この Microsoft Office 2004 for Mac (KB979674) 用のセキュリティ更新プログラムも [MS10-004](http://technet.microsoft.com/security/bulletin/ms10-004) で説明している脆弱性を解決します。Microsoft Office 2004 for Mac をインストールしている場合、このセキュリティ更新プログラムをインストールする必要がありますが、インストールが必要なのは一回のみです。
...
<span></span>
次の深刻度の評価は脆弱性による影響が最大であった場合を前提としています。このセキュリティ情報のリリース後 30 日以内に、深刻度の評価およびセキュリティ上の影響に関連する脆弱性が悪用される可能性に関する情報は、[2 月 月のセキュリティ情報](http://technet.microsoft.com/security/bulletin/ms10-feb)の「Exploitability Index (悪用可能性指標)」のセクションをご覧ください。 詳細については、[Microsoft Exploitability Index (悪用可能性指標)](http://technet.microsoft.com/security/cc998259.aspx)をご覧ください。
...
<th style="border:1px solid black;" >
MSO.DLL のバッファー オーバーフロー - [CVE-2010-0243](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0243)
</th>
<th style="border:1px solid black;" >
総合的な深刻度
</th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-0243](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0243) をご覧ください。
...
[Microsoft Mactopia Web サイト](http://www.microsoft.com/japan/mac/downloads.mspx)から Microsoft Office 2004 for Mac 11.5.7 用の更新プログラムの適切な言語バージョンをダウンロードし、インストールします。
...
-   「MSO.DLL のバッファー オーバーフロー」 - [CVE-2010-0243](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0243) の 問題を報告してくださった [Core Security Technologies](http://www.coresecurity.com/) の Damian Frizza 氏
