...
[](http://www.microsoft.com/japan/security/bulletins/ms10-092e.mspx)[![](../../images/Dn636476.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
既知の問題: サポート技術情報 [2305420](http://support.microsoft.com/kb/2305420) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明しています。 また、これらの問題に対する推奨される解決策についても説明しています。

US マイクロソフトセキュリティ情報: [http://www.microsoft.com/technet/security/bulletin/MS10-092.mspx](http://technet.microsoft.com/security/bulletin/ms10-092)
...
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|----------------------------------------------------------|
| Windows Vista Service Pack 1 および Windows Vista Service Pack 2                                                  | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=48f10251-34d8-4149-b4b2-bf3ec28f5846&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2                          | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=099ccc5f-b92f-4d06-bcb5-92e35c49f613&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2\*             | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=bdc9564a-4091-4cde-963a-239513db6c17&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2\*       | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=dff39bfe-0799-4912-ae22-392562178ae6&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Server 2008 for Itanium-based Systems および Windows Server 2008 for Itanium-based Systems Service Pack 2 | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=cf341a35-32ea-4ff7-aca9-1a4683c100ee&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows 7 for 32-bit Systems                                                                                      | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=cf85cdb6-58c7-4144-82f6-f01a6a4f9c3a&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows 7 for x64-based Systems                                                                                   | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=0597018d-39f5-4ca9-b437-63d9e68f264d&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Server 2008 R2 for x64-based Systems\*                                                                    | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=28c832fb-4937-4652-8799-eab6c76d05fb&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
| Windows Server 2008 R2 for Itanium-based Systems                                                                  | [![](../../images/Dn636476.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=3ad64d5c-2d81-4ac8-934e-8917b2fcf961&displaylang=ja) | 特権の昇格             | 重要           | なし                                                     |
...
<th style="border:1px solid black;" >タスク スケジューラの脆弱性 - <a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338">CVE-2010-3338</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) をご覧ください。
...
タスク スケジューラとは、選択されたコンピューター上で所定のタスクの自動化を有効にできる Windows サービスです。タスク スケジューラは、タスクを開始するためにユーザーが選択した基準 (トリガーと呼ばれます) を監視し、その基準を満たした場合、自動化を有効にします。詳細情報は、MSDN ライブラリ: [Task Scheduler](http://msdn.microsoft.com/library/aa383614(vs.85).aspx) (英語情報) をご覧ください。
...
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) にアサインされています。
...
はい。このセキュリティ更新プログラムは公開された検証用コードにより悪用される可能性のある脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) に割り当てられています。
...
<td style="border:1px solid black;">
サポート技術情報 [2305420](http://support.microsoft.com/kb/2305420) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
-   「タスク スケジューラの脆弱性」 - [CVE-2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) を報告してくださった [Kaspersky Lab](http://www.kaspersky.com/) の Sergey Golovanov 氏、Alexander Gostev氏 、Maxim Golovkin 氏および Alexey Monastyrsky 氏、[Design and Test Lab](http://www.dnt-lab.com/) の Vitaly Kiktenko 氏および Alexander Saprykin 氏
-   「タスク スケジューラの脆弱性」 - [CVE-2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) を報告してくださった [Symantec](http://www.symantec.com/index.jsp) の Liam O Morchu 氏
-   「タスク スケジューラの脆弱性」 - [CVE-2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) を報告してくださった [ESET](http://www.eset.com/) の Alexandr Matrosov 氏、Eugene Rodionov 氏、Juraj Malcho 氏および David Harley 氏
