---
TOCTitle: 'MS10-062'
Title: 'マイクロソフト セキュリティ情報 MS10-062 - 緊急'
ms:assetid: 'ms10-062'
ms:contentKeyID: 61229233
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms10-062(v=Security.10)'
---
...
公開日: 2010年9月15日 | 最終更新日: 2010年9月16日

**バージョン:** 1.0

[](http://www.microsoft.com/japan/security/bulletins/ms10-062e.mspx)[![](../../images/Dn636446.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
このセキュリティ更新プログラムはすべてのサポートされているエディションの Windows XP、Windows Server 2003 (Itanium-based editions を除く)、Windows Vista および Windows Server 2008 (Itanium-based editions を除く) について、深刻度を「緊急」に評価しました。Itanium-based エディションの Windows Server 2003 および Windows Server 2008、およびすべてのサポートされているエディションの Windows 7 および Windows Server 2008 R2 はこの脆弱性の影響を受けません。詳細情報は、このセクションの「影響を受けるソフトウェアおよび影響を受けないソフトウェア」のサブセクションをご覧ください。

このセキュリティ更新プログラムは MPEG-4 コーデックが特別な細工がされたメディア コンテンツを処理する方法を変更することにより、この脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。
...
**US** **マイクロソフトセキュリティ情報:** [http://www.microsoft.com/technet/security/bulletin/MS10-062.mspx](http://technet.microsoft.com/security/bulletin/ms10-062)
...
![](../../images/Dn636446.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](http://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](http://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム                                                                                     | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響       | 総合的な深刻度 | この更新プログラムにより置き換えられるセキュリティ情報 |
|---------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|--------------------------------------------------------|
| Windows XP Service Pack 3                                                                                     | [![](../../images/Dn636446.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=2084a01c-2a91-4650-8665-7053015f2083&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                   |
| Windows XP Professional x64 Edition Service Pack 2                                                            | [![](../../images/Dn636446.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=284a0e80-fd03-4909-b354-0478f04585a1&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                   |
| Windows Server 2003 Service Pack 2                                                                            | [![](../../images/Dn636446.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=0a942985-081f-455c-bf9d-4345392c91b0&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                   |
| Windows Server 2003 x64 Edition Service Pack 2                                                                | [![](../../images/Dn636446.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=284a0e80-fd03-4909-b354-0478f04585a1&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                   |
| Windows Vista Service Pack 1 および Windows Vista Service Pack 2                                              | [![](../../images/Dn636446.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=84629c25-7827-40c1-86fb-7ffa247202a0&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                   |
| Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2                      | [![](../../images/Dn636446.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=36e2a74b-e5c6-47d5-9cd9-b9171be63c7d&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                   |
| Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2\*\*       | [![](../../images/Dn636446.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=fdfc393e-a54d-44dd-ba45-c2a550ffd2a1&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                   |
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2\*\* | [![](../../images/Dn636446.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=1b7af424-6286-4a80-827c-c4df4f92fe43&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                   |
...
<th style="border:1px solid black;" >MPEG-4 コーデックの脆弱性 - <a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0818">CVE-2010-0818</a></th>
...
MPEG-4 コーデックの脆弱性 - CVE-2010-0818  
-----------------------------------------
  
<span></span>
MPEG-4 コーデックをサポートしているフォーマット ファイルを処理する方法に、リモートでコードが実行される脆弱性が存在します。この脆弱性により、特別に細工されたメディア ファイルをユーザーが開いた場合に、リモートでコードが実行される可能性があります。ユーザーが管理者ユーザー権限でログオンしている場合、攻撃者はこの脆弱性を悪用して、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。システムで、アカウントのユーザー権限を低く設定している場合、管理者ユーザー権限で実行しているユーザーよりもこの脆弱性の影響が少なくなると考えられます。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-0818](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0818) をご覧ください。
  
#### 「MPEG-4 コーデックの脆弱性」の問題を緩和する要素 - CVE-2010-0818:
...
#### 「MPEG-4 コーデックの脆弱性」の回避策 - CVE-2010-0818:
  
回避策は、設定または構成の変更を示しており、基本的な脆弱性を正すものではありませんが、更新プログラムを適用する前に既知の攻撃方法を阻止するのに役立ちます。マイクロソフトは、以下の回避策を検証し、この回避策が機能性を低下させるかどうかについて、説明の部分で述べています。
  
-   **MP4S コーデックへのアクセスを制限する**
  
    MPEG-4 コーデックへのアクセスを制限するためには、次を行います。
    ...
    **注:** レジストリ エディターの不正確な使用は、オペレーティング システムの再インストールが必要となる深刻な問題の原因となる可能性があります。マイクロソフトはレジストリ エディターを正しく使用しなかったことが原因となる問題について保証することはできません。レジストリ エディターは、お客様各自の責任において使用してください。レジストリの編集方法に関する情報は、レジストリ エディター (Regedit.exe) の "キーおよび値を変更する" ヘルプ トピックをご覧ください。または Regedt32.exe の "レジストリ情報の追加と削除" および "レジストリ情報の編集" ヘルプ トピックをご覧ください。
    ...
    1.  次のコマンドが含まれている管理された適用スクリプトを使用して、レジストリ キーのバックアップ コピーを作成します:
        ...
        `Regedit.exe /e MPEG-4_Backup1.reg "HKEY_CLASSES_ROOT\CLSID\{82CCD3E0-F71A-11D0-9FE5-00609778EA66}"Regedit.exe /e MPEG-4_Backup2.reg "HKEY_CLASSES_ROOT\CLSID\{2a11bae2-fe6e-4249-864b-9e9ed6e8dbc2}"`
  
        **注:** コンピューターにインストールされている MPEG-4 コーデックのバージョンにより、上記のレジストリ キーで存在しないものがあります。コンピューターで存在しないレジストリ キーについてのバックアップ ファイルは作成されません。
  
    2.  Restrict\_MPEG-4\_Workaround.reg のように .REG 拡張子を付けたファイルに次を保存します。
  
        `Windows Registry Editor Version 5.00[-HKEY_CLASSES_ROOT\CLSID\{82CCD3E0-F71A-11D0-9FE5-00609778EA66}][-HKEY_CLASSES_ROOT\CLSID\{2a11bae2-fe6e-4249-864b-9e9ed6e8dbc2}]`
  
    3.  昇格されたコマンド プロンプトから次のコマンドを実行して、対象となるコンピューターで上記のレジストリ スクリプトを実行します:
  
        **32 ビット版の Windows システム:**
  
        `Regedit.exe /s Restrict_MPEG-4_Workaround.reg`
  
    **回避策の影響** **:** MPEG-4 バージョン 1 フォーマットでエンコードされたファイルが Windows Media Player などの MPEG-4 コーデックを使用するアプリケーションで再生されなくなります。
  
    **回避策の解除方法** **:** 次のコマンドを実行することにより、元の状態を復元します。
  
    **注:** 上記のレジストリ バックアップ ファイルで存在しないものがある場合があります。この回避策を実装する前にコンピューターに存在していなかったレジストリ キーについてのバックアップ ファイルは作成されませんでした。
  
#### 「MPEG-4 コーデックの脆弱性」のよく寄せられる質問 - CVE-2010-0818:
...
**何が原因で起こりますか?**  
Windows Media コーデックに含まれている MPEG-4 コーデックが特別な細工がされたメディア ファイルを適切に処理しないため、この脆弱性が起こります。
  
**どの MPEG-4 コーデックに脆弱性の影響を受けるコードが含まれていますか?**  
MPEG-4 は、圧縮、オーサリング、配信などのマルチメディア プレゼンテーションの多くの側面を網羅する International Standards Organization (ISO) の仕様です。MPEG-4 ビデオ デコードに使用されている MPEG-4 コーデックにこの脆弱性の影響を受けるコードが含まれます。
...
コーデックは、エンコーダーおよびデコーダーの 2 つのコンポーネントで構成されています。エンコーダーは、圧縮 (エンコード) 機能を実行し、デコーダーは圧縮解除 (デコード) 機能を実行します。これらのコンポーネントが含まれるコーデックと、ひとつだけ含まれるコーデックがあります。例えば、オーディオ CD からコンピューターに楽曲を転送する場合に、Windows Media Player が Windows Media オーディオ コーデックを既定で使用し、楽曲をコンパクト WMA ファイルに圧縮します。WMA ファイル (または Web サイトからストリームされたすべての WMA ファイル) を再生する 場合、プレーヤーは Windows Media Audio コーデックを使用してファイルを展開し、音楽をスピーカーを通じて再生できます。
...
電子メールでの攻撃のシナリオでは、攻撃者は特別な細工がされた MPEG-4 ファイルが埋め込まれたメディア ファイルをユーザーに送信し、ユーザーにそのファイルを開くよう誘導することにより、この脆弱性を悪用する可能性があります。
  
攻撃者は、インターネット ブラウザーを介してこの脆弱性を悪用するように設計された特別な細工がされたメディア コンテンツをホストする Web サイトをホストし、ユーザーを誘導してその Web サイトを表示させ、そのメディア コンテンツを開かせる可能性があります。
  
**主にどのようなコンピューターがこの脆弱性による危険にさらされますか?**  
影響を受けるソフトウェアを実行しているコンピューターが主にこの脆弱性による危険にさらされます。
  
**この更新プログラムはどのように問題を修正しますか?**  
このセキュリティ更新プログラムは MPEG-4 コーデックが特別な細工がされたメディア コンテンツを処理する方法を変更することにより、この脆弱性を解決します。
...
WindowsXP-WindowsMedia-KB975558-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsXP-SP2-X64-WindowsMedia-KB975558-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
WindowsXP-WindowsMedia-KB975558-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsXP-SP2-X64-WindowsMedia-KB975558-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB975558$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Media Player\\KB975558\_WM8  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Media Player\\SP0\\KB975558\_WM8
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
|--------------|----------------|------------|-------|---------|------------|
| Mp4sds32.ax  | 8.0.0.406      | 2010/04/05 | 13:31 | 241,664 | v8dme      |
| Mpg4ds32.ax  | 8.0.0.4504     | 2010/03/30 | 00:52 | 262,416 | wm8        |
| Mp4sdmod.dll | 9.0.0.4509     | 2010/04/05 | 11:54 | 384,512 | wm9        |
| Mp4sdmod.dll | 10.0.0.3706    | 2010/04/01 | 04:45 | 387,944 | wm10       |
| Mp4sdecd.dll | 11.0.5721.5274 | 2010/03/30 | 12:24 | 317,440 | wm11       |
...
| Mp4sds32.ax  | 8.0.0.406      | 2010/04/05 | 13:31 | 241,664 | v8dme      |
| Mpg4ds32.ax  | 8.0.0.4504     | 2010/03/30 | 00:52 | 262,416 | wm8        |
| Mp4sdmod.dll | 10.0.0.4007    | 2010/04/01 | 16:04 | 385,536 | wm10       |
| Mp4sdecd.dll | 11.0.5721.5274 | 2010/03/30 | 12:24 | 317,440 | wm11       |
...
Windows2003-SP2-WindowsMedia-KB975558-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
Windows2003-SP2-WindowsMedia-KB975558-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Vista:  
Windows6.0-KB975558-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows Vista:  
Windows6.0-KB975558-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
|--------------|-----------------|------------|-------|---------|
| Mp4sdecd.dll | 11.0.6001.7009  | 2010/04/06 | 01:08 | 317,952 |
| Mp4sdecd.dll | 11.0.6001.7117  | 2010/04/06 | 01:30 | 317,952 |
| Mp4sdecd.dll | 11.0.6002.18236 | 2010/04/06 | 02:02 | 317,952 |
| Mp4sdecd.dll | 11.0.6002.22377 | 2010/04/06 | 02:16 | 317,952 |

サポートされているすべての x64 エディションの Windows Vista:

| ファイル名   | バージョン      | 日付       | 時間  | サイズ  | CPU |
|--------------|-----------------|------------|-------|---------|-----|
| Mp4sdecd.dll | 11.0.6001.7009  | 2010/04/06 | 01:53 | 295,424 | x64 |
| Mp4sdecd.dll | 11.0.6001.7117  | 2010/04/06 | 01:40 | 295,424 | x64 |
| Mp4sdecd.dll | 11.0.6002.18236 | 2010/04/06 | 02:33 | 295,424 | x64 |
| Mp4sdecd.dll | 11.0.6002.22377 | 2010/04/06 | 02:13 | 295,424 | x64 |
| Mp4sdecd.dll | 11.0.6001.7009  | 2010/04/06 | 01:08 | 317,952 | x86 |
| Mp4sdecd.dll | 11.0.6001.7117  | 2010/04/06 | 01:30 | 317,952 | x86 |
| Mp4sdecd.dll | 11.0.6002.18236 | 2010/04/06 | 02:02 | 317,952 | x86 |
| Mp4sdecd.dll | 11.0.6002.22377 | 2010/04/06 | 02:16 | 317,952 | x86 |
...
-   「MPEG-4 コーデックの脆弱性」 - [CVE-2010-0818](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0818) の 問題を報告してくださった [Sourcefire VRT](http://www.sourcefire.com/services/sf_vrt.html) の Matthew Watchinski 氏
...
-   2010/09/16: Windows XP および Windows Server 2003 のファイル情報を正しいフォルダー名に修正しました。
