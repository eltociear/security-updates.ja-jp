...
[](http://www.microsoft.com/japan/security/bulletins/ms10-101e.mspx)[![](../../images/Dn636485.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
US マイクロソフトセキュリティ情報: [http://www.microsoft.com/technet/security/bulletin/MS10-101.mspx](http://technet.microsoft.com/security/bulletin/ms10-101)
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ad843b97-2f6e-4406-a17a-627b7db8a926&amp;displaylang=ja"><img src="../../images/Dn636485.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=0b0a06e7-0ae5-41f4-9ff5-d524fc0afbfa&amp;displaylang=ja"><img src="../../images/Dn636485.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">サービス拒否</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7c0c2850-e81d-4347-aeb3-47036caa7c1b&amp;displaylang=ja"><img src="../../images/Dn636485.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">サービス拒否</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6793f75b-cdf4-42ef-a53e-a1acb5b662d1&amp;displaylang=ja"><img src="../../images/Dn636485.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">サービス拒否</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=85add876-ca5a-4a92-984e-188a72e349fc&amp;displaylang=ja"><img src="../../images/Dn636485.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">サービス拒否</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=d7307afd-84a0-434e-9658-bf9f8ae4b938&amp;displaylang=ja"><img src="../../images/Dn636485.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">サービス拒否</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<th style="border:1px solid black;" >Netlogon RPC Null の逆参照の DOS の脆弱性 - <a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2742">CVE-2010-2742</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-2742](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2742) をご覧ください。
...
Netlogon RPC とは何ですか?  
Netlogon リモート プロトコルは リモート プロシージャ コール (RPC) のインターフェイスで、ドメインベースのネットワークでユーザーとマシンの認証に使用されます。Netlogon RPC の詳細情報は、MSDN の記事 [Netlogon Remote Protocol Specification](http://msdn.microsoft.com/library/cc237009(v=prot.10).aspx) (英語情報) をご覧ください。
...
<td style="border:1px solid black;">
サポート技術情報 [2207559](http://support.microsoft.com/kb/2207559) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
-   「Netlogon RPC Null の逆参照の DOS の脆弱性」 - [CVE-2010-2742](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2742) の 問題を報告してくださった The Samba Team の Matthias Dieter Wallnöfer 氏および Andrew Bartlett 氏
