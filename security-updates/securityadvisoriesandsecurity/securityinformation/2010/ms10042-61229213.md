...
[](http://www.microsoft.com/japan/security/bulletins/ms10-042e.mspx)[![](../../images/Dn636425.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
このセキュリティ更新プログラムは、最初に[マイクロソフト セキュリティ アドバイザリ 2219475](http://technet.microsoft.com/security/advisory/2219475) で説明した脆弱性についても解決します。
...
**US** **マイクロソフトセキュリティ情報:** [http://www.microsoft.com/technet/security/bulletin/MS10-042.mspx](http://technet.microsoft.com/security/bulletin/ms10-042)
...
|------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Windows XP Service Pack 2 および Windows XP Service Pack 3 | [![](../../images/Dn636425.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=7c2122bb-0ecf-4467-a3ba-6fb862f603c5&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows XP Professional x64 Edition Service Pack 2         | [![](../../images/Dn636425.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=9232a336-9ded-4820-bac4-2d68877ee76c&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Server 2003 Service Pack 2                         | [![](../../images/Dn636425.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=cd4363b2-d7a7-4fff-8bcd-6fd02bd1ac07&displaylang=ja) | リモートでコードが実行される | 注意           | なし                                                     |
| Windows Server 2003 x64 Edition Service Pack 2             | [![](../../images/Dn636425.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=a6bafd3b-c921-466d-bee0-59a3fe126712&displaylang=ja) | リモートでコードが実行される | 注意           | なし                                                     |
| Windows Server 2003 with SP2 for Itanium-based Systems     | [![](../../images/Dn636425.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=b61cc2d5-8432-4681-aa2c-a8807ec1fcf4&displaylang=ja) | リモートでコードが実行される | 注意           | なし                                                     |
...
<th style="border:1px solid black;" >ヘルプ センターの URL の検証の脆弱性 - <a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1885">CVE-2010-1885</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-1885](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1885) をご覧ください。
...
-   **HCP プロトコルの登録を解除する**
    ...
    **注:** 自動化された “Microsoft Fix it” ソリューションを使用してこの回避策を有効または無効にするには、サポート技術情報 [2229593](http://support.microsoft.com/kb/2229593) をご覧ください。
...
**URI とは何ですか?**  
Uniform Resource Identifier (URI) とは、インターネットやネットワークのリソースの操作または識別を行うために使用される文字列です。URL は Web サイトなどのリソースを参照する URI の典型的な例です。URI に関する詳細は、[RFC-2396](http://www.ietf.org/rfc/rfc2396.txt) (英語情報) をご覧ください。
...
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2010-1885](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1885) にアサインされています。  
この脆弱性はマイクロソフト セキュリティ アドバイザリ [2219475](http://technet.microsoft.com/security/advisory/2219475) で最初に説明されました。
