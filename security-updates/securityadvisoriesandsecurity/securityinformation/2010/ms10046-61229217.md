...
[](http://www.microsoft.com/japan/security/bulletins/ms10-046e.mspx)[![](../../images/Dn636429.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
このセキュリティ更新プログラムは、最初に[マイクロソフト セキュリティ アドバイザリ 2286198](http://technet.microsoft.com/security/advisory/2286198) で説明した脆弱性を解決します。
...
**US** **マイクロソフトセキュリティ情報:** [http://www.microsoft.com/technet/security/bulletin/MS10-046.mspx](http://technet.microsoft.com/security/bulletin/ms10-046)
...
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|---------------------------------------------------------------------|
| Windows XP Service Pack 3                                                                                         | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=12361875-b453-45e8-852b-90f2727894fd&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                                |
| Windows XP Professional x64 Edition Service Pack 2                                                                | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=3b44bd67-48e2-497f-9165-42a702e2cc0d&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS07-061](http://technet.microsoft.com/security/bulletin/ms07-061) |
| Windows Server 2003 Service Pack 2                                                                                | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=32fe91ef-5a8d-4095-90ee-2ca216696b09&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS07-061](http://technet.microsoft.com/security/bulletin/ms07-061) |
| Windows Server 2003 x64 Edition Service Pack 2                                                                    | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=923de214-c4fa-41e6-8307-2c5a37f13e8e&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS07-061](http://technet.microsoft.com/security/bulletin/ms07-061) |
| Windows Server 2003 with SP2 for Itanium-based Systems                                                            | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=63aa5f8a-fe47-4892-b905-b54e4f3b6580&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS07-061](http://technet.microsoft.com/security/bulletin/ms07-061) |
| Windows Vista Service Pack 1 および Windows Vista Service Pack 2                                                  | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=52748886-6280-4247-8cbd-f64db229ee66&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                                |
| Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2                          | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=37648e95-05c2-4802-9a0f-660200baa229&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                                |
| Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2\*             | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=3aabd189-7d4c-4c9f-8854-f33127b1c309&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                                |
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2\*       | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=29c6fc2d-d318-4a63-9ab2-82e84272aaf2&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                                |
| Windows Server 2008 for Itanium-based Systems および Windows Server 2008 for Itanium-based Systems Service Pack 2 | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=cfe227b5-6660-49f8-9d71-a997dd83de0b&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                                |
| Windows 7 for 32-bit Systems                                                                                      | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=22e62b5c-e4c1-47d0-ae4a-8bd2d70d0a0a&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                                |
| Windows 7 for x64-based Systems                                                                                   | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=9499f771-c388-4de3-a5c7-8cc8b00b4395&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                                |
| Windows Server 2008 R2 for x64-based Systems\*                                                                    | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=0d9dd09b-db40-462b-88b0-4dbb8180e81f&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                                |
| Windows Server 2008 R2 for Itanium-based Systems                                                                  | [![](../../images/Dn636429.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=ce2bb5d4-f661-44e3-ac28-0b81f7b72670&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                                |
...
<th style="border:1px solid black;" >ショートカット アイコンの読み込みの脆弱性 - <a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568">CVE-2010-2568</a></th>
...
<span></span>
影響を受けるバージョンの Microsoft Windows に、リモートでコードが実行される脆弱性が存在します。オペレーティング システムが悪意のあるショートカット ファイルのアイコンを表示する際に、Windows がショートカットを正確に解析しないために、悪質なコードが実行される脆弱性が存在します。攻撃者がこの脆弱性を悪用した場合、ログオン ユーザーとして任意のコードを実行する可能性があります。この更新プログラムは以前にマイクロソフト セキュリティ アドバイザリ [2286198](http://technet.microsoft.com/security/advisory/2286198) で説明した脆弱性を解決します。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-2568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568) をご覧ください。
...
-   **ショートカット用アイコンの表示を無効にする**
    ...
    注: 自動化された “Microsoft Fix it” ソリューションを使用してこの回避策を有効または無効にするには、サポート技術情報 [2286198](http://support.microsoft.com/kb/2286198) をご覧ください。この “Microsoft Fix it” ソリューションは、再起動して完全に有効にする必要があります。この “Microsoft Fix it” ソリューションは、回避策を展開するために、ユーザーに対する同様の影響があります。マイクロソフトは、管理者が詳細にサポート技術情報を確認して、この “Microsoft Fix it” ソリューションを展開することを推奨します。
...
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2010-2568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568) にアサインされています。
...
注: wusa.exe インストーラーに関する詳細情報は、[Windows 7 でのその他の変更](http://technet.microsoft.com/ja-jp/library/dd871148(ws.10).aspx)の「Windows Update スタンドアロン インストーラー」をご覧ください。
...
注: wusa.exe インストーラに関する詳細情報は、[Windows 7 でのその他の変更](http://technet.microsoft.com/ja-jp/library/dd871148(ws.10).aspx)の「Windows Update スタンドアロン インストーラー」をご覧ください。
...
-   ショートカット アイコンの読み込みの脆弱性 [CVE-2010-2568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568) を報告してくださった [VirusBlokAda](http://www.vba.com.by/) の Sergey I. Ulasen 氏 および Oleg Kupreev 氏
-   ショートカット アイコンの読み込みの脆弱性 [CVE-2010-2568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568) を報告してくださった [AV-Test](http://www.av-test.org/) の Andreas Marx 氏 および Maik Morgenstern 氏
-   ショートカット アイコンの読み込みの脆弱性 [CVE-2010-2568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568) についてマイクロソフトと協力してくださった [CERT/CC](http://www.cert.org/) の Will Dormann 氏
-   ショートカット アイコンの読み込みの脆弱性 [CVE-2010-2568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568) についてマイクロソフトと協力してくださった Niels Teusink 氏
-   ショートカット アイコンの読み込みの脆弱性 [CVE-2010-2568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568) についてマイクロソフトと協力してくださった Stefan Kanthak 氏
