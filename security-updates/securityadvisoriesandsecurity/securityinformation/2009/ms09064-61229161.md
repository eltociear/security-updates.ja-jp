...
[](http://www.microsoft.com/japan/security/bulletins/ms09-064e.mspx)[![](../../images/Dn627147.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
**US** **マイクロソフトセキュリティ情報:** [http://www.microsoft.com/technet/security/bulletin/MS09-064.mspx](http://technet.microsoft.com/security/bulletin/ms09-064)
...
|----------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Microsoft Windows 2000 Server Service Pack 4 | [![](../../images/Dn627147.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=365a8dff-2383-42f6-b567-e545461fd135&displaylang=ja) | [![](../../images/Dn627147.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=365a8dff-2383-42f6-b567-e545461fd135&amp;displaylang=ja-nec) | リモートでコードが実行される | 緊急           | なし                                                     |
...
<th style="border:1px solid black;" >ライセンス ログ サーバーのヒープ オーバーフローの脆弱性 - <a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2523">CVE-2009-2523</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2009-2523](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2523) をご覧ください。
...
-   **ライセンス ログ サービスを無効にする**
    ...
    **回避策の影響** **:** ライセンス ログ サービスが無効となっている場合、明示的にライセンス ログ サービスに依存しているサービスはシステム イベント ログにエラー メッセージのログの記録を行う可能性があります。詳細は、サポート技術情報 [316631](http://support.microsoft.com/kb/316631) をご覧ください。
...
-   「ライセンス ログ サーバーのヒープ オーバーフローの脆弱性」 - [CVE-2009-2523](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2523) の 問題を報告してくださった [TippingPoint DVLabs](http://dvlabs.tippingpoint.com/) の Cody Pierce 氏
