...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|--------------------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=7da5b341-6a6f-46de-8d01-448da38e9908)                                                                                            | サービス拒否           | 警告           | なし                                                   |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=1ba25d9c-0fef-471f-8e30-045fe9586a9c)                                                                                | サービス拒否           | 警告           | なし                                                   |
| [Windows Server 2008 for 32-bit Systems Service Pack 2](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=45a4784e-5051-4628-9a19-d53f30c1fdf3)\*\*                                                               | サービス拒否           | 警告           | なし                                                   |
| [Windows Server 2008 for x64-based Systems Service Pack 2](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=503cb9c0-d6db-4deb-a555-67af0b25739b)\*\*                                                            | サービス拒否           | 警告           | なし                                                   |
| [Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=f3a14012-38ae-490e-a48e-7c851f82a7e6)                                         | サービス拒否           | 警告           | なし                                                   |
| [Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=760b5aa4-4e65-4ff1-9ae2-771234803bf0)                                   | サービス拒否           | 警告           | なし                                                   |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=86095b20-5869-4b55-8777-ee0af82aaf37)\*\*     | サービス拒否           | 警告           | なし                                                   |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=dc5c336f-329c-4a56-8b24-555e3c8afd50) | サービス拒否           | 警告           | なし                                                   |
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0156](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0156) を参照してください。
...
DirectWrite とは 何ですか?   
DirectWrite は、解像度に依存しないマルチ形式のフル Unicode テキスト レンダリング API で、テキストの測定、描画およびヒットテストに対応しています。DirectWrite の詳細については、MSDN の記事 [Introducing DirectWrite](http://msdn.microsoft.com/en-us/library/windows/desktop/dd371554(v=vs.85).aspx) (英語情報) を参照してください。
...
はい。この脆弱性は一般で公開されていました。これは Common Vulnerability and Exposure の番号 [CVE-2012-0156](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0156) が割り当てられています。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2665364/ja">サポート技術情報 2665364</a> を参照してください。</td>
</tr>
<tr class="odd">
