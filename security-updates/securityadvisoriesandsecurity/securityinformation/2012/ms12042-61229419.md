...
<td style="border:1px solid black;">
[MS11-098](http://go.microsoft.com/fwlink/?linkid=232424) の KB2633171 は KB2707511 に置き換えられる
</td>
</tr>
...
<td style="border:1px solid black;">
[MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) の KB2556532 は KB2709715 に置き換えられる
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0217](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0217) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1515](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515) を参照してください。
...
このセキュリティ情報の公開時に、この脆弱性は一般に知られていましたか? 
はい。この脆弱性は一般で公開されていました。これは Common Vulnerability and Exposure の番号 [CVE-2012-1515](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515) が割り当てられています。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2707511/ja">マイクロソフト サポート技術情報 2707511</a> を参照してください。</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2709715/ja">マイクロソフト サポート技術情報 2709715</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">レジストリ キーの確認</td>
...
-   ユーザー モード スケジューラーのメモリ破損の脆弱性 (CVE-2012-0217) を報告してくださった [Bromium](http://www.bromium.com/) の Rafal Wojtczuk 氏および [SUSE](http://www.suse.com/) の Jan Beulich 氏
