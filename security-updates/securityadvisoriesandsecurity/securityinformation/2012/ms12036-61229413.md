...
<td style="border:1px solid black;">
[MS12-020](http://go.microsoft.com/fwlink/?linkid=232664) の KB2621440 は、KB2685939 に置き換えられる
</td>
</tr>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0173](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0173) を参照してください。
...
-   サポートされるエディションの Windows Vista、Windows 7、Windows Server 2008、Windows Server 2008 R2 が実行されているシステムでネットワーク レベル認証を有効化する
    ...
      
    注: 自動化された Microsoft Fix It ソリューションを使用してこの回避策を有効にする方法については、[サポート技術情報 2685939](http://support.microsoft.com/kb/2685939/ja) を参照してください。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2685939/ja">マイクロソフト サポート技術情報 2685939</a> を参照してください。</td>
</tr>
<tr class="even">
