...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|--------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=feaeda8c-84ee-47be-8c68-736f0e5b1fc7%20)                           | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=211827f2-fe6a-4e16-a90c-0cc3b60a722d)     | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=b8e46267-7988-4fbe-ae94-68b6fdb2e7d9)                     | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=5975b01e-139b-4b9d-a0d5-a87a279bfea1)         | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2003 with SP2 for Itanium-based Systems](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=26079c35-4b96-42fc-ad47-138be25a6bf0) | リモートでコードが実行される | 重要           | なし                                                   |
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0009](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0009) を参照してください。
...
Windows オブジェクト パッケージャーは、ファイルに挿入可能なパッケージを作成するために使用できるツールです。オブジェクト パッケージャーの詳細については、[Microsoft Product Documentation](http://www.microsoft.com/resources/documentation/windows/xp/all/proddocs/en-us/packager_what_is_obj_pkg.mspx?mfr=true) (英語情報) を参照してください。
