...
<td style="border:1px solid black;">
[MS12-018](http://go.microsoft.com/fwlink/?linkid=235364) の KB2641653 は、KB2709162 に置き換えられる
</td>
</tr>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1864](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1864) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1865](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1865) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1866](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1866) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1867](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1867) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1868) を参照してください。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2709162/ja">マイクロソフト サポート技術情報 2709162</a> を参照してください。</td>
</tr>
<tr class="even">
...
-   文字列アトム クラス名の処理の脆弱性 (CVE-2012-1864) の問題を報告してくださった [Azimuth Security](http://www.azimuthsecurity.com/) の Tarjei Mandt 氏  
-   Win32k.sys 競合状態の脆弱性 (CVE-2012-1865) の問題を報告してくださった [Azimuth Security](http://www.azimuthsecurity.com/) の Tarjei Mandt 氏  
-   クリップボード形式アトム名の処理の脆弱性 (CVE-2012-1866) の問題を報告してくださった [Azimuth Security](http://www.azimuthsecurity.com/) の Tarjei Mandt 氏  
-   フォント リソース参照カウントの整数オーバーフローの脆弱性 (CVE-2012-1867) の問題を報告してくださった [Google Inc.](http://www.google.com) の [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org) 氏
