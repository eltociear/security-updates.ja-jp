...
このセキュリティ更新プログラムは、Microsoft Exchange Server の影響を受けるエディションに対し、最初に[マイクロソフト セキュリティ アドバイザリ 2737111](http://technet.microsoft.com/ja-jp/security/advisory/2737111) で説明されている脆弱性も解決します。
...
WebReady ドキュメント表示を無効にする[マイクロソフト セキュリティ アドバイザリ 2737111](http://technet.microsoft.com/ja-jp/security/advisory/2737111) の回避策をすでに実行しているお客様は、この更新プログラムの適用前に回避策を解除する必要はありません。しかし、WebReady ドキュメント表示機能を再度有効にするためには、更新プログラムの適用後に回避策の解除が必要になる場合があります。
...
-   Exchange Server 2007 Service Pack 3 (KB2756497) 用の更新プログラムのロールアップ 8 については、[マイクロソフト サポート技術情報 2756497](http://support.microsoft.com/kb/2756497/ja) を参照してください。
-   Exchange 2010 Service Pack 1 (KB2756496) 用の更新プログラムのロールアップ 7 については、[サポート技術情報 2756496](http://support.microsoft.com/kb/2756496/ja) を参照してください。
-   Exchange 2010 Service Pack 2 (KB2756485) 用の更新プログラムのロールアップ 4 については、[サポート技術情報 2756485](http://support.microsoft.com/kb/2756485/ja) を参照してください。

ファイル情報の詳細はどこにありますか? 
ファイル情報の詳細の場所については、「セキュリティ更新プログラムの展開」の参照表を参照してください。

セキュリティ 更新プログラムのハッシュはどこにありますか? 
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの詳細については、[サポート技術情報 2740358](http://support.microsoft.com/kb/2740358/ja) を参照してください。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2740358/ja">マイクロソフト サポート技術情報 2740358</a> を参照してください。</td>
</tr>
<tr class="even">
