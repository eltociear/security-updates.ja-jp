...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2549) を参照してください。
...
-   失効したクライアント証明書に関連付けられているドメイン コンピューター アカウントを無効にする 。
    ...
    Windows Server 2008 R2 および Windows Server 2012 でコンピューター アカウントを無効にする方法については、「[コンピューター アカウントを無効または有効にする](http://technet.microsoft.com/ja-jp/library/cc732965.aspx)」を参照してください。

    スクリプトを使用して複数のコンピューター アカウントを無効にする方法については、「[Disable Computer Accounts](http://gallery.technet.microsoft.com/scriptcenter/ac6c44dd-db2f-487a-a51f-3ecb69b9386c)」(英語情報) を参照してください。
...
IP-HTTPS とは何ですか?  
IP over HTTPS (IP-HTTPS) は、セキュリティで保護された HTTP 接続を使用して、セキュリティで保護された IP トンネルを構築できるようにするプロトコルです。このプロトコルは、Microsoft DirectAccess の展開で一般的に使用されます。詳細については、「[IP over HTTPS (IP-HTTPS) Tunneling Protocol](http://msdn.microsoft.com/ja-jp/library/dd358571(v=prot.20).aspx)」(英語情報) を参照してください。

DirectAccess とは何ですか?  
Windows 7 および Windows Server 2008 R2 オペレーティング システムで導入された DirectAccess を使用すると、リモート ユーザーは IP-HTTPS のようなセキュリティで保護されたプロトコルを使用して、エンタープライズの共有、Web サイト、およびアプリケーションに安全にアクセスできます。詳細については、「[DirectAccess](http://technet.microsoft.com/ja-jp/network/dd420463.aspx)」(英語情報) を参照してください。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2765809/ja">サポート技術情報 KB2765809</a> を参照してください。</td>
</tr>
<tr class="odd">
