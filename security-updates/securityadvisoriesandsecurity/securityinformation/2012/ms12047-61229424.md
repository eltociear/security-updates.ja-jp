...
<td style="border:1px solid black;">
[MS12-041](http://go.microsoft.com/fwlink/?linkid=251707) の KB2709162 は KB2718523 に置き換えられます。
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 for 32-bit Systems Service Pack 2](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=ed201422-7c65-4c20-a825-8cecab1aeebc) (Server Core インストール)  
(KB2718523)
</td>
<td style="border:1px solid black;">
特権の昇格
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 for x64-based Systems Service Pack 2](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=8e1a27c9-6495-4030-8a46-264afd78a5a1) (Server Core インストール)  
(KB2718523)
</td>
<td style="border:1px solid black;">
特権の昇格
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 for x64-based Systems](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (Server Core インストール)  
(KB2718523)
</td>
<td style="border:1px solid black;">
特権の昇格
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 for x64-based Systems Service Pack 1](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (Server Core インストール)  
(KB2718523)
</td>
<td style="border:1px solid black;">
特権の昇格
...
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの詳細については、[サポート技術情報 2718523](http://support.microsoft.com/kb/2718523/ja) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890) を参照してください。
...
はい。この脆弱性は一般で公開されていました。これは Common Vulnerability and Exposure の番号 [CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890) が割り当てられています。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1893](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1893) を参照してください。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2718523/ja">サポート技術情報 2718523</a> を参照してください。</td>
</tr>
<tr class="even">
...
-   「キーボードのレイアウトの脆弱性 (CVE-2012-1890)」を報告してくださった [Core Security Technologies](http://www.coresecurity.com/) の Nicolas Economou 氏  
-   「キーボードのレイアウトの脆弱性 (CVE-2012-1890)」を報告してくださった [Qihoo 360 Security Center](http://www.360.cn/)  
-   [Secunia Research](http://secunia.com/) にご協力いただき、「Win32k の誤った型処理の脆弱性 (CVE-2012-1893)」を報告してくださった Neusoft Corporation の Lufeng Li 氏
