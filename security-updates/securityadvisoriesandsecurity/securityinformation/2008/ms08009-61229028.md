...
[](http://www.microsoft.com/japan/security/bulletins/ms08-009e.mspx)
...
**US** **マイクロソフトセキュリティ情報:** [http://www.microsoft.com/technet/security/bulletin/MS08-009.mspx](http://technet.microsoft.com/security/bulletin/ms08-009)
...
(KB943990)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a513069b-8244-48e9-b136-01ddd3862802&amp;displaylang=ja"><img src="../../images/Dn610202.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
(KB943957)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=78c338aa-e410-4422-9e36-562f70d742e9&amp;displaylang=ja"><img src="../../images/Dn610202.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
...
(KB943983)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=85cb1aa5-211f-4652-827b-2e79b8ffc2fc&amp;displaylang=ja"><img src="../../images/Dn610202.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=fd4ddecd-abd6-4783-b300-32b9d4bad22a&amp;displaylang=ja"><img src="../../images/Dn610202.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms07-024">MS07-024</a></td>
</tr>
...
<th style="border:1px solid black;" >Word のメモリ破損の脆弱性 - <a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0109"><strong>CVE-2008-0109</strong></a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-0109](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0109) をご覧ください。
...
<td style="border:1px solid black;">
完全なファイル マニフェストについては、このセクション内のサブセクション「ファイル情報」、または、マイクロソフト サポート技術情報 [940602](http://support.microsoft.com/kb/940602) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
-   「Word のメモリ破損の脆弱性」 - [CVE-2008-0109](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0109) の 問題を報告してくださった Rubén Santamarta 氏
