---
TOCTitle: 'MS08-007'
Title: 'マイクロソフト セキュリティ情報 MS08-007 - 緊急'
ms:assetid: 'ms08-007'
ms:contentKeyID: 61229026
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms08-007(v=Security.10)'
---
...
[](http://www.microsoft.com/japan/security/bulletins/ms08-007e.mspx)
...
**US** **マイクロソフトセキュリティ情報:** [http://www.microsoft.com/technet/security/bulletin/MS08-007.mspx](http://technet.microsoft.com/security/bulletin/ms08-007)
...
![](../../images/Dn610200.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、PC/AT 互換機用の更新プログラムをダウンロードしてください。
更新プログラムをダウンロードおよびインストールする方法は、[更新プログラムのダウンロード方法](http://www.microsoft.com/japan/security/bulletins/dcsteps_vista.mspx)および[更新プログラムのインストール方法](http://www.microsoft.com/japan/security/bulletins/instsecupdate_vista.mspx)をご覧ください。

| オペレーティング システム/ソフトウェア                                                                               | PC/AT                                                                                                                                                                                             | 最も深刻な脆弱性の影響       | 総合的な深刻度 | この更新プログラムによって置き換えられるセキュリティ情報 |
|----------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|----------------------------------------------------------|
| Windows XP Service Pack 2                                                                                            | [![](../../images/Dn610200.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=afeef3ec-6160-4c1d-94bd-0bfce641d0a2&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows XP Professional x64 Edition および Windows XP Professional x64 Edition Service Pack 2                        | [![](../../images/Dn610200.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=15b7d1c4-4ef4-47b2-9e3b-22eafbdb90d8&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Server 2003 Service Pack 1 および Windows Server 2003 Service Pack 2                                         | [![](../../images/Dn610200.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=b7e725bf-7248-4119-aca5-b7d502c09cfc&displaylang=ja) | リモートでコードが実行される | 重要           | なし                                                     |
| Windows Server 2003 x64 Edition および Windows Server 2003 x64 Edition Service Pack 2                                | [![](../../images/Dn610200.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=8af82f86-731c-46a0-a025-b62447e2af38&displaylang=ja) | リモートでコードが実行される | 重要           | なし                                                     |
| Windows Server 2003 with SP1 for Itanium-based Systems および Windows Server 2003 with SP2 for Itanium-based Systems | [![](../../images/Dn610200.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=bca224db-fe0e-411d-a948-1c776ce974f3&displaylang=ja) | リモートでコードが実行される | 重要           | なし                                                     |
| Windows Vista                                                                                                        | [![](../../images/Dn610200.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=ba7a2b42-1c89-45e5-b8a6-049fa500c03a&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
| Windows Vista x64 Edition                                                                                            | [![](../../images/Dn610200.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=45962232-af78-42cb-bfa0-9ce7de199585&displaylang=ja) | リモートでコードが実行される | 緊急           | なし                                                     |
...
<th style="border:1px solid black;" >Mini-Redirector のヒープ オーバーフローの脆弱性- <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0080">CVE-2008-0080</a></th>
...
<span></span>
リモートでコードが実行される脆弱性が、WEBDAV Mini-Redirector が応答を処理する方法に存在します。攻撃者によりこの脆弱性が悪用された場合、影響を受けるコンピュータが完全に制御される可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2008-0080](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0080) をご覧ください。
  
#### 「Mini-Redirector のヒープ オーバーフローの脆弱性」の問題を緩和する要素 - CVE-2008-0080
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   Web Client サービスは Windows Server 2003 では既定で無効となっています。
  
#### 「Mini-Redirector のヒープ オーバーフローの脆弱性」の回避策 - CVE-2008-0080
  
回避策は、設定または構成の変更を示しており、基本的な脆弱性を正すものではありませんが、更新プログラムを適用する前に既知の攻撃方法を阻止するのに役立ちます。マイクロソフトは、以下の回避策を検証し、この回避策が機能性を低下させるかどうかについて、説明の部分で述べています。
  
-   **WebClient** **サービスを無効にします**
  
    WebClient サービスを無効にするために、次のステップを行ってください。
  
    1.  \[スタート\] メニューの \[ファイル名を指定して実行\] に "Services.msc" と入力し、次に \[OK\] をクリックします。  
    2.  \[Web Client サービス\] を右クリックし、\[プロパティ\] をクリックします。  
    ...
    **回避策の解除方法** **:** 回避策を解除するには、以下のステップを行ってください。
    ...
    1.  \[スタート\] をクリックして \[ファイル名を指定して実行\] をクリックします。Services.msc と入力して、\[OK\] をクリックします。  
    2.  \[Web Client サービス\] を右クリックし、\[プロパティ\] をクリックします。  
    3.  スタートアップの種類を \[自動\] に変更し \[適用\] をクリックします。  
    4.  \[スタート\] をクリックしてから、\[OK\] をクリックし管理アプリケーションを閉じます。
  
#### 「Mini-Redirector のヒープ オーバーフローの脆弱性」のよく寄せられる質問 - CVE-2008-0080
...
**何が原因で起こりますか?**  
Mini-Redirector が特別な細工がされた WebDAV の応答を適切に処理しません。
  
**WebDAV** **とは何ですか？**  
Web Distributed Authoring and Versioning (WebDAV) とはHTTP (Hypertext Transfer Protocol) の拡張仕様で、ファイルのコピー、移動、削除および作成などの基本的な機能をコンピュータが実行する方法を HTTP を使用して定義します。
  
**WebDAV Redirector** **とは何ですか？**  
WebDAV Redirector とは WedDAV プロトコルでのリモート ファイル システムで、Windows クライアント マシンが WedDAV 発行ディレクトリに接続するのをコマンド ライン経由で許可します。WebDAV Redirector はあたかもマップされたネットワーク ドライブにファイルが存在するかのように、Web 上のデータを操作するのを可能にします。
  
**WebDAV** **mini-redirectorとは何ですか？**  
WebDAV Mini-Redirector は WebClient サービスとも呼ばれます。このサービスは DAV が有効にされたフォルダを汎用名前付け規則 (UNC) 共有として表示させます。
  
**この脆弱性により、攻撃者は何を行う可能性がありますか?**  
攻撃者はこの脆弱性を悪用し任意のコードを実行する可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
**攻撃者はこの脆弱性をどのように悪用する可能性がありますか?**  
この脆弱性が悪用されるには、ユーザー側での操作が攻撃者にとっての必要条件となります。攻撃者は、特別な細工をしたサーバー上のディレクトリを構成し、WebDAV リソースを提供し、その後影響を受けるシステムのユーザーが WebDAV リソースに WebClient サービス経由でアクセスするようにコマンドラインを使用したり Web サイト、電子メール、またはインスタント メッセンジャーのメッセージのリンク経由で誘導することにより、この脆弱性を悪用する可能性があります。しかし、いずれの場合も攻撃者はユーザーを特別な細工をした WebDAV リソースに強制的にアクセスさせることはできません。
  
**主にどのようなコンピュータがこの脆弱性による危険にさらされますか?**  
WebClient サービスが有効なコンピュータが主にこの脆弱性による危険にさらされます。管理者がユーザーにサーバーにログオンしプログラムを実行することを許可した場合、サーバーが危険にさらされる可能性が高くなります。しかし、セキュリティ上の最善策として、これを許可しないことが強く推奨されています。
  
**この更新プログラムはどのように問題を修正しますか?**  
この更新プログラムは WebDAV の応答を正しく検証することにより、この脆弱性を排除します。
...
Windowsxp-KB946026-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB946026-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB946026-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての ｘ64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB946026-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP3\\KB946026\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB946026\\Filelist
</td>
</tr>
</table>
...
WindowsServer2003-KB946026-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB946026-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB946026-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB946026-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB946026\\Filelist
</td>
</tr>
</table>
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows Vista:  
Windows6.0-KB946026-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| ファイル名  | バージョン     | 日付      | 時間  | サイズ  | フォルダ                                                                                               |
|-------------|----------------|-----------|-------|---------|--------------------------------------------------------------------------------------------------------|
| webclnt.dll | 6.0.6000.20751 | 2008/1/12 | 13:24 | 196,096 | x86\_microsoft-windows-webdavredir-webclient\_31bf3856ad364e35\_6.0.6000.20751\_none\_5394188fcfd05766 |
| webclnt.dll | 6.0.6000.16626 | 2008/1/12 | 13:27 | 194,560 | x86\_microsoft-windows-webdavredir-webclient\_31bf3856ad364e35\_6.0.6000.16626\_none\_532fecfab695e27c |
| mrxdav.sys  | 6.0.6000.20751 | 2008/1/12 | 10:45 | 110,080 | x86\_microsoft-windows-webdavredir-mrxdav\_31bf3856ad364e35\_6.0.6000.20751\_none\_1319340ae1da587f    |
| mrxdav.sys  | 6.0.6000.16626 | 2008/1/12 | 10:45 | 110,080 | x86\_microsoft-windows-webdavredir-mrxdav\_31bf3856ad364e35\_6.0.6000.16626\_none\_12b50875c89fe395    |
| davclnt.dll | 6.0.6000.20751 | 2008/1/12 | 13:20 | 48,640  | x86\_microsoft-windows-webdavredir-davclient\_31bf3856ad364e35\_6.0.6000.20751\_none\_923bb8126e5dee69 |

サポートされているすべての x64 エディションの Windows Vista:

| ファイル名  | バージョン     | 日付      | 時間  | サイズ  | CPU | フォルダ                                                                                                 |
|-------------|----------------|-----------|-------|---------|-----|----------------------------------------------------------------------------------------------------------|
| davclnt.dll | 6.0.6000.20751 | 2008/1/12 | 13:20 | 48,640  | x86 | x86\_microsoft-windows-webdavredir-davclient\_31bf3856ad364e35\_6.0.6000.20751\_none\_923bb8126e5dee69   |
| webclnt.dll | 6.0.6000.20751 | 2008/1/12 | 13:24 | 196,096 | x86 | x86\_microsoft-windows-webdavredir-webclient\_31bf3856ad364e35\_6.0.6000.20751\_none\_5394188fcfd05766   |
| webclnt.dll | 6.0.6000.16626 | 2008/1/12 | 13:27 | 194,560 | x86 | x86\_microsoft-windows-webdavredir-webclient\_31bf3856ad364e35\_6.0.6000.16626\_none\_532fecfab695e27c   |
| davclnt.dll | 6.0.6000.20751 | 2008/1/12 | 13:30 | 66,560  | x64 | amd64\_microsoft-windows-webdavredir-davclient\_31bf3856ad364e35\_6.0.6000.20751\_none\_ee5a539626bb5f9f |
| mrxdav.sys  | 6.0.6000.20751 | 2008/1/12 | 10:59 | 134,144 | x64 | amd64\_microsoft-windows-webdavredir-mrxdav\_31bf3856ad364e35\_6.0.6000.20751\_none\_6f37cf8e9a37c9b5    |
| mrxdav.sys  | 6.0.6000.16626 | 2008/1/12 | 10:59 | 134,144 | x64 | amd64\_microsoft-windows-webdavredir-mrxdav\_31bf3856ad364e35\_6.0.6000.16626\_none\_6ed3a3f980fd54cb    |
| webclnt.dll | 6.0.6000.20751 | 2008/1/12 | 13:35 | 213,504 | x64 | amd64\_microsoft-windows-webdavredir-webclient\_31bf3856ad364e35\_6.0.6000.20751\_none\_afb2b413882dc89c |
| webclnt.dll | 6.0.6000.16626 | 2008/1/12 | 13:38 | 211,456 | x64 | amd64\_microsoft-windows-webdavredir-webclient\_31bf3856ad364e35\_6.0.6000.16626\_none\_af4e887e6ef353b2 |
...
-   「WebDAV Mini-Redirector のヒート オーバーフローの脆弱性」 - [CVE-2008-0080](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0080) の 問題を報告してくださった [COSEINC Vulnerability Research Lab](http://www.coseinc.com/) のSteven 氏
