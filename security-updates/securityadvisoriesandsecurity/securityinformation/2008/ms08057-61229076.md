...
-   **VBE6.DLL の アクセス制御リスト (ACL) を変更して、Everyone グループへのアクセスを拒否する**
    ...
    -   **Windows Vista および Windows Server 2008**
        ...
        4.  このファイルに対する ‘everyone’ グループのアクセスを拒否するために、コマンド プロンプトで次のコマンドを入力します。
            ...
            `takeown /f "%ProgramFiles%\Common Files\Microsoft Shared\VBA\VBA6\vbe6.dll"icacls "%ProgramFiles%\Common Files\Microsoft Shared\VBA\VBA6\vbe6.dll" /save %TEMP%\VBE6_ACL.TXTicacls "%ProgramFiles%\Common Files\Microsoft Shared\VBA\VBA6\vbe6.dll" /deny everyone:(F)`
