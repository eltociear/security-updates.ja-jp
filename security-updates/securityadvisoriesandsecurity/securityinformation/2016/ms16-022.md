...
<sup>[2]</sup>Windows 10 の更新プログラム用の Adobe Flash Player の更新プログラムは、[Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) または [Microsoft Update カタログ](http://catalog.update.microsoft.com/v7/site/home.aspx)から入手できます。

**注:** Windows Server Technical Preview 4 は影響を受けます。リモートでのコード実行の総合的な深刻度は「緊急」で影響の度合は「警告」です。このオペレーティング システムを実行しているお客様は、[Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) から入手できる更新プログラムを適用することをお勧めします。
