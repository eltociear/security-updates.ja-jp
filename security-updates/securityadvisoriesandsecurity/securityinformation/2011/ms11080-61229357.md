---
TOCTitle: 'MS11-080'
Title: 'マイクロソフト セキュリティ情報 MS11-080 - 重要'
ms:assetid: 'ms11-080'
ms:contentKeyID: 61229357
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-080(v=Security.10)'
---
...
このセキュリティ更新プログラムは、1 件の非公開で報告された Microsoft Windows Ancillary Function ドライバー (AFD) の脆弱性を解決します。この脆弱性により、攻撃者がユーザーのシステムにログオンし、特別に細工されたアプリケーションを実行した場合、特権が昇格される可能性があります。この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。
...
このセキュリティ更新プログラムは、入力をユーザー モードから Windows カーネルに渡す前に、Ancillary Function ドライバー (AFD) が入力を検証する方法を修正することにより、この脆弱性を解決します。この脆弱性に関する詳細については、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」を参照してください。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|---------------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f1b2dceb-5bef-4522-9001-8dff0545d805&displaylang=ja)                              | 特権の昇格             | 重要           | [MS11-046](http://technet.microsoft.com/security/bulletin/ms11-046)       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9a37864e-8543-4c52-aa73-e3c190860d76&displaylang=ja)     | 特権の昇格             | 重要           | [MS11-046](http://technet.microsoft.com/security/bulletin/ms11-046)       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=29228167-b811-43d7-b4a0-91e385b598a5&displaylang=ja)                     | 特権の昇格             | 重要           | [MS11-046](http://technet.microsoft.com/security/bulletin/ms11-046)       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0816d729-6769-4ca6-a14e-71750eca8d29&displaylang=ja)         | 特権の昇格             | 重要           | [MS11-046](http://technet.microsoft.com/ja-jp/security/bulletin/ms11-046) |
| [Windows Server 2003 with SP2 for Itanium-based Systems](http://www.microsoft.com/downloads/details.aspx?familyid=42465652-2664-4fd5-9a22-ae847b08e7c8&displaylang=ja) | 特権の昇格             | 重要           | [MS11-046](http://technet.microsoft.com/ja-jp/security/bulletin/ms11-046) |
...
<th style="border:1px solid black;" >Ancillary Function ドライバーの特権の昇格の脆弱性 - CVE-2011-2005</th>
...
Ancillary Function ドライバーの特権の昇格の脆弱性 - CVE-2011-2005  
-----------------------------------------------------------------
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-2005](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2005) を参照してください。
  
#### 「Ancillary Function ドライバーの特権の昇格の脆弱性」の問題を緩和する要素 - CVE-2011-2005
  
緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。
  
#### 「Ancillary Function ドライバーの特権の昇格の脆弱性」の回避策 - CVE-2011-2005
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Ancillary Function ドライバーの特権の昇格の脆弱性」のよく寄せられる質問 - CVE-2011-2005
...
WindowsXP-KB2592799-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2592799-x64-jpn.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
WindowsXP-KB2592799-x86-jpn.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2592799-x64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">[コントロール パネル] の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2592799$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2592799">サポート技術情報 2592799</a> を参照してください。</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2592799-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2592799-ia64-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32-bit エディションの Windows Server 2003:<br />
WindowsServer2003-KB2592799-x86-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003:<br />
WindowsServer2003-KB2592799-ia64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ログ ファイル</td>
<td style="border:1px solid black;">KB2592799.log</td>
...
-   「Ancillary Function ドライバーの特権の昇格の脆弱性」(CVE-2011-2005) を報告してくださった [National University of Defense Technology](http://www.nudt.edu.cn/) の Bo Zhou 氏
