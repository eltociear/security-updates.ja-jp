...
|-------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|-----------------------------------------------------------|
| Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1                                         | [JScript 5.8](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=54a64215-e407-4b7b-8536-28817ef23bac)      | 情報漏えい             | 重要           | なし                                                      |
| Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1                                         | [VBScript 5.8](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=54a64215-e407-4b7b-8536-28817ef23bac)     | 情報漏えい             | 重要           | [MS10-022](http://go.microsoft.com/fwlink/?linkid=184779) |
| Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1                                   | [JScript 5.8](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=b854d76e-6891-426d-8c09-0ed8243a3b8d)      | 情報漏えい             | 重要           | なし                                                      |
| Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1                                   | [VBScript 5.8](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=b854d76e-6891-426d-8c09-0ed8243a3b8d)     | 情報漏えい             | 重要           | [MS10-022](http://go.microsoft.com/fwlink/?linkid=184779) |
| Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1         | [JScript 5.8](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=f482bd40-f0b9-4534-a768-45879f1e7285)\*\*  | 情報漏えい             | 警告           | なし                                                      |
| Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1         | [VBScript 5.8](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=f482bd40-f0b9-4534-a768-45879f1e7285)\*\* | 情報漏えい             | 警告           | [MS10-022](http://go.microsoft.com/fwlink/?linkid=184779) |
| Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1 | [JScript 5.8](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=f05a3de0-381c-4d17-83ee-ca4f6da1bdb0)      | 情報漏えい             | 警告           | なし                                                      |
| Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1 | [VBScript 5.8](http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=f05a3de0-381c-4d17-83ee-ca4f6da1bdb0)     | 情報漏えい             | 警告           | [MS10-022](http://go.microsoft.com/fwlink/?linkid=184779) |
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-0031](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0031) を参照してください。
...
-   既定で、Windows Server 2008 および Windows Server 2008 R2 上の[](http://technet.microsoft.com/ja-jp/library/dd883248(ws.10).aspx)Internet Explorer は、「セキュリティ強化の構成」と呼ばれる制限されたモードで実行されます。このモードは、この脆弱性の影響を緩和します。Internet Explorer のセキュリティ強化の構成に関する詳細については、このセキュリティ更新プログラムに関する「よく寄せられる質問」を参照してください。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2475792/ja">サポート技術情報 2475792</a> を参照してください。</td>
</tr>
<tr class="odd">
...
-   スクリプト エンジンの情報漏えいの脆弱性 - CVE-2011-0031 を報告してくださった [Palo Alto Networks](http://www.paloaltonetworks.com/) の Yamata Li 氏
