...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|----------------|---------------------------------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=114c2835-921a-4d3e-be91-dfd217fd26a9&displaylang=ja)                                                                                            | サービス拒否           | 警告           | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0fcee476-8d7e-49a7-b6ea-89043304a653&displaylang=ja)                                                                                | サービス拒否           | 警告           | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 for 32-bit Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c01d9132-af5f-4039-8195-95f6761f2d0e&displaylang=ja)\*                                                                 | サービス拒否           | 重要           | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 for x64-based Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=70797adb-d693-4102-9e7c-ba1ea8fb07d0&displaylang=ja)\*                                                              | サービス拒否           | 重要           | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 for Itanium-based Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9babf81a-8b21-42ae-a65c-f414793516ab&displaylang=ja)                                                            | サービス拒否           | 重要           | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=814bbdfa-7cbc-40e5-8ca3-8fed9d13ff00&displaylang=ja)                                         | サービス拒否           | 警告           | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=085ee785-b6ad-4c68-835a-e17bc8f12a53&displaylang=ja)                                   | サービス拒否           | 警告           | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=9fd2b4ba-d98e-4ad6-99f2-c471335042d3&displaylang=ja)\*       | サービス拒否           | 重要           | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=93752c8f-5461-4e6f-9cab-6401b985ef17&displaylang=ja) | サービス拒否           | 重要           | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1871](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1871) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1965](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1965) を参照してください。
...
-   ポリシーベースの QoS を無効にします。 詳細については、マイクロソフト TechNet の記事 [Policy-based Quality of Service (QoS)](http://technet.microsoft.com/en-us/library/dd919203(ws.10).aspx) (英語情報) を参照してください。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2563894">サポート技術情報 2563894</a> を参照してください。</td>
</tr>
<tr class="odd">
