...
[](http://www.microsoft.com/japan/security/bulletins/ms11-006e.mspx)[![](../../images/Dn636496.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
このセキュリティ更新プログラムは、最初に [マイクロソフト セキュリティ アドバイザリ 2490606](http://technet.microsoft.com/security/advisory/2490606) で説明した脆弱性についても解決します。
...
**US** **マイクロソフトセキュリティ情報:** [http://www.microsoft.com/technet/security/bulletin/MS11-006.mspx](http://technet.microsoft.com/security/bulletin/ms11-006)
...
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|---------------------------------------------------------------------|
| Windows XP Service Pack 3                                                                                         | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=bbea7ead-6c5c-4da8-aa03-a40325fd2de3&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows XP Professional x64 Edition Service Pack 2                                                                | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=bcb7217e-624a-4d61-86a1-f2440a1afd57&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Server 2003 Service Pack 2                                                                                | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=2aa94528-5063-427b-97f7-2a0a55cbb6bf&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Server 2003 x64 Edition Service Pack 2                                                                    | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=6e740922-6ce4-46ec-a35e-e94201a9e398&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Server 2003 with SP2 for Itanium-based Systems                                                            | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=a4f9ec46-35b2-44c9-abf6-647f7a474b99&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Vista Service Pack 1 および Windows Vista Service Pack 2                                                  | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=0c18ecca-afb9-4738-bc7b-76a0e815dfb8&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Vista x64 Edition Service Pack 1 および Windows Vista x64 Edition Service Pack 2                          | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=62dc454f-4b1e-4ac0-8ffe-6c73112f8d4d&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Server 2008 for 32-bit Systems および Windows Server 2008 for 32-bit Systems Service Pack 2\*\*           | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=253c47a0-69ac-437a-ad3e-778c37fa37cb&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Server 2008 for x64-based Systems および Windows Server 2008 for x64-based Systems Service Pack 2\*\*     | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=ec7101aa-96c2-4931-a3e4-0c55cbc74d9c&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| Windows Server 2008 for Itanium-based Systems および Windows Server 2008 for Itanium-based Systems Service Pack 2 | [![](../../images/Dn636496.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=e62493cb-8d25-4975-bbe6-a368e039872b&displaylang=ja) | リモートでコードが実行される | 緊急           | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
...
はい。このセキュリティ更新プログラムをインストールする前に、「Windows XP および Windows Server 2003 システム上の shimgvw.dll のアクセス制御リスト (ACL) を変更する」の回避策を、以前に適用したシステムから元に戻す必要があります。自動化された “Microsoft Fix it” ソリューションを使用して、この回避策を無効にするには、サポート技術情報 [2483185](http://support.microsoft.com/kb/2483185) をご覧ください。
...
<th style="border:1px solid black;" >Windows シェルのグラフィック処理のオーバーランの脆弱性 - <a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970">CVE-2010-3970</a></th>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2010-3970](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970) をご覧ください。
...
-   **Windows XP および Windows Server 2003 上の shimgvw.dll のアクセス制御リスト (ACL) を変更する**
    ...
    **注意:** 自動化された “Microsoft Fix it” ソリューションを使用してこの回避策を有効または無効にするには、サポート技術情報 [2483185](http://support.microsoft.com/kb/2483185) をご覧ください。
...
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2010-3970](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970) にアサインされています。この脆弱性は、マイクロソフト セキュリティ アドバイザリ [2490606](http://technet.microsoft.com/security/advisory/2490606) で説明しました。
...
はい。このセキュリティ更新プログラムは公開された検証用コードにより悪用される可能性のある脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2010-3970](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970) に割り当てられています。
...
<td style="border:1px solid black;">
サポート技術情報 [2483185](http://support.microsoft.com/kb/2483185) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2" style="border:1px solid black;">
...
-   「Windows シェルのグラフィック処理のオーバーランの脆弱性」[CVE-2010-3970](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970) を報告してくださった [VeriSign iDefense Labs](http://labs.idefense.com/) に協力している Kobi Pariente 氏および Yaniv Miron 氏
