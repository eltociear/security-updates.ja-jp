---
TOCTitle: 'MS11-071'
Title: 'マイクロソフト セキュリティ情報 MS11-071 - 重要'
ms:assetid: 'ms11-071'
ms:contentKeyID: 61229348
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-071(v=Security.10)'
---
...
公開日: 2011年9月14日 | 最終更新日: 2011年11月9日
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|----------------|--------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=70f944b0-9bf0-4168-b150-67d2ff68df2d&displaylang=ja)                                                                                               | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4b9debed-edbb-43e1-b755-0faf01980289&displaylang=ja)                                                                      | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d44274d2-0401-4fd8-bc4f-c59f6d81c34f&displaylang=ja)                                                                                      | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=935720ee-cee0-42c2-965e-ce1b07e95e1a&displaylang=ja)                                                                          | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2003 with SP2 for Itanium-based Systems](http://www.microsoft.com/downloads/details.aspx?familyid=78c2ac72-da89-42a4-bff9-79551b5d3c4e&displaylang=ja)                                                                  | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=15840336-4886-4a1b-8c1e-2c535c3938f7&displaylang=ja)                                                                                            | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e80739b4-89bb-4317-8381-991244a71cb8&displaylang=ja)                                                                                | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2008 for 32-bit Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=05c39ab3-7b57-4147-8913-df5df6005799&displaylang=ja)\*                                                                 | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2008 for x64-based Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1499d988-fd55-4317-b859-ec170907d547&displaylang=ja)\*                                                              | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2008 for Itanium-based Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6e2d2ea9-0af6-4d23-875d-3211722cd62f&displaylang=ja)                                                            | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=76b99ab2-7e99-4aad-a419-7996bae05c48&displaylang=ja)                                         | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0f6d32de-d3ff-4af9-9b26-a4f12581f5fe&displaylang=ja)                                   | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=a8a451bd-3e5c-4845-9941-daabd9418776&displaylang=ja)\*       | リモートでコードが実行される | 重要           | なし                                                   |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0fdfb1f9-20b3-4d61-8019-33d1003290c8&displaylang=ja) | リモートでコードが実行される | 重要           | なし                                                   |
...
マイクロソフトはこのセキュリティ情報を再リリースし、Windows 7 Embedded の更新プログラムの提供を開始したことをお知らせしました。このプラットフォームを実行しているお客様はこの更新プログラムをダウンロードし、ご使用のコンピューターに適用することを推奨します。セキュリティ更新プログラムは、[Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) および [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) から入手できます。その他の更新プログラムについては、この再リリースによる影響はありません。

ファイル情報の詳細はどこにありますか? 
ファイル情報の詳細の場所については、「セキュリティ更新プログラムの展開」の参照表をご覧ください。

この更新プログラムは、マイクロソフト セキュリティ アドバイザリ 2269637 と関連していますか?  
はい。この更新プログラムが解決する Windows コンポーネントの安全でないライブラリのロードの脆弱性 (CVE-2010-1991) は、[マイクロソフト セキュリティ アドバイザリ 2269637](http://technet.microsoft.com/ja-jp/security/advisory/2269637) で説明している、アプリケーションが外部ライブラリをロードする仕組みに影響する脆弱性の一種です。このセキュリティ更新プログラムはこの種の脆弱性の特定の問題を解決します。
...
<span></span>
次の深刻度の評価は、脆弱性の影響が最も深刻な場合を想定しています。深刻度の評価およびセキュリティ上の影響に関連して、このセキュリティ情報の公開から 30 日間でこの脆弱性が悪用される可能性に関する情報については、[9 月のセキュリティ情報の概要](http://technet.microsoft.com/ja-jp/security/bulletin/ms11-sep)の Exploitability Index を参照してください。詳細については、[Microsoft Exploitability Index](http://technet.microsoft.com/ja-jp/security/cc998259.aspx) (悪用可能性指標) を参照してください。
...
<th style="border:1px solid black;" >Windows コンポーネントの安全でないライブラリのロードの脆弱性 - CVE-2011-1991</th>
...
<span></span>
特定の Windows コンポーネントが DLL ファイルのロードを処理する方法に、リモートでコードが実行される脆弱性が存在します。攻撃者がこの脆弱性の悪用に成功した場合、影響を受けるシステムを完全に制御する可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除などを行ったり、完全なユーザー権限を持つ新たなアカウントを作成したりする可能性があります。コンピューターでのユーザー権限が低い設定のアカウントを持つユーザーは、管理者特権で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1991](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1991) を参照してください。
  
#### 「Windows コンポーネントの安全でないライブラリのロードの脆弱性」の問題を緩和する要素 - CVE-2011-1991
  
緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。
  
-   ユーザーが信頼されていないリモート ファイル システムの場所または WebDAV 共有を訪問し、リッチ テキスト形式ファイル (.rtf)、テキスト ファイル (.txt)、または Word 文書 (.doc) ファイルを開くことが、攻撃者にとっての必要条件となります。  
...
#### 「Windows コンポーネントの安全でないライブラリのロードの脆弱性」の回避策 - CVE-2011-1991
...
#### 「Windows コンポーネントの安全でないライブラリのロードの脆弱性」のよく寄せられる質問 - CVE-2011-1991
...
何が原因で起こりますか?   
特定の Windows コンポーネントが外部ライブラリをロードするために使用するパスを正しく制限しない場合に、この脆弱性が起こります。
  
この更新プログラムで解決されているのはどのコンポーネントですか?   
この更新プログラムで解決されているコンポーネントは、ディスプレイ パン CPL 拡張 (deskpan.dll)、Microsoft EAPHost 認証システム サービス、Microsoft 管理コンソール (MMC)、フォルダー リダイレクト、日本語入力方式エディター (IME)、およびハイパーターミナルです。
  
ディスプレイ パン コントロール パネル アプリケーション (CPL) 拡張とは何ですか?   
ディスプレイ パン CPL 拡張 (deskpan.dll) は、ユーザーの画面に表示される画像の表示設定に関連するモジュールです。関連する DLL とこの拡張により、ユーザーは、ディスプレイ アダプターの詳細プロパティとディスプレイ モニター プロパティを調整できるようになります。
  
Microsoft EAPHost 認証システム サービスとは何ですか?   
EAPHost は Microsoft Windows ネットワーク コンポーネントの一種であり、802.1X や Point-to-Point (PPP) など、"サプリカント" プロトコル実装の認証のために、拡張認証プロトコル (EAP) インフラストラクチャを提供します。また Microsoft ネットワーク ポリシー サーバー (NPS) など、"認証システム" テクノロジでの認証も可能になります。詳細については、MSDN の記事 [Extensible Authentication Protocol Host](http://msdn.microsoft.com/en-us/library/aa364249(v=vs.85).aspx) (英語情報) を参照してください。
  
Microsoft 管理コンソール (MMC) とは何ですか?   
Microsoft 管理コンソール (MMC) は、管理アプリケーションのために共通して使用する拡張可能プレゼンテーション サービスです。MMC は、Microsoft とサード パーティ ソフトウェア ベンダーが提供するスナップインのために、共通のホスト環境を提供します。実際の管理機能を提供するのはスナップインであり、MMC 自体は管理機能を提供しません。MMC 環境は、スナップイン間でシームレスな統合を提供します。詳細については、TechNet 記事 [Microsoft 管理コンソール ‐ 概要](http://technet.microsoft.com/ja-jp/library/bb742441.aspx)を参照してください。
  
フォルダー リダイレクト コンポーネントとは何ですか?   
フォルダー リダイレクトは、ユーザーと管理者がフォルダーのパスを新しい場所にリダイレクトできるようにする IntelliMirror の機能です。新しい場所として、ローカル コンピューターのフォルダーまたはネットワーク共有のディレクトリを指定できます。ドキュメントがローカル ドライブにある場合と同様に、ユーザーはサーバー上のドキュメントを操作できます。たとえば、通常、コンピューターのローカル ハード ディスクにある \[マイ ドキュメント\] フォルダーを、ネットワーク上の特定の場所にリダイレクトできます。フォルダー内のドキュメントは、ネットワークに接続されたあらゆるコンピューターのユーザーが利用できます。詳細については、TechNet の記事 [Folder Redirection Overview](http://technet.microsoft.com/en-us/library/cc778976(ws.10).aspx) (英語情報) を参照してください。
  
入力方式エディター (日本語) コンポーネントとは何ですか?   
日本語の入力方式エディター (IME) では、ドキュメント、ワークシート、プレゼンテーション、メール メッセージ、パブリケーション、および Web ページに、日本語のテキストを入力できます。利用可能な IME の詳細については、MSDN の記事「[IME のインストールと使用](http://msdn.microsoft.com/ja-jp/library/ee418266%28v=vs.85%29.aspx)」を参照してください。
  
HyperTerminal とは何ですか?   
ハイパーターミナルは、モデム、ヌル モデム ケーブル、またはイーサネット接続を使用して、他のコンピューター、Telnet サイト、掲示板サービス (BBS)、オンライン サービス、およびホスト コンピューターに接続できるプログラムです。
  
この脆弱性によって、なぜ複数のコンポーネントが一覧表示されるのですか?   
この 1 つの脆弱性よって複数のコンポーネントが一覧表示されますが、この問題の根本的な原因はすべてのコンポーネント間で共有されています。
...
攻撃者は、特別に細工されたダイナミック リンク ライブラリ (DLL) ファイルがあるネットワーク ディレクトリ内で、正当なリッチ テキスト形式ファイル (.rtf)、テキスト ファイル (.txt)、または Word 文書 (.doc) を、ユーザーに開かせようとする可能性があります。次に、正当なファイルを開いている間に影響を受けるコンポーネントが DLL ファイルをロードし、それに含まれている任意のコードを実行しようとする可能性があります。
  
電子メールの攻撃のシナリオでは、攻撃者は正当なリッチ テキスト形式ファイル (.rtf)、テキスト ファイル (.txt)、または Word 文書 (.doc) として添付ファイルをユーザーに送り、ユーザーにその添付ファイルを特別に細工した DLL ファイルが含まれるディレクトリに置かせ、その正当なファイルを開かせることにより、この脆弱性を悪用する可能性があります。次に、正当なファイルを開いている間に影響を受けるコンポーネントが DLL ファイルをロードし、それに含まれている任意のコードを実行しようとする可能性があります。
  
ネットワーク攻撃のシナリオでは、攻撃者は正当なリッチ テキスト形式ファイル (.rtf)、テキスト ファイル (.txt)、または Word 文書 (.doc) と特別に細工された DLL ファイルを、ネットワーク共有、UNC、または WebDAV の場所に置き、ユーザーにそのファイルを開かせようとする可能性があります。
...
この更新プログラムは、Windows コンポーネントが外部のライブラリをロードする方法を修正して、この脆弱性を解決します。またこの更新プログラムでは、外部ライブラリのロードを制限するために、レジストリ キー エントリが修正されます。
...
はい。この脆弱性は一般で公開されていました。これは Common Vulnerability and Exposure の [CVE-2011-1991](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1991) にアサインされています。
...
WindowsXP-KB2570947-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2570947-x64-jpn.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
WindowsXP-KB2570947-x86-jpn.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2570947-x64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">[コントロール パネル]の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2570947$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2570947">サポート技術情報 2570947</a> を参照してください。</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2570947-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2570947-ia64-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32-bit エディションの Windows Server 2003:<br />
WindowsServer2003-KB2570947-x86-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003:<br />
WindowsServer2003-KB2570947-ia64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ログ ファイル</td>
<td style="border:1px solid black;">KB2570947.log</td>
