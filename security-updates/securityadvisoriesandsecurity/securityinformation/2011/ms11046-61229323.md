---
TOCTitle: 'MS11-046'
Title: 'マイクロソフト セキュリティ情報 MS11-046 - 重要'
ms:assetid: 'ms11-046'
ms:contentKeyID: 61229323
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-046(v=Security.10)'
---

マイクロソフト セキュリティ情報 MS11-046 - 重要
===============================================

Microsoft Ancillary Function ドライバーの脆弱性により、特権が昇格される (2503665)
---------------------------------------------------------------------------------

公開日: 2011年6月15日 | 最終更新日: 2011年7月1日

**バージョン:** 1.0

[](http://www.microsoft.com/japan/security/bulletins/ms11-046e.mspx)[![](../../images/Dn636536.SNS300x50(ja-JP,Security.10).jpg)](https://profile.microsoft.com/regsysprofilecenter/subscriptionwizard.aspx?wizid=cbdde499-aa75-4a75-9cb3-f48eac2e7c3f&lcid=1041)
...
このセキュリティ更新プログラムは、入力がユーザー モードから Windows カーネルに渡される前に、AFD が入力を検証する方法を修正して、この脆弱性を解決します。この脆弱性の詳細情報は、次の「脆弱性の情報」のセクションの特定の脆弱性に関するサブセクション「よく寄せられる質問 (FAQ)」をご覧ください。
...
US マイクロソフトセキュリティ情報: [http://www.microsoft.com/technet/security/bulletin/MS11-046.mspx](http://technet.microsoft.com/security/bulletin/ms11-046)
...
![](../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg)このマークをクリックして、更新プログラムをダウンロードしてください。
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a1db7736-f3e4-45df-af1d-52746978a0a8&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-066">MS08-066</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2<br />
</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=71497891-41a2-476d-b524-4eb5cecb9639&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-066">MS08-066</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c614cb8b-223e-4f84-b94c-f15747760aa5&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-066">MS08-066</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9a951087-25c5-4f5c-8407-a1585491ae0b&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-066">MS08-066</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=dd48b93b-24fa-45a3-91fb-9f9f9418c49f&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-066">MS08-066</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b69e3bda-940b-4524-a724-0af4ae0ec719&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e3a26bc5-1757-4b38-9cae-419c919f4877&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e34e4cf9-cdae-4240-8574-950c0be00822&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a3604f05-26b2-451b-9153-0e718158371e&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e8a82b44-e1d8-45f8-b8b8-b1f74e1efce0&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=63d8b801-5178-474b-a21e-72a0ce501d3e&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=cd7d3cb9-cb60-4b62-b0df-a38fe21802e9&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-058">MS10-058</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e67c73ca-d0f9-40c1-8b6e-25b1b13caa3a&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-058">MS10-058</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=72d1d6b6-e8bd-492b-b65a-82060beef441&amp;displaylang=ja"><img src="../../images/Dn636536.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">特権の昇格</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-058">MS10-058</a></td>
</tr>
...
<th style="border:1px solid black;" >Microsoft Ancillary Function ドライバーの特権の昇格の脆弱性 - <a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249">CVE-2011-1249</a></th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Microsoft Ancillary Function ドライバーの特権の昇格の脆弱性 - CVE-2011-1249  
---------------------------------------------------------------------------
  
 
Ancillary Function Driver (afd.sys) がユーザー モードからカーネルに渡された入力を適切に検証しない場合に、特権の昇格の脆弱性が存在します。この脆弱性では、攻撃者が昇格された特権でコードを実行する可能性があります。攻撃者がローカルでこの脆弱性を悪用した場合、任意のコードを実行し、影響を受けるコンピューターを完全に制御する可能性があります。その後、攻撃者はプログラムのインストール、データの表示、変更、削除、または完全なユーザー権限を持つ新たなアカウントを作成する可能性があります。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性をご覧になるためには、[CVE-2011-1249](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249) をご覧ください。
  
#### 「Microsoft Ancillary Function ドライバーの特権の昇格の脆弱性」の問題を緩和する要素 - CVE-2011-1249:
  
「問題を緩和する要素」とは、設定、一般的な構成または一般的な最善策、既定の状態により、脆弱性の悪用の深刻度が低くなる可能性がある要素を指します。次の「問題を緩和する要素」は、お客様の環境で役立つ場合があります。
  
-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。
  
#### 「Microsoft Ancillary Function ドライバーの特権の昇格の脆弱性」の回避策 - CVE-2011-1249:
  
マイクロソフトは、この脆弱性の回避策を確認していません。
  
#### 「Microsoft Ancillary Function ドライバーの特権の昇格の脆弱性」のよく寄せられる質問 - CVE-2011-1249:
...
何が原因で起こりますか?  
この脆弱性は、AFD がユーザー モードからカーネルにデータを渡す際に、ユーザーの提供した入力を正しく検証しない場合に起こります。
  
Microsoft Ancillary Function ドライバー (AFD) とは何ですか?  
Microsoft Ancillary Function ドライバー (AFD) は、Windows ソケットのアプリケーションをサポートし、afd.sys ファイルに含まれています。afd.sys ドライバーはカーネル モードで実行し、Winsock TCP/IP の通信プロトコルを管理します。この Winsock カーネルインターフェイスは TDI のトランスポートへのアクセスを提供します。
  
Transport Driver Interface (TDI) とはなんですか?  
Transport Driver Interface (TDI) はカーネル モードのネットワーク インターフェイスを定義し、すべてのトランスポート プロトコルのスタックの上端に現れます。各スタックの最上位レベルのプロトコル ドライバーは、上位レベルのカーネル モードのネットワーク クライアント向けの TDI インターフェイスをサポートします。TDI コンポーネントに関する詳細情報は、MSDN の記事 [Transport Driver Interface](http://msdn.microsoft.com/library/ff565685.aspx) (英語情報) をご覧ください。
...
この更新プログラムは、入力がユーザー モードから Windows カーネルに渡される前に、AFD が入力を検証する方法を修正して、この脆弱性を解決します。
  
このセキュリティ情報のリリース時に、この脆弱性は一般に公開されていましたか?  
はい。この脆弱性は一般に知られていました。これは Common Vulnerability and Exposure の [CVE-2011-1249](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249) にアサインされています。
...
はい。このセキュリティ更新プログラムは、公開された検証用コードを使用して悪用される可能性がある脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2011-1249](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249) に割り当てられています。
...
SMS 2003 について、SMS 2003 Inventory Tool for Microsoft Updates (ITMU) は、[Microsoft Update](http://update.microsoft.com/microsoftupdate/) により提供されるセキュリティ更新プログラムおよび [Windows Server Update Services](http://technet.microsoft.com/ja-jp/wsus/default.aspx) よりサポートされるセキュリティ更新プログラムを検出するために、SMS により使用されます。SMS 2003 ITMU に関する詳細は、次の [マイクロソフトの Web サイト](http://technet.microsoft.com/ja-jp/sms/bb676783.aspx) をご覧ください。また SMS 2003 も Microsoft Office Inventory Tool を使用して Microsoft Office アプリケーションに必要な更新プログラムを検出することができます。Office Inventory Tool および別のスキャンニング ツールに関する詳細情報は、[SMS 2003 Software Update Scanning Tools](http://technet.microsoft.com/en-us/sms/bb676786.aspx) (英語情報) をご覧ください。詳細は [Downloads for Systems Management Server 2003](http://technet.microsoft.com/en-us/sms/bb676766.aspx) (英語情報) もご覧ください。
...
Windowsxp-KB2503665-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2503665-x64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
Windowsxp-KB2503665-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
WindowsServer2003.WindowsXP-KB2503665-x64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
\[コントロール パネル\] の \[プログラムの追加と削除\] を使用してください。システム管理者は Spuninst.exe ユーティリティを使用し、このセキュリティ更新プログラムを削除することができます。Spuninst.exe ユーティリティは %Windir%\\$NTUninstallKB2503665$\\Spuninst フォルダーにあります。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポート技術情報 [2503665](http://support.microsoft.com/kb/2503665) をご覧ください。
</td>
</tr>
<tr>
<th colspan="2">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP\\SP4\\KB2503665\\Filelist
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows XP:  
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows XP Version 2003\\SP3\\KB2503665\\Filelist
</td>
</tr>
</table>
...
WindowsServer2003-KB2503665-x86-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2503665-ia64-JPN /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2503665-x86-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB2503665-ia64-JPN /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2503665\\Filelist
</td>
</tr>
</table>
...
Windows6.0-KB2503665-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2503665-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows Vista:  
Windows6.0-KB2503665-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows Vista:  
Windows6.0-KB2503665-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2503665-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.0-KB2503665-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2503665-x86 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2503665-x64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての 32-bit エディションの Windows 7:  
Windows6.1-KB2503665-x86 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
サポートされているすべての x64 エディションの Windows 7:  
Windows6.1-KB2503665-x64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
注: wusa.exe インストーラーに関する詳細情報は、TechNet の記事 [Windows 7 でのその他の変更](http://technet.microsoft.com/ja-jp/library/dd871148%0d%0a%0d%0a(ws.10).aspx)の「Windows Update スタンドアロン インストーラー」をご覧ください。
...
Windows6.1-KB2503665-ia64 /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows6.1-KB2503665-ia64 /quiet /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   「 Microsoft Ancillary Function ドライバーの特権の昇格の脆弱性」 - [CVE-2011-1249](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249) を報告してくださった [Shadowserver Foundation](http://www.shadowserver.org) の Steven Adair 氏および Chris S. 氏
...
-   2011/07/01: このセキュリティ情報ページを更新し、影響を受けるソフトウェアの表を修正して、このセキュリティ更新プログラムにより置き換えられるセキュリティ情報に MS10-058 を追記しました。今回の更新は情報のみの変更です。このセキュリティ情報のセキュリティ更新プログラムのファイルおよび検出ロジックへの変更はありません。
