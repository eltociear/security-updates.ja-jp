...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|------------------------------|---------------------------------------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fc3fe87c-2493-431d-a904-dec9310f6042&displaylang=ja)                                                                                                        | 緊急                   | リモートでコードが実行される | [MS11-064](http://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=042c1a8f-834d-4eed-8a59-9e030ccc6d39&displaylang=ja)                                                                                            | 緊急                   | リモートでコードが実行される | [MS11-064](http://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows Server 2008 for 32-bit Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79382bf2-d2cb-42ea-92dc-64f949353521&displaylang=ja)\*                                                                             | 緊急                   | リモートでコードが実行される | [MS11-064](http://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows Server 2008 for x64-based Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=71ff3a89-d7ad-4dda-9e59-fab54b21bd5d&displaylang=ja)\*                                                                          | 緊急                   | リモートでコードが実行される | [MS11-064](http://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows Server 2008 for Itanium-based Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b1c0cb05-c284-49b1-ae4f-92813fdf520f&displaylang=ja)                                                                        | 緊急                   | リモートでコードが実行される | [MS11-064](http://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4ddb4c2a-bada-49b0-ad78-e07e7e11ced7&displaylang=ja)                                                     | 緊急                   | リモートでコードが実行される | [MS11-064](http://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=05eef5d7-acf6-46e4-abfc-dc83f0a7cae5&displaylang=ja)                                               | 緊急                   | リモートでコードが実行される | [MS11-064](http://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=3f9f74a6-e984-4aab-837c-ef7286e7305f&displaylang=ja)\*                   | 緊急                   | リモートでコードが実行される | [MS11-064](http://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
| [Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b20bfcbd-a515-4074-b56e-b82539fe5bad&displaylang&displaylang=ja) | 緊急                   | リモートでコードが実行される | [MS11-064](http://technet.microsoft.com/ja-jp/security/bulletin/ms11-064) |
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-2013](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2013) を参照してください。
...
-   未使用の UDP ポートを境界ファイアウォールでブロックする
    ...
    未使用の (閉じられている) UDP ポートを境界ファイアウォールでブロックするすると、ファイアウォールの背後のシステムを、この脆弱性の悪用の試行から保護する手助けとなります。ポートの詳細については、TechNet の記事 [TCP and UDP Port Assignments](http://go.microsoft.com/fwlink/?linkid=21312) (英語情報) を参照してください。
...
UDP とは何ですか?    
User Datagram Protocol (UDP) は RFC 768 "User Datagram Protocol (UDP)" で定義された TCP/IP の標準です。UDP は、TCP/IP ホスト間で高速、軽量、信頼性の低いデータの転送を行うために TCP に代わって一部のプログラムで使用されます。UDP はコネクションレス データグラム サービスで、ベストエフォート配信を行います。つまり、UDP はデータグラムの配信を保証しません。また、シーケンスを検証しません。信頼性のある通信を必要としているソース ホストは、TCP や、独自のシーケンス サービスおよび確認サービスを備えたプログラムを使用する必要があります。詳細については、TechNet の記事[ユーザー データグラム プロトコル (UDP)](http://technet.microsoft.com/ja-jp/library/cc785220(ws.10).aspx)を参照してください。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2588516">サポート技術情報 2588516</a> を参照してください。</td>
</tr>
<tr class="odd">
