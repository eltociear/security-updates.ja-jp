...
[](http://www.microsoft.com/japan/security/bulletins/ms06-050e.mspx)
...
|                                                                                                                                 | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                           | [![](../../images/Dn610095.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=bfe3f869-08be-4f13-97a1-7274ad44c7fb&displaylang=ja) | [![](../../images/Dn610095.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=bfe3f869-08be-4f13-97a1-7274ad44c7fb&displaylang=ja-nec) | ![](../../images/Dn610095.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                  | [![](../../images/Dn610095.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=2d014bac-f03d-474a-a7ab-49e8ead8edb0&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610095.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                   | [![](../../images/Dn610095.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=cae094e4-64a0-4577-986b-4d6c131806d9&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610095.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                               | [![](../../images/Dn610095.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=21d1e864-4517-4353-8477-b4cd3c6187c0&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610095.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems | [![](../../images/Dn610095.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=bc60b6c3-ada8-48ab-a63d-b2f1c9320b0d&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610095.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                       | [![](../../images/Dn610095.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=9d2ba5d1-6f91-47b4-8cc1-dcd44baaa6ce&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610095.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610095.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](http://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|-----------------------------|------------------------------------------------------------|---------------------------------------------------------------|
| ハイパーリンク COM オブジェクト バッファ オーバーフローの脆弱性 - [CVE-2006-3086](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3086) | リモートでコードが実行される | 重要                        | 重要                                                       | 重要                                                          |
| ハイパーリンク オブジェクト機能の脆弱性 - [CVE-2006-3438](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3438)                         | リモートでコードが実行される | 重要                        | 重要                                                       | 重要                                                          |
...
|---------------------------------------------------------------------|--------------|------------------------------------------------------------|---------------------|------------------------------------|
| [MS05-015](http://technet.microsoft.com/security/bulletin/ms05-015) | 置き換わる   | 置き換わる                                                 | 置き換わる          | 対象外                             |
...
ハイパーリンク オブジェクト ライブラリは、アプリケーション プログラミング インターフェイスの集合体です。これらのインターフェイスにより、ソフトウェア開発者にハイパーリンクの処理の機能が提供されます。[ハイパーリンク](http://msdn2.microsoft.com/en-us/library/aa740928.aspx)に関する詳細は、説明をご覧ください。
...
はい。このセキュリティ更新プログラムは公開された検証用コードにより悪用される可能性のある脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2006-3086](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3086)に割り当てられています。
...
-   「ハイパーリンク オブジェクト バッファ オーバーフローの脆弱性」- [CVE-2006-3086](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3086) を報告して下さった [TippingPoint Security Research Team](http://www.tippingpoint.com/security)の Pedram Amini 氏
-   「ハイパーリンク オブジェクト機能の脆弱性」- [CVE-2006-3438](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3438) を報告してくださった [CSC Australia Pty Limited](http://au.country.csc.com/en/) の Steve Tai 氏
...
-   US マイクロソフトセキュリティ情報（MS06-050）
    [http://www.microsoft.com/technet/security/bulletin/MS06-050.mspx](http://technet.microsoft.com/security/bulletin/ms06-050)
-   サポート技術情報 （KB） 文書番号 ：920670
    [\[MS06-050\] Microsoft Windows ハイパーリンク オブジェクト ライブラリの脆弱性により、リモートでコードが実行される](http://support.microsoft.com/kb/920670)
