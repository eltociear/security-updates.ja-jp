...
[](http://www.microsoft.com/japan/security/bulletins/ms06-043e.mspx)
...
|                                                                                         | PC/AT                                                                                                                                                                                             | PC-9800 | MU                                                                            |
|-----------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|-------------------------------------------------------------------------------|
| Microsoft Windows XP Service Pack 2 上の Outlook Express 6                              | [![](../../images/Dn610088.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=c9037cdb-3a57-4db7-aa0d-5ad28730303a&displaylang=ja) | -       | ![](../../images/Dn610088.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition 上の Outlook Express 6                    | [![](../../images/Dn610088.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=71f09617-d3cd-45fb-a09b-a9025c1d3f47&displaylang=ja) | -       | ![](../../images/Dn610088.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 Service Pack 1 上の Outlook Express 6                     | [![](../../images/Dn610088.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=0c7e507f-2a42-49b5-82b2-84a6ec40b895&displaylang=ja) | -       | ![](../../images/Dn610088.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 with SP1 for Itanium-based Systems 上の Outlook Express 6 | [![](../../images/Dn610088.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=8f062b1c-7b93-4cb2-835a-b58ba29435f2&displaylang=ja) | -       | ![](../../images/Dn610088.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition 上の Outlook Express 6                        | [![](../../images/Dn610088.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=2aa6b4d1-a6eb-425b-ab7e-6cc27124a59e&displaylang=ja) | -       | ![](../../images/Dn610088.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610088.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](http://windowsupdate.microsoft.com/) からインストールすることもできます。
...
|-----------------------------------------------------------------------------------------------------|------------------------------|--------------------------------------------------------------------------|-------------------------------------------------------------------------------------|
| MHTML 解析の脆弱性 [CVE-2006-2766](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2766) | リモートでコードが実行される | 緊急                                                                     | 緊急                                                                                |
...
はい。このセキュリティ更新プログラムは公開された検証用コードにより悪用される可能性のある脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2006-2766](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2766) に割り当てられています。
...
過去に修正プログラムをインストールしてこれらのファイルのいずれかをアップデートしている場合は、SP1QFE ファイルがコンピュータにコピーされます。それ以外の場合は、SP1GDR ファイルがコンピュータにコピーされます。セキュリティ更新プログラムはこれらのファイルのすべてのバリエーションを含んでいない場合があります。この動作に関する詳細情報は、サポート技術情報 [824994](http://support.microsoft.com/kb/824994) をご覧ください。
...
過去に修正プログラムをインストールしてこれらのファイルのいずれかをアップデートしている場合は、SP1QFE または SP2QFE ファイルがコンピュータにコピーされます。それ以外の場合は、SP1GDR または SP2GDR ファイルがコンピュータにコピーされます。セキュリティ更新プログラムはこれらのファイルのすべてのバリエーションを含んでいない場合があります。この動作に関する詳細情報は、サポート技術情報 [824994](http://support.microsoft.com/kb/824994) をご覧ください。
...
-   US マイクロソフトセキュリティ情報（MS06-043）
    [http://www.microsoft.com/technet/security/bulletin/MS06-043.mspx](http://technet.microsoft.com/security/bulletin/ms06-043)
-   サポート技術情報 （KB） 文書番号 ：920214
    [\[MS06-043\] Microsoft Windows の脆弱性により、リモートでコードが実行される](http://support.microsoft.com/kb/920214)
