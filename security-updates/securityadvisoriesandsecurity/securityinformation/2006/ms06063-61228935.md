...
|                                                                                                                                 | PC/AT                                                                                                                                                                                             | PC-9800                                                                                                                                                                                               | MU                                                                            |
|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                                           | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=2998105d-6796-4e60-8c9c-e8241385f2a9&displaylang=ja) | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=2998105d-6796-4e60-8c9c-e8241385f2a9&displaylang=ja-nec) | ![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Service Pack 1 および Microsoft Windows XP Service Pack 2                                                  | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=08ab17b9-149c-44d4-96cf-87a8c6b9dc22&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows XP Professional x64 Edition                                                                                   | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=433fd0f9-938f-432d-99d4-f41b92235dcf&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1                                               | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=abad4cc1-4ea6-4051-bc5a-79deb4dbe72b&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 for Itanium-based Systems および Microsoft Windows Server 2003 with SP1 for Itanium-based Systems | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=849eedef-332b-4792-b84e-3750d407a86f&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif) |
| Microsoft Windows Server 2003 x64 Edition                                                                                       | [![](../../images/Dn610108.dl_arrow(ja-JP,Security.10).jpg)](http://www.microsoft.com/downloads/details.aspx?familyid=31e448f7-298d-417c-a857-1646689e0817&displaylang=ja) | -                                                                                                                                                                                                     | ![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif) |
...
![](../../images/Dn610108.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](http://update.microsoft.com/microsoftupdate/) からインストールすることもできます。
...
|---------------------------------------------------------------------------------------------------------------------------|------------------------------|-----------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Server サービスの サービス拒否の脆弱性 - [CVE-2006-3942](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3942) | サービス拒否                 | 重要                        | 重要                      | 重要                      | 重要                | 重要                               |
| SMB の名前の変更の脆弱性- [CVE-2006-4696](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4696)                | リモートでコードが実行される | 重要                        | 重要                      | 重要                      | 重要                | 重要                               |
...
|---------------------------------------------------------------------|-----------------------------|------------------------------------------------------------|------------------------|---------------------------------------------------------------|
| [MS06-035](http://technet.microsoft.com/security/bulletin/ms06-035) | 置き換わる                  | 置き換わる                                                 | 置き換わる             | 置き換わる                                                    |
...
Server サービスが特定のネットワーク メッセージを処理する方法に[サービス拒否](http://www.microsoft.com/japan/security/glossary.mspx)の脆弱性が存在します。Server サービスを実行しているコンピュータに特別な細工がされたネットワーク メッセージを送ることにより、攻撃者はこの脆弱性を悪用する可能性があります。攻撃者はこの脆弱性を悪用し、影響を受けるコンピュータが応答しないようにする可能性があります。
...
-   **ネットワークベースでのこの脆弱性の悪用に対する保護の手助けを行うために、Windows XP** **および** **Windows Server 2003** **に含まれている**[**インターネット接続ファイアウォール**](http://www.microsoft.com/japan/athome/security/protect/firewall.mspx)**などのパーソナルファイアウォールを使用する**
...
これは、[サービス拒否](http://www.microsoft.com/japan/security/glossary.mspx)の脆弱性です。攻撃者はこの脆弱性を悪用し、影響を受けるコンピュータが応答しないようにし、自動的に再起動させる可能性があります。その間、サーバーはリクエストに応答できない可能性があります。攻撃者により、サービス拒否の脆弱性が悪用されても、コードが実行されたり、特権の昇格が行われることはありません。しかし、影響を受けるコンピュータが要求を受け入れない可能性があります。
...
このセキュリティ更新プログラムは公開された検証用コードにより悪用される可能性のある脆弱性を解決します。解決される脆弱性は Common Vulnerability and Exposure の番号 [CVE-2004-3942](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3942) に割り当てられています。

**この脆弱性は**[**MS06-035**](http://technet.microsoft.com/security/bulletin/ms06-035)**および**[**MS06-040**](http://technet.microsoft.com/security/bulletin/ms06-040)**で修正されている脆弱性とどのように関連しますか?**
...
このセキュリティ更新プログラムはホットパッチをサポートします。ホットパッチおよびホットパッチとしてこのセキュリティ更新プログラムを適用する方法に関する詳細情報は、サポート技術情報 [897341](http://support.microsoft.com/kb/897341) をご覧ください。
...
-   Server サービスサービス拒否の脆弱性 ([CVE-2006-3942](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3942)) を報告してくださった [Core Security Technologies](http://www.coresecurity.com/) の Gerardo Richarte 氏
-   Server サービスのサービス拒否の脆弱性 ([CVE-2006-3942](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3942)) を報告してくださった [NS Focus](http://www.nsfocus.com/)
-   SMB の名前の変更の脆弱性 ([CVE-2006-4696](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4696)) を報告してくださった [Fortinet](http://www.fortinet.com/)
-   SMB の名前の変更の脆弱性 ([CVE-2006-4696](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4696)) を報告してくださった [VMWare](http://www.vmware.com/) の Matthew Amdur 氏
...
-   US マイクロソフトセキュリティ情報（MS06-063）
    [http://www.microsoft.com/technet/security/bulletin/MS06-063.mspx](http://technet.microsoft.com/security/bulletin/ms06-063)
-   サポート技術情報 （KB） 文書番号 ：923414
    [\[MS06-063\] Server サービスの脆弱性により、サービス拒否およびリモートでのコードの実行が起こる](http://support.microsoft.com/kb/923414)
