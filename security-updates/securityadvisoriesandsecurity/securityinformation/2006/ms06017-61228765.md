...
**このセキュリティ情報の対象となるユーザー:**  
 Microsoft FrontPage Server Extensions 2002 または SharePoint Team Services を使用しているお客様
...
**警告:**  
 サポート技術情報 [917627](http://support.microsoft.com/kb/917627) で、このセキュリティ更新プログラムのインストール時に発生する可能性がある既知の問題に関して説明されています。また、このサポート技術情報には、これらの問題に対する推奨される解決策に関する説明も記載されています。詳細情報は、サポート技術情報 [917627](http://support.microsoft.com/kb/917627) をご覧ください。
