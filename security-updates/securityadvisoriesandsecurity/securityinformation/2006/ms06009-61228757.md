...
**このセキュリティ情報の対象となるユーザー:**  
 Microsoft Windows または Microsoft Office をご使用のお客様
...
**含まれる過去のセキュリティ更新プログラム:**  
 このセキュリティ更新プログラムは [MS06-003](http://technet.microsoft.com/security/bulletin/ms06-003) の更新プログラム、具体的には Microsoft Office 2003 Multilingual User Interface Pack の韓国語版に置き換わるものです。
