...
<td style="border:1px solid black;"><p>以前のバージョンの機能すべて</p>
<p>SP2 クライアントの場合、クライアントはセルフライセンス認証を実行できます。</p>
<p>Version 1 クライアントの場合、クライアントはインターネット経由でライセンス認証を実行する必要があります。</p></td>
</tr>
<tr class="even">
...
<p>サーバー ロックボックス。</p>
<p>Microsoft SQL Server™ 2005 は製品そのままの状態でサポートされています。</p></td>
<td style="border:1px solid black;"><p>以前のバージョンのすべての機能と SP2 の機能。</p>
<p>サーバーのオフライン登録。</p>  
<p>SP2 クライアントの場合、クライアントはセルフライセンス認証を実行できます。</p>
<p>Version 1 クライアントの場合、クライアントはインターネット経由でライセンス認証を実行する必要があります。</p></td>
</tr>
