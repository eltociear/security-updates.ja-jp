...
<td style="border:1px solid black;">Urlscan.ini の [DenyExtensions] セクションを使用して、次のファイルを許可します。<br/><br/>
ASP 要求 : .asp、.cer、.cdx、.asa<br/><br/>
実行可能ファイル : .bat、.cmd、.com<br/><br/>
- .exe は WSUS 用に有効にする必要があることに注意してください。<br/><br/>
スクリプト : .htw、.ida、.idq、.htr、.idc、.shtm、.shtml、.stm、.printer<br/><br/>
