...
ms:contentKeyID: 18128253
ms:mtpsurl: 'https://technet.microsoft.com/ja-jp/library/Cc708563(v=WS.10)'
---
...
| ![](images/Cc708563.Important(WS.10).gif)重要 |
|----------------------------------------------------------------------------|
...
| ![](images/Cc708563.note(WS.10).gif)注                                                                                                                                                                                                                                                                                                                                                     |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
