...
ms:contentKeyID: 18128289
ms:mtpsurl: 'https://technet.microsoft.com/ja-jp/library/Cc708604(v=WS.10)'
---
...
| ![](images/Cc708604.note(WS.10).gif)注 |  
|---------------------------------------------------------------------|  
...
| ![](images/Cc708604.Important(WS.10).gif)重要                                                                         |  
|----------------------------------------------------------------------------------------------------------------------------------------------------|  
