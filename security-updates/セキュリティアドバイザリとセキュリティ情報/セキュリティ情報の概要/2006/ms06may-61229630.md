...
<span></span>
[MS06-018 : Windows の重要な更新](http://www.microsoft.com/japan/security/bulletins/ms06-018e.mspx)

[MS06-019 : Exchange の重要な更新](http://www.microsoft.com/japan/security/bulletins/ms06-019e.mspx)

[MS06-020 : Windows の重要な更新](http://www.microsoft.com/japan/security/bulletins/ms06-020e.mspx)
...
|------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| **タイトル**                 | [**Microsoft Exchange** **の脆弱性により、リモートでコードが実行される** **(916803)**](http://technet.microsoft.com/security/bulletin/ms06-019) |
...
|------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **タイトル**                 | [**Adobe** **の** **Macromedia Flash Player** **の脆弱性により、リモートでコードが実行される** **(913433)**](http://technet.microsoft.com/security/bulletin/ms06-020) |
...
|------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **タイトル**                 | [**Microsoft Distributed Transaction Coordinator (MSDTC)** **の脆弱性によりサービス拒否が起こる** **(913580)**](http://technet.microsoft.com/security/bulletin/ms06-018)                                                                 |
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e70515c7-8924-46da-8573-457957eea0d7&amp;displaylang=ja">注意</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 for Itanium-based Systems</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7bd81335-79ea-46ce-8d3c-0aa91eefff02&amp;displaylang=ja">注意</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows XP Service Pack 1</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=d80b43b2-727b-46b6-82d1-f2cbd916fe32&amp;displaylang=ja">注意</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b2b8f9a8-4874-405a-9f0c-768b2631673a&amp;displaylang=ja">緊急</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8b98f380-0e5c-4b80-9710-95e1b35afd83&amp;displaylang=ja">警告</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><p><strong>影響を受けるExchangeのソフトウェア:</strong></p></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f32574e0-f35c-4537-9ad0-524cb49afe53&amp;displaylang=ja">緊急</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Exchange Server 2003 Service Pack 2</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=82ae4397-0982-4585-84c1-dc1af6944a0f&amp;displaylang=ja">緊急</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Exchange 2000 Server Service Pack 3
<p>注　2004 年 8 月公開の Exchange 2000 Server Service Pack 3 以降の更新プログラムのロールアップを適用している必要があります</p></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e72c8f94-782f-4670-9221-e2e37eadb8ec&amp;displaylang=ja">緊急</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   [MS06-018](http://technet.microsoft.com/security/bulletin/ms06-018) の問題を報告してくださった [eEye Digital Security](http://www.eeye.com/html/) 社  
-   [MS06-018](http://technet.microsoft.com/security/bulletin/ms06-018) の問題を報告してくださった [McAfee](http://www.mcafee.com/) 社のXiao Chen 氏  
-   [MS06-018](http://technet.microsoft.com/security/bulletin/ms06-018) の問題を報告してくださった [VenusTech](http://www.venustech.com.cn/) の Kai Zhang 氏
