...
<td style="border:1px solid black;">
[**Windows IME の特権の昇格の脆弱性 - CVE-2016-7221**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7221)

</td>
<td style="border:1px solid black;">
[**タスク スケジューラの特権の昇格の脆弱性 - CVE-2016-7222**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7222)

</td>
<td style="border:1px solid black;">
[**Windows のリモートでコードが実行される脆弱性 - CVE-2016-7212**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7212)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 for 32-bit Systems Service Pack 2](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3196718)  
(3196718)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 for x64-based Systems Service Pack 2](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3196718)  
(3196718)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 for Itanium-based Systems Service Pack 2](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3196718)  
(3196718)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 for 32-bit Systems Service Pack 2](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3190847) (Server Core インストール)  
(3193418)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 for x64-based Systems Service Pack 2](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3190847) (Server Core インストール)  
(3193418)
...
<tr class="even">
<td style="border:1px solid black;"><p>Windows IME の特権の昇格の脆弱性</p></td>
