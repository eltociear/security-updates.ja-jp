...
<p>(KB929062) クライアント用更新プログラムおよび管理者用更新プログラム</p></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=20e089e7-7dd3-44a4-abfe-6d8c27721683&amp;displaylang=ja"><img src="images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<p>(KB929063) クライアント用更新プログラムおよび管理者用更新プログラム</p></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c54b1fda-1237-48f7-ad19-f0830ee0e8ff&amp;displaylang=ja"><img src="images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><img src="images/Dn610139.ot_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="odd">
...
<p>(KB929064) クライアント用更新プログラムおよび管理者用更新プログラム</p></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=bb0973e7-275d-4491-9ba1-91eaea84eefd&amp;displaylang=ja"><img src="images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><img src="images/Dn610139.ot_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Microsoft Project 2000 Service Release 1</strong>
<p>(KB929062)クライアント用更新プログラムおよび管理者用更新プログラム<br />
上述の Office 2000 Service Pack 3 (KB929062) とは別の更新プログラムです</p></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=3df54b5c-cb82-4a99-9b90-edab38ad6310&amp;displaylang=ja"><img src="images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<p>(KB929063) クライアント用更新プログラムおよび管理者用更新プログラム<br />
上述の Office XP Service Pack 3 (KB929063) とは別の更新プログラムです</p></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=419191dc-01b8-4e2a-ba5b-71bf3066c169&amp;displaylang=ja"><img src="images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><img src="images/Dn610139.ot_s(ja-JP,Security.10).gif" /><br />
</td>
</tr>
<tr class="even">
...
<p>(KB929063) クライアント用更新プログラムおよび管理者用更新プログラム<br />
上述の Office XP Service Pack 3 (KB929063) とは別の更新プログラムです</p></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f50a5111-0926-4221-96df-18294230ed1e&amp;displaylang=ja"><img src="images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><img src="images/Dn610139.ot_s(ja-JP,Security.10).gif" /><br />
</td>
</tr>
</tbody>
...
<p>(KB932185) クライアント用更新プログラムおよび管理者用更新プログラム</p></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/japan/mac/downloads.mspx"><img src="images/Dn610139.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
</tr>
</tbody>
</table>
...
|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|-----------------------|---------------------|-----------------------|-------------------------------|  
| PowerPoint の不正な形式のレコード メモリの破損の脆弱性 - [CVE-2006-3877](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3877) | リモートでコードが実行される | 緊急                  | 重要                | 重要                  | 重要                          |  
| Excel の不正な形式のレコードの脆弱性 - [CVE-2007-0671](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0671)                   | リモートでコードが実行される | 緊急                  | 重要                | 重要                  | 重要                          |  
...
|---------------------------------------------------------------------|-----------------------|---------------------|-----------------------|-------------------------------|  
| [MS06-062](http://technet.microsoft.com/security/bulletin/ms06-062) | 置き換わる            | 置き換わる          | 置き換わる            | 置き換わる                    |
...
1.  [Office 2000 用のセキュリティ更新プログラム](http://download.microsoft.com/download/1/3/0/130dc99d-e1bf-4087-936d-ca39adc6cbc8/office2000-kb929062-fullfile-jpn.exe)または [Project 2000 Service Pack 1 用のセキュリティ更新プログラム](http://download.microsoft.com/download/b/9/5/b95cb38c-f65e-4198-8283-bee4c030c550/project2000-kb929062-fullfile-jpn.exe)をダウンロードしてください。  
...
1.  [Office XP 用のセキュリティ更新プログラム](http://download.microsoft.com/download/e/f/1/ef1f70a9-751d-46f9-85b4-632db8124f61/officexp-kb929063-fullfile-jpn.exe)および [Project 2002 Service Pack 1 (SP1) 用のセキュリティ更新プログラム](http://download.microsoft.com/download/c/2/0/c2004c89-b05e-4d85-a046-dda910d5f664/project2002-kb929063-fullfile-jpn.exe)および [Visio 2002 Service Pack 2 (SP2) 用のこのセキュリティ更新プログラム](http://download.microsoft.com/download/9/c/3/9c358d05-1588-45ed-8018-04a4a49eb80f/visio2002-kb929063-fullfile-jpn.exe)をダウンロードしてください。  
2.  \[このプログラムをディスクに保存する\] をクリックし、次に \[OK\] をクリックします。  
3.  \[保存\] をクリックします。  
4.  Windows エクスプローラを使用して、保存されたファイルを含むフォルダを検索し、次に保存されたファイルをダブルクリックします。  
5.  更新プログラムのインストールの確認メッセージが表示されたら、\[はい\] をクリックします。  
...
1.  [Office 2003 用のセキュリティ更新プログラムをダウンロードします。](http://download.microsoft.com/download/6/b/5/6b5b56c2-f2b1-4a02-9016-40ca3bd83fa5/office2003-kb929064-fullfile-jpn.exe)  
2.  \[このプログラムをディスクに保存する\] をクリックし、次に \[OK\] をクリックします。  
3.  \[保存\] をクリックします。  
4.  Windows エクスプローラを使用して、保存されたファイルを含むフォルダを検索し、次に保存されたファイルをダブルクリックします。  
5.  更新プログラムのインストールの確認メッセージが表示されたら、\[はい\] をクリックします。  
...
-   PowerPoint の不正な形式のレコード メモリの破損の脆弱性 - [CVE-2006-3877](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3877) を報告してくださった [VigilantMinds Inc.](http://www.vigilantminds.com/) の Chris Ries 氏
...
-   US マイクロソフトセキュリティ情報 (MS07-015）  
    [http://www.microsoft.com/technet/security/bulletin/MS07-015.mspx](http://technet.microsoft.com/security/bulletin/ms07-015)  
-   サポート技術情報 （KB） 文書番号 ：932554  
    [\[MS07-015\] Microsoft Office の脆弱性により、リモートでコードが実行される](http://support.microsoft.com/kb/932554)
