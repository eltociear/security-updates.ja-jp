...
**既知の問題:** [サポート技術情報 2566220](http://support.microsoft.com/kb/2566220) で、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。

**USマイクロソフトセキュリティ情報：**[http://www.microsoft.com/technet/security/bulletin/MS11-053.mspx](http://technet.microsoft.com/security/bulletin/ms11-053)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6bff74ac-45f3-4585-92da-316921b458fa&amp;displaylang=ja">Windows Vista Service Pack 1</a>[1]<br />
(KB2561109)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a1e5aa7d-5f38-4ce2-9575-4b4cb7520160&amp;displaylang=ja">Windows Vista Service Pack 2</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=849d2694-c8b3-4670-8203-912661bccabf&amp;displaylang=ja">Windows Vista x64 Edition Service Pack 1</a>[1]<br />
(KB2561109)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4287eeb4-ab29-4727-83f2-260d838b44d4&amp;displaylang=ja">Windows Vista x64 Edition Service Pack 2</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7f811b75-c3ff-411a-aaa9-126dce34cc01&amp;displaylang=ja">Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=90b2da71-18f9-46ee-9e3d-b08620ca06aa&amp;displaylang=ja">Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">緊急</td>
<td style="border:1px solid black;">なし</td>
...
Windows Vista Service Pack 1 が影響を受けるのは、Bluetooth 2.1 テクノロジがサポートされているコンピューターにおいてだけです。[Windows Vista Feature Pack for Wireless](http://support.microsoft.com/kb/942567) をインストールしたお客様の Windows Vista Service Pack 1 搭載コンピューターは、Bluetooth 2.1 テクノロジをサポートしているため、この脆弱性の影響を受けます。該当するお客様は、セキュリティ更新プログラム KB2561109 をインストールする必要があります。Windows Vista Feature Pack for Wireless をインストールしていない場合は、Bluetooth 2.1 がサポートされていないため、この脆弱性による影響は受けません。詳細については、[サポート技術情報 2566220](http://support.microsoft.com/kb/2566220) を参照してください。
...
Windows Vista Service Pack 1 のユーザーが、Windows Vista Service Pack 1 に [Windows Vista Feature Pack for Wireless](http://support.microsoft.com/kb/942567) を適用した後、Windows Vista Service Pack 2 にアップグレードした場合、セキュリティ更新プログラム KB2532531 をインストールする必要があります。詳細については、[サポート技術情報 2566220](http://support.microsoft.com/kb/2566220) を参照してください。
...
<tr class="header">
<th>影響を受けるソフトウェア</th>
<th>Bluetooth スタックの脆弱性 - CVE-2011-1265</th>
<th>総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1265](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1265) を参照してください。
...
**Bluetooth とは何ですか?**    
Bluetooth は業界標準のプロトコルで、コンピューター、ハンドヘルド デバイス、携帯電話などのデバイスの無線接続を有効にします。詳細については、MSDN の記事 [Bluetooth](http://msdn.microsoft.com/en-us/library/aa362932(vs.85).aspx) (英語情報) を参照してください。
...
<a href="http://support.microsoft.com/kb/2561109">サポート技術情報 2561109</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Vista Service Pack 2:<br />
<a href="http://support.microsoft.com/kb/2532531">サポート技術情報 2532531</a> を参照してください。</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>ファイルに関する情報</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2532531">サポート技術情報 2532531</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>レジストリ キーの確認</strong></td>
<td style="border:1px solid black;"><strong>注</strong>: この更新プログラムが存在しているかどうかを検証するためのレジストリ キーはありません。</td>
