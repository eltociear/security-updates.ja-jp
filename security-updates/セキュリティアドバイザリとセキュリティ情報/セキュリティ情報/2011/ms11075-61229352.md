---
TOCTitle: 'MS11-075'
Title: 'マイクロソフト セキュリティ情報 MS11-075 - 重要'
ms:assetid: 'ms11-075'
ms:contentKeyID: 61229352
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms11-075(v=Security.10)'
---
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=96af60b9-4b8d-4a9b-b125-10775bb48252&amp;displaylang=ja">Windows XP Service Pack 3</a><br />
(KB2564958)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c8fcf427-17d0-4caa-b406-50703f980862&amp;displaylang">Windows XP Professional x64 Edition Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=09e178f8-2bd2-46e1-b975-4938ee1f304d&amp;displaylang=ja">Windows Server 2003 Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9b8030db-1f47-4666-8cb5-1c56577f2340&amp;displaylang">Windows Server 2003 x64 Edition Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=82653b8c-0e58-440d-9702-8847f599caed">Windows Server 2003 with SP2 for Itanium-based Systems</a><br />
(KB2605295)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">なし</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=96b089c0-a2e7-44cb-9fc4-9569b3993afa&amp;displaylang=ja">Windows Vista Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/japan/technet/security/bulletin/ms11-038.mspx">MS11-038</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b79a389c-8340-4dd2-9ab1-a0943c5a220f&amp;displaylang=ja">Windows Vista x64 Edition Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/japan/technet/security/bulletin/ms11-038.mspx">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7cd1ecec-8a3f-4cb2-833c-a177c9602ff5&amp;displaylang=ja">Windows Server 2008 for 32-bit Systems Service Pack 2</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/japan/technet/security/bulletin/ms11-038.mspx">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=456e450c-3928-4130-8127-e4d3f482c1ca&amp;displaylang=ja">Windows Server 2008 for x64-based Systems Service Pack 2</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/japan/technet/security/bulletin/ms11-038.mspx">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2e9930d3-ba13-446d-bfa0-60720c48203b&amp;displaylang=ja">Windows Server 2008 for Itanium-based Systems Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/japan/technet/security/bulletin/ms11-038.mspx">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=02d28e59-b38f-433a-a568-e86f9d43dd42&amp;displaylang=ja">Windows 7 for 32-bit Systems および Windows 7 for 32-bit Systems Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/japan/technet/security/bulletin/ms11-038.mspx">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=904dec69-e8b9-4b23-a5ea-d3e7e9b9df07&amp;displaylang=ja">Windows 7 for x64-based Systems および Windows 7 for x64-based Systems Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/japan/technet/security/bulletin/ms11-038.mspx">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c7bd50b7-03f1-4ea4-ad71-d428822c62f8&amp;displaylang=ja">Windows Server 2008 R2 for x64-based Systems および Windows Server 2008 R2 for x64-based Systems Service Pack 1</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/japan/technet/security/bulletin/ms11-038.mspx">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=aa816682-9652-433c-b1b4-5d0bc17b6a87&amp;displaylang=ja">Windows Server 2008 R2 for Itanium-based Systems および Windows Server 2008 R2 for Itanium-based Systems Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">リモートでコードが実行される</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/japan/technet/security/bulletin/ms11-038.mspx">MS11-038</a></td>
...
はい。この更新プログラムが解決する脆弱性は、[マイクロソフト セキュリティ アドバイザリ 2269637](http://technet.microsoft.com/japan/security/advisory/2269637) で説明している、アプリケーションが外部ライブラリをロードする仕組みに影響する脆弱性の一種です。このセキュリティ更新プログラムはこの種の脆弱性の特定の問題を解決します。
...
<th style="border:1px solid black;" >Active Accessibility コンポーネントの安全でないライブラリのロードの脆弱性 - CVE-2011-1247</th>
<th style="border:1px solid black;" >総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Active Accessibility コンポーネントの安全でないライブラリのロードの脆弱性 - CVE-2011-1247  
-----------------------------------------------------------------------------------------
  
<span></span>
Microsoft Active Accessibility コンポーネントが DLL ファイルのロードを処理する方法に、リモートでコードが実行される脆弱性が存在します。攻撃者がこの脆弱性の悪用に成功した場合、影響を受けるシステムを完全に制御する可能性があります。攻撃者は、その後、プログラムのインストール、データの表示、変更、削除などを行ったり、完全なユーザー権限を持つ新たなアカウントを作成したりする可能性があります。コンピューターでのユーザー権限が低い設定のアカウントを持つユーザーは、管理者特権で実行しているユーザーよりもこの脆弱性による影響が少ないと考えられます。
  
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2011-1247](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1247) を参照してください。
  
#### 「Active Accessibility の安全でないライブラリのロードの脆弱性」の問題を緩和する要素 - CVE-2011-1247
...
#### 「Active Accessibility の安全でないライブラリのロードの脆弱性」の回避策 - CVE-2011-1247
...
#### 「Active Accessibility の安全でないライブラリのロードの脆弱性」のよく寄せられる質問 - CVE-2011-1247
...
**何が原因で起こりますか?**  
この脆弱性は、Microsoft Active Accessibility コンポーネントが外部ライブラリをロードするために使用するパスを正しく制限しないことにより起こります。
  
**Microsoft Active Accessibility コンポーネントとは何ですか?**  
Microsoft Active Accessibility コンポーネントは、アクセシビリティ製品と Microsoft Windows 上で実行されているアプリケーションの連携方法を改善する、コンポーネント オブジェクト モデル (COM) ベースのテクノロジです。オペレーティング システムに組み込まれるダイナミック リンク ライブラリや、UI 要素に関する情報を公開するたしかな手段である COM インターフェイスおよび API 要素が提供されます。詳細については、MSDN の「[Microsoft Active Accessibility](http://msdn.microsoft.com/ja-jp/library/ms971350.aspx)」を参照してください。
...
攻撃者は、特別に細工されたダイナミック リンク ライブラリ (DLL) ファイルと同じネットワーク ディレクトリにある正当なファイルをユーザーに開かせることにより、この脆弱性を悪用する可能性があります。次に、正当なファイルを開いている間に Microsoft Active Accessibility コンポーネントが DLL ファイルをロードし、それに含まれている任意のコードを実行しようとする可能性があります。
  
電子メールの攻撃のシナリオで、攻撃者は正当な添付ファイルをユーザーに送り、ユーザーにその添付ファイルを特別な細工がされた DLL ファイルを含むディレクトリに置き、その正当なファイルを開かせることにより、この脆弱性を悪用する可能性があります。次に、正当なファイルを開いている間に Microsoft Active Accessibility コンポーネントが DLL ファイルをロードし、それに含まれている任意のコードを実行しようとする可能性があります。
...
この更新プログラムは、Microsoft Active Accessibility コンポーネント が外部のライブラリをロードする方法を修正して、この脆弱性を解決します。
...
WindowsXP-KB2564958-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2564958-x64-jpn.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
WindowsXP-KB2564958-x86-jpn.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2564958-x64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">[コントロール パネル]<strong></strong>の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2564958$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>ファイルに関する情報:</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2564958">マイクロソフト サポート技術情報 2564958</a> を参照してください。</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
すべてのサポートされている 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2564958-x86-jpn.exe /quiet
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KBKB2564958-x64-jpn.exe /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2605295-ia64-jpn.exe /quiet
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
すべてのサポートされている 32-bit エディションの Windows Server 2003:  
WindowsServer2003-KB2564958-x86-jpn.exe /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
すべてのサポートされている x64-based エディションの Windows Server 2003:  
WindowsServer2003.WindowsXP-KBKB2564958-x64-jpn.exe /norestart
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
すべてのサポートされている Itanium-based エディションの Windows Server 2003:  
WindowsServer2003-KB2605295-ia64-jpn.exe /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
すべてのサポートされている 32-bit および x64-based エディションの Windows Server 2003:  
KB2564958.log
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
このセキュリティ更新プログラムはホットパッチをサポートしません。ホットパッチの詳細については、[マイクロソフト サポート技術情報 897341](http://support.microsoft.com/kb/897341) を参照してください。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
すべてのサポートされている 32-bit および x64-based エディションの Windows Server 2003:  
\[コントロール パネル\]****の \[プログラムの追加と削除\] または %Windir%\\$NTUninstallKB2564958$\\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
すべてのサポートされている Itanium-based エディションの Windows Server 2003:  
\[コントロール パネル\] の****\[プログラムの追加と削除\] または %Windir%\\$NTUninstallKB2605295$\\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
すべてのサポートされている 32-bit および x64-based エディションの Windows Server 2003:  
[マイクロソフト サポート技術情報 2564958](http://support.microsoft.com/kb/2564958) を参照してください。
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
すべてのサポートされている Itanium-based エディションの Windows Server 2003:  
[マイクロソフト サポート技術情報 2605295](http://support.microsoft.com/kb/2605295) を参照してください。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>この修正を含む予定の</strong> <strong>サービス パック</strong></td>
<td style="border:1px solid black;">この問題に対する更新プログラムは今後リリースされるサービス パックまたは更新プログラムのロールアップに含まれる予定です。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>適用</strong></td>
...
この問題を連絡し、顧客の保護に協力してくださった下記の方に対し、マイクロソフトは深い[謝意](http://www.microsoft.com/japan/technet/security/bulletin/policy.mspx)を表します。
  
-   [Adobe Systems, Inc.](http://www.adobe.com) の Anshul Kothari 氏および Nishant Kaushik 氏と協力して Active Accessibility コンポーネントの安全でないライブラリのロードの脆弱性について報告してくださった[Mila Parkour](http://contagiodump.com) 氏 (CVE-2011-1247)
