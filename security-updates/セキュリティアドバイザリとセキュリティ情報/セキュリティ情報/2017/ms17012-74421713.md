...
<tr class="even">
<td style="border:1px solid black;"><p>Device Guard のセキュリティ機能のバイパスの脆弱性</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>SMBv2/SMBv3 の Null 逆参照のサービス拒否の脆弱性</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>Windows DNS クエリの情報漏えいの脆弱性</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>Windows COM の特権の昇格の脆弱性</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>iSNS Server のメモリ破損の脆弱性</p></td>
