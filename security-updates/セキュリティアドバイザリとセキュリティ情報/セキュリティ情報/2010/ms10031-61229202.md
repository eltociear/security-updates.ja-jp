...
-   **VBE6.dll へのアクセスを制限する**
    ...
    `takeown /f "%ProgramFiles%\Common Files\Microsoft Shared\VBA\VBA6\vbe6.dll"icacls "%ProgramFiles%\Common Files\Microsoft Shared\VBA\VBA6\vbe6.dll" /save %TEMP%\VBE6 _ACL.TXTicacls "%ProgramFiles%\Common Files\Microsoft Shared\VBA\VBA6\vbe6.dll" /deny everyone:(F)`
    ...
    **回避策の解除方法:**
    ...
    `takeown /f "%ProgramFiles%\Common Files\Microsoft Shared\VBA\VBA6\vbe6.dll"icacls "%ProgramFiles%\Common Files\Microsoft Shared\VBA\VBA6\vbe6.dll" /restore %TEMP%\VBE6_ACL.TXT`
