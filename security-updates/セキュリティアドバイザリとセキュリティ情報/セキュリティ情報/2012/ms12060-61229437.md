...
既知の問題: [マイクロソフト サポート技術情報 2720573](http://support.microsoft.com/kb/2720573/ja) で、このセキュリティ更新プログラムをインストールする際に起こる可能性のある既知の問題に関して説明しています。また、これらの問題に対する推奨される解決策についても説明しています。なお、既知の問題および推奨される解決策がソフトウェアの特定のリリースにのみ該当する場合は、サポート技術情報に関連のリンクを掲載します。
...
<td style="border:1px solid black;">
[MS12-027](http://go.microsoft.com/fwlink/?linkid=246275) の KB2597112 は KB2687323 または KB2726929 に置き換えられます。
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-027](http://go.microsoft.com/fwlink/?linkid=246275) の KB2598041 は KB2687441 に置き換えられます。
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-027](http://go.microsoft.com/fwlink/?linkid=246275) の KB2598039 は KB2597986 に置き換えられます。
</td>
</tr>
</table>
<p> </p>
...
<td style="border:1px solid black;">
[MS12-027](http://go.microsoft.com/fwlink/?linkid=246275) の KB983808 は KB983812 に置き換えられます。  
[MS12-027](http://go.microsoft.com/fwlink/?linkid=246275) の KB983809 は KB983811 に置き換えられます。
</td>
</tr>
</table>
<p> </p>
...
<td style="border:1px solid black;">
[MS12-027](http://go.microsoft.com/fwlink/?linkid=246275) の KB983807 は KB983813 に置き換えられます。
</td>
</tr>
<tr>
<th colspan="4">
...
<td style="border:1px solid black;">
[MS12-027](http://go.microsoft.com/fwlink/?linkid=246275) の KB2645025 は KB2716389 に置き換えられます。
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-027](http://go.microsoft.com/fwlink/?linkid=246275) の KB2658677 は KB2716390 に置き換えられます。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-027](http://go.microsoft.com/fwlink/?linkid=246275) の KB2655547 は KB2716392 に置き換えられます。
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-027](http://go.microsoft.com/fwlink/?linkid=246275) の KB2658676 は KB2716393 に置き換えられます。
</td>
</tr>
<tr>
<th colspan="4">
...
<td style="border:1px solid black;">
[MS12-027](http://go.microsoft.com/fwlink/?linkid=246275) の KB2647488 は KB2708940 に置き換えられます。
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-027](http://go.microsoft.com/fwlink/?linkid=246275) の KB2647490 は KB2708941 に置き換えられます。
</td>
</tr>
<tr>
<th colspan="4">
...
<td style="border:1px solid black;">
[MS12-027](http://go.microsoft.com/fwlink/?linkid=246275) の KB2641426 は KB2708437 に置き換えられます。
</td>
</tr>
</table>
<p> </p>
...
ActiveX コントロールを再配布する開発者は、アプリケーションにインストールされている ActiveX コントロールのバージョンが、このセキュリティ情報で提供している更新プログラムをダウンロードして更新されたバージョンであることを確認してください。再配布されたコンポーネントの使用についての最善策の詳細については、[マイクロソフト サポート技術情報 835322](http://support.microsoft.com/kb/835322/ja) および [Isolated Applications and Side-by-side Assemblies](http://msdn.microsoft.com/library/dd408052.aspx) (英語情報) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-1856](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1856) を参照してください。
...
-   既定で、Windows Server 2003、Windows Server 2008 および Windows Server 2008 R2 上の Internet Explorer は、「[セキュリティ強化の構成](http://technet.microsoft.com/ja-jp/library/dd883248.aspx)」と呼ばれる制限されたモードで実行されます。このモードは、この脆弱性の影響を緩和します。Internet Explorer のセキュリティ強化の構成に関する詳細については、このセキュリティ更新プログラムに関する「よく寄せられる質問」を参照してください。
...
-   脆弱性の影響を受ける ActiveX コントロールが Internet Explorer で実行されないようにする
    ...
    2.  .reg ファイルをダブルクリックして、個別のシステムに適用します。
        注:変更を有効にするには、Internet Explorer を再起動する必要があります。グループ ポリシーを使用し、ドメインに適用することもできます。グループ ポリシーの詳細については、TechNet の記事「[Group Policy collection](http://go.microsoft.com/fwlink/?linkid=215719) 」をご参照ください。
...
| ファイルに関する情報                 | [サポート技術情報 2726929](http://support.microsoft.com/kb/2726929/ja) を参照してください。                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| レジストリ キーの確認                | 対象外                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| ファイルに関する情報                 | [サポート技術情報 2687441](http://support.microsoft.com/kb/2687441/ja) を参照してください。                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| レジストリ キーの確認                | 対象外                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| ホットパッチ                         | 対象外                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 削除に関する情報                     | この更新プログラムは削除することができません。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ファイルに関する情報                 | [サポート技術情報 2597986](http://support.microsoft.com/kb/2597986/ja) を参照してください。                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| レジストリ キーの確認                | 対象外                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
<td style="border:1px solid black;">SQL Server 2000 Analysis Services Service Pack 4:<br />
<a href="http://support.microsoft.com/kb/983813/ja">マイクロソフト サポート技術情報 983813</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft SQL Server 2000 Service Pack 4 の GDR 用の更新プログラム:<br />
詳細については、<a href="http://support.microsoft.com/kb/983812/ja">サポート技術情報 983812</a> を参照してください。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft SQL Server 2000 Service Pack 4 の QFE 用の更新プログラム:<br />
詳細については、<a href="http://support.microsoft.com/kb/983811/ja">サポート技術情報 983811</a> を参照してください。</td>
</tr>
</tbody>
</table>
<p> </p>
...
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;">詳細については、<a href="http://support.microsoft.com/kb/2716389/ja">サポート技術情報 2716389</a> を参照してください。</td>
</tr>  
<tr class="even">
...
-   Microsoft Baseline Security Analyzer
    ...
    影響を受けるコンピューターにセキュリティ更新プログラムが適用されていることを確認するために、Microsoft Baseline Security Analyzer (MBSA) ツールを使用することができます。管理者は、一般的なセキュリティ上誤った構成とともに、不足しているセキュリティ更新プログラムについて、ローカル コンピューターおよびリモート コンピューターを Microsoft Baseline Security Analyzer (MBSA) を使ってスキャンすることができます。MBSA に関する追加情報は、[Microsoft Baseline Security Analyzer の Web サイト](http://go.microsoft.com/fwlink/?linkid=21134)を参照してください。
...
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;">詳細については、<a href="http://support.microsoft.com/kb/2716390/ja">サポート技術情報 2716390</a> を参照してください。</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">レジストリ キーの確認</td>
<td style="border:1px solid black;">キーファイルのバージョン (mscomctl.ocx) を使用して更新プログラムのインストールを確認します</td>
...
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;">詳細については、<a href="http://support.microsoft.com/kb/2716392/ja">サポート技術情報 2716392</a> を参照してください。</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">レジストリ キーの確認</td>
<td style="border:1px solid black;">キーファイルのバージョン (mscomctl.ocx) を使用して更新プログラムのインストールを確認します</td>
...
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;">詳細については、<a href="http://support.microsoft.com/kb/2716393/ja">サポート技術情報 2716393</a> を参照してください。</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">レジストリ キーの確認</td>
<td style="border:1px solid black;">キーファイルのバージョン (mscomctl.ocx) を使用して更新プログラムのインストールを確認します</td>
...
| ファイルに関する情報                 | 詳細については、[サポート技術情報 2711207](http://support.microsoft.com/kb/2711207/ja) を参照してください。                                                                                                                               |  
...
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;">詳細については、<a href="http://support.microsoft.com/kb/2708940/ja">サポート技術情報 2708940</a> を参照してください。</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">レジストリ キーの確認</td>
...
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;">詳細については、<a href="http://support.microsoft.com/kb/2708941/ja">サポート技術情報 2708941</a> を参照してください。</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">レジストリ キーの確認</td>
...
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報</td>
<td style="border:1px solid black;">詳細については、<a href="http://support.microsoft.com/kb/2708437/ja">サポート技術情報 2708437</a> を参照してください。</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">レジストリ キーの確認</td>
