...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2522](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2522) を参照してください。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-CVE-2012-2523](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2523) を参照してください。
...
注: この更新プログラムでは、Internet Explorer 8 の脆弱性は解決しません。Internet Explorer 8 の場合、更新プログラムは [MS12-056](http://go.microsoft.com/fwlink/?linkid=256487) で説明されている KB2706045 更新プログラムを通じて利用可能です。

Internet Explorer 8 をコンピューターにインストールしています。CVE-2012-2523 を解決する更新プログラムはどこで入手できますか? 
システムに Internet Explorer 8 をインストールしているお客様は、[MS12-056](http://go.microsoft.com/fwlink/?linkid=256487) で説明している KB2706045 更新プログラムをインストールすることで、CVE-2012-2523 で説明している脆弱性を解決できます。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2722913/ja">マイクロソフト サポート技術情報 2722913</a> を参照してください。</td>
</tr>
<tr class="even">
...
-   [VeriSign iDefense Labs](http://labs.idefense.com/) に協力して、レイアウトのメモリ破損の脆弱性 (CVE-2012-1526) を報告してくださった GWSlabs  
-   [Beyond Security の SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html) プログラムに協力して、非同期の NULL オブジェクト アクセスにより、リモートでコードが実行される脆弱性 (CVE-2012-2521) を報告してくださった Derek Soeder 氏  
-   仮想関数テーブルの破損により、リモートでコードが実行される脆弱性 (CVE-2012-2522) を報告してくださった [Trend Micro](http://www.trendmicro.com/) の Sung-ting Tsai 氏および Ming-Chieh Pan 氏  
-   JavaScript 整数オーバーフローのリモートでコードが実行される脆弱性 (CVE-2012-2523) を報告してくださった [Google's Chrome Security Team](http://chrome.google.com/) の Cris Neckar 氏
