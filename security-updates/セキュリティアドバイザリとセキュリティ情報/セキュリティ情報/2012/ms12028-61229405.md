...
<td style="border:1px solid black;">
[MS09-024](http://go.microsoft.com/fwlink/?linkid=128104) の KB969559 は、KB2596871 に置き換えられる
</td>
</tr>
<tr>
<th colspan="4">
...
<td style="border:1px solid black;">
[MS10-105](http://go.microsoft.com/fwlink/?linkid=147425) の KB2431831 は、KB2680317 に置き換えられる
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS09-024](http://go.microsoft.com/fwlink/?linkid=128104) の KB968326 は、KB2680326 に置き換えられる
</td>
</tr>
</table>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-0177](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0177) を参照してください。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2596871/ja">サポート技術情報 2596871</a> を参照してください。</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;">Microsoft Works 9 については、<a href="http://support.microsoft.com/kb/2680317/ja">サポート技術情報 2680317</a> を参照してください。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Works 6-9 ファイル コンバーターについては、<a href="http://support.microsoft.com/kb/2680326/ja">サポート技術情報 2680326</a> を参照してください。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">レジストリ キーの確認</td>
<td style="border:1px solid black;">対象外</td>
...
-   Office WPS コンバーターのヒープ オーバーフローの脆弱性」 - CVE-2012-0177 を報告してくださった [IOActive, Ltd.](http://ioactive.co.uk/) の Shaun Colley 氏
