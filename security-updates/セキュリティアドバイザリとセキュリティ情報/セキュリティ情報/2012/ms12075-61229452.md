---
TOCTitle: 'MS12-075'
Title: 'マイクロソフト セキュリティ情報 MS12-075 - 緊急'
ms:assetid: 'ms12-075'
ms:contentKeyID: 61229452
ms:mtpsurl: 'https://technet.microsoft.com/ja-JP/library/ms12-075(v=Security.10)'
---

Security Bulletin

マイクロソフト セキュリティ情報 MS12-075 - 緊急
===============================================

Windows カーネルモード ドライバーの脆弱性により、リモートでコードが実行される (2761226)
---------------------------------------------------------------------------------------

公開日: 2012年11月13日 | 最終更新日: 2012年11月15日
...
このセキュリティ更新プログラムは、非公開で報告された 3 件の Microsoft Windows に存在する脆弱性を解決します。最も深刻な場合、ユーザーが特別な細工がされた文書を開いた場合や、TrueType フォント ファイルが埋め込まれた悪意のある Web ページを表示した場合に、この脆弱性によりリモートでコードが実行される可能性があります。通常、ユーザーに電子メール メッセージ内のリンクをクリックさせて攻撃者の Web サイトに誘導することにより、ユーザーを攻撃者の Web サイトに訪問させることが攻撃者にとっての必要条件となります。
...
<td style="border:1px solid black;">
[MS12-055](http://go.microsoft.com/fwlink/?linkid=257907) の KB2731847 は KB2761226 に置き換えられる
</td>
</tr>
...
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの情報については、[サポート技術情報 2761226](https://support.microsoft.com/kb/2761226/ja) を参照してください。

Windows 8 Release Preview および Windows Server 2012 Release Preview Candidate は、このセキュリティ情報で説明している脆弱性の影響を受けますか？
はい。Windows 8 Release Preview および Windows Server 2012 Release Candidate 用の KB2761226 の更新プログラムが利用可能です。Windows 8 Release Preview および Windows Server 2012 RC 版をご使用のお客様は、システムにこの更新プログラムを適用することをお勧めします。この更新プログラムは [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) でのみ利用可能です。
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2530](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2530) を参照してください。

#### 「Win32k の解放後使用の脆弱性」の問題を緩和する要素 – CVE-2012-2530

緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。

-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。

#### 「Win32k の解放後使用の脆弱性」の回避策 – CVE-2012-2530

マイクロソフトは、この脆弱性の回避策を確認していません。

#### 「Win32k の解放後使用の脆弱性」のよく寄せられる質問 – CVE-2012-2530
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2553](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2553) を参照してください。

#### 「Win32k の解放後使用の脆弱性」の問題を緩和する要素 – CVE-2012-2553

緩和する要素は、既定の状態における設定、一般的な構成または最善策を示し、脆弱性悪用の深刻度が下がる場合があります。お客様の状況で、次の「緩和する要素」が役立つ場合があります。

-   この脆弱性が悪用されるには、有効な資格情報を所有し、ローカルでログオンできることが攻撃者にとっての必要条件となります。

#### 「Win32k の解放後使用の脆弱性」の回避策 – CVE-2012-2553

マイクロソフトは、この脆弱性の回避策を確認していません。

#### 「Win32k の解放後使用の脆弱性」のよく寄せられる質問 – CVE-2012-2553
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2897](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2897) を参照してください。

#### 「TrueType フォントの解析の脆弱性」の問題を緩和する要素 - CVE-2012-2897
...
#### 「TrueType フォントの解析の脆弱性」の回避策 - CVE-2012-2897

マイクロソフトは、この脆弱性の回避策を確認していません。

#### 「TrueType フォントの解析の脆弱性」のよく寄せられる質問 - CVE-2012-2897

この脆弱性により、どのようなことが起こる可能性がありますか? 
これはリモートでコードが実行される脆弱性です。

何が原因で起こりますか? 
この脆弱性は、Windows が特別に細工された TrueType フォント (TTF) を適切に処理できない場合に起こります。
...
この更新プログラムはどのように問題を修正しますか? 
この更新プログラムは Windows が特別に細工された TrueType フォント ファイルを処理する方法を修正して、この脆弱性を解決します。
...
WindowsXP-KB2761226-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2761226-x64-jpn.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">Windows XP Service Pack 3:<br />
WindowsXP-KB2761226-x86-jpn.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2761226-x64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">[コントロール パネル] の [プログラムの追加と削除] または次のフォルダーにある Spuninst.exe を使用します。%Windir%\$NTUninstallKB2761226$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ファイルに関する情報:</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2761226/ja">マイクロソフト サポート技術情報 2761226</a> を参照してください。</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2761226-x86-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2761226-ia64-jpn.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">再起動しないでインストールする</td>
<td style="border:1px solid black;">すべてのサポートされている 32 ビット版の Windows Server 2003:<br />
WindowsServer2003-KB2761226-x86-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている x64-based エディションの Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">すべてのサポートされている Itanium-based エディションの Windows Server 2003:<br />
WindowsServer2003-KB2761226-ia64-jpn.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ログ ファイル</td>
<td style="border:1px solid black;">KB2761226.log</td>
...
| ファイルに関する情報:               | [マイクロソフト サポート技術情報 2761226](http://support.microsoft.com/kb/2761226/ja) を参照してください。                                                                                  |
...
-   Windows カーネル win32k.sys の解放後使用の脆弱性 (CVE-2012-2553) を報告してくださった [Google Inc](http://www.google.com) の Matthew Jurczyk 氏  
-   Chromium Security Rewards Program と協力して TrueType フォントの解析の脆弱性 (CVE-2012-2897) を報告してくださった [Documill](http://www.documill.com) の Eetu Luodemaa 氏と Joni Vähämäki 氏
...
-   V1.1 (2012/11/15):このセキュリティ情報ページを更新し、CVE-2012-2897 の脆弱性のタイトルとよく寄せられる質問を修正しました。今回の更新は情報のみの変更です。
