...
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232498">MS12-028</a> の KB2680317 は、KB2754670 に置き換えられる</td>
</tr>
</tbody>
</table>
...
セキュリティ更新プログラムの SHA1 および SHA2 ハッシュを使用して、ダウンロードされたセキュリティ更新プログラム パッケージの信頼性を確認することができます。この更新プログラムに関するハッシュの情報については、[サポート技術情報 2754670](http://support.microsoft.com/kb/2754670/ja) を参照してください。
...
<tr class="header">
<th>影響を受けるソフトウェア</th>
<th>Works ヒープの脆弱性 - CVE-2012-2550</th>
<th>総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2012-2550](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2550) を参照してください。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2754670/ja">サポート技術情報 2754670</a> を参照してください。</td>
</tr>
<tr class="even">
