...
<tr class="header">
<th>影響を受けるソフトウェア</th>
<th>Outlook Web Access を実行している Exchange Server の、データ検証のクロスサイト スクリプティングの脆弱性 - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2247">CVE-2008-2247</a></th>
<th>Outlook Web Access を実行している Exchange Server の、クロスサイト スクリプティング解析の脆弱性 - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2248">CVE-2008-2248</a></th>
<th>総合的な深刻度</th>
</tr>
</thead>
<tbody>
