...
<td style="border:1px solid black;"><p><strong>MSXML 4.0 および MSXML 5.0</strong></p></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><p>Windows Server 2003</p></td>
<td style="border:1px solid black;"><p>MSXML 3.0 はオペレーティング システムに同梱される。MSXML 6.0 はその他のソフトウェアと共にインストールされる。</p></td>
...
<td style="border:1px solid black;"><p>オペレーティング システムに同梱</p></td>
<td style="border:1px solid black;"><p>MSXML 4.0 はその他のソフトウェアと共にインストールされる。MSXML 5.0 は対象外。</p></td>
</tr>  
<tr class="even">
