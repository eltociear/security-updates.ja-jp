...
<td style="border:1px solid black;"><p>[コントロール パネル]<strong><strong></strong></strong>の [プログラムの追加と削除] または %Windir%\$NTUninstallKB2918614$\Spuninst フォルダーの Spuninst.exe ユーティリティを使用します。</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>ファイルに関する情報</strong></p></td>
<td style="border:1px solid black;"><p><a href="https://support.microsoft.com/kb/2918614/ja">サポート技術情報 2918614</a> を参照してください。</p></td>
</tr>
<tr class="even">
