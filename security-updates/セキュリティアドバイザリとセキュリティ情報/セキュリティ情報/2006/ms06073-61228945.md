...
<p><strong>注:</strong> すべての Visual Studio 2005 のバージョンに影響を受けるファイルが含まれているわけではありません。コンピュータに wmiscriptutils.dll がなければ、この脆弱性の影響を受けることはありません。下記の「影響を受けないソフトウェア」の欄も確認してください。</p></td>
