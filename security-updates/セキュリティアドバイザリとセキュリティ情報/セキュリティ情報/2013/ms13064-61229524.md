...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/ja-jp/details.aspx?familyid=a0c0a26c-0c46-4db2-94e8-cb5e03a559ef">Windows Server 2012</a><br />
(2849568)</td>
...
<tr class="header">
<th>影響を受けるソフトウェア</th>
<th>Windows NAT サービス拒否の脆弱性 - CVE-2013-3182</th>
<th>総合的な深刻度</th>
</tr>
</thead>
<tbody>
...
Common Vulnerabilities and Exposures のリストの標準のエントリとしてこの脆弱性を確認するには、[CVE-2013-3182](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3182) を参照してください。
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2849568/ja">サポート技術情報 2849568</a> を参照してください。</td>
</tr>
<tr class="even">
