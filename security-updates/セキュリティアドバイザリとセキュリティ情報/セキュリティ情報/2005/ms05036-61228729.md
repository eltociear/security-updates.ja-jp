...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=fa8d18ec-ebf4-4c49-afa0-f6a215b3624f&amp;displaylang=ja"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=fa8d18ec-ebf4-4c49-afa0-f6a215b3624f&amp;displaylang=ja-nec"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c5bcf2db-adce-42bd-abee-1380f258158b&amp;displaylang=ja"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">-</td>
<td style="border:1px solid black;"><img src="../../images/Dn610026.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows XP Professional x64 Edition</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c54bb4ba-fb9b-4615-9bbe-ef6d3885467d&amp;displaylang=ja"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">-</td>
<td style="border:1px solid black;"><img src="../../images/Dn610026.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows Server 2003 および Microsoft Windows Server 2003 Service Pack 1</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=44275ecb-2e79-4ce8-8269-e81219ce8f6c&amp;displaylang=ja"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">-</td>
<td style="border:1px solid black;"><img src="../../images/Dn610026.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=97a903bc-90e1-4fde-9487-1816c4a647bb&amp;displaylang=ja"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">-</td>
<td style="border:1px solid black;"><img src="../../images/Dn610026.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows Server 2003 x64 Edition</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=52167b42-8790-4965-9f26-dc5edc2e84f8&amp;displaylang=ja"><img src="../../images/Dn610026.dl_arrow(ja-JP,Security.10).jpg" /></a></td>
<td style="border:1px solid black;">-</td>
<td style="border:1px solid black;"><img src="../../images/Dn610026.mu_s(ja-JP,Security.10).gif" /></td>
</tr>
<tr class="odd">
...
![](../../images/Dn610026.mu_s(ja-JP,Security.10).gif)このマークの付いている更新プログラムは [Microsoft Update](http://update.microsoft.com/microsoftupdate/) からインストールすることもできます。  
...
|-----------------------------------------------------------------------------------------------------------------|------------------------------|-----------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|  
| カラー管理モジュールの脆弱性 - [CAN-2005-1219](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1219) | リモートでコードが実行される | 重要                  | 緊急         | 緊急                      | 緊急                      | 緊急                | 緊急                               |
...
はい。MBSA 1.2.1 によって、MBSA がサポートするプログラムのみを対象にこの更新プログラムが必要かどうか確認されます。MBSA に関する詳細は、[MBSA Web サイト](http://technet.microsoft.com/ja-jp/security/cc184924.aspx) をご覧ください。
  
**Microsoft Baseline Security Analyzer (MBSA) 2.0** **を使用して、この更新プログラムが必要であるかどうかを確認することはできますか?**
  
はい。MBSA 2.0 は、この更新プログラムが必要かどうかを確認します。MBSA 2.0 は Microsoft Update がサポートする製品用のセキュリティ更新プログラムを検出することができます。MBSA に関する詳細は、[MBSA Web サイト](http://technet.microsoft.com/ja-jp/security/cc184924.aspx) をご覧下さい。
...
マイクロソフト カラー 管理 モジュールにより、オペレーティング システムが、異なるデバイスとアプリケーションで、一貫したカラー マッピングを行うことが出来ます。 さらに、このモジュールは一つのカラー スペースから別のものへと変換するために使用されます (例: RGB から CMYK) 。 カラー管理に関する詳細情報は、次の[Web サイト](http://www.microsoft.com/whdc/device/display/color/icmwp.mspx) (英語情報) をご覧ください。
  
**International Color Consortium (ICC)** **とは何ですか?**
  
The International Color Consortium はベンダー間の互換性を確保するために、ベンダーが色彩管理行うことにより標準化を提供する目的の団体です。カラー管理に関する詳細情報は、次の[Web サイト](http://www.color.org) (英語情報)をご覧ください。
...
いいえ。Windows 98、Windows 98 Second Edition、および Windows Millennium Edition には影響を受けるコンポーネントが含まれますが、重大な攻撃ベクタで悪用できないため、この脆弱性の深刻度は「緊急」ではありません。 さらに、現在知られている攻撃のベクタがこの脆弱性を悪用するには、ユーザーの操作が必要になります。深刻度評価システムに関する詳細情報は、次の [Web サイト](http://technet.microsoft.com/security/bulletin/rating) をご覧ください。
...
Windows 2000 に関して、このセキュリティ更新プログラムを適用するには、Service Pack 4 (SP4) がインストールされている必要があります。Small Business Server 2000 にこのセキュリティ更新プログラムを適用するには、Windows 2000 Server Service Pack 4 (SP4) に Small Business Server 2000 Service Pack 1a (SP1a) または Small Business Server 2000 がインストールされている必要があります。詳細情報は、サポート技術情報 [322389](http://support.microsoft.com/kb/322389) をご覧ください。
...
-   カラー管理モジュールの脆弱性 (CAN-2005-1219) を報告してくださった[Information & Communication Security Technology Center (ICST)](http://www.icst.org.tw/) のShih-hao Weng 氏
...
-   US マイクロソフトセキュリティ情報（MS05-036）
    [http://www.microsoft.com/technet/security/bulletin/MS05-036.mspx](http://technet.microsoft.com/security/bulletin/ms05-036)
-   サポート技術情報 （KB） 文書番号 ：901214
    [\[MS05-036\] マイクロソフト カラー管理モジュールの脆弱性によりリモートでコードが実行される](http://support.microsoft.com/kb/901214)
